 ...
 * @generated
 */
public class StChAssumptionsLocalServiceClp
    ...
    public StChAssumptionsLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addStChAssumptions";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.StChAssumptions"
            };

        _methodName1 = "createStChAssumptions";

        _methodParameterTypes1 = new String[] {
                "com.stpl.app.service.persistence.StChAssumptionsPK"
            };

        _methodName2 = "deleteStChAssumptions";

        _methodParameterTypes2 = new String[] {
                "com.stpl.app.service.persistence.StChAssumptionsPK"
            };

        _methodName3 = "deleteStChAssumptions";
        ...
        _methodName10 = "fetchStChAssumptions";

        _methodParameterTypes10 = new String[] {
                "com.stpl.app.service.persistence.StChAssumptionsPK"
            };

        _methodName11 = "getStChAssumptions";
        ...
        _methodName13 = "getStChAssumptionses";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getStChAssumptionsesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateStChAssumptions";
    ...
    public com.stpl.app.model.StChAssumptions addStChAssumptions(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(stChAssumptions) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.StChAssumptions) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.stpl.app.model.StChAssumptions> getStChAssumptionses(
        ...
        return (java.util.List<com.stpl.app.model.StChAssumptions>) ClpSerializer.translateOutput(returnObj);
    }
