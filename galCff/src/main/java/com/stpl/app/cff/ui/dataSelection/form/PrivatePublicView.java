...
public class PrivatePublicView extends AbstractViewLookup {
    ...
    public PrivatePublicView(final String indicator, final CustomTextField lookup, final String windowName, final String screenName) {
        super(windowName);
        LOGGER.info("Entering PrivatePublicView");
        ...
        buildLookup();
        LOGGER.info("End of PrivatePublicView");
    }
    ...
    private void initializeComponents() {
        LOGGER.info("Entering initializeComponents");
        ...
        LOGGER.info("End of initializeComponents");
    }
    ...
    protected void configureField() {
        LOGGER.info("Entering configureField");
        //Configure the table
        ...
        viewName.focus();
        results.setHeight(500, Unit.PIXELS);
    ...
    public void btnSearchLogic() {
        LOGGER.info("Entering btnSearchLogic method");
        try {
        ...
        LOGGER.info("End of btnSearchLogic method");
    }
    ...
    public void btnSelectLogic() {
        LOGGER.info("Entering btnSelectLogic method");
        ...
        LOGGER.info("End of btnSelectLogic method");
    }
