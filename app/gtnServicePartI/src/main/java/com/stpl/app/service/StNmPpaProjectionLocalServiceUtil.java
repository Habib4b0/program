...
public class StNmPpaProjectionLocalServiceUtil {
    private static StNmPpaProjectionLocalService _service;
    ...
    */
    ...
    public static StNmPpaProjectionLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StNmPpaProjectionLocalService.class.getName());

            if (invokableLocalService instanceof StNmPpaProjectionLocalService) {
                _service = (StNmPpaProjectionLocalService) invokableLocalService;
            } else {
                _service = new StNmPpaProjectionLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StNmPpaProjectionLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StNmPpaProjectionLocalService service) {
    }
}
