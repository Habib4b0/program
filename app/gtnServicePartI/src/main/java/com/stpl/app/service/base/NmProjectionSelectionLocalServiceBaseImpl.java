...
public abstract class NmProjectionSelectionLocalServiceBaseImpl
    ...
    private NmProjectionSelectionLocalServiceClpInvoker _clpInvoker = new NmProjectionSelectionLocalServiceClpInvoker();
    ...
    public NmProjectionSelection deleteNmProjectionSelection(
        int nmProjectionSelectionSid) throws PortalException, SystemException {
    ...
    public NmProjectionSelection fetchNmProjectionSelection(
        int nmProjectionSelectionSid) throws SystemException {
     ...
     */
    @Override
    public int getNmProjectionSelectionsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.NmProjectionSelection",
