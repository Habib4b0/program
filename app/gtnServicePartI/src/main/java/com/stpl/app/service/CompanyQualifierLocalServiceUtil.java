...
public class CompanyQualifierLocalServiceUtil {
    private static CompanyQualifierLocalService _service;
    ...
    */
    public static com.stpl.app.model.CompanyQualifier findByCompanyCrtQualifierByName(
        ...
        throws com.stpl.app.NoSuchCompanyQualifierException,
            com.stpl.portal.kernel.exception.SystemException {
        return getService().findByCompanyCrtQualifierByName(companyQualifierName);
    }
    ...
    public static CompanyQualifierLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    CompanyQualifierLocalService.class.getName());

            if (invokableLocalService instanceof CompanyQualifierLocalService) {
                _service = (CompanyQualifierLocalService) invokableLocalService;
            } else {
                _service = new CompanyQualifierLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(CompanyQualifierLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(CompanyQualifierLocalService service) {
    }
}
