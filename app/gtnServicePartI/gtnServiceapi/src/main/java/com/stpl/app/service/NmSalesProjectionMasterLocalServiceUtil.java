...
public class NmSalesProjectionMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<NmSalesProjectionMasterLocalService, NmSalesProjectionMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(NmSalesProjectionMasterLocalService.class);
}