...
/**
 * The persistence utility for the ch sales projection master service. This utility wraps {@link com.stpl.app.service.persistence.impl.ChSalesProjectionMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.stpl.app.service.persistence.impl.ChSalesProjectionMasterPersistenceImpl
 * @generated
 */
@ProviderType
public class ChSalesProjectionMasterUtil {
	...
	*/
	public static ChSalesProjectionMaster create(int projectionDetailsSid) {
	...
	*/
	public static ChSalesProjectionMaster remove(int projectionDetailsSid)
		throws com.stpl.app.exception.NoSuchChSalesProjectionMasterException {
		return getPersistence().remove(projectionDetailsSid);
	}

	public static ChSalesProjectionMaster updateImpl(
		ChSalesProjectionMaster chSalesProjectionMaster) {
	...
	* @throws NoSuchChSalesProjectionMasterException if a ch sales projection master with the primary key could not be found
	*/
	public static ChSalesProjectionMaster findByPrimaryKey(
	...
	*/
	public static ChSalesProjectionMaster fetchByPrimaryKey(
		int projectionDetailsSid) {
		return getPersistence().fetchByPrimaryKey(projectionDetailsSid);
	}

	public static java.util.Map<java.io.Serializable, ChSalesProjectionMaster> fetchByPrimaryKeys(
	...
	*/
	public static List<ChSalesProjectionMaster> findAll() {
	...
	*/
	public static List<ChSalesProjectionMaster> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<ChSalesProjectionMasterPersistence, ChSalesProjectionMasterPersistence> _serviceTracker =
		ServiceTrackerFactory.open(ChSalesProjectionMasterPersistence.class);
}