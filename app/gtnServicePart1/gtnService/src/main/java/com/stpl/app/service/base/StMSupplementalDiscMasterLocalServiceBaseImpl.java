...
import com.stpl.app.service.StMSupplementalDiscMasterLocalService;
...
/**
 * Provides the base implementation for the st m supplemental disc master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.StMSupplementalDiscMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.StMSupplementalDiscMasterLocalServiceImpl
 * @see com.stpl.app.service.StMSupplementalDiscMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StMSupplementalDiscMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements StMSupplementalDiscMasterLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.StMSupplementalDiscMasterLocalServiceUtil} to access the st m supplemental disc master local service.
	 */
	...
	@Override
	public StMSupplementalDiscMaster addStMSupplementalDiscMaster(
		StMSupplementalDiscMaster stMSupplementalDiscMaster) {
		stMSupplementalDiscMaster.setNew(true);

		return stMSupplementalDiscMasterPersistence.update(stMSupplementalDiscMaster);
	}
	 ...
	 */
	@Override
	public StMSupplementalDiscMaster createStMSupplementalDiscMaster(
		StMSupplementalDiscMasterPK stMSupplementalDiscMasterPK) {
		return stMSupplementalDiscMasterPersistence.create(stMSupplementalDiscMasterPK);
	}
	...
	@Override
	public StMSupplementalDiscMaster deleteStMSupplementalDiscMaster(
		StMSupplementalDiscMasterPK stMSupplementalDiscMasterPK)
		throws PortalException {
		return stMSupplementalDiscMasterPersistence.remove(stMSupplementalDiscMasterPK);
	}
	...
	public StMSupplementalDiscMaster deleteStMSupplementalDiscMaster(
		StMSupplementalDiscMaster stMSupplementalDiscMaster) {
		return stMSupplementalDiscMasterPersistence.remove(stMSupplementalDiscMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StMSupplementalDiscMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stMSupplementalDiscMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stMSupplementalDiscMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StMSupplementalDiscMaster fetchStMSupplementalDiscMaster(
		StMSupplementalDiscMasterPK stMSupplementalDiscMasterPK) {
		return stMSupplementalDiscMasterPersistence.fetchByPrimaryKey(stMSupplementalDiscMasterPK);
	}
	 ...
	 */
	@Override
	public StMSupplementalDiscMaster getStMSupplementalDiscMaster(
		StMSupplementalDiscMasterPK stMSupplementalDiscMasterPK)
		throws PortalException {
		return stMSupplementalDiscMasterPersistence.findByPrimaryKey(stMSupplementalDiscMasterPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stMSupplementalDiscMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StMSupplementalDiscMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(stMSupplementalDiscMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StMSupplementalDiscMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stMSupplementalDiscMasterLocalService.deleteStMSupplementalDiscMaster((StMSupplementalDiscMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stMSupplementalDiscMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StMSupplementalDiscMaster> getStMSupplementalDiscMasters(
		int start, int end) {
		return stMSupplementalDiscMasterPersistence.findAll(start, end);
	}
	...
	public int getStMSupplementalDiscMastersCount() {
		return stMSupplementalDiscMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StMSupplementalDiscMaster updateStMSupplementalDiscMaster(
		StMSupplementalDiscMaster stMSupplementalDiscMaster) {
		return stMSupplementalDiscMasterPersistence.update(stMSupplementalDiscMaster);
	}
	 ...
	 */
	public StMSupplementalDiscMasterLocalService getStMSupplementalDiscMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.StMSupplementalDiscMaster",
			stMSupplementalDiscMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.StMSupplementalDiscMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StMSupplementalDiscMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stMSupplementalDiscMasterPersistence.getDataSource();
	...
	@BeanReference(type = StMSupplementalDiscMasterLocalService.class)
	protected StMSupplementalDiscMasterLocalService stMSupplementalDiscMasterLocalService;
