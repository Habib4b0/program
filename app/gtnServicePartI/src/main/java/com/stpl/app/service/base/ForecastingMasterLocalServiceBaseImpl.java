...
import com.stpl.app.service.ForecastingMasterLocalService;
...
/**
 * Provides the base implementation for the forecasting master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ForecastingMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class ForecastingMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ForecastingMasterLocalService,
        IdentifiableBean {
    ...
    private ForecastingMasterLocalServiceClpInvoker _clpInvoker = new ForecastingMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ForecastingMasterLocalServiceUtil} to access the forecasting master local service.
     */
    ...
    @Override
    public ForecastingMaster addForecastingMaster(
        ForecastingMaster forecastingMaster) throws SystemException {
        forecastingMaster.setNew(true);

        return forecastingMasterPersistence.update(forecastingMaster);
    }
     ...
     */
    @Override
    public ForecastingMaster createForecastingMaster(int forecastMasterSid) {
        return forecastingMasterPersistence.create(forecastMasterSid);
    }
    ...
    @Override
    public ForecastingMaster deleteForecastingMaster(int forecastMasterSid)
        throws PortalException, SystemException {
        return forecastingMasterPersistence.remove(forecastMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ForecastingMaster deleteForecastingMaster(
        ForecastingMaster forecastingMaster) throws SystemException {
        return forecastingMasterPersistence.remove(forecastingMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ForecastingMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return forecastingMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return forecastingMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ForecastingMaster fetchForecastingMaster(int forecastMasterSid)
        throws SystemException {
        return forecastingMasterPersistence.fetchByPrimaryKey(forecastMasterSid);
    }
     ...
     */
    @Override
    public ForecastingMaster getForecastingMaster(int forecastMasterSid)
        throws PortalException, SystemException {
        return forecastingMasterPersistence.findByPrimaryKey(forecastMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return forecastingMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ForecastingMaster> getForecastingMasters(int start, int end)
        throws SystemException {
        return forecastingMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getForecastingMastersCount() throws SystemException {
        return forecastingMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ForecastingMaster updateForecastingMaster(
        ForecastingMaster forecastingMaster) throws SystemException {
        return forecastingMasterPersistence.update(forecastingMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ForecastingMaster",
            forecastingMasterLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = forecastingMasterPersistence.getDataSource();
