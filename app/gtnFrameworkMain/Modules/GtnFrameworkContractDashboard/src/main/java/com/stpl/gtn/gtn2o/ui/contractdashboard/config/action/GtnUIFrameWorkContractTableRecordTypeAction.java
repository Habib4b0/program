    ...
    private void manageTableRecordType(GtnWsRecordBean record, GtnUIFrameworkBaseComponent tableBaseComponent)
        ...
        try {
            ...
            for (int i = 0; i < recordHeader.size(); i++) {
                ...
                if ((GtnFrameworkContractDashboardContants.getPriceProtectionEditableColumn()[17].equals(propertyId)) && (priceprotectionpricingTable.getExtPagedTable().isReadOnly() == false)) {
