...
public class ProjectionMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<ProjectionMasterLocalService, ProjectionMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ProjectionMasterLocalService.class);
}