...
public class ErrorLabel extends Label implements ErrorDisplay {
    ...
    public ErrorLabel() {
        super();
        LOGGER.info("entering ErrorLabel");
        setVisible(false);
        setStyleName("myerror");
        LOGGER.info("End of ErrorLabel");
    }
    ...
    public void setError(final String error) {
        LOGGER.info("entering setError method");
        setValue(error);
        setComponentError(new UserError(error));
        setVisible(true);
        LOGGER.info("End of setError method");
    }
    ...
    public void clearError() {
        LOGGER.info("entering clearError method");
        setValue(null);
        setComponentError(null);
        setVisible(false);
        LOGGER.info("End of clearError method");
    }
}