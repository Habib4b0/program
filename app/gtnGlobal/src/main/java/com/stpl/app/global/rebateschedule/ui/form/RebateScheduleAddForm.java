...
public final class RebateScheduleAddForm extends StplCustomComponent implements AddBaseForm {
    ...
    public RebateScheduleAddForm(final RebateScheduleMasterDTO rebateSchMaster, final ErrorfulFieldGroup binder, final BeanItemContainer<IFPDetailsDTO> selectedItemResultBean,
            final BeanItemContainer<ItemDetailsDTO> itemResultBean, String mode, final SessionDTO sessionDTO) throws SystemException, PortalException {
        super();
    ...
    private void addPermissionToFooterButtons() throws SystemException, PortalException {
    ...
    private void deleteButton() {
        ...
        deleteBtn.addClickListener(new ClickListener() {
             ...
             */
            public void buttonClick(final ClickEvent event) {
                LOGGER.debug("Entering Rebate Schedule delete operation in Edit");
                ...
                LOGGER.debug("DeleteButton id=" + idValue);
                ...
                if (psContractList != null && !psContractList.isEmpty() && psContractList.size() > 0) {
                    final MessageBox msg = MessageBox.showPlain(Icon.WARN, ValidationUtils.CANNOT_DELETE, "Rebate Schedule cannot be deleted as it is associated with Contract", new MessageBoxListener() {
    ...
    public void updateLogic() {
        ...
        try {
            ...
            LOGGER.debug("Ending Rebate Schedule update operation in Edit");
