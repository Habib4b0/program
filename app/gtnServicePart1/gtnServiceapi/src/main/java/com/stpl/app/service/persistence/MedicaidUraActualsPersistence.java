...
public interface MedicaidUraActualsPersistence extends BasePersistence<MedicaidUraActuals> {
	...
	*/
	public void cacheResult(
		java.util.List<MedicaidUraActuals> medicaidUraActualses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, MedicaidUraActuals> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<MedicaidUraActuals> findAll();
	...
	*/
	public java.util.List<MedicaidUraActuals> findAll(int start, int end);
	...
	*/
	public java.util.List<MedicaidUraActuals> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MedicaidUraActuals> orderByComparator);
