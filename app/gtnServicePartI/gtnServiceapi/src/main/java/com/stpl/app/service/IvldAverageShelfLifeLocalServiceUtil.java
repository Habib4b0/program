...
public class IvldAverageShelfLifeLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<IvldAverageShelfLifeLocalService, IvldAverageShelfLifeLocalService> _serviceTracker =
		ServiceTrackerFactory.open(IvldAverageShelfLifeLocalService.class);
}