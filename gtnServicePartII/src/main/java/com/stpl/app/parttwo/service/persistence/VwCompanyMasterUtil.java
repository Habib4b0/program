...
/**
 * The persistence utility for the vw company master service. This utility wraps {@link VwCompanyMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class VwCompanyMasterUtil {
    private static VwCompanyMasterPersistence _persistence;
    ...
    */
    public static com.stpl.app.parttwo.model.VwCompanyMaster create(
    ...
    */
    public static com.stpl.app.parttwo.model.VwCompanyMaster remove(
        int companyMasterSid)
    ...
    public static com.stpl.app.parttwo.model.VwCompanyMaster updateImpl(
        com.stpl.app.parttwo.model.VwCompanyMaster vwCompanyMaster)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.VwCompanyMaster findByPrimaryKey(
        int companyMasterSid)
        throws com.stpl.app.parttwo.NoSuchVwCompanyMasterException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.VwCompanyMaster fetchByPrimaryKey(
        int companyMasterSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.parttwo.model.VwCompanyMaster> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static VwCompanyMasterPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (VwCompanyMasterPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.parttwo.service.ClpSerializer.getServletContextName(),
                    VwCompanyMasterPersistence.class.getName());

            ReferenceRegistry.registerReference(VwCompanyMasterUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(VwCompanyMasterPersistence persistence) {
    }
}
