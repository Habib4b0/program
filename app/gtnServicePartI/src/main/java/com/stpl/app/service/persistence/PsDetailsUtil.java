...
/**
 * The persistence utility for the ps details service. This utility wraps {@link PsDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PsDetailsUtil {
    private static PsDetailsPersistence _persistence;
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PsDetails findByPriceScheduleMasterDetails_First(
        int psModelSid,
        com.stpl.portal.kernel.util.OrderByComparator orderByComparator)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PsDetails fetchByPriceScheduleMasterDetails_First(
        int psModelSid,
        com.stpl.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getPersistence()
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PsDetails findByPriceScheduleMasterDetails_Last(
        int psModelSid,
        com.stpl.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.stpl.app.NoSuchPsDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PsDetails fetchByPriceScheduleMasterDetails_Last(
        int psModelSid,
        com.stpl.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getPersistence()
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PsDetails[] findByPriceScheduleMasterDetails_PrevAndNext(
    ...
    */
    public static void cacheResult(com.stpl.app.model.PsDetails psDetails) {
    ...
    */
    public static com.stpl.app.model.PsDetails create(int psDetailsSid) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PsDetails remove(int psDetailsSid)
        throws com.stpl.app.NoSuchPsDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().remove(psDetailsSid);
    }

    public static com.stpl.app.model.PsDetails updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PsDetails findByPrimaryKey(
        int psDetailsSid)
        throws com.stpl.app.NoSuchPsDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PsDetails fetchByPrimaryKey(
        int psDetailsSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.PsDetails> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static PsDetailsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (PsDetailsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    PsDetailsPersistence.class.getName());

            ReferenceRegistry.registerReference(PsDetailsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(PsDetailsPersistence persistence) {
    }
}
