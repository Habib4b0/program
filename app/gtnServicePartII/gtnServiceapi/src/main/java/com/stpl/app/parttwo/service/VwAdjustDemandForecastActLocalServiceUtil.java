...
public class VwAdjustDemandForecastActLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<VwAdjustDemandForecastActLocalService, VwAdjustDemandForecastActLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VwAdjustDemandForecastActLocalService.class);
}