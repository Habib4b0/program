...
/**
 * The persistence utility for the ivld customer gts forecast service. This utility wraps {@link com.stpl.app.parttwo.service.persistence.impl.IvldCustomerGtsForecastPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class IvldCustomerGtsForecastUtil {
	...
	*/
	public static IvldCustomerGtsForecast create(int ivldCustomerGtsForecastSid) {
	...
	*/
	public static IvldCustomerGtsForecast remove(int ivldCustomerGtsForecastSid)
		throws com.stpl.app.parttwo.exception.NoSuchIvldCustomerGtsForecastException {
		return getPersistence().remove(ivldCustomerGtsForecastSid);
	}

	public static IvldCustomerGtsForecast updateImpl(
		IvldCustomerGtsForecast ivldCustomerGtsForecast) {
	...
	* @throws NoSuchIvldCustomerGtsForecastException if a ivld customer gts forecast with the primary key could not be found
	*/
	public static IvldCustomerGtsForecast findByPrimaryKey(
	...
	*/
	public static IvldCustomerGtsForecast fetchByPrimaryKey(
		int ivldCustomerGtsForecastSid) {
		return getPersistence().fetchByPrimaryKey(ivldCustomerGtsForecastSid);
	}

	public static java.util.Map<java.io.Serializable, IvldCustomerGtsForecast> fetchByPrimaryKeys(
	...
	*/
	public static List<IvldCustomerGtsForecast> findAll() {
	...
	*/
	public static List<IvldCustomerGtsForecast> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IvldCustomerGtsForecastPersistence, IvldCustomerGtsForecastPersistence> _serviceTracker =
		ServiceTrackerFactory.open(IvldCustomerGtsForecastPersistence.class);
}