...
public abstract class HierarchyDefinitionLocalServiceBaseImpl
    ...
    private HierarchyDefinitionLocalServiceClpInvoker _clpInvoker = new HierarchyDefinitionLocalServiceClpInvoker();
    ...
    public HierarchyDefinition deleteHierarchyDefinition(
        int hierarchyDefinitionSid) throws PortalException, SystemException {
    ...
    public HierarchyDefinition fetchHierarchyDefinition(
        int hierarchyDefinitionSid) throws SystemException {
     ...
     */
    @Override
    public int getHierarchyDefinitionsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.HierarchyDefinition",
