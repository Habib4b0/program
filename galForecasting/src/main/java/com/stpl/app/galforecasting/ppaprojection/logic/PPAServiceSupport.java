...
public class PPAServiceSupport {
    ...
    public void getPriceTypeResults() {
        ...
        try {
            ...
            LOGGER.info("Ending getPriceTypeResults in PPA  return map size :" + +priceQualifierMap.size());
        } catch (SystemException | NumberFormatException e) {
            LOGGER.error("Error while loading Data for PPA Price Qualifier Name :" + e.getMessage());
        }
