...
public class ARMUtils {
    ...
    public static enum ADJUSTMENT_CONFIG_CONSTANTS {
        ...
        CREATED_DATE(CommonConstant.CREATED_DATE, "AC.CREATED_DATE"),
        CREATED_BY(CommonConstant.CREATED_BY, "(crt.lastName+' '+crt.firstName)"),
        MODIFIED_DATE(CommonConstant.MODIFIED_DATE, "AC.MODIFIED_DATE"),
    ...
    public static Map<String, String> getAdjustmentSummaryAccountMap() {
    ...
    public static Map<String, String> getAdjustmentSummaryVisibleToDBColumnMap() {
    ...
    public static Map<String, String> getBalanceSummaryVisibleToDBColumnMap() {
    ...
    public static ARMUtils getInstance() {
        if (object == null) {
            object = new ARMUtils();
        }
        return object;
    ...
    public static Map<String, String> loadViewFilterMapForAdjustment() {
        if (VIEW_FILTER_MAPS.isEmpty()) {
            ...
            VIEW_FILTER_MAPS.put("balanceType.1", "BALANCE_TYPE");
            VIEW_FILTER_MAPS.put("database.2", "DATABASE_DESC");
            VIEW_FILTER_MAPS.put("dataAccessSet.3", "DATA_ACCESS_SET");
            VIEW_FILTER_MAPS.put("chartOfAccounts.4", "CHART_OF_ACCOUNTS");
            VIEW_FILTER_MAPS.put("ledger.5", "LEDGER");
            VIEW_FILTER_MAPS.put("category.6", CATEGORY);
            VIEW_FILTER_MAPS.put("source.7", "SOURCE_DESC");
            ...
            VIEW_FILTER_MAPS.put("journalName.11", "JOURNAL_NAME");
            VIEW_FILTER_MAPS.put("journalDescription.12", "JOURNAL_DESCRIPTION");
            VIEW_FILTER_MAPS.put("reverseJournal.13", "REVERSE_JOURNAL");
            VIEW_FILTER_MAPS.put("h_reversalPeriodOrDate.14", "REVERSAL_PERIOD_DATE");
            VIEW_FILTER_MAPS.put(CommonConstant.COMPANY15, "GL_COMPANY_ID");
            VIEW_FILTER_MAPS.put(VariableConstants.DIVISION_16, DIVISION);
            VIEW_FILTER_MAPS.put("businessUnit.17", "BU");
            VIEW_FILTER_MAPS.put(CommonConstant.COST_CENTER18, COST_CENTER);
            VIEW_FILTER_MAPS.put(CommonConstant.ACCOUNT19, ACCOUNT);
            VIEW_FILTER_MAPS.put(CommonConstant.BRAND20, "BRAND_ID");
            ...
            VIEW_FILTER_MAPS.put(CommonConstant.DEBIT24, "A.DEBIT");
            VIEW_FILTER_MAPS.put(CommonConstant.CREDIT25, "A.CREDIT");
            VIEW_FILTER_MAPS.put(CommonConstant.LINE_DESCRIPTION26, "LINE_DESCRIPTION");
            ...
            VIEW_FILTER_MAPS.put("redemptionPeriodDate.38", "REP_PERIIOD");
            VIEW_FILTER_MAPS.put("calculationPriodDate.39", "CALCULATION_PERIOD");
            VIEW_FILTER_MAPS.put("workFlowId.40", "A.WORKFLOW_ID");
            VIEW_FILTER_MAPS.put("workFlowName.41", "A.WORKFLOW_NAME");
            VIEW_FILTER_MAPS.put("h_workFlowStatus.42", "A.WORKFLOW_STATUS");
        }
      ...
      public static Map<String, String> loadViewFilterMapForAdjustmentDetailGTN() {
        if (VIEW_FILTER_GTN.isEmpty()) {
            ...
            VIEW_FILTER_GTN.put(CommonConstant.DEDUCTION_AMOUNT15, "ACCRUAL_AMOUNT");
            VIEW_FILTER_GTN.put("glCompanyNo.16", "GL_COMPANY_NO");
            VIEW_FILTER_GTN.put("glCompanyName.17", "GL_COMPANY_NAME");
            VIEW_FILTER_GTN.put("businessUnitNo.18", "BU_COMPANY_NO");
            VIEW_FILTER_GTN.put("businessUnitName.19", "BU_COMPANY_NAME");
            VIEW_FILTER_GTN.put("glDate.20", "GLDATE");
            VIEW_FILTER_GTN.put("createdDate.21", "CREATED_DATE");
            VIEW_FILTER_GTN.put("redemptionPeriodDate.22", "REDEMPTION_PERIOD");
            ...
            VIEW_FILTER_GTN.put("h_deductionProgram.36", "REBATE_PROGRAM_TYPE");
            ...
            VIEW_FILTER_GTN.put("deductionRate.44", "RATE");
            ...
            VIEW_FILTER_GTN.put("accountDescription.54", "ACCOUNT_DESC");
            ...
            VIEW_FILTER_GTN.put("workFlowId.57", "A.WORKFLOW_ID");
            VIEW_FILTER_GTN.put("workFlowName.58", "A.WORKFLOW_NAME");
            VIEW_FILTER_GTN.put("h_workFlowStatus.59", "A.WORKFLOW_STATUS");
        }
