...
public class ImtdRsContractDetailsFrLocalServiceUtil {
    private static ImtdRsContractDetailsFrLocalService _service;
    ...
    */
    ...
    public static ImtdRsContractDetailsFrLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ImtdRsContractDetailsFrLocalService.class.getName());

            if (invokableLocalService instanceof ImtdRsContractDetailsFrLocalService) {
                _service = (ImtdRsContractDetailsFrLocalService) invokableLocalService;
            } else {
                _service = new ImtdRsContractDetailsFrLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ImtdRsContractDetailsFrLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ImtdRsContractDetailsFrLocalService service) {
    }
}
