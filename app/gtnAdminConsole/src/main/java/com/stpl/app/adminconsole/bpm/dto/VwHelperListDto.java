...
public class VwHelperListDto {
	...
	public String toString() {
		return "VwHelperListDto [uniqueId=" + uniqueId + ", actualTableName="
				+ actualTableName + ", actualColumnName=" + actualColumnName
				+ ", referenceTableName=" + referenceTableName
				+ ", referenceColumnName=" + referenceColumnName
				+ ", mappingColumnName=" + mappingColumnName + ", listName="
				+ listName + ", primaryKeyColumnName=" + primaryKeyColumnName
				+ "]";
	}
