...
public class PsModelCacheModel implements CacheModel<PsModel>, Externalizable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PsModelCacheModel)) {
			return false;
		}

		PsModelCacheModel psModelCacheModel = (PsModelCacheModel)obj;

		if (psModelSid == psModelCacheModel.psModelSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, psModelSid);
	}
