...
public class GtnFrameworkDeductionCalendarPopUpConfig {
	...
	private void addSearchButtonComponent(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		validationActionConfig.setFieldValues(Arrays.asList(new String[] { GtnFrameworkCommonConstants.PROPERTY_DEDUCTION_CALENDAR_NO }));
	...
	private void addPagedTableComponent(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		GtnUIFrameworkComponentConfig searchResultConfig = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.DC_POP_UP_SEARCH_RESULT_TABLE, "Results", true, GtnUIFrameworkComponentType.PAGEDTABLE);
		...
		searchResults.setTableColumnMappingId(new Object[] { GtnFrameworkCommonConstants.PROPERTY_DEDUCTION_CALENDAR_NO, "deductionCalendarName",
	...
	private void addSelectButtonComponent(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		closeAction.setActionParameterList(Arrays.asList(new Object[] { GtnFrameworkCommonConstants.DEDUCTION_CALENDAR_POP_UP_SEARCH_VIEW }));
