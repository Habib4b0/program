...
public class IvldMasterDataAttributeLocalServiceUtil {
    private static IvldMasterDataAttributeLocalService _service;
    ...
    */
    ...
    public static IvldMasterDataAttributeLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    IvldMasterDataAttributeLocalService.class.getName());

            if (invokableLocalService instanceof IvldMasterDataAttributeLocalService) {
                _service = (IvldMasterDataAttributeLocalService) invokableLocalService;
            } else {
                _service = new IvldMasterDataAttributeLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(IvldMasterDataAttributeLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(IvldMasterDataAttributeLocalService service) {
    }
}
