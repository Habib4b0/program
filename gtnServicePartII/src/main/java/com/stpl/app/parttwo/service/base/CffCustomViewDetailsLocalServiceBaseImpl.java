...
import com.stpl.app.parttwo.service.CffCustomViewDetailsLocalService;
...
/**
 * Provides the base implementation for the cff custom view details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.CffCustomViewDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.CffCustomViewDetailsLocalServiceImpl
 * @see com.stpl.app.parttwo.service.CffCustomViewDetailsLocalServiceUtil
 * @generated
 */
public abstract class CffCustomViewDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements CffCustomViewDetailsLocalService,
        IdentifiableBean {
    ...
    private CffCustomViewDetailsLocalServiceClpInvoker _clpInvoker = new CffCustomViewDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.CffCustomViewDetailsLocalServiceUtil} to access the cff custom view details local service.
     */
    ...
    @Override
    public CffCustomViewDetails addCffCustomViewDetails(
        CffCustomViewDetails cffCustomViewDetails) throws SystemException {
        cffCustomViewDetails.setNew(true);

        return cffCustomViewDetailsPersistence.update(cffCustomViewDetails);
    }
     ...
     */
    @Override
    public CffCustomViewDetails createCffCustomViewDetails(
        int cffCustomViewDetailsSid) {
        return cffCustomViewDetailsPersistence.create(cffCustomViewDetailsSid);
    }
    ...
    @Override
    public CffCustomViewDetails deleteCffCustomViewDetails(
        int cffCustomViewDetailsSid) throws PortalException, SystemException {
        return cffCustomViewDetailsPersistence.remove(cffCustomViewDetailsSid);
    }
    ...
    public CffCustomViewDetails deleteCffCustomViewDetails(
        CffCustomViewDetails cffCustomViewDetails) throws SystemException {
        return cffCustomViewDetailsPersistence.remove(cffCustomViewDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CffCustomViewDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return cffCustomViewDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return cffCustomViewDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public CffCustomViewDetails fetchCffCustomViewDetails(
        int cffCustomViewDetailsSid) throws SystemException {
        return cffCustomViewDetailsPersistence.fetchByPrimaryKey(cffCustomViewDetailsSid);
    }
     ...
     */
    @Override
    public CffCustomViewDetails getCffCustomViewDetails(
        int cffCustomViewDetailsSid) throws PortalException, SystemException {
        return cffCustomViewDetailsPersistence.findByPrimaryKey(cffCustomViewDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return cffCustomViewDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<CffCustomViewDetails> getCffCustomViewDetailses(int start,
        int end) throws SystemException {
        return cffCustomViewDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCffCustomViewDetailsesCount() throws SystemException {
        return cffCustomViewDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public CffCustomViewDetails updateCffCustomViewDetails(
        CffCustomViewDetails cffCustomViewDetails) throws SystemException {
        return cffCustomViewDetailsPersistence.update(cffCustomViewDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.CffCustomViewDetails",
            cffCustomViewDetailsLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = cffCustomViewDetailsPersistence.getDataSource();
