...
/**
 * Provides the local service interface for ProjectionCustDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ProjectionCustDetailsLocalServiceUtil
...
public interface ProjectionCustDetailsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ProjectionCustDetailsLocalServiceUtil} to access the projection cust details local service. Add custom service methods to {@link com.stpl.app.service.impl.ProjectionCustDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
