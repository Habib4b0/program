...
public class ChProjectionSelectionLocalServiceUtil {
    private static ChProjectionSelectionLocalService _service;
    ...
    */
    ...
    public static ChProjectionSelectionLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ChProjectionSelectionLocalService.class.getName());

            if (invokableLocalService instanceof ChProjectionSelectionLocalService) {
                _service = (ChProjectionSelectionLocalService) invokableLocalService;
            } else {
                _service = new ChProjectionSelectionLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ChProjectionSelectionLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ChProjectionSelectionLocalService service) {
    }
}
