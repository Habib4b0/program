...
public class IvldMasterDataAttributeCacheModel implements CacheModel<IvldMasterDataAttribute>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldMasterDataAttributeCacheModel)) {
			return false;
		}

		IvldMasterDataAttributeCacheModel ivldMasterDataAttributeCacheModel = (IvldMasterDataAttributeCacheModel)obj;

		if (ivldMasterDataAtbteSid == ivldMasterDataAttributeCacheModel.ivldMasterDataAtbteSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldMasterDataAtbteSid);
	}
