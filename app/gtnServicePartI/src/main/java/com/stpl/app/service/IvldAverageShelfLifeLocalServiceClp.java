 ...
 * @generated
 */
public class IvldAverageShelfLifeLocalServiceClp
    ...
    public IvldAverageShelfLifeLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addIvldAverageShelfLife";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.IvldAverageShelfLife"
            };

        _methodName1 = "createIvldAverageShelfLife";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteIvldAverageShelfLife";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteIvldAverageShelfLife";
        ...
        _methodName10 = "fetchIvldAverageShelfLife";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getIvldAverageShelfLife";
        ...
        _methodName13 = "getIvldAverageShelfLifes";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getIvldAverageShelfLifesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateIvldAverageShelfLife";
    ...
    public com.stpl.app.model.IvldAverageShelfLife addIvldAverageShelfLife(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(ivldAverageShelfLife)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.IvldAverageShelfLife) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.IvldAverageShelfLife createIvldAverageShelfLife(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ivldAverageShelfLifeSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.IvldAverageShelfLife> getIvldAverageShelfLifes(
        ...
        return (java.util.List<com.stpl.app.model.IvldAverageShelfLife>) ClpSerializer.translateOutput(returnObj);
    }
