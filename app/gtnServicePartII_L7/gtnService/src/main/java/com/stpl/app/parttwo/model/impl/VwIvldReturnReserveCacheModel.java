...
public class VwIvldReturnReserveCacheModel implements CacheModel<VwIvldReturnReserve>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof VwIvldReturnReserveCacheModel)) {
			return false;
		}

		VwIvldReturnReserveCacheModel vwIvldReturnReserveCacheModel = (VwIvldReturnReserveCacheModel)obj;

		if (ivldReturnReserveSid == vwIvldReturnReserveCacheModel.ivldReturnReserveSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldReturnReserveSid);
	}
