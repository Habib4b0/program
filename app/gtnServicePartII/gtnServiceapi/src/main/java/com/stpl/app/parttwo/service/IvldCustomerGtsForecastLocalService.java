...
/**
 * Provides the local service interface for IvldCustomerGtsForecast. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldCustomerGtsForecastLocalServiceUtil
...
public interface IvldCustomerGtsForecastLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldCustomerGtsForecastLocalServiceUtil} to access the ivld customer gts forecast local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.IvldCustomerGtsForecastLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
