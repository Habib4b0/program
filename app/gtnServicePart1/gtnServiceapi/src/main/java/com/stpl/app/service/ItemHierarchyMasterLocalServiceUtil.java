...
public class ItemHierarchyMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<ItemHierarchyMasterLocalService, ItemHierarchyMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ItemHierarchyMasterLocalService.class);
}