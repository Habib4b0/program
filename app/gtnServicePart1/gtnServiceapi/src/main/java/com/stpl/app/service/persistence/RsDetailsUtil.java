...
/**
 * The persistence utility for the rs details service. This utility wraps {@link com.stpl.app.service.persistence.impl.RsDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class RsDetailsUtil {
	...
	*/
	public static void cacheResult(RsDetails rsDetails) {
	...
	*/
	public static void cacheResult(List<RsDetails> rsDetailses) {
	...
	*/
	public static RsDetails create(int rsDetailsSid) {
	...
	*/
	public static RsDetails remove(int rsDetailsSid)
		throws com.stpl.app.exception.NoSuchRsDetailsException {
		return getPersistence().remove(rsDetailsSid);
	}

	public static RsDetails updateImpl(RsDetails rsDetails) {
	...
	* @throws NoSuchRsDetailsException if a rs details with the primary key could not be found
	*/
	public static RsDetails findByPrimaryKey(int rsDetailsSid)
		throws com.stpl.app.exception.NoSuchRsDetailsException {
	...
	*/
	public static RsDetails fetchByPrimaryKey(int rsDetailsSid) {
		return getPersistence().fetchByPrimaryKey(rsDetailsSid);
	}

	public static java.util.Map<java.io.Serializable, RsDetails> fetchByPrimaryKeys(
	...
	*/
	public static List<RsDetails> findAll() {
	...
	*/
	public static List<RsDetails> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<RsDetailsPersistence, RsDetailsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(RsDetailsPersistence.class);
}