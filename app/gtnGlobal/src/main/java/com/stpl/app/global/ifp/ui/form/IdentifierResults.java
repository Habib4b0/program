...
public final class IdentifierResults extends StplCustomComponent {
	 ...
	 *            the identifier results bean
	 */
	public IdentifierResults(final BeanItemContainer<ItemIrtIdentifierDTO> identifierResultsBean) throws SystemException, PortalException {
		super();
	...
	private GridLayout addToGrid() {
		...
		final GridLayout grid = new GridLayout(NumericConstants.SIX, NumericConstants.TWO);
	...
	public Button populateButton() {
		...
		btnPopulate.addClickListener(new ClickListener() {
			...
			public void buttonClick(final ClickEvent event) {
				LOGGER.debug("Entering IdentifierResults Populate Button");
				binder.getFields();
				...
				LOGGER.debug("Ending IdentifierResults Populate Button");
			}
		});
	...
	public void configureFields() throws SystemException, PortalException {
		...
		LOGGER.debug("In configureFields lodding-getNativeSelectForIdentifier");
