...
public class GtnUiFrameworkNsfEditActionTest {
	...
	public void testConfigureParams() throws Exception {
		...
		GtnUiFrameworkNsfEditAction fixture = new GtnUiFrameworkNsfEditAction();
	...
	public void testDoAction_else() throws Exception {
		...
		actionParemeterList.add("viewId");
		actionParemeterList.add("addViewId");
		actionParemeterList.add("notEdit");
