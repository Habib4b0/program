 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldInventoryWdActualMasModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldInventoryWdActualMasImpl}.
 * </p>
 *
 * @author
 * @see IvldInventoryWdActualMasImpl
 * @see IvldInventoryWdActualMas
 * @see IvldInventoryWdActualMasModel
 * @generated
 */
@ProviderType
public class IvldInventoryWdActualMasModelImpl extends BaseModelImpl<IvldInventoryWdActualMas>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("IVLD_INVENTORY_WD_ACTUAL_MAS_SID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("INVENTORY_WD_ACTUAL_MAS_INTF_ID", Types.INTEGER);
	...
	private static final ClassLoader _classLoader = IvldInventoryWdActualMas.class.getClassLoader();
