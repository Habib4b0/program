...
public abstract class IvldAccrualInboundLocalServiceBaseImpl
    ...
    private IvldAccrualInboundLocalServiceClpInvoker _clpInvoker = new IvldAccrualInboundLocalServiceClpInvoker();
    ...
    public IvldAccrualInbound deleteIvldAccrualInbound(
        int ivldAccrualInboundSid) throws PortalException, SystemException {
     ...
     */
    @Override
    public int getIvldAccrualInboundsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.IvldAccrualInbound",
