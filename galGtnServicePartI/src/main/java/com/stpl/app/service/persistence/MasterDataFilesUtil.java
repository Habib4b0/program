...
/**
 * The persistence utility for the master data files service. This utility wraps {@link MasterDataFilesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class MasterDataFilesUtil {
    private static MasterDataFilesPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.MasterDataFiles create(
    ...
    */
    public static com.stpl.app.model.MasterDataFiles remove(
        int masterDataFilesSid)
    ...
    public static com.stpl.app.model.MasterDataFiles updateImpl(
        com.stpl.app.model.MasterDataFiles masterDataFiles)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.MasterDataFiles findByPrimaryKey(
        int masterDataFilesSid)
        throws com.stpl.app.NoSuchMasterDataFilesException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.MasterDataFiles fetchByPrimaryKey(
        int masterDataFilesSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.MasterDataFiles> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static MasterDataFilesPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (MasterDataFilesPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    MasterDataFilesPersistence.class.getName());

            ReferenceRegistry.registerReference(MasterDataFilesUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(MasterDataFilesPersistence persistence) {
    }
}
