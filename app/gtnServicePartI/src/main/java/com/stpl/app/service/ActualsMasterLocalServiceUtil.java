...
public class ActualsMasterLocalServiceUtil {
    private static ActualsMasterLocalService _service;
    ...
    */
    ...
    public static ActualsMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ActualsMasterLocalService.class.getName());

            if (invokableLocalService instanceof ActualsMasterLocalService) {
                _service = (ActualsMasterLocalService) invokableLocalService;
            } else {
                _service = new ActualsMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ActualsMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ActualsMasterLocalService service) {
    }
}
