...
/**
 * Provides the local service interface for IvldDemandActual. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldDemandActualLocalServiceUtil
...
public interface IvldDemandActualLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldDemandActualLocalServiceUtil} to access the ivld demand actual local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldDemandActualLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
