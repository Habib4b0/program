...
/**
 * Provides the local service interface for NmDiscountProjection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see NmDiscountProjectionLocalServiceUtil
...
public interface NmDiscountProjectionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NmDiscountProjectionLocalServiceUtil} to access the nm discount projection local service. Add custom service methods to {@link com.stpl.app.service.impl.NmDiscountProjectionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
