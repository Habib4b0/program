...
import static com.stpl.app.galforecasting.dao.impl.DiscountProjectionForChannelsDAOImpl.DBDate;
...
public class DPQueryUtils {
    ...
    public String massUpdateQuery(Date startDate, Date endDate, int startYear, int endYear,
        ...
        customSql = fieldValuequery + val + " FROM ST_CH_PROJECTION_DISCOUNT DPT, \n"
                + "(SELECT M.PROJECTION_DETAILS_SID, DP.PERIOD_SID, RS.RS_MODEL_SID FROM ST_CH_DISCOUNT_PROJ_MASTER M, PROJECTION_DETAILS B,\n"
                + " ST_CH_PROJECTION_DISCOUNT DP, RS_MODEL RS, \"PERIOD\" P \n"
                + " WHERE  M.PROJECTION_DETAILS_SID = B.PROJECTION_DETAILS_SID \n"
    ...
    public String saveDiscountProjectionListView(Date startDate, int yearToSave, Date endDate, boolean isCustomHierarchy,
        ...
        String customSql = fieldValuequery + fieldValue + " FROM ST_CH_PROJECTION_DISCOUNT DPT, \n"
                + "(SELECT M.PROJECTION_DETAILS_SID, DP.PERIOD_SID , M.RS_MODEL_SID FROM ST_CH_DISCOUNT_PROJ_MASTER M, PROJECTION_DETAILS B,\n "
                + " ST_CH_PROJECTION_DISCOUNT DP, RS_MODEL RS, \"PERIOD\" P, \n" + ccpDetails
                + " WHERE  M.PROJECTION_DETAILS_SID = B.PROJECTION_DETAILS_SID \n"
                + " and M.USER_ID = " + userId + "\n"
                + " and M.SESSION_ID = " + sessionId + "\n"
    ...
    public String getCustomCCPDetailsQuery(String hierarchyIndicator, int projectionId, List<String> customViewDetails, boolean custom, String hierarchyNo) {
        ...
        final String customerHierarchyNo = customViewDetails.get(2);
    ...
    public String masterTableUpdateQuery(String baselinePeriods, int projectionId, int discountName, String selectedPeriods) {
        ...
        query.append(" JOIN  RS_MODEL RS ON RS.RS_MODEL_SID = DPM.RS_MODEL_SID");
        ...
        query.append(" AND A.RS_MODEL_SID = DM.RS_MODEL_SID");
        return query.toString();
    }
    ...
    public String discountProjectionTableUpdateQuery(String adjustmentType, String adjustmentBasis, String allocationMethodology, String adjustmentValue, int projectionId,
        ...
        query.append(" JOIN RS_MODEL RS ON DPM.RS_MODEL_SID = RS.RS_MODEL_SID ");
