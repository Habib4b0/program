...
import com.stpl.addons.windowheaderextension.client.WindowHeaderExtensionServerRpc;
import com.stpl.addons.windowheaderextension.client.WindowHeaderExtensionState;
...
public class WindowHeaderExtension extends AbstractExtension {
	 ...
	 */
	public static void extend(Window win, FontIcon icon, String tooltipText, WindowButtonClickListener clickListener) {
	 ...
	 *            WindowButtonClicklistener
	 */
	public static void extend(Window win, FontIcon icon, WindowButtonClickListener clickListener) {
