...
//        RebatePlanAddForm rebatePlanAddForm;
    /**
     ...
     * The level property.
     */
    private ObjectProperty levelProperty = new ObjectProperty(value, Integer.class);
     ...
     */
    public RebatePlanView(final SessionDTO sessionDTO) throws SystemException, PortalException, Exception {
        super();
    ...
    public void enter(final ViewChangeEvent event) {
        try {            
            ...
            if ((ConstantsUtils.VIEW).equals(sessionDTO.getMode())) {
                ...
                LOGGER.info("getRebatePlanMasterById method Initiated, systemId= " + systemId);
                ...
                if (rebatePlanTierResults != null && rebatePlanTierResults.lastItemId() != null && rebatePlanTierResults.lastItemId().getTierTo() != null) {
                    ...
                    rebatePlanMasterDTO.setTierFrom((tierToValue.add(BigDecimal.valueOf(0.01))).setScale(2, RoundingMode.HALF_UP).toPlainString());
                }
                value = rebatePlanTierResults.size() + 1;
                levelProperty = new ObjectProperty(value, Integer.class);
