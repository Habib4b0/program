...
public abstract class MProjectionSelectionLocalServiceBaseImpl
    ...
    private MProjectionSelectionLocalServiceClpInvoker _clpInvoker = new MProjectionSelectionLocalServiceClpInvoker();
    ...
    public MProjectionSelection deleteMProjectionSelection(
        int mProjectionSelectionSid) throws PortalException, SystemException {
    ...
    public MProjectionSelection fetchMProjectionSelection(
        int mProjectionSelectionSid) throws SystemException {
     ...
     */
    @Override
    public int getMProjectionSelectionsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.MProjectionSelection",
