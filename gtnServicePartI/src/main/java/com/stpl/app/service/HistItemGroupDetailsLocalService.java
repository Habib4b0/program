...
/**
 * Provides the local service interface for HistItemGroupDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see HistItemGroupDetailsLocalServiceUtil
...
public interface HistItemGroupDetailsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link HistItemGroupDetailsLocalServiceUtil} to access the hist item group details local service. Add custom service methods to {@link com.stpl.app.service.impl.HistItemGroupDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
