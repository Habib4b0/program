...
/**
 * The persistence utility for the ivld cpi service. This utility wraps {@link com.stpl.app.service.persistence.impl.IvldCpiPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class IvldCpiUtil {
	 ...
	 */
	public static IvldCpi update(IvldCpi ivldCpi) {
	...
	*/
	public static void cacheResult(IvldCpi ivldCpi) {
	...
	*/
	public static void cacheResult(List<IvldCpi> ivldCpis) {
	...
	*/
	public static IvldCpi create(int ivldCpiSid) {
	...
	*/
	public static IvldCpi remove(int ivldCpiSid)
		throws com.stpl.app.exception.NoSuchIvldCpiException {
		return getPersistence().remove(ivldCpiSid);
	}

	public static IvldCpi updateImpl(IvldCpi ivldCpi) {
	...
	* @throws NoSuchIvldCpiException if a ivld cpi with the primary key could not be found
	*/
	public static IvldCpi findByPrimaryKey(int ivldCpiSid)
		throws com.stpl.app.exception.NoSuchIvldCpiException {
	...
	*/
	public static IvldCpi fetchByPrimaryKey(int ivldCpiSid) {
		return getPersistence().fetchByPrimaryKey(ivldCpiSid);
	}

	public static java.util.Map<java.io.Serializable, IvldCpi> fetchByPrimaryKeys(
	...
	*/
	public static List<IvldCpi> findAll() {
	...
	*/
	public static List<IvldCpi> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IvldCpiPersistence, IvldCpiPersistence> _serviceTracker =
		ServiceTrackerFactory.open(IvldCpiPersistence.class);
}