...
import com.stpl.app.galforecasting.dto.AttachmentDTO;
...
public class AdditionalInfoLogic {
     ...
     * @throws Exception the exception
     */
    public String getNotes(final int projectionId, final String moduleName, final String userName, List wordList) throws SystemException, Exception {
