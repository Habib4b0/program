 ...
 * @author Nandhaa
 */
public class AccrualSalesChart {
     ...
     * The Constant LOGGER.
     */
    private static final Logger LOGGER = Logger.getLogger(AccrualSalesChart.class);
     ...
     */
    public AccrualSalesChart(int proId) {
        LOGGER.info("Entering AccrualSalesChart method ");
        this.proId=proId;
        this.projType=projType;
//        this.dto = dto;
//        this.rightDto = rightDto;
        LOGGER.info("End of AccrualSalesChart method ");
    }
    ...
    public Component getChart(int from, int to) {
        ...
        for (CommonLevelDto dto : salesRowList) {
            ...
            listSeries5 = new ListSeries();
            listSeries6 = new ListSeries();
            listSeries7 = new ListSeries();
            listSeries8 = new ListSeries();
            listSeries9 = new ListSeries();
            listSeries10 = new ListSeries();

            listSeries1.setName(rsName + " Actual Total Units");
            listSeries2.setName(rsName + " Actual Excluded Units");
            listSeries3.setName(rsName + " Actual NetUnits");
            listSeries4.setName(rsName + " Actual Price");
            listSeries5.setName(rsName + " Actual Sales");
            listSeries6.setName(rsName + " Projected Total Units");
            listSeries7.setName(rsName + " Projected Excluded Units");
            listSeries8.setName(rsName + " Projected NetUnits");
            listSeries9.setName(rsName + " Projected Price");
            listSeries10.setName(rsName + " Projected Sales");
            for (Object key : dto.getProperties().keySet()) {
                ...
                if (flag) {
                    ...
                    if (String.valueOf(key).contains("Actual Total Units")) {
                        listSeries1.addData(Double.valueOf(value.toString()));
//                        System.out.println("List1");

                    } else if (String.valueOf(key).contains("Actual Excluded Units")) {
                        listSeries2.addData(Double.valueOf(value.toString()));

                    } else if (String.valueOf(key).contains("Actual NetUnits")) {
                        listSeries3.addData(Double.valueOf(value.toString()));

                    } else if (String.valueOf(key).contains("Actual Price")) {
                        listSeries4.addData(Double.valueOf(value.toString()));

                    }else if (String.valueOf(key).contains("Actual Sales")) {
                        listSeries5.addData(Double.valueOf(value.toString()));

                    }else if (String.valueOf(key).contains("Projected Total Units")) {
                        listSeries6.addData(Double.valueOf(value.toString()));

                    }else if (String.valueOf(key).contains("Projected Excluded Units")) {
                        listSeries7.addData(Double.valueOf(value.toString()));

                    }else if (String.valueOf(key).contains("Projected NetUnits")) {
                        listSeries8.addData(Double.valueOf(value.toString()));

                    }else if (String.valueOf(key).contains("Projected Price")) {
                        listSeries9.addData(Double.valueOf(value.toString()));

                    }else if (String.valueOf(key).contains("Projected Sales")) {
                        listSeries10.addData(Double.valueOf(value.toString()));
...
//        tooltip.setPointFormat("$ {point.y:%.2f}");
    ...
    public Component configureFields() {
        ...
        List finalList = logic.getAccrualSalesData(proId);
