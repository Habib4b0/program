...
/**
 * The Class ExtTreeContainer.
 *
 * @author Abhiram
 * @param <BEANTYPE> the generic type
 */
public class ExtTreeContainer<BEANTYPE> extends BeanItemContainer<BEANTYPE> implements
        Hierarchical {
    ...
    /**
     * Instantiates a new ext tree container.
     *
     * @param type the type
