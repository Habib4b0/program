...
public class ExistingComponentDTO {
    ...
    String companyFamilyPlanId;
    String companyFamilyPlanNo;
    String companyFamilyPlanStatusValue;
    String companyFamilyPlanStartDate;
    String companyFamilyPlanEndDate;
    String itemFamilyplanId;
    String itemFamilyplanNo;
    String displayIFPStatus;
    String ifpStartDate;
    String ifpEndDate;
    String priceScheduleIdValue;
    String priceScheduleNoValue;
    String priceScheduleStatusValue;
    String priceScheduleStartDate;
    String priceScheduleEndDate;
    String itemFamilyplanName;
    String priceScheduleTypeValue;
    String priceScheduleCategoryValue;
    String priceScheduleDesignationValue;
    String rebateScheduleId;
    String rebateScheduleNo;
    String statusRebate;
    String itemRebateStartDate;
    String itemRebateEndDate;
    String ifpName;
    String paymentFrequency;
    String rebateProgramType;
    String interestBearingBasis;
