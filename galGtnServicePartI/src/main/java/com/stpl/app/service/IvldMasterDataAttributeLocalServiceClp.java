 ...
 * @generated
 */
public class IvldMasterDataAttributeLocalServiceClp
    ...
    public IvldMasterDataAttributeLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addIvldMasterDataAttribute";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.IvldMasterDataAttribute"
            };

        _methodName1 = "createIvldMasterDataAttribute";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteIvldMasterDataAttribute";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteIvldMasterDataAttribute";
        ...
        _methodName10 = "fetchIvldMasterDataAttribute";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getIvldMasterDataAttribute";
        ...
        _methodName13 = "getIvldMasterDataAttributes";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getIvldMasterDataAttributesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateIvldMasterDataAttribute";
    ...
    public com.stpl.app.model.IvldMasterDataAttribute addIvldMasterDataAttribute(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(ivldMasterDataAttribute)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.IvldMasterDataAttribute) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.IvldMasterDataAttribute createIvldMasterDataAttribute(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ivldMasterDataAtbteSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.IvldMasterDataAttribute> getIvldMasterDataAttributes(
        ...
        return (java.util.List<com.stpl.app.model.IvldMasterDataAttribute>) ClpSerializer.translateOutput(returnObj);
    }
