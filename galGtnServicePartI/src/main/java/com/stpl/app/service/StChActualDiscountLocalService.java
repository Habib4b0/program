...
/**
 * Provides the local service interface for StChActualDiscount. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StChActualDiscountLocalServiceUtil
...
public interface StChActualDiscountLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link StChActualDiscountLocalServiceUtil} to access the st ch actual discount local service. Add custom service methods to {@link com.stpl.app.service.impl.StChActualDiscountLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
