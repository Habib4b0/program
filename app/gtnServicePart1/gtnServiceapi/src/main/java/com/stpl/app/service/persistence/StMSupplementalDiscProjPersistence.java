...
public interface StMSupplementalDiscProjPersistence extends BasePersistence<StMSupplementalDiscProj> {
	...
	*/
	public void cacheResult(
		java.util.List<StMSupplementalDiscProj> stMSupplementalDiscProjs);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, StMSupplementalDiscProj> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<StMSupplementalDiscProj> findAll();
	...
	*/
	public java.util.List<StMSupplementalDiscProj> findAll(int start, int end);
	...
	*/
	public java.util.List<StMSupplementalDiscProj> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<StMSupplementalDiscProj> orderByComparator);
