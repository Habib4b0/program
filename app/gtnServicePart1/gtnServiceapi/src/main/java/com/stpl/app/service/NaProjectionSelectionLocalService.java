...
/**
 * Provides the local service interface for NaProjectionSelection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see NaProjectionSelectionLocalServiceUtil
...
public interface NaProjectionSelectionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NaProjectionSelectionLocalServiceUtil} to access the na projection selection local service. Add custom service methods to {@link com.stpl.app.service.impl.NaProjectionSelectionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public NaProjectionSelection addNaProjectionSelection(
	...
	*/
	public NaProjectionSelection createNaProjectionSelection(
	...
	*/
	...
	public NaProjectionSelection deleteNaProjectionSelection(
		int naProjectionSelectionSid) throws PortalException;
	...
	*/
	...
	public NaProjectionSelection fetchNaProjectionSelection(
		int naProjectionSelectionSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NaProjectionSelection getNaProjectionSelection(
		int naProjectionSelectionSid) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NaProjectionSelection> getNaProjectionSelections(int start,
		int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public NaProjectionSelection updateNaProjectionSelection(
		NaProjectionSelection naProjectionSelection);
}