...
import com.stpl.app.service.DeductionDetailsLocalService;
...
/**
 * Provides the base implementation for the deduction details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.DeductionDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class DeductionDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DeductionDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.DeductionDetailsLocalServiceUtil} to access the deduction details local service.
	 */
	...
	@Override
	public DeductionDetails addDeductionDetails(
		DeductionDetails deductionDetails) {
		deductionDetails.setNew(true);

		return deductionDetailsPersistence.update(deductionDetails);
	}
	 ...
	 */
	@Override
	public DeductionDetails createDeductionDetails(int deductionDetailsSid) {
		return deductionDetailsPersistence.create(deductionDetailsSid);
	}
	...
	@Override
	public DeductionDetails deleteDeductionDetails(int deductionDetailsSid)
		throws PortalException {
		return deductionDetailsPersistence.remove(deductionDetailsSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DeductionDetails deleteDeductionDetails(
		DeductionDetails deductionDetails) {
		return deductionDetailsPersistence.remove(deductionDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DeductionDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return deductionDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return deductionDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DeductionDetails fetchDeductionDetails(int deductionDetailsSid) {
		return deductionDetailsPersistence.fetchByPrimaryKey(deductionDetailsSid);
	}
	 ...
	 */
	@Override
	public DeductionDetails getDeductionDetails(int deductionDetailsSid)
		throws PortalException {
		return deductionDetailsPersistence.findByPrimaryKey(deductionDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(deductionDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DeductionDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("deductionDetailsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(deductionDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DeductionDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return deductionDetailsLocalService.deleteDeductionDetails((DeductionDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return deductionDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DeductionDetails> getDeductionDetailses(int start, int end) {
		return deductionDetailsPersistence.findAll(start, end);
	}
	...
	public int getDeductionDetailsesCount() {
		return deductionDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DeductionDetails updateDeductionDetails(
		DeductionDetails deductionDetails) {
		return deductionDetailsPersistence.update(deductionDetails);
	}
	 ...
	 */
	public DeductionDetailsLocalService getDeductionDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.DeductionDetails",
			deductionDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeductionDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = deductionDetailsPersistence.getDataSource();
	...
	@BeanReference(type = DeductionDetailsLocalService.class)
	protected DeductionDetailsLocalService deductionDetailsLocalService;
