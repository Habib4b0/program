...
public class GtnWsQueryService {
	...
	public List<Object[]> getSelectedCust() {
		...
		// + " FROM (VALUES
		// ('390-116.'),('390-116.222.'),('390-116.222.44.'),('390-116.222.60.'),('390-116.222.25.'),('390-116.222.24.'),('390-116.222.23.'),('390-116.222.22.'),('390-116.222.61.')\n"
		// +
	...
	public List<Object[]> getSelectedProd() {
		...
		// + " SELECT DISTINCT HIERARCHY_NO\n"
		// + " FROM (VALUES
		// ('403-94.'),('403-94.97.'),('403-94.97.145.'),('403-94.97.144.'),('403-94.97.143.'),('403-94.97.142.'),('403-94.97.141.'),('403-94.97.140.'),('403-94.97.139.'),\n"
		// +
	...
	public List<Object[]> getDeductionQueryList() {
		...
		results.add(new Object[] { "158", "6281", "6271", "6301", "12363", "12358", "12359", "12360", "12361", "12363",
				"RS_2" });
		results.add(new Object[] { "180", "6281", "6271", "6301", "12363", "12358", "12359", "12360", "12361", "12363",
				"RS_13" });
		results.add(new Object[] { "181", "6281", "6271", "6301", "12363", "12358", "12359", "12360", "12361", "12363",
				"RS_1" });
		results.add(new Object[] { "182", "6281", "6271", "6301", "12363", "12358", "12359", "12360", "12361", "12363",
				"RS_1" });
		results.add(new Object[] { "183", "6281", "6271", "6301", "12363", "12358", "12359", "12360", "12361", "12363",
				"RS_1" });
