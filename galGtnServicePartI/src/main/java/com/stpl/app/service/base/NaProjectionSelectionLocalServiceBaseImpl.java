...
public abstract class NaProjectionSelectionLocalServiceBaseImpl
    ...
    private NaProjectionSelectionLocalServiceClpInvoker _clpInvoker = new NaProjectionSelectionLocalServiceClpInvoker();
    ...
    public NaProjectionSelection deleteNaProjectionSelection(
        int naProjectionSelectionSid) throws PortalException, SystemException {
    ...
    public NaProjectionSelection fetchNaProjectionSelection(
        int naProjectionSelectionSid) throws SystemException {
     ...
     */
    @Override
    public int getNaProjectionSelectionsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.NaProjectionSelection",
