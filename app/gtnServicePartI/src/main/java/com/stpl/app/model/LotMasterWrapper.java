...
public class LotMasterWrapper implements LotMaster, ModelWrapper<LotMaster> {
    ...
    */
    @Override
    public java.util.Date getLastLotSoldDate() {
    ...
    */
    @Override
    public void setLastLotSoldDate(java.util.Date lastLotSoldDate) {
    ...
    */
    @Override
    public java.util.Date getLotExpirationDate() {
    ...
    */
    @Override
    public void setLotExpirationDate(java.util.Date lotExpirationDate) {
    ...
    */
    ...
    @Override
    public com.stpl.portal.model.CacheModel<LotMaster> toCacheModel() {
    ...
    public boolean equals(Object obj) {
        ...
        if (Validator.equals(_lotMaster, lotMasterWrapper._lotMaster)) {
            return true;
        }
     ...
     */
    public LotMaster getWrappedLotMaster() {
        return _lotMaster;
    }
