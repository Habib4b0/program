...
import com.stpl.app.parttwo.service.VwCustomerGtsForecastLocalService;
...
/**
 * Provides the base implementation for the vw customer gts forecast local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwCustomerGtsForecastLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwCustomerGtsForecastLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwCustomerGtsForecastLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VwCustomerGtsForecastLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VwCustomerGtsForecastLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwCustomerGtsForecastLocalServiceUtil} to access the vw customer gts forecast local service.
	 */
	...
	@Override
	public VwCustomerGtsForecast addVwCustomerGtsForecast(
		VwCustomerGtsForecast vwCustomerGtsForecast) {
		vwCustomerGtsForecast.setNew(true);

		return vwCustomerGtsForecastPersistence.update(vwCustomerGtsForecast);
	}
	 ...
	 */
	@Override
	public VwCustomerGtsForecast createVwCustomerGtsForecast(
		int customerGtsForecastSid) {
		return vwCustomerGtsForecastPersistence.create(customerGtsForecastSid);
	}
	...
	@Override
	public VwCustomerGtsForecast deleteVwCustomerGtsForecast(
		int customerGtsForecastSid) throws PortalException {
		return vwCustomerGtsForecastPersistence.remove(customerGtsForecastSid);
	}
	...
	public VwCustomerGtsForecast deleteVwCustomerGtsForecast(
		VwCustomerGtsForecast vwCustomerGtsForecast) {
		return vwCustomerGtsForecastPersistence.remove(vwCustomerGtsForecast);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VwCustomerGtsForecast.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vwCustomerGtsForecastPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vwCustomerGtsForecastPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VwCustomerGtsForecast fetchVwCustomerGtsForecast(
		int customerGtsForecastSid) {
		return vwCustomerGtsForecastPersistence.fetchByPrimaryKey(customerGtsForecastSid);
	}
	 ...
	 */
	@Override
	public VwCustomerGtsForecast getVwCustomerGtsForecast(
		int customerGtsForecastSid) throws PortalException {
		return vwCustomerGtsForecastPersistence.findByPrimaryKey(customerGtsForecastSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vwCustomerGtsForecastLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VwCustomerGtsForecast.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vwCustomerGtsForecastLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VwCustomerGtsForecast.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vwCustomerGtsForecastLocalService.deleteVwCustomerGtsForecast((VwCustomerGtsForecast)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vwCustomerGtsForecastPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VwCustomerGtsForecast> getVwCustomerGtsForecasts(int start,
		int end) {
		return vwCustomerGtsForecastPersistence.findAll(start, end);
	}
	...
	public int getVwCustomerGtsForecastsCount() {
		return vwCustomerGtsForecastPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VwCustomerGtsForecast updateVwCustomerGtsForecast(
		VwCustomerGtsForecast vwCustomerGtsForecast) {
		return vwCustomerGtsForecastPersistence.update(vwCustomerGtsForecast);
	}
	 ...
	 */
	public VwCustomerGtsForecastLocalService getVwCustomerGtsForecastLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.VwCustomerGtsForecast",
			vwCustomerGtsForecastLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.VwCustomerGtsForecast");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VwCustomerGtsForecastLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vwCustomerGtsForecastPersistence.getDataSource();
	...
	@BeanReference(type = VwCustomerGtsForecastLocalService.class)
	protected VwCustomerGtsForecastLocalService vwCustomerGtsForecastLocalService;
