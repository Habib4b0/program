...
public class CrossReferenceForm extends VerticalLayout {
    ...
    private void addTab() {
        ...
        crossRefTab.addTab(new CrossReferencePricing(), "Pricing", null, NumericConstants.TWO);
        crossRefTab.addTab(new CrossReferenceRebates(), "Rebate", null, NumericConstants.THREE);
    }
