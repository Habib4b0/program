...
public class CcpDetailsLocalServiceUtil {
    private static CcpDetailsLocalService _service;
    ...
    */
    ...
    public static CcpDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    CcpDetailsLocalService.class.getName());

            if (invokableLocalService instanceof CcpDetailsLocalService) {
                _service = (CcpDetailsLocalService) invokableLocalService;
            } else {
                _service = new CcpDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(CcpDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(CcpDetailsLocalService service) {
    }
}
