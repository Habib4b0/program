...
public class GtnWsRollingAverageTrendMethodologyTest {
	
	@Test
	public void testRollingAnnualTrendMethodology() {
	...
	/*
	 * RAT_ will be appended before PROJECTED_RETURN_AMOUNT and
	 * PROJECTED_RPU in the formula properties file.
	 * 
	 * Will be like RAT_PROJECTED_RETURN_AMOUNT and
	 * RAT_PROJECTED_RPU.
	 */
