...
public class StNmPpaProjectionUtil {
	...
	*/
	public static void cacheResult(StNmPpaProjection stNmPpaProjection) {
	...
	*/
	public static void cacheResult(List<StNmPpaProjection> stNmPpaProjections) {
	...
	*/
	public static StNmPpaProjection create(
	...
	*/
	public static StNmPpaProjection remove(
		StNmPpaProjectionPK stNmPpaProjectionPK)
		throws com.stpl.app.exception.NoSuchStNmPpaProjectionException {
		return getPersistence().remove(stNmPpaProjectionPK);
	}

	public static StNmPpaProjection updateImpl(
	...
	* @throws NoSuchStNmPpaProjectionException if a st nm ppa projection with the primary key could not be found
	*/
	public static StNmPpaProjection findByPrimaryKey(
		StNmPpaProjectionPK stNmPpaProjectionPK)
		throws com.stpl.app.exception.NoSuchStNmPpaProjectionException {
	...
	*/
	public static StNmPpaProjection fetchByPrimaryKey(
		StNmPpaProjectionPK stNmPpaProjectionPK) {
		return getPersistence().fetchByPrimaryKey(stNmPpaProjectionPK);
	}

	public static java.util.Map<java.io.Serializable, StNmPpaProjection> fetchByPrimaryKeys(
	...
	*/
	public static List<StNmPpaProjection> findAll() {
	...
	*/
	public static List<StNmPpaProjection> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<StNmPpaProjectionPersistence, StNmPpaProjectionPersistence> _serviceTracker =
		ServiceTrackerFactory.open(StNmPpaProjectionPersistence.class);
}