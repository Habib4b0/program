...
/**
 * Provides the local service interface for InventoryWdProjMas. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see InventoryWdProjMasLocalServiceUtil
...
public interface InventoryWdProjMasLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InventoryWdProjMasLocalServiceUtil} to access the inventory wd proj mas local service. Add custom service methods to {@link com.stpl.app.service.impl.InventoryWdProjMasLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
