 ...
 * @generated
 */
public class ProjectionCustDetailsLocalServiceClp
    ...
    public ProjectionCustDetailsLocalServiceClp(
    ...
    public com.stpl.app.model.ProjectionCustDetails addProjectionCustDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(projectionCustDetails)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ProjectionCustDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ProjectionCustDetails createProjectionCustDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { customerDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ProjectionCustDetails deleteProjectionCustDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { customerDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ProjectionCustDetails fetchProjectionCustDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { customerDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ProjectionCustDetails getProjectionCustDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { customerDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ProjectionCustDetails> getProjectionCustDetailses(
        ...
        return (java.util.List<com.stpl.app.model.ProjectionCustDetails>) ClpSerializer.translateOutput(returnObj);
    }
