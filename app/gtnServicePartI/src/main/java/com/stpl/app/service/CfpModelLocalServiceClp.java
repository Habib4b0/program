 ...
 * @generated
 */
public class CfpModelLocalServiceClp implements CfpModelLocalService {
    ...
    public CfpModelLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.stpl.app.model.CfpModel addCfpModel(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(cfpModel) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.CfpModel) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.CfpModel createCfpModel(int cfpModelSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { cfpModelSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.CfpModel deleteCfpModel(int cfpModelSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { cfpModelSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.CfpModel fetchCfpModel(int cfpModelSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { cfpModelSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.CfpModel getCfpModel(int cfpModelSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { cfpModelSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.CfpModel> getCfpModels(int start,
        ...
        return (java.util.List<com.stpl.app.model.CfpModel>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List findCfpModelV1(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(cfp),
                        
                    ClpSerializer.translateInput(orderByColumn),
                        
                    ClpSerializer.translateInput(sortOrder),
                        
                    ClpSerializer.translateInput(index),
                        
                    ClpSerializer.translateInput(next),
