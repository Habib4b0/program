package com.stpl.app.galforecasting.bpm.service;
...
public class BPMProcessBean {
    ...
    public static ProcessInstance startProcess(String processName, Map<String, Object> params) throws Exception {
    ...
    public static void startTask(Long taskId, String userId) throws Exception {
    ...
    public static void claimTask(Long taskId, String actualUserId, String targetUserId) throws Exception {
        TaskService taskService = BPMManagerBean.getEngine().getRuntimeEngine().getTaskService();
