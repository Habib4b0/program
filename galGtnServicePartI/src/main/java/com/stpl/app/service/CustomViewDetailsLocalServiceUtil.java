...
public class CustomViewDetailsLocalServiceUtil {
    private static CustomViewDetailsLocalService _service;
    ...
    */
    ...
    public static CustomViewDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    CustomViewDetailsLocalService.class.getName());

            if (invokableLocalService instanceof CustomViewDetailsLocalService) {
                _service = (CustomViewDetailsLocalService) invokableLocalService;
            } else {
                _service = new CustomViewDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(CustomViewDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(CustomViewDetailsLocalService service) {
    }
}
