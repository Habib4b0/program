 ...
 * @param <BEANTYPE>
 */
public class ExtTreeContainer<BEANTYPE> extends ExtContainer<BEANTYPE> implements
        Hierarchical {
    ...
    public ExtTreeContainer(Class<? super BEANTYPE> type, DataStructureMode dataStructure)
            throws IllegalArgumentException {
        super(type, dataStructure);
    }
...
//    }
     ...
     * have children. (
     * <code>canHaveChildren(newParentId) == true</code>). It is also possible
     * to detach a node from the hierarchy (and thus make it root) by setting
     * the parent
     * <code>null</code>.
     * </p>
     *
    ...
    private static Logger getLogger() {
        return Logger.getLogger(ExtTreeContainer.class.getName());
    }
