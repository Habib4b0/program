...
public class SummaryDTO implements Serializable {
    ...
    private String cfpValue = StringUtils.EMPTY;
    private String ifpValue = StringUtils.EMPTY;
    private String psValue = StringUtils.EMPTY;
    private String rsValue = StringUtils.EMPTY;
    ...
    public String getCfpValue() {
        return cfpValue;
    }

    public void setCfpValue(String cfpValue) {
        this.cfpValue = cfpValue;
    }

    public String getIfpValue() {
        return ifpValue;
    }

    public void setIfpValue(String ifpValue) {
        this.ifpValue = ifpValue;
    }
