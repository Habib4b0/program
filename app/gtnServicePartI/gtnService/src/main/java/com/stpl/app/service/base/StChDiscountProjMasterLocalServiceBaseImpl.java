...
import com.stpl.app.service.StChDiscountProjMasterLocalService;
...
/**
 * Provides the base implementation for the st ch discount proj master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.StChDiscountProjMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.StChDiscountProjMasterLocalServiceImpl
 * @see com.stpl.app.service.StChDiscountProjMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StChDiscountProjMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StChDiscountProjMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.StChDiscountProjMasterLocalServiceUtil} to access the st ch discount proj master local service.
	 */
	...
	@Override
	public StChDiscountProjMaster addStChDiscountProjMaster(
		StChDiscountProjMaster stChDiscountProjMaster) {
		stChDiscountProjMaster.setNew(true);

		return stChDiscountProjMasterPersistence.update(stChDiscountProjMaster);
	}
	 ...
	 */
	@Override
	public StChDiscountProjMaster createStChDiscountProjMaster(
		StChDiscountProjMasterPK stChDiscountProjMasterPK) {
		return stChDiscountProjMasterPersistence.create(stChDiscountProjMasterPK);
	}
	...
	@Override
	public StChDiscountProjMaster deleteStChDiscountProjMaster(
		StChDiscountProjMasterPK stChDiscountProjMasterPK)
		throws PortalException {
		return stChDiscountProjMasterPersistence.remove(stChDiscountProjMasterPK);
	}
	...
	public StChDiscountProjMaster deleteStChDiscountProjMaster(
		StChDiscountProjMaster stChDiscountProjMaster) {
		return stChDiscountProjMasterPersistence.remove(stChDiscountProjMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StChDiscountProjMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stChDiscountProjMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stChDiscountProjMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StChDiscountProjMaster fetchStChDiscountProjMaster(
		StChDiscountProjMasterPK stChDiscountProjMasterPK) {
		return stChDiscountProjMasterPersistence.fetchByPrimaryKey(stChDiscountProjMasterPK);
	}
	 ...
	 */
	@Override
	public StChDiscountProjMaster getStChDiscountProjMaster(
		StChDiscountProjMasterPK stChDiscountProjMasterPK)
		throws PortalException {
		return stChDiscountProjMasterPersistence.findByPrimaryKey(stChDiscountProjMasterPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stChDiscountProjMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StChDiscountProjMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(stChDiscountProjMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StChDiscountProjMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stChDiscountProjMasterLocalService.deleteStChDiscountProjMaster((StChDiscountProjMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stChDiscountProjMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StChDiscountProjMaster> getStChDiscountProjMasters(int start,
		int end) {
		return stChDiscountProjMasterPersistence.findAll(start, end);
	}
	...
	public int getStChDiscountProjMastersCount() {
		return stChDiscountProjMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StChDiscountProjMaster updateStChDiscountProjMaster(
		StChDiscountProjMaster stChDiscountProjMaster) {
		return stChDiscountProjMasterPersistence.update(stChDiscountProjMaster);
	}
	 ...
	 */
	public StChDiscountProjMasterLocalService getStChDiscountProjMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.StChDiscountProjMaster",
			stChDiscountProjMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.StChDiscountProjMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StChDiscountProjMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stChDiscountProjMasterPersistence.getDataSource();
	...
	@BeanReference(type = StChDiscountProjMasterLocalService.class)
	protected StChDiscountProjMasterLocalService stChDiscountProjMasterLocalService;
