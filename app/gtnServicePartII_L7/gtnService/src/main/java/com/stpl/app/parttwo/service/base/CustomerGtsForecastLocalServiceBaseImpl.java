...
import com.stpl.app.parttwo.service.CustomerGtsForecastLocalService;
...
/**
 * Provides the base implementation for the customer gts forecast local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.CustomerGtsForecastLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.CustomerGtsForecastLocalServiceImpl
 * @see com.stpl.app.parttwo.service.CustomerGtsForecastLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CustomerGtsForecastLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CustomerGtsForecastLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.CustomerGtsForecastLocalServiceUtil} to access the customer gts forecast local service.
	 */
	...
	@Override
	public CustomerGtsForecast addCustomerGtsForecast(
		CustomerGtsForecast customerGtsForecast) {
		customerGtsForecast.setNew(true);

		return customerGtsForecastPersistence.update(customerGtsForecast);
	}
	 ...
	 */
	@Override
	public CustomerGtsForecast createCustomerGtsForecast(
		int customerGtsForecastSid) {
		return customerGtsForecastPersistence.create(customerGtsForecastSid);
	}
	...
	@Override
	public CustomerGtsForecast deleteCustomerGtsForecast(
		int customerGtsForecastSid) throws PortalException {
		return customerGtsForecastPersistence.remove(customerGtsForecastSid);
	}
	...
	public CustomerGtsForecast deleteCustomerGtsForecast(
		CustomerGtsForecast customerGtsForecast) {
		return customerGtsForecastPersistence.remove(customerGtsForecast);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CustomerGtsForecast.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return customerGtsForecastPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return customerGtsForecastPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CustomerGtsForecast fetchCustomerGtsForecast(
		int customerGtsForecastSid) {
		return customerGtsForecastPersistence.fetchByPrimaryKey(customerGtsForecastSid);
	}
	 ...
	 */
	@Override
	public CustomerGtsForecast getCustomerGtsForecast(
		int customerGtsForecastSid) throws PortalException {
		return customerGtsForecastPersistence.findByPrimaryKey(customerGtsForecastSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(customerGtsForecastLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CustomerGtsForecast.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(customerGtsForecastLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CustomerGtsForecast.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return customerGtsForecastLocalService.deleteCustomerGtsForecast((CustomerGtsForecast)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return customerGtsForecastPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomerGtsForecast> getCustomerGtsForecasts(int start, int end) {
		return customerGtsForecastPersistence.findAll(start, end);
	}
	...
	public int getCustomerGtsForecastsCount() {
		return customerGtsForecastPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomerGtsForecast updateCustomerGtsForecast(
		CustomerGtsForecast customerGtsForecast) {
		return customerGtsForecastPersistence.update(customerGtsForecast);
	}
	 ...
	 */
	public CustomerGtsForecastLocalService getCustomerGtsForecastLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.CustomerGtsForecast",
			customerGtsForecastLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CustomerGtsForecastLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = customerGtsForecastPersistence.getDataSource();
	...
	@BeanReference(type = CustomerGtsForecastLocalService.class)
	protected CustomerGtsForecastLocalService customerGtsForecastLocalService;
