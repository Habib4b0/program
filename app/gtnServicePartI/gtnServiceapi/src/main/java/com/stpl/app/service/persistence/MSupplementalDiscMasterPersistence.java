...
public interface MSupplementalDiscMasterPersistence extends BasePersistence<MSupplementalDiscMaster> {
	...
	*/
	public void cacheResult(
		java.util.List<MSupplementalDiscMaster> mSupplementalDiscMasters);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, MSupplementalDiscMaster> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<MSupplementalDiscMaster> findAll();
	...
	*/
	public java.util.List<MSupplementalDiscMaster> findAll(int start, int end);
	...
	*/
	public java.util.List<MSupplementalDiscMaster> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MSupplementalDiscMaster> orderByComparator);
