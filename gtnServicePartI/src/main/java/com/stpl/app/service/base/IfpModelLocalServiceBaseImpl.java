...
public abstract class IfpModelLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements IfpModelLocalService, IdentifiableBean {
    ...
    private IfpModelLocalServiceClpInvoker _clpInvoker = new IfpModelLocalServiceClpInvoker();
    ...
    @Override
    public IfpModel addIfpModel(IfpModel ifpModel) throws SystemException {
    ...
    @Override
    public IfpModel deleteIfpModel(int ifpModelSid)
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public IfpModel deleteIfpModel(IfpModel ifpModel) throws SystemException {
    ...
    @Override
    public IfpModel fetchIfpModel(int ifpModelSid) throws SystemException {
     ...
     */
    @Override
    public IfpModel getIfpModel(int ifpModelSid)
        throws PortalException, SystemException {
     ...
     */
    @Override
    public int getIfpModelsCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IfpModel updateIfpModel(IfpModel ifpModel) throws SystemException {
        return ifpModelPersistence.update(ifpModel);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.IfpModel",
