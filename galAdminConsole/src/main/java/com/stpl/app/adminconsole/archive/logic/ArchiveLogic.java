...
public class ArchiveLogic {
     ...
     */
    public List<ArchiveDTO> getTableName(final String tableName) throws SystemException, Exception {
        LOGGER.info("getTableName started with P1:String tableName=" + tableName);
     ...
     * @throws Exception the exception
     */
    public List<ArchiveDTO> getLevelValues(final String tableName, final String fieldName) throws SystemException, Exception {
