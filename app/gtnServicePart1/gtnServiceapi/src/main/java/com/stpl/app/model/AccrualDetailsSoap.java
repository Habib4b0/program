...
public class AccrualDetailsSoap implements Serializable {
	public static AccrualDetailsSoap toSoapModel(AccrualDetails model) {
		...
		soapModel.setCompanyStringIdentifierCodeQualifier(model.getCompanyStringIdentifierCodeQualifier());
	...
	public String getCompanyStringIdentifierCodeQualifier() {
		return _companyStringIdentifierCodeQualifier;
	}

	public void setCompanyStringIdentifierCodeQualifier(
		String companyStringIdentifierCodeQualifier) {
		_companyStringIdentifierCodeQualifier = companyStringIdentifierCodeQualifier;
	}
	...
	private String _companyStringIdentifierCodeQualifier;
