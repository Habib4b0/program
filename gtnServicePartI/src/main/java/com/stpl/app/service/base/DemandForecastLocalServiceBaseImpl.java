...
import com.stpl.app.service.DemandForecastLocalService;
...
/**
 * Provides the base implementation for the demand forecast local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.DemandForecastLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.DemandForecastLocalServiceImpl
 * @see com.stpl.app.service.DemandForecastLocalServiceUtil
 * @generated
 */
public abstract class DemandForecastLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements DemandForecastLocalService,
        IdentifiableBean {
    ...
    private DemandForecastLocalServiceClpInvoker _clpInvoker = new DemandForecastLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.DemandForecastLocalServiceUtil} to access the demand forecast local service.
     */
    ...
    @Override
    public DemandForecast addDemandForecast(DemandForecast demandForecast)
        throws SystemException {
        demandForecast.setNew(true);

        return demandForecastPersistence.update(demandForecast);
    }
     ...
     */
    @Override
    public DemandForecast createDemandForecast(int demandForecastSid) {
        return demandForecastPersistence.create(demandForecastSid);
    }
    ...
    @Override
    public DemandForecast deleteDemandForecast(int demandForecastSid)
        throws PortalException, SystemException {
        return demandForecastPersistence.remove(demandForecastSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public DemandForecast deleteDemandForecast(DemandForecast demandForecast)
        throws SystemException {
        return demandForecastPersistence.remove(demandForecast);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(DemandForecast.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return demandForecastPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return demandForecastPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public DemandForecast fetchDemandForecast(int demandForecastSid)
        throws SystemException {
        return demandForecastPersistence.fetchByPrimaryKey(demandForecastSid);
    }
     ...
     */
    @Override
    public DemandForecast getDemandForecast(int demandForecastSid)
        throws PortalException, SystemException {
        return demandForecastPersistence.findByPrimaryKey(demandForecastSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return demandForecastPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<DemandForecast> getDemandForecasts(int start, int end)
        throws SystemException {
        return demandForecastPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getDemandForecastsCount() throws SystemException {
        return demandForecastPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public DemandForecast updateDemandForecast(DemandForecast demandForecast)
        throws SystemException {
        return demandForecastPersistence.update(demandForecast);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.DemandForecast",
            demandForecastLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.DemandForecast");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = demandForecastPersistence.getDataSource();
