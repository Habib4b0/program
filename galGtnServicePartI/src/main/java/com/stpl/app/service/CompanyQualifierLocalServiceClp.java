 ...
 * @generated
 */
public class CompanyQualifierLocalServiceClp
    ...
    public CompanyQualifierLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addCompanyQualifier";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.CompanyQualifier"
            };

        _methodName1 = "createCompanyQualifier";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteCompanyQualifier";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteCompanyQualifier";
        ...
        _methodName10 = "fetchCompanyQualifier";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getCompanyQualifier";
        ...
        _methodName13 = "getCompanyQualifiers";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getCompanyQualifiersCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateCompanyQualifier";
        ...
        _methodName19 = "findByCompanyCrtQualifierByName";
    ...
    public com.stpl.app.model.CompanyQualifier addCompanyQualifier(
        ...
        return (com.stpl.app.model.CompanyQualifier) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.CompanyQualifier createCompanyQualifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { companyQualifierSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.CompanyQualifier deleteCompanyQualifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { companyQualifierSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.CompanyQualifier fetchCompanyQualifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    ...
                    new Object[] { companyQualifierSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.CompanyQualifier> getCompanyQualifiers(
        ...
        return (java.util.List<com.stpl.app.model.CompanyQualifier>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.CompanyQualifier findByCompanyCrtQualifierByName(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(companyQualifierName)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

            if (t instanceof com.stpl.app.NoSuchCompanyQualifierException) {
                throw (com.stpl.app.NoSuchCompanyQualifierException) t;
            }
