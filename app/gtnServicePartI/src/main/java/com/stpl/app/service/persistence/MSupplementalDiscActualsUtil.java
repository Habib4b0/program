...
/**
 * The persistence utility for the m supplemental disc actuals service. This utility wraps {@link MSupplementalDiscActualsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class MSupplementalDiscActualsUtil {
    private static MSupplementalDiscActualsPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.MSupplementalDiscActuals create(
    ...
    */
    public static com.stpl.app.model.MSupplementalDiscActuals remove(
        MSupplementalDiscActualsPK mSupplementalDiscActualsPK)
    ...
    public static com.stpl.app.model.MSupplementalDiscActuals updateImpl(
        com.stpl.app.model.MSupplementalDiscActuals mSupplementalDiscActuals)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.MSupplementalDiscActuals findByPrimaryKey(
        MSupplementalDiscActualsPK mSupplementalDiscActualsPK)
        throws com.stpl.app.NoSuchMSupplementalDiscActualsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.MSupplementalDiscActuals fetchByPrimaryKey(
        MSupplementalDiscActualsPK mSupplementalDiscActualsPK)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.MSupplementalDiscActuals> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static MSupplementalDiscActualsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (MSupplementalDiscActualsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    MSupplementalDiscActualsPersistence.class.getName());

            ReferenceRegistry.registerReference(MSupplementalDiscActualsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(MSupplementalDiscActualsPersistence persistence) {
    }
}
