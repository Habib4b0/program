...
import com.stpl.app.parttwo.service.AhTempDetailsLocalService;
...
/**
 * Provides the base implementation for the ah temp details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.AhTempDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.AhTempDetailsLocalServiceImpl
 * @see com.stpl.app.parttwo.service.AhTempDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AhTempDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AhTempDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.AhTempDetailsLocalServiceUtil} to access the ah temp details local service.
	 */
	...
	@Override
	public AhTempDetails addAhTempDetails(AhTempDetails ahTempDetails) {
		ahTempDetails.setNew(true);

		return ahTempDetailsPersistence.update(ahTempDetails);
	}
	 ...
	 */
	@Override
	public AhTempDetails createAhTempDetails(int componentMasterSid) {
		return ahTempDetailsPersistence.create(componentMasterSid);
	}
	...
	@Override
	public AhTempDetails deleteAhTempDetails(int componentMasterSid)
		throws PortalException {
		return ahTempDetailsPersistence.remove(componentMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AhTempDetails deleteAhTempDetails(AhTempDetails ahTempDetails) {
		return ahTempDetailsPersistence.remove(ahTempDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AhTempDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ahTempDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ahTempDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AhTempDetails fetchAhTempDetails(int componentMasterSid) {
		return ahTempDetailsPersistence.fetchByPrimaryKey(componentMasterSid);
	}
	 ...
	 */
	@Override
	public AhTempDetails getAhTempDetails(int componentMasterSid)
		throws PortalException {
		return ahTempDetailsPersistence.findByPrimaryKey(componentMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ahTempDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AhTempDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("componentMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ahTempDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AhTempDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ahTempDetailsLocalService.deleteAhTempDetails((AhTempDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ahTempDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AhTempDetails> getAhTempDetailses(int start, int end) {
		return ahTempDetailsPersistence.findAll(start, end);
	}
	...
	public int getAhTempDetailsesCount() {
		return ahTempDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AhTempDetails updateAhTempDetails(AhTempDetails ahTempDetails) {
		return ahTempDetailsPersistence.update(ahTempDetails);
	}
	 ...
	 */
	public AhTempDetailsLocalService getAhTempDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.AhTempDetails",
			ahTempDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.AhTempDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AhTempDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ahTempDetailsPersistence.getDataSource();
	...
	@BeanReference(type = AhTempDetailsLocalService.class)
	protected AhTempDetailsLocalService ahTempDetailsLocalService;
