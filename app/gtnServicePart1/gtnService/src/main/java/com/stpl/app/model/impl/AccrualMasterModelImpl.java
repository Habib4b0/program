 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link AccrualMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AccrualMasterImpl}.
 * </p>
 *
 * @author
...
public class AccrualMasterModelImpl extends BaseModelImpl<AccrualMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ACCT_IDENT_CODE_QUALIFIER", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("COMP_IDENT_CODE_QUALIFIER", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ITEM_IDENT_CODE_QUALIFIER", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("GL_AMOUNT", Types.DOUBLE);
	...
	public Object clone() {
		...
		accrualMasterImpl.setCompanyStringId(getCompanyStringId());
	...
	public CacheModel<AccrualMaster> toCacheModel() {
		...
		accrualMasterCacheModel.companyStringId = getCompanyStringId();

		String companyStringId = accrualMasterCacheModel.companyStringId;

		if ((companyStringId != null) && (companyStringId.length() == 0)) {
			accrualMasterCacheModel.companyStringId = null;
		}
	...
	private static final ClassLoader _classLoader = AccrualMaster.class.getClassLoader();
