...
/**
 * Provides the local service interface for CustomViewMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CustomViewMasterLocalServiceUtil
...
public interface CustomViewMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomViewMasterLocalServiceUtil} to access the custom view master local service. Add custom service methods to {@link com.stpl.app.service.impl.CustomViewMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
