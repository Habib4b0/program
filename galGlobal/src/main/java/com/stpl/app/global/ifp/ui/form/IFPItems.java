...
CommonSecurityLogic commonSecurityLogic = new CommonSecurityLogic();
    ...
    public IFPItems(final ErrorfulFieldGroup binder, final SessionDTO sessionDTO) throws Exception {
        this.binder = binder;
    ...
    public void addBtnPopulate() {
        ...
        btnPopulate.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("Entering inside IFPTabsheetForm POPULATE  method ");
                ...
                try {
                    ...
                    if (massUpdate) {
                        ...
                        /* boolean pass = false;
                         ...
                         if(!pass){
                         binder.getErrorDisplay().setError("Select a row to populate");
                         }*/
                        ...
                        LOGGER.info("Ending Mass update operation");
                    }
                    LOGGER.info("Ending IFPTabsheetForm POPULATE  method ");
    ...
    public void addAllPopulate() {
        ...
        btnAllPopulate.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                try {
                    LOGGER.info("Entering inside IFPTabsheetForm POPULATE_ALL  method ");
                    binder.getErrorDisplay().clearError();
                    boolean massUpdate;
                    if (massField.getValue() == null) {
                        final MessageBox msg = MessageBox.showPlain(Icon.INFO, "Info", "Select Field", new MessageBoxListener() {
                    ...
                    LOGGER.info("Ending IFPTabsheetForm POPULATE_ALL  method ");
                } catch (PortalException ex) {
                    LOGGER.error(ex);
                } catch (SystemException ex) {
                    LOGGER.error(ex);
    ...
    */
    void ItemsPerPageRefreshing() {
        itemDetailsTable.setItemsPerPage(10);
        itemDetailsTable.setItemsPerPage(7);
    }
...
//        ResponsiveUtils.getResponsiveControls(viewResultsTable.createControls(), pageCreater);
    ...
    private void setDefaultTableWidth(final CustomePagedFilterTable table) {
    ...
    public void createWorkSheetContent(final Integer start, final Integer end, final PrintWriter printWriter) throws PortalException, SystemException {
        ...
        if (itemDetailsTable.size() > 0) {
            ...
            if (mode.equals(ConstantsUtils.VIEW_BTN)) {
                ...
                items = ifpLogic.getCoustomizedResult(returnList, binder);
            }
