...
/**
 * Provides the local service interface for VwIvldInventoryWdActualProjMas. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see VwIvldInventoryWdActualProjMasLocalServiceUtil
...
public interface VwIvldInventoryWdActualProjMasLocalService
    extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link VwIvldInventoryWdActualProjMasLocalServiceUtil} to access the vw ivld inventory wd actual proj mas local service. Add custom service methods to {@link com.stpl.app.service.impl.VwIvldInventoryWdActualProjMasLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
