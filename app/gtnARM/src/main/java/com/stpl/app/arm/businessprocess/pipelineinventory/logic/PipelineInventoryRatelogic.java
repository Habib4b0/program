    ...
    protected List getQueryInput(AdjustmentDTO parentDTO, AbstractSelectionDTO selection, List input, String queryName) {
        switch (parentDTO.getLevelName()) {
            ...
            case VariableConstants.CUSTOMER_UPPERCASE:
                ...
                if ((CommonConstant.CUSTOMERCONTRACTVIEW.equals(queryName) || CommonConstant.CUSTOMERCONTRACTEDIT.equals(queryName)) && !ARMConstants.getDeductionContractCustomer().equals(selection.getRateDeductionView())) {
                    input.add("%");
                } else {
