...
public class SalesMasterCacheModel implements CacheModel<SalesMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof SalesMasterCacheModel)) {
			return false;
		}

		SalesMasterCacheModel salesMasterCacheModel = (SalesMasterCacheModel)obj;

		if (salesMasterSid == salesMasterCacheModel.salesMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, salesMasterSid);
	}
	...
	public SalesMaster toEntityModel() {
		...
		if (companyStringId == null) {
			salesMasterImpl.setCompanyStringId(StringPool.BLANK);
		}
		else {
			salesMasterImpl.setCompanyStringId(companyStringId);
		}
