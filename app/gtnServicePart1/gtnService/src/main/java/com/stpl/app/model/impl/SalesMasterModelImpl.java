 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link SalesMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link SalesMasterImpl}.
 * </p>
 *
 * @author
 * @see SalesMasterImpl
...
public class SalesMasterModelImpl extends BaseModelImpl<SalesMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("RECORD_SEQUENCE", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("SALES_MASTER_SID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("ITEM_CODE_QUALIFIER", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("PROVISION_ID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("ITEM_PARENT_NO", Types.VARCHAR);
	...
	public static final long COMPANYSTRINGID_COLUMN_BITMASK = 4L;
	public static final long CONTRACTID_COLUMN_BITMASK = 8L;
	public static final long CONTRACTNO_COLUMN_BITMASK = 16L;
	public static final long ITEMID_COLUMN_BITMASK = 32L;
	public static final long ITEMNO_COLUMN_BITMASK = 64L;
	public static final long SALESID_COLUMN_BITMASK = 128L;
	public static final long SALESMASTERSID_COLUMN_BITMASK = 256L;
	...
	public Object clone() {
		...
		salesMasterImpl.setCompanyStringId(getCompanyStringId());
	...
	public void resetOriginalValues() {
		...
		salesMasterModelImpl._originalCompanyStringId = salesMasterModelImpl._companyStringId;
	...
	public CacheModel<SalesMaster> toCacheModel() {
		...
		salesMasterCacheModel.companyStringId = getCompanyStringId();

		String companyStringId = salesMasterCacheModel.companyStringId;

		if ((companyStringId != null) && (companyStringId.length() == 0)) {
			salesMasterCacheModel.companyStringId = null;
		}
	...
	private static final ClassLoader _classLoader = SalesMaster.class.getClassLoader();
