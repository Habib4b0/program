...
import com.stpl.app.service.CustomViewMasterLocalService;
...
/**
 * Provides the base implementation for the custom view master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CustomViewMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class CustomViewMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CustomViewMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CustomViewMasterLocalServiceUtil} to access the custom view master local service.
	 */
	...
	@Override
	public CustomViewMaster addCustomViewMaster(
		CustomViewMaster customViewMaster) {
		customViewMaster.setNew(true);

		return customViewMasterPersistence.update(customViewMaster);
	}
	 ...
	 */
	@Override
	public CustomViewMaster createCustomViewMaster(int customViewMasterSid) {
		return customViewMasterPersistence.create(customViewMasterSid);
	}
	...
	@Override
	public CustomViewMaster deleteCustomViewMaster(int customViewMasterSid)
		throws PortalException {
		return customViewMasterPersistence.remove(customViewMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CustomViewMaster deleteCustomViewMaster(
		CustomViewMaster customViewMaster) {
		return customViewMasterPersistence.remove(customViewMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CustomViewMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return customViewMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return customViewMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CustomViewMaster fetchCustomViewMaster(int customViewMasterSid) {
		return customViewMasterPersistence.fetchByPrimaryKey(customViewMasterSid);
	}
	 ...
	 */
	@Override
	public CustomViewMaster getCustomViewMaster(int customViewMasterSid)
		throws PortalException {
		return customViewMasterPersistence.findByPrimaryKey(customViewMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(customViewMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CustomViewMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("customViewMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(customViewMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CustomViewMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return customViewMasterLocalService.deleteCustomViewMaster((CustomViewMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return customViewMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CustomViewMaster> getCustomViewMasters(int start, int end) {
		return customViewMasterPersistence.findAll(start, end);
	}
	...
	public int getCustomViewMastersCount() {
		return customViewMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CustomViewMaster updateCustomViewMaster(
		CustomViewMaster customViewMaster) {
		return customViewMasterPersistence.update(customViewMaster);
	}
	 ...
	 */
	public CustomViewMasterLocalService getCustomViewMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.CustomViewMaster",
			customViewMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.CustomViewMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CustomViewMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = customViewMasterPersistence.getDataSource();
	...
	@BeanReference(type = CustomViewMasterLocalService.class)
	protected CustomViewMasterLocalService customViewMasterLocalService;
