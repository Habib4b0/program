...
public class StNmAssumptionsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<StNmAssumptionsLocalService, StNmAssumptionsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(StNmAssumptionsLocalService.class);
}