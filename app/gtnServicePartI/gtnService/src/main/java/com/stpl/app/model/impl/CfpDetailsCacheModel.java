...
public class CfpDetailsCacheModel implements CacheModel<CfpDetails>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CfpDetailsCacheModel)) {
			return false;
		}

		CfpDetailsCacheModel cfpDetailsCacheModel = (CfpDetailsCacheModel)obj;

		if (cfpDetailsSid == cfpDetailsCacheModel.cfpDetailsSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, cfpDetailsSid);
	}
