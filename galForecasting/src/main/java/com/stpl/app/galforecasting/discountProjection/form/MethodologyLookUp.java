...
public class MethodologyLookUp extends Window {
     ...
     * @throws Exception
     */
    public MethodologyLookUp() throws Exception {
    ...
    private void configureTable() throws SystemException {
        ...
        resultsTable.setColumnWidth("formulaName", 434);
    ...
    public void searchLogic() {
        try {
            ...
            SupplementalDiscountProjectionLogic projectionLogic = new SupplementalDiscountProjectionLogic();
            resultList = (List<FormulaDTO>) projectionLogic.loadFormula();
