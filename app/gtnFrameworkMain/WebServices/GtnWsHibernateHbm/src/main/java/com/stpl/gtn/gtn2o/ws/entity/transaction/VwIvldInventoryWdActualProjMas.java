...
public class VwIvldInventoryWdActualProjMas implements java.io.Serializable {

	private int ivldInventoryWdActualProjMasSid;
	private String inventoryWdActualProjMasIntfId;
	...
	public int getIvldInventoryWdActualProjMasSid() {
		return ivldInventoryWdActualProjMasSid;
	}

	public void setIvldInventoryWdActualProjMasSid(int ivldInventoryWdActualProjMasSid) {
		this.ivldInventoryWdActualProjMasSid = ivldInventoryWdActualProjMasSid;
	}

	public String getInventoryWdActualProjMasIntfId() {
		return inventoryWdActualProjMasIntfId;
	}

	public void setInventoryWdActualProjMasIntfId(String inventoryWdActualProjMasIntfId) {
		this.inventoryWdActualProjMasIntfId = inventoryWdActualProjMasIntfId;
	}
