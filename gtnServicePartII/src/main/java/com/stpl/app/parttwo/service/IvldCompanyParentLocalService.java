...
/**
 * Provides the local service interface for IvldCompanyParent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldCompanyParentLocalServiceUtil
...
public interface IvldCompanyParentLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IvldCompanyParentLocalServiceUtil} to access the ivld company parent local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.IvldCompanyParentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
