...
public class PsContractDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<PsContractDetailsLocalService, PsContractDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(PsContractDetailsLocalService.class);
}