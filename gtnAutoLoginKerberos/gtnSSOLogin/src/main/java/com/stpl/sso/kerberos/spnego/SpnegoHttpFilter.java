 ...
 * href="http://en.wikipedia.org/wiki/SPNEGO" target="_blank">SPNEGO</a>
 ...
 *
 * <p>
 * <b>Modifying the web.xml file</b></p>
 *
 * <p>
 ...
 *
 * <p>
 * <b>Example usage on web page</b></p>
 *
 * <p>
 * <
...
//        initiateSystemPropertiesManually();
        StplSpnegoConfigReader reader = StplSpnegoConfigReader.getInstance();
        try {
    ...
    public SpnegoPrincipal getPrincipal(final ServletRequest request, final ServletResponse response) throws IOException, ServletException {
        init(null);
    ...
    public static final class Constants {
         ...
         * http://127.0.0.1 should not be authenticated using Kerberos.</p>
         *
         * <p>
         ...
         * reject connections that do not use SSL/TLS.</p>
         */
         ...
         *
         * <p>
         * The LoginModule name that exists in the login.conf file.</p>
         */
         ...
         * <code>%WINDOWS_ROOT%/krb5.ini</code> here.</p>
         *
         * <p>
         ...
         *
         * <p>
         * Example: <code>Logger.getLogger(Constants.LOGGER_NAME)</code></p>
         */
         ...
         * of "Basic" (if allowed by the web.xml file).</p>
         */
