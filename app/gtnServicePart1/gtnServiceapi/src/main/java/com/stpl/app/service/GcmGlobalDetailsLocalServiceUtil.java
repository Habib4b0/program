...
public class GcmGlobalDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<GcmGlobalDetailsLocalService, GcmGlobalDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(GcmGlobalDetailsLocalService.class);
}