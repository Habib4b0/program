...
public class AdditionalNotesUtil {
    private static AdditionalNotesPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.AdditionalNotes create(
    ...
    */
    public static com.stpl.app.model.AdditionalNotes remove(
        int additionalNotesId)
    ...
    public static com.stpl.app.model.AdditionalNotes updateImpl(
        com.stpl.app.model.AdditionalNotes additionalNotes)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.AdditionalNotes findByPrimaryKey(
        int additionalNotesId)
        throws com.stpl.app.NoSuchAdditionalNotesException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.AdditionalNotes fetchByPrimaryKey(
        int additionalNotesId)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.AdditionalNotes> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static AdditionalNotesPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (AdditionalNotesPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    AdditionalNotesPersistence.class.getName());

            ReferenceRegistry.registerReference(AdditionalNotesUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(AdditionalNotesPersistence persistence) {
    }
}
