...
public class BaseRateCalculation extends CustomComponent implements View {
    ...
    private CustomTreeContainer<TreeDTO> availTreeContainer = new CustomTreeContainer<TreeDTO>(TreeDTO.class);
    private CustomTreeContainer<TreeDTO> selTreeContainer = new CustomTreeContainer<TreeDTO>(TreeDTO.class);
    ...
    private CustomTreeContainer<TreeDTO> selectedBean = new CustomTreeContainer<TreeDTO>(TreeDTO.class);
    ...
    /* The Excel container */
    CustomTreeContainer<BaseRateDTO> excelContainer = new CustomTreeContainer<BaseRateDTO>(BaseRateDTO.class);
    ...
    public void configureSelTable() {
        if (!lookUpFlag) {
            ...
            selectedBean
                    = new CustomTreeContainer<TreeDTO>(TreeDTO.class
                    );
    ...
    public void excelBtnClick(Button.ClickEvent event) {
        try {
            ...
            excelContainer
                    = new CustomTreeContainer<BaseRateDTO>(BaseRateDTO.class
                    );
            CustomTableHeaderDTO excelHeader = new CustomTableHeaderDTO();
            doubleHeaderList = DataSelectionUtil.configureTimeDdlb(fromDateDdlb, toDateDdlb, session.getDsFromDate(), session.getDsToDate(), StringUtils.EMPTY, "DS", String.valueOf(frequency.getValue()));
            final String timePeriodFrom = String.valueOf(fromDateDdlb.getValue());
    ...
    public void graphBtnClick(Button.ClickEvent event) {
        ...
        BaseRateGraph graph = new BaseRateGraph(baseRateCalcContainer.getItemIds(), headerDTO.getSingleColumns(), headerDTO.getSingleHeaders());
