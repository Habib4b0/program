...
public class SalesProjectionDAOImpl implements SalesProjectionDAO {
    ...
    @Override
    public List<String> getPMPYTradingPartnerList(String tpName) throws SystemException, PortalException, Exception {
        throw new UnsupportedOperationException("Not supported yet."); 
    }

    /* (non-Javadoc)
     * @see com.stpl.app.galforecasting.dao.SalesProjectionDAO#getPMPYContractHolder()
     */
    @Override
    public List<String> getPMPYContractHolder(DynamicQuery dynamicQuery) throws SystemException, PortalException, Exception {
	...
	public List getContractHolderSummary(int projectionId, String indicator, List<Integer> comparisonProjections, String frequency,
			String level, String discountLevel) throws SystemException, PortalException, Exception {
 ...
 */
	@Override
	public List<String> getGroupList(DynamicQuery query) throws SystemException, Exception {
