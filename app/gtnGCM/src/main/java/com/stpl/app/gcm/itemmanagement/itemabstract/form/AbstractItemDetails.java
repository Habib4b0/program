...
public class AbstractItemDetails extends CustomComponent {
    ...
    Component ConfigureItemTable() {
        ...
        itemdetailstable.setEditable(BooleanConstant.getTrueFlag());
        itemdetailstable.addStyleName(VALO_THEME_EXTFILTERING_TABLE);
        itemdetailstable.setColumnCheckBox(Constants.CHECK_RECORD, BooleanConstant.getTrueFlag());
    ...
    Component ConfigureTransferItemTable() {
        ...
        itemTransferTable.setEditable(BooleanConstant.getTrueFlag());
        itemTransferTable.addStyleName(VALO_THEME_EXTFILTERING_TABLE);
        itemTransferTable.setColumnCheckBox(Constants.CHECK_RECORD, BooleanConstant.getTrueFlag());
    ...
    public void loadData() {
        ...
        itemdetailstableLogic.loadSetData(selection, BooleanConstant.getTrueFlag());
        if (selection.getButtonMode().equals(ConstantsUtil.TRANSFER) || selection.getButtonMode().equals(ConstantsUtil.PROJECTIONTRANSFER)) {
            selection.setOperation("TRANSFER SUMMARY");
            itemTransferTableLogic.loadSetData(selection, BooleanConstant.getTrueFlag());
        }
    }
