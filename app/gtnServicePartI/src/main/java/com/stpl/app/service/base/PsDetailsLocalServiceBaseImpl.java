...
import com.stpl.app.service.PsDetailsLocalService;
...
/**
 * Provides the base implementation for the ps details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.PsDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class PsDetailsLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PsDetailsLocalService, IdentifiableBean {
    ...
    private PsDetailsLocalServiceClpInvoker _clpInvoker = new PsDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.PsDetailsLocalServiceUtil} to access the ps details local service.
     */
    ...
    @Override
    public PsDetails addPsDetails(PsDetails psDetails)
        throws SystemException {
        psDetails.setNew(true);

        return psDetailsPersistence.update(psDetails);
    }
     ...
     */
    @Override
    public PsDetails createPsDetails(int psDetailsSid) {
        return psDetailsPersistence.create(psDetailsSid);
    }
    ...
    @Override
    public PsDetails deletePsDetails(int psDetailsSid)
        throws PortalException, SystemException {
        return psDetailsPersistence.remove(psDetailsSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PsDetails deletePsDetails(PsDetails psDetails)
        throws SystemException {
        return psDetailsPersistence.remove(psDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PsDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return psDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return psDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return psDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public PsDetails fetchPsDetails(int psDetailsSid) throws SystemException {
        return psDetailsPersistence.fetchByPrimaryKey(psDetailsSid);
    }
     ...
     */
    @Override
    public PsDetails getPsDetails(int psDetailsSid)
        throws PortalException, SystemException {
        return psDetailsPersistence.findByPrimaryKey(psDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return psDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<PsDetails> getPsDetailses(int start, int end)
        throws SystemException {
        return psDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getPsDetailsesCount() throws SystemException {
        return psDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public PsDetails updatePsDetails(PsDetails psDetails)
        throws SystemException {
        return psDetailsPersistence.update(psDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.PsDetails",
            psDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.PsDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = psDetailsPersistence.getDataSource();
