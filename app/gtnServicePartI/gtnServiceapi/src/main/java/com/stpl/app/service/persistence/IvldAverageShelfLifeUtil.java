...
/**
 * The persistence utility for the ivld average shelf life service. This utility wraps {@link com.stpl.app.service.persistence.impl.IvldAverageShelfLifePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class IvldAverageShelfLifeUtil {
	...
	*/
	public static void cacheResult(IvldAverageShelfLife ivldAverageShelfLife) {
	...
	*/
	public static void cacheResult(
		List<IvldAverageShelfLife> ivldAverageShelfLifes) {
	...
	*/
	public static IvldAverageShelfLife create(int ivldAverageShelfLifeSid) {
	...
	*/
	public static IvldAverageShelfLife remove(int ivldAverageShelfLifeSid)
		throws com.stpl.app.exception.NoSuchIvldAverageShelfLifeException {
		return getPersistence().remove(ivldAverageShelfLifeSid);
	}

	public static IvldAverageShelfLife updateImpl(
		IvldAverageShelfLife ivldAverageShelfLife) {
	...
	* @throws NoSuchIvldAverageShelfLifeException if a ivld average shelf life with the primary key could not be found
	*/
	public static IvldAverageShelfLife findByPrimaryKey(
	...
	*/
	public static IvldAverageShelfLife fetchByPrimaryKey(
		int ivldAverageShelfLifeSid) {
		return getPersistence().fetchByPrimaryKey(ivldAverageShelfLifeSid);
	}

	public static java.util.Map<java.io.Serializable, IvldAverageShelfLife> fetchByPrimaryKeys(
	...
	*/
	public static List<IvldAverageShelfLife> findAll() {
	...
	*/
	public static List<IvldAverageShelfLife> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IvldAverageShelfLifePersistence, IvldAverageShelfLifePersistence> _serviceTracker =
		ServiceTrackerFactory.open(IvldAverageShelfLifePersistence.class);
}