 ...
 *
 */
public class GtnFrameworkCommercialForecastingProductGroupLookup {

	public GtnUIFrameworkViewConfig getProductGroupLookUpView() {

		GtnUIFrameworkViewConfig view = new GtnUIFrameworkViewConfig();
		view.setViewName("Product Group LookUp");
		view.setViewId("prodGroupLookupView");
	...
	private void searchAndResetButtonLayout(List<GtnUIFrameworkComponentConfig> componentList,
		...
		loadDataTableActionConfig
				.setActionParameterList(Arrays.asList(new Object[] { "prodGroupLookupSearchResultTable" }));
		loadDataTableActionConfig.setFieldValues(
				Arrays.asList(new String[] { "prodGroupLookupProductGroupName", "prodGroupLookupProductGroupNo" }));
	...
	private void resultsPanel(List<GtnUIFrameworkComponentConfig> componentList, String parentComponentId) {
		...
		GtnUIFrameworkComponentConfig prodGroupLookupResultsPanel = new GtnUIFrameworkComponentConfig();
		prodGroupLookupResultsPanel.setComponentType(GtnUIFrameworkComponentType.PANEL);
		prodGroupLookupResultsPanel.setComponentId("prodGroupLookupResultsPanel");
		prodGroupLookupResultsPanel.setComponentName("Results");
		prodGroupLookupResultsPanel.setParentComponentId(parentComponentId);
		prodGroupLookupResultsPanel.setComponentWidth(GtnFrameworkCssConstants.HUNDRED_PERCENTAGE);
		prodGroupLookupResultsPanel.setAddToParent(Boolean.TRUE);
		componentList.add(prodGroupLookupResultsPanel);
		resultLayout(componentList, prodGroupLookupResultsPanel.getComponentId());
	...
	private void addPagedTableComponent(List<GtnUIFrameworkComponentConfig> componentList, String parentComponentId) {
		...
		searchResults.setCountUrl("/gtnCommercialForecasting/lookUp/getProductGroupLookUp");
		searchResults.setResultSetUrl("/gtnCommercialForecasting/lookUp/getProductGroupLookUp");
	...
	private void addControlPopUpButtonLayout(List<GtnUIFrameworkComponentConfig> componentList,
		...
		selectAction.setActionParameterList(Arrays.asList(new Object[] { "prodGroupLookupSearchResultTable",
				"productGroup", (Arrays.asList(new String[] { "prodGroupLookupProductGroupNameFilterView" })),
				Arrays.asList(new String[] { "productGroup" }) }));
		...
		closeOnSelectAction.setActionParameterList(Arrays.asList(new Object[] { "prodGroupLookupView" }));
