...
public class HistRelationshipLevelDefnLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<HistRelationshipLevelDefnLocalService, HistRelationshipLevelDefnLocalService> _serviceTracker =
		ServiceTrackerFactory.open(HistRelationshipLevelDefnLocalService.class);
}