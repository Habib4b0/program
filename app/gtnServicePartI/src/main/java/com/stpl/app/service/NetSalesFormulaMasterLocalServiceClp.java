 ...
 * @generated
 */
public class NetSalesFormulaMasterLocalServiceClp
    ...
    public NetSalesFormulaMasterLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addNetSalesFormulaMaster";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.NetSalesFormulaMaster"
            };

        _methodName1 = "createNetSalesFormulaMaster";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteNetSalesFormulaMaster";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteNetSalesFormulaMaster";
        ...
        _methodName10 = "fetchNetSalesFormulaMaster";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getNetSalesFormulaMaster";
        ...
        _methodName13 = "getNetSalesFormulaMasters";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getNetSalesFormulaMastersCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateNetSalesFormulaMaster";
    ...
    public com.stpl.app.model.NetSalesFormulaMaster addNetSalesFormulaMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(netSalesFormulaMaster)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.NetSalesFormulaMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.NetSalesFormulaMaster createNetSalesFormulaMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { netSalesFormulaMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.NetSalesFormulaMaster> getNetSalesFormulaMasters(
        ...
        return (java.util.List<com.stpl.app.model.NetSalesFormulaMaster>) ClpSerializer.translateOutput(returnObj);
    }
