...
/**
 * The persistence utility for the projection cust details service. This utility wraps {@link com.stpl.app.service.persistence.impl.ProjectionCustDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ProjectionCustDetailsUtil {
	...
	*/
	public static void cacheResult(ProjectionCustDetails projectionCustDetails) {
	...
	*/
	public static void cacheResult(
		List<ProjectionCustDetails> projectionCustDetailses) {
	...
	*/
	public static ProjectionCustDetails create(int customerDetailsId) {
	...
	*/
	public static ProjectionCustDetails remove(int customerDetailsId)
		throws com.stpl.app.exception.NoSuchProjectionCustDetailsException {
		return getPersistence().remove(customerDetailsId);
	}

	public static ProjectionCustDetails updateImpl(
		ProjectionCustDetails projectionCustDetails) {
	...
	* @throws NoSuchProjectionCustDetailsException if a projection cust details with the primary key could not be found
	*/
	public static ProjectionCustDetails findByPrimaryKey(int customerDetailsId)
		throws com.stpl.app.exception.NoSuchProjectionCustDetailsException {
	...
	*/
	public static ProjectionCustDetails fetchByPrimaryKey(int customerDetailsId) {
		return getPersistence().fetchByPrimaryKey(customerDetailsId);
	}

	public static java.util.Map<java.io.Serializable, ProjectionCustDetails> fetchByPrimaryKeys(
	...
	*/
	public static List<ProjectionCustDetails> findAll() {
	...
	*/
	public static List<ProjectionCustDetails> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<ProjectionCustDetailsPersistence, ProjectionCustDetailsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(ProjectionCustDetailsPersistence.class);
}