 ...
 * @see com.stpl.app.service.persistence.AdditionalNotesUtil
 * @generated
 */
@ProviderType
public class AdditionalNotesPersistenceImpl extends BasePersistenceImpl<AdditionalNotes>
	...
	public AdditionalNotesPersistenceImpl() {
		...
		try {
			...
			dbColumnNames.put("additionalNotesId", "ADDITIONAL_NOTES_ID");
	...
	public void cacheResult(AdditionalNotes additionalNotes) {
		entityCache.putResult(AdditionalNotesModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache() {
		entityCache.clearCache(AdditionalNotesImpl.class);
	...
	public void clearCache(AdditionalNotes additionalNotes) {
		entityCache.removeResult(AdditionalNotesModelImpl.ENTITY_CACHE_ENABLED,
			AdditionalNotesImpl.class, additionalNotes.getPrimaryKey());
	...
	public AdditionalNotes updateImpl(AdditionalNotes additionalNotes) {
		...
		try {
			...
			if (additionalNotes.isNew()) {
				...
				additionalNotes = (AdditionalNotes)session.merge(additionalNotes);
			}
		}
		catch (Exception e) {
			throw processException(e);
	...
	/**
	 * Returns the additional notes with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the additional notes
	...
	public AdditionalNotes fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(AdditionalNotesModelImpl.ENTITY_CACHE_ENABLED,
		...
		AdditionalNotes additionalNotes = (AdditionalNotes)serializable;
		...
		if (additionalNotes == null) {
			...
			try {
				...
				if (additionalNotes != null) {
					...
					entityCache.putResult(AdditionalNotesModelImpl.ENTITY_CACHE_ENABLED,
						AdditionalNotesImpl.class, primaryKey, nullModel);
				}
			}
			catch (Exception e) {
				entityCache.removeResult(AdditionalNotesModelImpl.ENTITY_CACHE_ENABLED,
	...
	@Override
	public Map<Serializable, AdditionalNotes> fetchByPrimaryKeys(
		Set<Serializable> primaryKeys) {
		if (primaryKeys.isEmpty()) {
			return Collections.emptyMap();
		}

		Map<Serializable, AdditionalNotes> map = new HashMap<Serializable, AdditionalNotes>();
		...
		if (primaryKeys.size() == 1) {
			...
			if (additionalNotes != null) {
				map.put(primaryKey, additionalNotes);
			}
		...
		for (Serializable primaryKey : primaryKeys) {
			...
			if (serializable != nullModel) {
				if (serializable == null) {
					...
					map.put(primaryKey, (AdditionalNotes)serializable);
				}
			}
		}
		...
		query.append(_SQL_SELECT_ADDITIONALNOTES_WHERE_PKS_IN);
		...
		try {
			...
			for (AdditionalNotes additionalNotes : (List<AdditionalNotes>)q.list()) {
				map.put(additionalNotes.getPrimaryKeyObj(), additionalNotes);

				cacheResult(additionalNotes);

				uncachedPrimaryKeys.remove(additionalNotes.getPrimaryKeyObj());
			}
	 ...
	 */
	@Override
	public List<AdditionalNotes> findAll() {
	...
	public List<AdditionalNotes> findAll(int start, int end,
		...
		List<AdditionalNotes> list = null;

		if (retrieveFromCache) {
			list = (List<AdditionalNotes>)finderCache.getResult(finderPath,
					finderArgs, this);
		}
	...
	protected Map<String, Integer> getTableColumnsMap() {
		return AdditionalNotesModelImpl.TABLE_COLUMNS_MAP;
	}
	...
	public void destroy() {
		entityCache.removeCache(AdditionalNotesImpl.class.getName());
	...
	private static final String _SQL_SELECT_ADDITIONALNOTES_WHERE_PKS_IN = "SELECT additionalNotes FROM AdditionalNotes additionalNotes WHERE ADDITIONAL_NOTES_ID IN (";
	...
	private static final Log _log = LogFactoryUtil.getLog(AdditionalNotesPersistenceImpl.class);
