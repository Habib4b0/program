...
public class NMSalesProjectionResultsLogic {
            ...
            if ("period".equalsIgnoreCase(pivotView)) {
                    ...
                    for (int j = 0; j < levelCount.size(); j++) {
                        ...
                        for (int i = 0; i < sprList.size(); i++) {
                            ...
                            if (Constant.SALES.equalsIgnoreCase(salesOrUnits) || Constant.BOTH_SMALL.equalsIgnoreCase(salesOrUnits)) {
                                ...
                                salesDTO.addStringProperties(commonColumn + Constant.ACTUALS, obj[NumericConstants.FOUR] != null && !Constant.NULL.equals(String.valueOf(obj[NumericConstants.FOUR])) && !StringUtils.EMPTY.equals(String.valueOf(obj[NumericConstants.FOUR])) ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(obj[NumericConstants.FOUR])))) : "-");
                                if (headerList.contains(commonColumn + Constant.PROJECTIONS)) {
                                    salesDTO.addStringProperties(commonColumn + Constant.PROJECTIONS, obj[NumericConstants.SIX] != null && !Constant.NULL.equals(String.valueOf(obj[NumericConstants.SIX])) && !StringUtils.EMPTY.equals(String.valueOf(obj[NumericConstants.SIX])) ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(obj[NumericConstants.SIX])))) : "-");
                                } else {
                                    salesDTO.addStringProperties(commonColumn + Constant.PROJECTIONS, obj[NumericConstants.EIGHT] != null && !Constant.NULL.equals(String.valueOf(obj[NumericConstants.EIGHT])) && !StringUtils.EMPTY.equals(String.valueOf(obj[NumericConstants.EIGHT])) ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(obj[NumericConstants.EIGHT])))) : "-");
                                }
                            }
                            if (Constant.UNITS.equalsIgnoreCase(salesOrUnits) || Constant.BOTH_SMALL.equalsIgnoreCase(salesOrUnits)) {
                                ...
                                unitsDTO.addStringProperties(commonColumn + Constant.ACTUALS, obj[NumericConstants.FIVE] != null && !Constant.NULL.equals(String.valueOf(obj[NumericConstants.FIVE])) && !StringUtils.EMPTY.equals(String.valueOf(obj[NumericConstants.FIVE])) ? UNITVOLUME.format(Double.parseDouble(String.valueOf(obj[NumericConstants.FIVE]))) : "-");
                                if (headerList.contains(commonColumn + Constant.PROJECTIONS)) {
                                    unitsDTO.addStringProperties(commonColumn + Constant.PROJECTIONS, obj[NumericConstants.SEVEN] != null && !StringUtils.EMPTY.equals(String.valueOf(obj[NumericConstants.SEVEN])) && !StringUtils.EMPTY.equals(String.valueOf(obj[NumericConstants.SEVEN])) ? UNITVOLUME.format(Double.parseDouble(String.valueOf(obj[NumericConstants.SEVEN]))) : "-");
                                } else {
                                    unitsDTO.addStringProperties(commonColumn + Constant.PROJECTIONS, obj[NumericConstants.NINE] != null && !Constant.NULL.equals(String.valueOf(obj[NumericConstants.NINE])) && !StringUtils.EMPTY.equals(String.valueOf(obj[NumericConstants.NINE])) ? UNITVOLUME.format(Double.parseDouble(String.valueOf(obj[NumericConstants.NINE]))) : "-");
                                }
                            }
                ...
                try {
                    ...
                    if (connection != null) {
                        ...
                        statement.setObject(NumericConstants.FOUR, Integer.parseInt(String.valueOf(selections[NumericConstants.EIGHT])));
                        statement.setObject(NumericConstants.FIVE, Integer.parseInt(String.valueOf(selections[NumericConstants.SEVEN])));
                    ...
                    for (int j = 0; j < levelCount.size(); j++) {
                        ...
                        for (int i = 0; i < sprList.size(); i++) {
                            ...
                            if (list.get(0).contains(commonColumn) || list.get(1).contains(commonColumn)) {
                                ...
                                salesDTO.addStringProperties("cswActuals", obj[NumericConstants.FOUR] != null || obj[NumericConstants.FOUR] == StringUtils.EMPTY ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(obj[NumericConstants.FOUR])))) : "-");
                                salesDTO.addStringProperties("uvActuals", obj[NumericConstants.FIVE] != null || obj[NumericConstants.FIVE] == StringUtils.EMPTY ? UNITVOLUME.format(Double.parseDouble(String.valueOf(obj[NumericConstants.FIVE]))) : "-");
                                salesDTO.addStringProperties("PerExFactoryActuals", obj[NumericConstants.SIX] != null || obj[NumericConstants.SIX] == StringUtils.EMPTY ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(obj[NumericConstants.SIX])))) : "-");
                                for (int k = 0; k < gtsList.size(); k++) {
                                    Object[] gtsObj = (Object[]) gtsList.get(k);
                                    String gtsCommonColumn = StringUtils.EMPTY;
                                    if (frequency.equalsIgnoreCase(QUARTERLY.getConstant())) {
                                        gtsCommonColumn = Constant.Q + gtsObj[NumericConstants.FIVE] + gtsObj[NumericConstants.SIX];
                                    } else if (frequency.equalsIgnoreCase(SEMI_ANNUALLY.getConstant())) {
                                        gtsCommonColumn = Constant.S + gtsObj[NumericConstants.FIVE] + gtsObj[NumericConstants.SIX];
                                    } else if (frequency.equalsIgnoreCase(MONTHLY.getConstant())) {
                                        String monthName = getMonthForInt(Integer.valueOf(StringUtils.EMPTY + gtsObj[NumericConstants.FOUR]) - 1);
                                    ...
                                    if (commonColumn.equalsIgnoreCase(gtsCommonColumn)) {
                                        if (list.get(0).contains(commonColumn)) {
                                            salesDTO.addStringProperties("gtsActuals", gtsObj[NumericConstants.TWO] != null || gtsObj[NumericConstants.TWO] == StringUtils.EMPTY ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(gtsObj[NumericConstants.TWO])))) : "-");
                                        } else {
                                            salesDTO.addStringProperties("gtsProjections", gtsObj[NumericConstants.TWO] != null || gtsObj[NumericConstants.TWO] == StringUtils.EMPTY ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(gtsObj[NumericConstants.TWO])))) : "-");
                                        }
                                    }
                                }
                                if (list.get(0).contains(commonColumn)) {
                                    salesDTO.addStringProperties("cswProjections", obj[NumericConstants.SIX] != null || obj[NumericConstants.SIX] == StringUtils.EMPTY ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(obj[NumericConstants.SIX])))) : "-");
                                    salesDTO.addStringProperties("uvProjections", obj[NumericConstants.SEVEN] != null || obj[NumericConstants.SEVEN] == StringUtils.EMPTY ? UNITVOLUME.format(Double.parseDouble(String.valueOf(obj[NumericConstants.SEVEN]))) : "-");
                                } else {
                                    salesDTO.addStringProperties("cswProjections", obj[NumericConstants.EIGHT] != null || obj[NumericConstants.EIGHT] == StringUtils.EMPTY ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(obj[NumericConstants.EIGHT])))) : "-");
                                    salesDTO.addStringProperties("uvProjections", obj[NumericConstants.NINE] != null || obj[NumericConstants.NINE] == StringUtils.EMPTY ? UNITVOLUME.format(Double.parseDouble(String.valueOf(obj[NumericConstants.NINE]))) : "-");
                                }
                                salesList.add(salesDTO);
                                unitList.add(unitsDTO);
                            }
                    ...
                    if ("period".equalsIgnoreCase(pivotView)) {
                        for (int i = 0; i < list.size(); i++) {
                            ...
                            if (frequency.equalsIgnoreCase(QUARTERLY.getConstant())) {
                                ...
                                String monthName = getMonthForInt(Integer.valueOf(StringUtils.EMPTY + obj[NumericConstants.FOUR]) - 1);
                            ...
                            gtsDTO.addStringProperties(commonColumn + Constant.PROJECTIONS, obj[NumericConstants.TWO] != null && StringUtils.EMPTY.equals(String.valueOf(obj[NumericConstants.TWO])) ? "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(obj[NumericConstants.TWO])))) : "-");
                            gtsList.add(gtsDTO);
                        }
                    } else {
                        for (int i = 0; i < list.size(); i++) {
                            ...
                            Object[] obj = (Object[]) list.get(i);
                            gtsDTO.addStringProperties("gtsProjections", "$".concat(DOLLAR.format(Double.parseDouble(String.valueOf(obj[NumericConstants.TWO])))));
                            gtsList.add(gtsDTO);
                        }
                    }
                } else {
        ...
        if (projSelDTO.isIsCustomHierarchy()) {
            ...
            for (Object object : obj) {
                ...
                if (levelMap.containsKey(hierarchyNo)) {
                    ...
                    dto.setGroup(projSelDTO.getSessionDTO().getLevelValueDiscription(hierarchyNo, projSelDTO.getHierarchyIndicator()));
                    dto.setLevelValue(projSelDTO.getSessionDTO().getLevelValueDiscription(hierarchyNo, projSelDTO.getHierarchyIndicator()));
    ...
    public List<SalesProjectionResultsDTO> getSalesProjectionResultsTotal(int start, int offset, ProjectionSelectionDTO projSelDTO) {
        ...
        if (neededRecord > 0 && projSelDTO.getPivotView().contains(PERIOD.getConstant())) {
            ...
            if ((neededRecord > 0 && (salesUnits.equals(Constant.BOTH) || salesUnits.equals(Constant.SALES_SMALL))) && ((start < NumericConstants.THREE) && (contractSalesDto != null))) {
        ...
        if (!projSelDTO.getLevelValue().startsWith(Constant.ALL)
            ...
            if (neededRecord > 0 && projSelDTO.getPivotView().contains(PERIOD.getConstant())) {
                ...
                if (projSelDTO.isIsProjectionTotal()) {
                    ...
                    if (neededRecord > 0 && (salesUnits.equals(BOTH.getConstant()) || salesUnits.equals(SALES.getConstant()) || salesUnits.equals(UNITS.getConstant()))) {
                        ...
                        if (started == NumericConstants.THREE) {
                            if (!projSelDTO.hasNonFetchableIndex(StringUtils.EMPTY + started)) {
                                SalesProjectionResultsDTO inventoryWithdrawDTO = projectionTotalList.get(NumericConstants.TWO);
                        ...
                        if (started == NumericConstants.FOUR && !salesUnits.equals(UNITS.getConstant())) {
                            if (!projSelDTO.hasNonFetchableIndex(StringUtils.EMPTY + started)) {
                                SalesProjectionResultsDTO contractSalesDto = projectionTotalList.get(NumericConstants.THREE);
                                projDTOList.add(contractSalesDto);
                            }
                            started++;
                            neededRecord--;
                        ...
                        if (started == NumericConstants.FIVE && !(salesUnits.equals(BOTH.getConstant()))) {
                            if (!projSelDTO.hasNonFetchableIndex(StringUtils.EMPTY + started)) {
                                 SalesProjectionResultsDTO PercentageExFactorySalesDto = projectionTotalList.get(NumericConstants.FIVE);
                    ...
                    if (salesUnits.equals(BOTH.getConstant()) || salesUnits.equals(SALES.getConstant()) || salesUnits.equals(UNITS.getConstant())) {
                        if ((salesUnits.equals(BOTH.getConstant()) && started == 2) || started == 1 || started == 0) {
                            if (!projSelDTO.hasNonFetchableIndex(StringUtils.EMPTY + started)) {
                                projDTOList.add(exFactorySalesDTO);
                }
    ...
    public void getProjectionTotal(Object[] orderedArgs, ProjectionSelectionDTO projSelDTO) {
        if (projSelDTO.getScreenName().equals(CommonUtils.BUSINESS_PROCESS_TYPE_NONMANDATED)) {
            ...
            if (!projSelDTO.getSessionDTO().isSprRefreshReqd() && CommonLogic.checkProcedureInputIsSame(orderedArgs, nonmandatedorderedArgs)) {
    ...
    public List<SalesProjectionResultsDTO> getCustomizedProjectionTotal(List<Object[]> list, ProjectionSelectionDTO projSelDTO) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (Object list1 : list) {
                ...
                PercentageExFactorySalesDto.addStringProperties(commonColumn + Constant.PROJECTIONS, PerExFactoryProjections);
    ...
    public List<SalesProjectionResultsDTO[]> getContractSalesAndUnitsMultiple(Set nodeSet, ProjectionSelectionDTO projSelDTO) {
    ...
    public List<SalesProjectionResultsDTO[]> getCustomizedSalesProjectionResultsSalesMultiple(List<Object> list, ProjectionSelectionDTO projSelDTO) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (Object list1 : list) {
                ...
                if (hierarChyNo.equals(String.valueOf(obj[obj.length - 1]))) {
                    generateContractUnitData(obj, frequencyDivision, projSelDTO, projSalesDTO, projUnitDTO, projExFacDTO, columnList);
                } else {
                    for (String columns : columnList) {
                        projSalesDTO.addStringProperties(columns, getFormattedValue(CUR_ZERO, Constant.NULL));
                        projUnitDTO.addStringProperties(columns, getFormattedValue(CUR_ZERO, Constant.NULL));
    ...
    public List<SalesProjectionResultsDTO> getSalesProjectionResultsMandated(int start, int offset, ProjectionSelectionDTO projSelDTO) {
        ...
        if (projSelDTO.isIsProjectionTotal()) {
            ...
            if (neededRecord > 0 && projSelDTO.getPivotView().contains(PERIOD.getConstant())) {
                ...
                String salesUnits = projSelDTO.getSalesOrUnit();
                if (neededRecord > 0 && (salesUnits.equals(Constant.BOTH) || salesUnits.equals(Constant.SALES_SMALL) || salesUnits.equals(Constant.UNITS_SMALL))) {
        ...
        if (projSelDTO.isIsCustomHierarchy()) {
            ...
            for (Object object : obj) {
                ...
                if (levelMap.containsKey(hierarchyNo)) {
                    ...
                    dto.setHierarchyNo(hierarchyNo);
                    dto.setHierarchyIndicator(projSelDTO.getHierarchyIndicator());
                    dto.setRelationshipLevelName(projSelDTO.getSessionDTO().getLevelValueDiscription(dto.getHierarchyNo(), projSelDTO.getHierarchyIndicator()));
                    if (projSelDTO.getHierarchyIndicator().equals(Constant.INDICATOR_LOGIC_CUSTOMER_HIERARCHY)) {
                        dto.setCustomerHierarchyNo(dto.getHierarchyNo());
                        dto.setProductHierarchyNo(projSelDTO.getProductHierarchyNo());
                    } else if (projSelDTO.getHierarchyIndicator().equals(Constant.INDICATOR_LOGIC_PRODUCT_HIERARCHY)) {
