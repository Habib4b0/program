...
/**
 * The persistence utility for the deduction group details service. This utility wraps {@link DeductionGroupDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class DeductionGroupDetailsUtil {
    private static DeductionGroupDetailsPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.DeductionGroupDetails create(
    ...
    */
    public static com.stpl.app.model.DeductionGroupDetails remove(
        int deductionGroupDetailsSid)
    ...
    public static com.stpl.app.model.DeductionGroupDetails updateImpl(
        com.stpl.app.model.DeductionGroupDetails deductionGroupDetails)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.DeductionGroupDetails findByPrimaryKey(
        int deductionGroupDetailsSid)
        throws com.stpl.app.NoSuchDeductionGroupDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.DeductionGroupDetails fetchByPrimaryKey(
        int deductionGroupDetailsSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.DeductionGroupDetails> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static DeductionGroupDetailsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (DeductionGroupDetailsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    DeductionGroupDetailsPersistence.class.getName());

            ReferenceRegistry.registerReference(DeductionGroupDetailsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(DeductionGroupDetailsPersistence persistence) {
    }
}
