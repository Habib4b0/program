...
public interface IvldForecastSalesPersistence extends BasePersistence<IvldForecastSales> {
	...
	*/
	public void cacheResult(
		java.util.List<IvldForecastSales> ivldForecastSaleses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, IvldForecastSales> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<IvldForecastSales> findAll();
	...
	*/
	public java.util.List<IvldForecastSales> findAll(int start, int end);
	...
	*/
	public java.util.List<IvldForecastSales> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<IvldForecastSales> orderByComparator);
