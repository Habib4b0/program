...
import com.stpl.app.service.DeductionGroupLocalService;
...
/**
 * Provides the base implementation for the deduction group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.DeductionGroupLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.DeductionGroupLocalServiceImpl
 * @see com.stpl.app.service.DeductionGroupLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class DeductionGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DeductionGroupLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.DeductionGroupLocalServiceUtil} to access the deduction group local service.
	 */
	...
	public DeductionGroup addDeductionGroup(DeductionGroup deductionGroup) {
		...
		return deductionGroupPersistence.update(deductionGroup);
	}
	...
	public DeductionGroup createDeductionGroup(int deductionGroupSid) {
		return deductionGroupPersistence.create(deductionGroupSid);
	}
	...
	public DeductionGroup deleteDeductionGroup(int deductionGroupSid)
		...
		return deductionGroupPersistence.remove(deductionGroupSid);
	}
	...
	public DeductionGroup deleteDeductionGroup(DeductionGroup deductionGroup) {
		return deductionGroupPersistence.remove(deductionGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DeductionGroup.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return deductionGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return deductionGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DeductionGroup fetchDeductionGroup(int deductionGroupSid) {
		return deductionGroupPersistence.fetchByPrimaryKey(deductionGroupSid);
	}
	...
	public DeductionGroup getDeductionGroup(int deductionGroupSid)
		throws PortalException {
		return deductionGroupPersistence.findByPrimaryKey(deductionGroupSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(deductionGroupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DeductionGroup.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("deductionGroupSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(deductionGroupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DeductionGroup.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return deductionGroupLocalService.deleteDeductionGroup((DeductionGroup)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return deductionGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DeductionGroup> getDeductionGroups(int start, int end) {
		return deductionGroupPersistence.findAll(start, end);
	}
	...
	public int getDeductionGroupsCount() {
		return deductionGroupPersistence.countAll();
	}
	 ...
	 */
	public DeductionGroupLocalService getDeductionGroupLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.DeductionGroup",
			deductionGroupLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeductionGroupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = deductionGroupPersistence.getDataSource();
	...
	@BeanReference(type = DeductionGroupLocalService.class)
	protected DeductionGroupLocalService deductionGroupLocalService;
