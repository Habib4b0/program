...
/**
 * Provides the local service interface for StMSupplementalDiscMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StMSupplementalDiscMasterLocalServiceUtil
...
public interface StMSupplementalDiscMasterLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link StMSupplementalDiscMasterLocalServiceUtil} to access the st m supplemental disc master local service. Add custom service methods to {@link com.stpl.app.service.impl.StMSupplementalDiscMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
