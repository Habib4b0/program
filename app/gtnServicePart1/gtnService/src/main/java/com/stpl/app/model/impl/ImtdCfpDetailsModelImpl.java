 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ImtdCfpDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ImtdCfpDetailsImpl}.
 * </p>
 *
 * @author
...
public class ImtdCfpDetailsModelImpl extends BaseModelImpl<ImtdCfpDetails>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("IMTD_CFP_DETAILS_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_START_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("COMPANY_TYPE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_TC_START_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("MODIFIED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_TC_END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("IMTD_CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_ATTACHED_STATUS", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CHECK_RECORD", Types.BOOLEAN);
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_ATTACHED_DATE", Types.TIMESTAMP);
		...
		TABLE_COLUMNS_MAP.put("TRADING_PARTNER_CONTRACT_NO", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_MODIFIED_BY", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_SID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("CFP_DETAILS_CREATED_BY", Types.VARCHAR);
	...
	public static final long IMTDCFPDETAILSSID_COLUMN_BITMASK = 8L;
	...
	public Object clone() {
		...
		imtdCfpDetailsImpl.setCompanyStringId(getCompanyStringId());
	...
	public CacheModel<ImtdCfpDetails> toCacheModel() {
		...
		imtdCfpDetailsCacheModel.companyStringId = getCompanyStringId();

		String companyStringId = imtdCfpDetailsCacheModel.companyStringId;

		if ((companyStringId != null) && (companyStringId.length() == 0)) {
			imtdCfpDetailsCacheModel.companyStringId = null;
		}
	...
	private static final ClassLoader _classLoader = ImtdCfpDetails.class.getClassLoader();
