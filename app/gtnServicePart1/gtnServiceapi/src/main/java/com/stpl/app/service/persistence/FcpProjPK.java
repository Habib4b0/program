 ...
 */
@ProviderType
public class FcpProjPK implements Comparable<FcpProjPK>, Serializable {
	...
	public FcpProjPK(int periodSid, String priceType, int naProjDetailsSid) {
	...
	@Override
	public int compareTo(FcpProjPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof FcpProjPK)) {
			return false;
		}

		FcpProjPK pk = (FcpProjPK)obj;
