 ...
 * @generated
 */
public class CffMasterLocalServiceClp implements CffMasterLocalService {
    ...
    public CffMasterLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.stpl.app.parttwo.model.CffMaster addCffMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(cffMaster) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.parttwo.model.CffMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.parttwo.model.CffMaster createCffMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { cffMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.parttwo.model.CffMaster deleteCffMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { cffMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.parttwo.model.CffMaster fetchCffMaster(int cffMasterSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { cffMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.parttwo.model.CffMaster getCffMaster(int cffMasterSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { cffMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.parttwo.model.CffMaster> getCffMasters(
        ...
        return (java.util.List<com.stpl.app.parttwo.model.CffMaster>) ClpSerializer.translateOutput(returnObj);
    }
