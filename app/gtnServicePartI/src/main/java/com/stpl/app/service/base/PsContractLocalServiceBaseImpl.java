...
import com.stpl.app.service.PsContractLocalService;
...
/**
 * Provides the base implementation for the ps contract local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.PsContractLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.PsContractLocalServiceImpl
 * @see com.stpl.app.service.PsContractLocalServiceUtil
 * @generated
 */
public abstract class PsContractLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements PsContractLocalService,
        IdentifiableBean {
    ...
    private PsContractLocalServiceClpInvoker _clpInvoker = new PsContractLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.PsContractLocalServiceUtil} to access the ps contract local service.
     */
    ...
    @Override
    public PsContract addPsContract(PsContract psContract)
        throws SystemException {
        psContract.setNew(true);

        return psContractPersistence.update(psContract);
    }
     ...
     */
    @Override
    public PsContract createPsContract(int psContractSid) {
        return psContractPersistence.create(psContractSid);
    }
    ...
    @Override
    public PsContract deletePsContract(int psContractSid)
        throws PortalException, SystemException {
        return psContractPersistence.remove(psContractSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PsContract deletePsContract(PsContract psContract)
        throws SystemException {
        return psContractPersistence.remove(psContract);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PsContract.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return psContractPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return psContractPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return psContractPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public PsContract fetchPsContract(int psContractSid)
        throws SystemException {
        return psContractPersistence.fetchByPrimaryKey(psContractSid);
    }
     ...
     */
    @Override
    public PsContract getPsContract(int psContractSid)
        throws PortalException, SystemException {
        return psContractPersistence.findByPrimaryKey(psContractSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return psContractPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<PsContract> getPsContracts(int start, int end)
        throws SystemException {
        return psContractPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getPsContractsCount() throws SystemException {
        return psContractPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public PsContract updatePsContract(PsContract psContract)
        throws SystemException {
        return psContractPersistence.update(psContract);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.PsContract",
            psContractLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.PsContract");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = psContractPersistence.getDataSource();
