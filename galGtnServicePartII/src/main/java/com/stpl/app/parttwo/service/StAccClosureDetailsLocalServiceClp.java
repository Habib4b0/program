 ...
 * @generated
 */
public class StAccClosureDetailsLocalServiceClp
    ...
    public StAccClosureDetailsLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addStAccClosureDetails";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.parttwo.model.StAccClosureDetails"
            };

        _methodName1 = "createStAccClosureDetails";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteStAccClosureDetails";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteStAccClosureDetails";
        ...
        _methodName10 = "fetchStAccClosureDetails";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getStAccClosureDetails";
        ...
        _methodName13 = "getStAccClosureDetailses";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getStAccClosureDetailsesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateStAccClosureDetails";
    ...
    public com.stpl.app.parttwo.model.StAccClosureDetails addStAccClosureDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(stAccClosureDetails)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.parttwo.model.StAccClosureDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.parttwo.model.StAccClosureDetails createStAccClosureDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { accClosureMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.parttwo.model.StAccClosureDetails deleteStAccClosureDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { accClosureMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.parttwo.model.StAccClosureDetails fetchStAccClosureDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    ...
                    new Object[] { accClosureMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.parttwo.model.StAccClosureDetails> getStAccClosureDetailses(
        ...
        return (java.util.List<com.stpl.app.parttwo.model.StAccClosureDetails>) ClpSerializer.translateOutput(returnObj);
    }
