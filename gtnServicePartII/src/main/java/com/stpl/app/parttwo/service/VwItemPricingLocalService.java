...
/**
 * Provides the local service interface for VwItemPricing. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see VwItemPricingLocalServiceUtil
...
public interface VwItemPricingLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link VwItemPricingLocalServiceUtil} to access the vw item pricing local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.VwItemPricingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
