...
public abstract class LotMasterLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements LotMasterLocalService, IdentifiableBean {
    ...
    private LotMasterLocalServiceClpInvoker _clpInvoker = new LotMasterLocalServiceClpInvoker();
    ...
    @Override
    public LotMaster fetchLotMaster(int lotMasterSid) throws SystemException {
     ...
     */
    @Override
    public LotMaster getLotMaster(int lotMasterSid)
        throws PortalException, SystemException {
     ...
     */
    @Override
    public int getLotMastersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.LotMaster",
