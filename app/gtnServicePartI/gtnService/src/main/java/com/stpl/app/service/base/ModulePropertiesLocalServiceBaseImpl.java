...
import com.stpl.app.service.ModulePropertiesLocalService;
...
/**
 * Provides the base implementation for the module properties local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ModulePropertiesLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ModulePropertiesLocalServiceImpl
 * @see com.stpl.app.service.ModulePropertiesLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ModulePropertiesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ModulePropertiesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ModulePropertiesLocalServiceUtil} to access the module properties local service.
	 */
	...
	@Override
	public ModuleProperties addModuleProperties(
		ModuleProperties moduleProperties) {
		moduleProperties.setNew(true);

		return modulePropertiesPersistence.update(moduleProperties);
	}
	 ...
	 */
	@Override
	public ModuleProperties createModuleProperties(int modulePropertySid) {
		return modulePropertiesPersistence.create(modulePropertySid);
	}
	...
	@Override
	public ModuleProperties deleteModuleProperties(int modulePropertySid)
		throws PortalException {
		return modulePropertiesPersistence.remove(modulePropertySid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ModuleProperties deleteModuleProperties(
		ModuleProperties moduleProperties) {
		return modulePropertiesPersistence.remove(moduleProperties);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ModuleProperties.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return modulePropertiesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return modulePropertiesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ModuleProperties fetchModuleProperties(int modulePropertySid) {
		return modulePropertiesPersistence.fetchByPrimaryKey(modulePropertySid);
	}
	 ...
	 */
	@Override
	public ModuleProperties getModuleProperties(int modulePropertySid)
		throws PortalException {
		return modulePropertiesPersistence.findByPrimaryKey(modulePropertySid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(modulePropertiesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ModuleProperties.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("modulePropertySid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(modulePropertiesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ModuleProperties.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return modulePropertiesLocalService.deleteModuleProperties((ModuleProperties)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return modulePropertiesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ModuleProperties> getModulePropertieses(int start, int end) {
		return modulePropertiesPersistence.findAll(start, end);
	}
	...
	public int getModulePropertiesesCount() {
		return modulePropertiesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ModuleProperties updateModuleProperties(
		ModuleProperties moduleProperties) {
		return modulePropertiesPersistence.update(moduleProperties);
	}
	 ...
	 */
	public ModulePropertiesLocalService getModulePropertiesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ModuleProperties",
			modulePropertiesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ModuleProperties");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ModulePropertiesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = modulePropertiesPersistence.getDataSource();
	...
	@BeanReference(type = ModulePropertiesLocalService.class)
	protected ModulePropertiesLocalService modulePropertiesLocalService;
