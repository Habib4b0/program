...
public abstract class VwCustomerGtsForecastLocalServiceBaseImpl
    ...
    private VwCustomerGtsForecastLocalServiceClpInvoker _clpInvoker = new VwCustomerGtsForecastLocalServiceClpInvoker();
    ...
    public VwCustomerGtsForecast deleteVwCustomerGtsForecast(
        int customerGtsForecastSid) throws PortalException, SystemException {
    ...
    public VwCustomerGtsForecast fetchVwCustomerGtsForecast(
        int customerGtsForecastSid) throws SystemException {
     ...
     */
    @Override
    public int getVwCustomerGtsForecastsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.VwCustomerGtsForecast",
