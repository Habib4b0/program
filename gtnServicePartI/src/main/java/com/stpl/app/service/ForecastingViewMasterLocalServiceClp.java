 ...
 * @generated
 */
public class ForecastingViewMasterLocalServiceClp
    ...
    public ForecastingViewMasterLocalServiceClp(
        ...
        _methodName20 = "findViewByNameForChannels";
    ...
    public com.stpl.app.model.ForecastingViewMaster addForecastingViewMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(forecastingViewMaster)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ForecastingViewMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ForecastingViewMaster createForecastingViewMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { viewId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ForecastingViewMaster deleteForecastingViewMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { viewId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ForecastingViewMaster fetchForecastingViewMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { viewId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ForecastingViewMaster getForecastingViewMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { viewId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ForecastingViewMaster> getForecastingViewMasters(
        ...
        return (java.util.List<com.stpl.app.model.ForecastingViewMaster>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List findViewByName(java.lang.String viewName,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(viewName),
                        
                    ClpSerializer.translateInput(forecastType),
                        
                    ClpSerializer.translateInput(userId),
                        
                    ClpSerializer.translateInput(viewType)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
