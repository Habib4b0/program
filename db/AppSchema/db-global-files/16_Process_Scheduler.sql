...
END
GO
-----------------------Insert for Existing interfaces-------------------------------------

----------------------------------WORKFLOW_PROFILE ACCRUAL_RATE_PROJECTION_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE ACCRUAL_INBOUND_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Accrual_Master_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE COMPANY_MASTER_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Company_Master_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE COMPANY_PARENT_DETAILS_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Company_Parent_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE COMPANY_TRADE_CLASS_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Company_Trade_Class_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE COMPANY_IDENTIFIER_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Company_Identifier_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE ITEM_MASTER_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE ITEM_IDENTIFIER_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Item_Identifier_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE ITEM_PRICING_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Item_Pricing_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE CONTRACT_HEADER_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Contract_Header_Intf.sh'
		)
END
GO
----------------------------------WORKFLOW_PROFILE COMPANY_FAMILY_PLAN_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Company_Family_Plan_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE ITEM_FAMILY_PLAN_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Item_Family_Plan_Intf.sh'
		)
END
GO
----------------------------------WORKFLOW_PROFILE PRICE_SCHEDULE_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Price_Schedule_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE REBATE_SCHEDULE_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Rebate_Schedule_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE REBATE_PLAN_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE ACTUAL_MASTER_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Actual_Master_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE SALES_MASTER_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Sales_Master_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE ITEM_HIERARCHY_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Item_Hierarchy_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE ITEM_HIERARCHY_DEFINITION_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Item_Hierarchy_Defn_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE FORECAST_SALES_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Forecasting_Sales_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE GL_BALANCE_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE CPI_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE FORMULA_DETAILS_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Formula_Details_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE MASTER_DATA_ATTRIBUTE_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Master_Data_Attrb_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE BEST_PRICE_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE AVERAGE_SHELF_LIFE_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE GL_COST_CENTER_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'GL_Cost_Center_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE LOT_MASTER_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE ACCRUAL_OUTBOUND_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Accrual_Outbound_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE GL_POSTING_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE DEMAND_ACTUAL_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Demand_Actual_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE DEMAND_FORECAST_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Demand_Forecast_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE INVENTORY_WITHDRAWAL_ACTUAL_DETAIL_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Inventory_Withdrawal_Actual_Detail_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE INVENTORY_WITHDRAWAL_ACTUAL_SUMMARY_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Inventory_Withdrawal_Actual_Summary_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE INVENTORY_WITHDRAWAL_PROJECTED_DETAIL_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Inventory_Withdrawal_Projected_Detail_Intf.sh'
		)
END
GO


----------------------------------WORKFLOW_PROFILE INVENTORY_WITHDRAWAL_PROJECTED_SUMMARY_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Inventory_Withdrawal_Projected_Summary_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE RETURNS_INTERFACE -------------------------------------
...
----------------------------------WORKFLOW_PROFILE CUSTOMER_GTS_ACTUAL_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Customer_Gts_Actual_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE CUSTOMER_GTS_FORECAST_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Customer_Gts_Forecast_Intf.sh'
		)
END
GO

----------------------------------WORKFLOW_PROFILE ADJUSTED_DEMAND_ACTUAL_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Adjusted_Demand_Actual_Intf.sh'
		)
END
GO
...
----------------------------------WORKFLOW_PROFILE ADJUSTED_DEMAND_FORECAST_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,'Adjusted_Demand_Forecast_Intf.sh'
		)
END
GO
...
----------------------------------WORKFLOW_PROFILE ITEM_UOM_INTERFACE -------------------------------------
...
BEGIN
	...
	VALUES (
		...
		,1
		,'A'
		,'SUCCESS - ITEM_UOM_INTERFACE'
		,'ITEM_UOM_INTERFACE SUCCESS'
		,'FAILURE - ITEM_UOM_INTERFACE '
		,'ITEM_UOM_INTERFACE FAILURE'
		,'Item_Uom_Intf.sh'
		)
END
GO
...
----------------------------------WORKFLOW_PROFILE RETURN_RATE_FORECAST_INTERFACE -------------------------------------
