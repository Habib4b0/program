...
/**
 * Provides the local service interface for ChActualDiscount. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ChActualDiscountLocalServiceUtil
...
public interface ChActualDiscountLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChActualDiscountLocalServiceUtil} to access the ch actual discount local service. Add custom service methods to {@link com.stpl.app.service.impl.ChActualDiscountLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
