...
import com.stpl.app.service.IvldLotMasterLocalService;
...
/**
 * Provides the base implementation for the ivld lot master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldLotMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldLotMasterLocalServiceImpl
 * @see com.stpl.app.service.IvldLotMasterLocalServiceUtil
 * @generated
 */
public abstract class IvldLotMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements IvldLotMasterLocalService,
        IdentifiableBean {
    ...
    private IvldLotMasterLocalServiceClpInvoker _clpInvoker = new IvldLotMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldLotMasterLocalServiceUtil} to access the ivld lot master local service.
     */
    ...
    @Override
    public IvldLotMaster addIvldLotMaster(IvldLotMaster ivldLotMaster)
        throws SystemException {
        ivldLotMaster.setNew(true);

        return ivldLotMasterPersistence.update(ivldLotMaster);
    }
     ...
     */
    @Override
    public IvldLotMaster createIvldLotMaster(int ivldLotMasterSid) {
        return ivldLotMasterPersistence.create(ivldLotMasterSid);
    }
    ...
    @Override
    public IvldLotMaster deleteIvldLotMaster(int ivldLotMasterSid)
        throws PortalException, SystemException {
        return ivldLotMasterPersistence.remove(ivldLotMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public IvldLotMaster deleteIvldLotMaster(IvldLotMaster ivldLotMaster)
        throws SystemException {
        return ivldLotMasterPersistence.remove(ivldLotMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IvldLotMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldLotMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldLotMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public IvldLotMaster fetchIvldLotMaster(int ivldLotMasterSid)
        throws SystemException {
        return ivldLotMasterPersistence.fetchByPrimaryKey(ivldLotMasterSid);
    }
     ...
     */
    @Override
    public IvldLotMaster getIvldLotMaster(int ivldLotMasterSid)
        throws PortalException, SystemException {
        return ivldLotMasterPersistence.findByPrimaryKey(ivldLotMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ivldLotMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IvldLotMaster> getIvldLotMasters(int start, int end)
        throws SystemException {
        return ivldLotMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIvldLotMastersCount() throws SystemException {
        return ivldLotMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IvldLotMaster updateIvldLotMaster(IvldLotMaster ivldLotMaster)
        throws SystemException {
        return ivldLotMasterPersistence.update(ivldLotMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.IvldLotMaster",
            ivldLotMasterLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.IvldLotMaster");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ivldLotMasterPersistence.getDataSource();
