...
public interface NationalAssumptionsProjPersistence extends BasePersistence<NationalAssumptionsProj> {
	...
	*/
	public void cacheResult(
		java.util.List<NationalAssumptionsProj> nationalAssumptionsProjs);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, NationalAssumptionsProj> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<NationalAssumptionsProj> findAll();
	...
	*/
	public java.util.List<NationalAssumptionsProj> findAll(int start, int end);
	...
	*/
	public java.util.List<NationalAssumptionsProj> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<NationalAssumptionsProj> orderByComparator);
