...
/**
 * Provides the local service interface for ImtdRsContractDetailsFr. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ImtdRsContractDetailsFrLocalServiceUtil
...
public interface ImtdRsContractDetailsFrLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ImtdRsContractDetailsFrLocalServiceUtil} to access the imtd rs contract details fr local service. Add custom service methods to {@link com.stpl.app.service.impl.ImtdRsContractDetailsFrLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
