 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link WorkflowProcessInfoModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link WorkflowProcessInfoImpl}.
 * </p>
 *
 * @author
...
public class WorkflowProcessInfoModelImpl extends BaseModelImpl<WorkflowProcessInfo>
	...
	static {
		TABLE_COLUMNS_MAP.put("PROCESS_INSTANCE_ID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("PROJECTION_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("WORKFLOW_PROCESS_INFO_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("ACC_CLOSURE_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CONTRACT_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CONTRACT_STRUCTURE", Types.VARCHAR);
	}
	...
	private static final ClassLoader _classLoader = WorkflowProcessInfo.class.getClassLoader();
