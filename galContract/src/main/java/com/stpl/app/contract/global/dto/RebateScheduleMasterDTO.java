 ...
 * @author manikanta
 */
public class RebateScheduleMasterDTO implements Serializable {

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = 4006958135325757059L;
    /**
     ...
     */
    public HelperDTO rebateScheduleStatus;
    /**
     * The modified by.
     */
     ...
     */
    public HelperDTO rebateProgramType;
    /**
     ...
     */
    public HelperDTO rebateScheduleType;
    /**
     * The address2.
     */
     ...
     */
    public String rebateScheduleCategory;
    /**
     * The calendar.
     */
    ...
    private String displayRsStatus=StringUtils.EMPTY;
    
    private String displayRsType=StringUtils.EMPTY;
    
    private String displayRpType=StringUtils.EMPTY;
     ...
     */
    public void setRebatePlanLevel(final String rebatePlanLevel) {
     ...
     */
    public void setRebateRuleType(final String rebateRuleType) {
     ...
     */
    public void setRebateFrequency(final String rebateFrequency) {
     ...
     */
    public void setValidationProfile(final String validationProfile) {
     ...
     */
    public void setRebateScheduleCategory(final String rebateScheduleCategory) {
    ...
    public String getDisplayRsStatus() {
        return displayRsStatus;
    }

    public void setDisplayRsStatus(String displayRsStatus) {
        this.displayRsStatus = displayRsStatus;
    }

    public String getDisplayRsType() {
        return displayRsType;
    }

    public void setDisplayRsType(String displayRsType) {
        this.displayRsType = displayRsType;
    }

    public String getDisplayRpType() {
        return displayRpType;
    }

    public void setDisplayRpType(String displayRpType) {
        this.displayRpType = displayRpType;
    }
}
