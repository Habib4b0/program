...
'
		...
		BEGIN
			...
			SELECT PROJECTION_MASTER_SID,
				...
				SUM(IIF((SALES_INCLUSION = @SALES_INCLUSION OR @SALES_INCLUSION IS NULL), ISNULL(ACTUAL_UNITS,0), NULL) *  COALESCE(NULLIF(UOM_VALUE, 0),1) ) AS CONTRACT_UNITS_ACTUALS,
				PARENT_HIERARCHY_NO
			...
			SELECT PROJECTION_MASTER_SID,
				...
				SUM(IIF((SALES_INCLUSION = @SALES_INCLUSION OR @SALES_INCLUSION IS NULL), ISNULL(PROJECTION_UNITS,0), NULL) *  COALESCE(NULLIF(UOM_VALUE, 0),1) ) AS CONTRACT_UNITS_PROJECTED,
				PARENT_HIERARCHY_NO
