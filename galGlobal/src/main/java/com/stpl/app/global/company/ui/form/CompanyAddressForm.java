...
public class CompanyAddressForm extends CustomComponent {
     ...
     * @throws Exception 
     */
    public Component getContent(ErrorfulFieldGroup binder, SessionDTO sessionDTO) throws PortalException, SystemException, Exception {
        this.binder = binder;
    ...
    private void getResponsiveSecondTab(final Map<String, AppPermission> fieldCompanyHM) {
        ...
        LOGGER.info("Entering getResponsiveSecondTab");
        try {
        ...
        LOGGER.info("Ending getResponsiveSecondTab");
