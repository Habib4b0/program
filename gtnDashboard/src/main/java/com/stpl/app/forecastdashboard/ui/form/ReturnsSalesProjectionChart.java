 ...
 * @author Lokeshwari
 */
public class ReturnsSalesProjectionChart {
     ...
     * The Constant LOGGER.
     */
    private static final Logger LOGGER = Logger.getLogger(ReturnsSalesProjectionChart.class);
     ...
     */
    public ReturnsSalesProjectionChart(int projId) {
        this.projId = projId;
    }
    ...
    public Component getChart(int from, int to) {
        ...
        listSeries1.setName("Actual Return Percent");
        listSeries2.setName("Actual RPU");
        listSeries3.setName("Actual Return Amount");
        listSeries4.setName("Projected Return Percent");
        listSeries5.setName("Contract Units Actuals");
        listSeries6.setName("Contract Units Projected");
        listSeries7.setName("Growth Rate");

        final Configuration conf = chart.getConfiguration();

        conf.setTitle("Returns Sales Projection");
        conf.disableCredits();
...
//        tooltip.setFormatter("this.x +': $ '+ this.y ");
    ...
    public Component configureFields() {
        ...
        commonLevelDtoList = logic.getReturnsSalesChartData(projId);
