...
public interface HistRelationshipBuilderPersistence extends BasePersistence<HistRelationshipBuilder> {
	...
	*/
	public void cacheResult(
		java.util.List<HistRelationshipBuilder> histRelationshipBuilders);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, HistRelationshipBuilder> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<HistRelationshipBuilder> findAll();
	...
	*/
	public java.util.List<HistRelationshipBuilder> findAll(int start, int end);
	...
	*/
	public java.util.List<HistRelationshipBuilder> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<HistRelationshipBuilder> orderByComparator);
