...
/**
 * The persistence utility for the medicaid ura proj service. This utility wraps {@link com.stpl.app.service.persistence.impl.MedicaidUraProjPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.stpl.app.service.persistence.impl.MedicaidUraProjPersistenceImpl
 * @generated
 */
@ProviderType
public class MedicaidUraProjUtil {
	...
	*/
	public static void cacheResult(MedicaidUraProj medicaidUraProj) {
	...
	*/
	public static void cacheResult(List<MedicaidUraProj> medicaidUraProjs) {
	...
	*/
	public static MedicaidUraProj create(MedicaidUraProjPK medicaidUraProjPK) {
	...
	*/
	public static MedicaidUraProj remove(MedicaidUraProjPK medicaidUraProjPK)
		throws com.stpl.app.exception.NoSuchMedicaidUraProjException {
		return getPersistence().remove(medicaidUraProjPK);
	}

	public static MedicaidUraProj updateImpl(MedicaidUraProj medicaidUraProj) {
	...
	* @throws NoSuchMedicaidUraProjException if a medicaid ura proj with the primary key could not be found
	*/
	public static MedicaidUraProj findByPrimaryKey(
	...
	*/
	public static MedicaidUraProj fetchByPrimaryKey(
		MedicaidUraProjPK medicaidUraProjPK) {
		return getPersistence().fetchByPrimaryKey(medicaidUraProjPK);
	}

	public static java.util.Map<java.io.Serializable, MedicaidUraProj> fetchByPrimaryKeys(
	...
	*/
	public static List<MedicaidUraProj> findAll() {
	...
	*/
	public static List<MedicaidUraProj> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<MedicaidUraProjPersistence, MedicaidUraProjPersistence> _serviceTracker =
		ServiceTrackerFactory.open(MedicaidUraProjPersistence.class);
}