...
public class CpiIndexMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<CpiIndexMasterLocalService, CpiIndexMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(CpiIndexMasterLocalService.class);
}