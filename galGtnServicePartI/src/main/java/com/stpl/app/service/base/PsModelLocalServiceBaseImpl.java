...
import com.stpl.app.service.PsModelLocalService;
...
/**
 * Provides the base implementation for the ps model local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.PsModelLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.PsModelLocalServiceImpl
 * @see com.stpl.app.service.PsModelLocalServiceUtil
 * @generated
 */
public abstract class PsModelLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PsModelLocalService, IdentifiableBean {
    ...
    private PsModelLocalServiceClpInvoker _clpInvoker = new PsModelLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.PsModelLocalServiceUtil} to access the ps model local service.
     */
    ...
    @Override
    public PsModel addPsModel(PsModel psModel) throws SystemException {
        psModel.setNew(true);

        return psModelPersistence.update(psModel);
    }
     ...
     */
    @Override
    public PsModel createPsModel(int psModelSid) {
        return psModelPersistence.create(psModelSid);
    }
    ...
    @Override
    public PsModel deletePsModel(int psModelSid)
        throws PortalException, SystemException {
        return psModelPersistence.remove(psModelSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PsModel deletePsModel(PsModel psModel) throws SystemException {
        return psModelPersistence.remove(psModel);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PsModel.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return psModelPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return psModelPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return psModelPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return psModelPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return psModelPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public PsModel fetchPsModel(int psModelSid) throws SystemException {
        return psModelPersistence.fetchByPrimaryKey(psModelSid);
    }
     ...
     */
    @Override
    public PsModel getPsModel(int psModelSid)
        throws PortalException, SystemException {
        return psModelPersistence.findByPrimaryKey(psModelSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return psModelPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<PsModel> getPsModels(int start, int end)
        throws SystemException {
        return psModelPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getPsModelsCount() throws SystemException {
        return psModelPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public PsModel updatePsModel(PsModel psModel) throws SystemException {
        return psModelPersistence.update(psModel);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.PsModel",
            psModelLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.PsModel");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = psModelPersistence.getDataSource();
