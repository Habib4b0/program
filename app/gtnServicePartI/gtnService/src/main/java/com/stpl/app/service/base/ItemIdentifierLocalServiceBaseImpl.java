...
import com.stpl.app.service.ItemIdentifierLocalService;
...
/**
 * Provides the base implementation for the item identifier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ItemIdentifierLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class ItemIdentifierLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ItemIdentifierLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ItemIdentifierLocalServiceUtil} to access the item identifier local service.
	 */
	...
	@Override
	public ItemIdentifier addItemIdentifier(ItemIdentifier itemIdentifier) {
		itemIdentifier.setNew(true);

		return itemIdentifierPersistence.update(itemIdentifier);
	}
	 ...
	 */
	@Override
	public ItemIdentifier createItemIdentifier(int itemIdentifierSid) {
		return itemIdentifierPersistence.create(itemIdentifierSid);
	}
	...
	@Override
	public ItemIdentifier deleteItemIdentifier(int itemIdentifierSid)
		throws PortalException {
		return itemIdentifierPersistence.remove(itemIdentifierSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ItemIdentifier deleteItemIdentifier(ItemIdentifier itemIdentifier) {
		return itemIdentifierPersistence.remove(itemIdentifier);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ItemIdentifier.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return itemIdentifierPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return itemIdentifierPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ItemIdentifier fetchItemIdentifier(int itemIdentifierSid) {
		return itemIdentifierPersistence.fetchByPrimaryKey(itemIdentifierSid);
	}
	 ...
	 */
	@Override
	public ItemIdentifier getItemIdentifier(int itemIdentifierSid)
		throws PortalException {
		return itemIdentifierPersistence.findByPrimaryKey(itemIdentifierSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(itemIdentifierLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ItemIdentifier.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(itemIdentifierLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ItemIdentifier.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return itemIdentifierLocalService.deleteItemIdentifier((ItemIdentifier)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return itemIdentifierPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ItemIdentifier> getItemIdentifiers(int start, int end) {
		return itemIdentifierPersistence.findAll(start, end);
	}
	...
	public int getItemIdentifiersCount() {
		return itemIdentifierPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ItemIdentifier updateItemIdentifier(ItemIdentifier itemIdentifier) {
		return itemIdentifierPersistence.update(itemIdentifier);
	}
	 ...
	 */
	public ItemIdentifierLocalService getItemIdentifierLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ItemIdentifier",
			itemIdentifierLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ItemIdentifierLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = itemIdentifierPersistence.getDataSource();
	...
	@BeanReference(type = ItemIdentifierLocalService.class)
	protected ItemIdentifierLocalService itemIdentifierLocalService;
