...
import com.stpl.app.service.NaProjMasterLocalService;
...
/**
 * Provides the base implementation for the na proj master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.NaProjMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.NaProjMasterLocalServiceImpl
 * @see com.stpl.app.service.NaProjMasterLocalServiceUtil
 * @generated
 */
public abstract class NaProjMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements NaProjMasterLocalService,
        IdentifiableBean {
    ...
    private NaProjMasterLocalServiceClpInvoker _clpInvoker = new NaProjMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.NaProjMasterLocalServiceUtil} to access the na proj master local service.
     */
    ...
    @Override
    public NaProjMaster addNaProjMaster(NaProjMaster naProjMaster)
        throws SystemException {
        naProjMaster.setNew(true);

        return naProjMasterPersistence.update(naProjMaster);
    }
     ...
     */
    @Override
    public NaProjMaster createNaProjMaster(int naProjMasterSid) {
        return naProjMasterPersistence.create(naProjMasterSid);
    }
    ...
    @Override
    public NaProjMaster deleteNaProjMaster(int naProjMasterSid)
        throws PortalException, SystemException {
        return naProjMasterPersistence.remove(naProjMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public NaProjMaster deleteNaProjMaster(NaProjMaster naProjMaster)
        throws SystemException {
        return naProjMasterPersistence.remove(naProjMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(NaProjMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return naProjMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return naProjMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public NaProjMaster fetchNaProjMaster(int naProjMasterSid)
        throws SystemException {
        return naProjMasterPersistence.fetchByPrimaryKey(naProjMasterSid);
    }
     ...
     */
    @Override
    public NaProjMaster getNaProjMaster(int naProjMasterSid)
        throws PortalException, SystemException {
        return naProjMasterPersistence.findByPrimaryKey(naProjMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return naProjMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<NaProjMaster> getNaProjMasters(int start, int end)
        throws SystemException {
        return naProjMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getNaProjMastersCount() throws SystemException {
        return naProjMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public NaProjMaster updateNaProjMaster(NaProjMaster naProjMaster)
        throws SystemException {
        return naProjMasterPersistence.update(naProjMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.NaProjMaster",
            naProjMasterLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.NaProjMaster");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = naProjMasterPersistence.getDataSource();
