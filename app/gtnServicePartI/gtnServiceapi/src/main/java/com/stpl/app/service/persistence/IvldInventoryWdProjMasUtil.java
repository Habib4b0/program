...
public class IvldInventoryWdProjMasUtil {
	...
	*/
	public static IvldInventoryWdProjMas create(int ivldInventoryWdProjMasSid) {
	...
	*/
	public static IvldInventoryWdProjMas remove(int ivldInventoryWdProjMasSid)
		throws com.stpl.app.exception.NoSuchIvldInventoryWdProjMasException {
		return getPersistence().remove(ivldInventoryWdProjMasSid);
	}

	public static IvldInventoryWdProjMas updateImpl(
		IvldInventoryWdProjMas ivldInventoryWdProjMas) {
	...
	* @throws NoSuchIvldInventoryWdProjMasException if a ivld inventory wd proj mas with the primary key could not be found
	*/
	public static IvldInventoryWdProjMas findByPrimaryKey(
	...
	*/
	public static IvldInventoryWdProjMas fetchByPrimaryKey(
		int ivldInventoryWdProjMasSid) {
		return getPersistence().fetchByPrimaryKey(ivldInventoryWdProjMasSid);
	}

	public static java.util.Map<java.io.Serializable, IvldInventoryWdProjMas> fetchByPrimaryKeys(
	...
	*/
	public static List<IvldInventoryWdProjMas> findAll() {
	...
	*/
	public static List<IvldInventoryWdProjMas> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IvldInventoryWdProjMasPersistence, IvldInventoryWdProjMasPersistence> _serviceTracker =
		ServiceTrackerFactory.open(IvldInventoryWdProjMasPersistence.class);
}