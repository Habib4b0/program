...
public class CommonUtils {
    ...
    public static final SimpleDateFormat dateFormat = new SimpleDateFormat(com.stpl.app.util.ConstantsUtils.DATE_FORMAT);
    ...
    public static final void beforeUnloadCloseUi(final UI uI) {
        ...
        ob.addUnloadListener(new BeforeUnload.UnloadListener() {
            ...
            public void unload(BeforeUnload.UnloadEvent event) {
               if (!Constants.TRUE.equals(VaadinSession.getCurrent().getAttribute(com.stpl.app.util.ConstantsUtils.EXCEL_CLOSE))) {
                    uI.close();
                } 
            }
        });
