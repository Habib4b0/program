...
public class Trx7PipelineAccrualRateLogic<T extends AdjustmentDTO, E extends AbstractSelectionDTO> extends Trx7RateLogic<T, E> {
    ...
    public static final Logger LOGGERFORRATESTAB = Logger.getLogger(Trx7PipelineAccrualRateLogic.class);
        ...
        try {
            ...
            if (isCount) {
                ...
                if (lastParent != null && (lastParent instanceof AdjustmentDTO)) {
                    ...
                    input.addAll(new ArrayList<>(Arrays.asList(selection.getRateDeductionLevelName(), selection.getRateLevelName(), selection.getRatesOverrideFlag(), selection.getTableName(), "%", "%", selection.getRateDeductionValue())));
                ...
                if (lastParent != null && (lastParent instanceof AdjustmentDTO)) {
                    ...
                    if (!ARMConstants.getDeductionCustomerContract().equals(selection.getRateDeductionView()) && !CommonConstant.DEDUCTION_CONTRACT.equals(selection.getRateDeductionView() )
                            && !"Deduction Customer".equals(selection.getRateDeductionView())&& !ARMConstants.getDeductionContractCustomer().equals(selection.getRateDeductionView())) {
                        input.addAll(new ArrayList<>(Arrays.asList(selection.getRateDeductionLevelName(), selection.getRateLevelName(), selection.getRatesOverrideFlag(),
        ...
        switch (parentDTO.getLevelName()) {
            case VariableConstants.DEDUCTION_UPPERCASE:
                if (!CommonConstant.DEDUCTION_CONTRACT.equals(selection.getRateDeductionView())) {
                    input.addAll(new ArrayList<>(Arrays.asList(selection.getRateDeductionLevelName(), ARMConstants.getDeductionContractCustomer().equals(selection.getRateDeductionView()) ? VariableConstants.CONTRACT_UPPERCASE : VariableConstants.CUSTOMER_UPPERCASE, selection.getRatesOverrideFlag(), selection.getTableName())));
                } else {
                    input.addAll(new ArrayList<>(Arrays.asList(selection.getRateDeductionLevelName(), VariableConstants.CONTRACT_UPPERCASE, selection.getRatesOverrideFlag(), selection.getTableName())));
                }
            ...
            case VariableConstants.CUSTOMER_UPPERCASE:
                if (!CommonConstant.DEDUCTION_CONTRACT.equals(selection.getRateDeductionView())) {
                    input.addAll(new ArrayList<>(Arrays.asList(selection.getRateDeductionLevelName(),
                            ...
                            : VariableConstants.BRAND_UPPERCASE, selection.getRatesOverrideFlag(), selection.getTableName())));
                } else {
                    input.addAll(new ArrayList<>(Arrays.asList(selection.getRateDeductionLevelName(), VariableConstants.BRAND_UPPERCASE,  selection.getRatesOverrideFlag(),selection.getTableName())));
                }
                input.add("%");
            ...
            case VariableConstants.CONTRACT_UPPERCASE:
                if (!CommonConstant.DEDUCTION_CONTRACT.equals(selection.getRateDeductionView())) {
                    input.addAll(new ArrayList<>(Arrays.asList(selection.getRateDeductionLevelName(),ARMConstants.getDeductionContractCustomer().equals(selection.getRateDeductionView()) ? VariableConstants.CUSTOMER_UPPERCASE : VariableConstants.BRAND_UPPERCASE, selection.getRatesOverrideFlag(), selection.getTableName())));
                } else {
                    input.addAll(new ArrayList<>(Arrays.asList(selection.getRateDeductionLevelName(), VariableConstants.CUSTOMER_UPPERCASE,  selection.getRatesOverrideFlag(),selection.getTableName())));
                }
                input.add("%");
                input.add(parentDTO.getDeductionSID() == 0 ? "%" : parentDTO.getDeductionSID());
            ...
            case VariableConstants.BRAND_UPPERCASE:
                input.addAll(new ArrayList<>(Arrays.asList(selection.getRateDeductionLevelName(), VariableConstants.PRODUCT_UPPER, selection.getRatesOverrideFlag(),selection.getTableName())));
    ...
    public List getExcelResultList(AbstractSelectionDTO selection) {
        ...
        try {
            ...
            LOGGERFORRATESTAB.debug(list.size());
        } catch (Exception e) {
