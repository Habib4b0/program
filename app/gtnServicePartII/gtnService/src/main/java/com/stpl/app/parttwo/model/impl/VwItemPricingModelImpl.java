 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link VwItemPricingModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link VwItemPricingImpl}.
 * </p>
 *
 * @author
...
public class VwItemPricingModelImpl extends BaseModelImpl<VwItemPricing>
	...
	static {
		TABLE_COLUMNS_MAP.put("PRICING_CODE_QUALIFIER", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_PRICE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ITEM_PRICING_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("PRICING_CODE_STATUS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PRICING_CODE_QUALIFIER_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_PRICE_PRECISION", Types.INTEGER);
	}
	...
	private static final ClassLoader _classLoader = VwItemPricing.class.getClassLoader();
