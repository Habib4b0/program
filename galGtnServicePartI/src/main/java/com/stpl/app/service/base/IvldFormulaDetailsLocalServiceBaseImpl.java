...
import com.stpl.app.service.IvldFormulaDetailsLocalService;
...
/**
 * Provides the base implementation for the ivld formula details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldFormulaDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldFormulaDetailsLocalServiceImpl
 * @see com.stpl.app.service.IvldFormulaDetailsLocalServiceUtil
 * @generated
 */
public abstract class IvldFormulaDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements IvldFormulaDetailsLocalService,
        IdentifiableBean {
    ...
    private IvldFormulaDetailsLocalServiceClpInvoker _clpInvoker = new IvldFormulaDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldFormulaDetailsLocalServiceUtil} to access the ivld formula details local service.
     */
    ...
    @Override
    public IvldFormulaDetails addIvldFormulaDetails(
        IvldFormulaDetails ivldFormulaDetails) throws SystemException {
        ivldFormulaDetails.setNew(true);

        return ivldFormulaDetailsPersistence.update(ivldFormulaDetails);
    }
     ...
     */
    @Override
    public IvldFormulaDetails createIvldFormulaDetails(
        int ivldFormulaDetailsSid) {
        return ivldFormulaDetailsPersistence.create(ivldFormulaDetailsSid);
    }
    ...
    @Override
    public IvldFormulaDetails deleteIvldFormulaDetails(
        int ivldFormulaDetailsSid) throws PortalException, SystemException {
        return ivldFormulaDetailsPersistence.remove(ivldFormulaDetailsSid);
    }
    ...
    public IvldFormulaDetails deleteIvldFormulaDetails(
        IvldFormulaDetails ivldFormulaDetails) throws SystemException {
        return ivldFormulaDetailsPersistence.remove(ivldFormulaDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IvldFormulaDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return ivldFormulaDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldFormulaDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public IvldFormulaDetails fetchIvldFormulaDetails(int ivldFormulaDetailsSid)
        throws SystemException {
        return ivldFormulaDetailsPersistence.fetchByPrimaryKey(ivldFormulaDetailsSid);
    }
     ...
     */
    @Override
    public IvldFormulaDetails getIvldFormulaDetails(int ivldFormulaDetailsSid)
        throws PortalException, SystemException {
        return ivldFormulaDetailsPersistence.findByPrimaryKey(ivldFormulaDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ivldFormulaDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IvldFormulaDetails> getIvldFormulaDetailses(int start, int end)
        throws SystemException {
        return ivldFormulaDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIvldFormulaDetailsesCount() throws SystemException {
        return ivldFormulaDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IvldFormulaDetails updateIvldFormulaDetails(
        IvldFormulaDetails ivldFormulaDetails) throws SystemException {
        return ivldFormulaDetailsPersistence.update(ivldFormulaDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.IvldFormulaDetails",
            ivldFormulaDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.IvldFormulaDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ivldFormulaDetailsPersistence.getDataSource();
