...
public class Items extends CustomComponent {
    ...
    public Items(final BeanItemContainer<TempPricingDTO> saveContainer,
            final BeanItemContainer<VwContractPriceInfoDTO> itemDetailsResultsBean, final Map<String, String> itemMap, final boolean isEditable, final SessionDTO sessionDTO) {
    ...
    private void configureFields() {
        try {
          ...
          massField.addValueChangeListener(new Property.ValueChangeListener() {
            ...
            LOGGER.error(("Error in Configure Fields" + ex.getMessage()));
        }
    ...
    private void addDetailsTable() {
        try {
            ...
            itemDetailsTable.setFilterDecorator(new ExtDemoFilterDecorator());
             tempDate = new HashMap<>();
            itemDetailsTable.setTableFieldFactory(new IFPItemsTableGenerator(saveContainer,fieldFactoryDates,tempDate));
            ...
            itemDetailsTableLogic.setPageLength(6);
    ...
    private void configureBinder() {
        try {
            LOGGER.info("Entering Configure Binder ");
    ...
    private void configureFieldsForInfoTab() throws SystemException, Exception {
    ...
    public void createWorkSheetContent(final Integer start, final Integer end, final PrintWriter printWriter) throws SystemException, PortalException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        ...
        if (String.valueOf(level.getValue()).equals(Constants.DETAILS)) {
            ...
            List exportCompany = logic.getCustomizedPricingDTO(returnList, priceType, true, itemDetailsTableLogic.getRecord());
            ...
            List<Object[]> returnList = tableLogic.loadData(0, 0);
                        ...
                        public void buttonClicked(final ButtonId buttonId) {
                            if (ButtonId.YES.equals(buttonId)) {
                                try {
                                     ...
                                     List<TempPricingDTO> list = logic.getCustomizedPricingDTO(returnList, priceType, true, itemDetailsTableLogic.getRecord());
    ...
    public class DateValidator extends AbstractValidator{
        ...
        public void validate(final Object value) throws Validator.InvalidValueException {
            ...
            if (dates.length > 0) {
                ...
                if ("EndDate".equals(field) && endDate.getValue() != null) {
                    if (dates[1] != null && endDate.getValue().after((Date) dates[1])) {
