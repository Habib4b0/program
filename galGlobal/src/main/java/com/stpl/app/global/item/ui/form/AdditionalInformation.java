...
CommonSecurityLogic commonSecurityLogic = new CommonSecurityLogic();
     ...
     * @throws Exception 
     */
    public AdditionalInformation(final ErrorfulFieldGroup binder, final String mode) throws Exception {
        this.binder = binder;
        this.mode=mode;
    ...
    private void getResponsiveTab(Map<String, AppPermission> fieldItemHM) throws Exception {
