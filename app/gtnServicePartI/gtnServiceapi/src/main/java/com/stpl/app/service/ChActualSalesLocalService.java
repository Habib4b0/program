...
/**
 * Provides the local service interface for ChActualSales. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ChActualSalesLocalServiceUtil
...
public interface ChActualSalesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChActualSalesLocalServiceUtil} to access the ch actual sales local service. Add custom service methods to {@link com.stpl.app.service.impl.ChActualSalesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
