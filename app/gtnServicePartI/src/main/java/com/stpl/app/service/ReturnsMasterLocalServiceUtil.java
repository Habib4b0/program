...
public class ReturnsMasterLocalServiceUtil {
    private static ReturnsMasterLocalService _service;
    ...
    */
    ...
    public static ReturnsMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ReturnsMasterLocalService.class.getName());

            if (invokableLocalService instanceof ReturnsMasterLocalService) {
                _service = (ReturnsMasterLocalService) invokableLocalService;
            } else {
                _service = new ReturnsMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ReturnsMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ReturnsMasterLocalService service) {
    }
}
