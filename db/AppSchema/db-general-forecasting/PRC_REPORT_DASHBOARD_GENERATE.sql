...
ON P.YEAR = B.YEAR
AND P.PERIOD = B.PERIOD
AND P.PROJECTION_MASTER_SID = B.PROJECTION_MASTER_SID
LEFT JOIN  ',@CURRENT_TOTAL_EXFACTORY,' E
ON P.YEAR = E.YEAR
AND P.PERIOD = E.PERIOD
AND P.PROJECTION_MASTER_SID = E.PROJECTION_MASTER_SID
and E.CFF_MASTER_SID<>0
...
ON P.YEAR=C.YEAR AND P.PERIOD=C.PERIOD
AND P.PROJECTION_MASTER_SID = C.PROJECTION_MASTER_SID
')
