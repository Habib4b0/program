...
import com.stpl.app.parttwo.service.StAdjustmentReserveDetailLocalService;
...
/**
 * Provides the base implementation for the st adjustment reserve detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.StAdjustmentReserveDetailLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.StAdjustmentReserveDetailLocalServiceImpl
 * @see com.stpl.app.parttwo.service.StAdjustmentReserveDetailLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StAdjustmentReserveDetailLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements StAdjustmentReserveDetailLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.StAdjustmentReserveDetailLocalServiceUtil} to access the st adjustment reserve detail local service.
	 */
	...
	@Override
	public StAdjustmentReserveDetail addStAdjustmentReserveDetail(
		StAdjustmentReserveDetail stAdjustmentReserveDetail) {
		stAdjustmentReserveDetail.setNew(true);

		return stAdjustmentReserveDetailPersistence.update(stAdjustmentReserveDetail);
	}
	 ...
	 */
	@Override
	public StAdjustmentReserveDetail createStAdjustmentReserveDetail(
		String workflowId) {
		return stAdjustmentReserveDetailPersistence.create(workflowId);
	}
	...
	@Override
	public StAdjustmentReserveDetail deleteStAdjustmentReserveDetail(
		String workflowId) throws PortalException {
		return stAdjustmentReserveDetailPersistence.remove(workflowId);
	}
	...
	public StAdjustmentReserveDetail deleteStAdjustmentReserveDetail(
		StAdjustmentReserveDetail stAdjustmentReserveDetail) {
		return stAdjustmentReserveDetailPersistence.remove(stAdjustmentReserveDetail);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StAdjustmentReserveDetail.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stAdjustmentReserveDetailPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stAdjustmentReserveDetailPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StAdjustmentReserveDetail fetchStAdjustmentReserveDetail(
		String workflowId) {
		return stAdjustmentReserveDetailPersistence.fetchByPrimaryKey(workflowId);
	}
	 ...
	 */
	@Override
	public StAdjustmentReserveDetail getStAdjustmentReserveDetail(
		String workflowId) throws PortalException {
		return stAdjustmentReserveDetailPersistence.findByPrimaryKey(workflowId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stAdjustmentReserveDetailLocalService.deleteStAdjustmentReserveDetail((StAdjustmentReserveDetail)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stAdjustmentReserveDetailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StAdjustmentReserveDetail> getStAdjustmentReserveDetails(
		int start, int end) {
		return stAdjustmentReserveDetailPersistence.findAll(start, end);
	}
	...
	public int getStAdjustmentReserveDetailsCount() {
		return stAdjustmentReserveDetailPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StAdjustmentReserveDetail updateStAdjustmentReserveDetail(
		StAdjustmentReserveDetail stAdjustmentReserveDetail) {
		return stAdjustmentReserveDetailPersistence.update(stAdjustmentReserveDetail);
	}
	 ...
	 */
	public StAdjustmentReserveDetailLocalService getStAdjustmentReserveDetailLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.StAdjustmentReserveDetail",
			stAdjustmentReserveDetailLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.StAdjustmentReserveDetail");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StAdjustmentReserveDetailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stAdjustmentReserveDetailPersistence.getDataSource();
	...
	@BeanReference(type = StAdjustmentReserveDetailLocalService.class)
	protected StAdjustmentReserveDetailLocalService stAdjustmentReserveDetailLocalService;
