...
/**
 * The persistence utility for the udcs service. This utility wraps {@link com.stpl.app.service.persistence.impl.UdcsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @author
 * @see UdcsPersistence
 * @see com.stpl.app.service.persistence.impl.UdcsPersistenceImpl
 * @generated
 */
@ProviderType
public class UdcsUtil {
	 ...
	 */
	public static List<Udcs> findWithDynamicQuery(DynamicQuery dynamicQuery,
		int start, int end, OrderByComparator<Udcs> orderByComparator) {
	 ...
	 */
	public static Udcs update(Udcs udcs) {
	...
	* @param udcs the udcs
	*/
	public static void cacheResult(Udcs udcs) {
	...
	*/
	public static void cacheResult(List<Udcs> udcses) {
	...
	* @return the new udcs
	*/
	public static Udcs create(int udcsSid) {
	...
	*/
	public static Udcs remove(int udcsSid)
		throws com.stpl.app.exception.NoSuchUdcsException {
		return getPersistence().remove(udcsSid);
	}

	public static Udcs updateImpl(Udcs udcs) {
	...
	* @throws NoSuchUdcsException if a udcs with the primary key could not be found
	*/
	public static Udcs findByPrimaryKey(int udcsSid)
		throws com.stpl.app.exception.NoSuchUdcsException {
	...
	*/
	public static Udcs fetchByPrimaryKey(int udcsSid) {
		return getPersistence().fetchByPrimaryKey(udcsSid);
	}

	public static java.util.Map<java.io.Serializable, Udcs> fetchByPrimaryKeys(
	...
	* @return the udcses
	*/
	public static List<Udcs> findAll() {
	...
	*/
	public static List<Udcs> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<UdcsPersistence, UdcsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(UdcsPersistence.class);
}