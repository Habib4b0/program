...
public class HelperListUtil {
     ...
     * The object.
     */
    private static com.stpl.app.galworkflow.util.HelperListUtil object;
     ...
     */
    public static com.stpl.app.galworkflow.util.HelperListUtil getInstance() {
        if (object == null) {
            object = new com.stpl.app.galworkflow.util.HelperListUtil();
        }
        return object;
    }
