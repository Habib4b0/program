 ...
 */
    public Component getContent(ErrorfulFieldGroup binder, final BeanItemContainer<CompanyMasterDTO> tradeClassResultsBean, SessionDTO sessionDTO) {
        ...
        try {
            ...
            final Map<String, AppPermission> fieldCompanyHM = stplSecurity.getFieldOrColumnPermission(userId, UISecurityUtil.COMPANY_MASTER+ConstantsUtils.COMMA+"Company Trade Class",false);
            final Map<String, AppPermission> functionHM = stplSecurity.getBusinessFunctionPermission(userId, UISecurityUtil.COMPANY_MASTER+ConstantsUtils.COMMA+"Company Trade Class");
    ...
    private void configurePermission(final Map<String, AppPermission> fieldCompanyHM, final Map<String, AppPermission> functionHM) {
        ...
        List<Object> resultList = ifpLogic.getFieldsForSecurity(UISecurityUtil.COMPANY_MASTER,"Company Trade Class");
        ...
        removeButton.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                ...
                if (list == null || list.isEmpty()) {
                    binder.getErrorDisplay().setError("Add at least one Trade Class in Company Trade Class tab");
                } else if (!flag) {
    ...
    public void addResponsiveVerticalTabFourLayout(final VerticalLayout verticalLayout) {
        reloadVerticalLayoutTabFourMap.put(1516, true);
        reloadVerticalLayoutTabFourMap.put(1300, true);
        reloadVerticalLayoutTabFourMap.put(1024, true);
        reloadVerticalLayoutTabFourMap.put(978, true);
        reloadVerticalLayoutTabFourMap.put(800, true);
        reloadVerticalLayoutTabFourMap.put(480, true);
        reloadVerticalLayoutTabFourMap.put(380, true);
        ...
        Page.getCurrent().addBrowserWindowResizeListener(
                new Page.BrowserWindowResizeListener() {
                    ...
                    public void browserWindowResized(
                        ...
                        if (browserWidth > 1516 && reloadVerticalLayoutTabFourMap.get(1516)) {
                            reloadVerticalLayoutTabFourMap.put(1516, false);
                            reloadVerticalLayoutTabFourMap.put(1300, true);
                            reloadVerticalLayoutTabFourMap.put(1024, true);
                            reloadVerticalLayoutTabFourMap.put(978, true);
                            reloadVerticalLayoutTabFourMap.put(800, true);
                        ...
                        } else if (browserWidth < 1516 && browserWidth > 1300 && reloadVerticalLayoutTabFourMap.get(1300)) {
                            reloadVerticalLayoutTabFourMap.put(1516, true);
                            reloadVerticalLayoutTabFourMap.put(1300, false);
                            reloadVerticalLayoutTabFourMap.put(1024, true);
                            reloadVerticalLayoutTabFourMap.put(978, true);
                            reloadVerticalLayoutTabFourMap.put(800, true);
                            reloadVerticalLayoutTabFourMap.put(480, true);
                            ...
                            reloadVerticalLayoutTabFourMap.put(0, true);
                            getCollapsibleColumnsDefault(resultTable);
                        } else if (browserWidth < 1300 && browserWidth > 1024 && reloadVerticalLayoutTabFourMap.get(1024)) {
                            reloadVerticalLayoutTabFourMap.put(1516, true);
                            reloadVerticalLayoutTabFourMap.put(1300, true);
                            reloadVerticalLayoutTabFourMap.put(1024, false);
                            reloadVerticalLayoutTabFourMap.put(978, true);
                            reloadVerticalLayoutTabFourMap.put(800, true);
                            reloadVerticalLayoutTabFourMap.put(480, true);
                            reloadVerticalLayoutTabFourMap.put(380, true);
                            reloadVerticalLayoutTabFourMap.put(0, true);
                            getCollapsibleColumnsDefault(resultTable);
                        } else if (browserWidth < 1024 && browserWidth > 978 && reloadVerticalLayoutTabFourMap.get(978)) {
                            reloadVerticalLayoutTabFourMap.put(1516, true);
                            reloadVerticalLayoutTabFourMap.put(1300, true);
                            reloadVerticalLayoutTabFourMap.put(1024, true);
                            reloadVerticalLayoutTabFourMap.put(978, false);
                            reloadVerticalLayoutTabFourMap.put(800, true);
                            reloadVerticalLayoutTabFourMap.put(480, true);
                            reloadVerticalLayoutTabFourMap.put(380, true);
                            reloadVerticalLayoutTabFourMap.put(0, true);
                        } else if (browserWidth < 978 && browserWidth > 800 && reloadVerticalLayoutTabFourMap.get(800)) {
                            reloadVerticalLayoutTabFourMap.put(1516, true);
                            reloadVerticalLayoutTabFourMap.put(1300, true);
                            reloadVerticalLayoutTabFourMap.put(1024, true);
                            reloadVerticalLayoutTabFourMap.put(978, true);
                            reloadVerticalLayoutTabFourMap.put(800, false);
                            reloadVerticalLayoutTabFourMap.put(480, true);
                            reloadVerticalLayoutTabFourMap.put(380, true);
                            reloadVerticalLayoutTabFourMap.put(0, true);

                        } else if (browserWidth <= 800 && browserWidth > 480 && reloadVerticalLayoutTabFourMap.get(480)) {
                            reloadVerticalLayoutTabFourMap.put(1516, true);
                            reloadVerticalLayoutTabFourMap.put(1300, true);
                            reloadVerticalLayoutTabFourMap.put(1024, true);
                            reloadVerticalLayoutTabFourMap.put(978, true);
                            reloadVerticalLayoutTabFourMap.put(800, true);
                            reloadVerticalLayoutTabFourMap.put(480, false);
                            reloadVerticalLayoutTabFourMap.put(380, true);
                            reloadVerticalLayoutTabFourMap.put(0, true);
                        } else if (browserWidth < 480 && browserWidth > 380 && reloadVerticalLayoutTabFourMap.get(380)) {
                            reloadVerticalLayoutTabFourMap.put(1516, true);
                            reloadVerticalLayoutTabFourMap.put(1300, true);
                            reloadVerticalLayoutTabFourMap.put(1024, true);
                            reloadVerticalLayoutTabFourMap.put(978, true);
                            reloadVerticalLayoutTabFourMap.put(800, true);
                            reloadVerticalLayoutTabFourMap.put(480, true);
                            reloadVerticalLayoutTabFourMap.put(380, false);
                            reloadVerticalLayoutTabFourMap.put(0, true);
                            getCollapsibleOneColumn(resultTable);
                        } else if (browserWidth < 380 && reloadVerticalLayoutTabFourMap.get(0)) {
                            reloadVerticalLayoutTabFourMap.put(1516, true);
                            reloadVerticalLayoutTabFourMap.put(1300, true);
                            reloadVerticalLayoutTabFourMap.put(1024, true);
                            reloadVerticalLayoutTabFourMap.put(978, true);
