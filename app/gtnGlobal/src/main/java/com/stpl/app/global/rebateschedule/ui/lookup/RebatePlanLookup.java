...
import com.stpl.app.global.rebateschedule.logic.tablelogic.RebatePlanTableLogic;
...
public class RebatePlanLookup extends Window {
     ...
     */
    private void init() {
        setContent(Clara.create(getClass().getResourceAsStream("/clara/rebateschedule/rebate-plan-lookup.xml"), this));
        configureFields();
        configureBinder();        
        configureTable();
    }
    ...
    private void configureFields() {      
        ...
        RsUtils.loadRebatePlanLookupColumnMap();
    ...
    */
    ...
    public void resetLogic(Button.ClickEvent event){
        ...
        tableLogic.clearAll();
        tableLogic.resetData(binder, true);
    }
    ...
    private void createWorkSheet() {
        ...
        final long recordCount = (Integer) rebateScheduleLogic.loadRebatePlan(rebatePlanDTO,0,0,true,null,null);
        ExcelExportforBB.createWorkSheet(resultsTable.getColumnHeaders(), recordCount, this, getUI(), "Rebate_Plan_No");
    ...
    public void createWorkSheetContent(final Integer start, final Integer end, final PrintWriter printWriter) {
       ...
       List<RebatePlanDTO> resultList = (List<RebatePlanDTO>) rebateScheduleLogic.loadRebatePlan(rebatePlanDTO,start,end,false,null,null); 
        ...
        for (int rowCount = 0; rowCount < resultList.size(); rowCount++) {
            ...
            printWriter.print(QUOTE + (dto.getRebatePlanType()) + QUOTE + ExcelExportUtil.COMMA);
