...
public class DashboardView extends VerticalLayout implements View {
     ...
     */
    public DashboardView(final SessionDTO sessionDTO) throws SystemException, PortalException {
        super();
        addStyleName("bootstrap");
        addStyleName("bootstrap-bb");
        LOGGER.debug("Entering DashboardView ");
        setSpacing(true);
        this.sessionDTO=sessionDTO;
        addComponent(new DashBoardForm(this.sessionDTO));
        LOGGER.debug("End of DashboardView ");
    }
    ...
    public void enter(final ViewChangeEvent event) {
        LOGGER.debug("Entering  DashboardView enter method");
        LOGGER.debug("End of DashboardView enter method");
    }
}
