...
public class SearchResultsDTO implements Serializable {
    ...
    private String dcCreationDate;
    private String dcCreatedBy = StringUtils.EMPTY;
    private String dcModifiedDate;
 ...
 public boolean isRecordLockStatus() {
  return recordLockStatus;
    ...
    public String getDcCreationDate() {
        return dcCreationDate;
    }

    public void setDcCreationDate(String dcCreationDate) {
    ...
    public String getDcModifiedDate() {
        return dcModifiedDate;
    }

    public void setDcModifiedDate(String dcModifiedDate) {
