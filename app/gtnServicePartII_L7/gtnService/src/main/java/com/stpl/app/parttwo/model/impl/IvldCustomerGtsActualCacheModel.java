...
public class IvldCustomerGtsActualCacheModel implements CacheModel<IvldCustomerGtsActual>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldCustomerGtsActualCacheModel)) {
			return false;
		}

		IvldCustomerGtsActualCacheModel ivldCustomerGtsActualCacheModel = (IvldCustomerGtsActualCacheModel)obj;

		if (ivldCustomerGtsActualSid == ivldCustomerGtsActualCacheModel.ivldCustomerGtsActualSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldCustomerGtsActualSid);
	}
