...
/**
 * The persistence utility for the st selection table service. This utility wraps {@link com.stpl.app.service.persistence.impl.StSelectionTablePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.stpl.app.service.persistence.impl.StSelectionTablePersistenceImpl
 * @generated
 */
@ProviderType
public class StSelectionTableUtil {
	...
	*/
	public static void cacheResult(StSelectionTable stSelectionTable) {
	...
	*/
	public static void cacheResult(List<StSelectionTable> stSelectionTables) {
	...
	*/
	public static StSelectionTable create(StSelectionTablePK stSelectionTablePK) {
	...
	*/
	public static StSelectionTable remove(StSelectionTablePK stSelectionTablePK)
		throws com.stpl.app.exception.NoSuchStSelectionTableException {
		return getPersistence().remove(stSelectionTablePK);
	}

	public static StSelectionTable updateImpl(StSelectionTable stSelectionTable) {
	...
	* @throws NoSuchStSelectionTableException if a st selection table with the primary key could not be found
	*/
	public static StSelectionTable findByPrimaryKey(
	...
	*/
	public static StSelectionTable fetchByPrimaryKey(
		StSelectionTablePK stSelectionTablePK) {
		return getPersistence().fetchByPrimaryKey(stSelectionTablePK);
	}

	public static java.util.Map<java.io.Serializable, StSelectionTable> fetchByPrimaryKeys(
	...
	*/
	public static List<StSelectionTable> findAll() {
	...
	*/
	public static List<StSelectionTable> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<StSelectionTablePersistence, StSelectionTablePersistence> _serviceTracker =
		ServiceTrackerFactory.open(StSelectionTablePersistence.class);
}