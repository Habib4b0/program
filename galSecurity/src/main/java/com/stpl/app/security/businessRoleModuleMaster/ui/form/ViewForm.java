...
public class ViewForm extends CustomComponent implements View {
	...
	public ViewForm(BusinessRoleModuleMasterDTO salesMasterDTO, ErrorfulFieldGroup binder) {
		...
		this.binder = binder;
		// this.binder=this.binder.setReadOnly(true);
		init();
	...
	private void addToContent() {
		...
		content.addComponent(space);
//		content.addComponent(new EditActionButtonLayout(getBinder()));

		setCompositionRoot(content);
	}

	private GridLayout addToGrid() {
		GridLayout grid = new GridLayout(3, 12);
		grid.setWidth(null);
...
//		isActive.addItem("Yes");
//		isActive.addItem("No");
		
//		salesId.addValidator(new RegexpValidator(
//				ValidationUtils.specialCharacter,
//				ValidationUtils.specialCharacter_Message));
//		salesId.setImmediate(true);
//		salesId.setValidationVisible(true);
//		salesId.setRequired(true);
//		salesId.setRequiredError("Sales Id is required");
//		
//		itemNo.setImmediate(true);
//		itemNo.setValidationVisible(true);
//		itemNo.addValidator(new RegexpValidator(
//				ValidationUtils.specialCharacter,
//				ValidationUtils.specialCharacter_Message));
//		itemNo.setRequired(true);
//		itemNo.setRequiredError("Item No should  be present");
//
//		itemId.setImmediate(true);
//		itemId.setValidationVisible(true);
//		itemId.addValidator(new RegexpValidator(
//				ValidationUtils.specialCharacter,
//				ValidationUtils.specialCharacter_Message));
//		itemId.setRequired(true);
//		itemId.setRequiredError("Item Id should  be present");

	}

	// private Container getQualifierItems() {
	// List<HelperDTO> helperLst = ItemSearchLogic.getItemQualifier();
	...
	public void enter(ViewChangeEvent event) {
		...
		//
		// String
		// systemId=(String)VaadinSession.getCurrent().getAttribute("systemId");
		//
		...
		//
		// itemMasterDTO =
		// itemLogic.getItemMasterById(Integer.valueOf(systemId));
