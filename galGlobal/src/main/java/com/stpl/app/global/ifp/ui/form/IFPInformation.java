...
public class IFPInformation extends CustomComponent {
    ...
    public IFPInformation(final ErrorfulFieldGroup binder, final ItemFamilyplanMasterDTO ifpMaster, final String mode) throws Exception {
    ...
    private void configureFields() throws SystemException, Exception {
        ...
        parentItemFamilyplanId.addClickListener(new CustomTextField.ClickListener() {
            ...
            public void click(final CustomTextField.ClickEvent event) {
                try {
                    if(lookUp==null){
                    LOGGER.info("Entering parent Item Family plan Id look up");
                    ...
                    lookUp.addCloseListener(new Window.CloseListener() {
                        ...
                        public void windowClose(final Window.CloseEvent e) {
                            ...
                            parentItemFamilyplanName.setReadOnly(true);
                            lookUp=null;
                            LOGGER.info("Ending parent Item Family plan Id look up");
                        }
                    });
    ...
    public void resetBinder(ItemFamilyplanMasterDTO dto) throws Exception {
