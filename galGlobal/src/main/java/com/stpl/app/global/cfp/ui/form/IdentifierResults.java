...
public final class IdentifierResults extends CustomComponent {
	...
	private void init() {
		try {
			LOGGER.info("Entering IdentifierResults init");
			space.setHeight(ConstantsUtils.HEIGHT);
			binder.bindMemberFields(this);
			addToContent();
			configureFields();
			LOGGER.info("Ending IdentifierResults init");
	...
	private void addToContent() {
		LOGGER.info("Entering IdentifierResults addToContent");
		...
		LOGGER.info("Ending IdentifierResults addToContent");
	}
	...
	private GridLayout addToGrid() {
		LOGGER.info("Entering IdentifierResults addToGrid");
		...
		LOGGER.info("Ending IdentifierResults addToGrid");
		return grid;
	}
	...
	private Table addToTable() {
		LOGGER.info("Entering IdentifierResults addToTable");
		...
		LOGGER.info("Ending IdentifierResults addToTable");
		return table;
	}
	...
	public Button populateButton() {
		...
		btnPopulate.addClickListener(new ClickListener() {
			...
			public void buttonClick(final ClickEvent event) {
				try {
					LOGGER.info("Entering inside IdentifierResults POPULATE  method ");
					binder.commit();
					...
					LOGGER.info("Ending IdentifierResults POPULATE  method ");
	...
	public void configureFields() throws PortalException, SystemException, Exception {
		LOGGER.info("Entering IdentifierResults configureFields");
		...
		LOGGER.info("Ending IdentifierResults configureFields");
	}
