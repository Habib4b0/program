...
import com.stpl.app.service.ContractMasterLocalService;
...
/**
 * Provides the base implementation for the contract master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ContractMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class ContractMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ContractMasterLocalService,
        IdentifiableBean {
    ...
    private ContractMasterLocalServiceClpInvoker _clpInvoker = new ContractMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ContractMasterLocalServiceUtil} to access the contract master local service.
     */
    ...
    @Override
    public ContractMaster addContractMaster(ContractMaster contractMaster)
        throws SystemException {
        contractMaster.setNew(true);

        return contractMasterPersistence.update(contractMaster);
    }
     ...
     */
    @Override
    public ContractMaster createContractMaster(int contractMasterSid) {
        return contractMasterPersistence.create(contractMasterSid);
    }
    ...
    @Override
    public ContractMaster deleteContractMaster(int contractMasterSid)
        throws PortalException, SystemException {
        return contractMasterPersistence.remove(contractMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ContractMaster deleteContractMaster(ContractMaster contractMaster)
        throws SystemException {
        return contractMasterPersistence.remove(contractMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ContractMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return contractMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return contractMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ContractMaster fetchContractMaster(int contractMasterSid)
        throws SystemException {
        return contractMasterPersistence.fetchByPrimaryKey(contractMasterSid);
    }
     ...
     */
    @Override
    public ContractMaster getContractMaster(int contractMasterSid)
        throws PortalException, SystemException {
        return contractMasterPersistence.findByPrimaryKey(contractMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return contractMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ContractMaster> getContractMasters(int start, int end)
        throws SystemException {
        return contractMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getContractMastersCount() throws SystemException {
        return contractMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ContractMaster updateContractMaster(ContractMaster contractMaster)
        throws SystemException {
        return contractMasterPersistence.update(contractMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ContractMaster",
            contractMasterLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = contractMasterPersistence.getDataSource();
