...
public class StChActualDiscountLocalServiceUtil {
    private static StChActualDiscountLocalService _service;
    ...
    */
    ...
    public static StChActualDiscountLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StChActualDiscountLocalService.class.getName());

            if (invokableLocalService instanceof StChActualDiscountLocalService) {
                _service = (StChActualDiscountLocalService) invokableLocalService;
            } else {
                _service = new StChActualDiscountLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StChActualDiscountLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StChActualDiscountLocalService service) {
    }
}
