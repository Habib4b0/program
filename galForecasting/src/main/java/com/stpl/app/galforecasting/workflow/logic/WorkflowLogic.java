 ...
 */
package com.stpl.app.galforecasting.workflow.logic;
...
import com.stpl.app.galforecasting.dao.impl.WorkFlowLogicDaoImpl;
...
import com.stpl.app.galforecasting.utils.BPIWorkFlowGeneratorXML;
...
public class WorkflowLogic {
     ...
     * @return
     */
    public String updateWorkflowFromForecast(int projectionId, String notes, String userId) throws Exception {
     ...
     */
    public void mailNotificationArchive(String workflowId, String approveORsubmit) throws Exception {
        ...
        try {
            ...
            st.setString(2, ccEmailId);
            st.setString(3, null);
            st.setString(4, subject);
            st.setString(5, tableBody);
            st.setString(6, null);
            st.execute();
