 ...
 * @generated
 */
public class IvldItemHierarchyLocalServiceClp
    ...
    public IvldItemHierarchyLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addIvldItemHierarchy";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.IvldItemHierarchy"
            };

        _methodName1 = "createIvldItemHierarchy";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteIvldItemHierarchy";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteIvldItemHierarchy";
        ...
        _methodName10 = "fetchIvldItemHierarchy";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getIvldItemHierarchy";
        ...
        _methodName13 = "getIvldItemHierarchies";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getIvldItemHierarchiesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateIvldItemHierarchy";
    ...
    public com.stpl.app.model.IvldItemHierarchy addIvldItemHierarchy(
        ...
        return (com.stpl.app.model.IvldItemHierarchy) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.IvldItemHierarchy createIvldItemHierarchy(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ivldItemHierarchySid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.IvldItemHierarchy> getIvldItemHierarchies(
        ...
        return (java.util.List<com.stpl.app.model.IvldItemHierarchy>) ClpSerializer.translateOutput(returnObj);
    }
