...
/**
 * The persistence utility for the st ch assumptions service. This utility wraps {@link StChAssumptionsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StChAssumptionsUtil {
    private static StChAssumptionsPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.StChAssumptions create(
    ...
    */
    public static com.stpl.app.model.StChAssumptions remove(
        StChAssumptionsPK stChAssumptionsPK)
    ...
    public static com.stpl.app.model.StChAssumptions updateImpl(
        com.stpl.app.model.StChAssumptions stChAssumptions)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.StChAssumptions findByPrimaryKey(
        StChAssumptionsPK stChAssumptionsPK)
        throws com.stpl.app.NoSuchStChAssumptionsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.StChAssumptions fetchByPrimaryKey(
        StChAssumptionsPK stChAssumptionsPK)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.StChAssumptions> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static StChAssumptionsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (StChAssumptionsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    StChAssumptionsPersistence.class.getName());

            ReferenceRegistry.registerReference(StChAssumptionsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(StChAssumptionsPersistence persistence) {
    }
}
