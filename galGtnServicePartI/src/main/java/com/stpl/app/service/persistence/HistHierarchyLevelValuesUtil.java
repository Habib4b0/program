...
/**
 * The persistence utility for the hist hierarchy level values service. This utility wraps {@link HistHierarchyLevelValuesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class HistHierarchyLevelValuesUtil {
    private static HistHierarchyLevelValuesPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.HistHierarchyLevelValues create(
    ...
    */
    public static com.stpl.app.model.HistHierarchyLevelValues remove(
        HistHierarchyLevelValuesPK histHierarchyLevelValuesPK)
    ...
    public static com.stpl.app.model.HistHierarchyLevelValues updateImpl(
        com.stpl.app.model.HistHierarchyLevelValues histHierarchyLevelValues)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.HistHierarchyLevelValues findByPrimaryKey(
        HistHierarchyLevelValuesPK histHierarchyLevelValuesPK)
        throws com.stpl.app.NoSuchHistHierarchyLevelValuesException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.HistHierarchyLevelValues fetchByPrimaryKey(
        HistHierarchyLevelValuesPK histHierarchyLevelValuesPK)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.HistHierarchyLevelValues> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static HistHierarchyLevelValuesPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (HistHierarchyLevelValuesPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    HistHierarchyLevelValuesPersistence.class.getName());

            ReferenceRegistry.registerReference(HistHierarchyLevelValuesUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(HistHierarchyLevelValuesPersistence persistence) {
    }
}
