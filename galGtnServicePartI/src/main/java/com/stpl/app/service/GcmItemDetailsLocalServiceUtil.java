...
public class GcmItemDetailsLocalServiceUtil {
    private static GcmItemDetailsLocalService _service;
    ...
    */
    ...
    public static GcmItemDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    GcmItemDetailsLocalService.class.getName());

            if (invokableLocalService instanceof GcmItemDetailsLocalService) {
                _service = (GcmItemDetailsLocalService) invokableLocalService;
            } else {
                _service = new GcmItemDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(GcmItemDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(GcmItemDetailsLocalService service) {
    }
}
