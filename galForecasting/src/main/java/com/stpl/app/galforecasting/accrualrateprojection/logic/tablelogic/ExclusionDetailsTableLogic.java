...
public class ExclusionDetailsTableLogic  extends PageTableLogic {
    ...
    public int getCount() {
        ...
        switch (tableName) {           
            ...
            case AccrualRateUtils.EXCLUDED_VALUES:    
                 count = searchLogic.getExcludedCompanysCount(accrualRateSelectionDTO,this.getSortByColumns(), this.getFilters());
                break;           
            default:
    ...
    public List loadData(int start, int offset) {
        ...
        switch (tableName) {           
            ...
            list = searchLogic.getAvalableValues(this.getSortByColumns(), this.getFilters(),start,offset);          
                break;
            case AccrualRateUtils.EXCLUDED_VALUES:   
                 list = searchLogic.getExcluededCompanys(accrualRateSelectionDTO,this.getSortByColumns(), this.getFilters(),start,offset);  
                break;           
            default:
                LOGGER.warn("Count - Table Name is not valid: " + tableName);
                break;
    ...
    public Object configureContainer(Object object, Container container) {
     ...
     public void setRequiredData(final String tableName, final AccrualRateSelectionDTO accrualRateSelectionDTO) {        
