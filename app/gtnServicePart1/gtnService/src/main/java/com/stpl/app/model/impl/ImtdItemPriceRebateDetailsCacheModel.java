...
public class ImtdItemPriceRebateDetailsCacheModel implements CacheModel<ImtdItemPriceRebateDetails>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ImtdItemPriceRebateDetailsCacheModel)) {
			return false;
		}

		ImtdItemPriceRebateDetailsCacheModel imtdItemPriceRebateDetailsCacheModel =
			(ImtdItemPriceRebateDetailsCacheModel)obj;

		if (imtdItemPriceRebateSid == imtdItemPriceRebateDetailsCacheModel.imtdItemPriceRebateSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, imtdItemPriceRebateSid);
	}
