...
/**
 * The persistence utility for the m assumptions service. This utility wraps {@link com.stpl.app.service.persistence.impl.MAssumptionsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class MAssumptionsUtil {
	...
	*/
	public static void cacheResult(MAssumptions mAssumptions) {
	...
	*/
	public static void cacheResult(List<MAssumptions> mAssumptionses) {
	...
	*/
	public static MAssumptions create(int mAssumptionsSid) {
	...
	*/
	public static MAssumptions remove(int mAssumptionsSid)
		throws com.stpl.app.exception.NoSuchMAssumptionsException {
		return getPersistence().remove(mAssumptionsSid);
	}

	public static MAssumptions updateImpl(MAssumptions mAssumptions) {
	...
	* @throws NoSuchMAssumptionsException if a m assumptions with the primary key could not be found
	*/
	public static MAssumptions findByPrimaryKey(int mAssumptionsSid)
		throws com.stpl.app.exception.NoSuchMAssumptionsException {
	...
	*/
	public static MAssumptions fetchByPrimaryKey(int mAssumptionsSid) {
		return getPersistence().fetchByPrimaryKey(mAssumptionsSid);
	}

	public static java.util.Map<java.io.Serializable, MAssumptions> fetchByPrimaryKeys(
	...
	*/
	public static List<MAssumptions> findAll() {
	...
	*/
	public static List<MAssumptions> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<MAssumptionsPersistence, MAssumptionsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(MAssumptionsPersistence.class);
}