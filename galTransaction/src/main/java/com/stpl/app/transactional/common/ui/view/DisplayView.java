...
public class DisplayView extends VerticalLayout implements View {
     ...
     * The Constructor.
     */
    public DisplayView() throws PortalException, SystemException, Exception {
        super();
        try {
            LOGGER.info("Entering ForecastEditView");
        ...
        LOGGER.info("Ends ForecastEditView");
    }
