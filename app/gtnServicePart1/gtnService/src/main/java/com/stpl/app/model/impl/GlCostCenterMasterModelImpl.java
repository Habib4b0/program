 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link GlCostCenterMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link GlCostCenterMasterImpl}.
 * </p>
 *
 * @author
...
public class GlCostCenterMasterModelImpl extends BaseModelImpl<GlCostCenterMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("GL_COST_CENTER_MASTER_SID", Types.INTEGER);
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.stpl.app.service.util.PropsUtil.get(
			...
			true);
	public static final long COMPANYCODE_COLUMN_BITMASK = 1L;
	public static final long COMPANYCOSTCENTER_COLUMN_BITMASK = 2L;
	public static final long NDC8_COLUMN_BITMASK = 4L;
	public static final long GLCOSTCENTERMASTERSID_COLUMN_BITMASK = 8L;
	...
	private static final ClassLoader _classLoader = GlCostCenterMaster.class.getClassLoader();
