...
public class RsModelCacheModel implements CacheModel<RsModel>, Externalizable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RsModelCacheModel)) {
			return false;
		}

		RsModelCacheModel rsModelCacheModel = (RsModelCacheModel)obj;

		if (rsModelSid == rsModelCacheModel.rsModelSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, rsModelSid);
	}
