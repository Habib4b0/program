...
public abstract class ContractAliasMasterLocalServiceBaseImpl
    ...
    private ContractAliasMasterLocalServiceClpInvoker _clpInvoker = new ContractAliasMasterLocalServiceClpInvoker();
    ...
    public ContractAliasMaster deleteContractAliasMaster(
        int contractAliasMasterSid) throws PortalException, SystemException {
    ...
    public ContractAliasMaster fetchContractAliasMaster(
        int contractAliasMasterSid) throws SystemException {
     ...
     */
    @Override
    public int getContractAliasMastersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ContractAliasMaster",
