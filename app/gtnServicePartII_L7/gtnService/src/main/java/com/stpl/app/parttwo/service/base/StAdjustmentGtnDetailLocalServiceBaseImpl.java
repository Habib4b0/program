...
import com.stpl.app.parttwo.service.StAdjustmentGtnDetailLocalService;
...
/**
 * Provides the base implementation for the st adjustment gtn detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.StAdjustmentGtnDetailLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.StAdjustmentGtnDetailLocalServiceImpl
 * @see com.stpl.app.parttwo.service.StAdjustmentGtnDetailLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StAdjustmentGtnDetailLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StAdjustmentGtnDetailLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.StAdjustmentGtnDetailLocalServiceUtil} to access the st adjustment gtn detail local service.
	 */
	...
	@Override
	public StAdjustmentGtnDetail addStAdjustmentGtnDetail(
		StAdjustmentGtnDetail stAdjustmentGtnDetail) {
		stAdjustmentGtnDetail.setNew(true);

		return stAdjustmentGtnDetailPersistence.update(stAdjustmentGtnDetail);
	}
	 ...
	 */
	@Override
	public StAdjustmentGtnDetail createStAdjustmentGtnDetail(String workflowId) {
		return stAdjustmentGtnDetailPersistence.create(workflowId);
	}
	...
	@Override
	public StAdjustmentGtnDetail deleteStAdjustmentGtnDetail(String workflowId)
		throws PortalException {
		return stAdjustmentGtnDetailPersistence.remove(workflowId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StAdjustmentGtnDetail deleteStAdjustmentGtnDetail(
		StAdjustmentGtnDetail stAdjustmentGtnDetail) {
		return stAdjustmentGtnDetailPersistence.remove(stAdjustmentGtnDetail);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StAdjustmentGtnDetail.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stAdjustmentGtnDetailPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stAdjustmentGtnDetailPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StAdjustmentGtnDetail fetchStAdjustmentGtnDetail(String workflowId) {
		return stAdjustmentGtnDetailPersistence.fetchByPrimaryKey(workflowId);
	}
	 ...
	 */
	@Override
	public StAdjustmentGtnDetail getStAdjustmentGtnDetail(String workflowId)
		throws PortalException {
		return stAdjustmentGtnDetailPersistence.findByPrimaryKey(workflowId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stAdjustmentGtnDetailLocalService.deleteStAdjustmentGtnDetail((StAdjustmentGtnDetail)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stAdjustmentGtnDetailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StAdjustmentGtnDetail> getStAdjustmentGtnDetails(int start,
		int end) {
		return stAdjustmentGtnDetailPersistence.findAll(start, end);
	}
	...
	public int getStAdjustmentGtnDetailsCount() {
		return stAdjustmentGtnDetailPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StAdjustmentGtnDetail updateStAdjustmentGtnDetail(
		StAdjustmentGtnDetail stAdjustmentGtnDetail) {
		return stAdjustmentGtnDetailPersistence.update(stAdjustmentGtnDetail);
	}
	 ...
	 */
	public StAdjustmentGtnDetailLocalService getStAdjustmentGtnDetailLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.StAdjustmentGtnDetail",
			stAdjustmentGtnDetailLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StAdjustmentGtnDetailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stAdjustmentGtnDetailPersistence.getDataSource();
	...
	@BeanReference(type = StAdjustmentGtnDetailLocalService.class)
	protected StAdjustmentGtnDetailLocalService stAdjustmentGtnDetailLocalService;
