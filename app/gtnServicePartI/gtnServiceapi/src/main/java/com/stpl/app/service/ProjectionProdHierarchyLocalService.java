...
public interface ProjectionProdHierarchyLocalService extends BaseLocalService,
	...
	*/
	...
	public ProjectionProdHierarchy addProjectionProdHierarchy(
	...
	*/
	public ProjectionProdHierarchy createProjectionProdHierarchy(
	...
	*/
	...
	public ProjectionProdHierarchy deleteProjectionProdHierarchy(
		int projectionProdHierarchySid) throws PortalException;
	...
	*/
	...
	public ProjectionProdHierarchy fetchProjectionProdHierarchy(
		int projectionProdHierarchySid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProjectionProdHierarchy> getProjectionProdHierarchies(
		int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectionProdHierarchy getProjectionProdHierarchy(
		int projectionProdHierarchySid) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ProjectionProdHierarchy updateProjectionProdHierarchy(
		ProjectionProdHierarchy projectionProdHierarchy);
}