...
import com.stpl.app.service.MedicaidUraProjLocalService;
...
/**
 * Provides the base implementation for the medicaid ura proj local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.MedicaidUraProjLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.MedicaidUraProjLocalServiceImpl
 * @see com.stpl.app.service.MedicaidUraProjLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class MedicaidUraProjLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MedicaidUraProjLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.MedicaidUraProjLocalServiceUtil} to access the medicaid ura proj local service.
	 */
	...
	@Override
	public MedicaidUraProj addMedicaidUraProj(MedicaidUraProj medicaidUraProj) {
		medicaidUraProj.setNew(true);

		return medicaidUraProjPersistence.update(medicaidUraProj);
	}
	 ...
	 */
	@Override
	public MedicaidUraProj createMedicaidUraProj(
		MedicaidUraProjPK medicaidUraProjPK) {
		return medicaidUraProjPersistence.create(medicaidUraProjPK);
	}
	...
	@Override
	public MedicaidUraProj deleteMedicaidUraProj(
		MedicaidUraProjPK medicaidUraProjPK) throws PortalException {
		return medicaidUraProjPersistence.remove(medicaidUraProjPK);
	}
	...
	@Override
	public MedicaidUraProj deleteMedicaidUraProj(
		MedicaidUraProj medicaidUraProj) {
		return medicaidUraProjPersistence.remove(medicaidUraProj);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MedicaidUraProj.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return medicaidUraProjPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return medicaidUraProjPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MedicaidUraProj fetchMedicaidUraProj(
		MedicaidUraProjPK medicaidUraProjPK) {
		return medicaidUraProjPersistence.fetchByPrimaryKey(medicaidUraProjPK);
	}
	 ...
	 */
	@Override
	public MedicaidUraProj getMedicaidUraProj(
		MedicaidUraProjPK medicaidUraProjPK) throws PortalException {
		return medicaidUraProjPersistence.findByPrimaryKey(medicaidUraProjPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(medicaidUraProjLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MedicaidUraProj.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(medicaidUraProjLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MedicaidUraProj.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return medicaidUraProjLocalService.deleteMedicaidUraProj((MedicaidUraProj)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return medicaidUraProjPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MedicaidUraProj> getMedicaidUraProjs(int start, int end) {
		return medicaidUraProjPersistence.findAll(start, end);
	}
	...
	public int getMedicaidUraProjsCount() {
		return medicaidUraProjPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MedicaidUraProj updateMedicaidUraProj(
		MedicaidUraProj medicaidUraProj) {
		return medicaidUraProjPersistence.update(medicaidUraProj);
	}
	 ...
	 */
	public MedicaidUraProjLocalService getMedicaidUraProjLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.MedicaidUraProj",
			medicaidUraProjLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.MedicaidUraProj");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MedicaidUraProjLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = medicaidUraProjPersistence.getDataSource();
	...
	@BeanReference(type = MedicaidUraProjLocalService.class)
	protected MedicaidUraProjLocalService medicaidUraProjLocalService;
