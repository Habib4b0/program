...
public abstract class IvldCustomerGtsActualLocalServiceBaseImpl
    ...
    private IvldCustomerGtsActualLocalServiceClpInvoker _clpInvoker = new IvldCustomerGtsActualLocalServiceClpInvoker();
    ...
    public IvldCustomerGtsActual deleteIvldCustomerGtsActual(
        int ivldCustomerGtsActualSid) throws PortalException, SystemException {
    ...
    public IvldCustomerGtsActual fetchIvldCustomerGtsActual(
        int ivldCustomerGtsActualSid) throws SystemException {
     ...
     */
    @Override
    public int getIvldCustomerGtsActualsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.IvldCustomerGtsActual",
