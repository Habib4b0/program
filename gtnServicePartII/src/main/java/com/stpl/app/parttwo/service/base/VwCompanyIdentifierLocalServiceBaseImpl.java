...
import com.stpl.app.parttwo.service.VwCompanyIdentifierLocalService;
...
/**
 * Provides the base implementation for the vw company identifier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwCompanyIdentifierLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwCompanyIdentifierLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwCompanyIdentifierLocalServiceUtil
 * @generated
 */
public abstract class VwCompanyIdentifierLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements VwCompanyIdentifierLocalService,
        IdentifiableBean {
    ...
    private VwCompanyIdentifierLocalServiceClpInvoker _clpInvoker = new VwCompanyIdentifierLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwCompanyIdentifierLocalServiceUtil} to access the vw company identifier local service.
     */
    ...
    @Override
    public VwCompanyIdentifier addVwCompanyIdentifier(
        VwCompanyIdentifier vwCompanyIdentifier) throws SystemException {
        vwCompanyIdentifier.setNew(true);

        return vwCompanyIdentifierPersistence.update(vwCompanyIdentifier);
    }
     ...
     */
    @Override
    public VwCompanyIdentifier createVwCompanyIdentifier(
        int companyIdentifierSid) {
        return vwCompanyIdentifierPersistence.create(companyIdentifierSid);
    }
    ...
    @Override
    public VwCompanyIdentifier deleteVwCompanyIdentifier(
        int companyIdentifierSid) throws PortalException, SystemException {
        return vwCompanyIdentifierPersistence.remove(companyIdentifierSid);
    }
    ...
    public VwCompanyIdentifier deleteVwCompanyIdentifier(
        VwCompanyIdentifier vwCompanyIdentifier) throws SystemException {
        return vwCompanyIdentifierPersistence.remove(vwCompanyIdentifier);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(VwCompanyIdentifier.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return vwCompanyIdentifierPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwCompanyIdentifierPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public VwCompanyIdentifier fetchVwCompanyIdentifier(
        int companyIdentifierSid) throws SystemException {
        return vwCompanyIdentifierPersistence.fetchByPrimaryKey(companyIdentifierSid);
    }
     ...
     */
    @Override
    public VwCompanyIdentifier getVwCompanyIdentifier(int companyIdentifierSid)
        throws PortalException, SystemException {
        return vwCompanyIdentifierPersistence.findByPrimaryKey(companyIdentifierSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return vwCompanyIdentifierPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<VwCompanyIdentifier> getVwCompanyIdentifiers(int start, int end)
        throws SystemException {
        return vwCompanyIdentifierPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getVwCompanyIdentifiersCount() throws SystemException {
        return vwCompanyIdentifierPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public VwCompanyIdentifier updateVwCompanyIdentifier(
        VwCompanyIdentifier vwCompanyIdentifier) throws SystemException {
        return vwCompanyIdentifierPersistence.update(vwCompanyIdentifier);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.VwCompanyIdentifier",
            vwCompanyIdentifierLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.VwCompanyIdentifier");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = vwCompanyIdentifierPersistence.getDataSource();
