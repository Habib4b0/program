 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link NetSalesFormulaMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link NetSalesFormulaMasterImpl}.
 * </p>
 *
 * @author
...
public class NetSalesFormulaMasterModelImpl extends BaseModelImpl<NetSalesFormulaMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("NET_SALES_FORMULA_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("NET_SALES_FORMULA_TYPE", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("NET_SALES_FORMULA_CATEGORY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CONTRACT_SELECTION", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("RECORD_LOCK_STATUS", Types.BOOLEAN);
		TABLE_COLUMNS_MAP.put("SOURCE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("NET_SALES_FORMULA_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("NET_SALES_FORMULA_NO", Types.VARCHAR);
	...
	private static final ClassLoader _classLoader = NetSalesFormulaMaster.class.getClassLoader();
