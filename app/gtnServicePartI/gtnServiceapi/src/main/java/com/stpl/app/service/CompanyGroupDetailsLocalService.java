...
/**
 * Provides the local service interface for CompanyGroupDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CompanyGroupDetailsLocalServiceUtil
...
public interface CompanyGroupDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CompanyGroupDetailsLocalServiceUtil} to access the company group details local service. Add custom service methods to {@link com.stpl.app.service.impl.CompanyGroupDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
