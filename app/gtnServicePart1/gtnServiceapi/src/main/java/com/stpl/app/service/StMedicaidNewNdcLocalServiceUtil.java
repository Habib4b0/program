...
public class StMedicaidNewNdcLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<StMedicaidNewNdcLocalService, StMedicaidNewNdcLocalService> _serviceTracker =
		ServiceTrackerFactory.open(StMedicaidNewNdcLocalService.class);
}