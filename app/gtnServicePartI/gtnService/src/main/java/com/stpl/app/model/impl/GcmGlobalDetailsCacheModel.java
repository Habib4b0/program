...
public class GcmGlobalDetailsCacheModel implements CacheModel<GcmGlobalDetails>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GcmGlobalDetailsCacheModel)) {
			return false;
		}

		GcmGlobalDetailsCacheModel gcmGlobalDetailsCacheModel = (GcmGlobalDetailsCacheModel)obj;

		if (gcmGlobalDetailsSid == gcmGlobalDetailsCacheModel.gcmGlobalDetailsSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, gcmGlobalDetailsSid);
	}
