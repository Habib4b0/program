...
import com.stpl.app.service.HistItemGroupDetailsLocalService;
...
/**
 * Provides the base implementation for the hist item group details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.HistItemGroupDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.HistItemGroupDetailsLocalServiceImpl
 * @see com.stpl.app.service.HistItemGroupDetailsLocalServiceUtil
 * @generated
 */
public abstract class HistItemGroupDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements HistItemGroupDetailsLocalService,
        IdentifiableBean {
    ...
    private HistItemGroupDetailsLocalServiceClpInvoker _clpInvoker = new HistItemGroupDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.HistItemGroupDetailsLocalServiceUtil} to access the hist item group details local service.
     */
    ...
    @Override
    public HistItemGroupDetails addHistItemGroupDetails(
        HistItemGroupDetails histItemGroupDetails) throws SystemException {
        histItemGroupDetails.setNew(true);

        return histItemGroupDetailsPersistence.update(histItemGroupDetails);
    }
     ...
     */
    @Override
    public HistItemGroupDetails createHistItemGroupDetails(
        HistItemGroupDetailsPK histItemGroupDetailsPK) {
        return histItemGroupDetailsPersistence.create(histItemGroupDetailsPK);
    }
    ...
    @Override
    public HistItemGroupDetails deleteHistItemGroupDetails(
        HistItemGroupDetailsPK histItemGroupDetailsPK)
        throws PortalException, SystemException {
        return histItemGroupDetailsPersistence.remove(histItemGroupDetailsPK);
    }
    ...
    public HistItemGroupDetails deleteHistItemGroupDetails(
        HistItemGroupDetails histItemGroupDetails) throws SystemException {
        return histItemGroupDetailsPersistence.remove(histItemGroupDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(HistItemGroupDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return histItemGroupDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return histItemGroupDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public HistItemGroupDetails fetchHistItemGroupDetails(
        HistItemGroupDetailsPK histItemGroupDetailsPK)
        throws SystemException {
        return histItemGroupDetailsPersistence.fetchByPrimaryKey(histItemGroupDetailsPK);
    }
     ...
     */
    @Override
    public HistItemGroupDetails getHistItemGroupDetails(
        HistItemGroupDetailsPK histItemGroupDetailsPK)
        throws PortalException, SystemException {
        return histItemGroupDetailsPersistence.findByPrimaryKey(histItemGroupDetailsPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return histItemGroupDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<HistItemGroupDetails> getHistItemGroupDetailses(int start,
        int end) throws SystemException {
        return histItemGroupDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getHistItemGroupDetailsesCount() throws SystemException {
        return histItemGroupDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public HistItemGroupDetails updateHistItemGroupDetails(
        HistItemGroupDetails histItemGroupDetails) throws SystemException {
        return histItemGroupDetailsPersistence.update(histItemGroupDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.HistItemGroupDetails",
            histItemGroupDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.HistItemGroupDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = histItemGroupDetailsPersistence.getDataSource();
