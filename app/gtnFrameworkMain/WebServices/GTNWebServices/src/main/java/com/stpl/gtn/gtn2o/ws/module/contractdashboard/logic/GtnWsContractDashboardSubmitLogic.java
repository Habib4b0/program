...
public class GtnWsContractDashboardSubmitLogic {
	...
	private void updateContractInfo(Session session, GtnWsContractDashboardRequest cdRequest)
		...
		try {
			...
			contractMaster.setInsideOwner(bean.getStringPropertyByIndex(18));
			contractMaster.setInsidePhone(bean.getStringPropertyByIndex(19));
			contractMaster.setInsideAuthor(bean.getStringPropertyByIndex(20));
			contractMaster.setInsideAdditional(bean.getStringPropertyByIndex(21));
			contractMaster.setInsideAdditionalName(bean.getStringPropertyByIndex(22));
			contractMaster.setInsideAdditionalPhone(bean.getStringPropertyByIndex(23));
			contractMaster.setOutsideOwner(bean.getStringPropertyByIndex(24));
			contractMaster.setOutsidePhone(bean.getStringPropertyByIndex(25));
			contractMaster.setOutsideAuthor(bean.getStringPropertyByIndex(26));
			contractMaster.setOutsideAdditional(bean.getStringPropertyByIndex(27));
			contractMaster.setOutsideAdditionalName(bean.getStringPropertyByIndex(28));
			contractMaster.setOutsideAdditionalPhone(bean.getStringPropertyByIndex(29));
			contractMaster.setAdvanceNoticeDays(BigDecimal.valueOf(bean.getDoublePropertyByIndex(30)));
			contractMaster.setAffiliatedContractInfo(bean.getStringPropertyByIndex(31));
			contractMaster.setShippingTerms(bean.getStringPropertyByIndex(32));
			contractMaster.setProposalStartDate(getConvertedDateValue(bean.getPropertyValueByIndex(33)));
			contractMaster.setProposalEndDate(getConvertedDateValue(bean.getPropertyValueByIndex(34)));
			contractMaster.setOriginalStartDate(getConvertedDateValue(bean.getPropertyValueByIndex(35)));
			contractMaster.setOriginalEndDate(getConvertedDateValue(bean.getPropertyValueByIndex(36)));
			contractMaster
					.setHelperTableByAwardStatus(session.load(HelperTable.class, bean.getIntegerPropertyByIndex(37)));
			contractMaster.setLastUpdatedDate(getConvertedDateValue(bean.getPropertyValueByIndex(38)));
			contractMaster.setPriceEscalationClause(bean.getStringPropertyByIndex(39));
			contractMaster.setExemptFromLowPrice(bean.getStringPropertyByIndex(40));
			contractMaster.setPriceResetIndicator(bean.getStringPropertyByIndex(41));
			contractMaster.setCancellationClause(bean.getStringPropertyByIndex(42));
			contractMaster.setMostFavoredNation(bean.getStringPropertyByIndex(43));
			contractMaster.setCategory(bean.getStringPropertyByIndex(44));
			contractMaster.setCurrency(bean.getStringPropertyByIndex(45));
			contractMaster.setMinimumOrder(bean.getStringPropertyByIndex(46));
			contractMaster
					.setHelperTableByPaymentTerms(session.load(HelperTable.class, bean.getIntegerPropertyByIndex(47)));
			contractMaster.setInternalNotes(bean.getStringPropertyByIndex(48));
