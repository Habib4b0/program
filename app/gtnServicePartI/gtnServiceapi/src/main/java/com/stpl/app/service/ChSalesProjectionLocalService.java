...
/**
 * Provides the local service interface for ChSalesProjection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ChSalesProjectionLocalServiceUtil
...
public interface ChSalesProjectionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChSalesProjectionLocalServiceUtil} to access the ch sales projection local service. Add custom service methods to {@link com.stpl.app.service.impl.ChSalesProjectionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
