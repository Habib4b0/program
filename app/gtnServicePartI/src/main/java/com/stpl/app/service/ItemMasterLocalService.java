...
/**
 * Provides the local service interface for ItemMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ItemMasterLocalServiceUtil
...
public interface ItemMasterLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ItemMasterLocalServiceUtil} to access the item master local service. Add custom service methods to {@link com.stpl.app.service.impl.ItemMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
