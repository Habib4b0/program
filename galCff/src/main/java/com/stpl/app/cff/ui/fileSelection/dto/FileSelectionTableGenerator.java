...
public class FileSelectionTableGenerator extends DefaultFieldFactory {
    ...
    private FileSelectionTableLogic tableLogic;
    private ExtPagedTable table;
    private CustomTextField fileName;
    SessionDTO session;

    public FileSelectionTableGenerator(ExtPagedTable table, BeanItemContainer searchContainer, FileSelectionTableLogic tableLogic,SessionDTO sessionDTO) {
        ...
        if (propertyId.equals("fileName")) {
            ...
            fileName.addClickListener(new CustomTextField.ClickListener() {
                ...
                public void click(final CustomTextField.ClickEvent event) {
                    ...
                    try {
                        final FileManagementLookup lookUp = new FileManagementLookup("", session, false, fileType, country, searchContainer, itemId);
                        lookUp.init();
