...
public class RebateScheduleLogic extends BeanItemContainer<RsModel> implements RebateLogic {
    ...
    public int getSearchCount(final ErrorfulFieldGroup rebateScheduleForm, BeanSearchCriteria searchCriteria) throws SystemException {
        ...
        LOGGER.debug("End of getSearchCount");
    ...
    public List<RebateScheduleMasterDTO> searchRebateScheduleMaster(final ErrorfulFieldGroup rebateScheduleForm, BeanSearchCriteria searchCriteria, final int start, final int end, final List<OrderByColumn> columns)
            throws SystemException {
        LOGGER.debug("Entering searchRebateScheduleMaster()");
        ...
        LOGGER.debug("End of searchRebateScheduleMaster searchList size=" + searchList.size());
    ...
    public ImtdContRsDetailsFrDTO addToSelectedFormulaList(RSFormulaDTO formula, int imtdContRsdSid, int contRsdFrSid, int contRsdSid, int itemSid) {
        ...
        try {
            if (list != null) {
                ...
                for (Object deductionList : list) {
                    ...
                    searchDTO.setDeductionName(!Constants.NULL.equals(String.valueOf(object[NumericConstants.TWO])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.TWO])) ? String.valueOf(object[NumericConstants.TWO]) : StringUtils.EMPTY);
                    searchDTO.setDeductionDesc(!Constants.NULL.equals(String.valueOf(object[NumericConstants.THREE])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.THREE])) ? String.valueOf(object[NumericConstants.THREE]) : StringUtils.EMPTY);
