...
public class RsContractDetailsFrLocalServiceUtil {
    private static RsContractDetailsFrLocalService _service;
    ...
    */
    ...
    public static RsContractDetailsFrLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    RsContractDetailsFrLocalService.class.getName());

            if (invokableLocalService instanceof RsContractDetailsFrLocalService) {
                _service = (RsContractDetailsFrLocalService) invokableLocalService;
            } else {
                _service = new RsContractDetailsFrLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(RsContractDetailsFrLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(RsContractDetailsFrLocalService service) {
    }
}
