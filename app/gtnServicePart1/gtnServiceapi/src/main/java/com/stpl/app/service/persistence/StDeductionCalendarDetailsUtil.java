...
/**
 * The persistence utility for the st deduction calendar details service. This utility wraps {@link com.stpl.app.service.persistence.impl.StDeductionCalendarDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StDeductionCalendarDetailsUtil {
	...
	*/
	public static StDeductionCalendarDetails create(
	...
	*/
	public static StDeductionCalendarDetails remove(
		StDeductionCalendarDetailsPK stDeductionCalendarDetailsPK)
		throws com.stpl.app.exception.NoSuchStDeductionCalendarDetailsException {
		return getPersistence().remove(stDeductionCalendarDetailsPK);
	}

	public static StDeductionCalendarDetails updateImpl(
		StDeductionCalendarDetails stDeductionCalendarDetails) {
	...
	* @throws NoSuchStDeductionCalendarDetailsException if a st deduction calendar details with the primary key could not be found
	*/
	public static StDeductionCalendarDetails findByPrimaryKey(
		StDeductionCalendarDetailsPK stDeductionCalendarDetailsPK)
		throws com.stpl.app.exception.NoSuchStDeductionCalendarDetailsException {
	...
	*/
	public static StDeductionCalendarDetails fetchByPrimaryKey(
		StDeductionCalendarDetailsPK stDeductionCalendarDetailsPK) {
		return getPersistence().fetchByPrimaryKey(stDeductionCalendarDetailsPK);
	}

	public static java.util.Map<java.io.Serializable, StDeductionCalendarDetails> fetchByPrimaryKeys(
	...
	*/
	public static List<StDeductionCalendarDetails> findAll() {
	...
	*/
	public static List<StDeductionCalendarDetails> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<StDeductionCalendarDetailsPersistence, StDeductionCalendarDetailsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(StDeductionCalendarDetailsPersistence.class);
}