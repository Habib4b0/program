 ...
 */
public class GtnFrameworkEmailconfigTest {
    
    @Mock
    GtnUIFrameworkEngine gtnUIFrameworkEngine;
    @InjectMocks
    GtnFrameworkEmailconfig instance;
    public GtnFrameworkEmailconfigTest() {
    }
    ...
    /**
     * Test of init method, of class GtnUIFrameworkEmailConfig.
     */
    @Test
    public void testInit() {
        ...
        GtnUIFrameworkEmailConfigDynamicClassFiller fil = Mockito.mock(GtnUIFrameworkEmailConfigDynamicClassFiller.class);
        ...
        PowerMockito.whenNew(GtnUIFrameworkEmailConfigDynamicClassFiller.class).withNoArguments().thenReturn(fil);

        doNothing().when(engine).buildVaadinScreen(root, nav, request, ui, "Mail Configuration", fil);
