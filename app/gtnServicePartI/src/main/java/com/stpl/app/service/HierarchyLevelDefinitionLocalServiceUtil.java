...
public class HierarchyLevelDefinitionLocalServiceUtil {
    private static HierarchyLevelDefinitionLocalService _service;
    ...
    */
    ...
    public static HierarchyLevelDefinitionLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    HierarchyLevelDefinitionLocalService.class.getName());

            if (invokableLocalService instanceof HierarchyLevelDefinitionLocalService) {
                _service = (HierarchyLevelDefinitionLocalService) invokableLocalService;
            } else {
                _service = new HierarchyLevelDefinitionLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(HierarchyLevelDefinitionLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(HierarchyLevelDefinitionLocalService service) {
    }
}
