...
public class DataSelectionDAOImpl implements DataSelectionDAO {
     ...
     */
    @Override
    public CffViewMaster deleteForecastingViewMaster(final int systemId) throws SystemException, PortalException, Exception {
     ...
     */
    @Override
    public CffViewMaster getForecastingViewMaster(final int systemId) throws SystemException, PortalException, Exception {
     ...
     */
    @Override
    public CffViewMaster addForecastingViewMaster(final CffViewMaster forecastViewMaster) throws SystemException, Exception {
     ...
     */
    @Override
    public CffViewMaster updateForecastingViewMaster(final CffViewMaster forecastViewMaster) throws SystemException, Exception {
    ...
    @Override
    public List<CffCustHierarchy> findCustHierarchyByProjectionId(DynamicQuery query) throws SystemException, Exception {
        return CffCustHierarchyLocalServiceUtil.dynamicQuery(query);
    }

    @Override
    public List<CffProdHierarchy> findProdHierarchyByProjectionId(DynamicQuery query) throws SystemException, Exception {
    ...
    @Override
    public List<CffDetails> findProjDetailsByProjectionId(DynamicQuery query) throws SystemException, Exception {
    ...
    @Override
    public CffDetails addProjectionDetails(CffDetails projectionDetails) throws PortalException, SystemException, Exception {
    ...
    public CffMaster addCffMaster(CffMaster cffMaster) throws SystemException, Exception {
