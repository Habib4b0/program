...
public class RsContractDetailsCacheModel implements CacheModel<RsContractDetails>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RsContractDetailsCacheModel)) {
			return false;
		}

		RsContractDetailsCacheModel rsContractDetailsCacheModel = (RsContractDetailsCacheModel)obj;

		if (rsContractDetailsSid == rsContractDetailsCacheModel.rsContractDetailsSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, rsContractDetailsSid);
	}
