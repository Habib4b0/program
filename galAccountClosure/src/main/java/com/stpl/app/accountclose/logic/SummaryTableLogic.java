...
public class SummaryTableLogic extends PageTreeTableLogic {
    ...
    public Object configureContainer(Object object, Container datasource) {
        ...
        ((CustomTreeContainer<BaseRateSummaryDTO>) datasource).addBean(dto);
        if (dto.getParent() == 1) {
            ((CustomTreeContainer<BaseRateSummaryDTO>) datasource).setChildrenAllowed(dto, true);
        } else {
            ((CustomTreeContainer<BaseRateSummaryDTO>) datasource).setChildrenAllowed(dto, false);
        }
        return dto;
    }
