...
import com.stpl.app.service.ChAssumptionsLocalService;
...
/**
 * Provides the base implementation for the ch assumptions local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ChAssumptionsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ChAssumptionsLocalServiceImpl
 * @see com.stpl.app.service.ChAssumptionsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ChAssumptionsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ChAssumptionsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ChAssumptionsLocalServiceUtil} to access the ch assumptions local service.
	 */
	...
	@Override
	public ChAssumptions addChAssumptions(ChAssumptions chAssumptions) {
		chAssumptions.setNew(true);

		return chAssumptionsPersistence.update(chAssumptions);
	}
	 ...
	 */
	@Override
	public ChAssumptions createChAssumptions(int chAssumptionsSid) {
		return chAssumptionsPersistence.create(chAssumptionsSid);
	}
	...
	@Override
	public ChAssumptions deleteChAssumptions(int chAssumptionsSid)
		throws PortalException {
		return chAssumptionsPersistence.remove(chAssumptionsSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ChAssumptions deleteChAssumptions(ChAssumptions chAssumptions) {
		return chAssumptionsPersistence.remove(chAssumptions);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ChAssumptions.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return chAssumptionsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return chAssumptionsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ChAssumptions fetchChAssumptions(int chAssumptionsSid) {
		return chAssumptionsPersistence.fetchByPrimaryKey(chAssumptionsSid);
	}
	 ...
	 */
	@Override
	public ChAssumptions getChAssumptions(int chAssumptionsSid)
		throws PortalException {
		return chAssumptionsPersistence.findByPrimaryKey(chAssumptionsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(chAssumptionsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ChAssumptions.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("chAssumptionsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(chAssumptionsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ChAssumptions.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return chAssumptionsLocalService.deleteChAssumptions((ChAssumptions)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return chAssumptionsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ChAssumptions> getChAssumptionses(int start, int end) {
		return chAssumptionsPersistence.findAll(start, end);
	}
	...
	public int getChAssumptionsesCount() {
		return chAssumptionsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ChAssumptions updateChAssumptions(ChAssumptions chAssumptions) {
		return chAssumptionsPersistence.update(chAssumptions);
	}
	 ...
	 */
	public ChAssumptionsLocalService getChAssumptionsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ChAssumptions",
			chAssumptionsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ChAssumptionsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = chAssumptionsPersistence.getDataSource();
	...
	@BeanReference(type = ChAssumptionsLocalService.class)
	protected ChAssumptionsLocalService chAssumptionsLocalService;
