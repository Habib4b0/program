...
public class TPContractHolderLookUp extends Window {
    ...
    public TPContractHolderLookUp(final String indicator, final String windowName, final TextField groupLookup, final String sidQuery) {
            ...
            if ((!StringUtils.EMPTY.equals(contractHolderId.getValue()) || !Constants.NULL.equals(String.valueOf(contractHolderId.getValue())))
                ...
                if ("Contract Holder".equals(indicator)) {
                    resultList = logic.getContractHolder(contractHolderId.getValue(), contractHolderNo.getValue(), contractHolderName.getValue(),
                            String.valueOf(contractHolderStatus.getValue()), String.valueOf(contractHolderType.getValue()), companySids);

                    LOGGER.info("Contract Holder Result List Value=" + resultList.size());
                }
