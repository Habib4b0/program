...
import com.stpl.app.parttwo.service.AdjustedDemandForecastLocalService;
...
/**
 * Provides the base implementation for the adjusted demand forecast local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.AdjustedDemandForecastLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.AdjustedDemandForecastLocalServiceImpl
 * @see com.stpl.app.parttwo.service.AdjustedDemandForecastLocalServiceUtil
 * @generated
 */
public abstract class AdjustedDemandForecastLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements AdjustedDemandForecastLocalService,
        IdentifiableBean {
    ...
    private AdjustedDemandForecastLocalServiceClpInvoker _clpInvoker = new AdjustedDemandForecastLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.AdjustedDemandForecastLocalServiceUtil} to access the adjusted demand forecast local service.
     */
    ...
    @Override
    public AdjustedDemandForecast addAdjustedDemandForecast(
        AdjustedDemandForecast adjustedDemandForecast)
        throws SystemException {
        adjustedDemandForecast.setNew(true);

        return adjustedDemandForecastPersistence.update(adjustedDemandForecast);
    }
     ...
     */
    @Override
    public AdjustedDemandForecast createAdjustedDemandForecast(
        int adjustedDemandForecastSid) {
        return adjustedDemandForecastPersistence.create(adjustedDemandForecastSid);
    }
    ...
    @Override
    public AdjustedDemandForecast deleteAdjustedDemandForecast(
        int adjustedDemandForecastSid) throws PortalException, SystemException {
        return adjustedDemandForecastPersistence.remove(adjustedDemandForecastSid);
    }
    ...
    public AdjustedDemandForecast deleteAdjustedDemandForecast(
        AdjustedDemandForecast adjustedDemandForecast)
        throws SystemException {
        return adjustedDemandForecastPersistence.remove(adjustedDemandForecast);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(AdjustedDemandForecast.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return adjustedDemandForecastPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return adjustedDemandForecastPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public AdjustedDemandForecast fetchAdjustedDemandForecast(
        int adjustedDemandForecastSid) throws SystemException {
        return adjustedDemandForecastPersistence.fetchByPrimaryKey(adjustedDemandForecastSid);
    }
     ...
     */
    @Override
    public AdjustedDemandForecast getAdjustedDemandForecast(
        int adjustedDemandForecastSid) throws PortalException, SystemException {
        return adjustedDemandForecastPersistence.findByPrimaryKey(adjustedDemandForecastSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return adjustedDemandForecastPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<AdjustedDemandForecast> getAdjustedDemandForecasts(int start,
        int end) throws SystemException {
        return adjustedDemandForecastPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getAdjustedDemandForecastsCount() throws SystemException {
        return adjustedDemandForecastPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public AdjustedDemandForecast updateAdjustedDemandForecast(
        AdjustedDemandForecast adjustedDemandForecast)
        throws SystemException {
        return adjustedDemandForecastPersistence.update(adjustedDemandForecast);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.AdjustedDemandForecast",
            adjustedDemandForecastLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = adjustedDemandForecastPersistence.getDataSource();
