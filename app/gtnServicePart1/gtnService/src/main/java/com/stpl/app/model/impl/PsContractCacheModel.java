...
public class PsContractCacheModel implements CacheModel<PsContract>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PsContractCacheModel)) {
			return false;
		}

		PsContractCacheModel psContractCacheModel = (PsContractCacheModel)obj;

		if (psContractSid == psContractCacheModel.psContractSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, psContractSid);
	}
