...
import com.stpl.app.service.CdrDetailsLocalService;
...
/**
 * Provides the base implementation for the cdr details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CdrDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.CdrDetailsLocalServiceImpl
 * @see com.stpl.app.service.CdrDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CdrDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CdrDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CdrDetailsLocalServiceUtil} to access the cdr details local service.
	 */
	...
	@Override
	public CdrDetails addCdrDetails(CdrDetails cdrDetails) {
		cdrDetails.setNew(true);

		return cdrDetailsPersistence.update(cdrDetails);
	}
	 ...
	 */
	@Override
	public CdrDetails createCdrDetails(int cdrDetailsSid) {
		return cdrDetailsPersistence.create(cdrDetailsSid);
	}
	...
	@Override
	public CdrDetails deleteCdrDetails(int cdrDetailsSid)
		throws PortalException {
		return cdrDetailsPersistence.remove(cdrDetailsSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CdrDetails deleteCdrDetails(CdrDetails cdrDetails) {
		return cdrDetailsPersistence.remove(cdrDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CdrDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cdrDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return cdrDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cdrDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CdrDetails fetchCdrDetails(int cdrDetailsSid) {
		return cdrDetailsPersistence.fetchByPrimaryKey(cdrDetailsSid);
	}
	 ...
	 */
	@Override
	public CdrDetails getCdrDetails(int cdrDetailsSid)
		throws PortalException {
		return cdrDetailsPersistence.findByPrimaryKey(cdrDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cdrDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CdrDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("cdrDetailsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cdrDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CdrDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cdrDetailsLocalService.deleteCdrDetails((CdrDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cdrDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CdrDetails> getCdrDetailses(int start, int end) {
		return cdrDetailsPersistence.findAll(start, end);
	}
	...
	public int getCdrDetailsesCount() {
		return cdrDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CdrDetails updateCdrDetails(CdrDetails cdrDetails) {
		return cdrDetailsPersistence.update(cdrDetails);
	}
	 ...
	 */
	public CdrDetailsLocalService getCdrDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.CdrDetails",
			cdrDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.CdrDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CdrDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cdrDetailsPersistence.getDataSource();
	...
	@BeanReference(type = CdrDetailsLocalService.class)
	protected CdrDetailsLocalService cdrDetailsLocalService;
