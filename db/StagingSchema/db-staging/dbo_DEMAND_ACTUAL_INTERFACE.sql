IF NOT EXISTS (SELECT 'X'
               ...
               WHERE  TABLE_NAME = 'DEMAND_ACTUAL_INTERFACE'
                      AND TABLE_SCHEMA = 'dbo')
  BEGIN

      CREATE TABLE  DEMAND_ACTUAL_INTERFACE
        (
...
GO
--DATA TYPE CHANGE FOR MARKET_SHARE_RATIO
IF EXISTS (SELECT 1
              ...
              WHERE  TABLE_NAME = 'DEMAND_ACTUAL_INTERFACE'
					 ...
					 AND IS_NULLABLE='NO')
  BEGIN
      ALTER TABLE [DBO].DEMAND_ACTUAL_INTERFACE
        ALTER COLUMN MARKET_SHARE_RATIO varchar(25) NOT NULL
  END
