...
public abstract class CffMasterLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements CffMasterLocalService, IdentifiableBean {
    ...
    private CffMasterLocalServiceClpInvoker _clpInvoker = new CffMasterLocalServiceClpInvoker();
    ...
    @Override
    public CffMaster fetchCffMaster(int cffMasterSid) throws SystemException {
     ...
     */
    @Override
    public CffMaster getCffMaster(int cffMasterSid)
        throws PortalException, SystemException {
     ...
     */
    @Override
    public int getCffMastersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.CffMaster",
