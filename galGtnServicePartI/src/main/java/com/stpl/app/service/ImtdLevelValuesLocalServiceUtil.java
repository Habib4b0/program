...
public class ImtdLevelValuesLocalServiceUtil {
    private static ImtdLevelValuesLocalService _service;
    ...
    */
    ...
    public static ImtdLevelValuesLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ImtdLevelValuesLocalService.class.getName());

            if (invokableLocalService instanceof ImtdLevelValuesLocalService) {
                _service = (ImtdLevelValuesLocalService) invokableLocalService;
            } else {
                _service = new ImtdLevelValuesLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ImtdLevelValuesLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ImtdLevelValuesLocalService service) {
    }
}
