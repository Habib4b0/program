...
import com.stpl.app.service.ContractAliasMasterLocalService;
...
/**
 * Provides the base implementation for the contract alias master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ContractAliasMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ContractAliasMasterLocalServiceImpl
 * @see com.stpl.app.service.ContractAliasMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ContractAliasMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ContractAliasMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ContractAliasMasterLocalServiceUtil} to access the contract alias master local service.
	 */
	...
	@Override
	public ContractAliasMaster addContractAliasMaster(
		ContractAliasMaster contractAliasMaster) {
		contractAliasMaster.setNew(true);

		return contractAliasMasterPersistence.update(contractAliasMaster);
	}
	 ...
	 */
	@Override
	public ContractAliasMaster createContractAliasMaster(
		int contractAliasMasterSid) {
		return contractAliasMasterPersistence.create(contractAliasMasterSid);
	}
	...
	@Override
	public ContractAliasMaster deleteContractAliasMaster(
		int contractAliasMasterSid) throws PortalException {
		return contractAliasMasterPersistence.remove(contractAliasMasterSid);
	}
	...
	public ContractAliasMaster deleteContractAliasMaster(
		ContractAliasMaster contractAliasMaster) {
		return contractAliasMasterPersistence.remove(contractAliasMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ContractAliasMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return contractAliasMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return contractAliasMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ContractAliasMaster fetchContractAliasMaster(
		int contractAliasMasterSid) {
		return contractAliasMasterPersistence.fetchByPrimaryKey(contractAliasMasterSid);
	}
	 ...
	 */
	@Override
	public ContractAliasMaster getContractAliasMaster(
		int contractAliasMasterSid) throws PortalException {
		return contractAliasMasterPersistence.findByPrimaryKey(contractAliasMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(contractAliasMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ContractAliasMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(contractAliasMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ContractAliasMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return contractAliasMasterLocalService.deleteContractAliasMaster((ContractAliasMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return contractAliasMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ContractAliasMaster> getContractAliasMasters(int start, int end) {
		return contractAliasMasterPersistence.findAll(start, end);
	}
	...
	public int getContractAliasMastersCount() {
		return contractAliasMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ContractAliasMaster updateContractAliasMaster(
		ContractAliasMaster contractAliasMaster) {
		return contractAliasMasterPersistence.update(contractAliasMaster);
	}
	 ...
	 */
	public ContractAliasMasterLocalService getContractAliasMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ContractAliasMaster",
			contractAliasMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ContractAliasMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ContractAliasMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = contractAliasMasterPersistence.getDataSource();
	...
	@BeanReference(type = ContractAliasMasterLocalService.class)
	protected ContractAliasMasterLocalService contractAliasMasterLocalService;
