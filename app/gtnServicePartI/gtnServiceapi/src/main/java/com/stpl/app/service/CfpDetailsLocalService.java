...
/**
 * Provides the local service interface for CfpDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CfpDetailsLocalServiceUtil
...
public interface CfpDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CfpDetailsLocalServiceUtil} to access the cfp details local service. Add custom service methods to {@link com.stpl.app.service.impl.CfpDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
