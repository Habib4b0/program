...
public class AccClosureDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<AccClosureDetailsLocalService, AccClosureDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AccClosureDetailsLocalService.class);
}