...
SET @TABLENAME1 = 'ARM_BSR_CCP' --TABLE NAME  
SET @SCHEMANAME1 = 'DBO' -- SCHEMA NAME  
...
--                      AND SCHEMA_NAME(SCHEMA_ID) = 'DBO' 
--                      AND NAME = 'PK_ARM_BSR_CCP_ARM_ADJUSTMENT_DETAILS_SID_ARM_ADJ_RES_CONFIG_MASTER_SID_SUMMARY_TYPE_ACC'
--                      AND TYPE = 'PK') 
--  BEGIN 
--      ALTER TABLE ARM_BSR_CCP 
--        ADD CONSTRAINT PK_ARM_BSR_CCP_ARM_ADJUSTMENT_DETAILS_SID_ARM_ADJ_RES_CONFIG_MASTER_SID_SUMMARY_TYPE_ACC PRIMARY KEY ( ARM_ADJUSTMENT_DETAILS_SID, ARM_ADJ_RES_CONFIG_MASTER_SID, SUMMARY_TYPE, ACCOUNT )
--  END 

--GO 
--DROPING Existing P.K
IF  EXISTS (SELECT 1 
               FROM   SYS.KEY_CONSTRAINTS 
               WHERE  OBJECT_NAME(PARENT_OBJECT_ID) = 'ARM_BSR_CCP' 
                      AND SCHEMA_NAME(SCHEMA_ID) = 'DBO' 
  ...
  BEGIN 
      ALTER TABLE ARM_BSR_CCP 
        DROP CONSTRAINT PK_ARM_BSR_CCP_ARM_ADJUSTMENT_DETAILS_SID_ARM_ADJ_RES_CONFIG_MASTER_SID_SUMMARY_TYPE_ACC 
  END 
