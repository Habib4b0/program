...
public class IvldDemandForecastLocalServiceUtil {
    private static IvldDemandForecastLocalService _service;
    ...
    */
    ...
    public static IvldDemandForecastLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    IvldDemandForecastLocalService.class.getName());

            if (invokableLocalService instanceof IvldDemandForecastLocalService) {
                _service = (IvldDemandForecastLocalService) invokableLocalService;
            } else {
                _service = new IvldDemandForecastLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(IvldDemandForecastLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(IvldDemandForecastLocalService service) {
    }
}
