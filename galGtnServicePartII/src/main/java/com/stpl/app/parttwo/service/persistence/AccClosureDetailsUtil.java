...
/**
 * The persistence utility for the acc closure details service. This utility wraps {@link AccClosureDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AccClosureDetailsPersistenceImpl
 * @generated
 */
public class AccClosureDetailsUtil {
    private static AccClosureDetailsPersistence _persistence;
    ...
    */
    public static void cacheResult(
        java.util.List<com.stpl.app.parttwo.model.AccClosureDetails> accClosureDetailses) {
    ...
    */
    public static com.stpl.app.parttwo.model.AccClosureDetails create(
    ...
    */
    public static com.stpl.app.parttwo.model.AccClosureDetails remove(
        int accClosureDetailsSid)
        throws com.stpl.app.parttwo.NoSuchAccClosureDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().remove(accClosureDetailsSid);
    }

    public static com.stpl.app.parttwo.model.AccClosureDetails updateImpl(
        com.stpl.app.parttwo.model.AccClosureDetails accClosureDetails)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.AccClosureDetails findByPrimaryKey(
        int accClosureDetailsSid)
        throws com.stpl.app.parttwo.NoSuchAccClosureDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.AccClosureDetails fetchByPrimaryKey(
        int accClosureDetailsSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.parttwo.model.AccClosureDetails> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static AccClosureDetailsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (AccClosureDetailsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.parttwo.service.ClpSerializer.getServletContextName(),
                    AccClosureDetailsPersistence.class.getName());

            ReferenceRegistry.registerReference(AccClosureDetailsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(AccClosureDetailsPersistence persistence) {
    }
}
