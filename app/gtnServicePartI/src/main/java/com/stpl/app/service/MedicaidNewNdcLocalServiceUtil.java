...
public class MedicaidNewNdcLocalServiceUtil {
    private static MedicaidNewNdcLocalService _service;
    ...
    */
    ...
    public static MedicaidNewNdcLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    MedicaidNewNdcLocalService.class.getName());

            if (invokableLocalService instanceof MedicaidNewNdcLocalService) {
                _service = (MedicaidNewNdcLocalService) invokableLocalService;
            } else {
                _service = new MedicaidNewNdcLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(MedicaidNewNdcLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(MedicaidNewNdcLocalService service) {
    }
}
