...
public class CommonLogic {
    ...
    public List getDiscountChartData(int projectionId,String projType) {
        
        if("Non Mandated".equals(projType)){
            
            List<Object> list = (List<Object>) RsModelLocalServiceUtil.executeSelectQuery(buildDiscountChartQuery(projectionId),null,null);
            return  convertfinalResultLists(list);
        }else{
            List<Object> list = (List<Object>) RsModelLocalServiceUtil.executeSelectQuery(buildGovtDiscountChartQuery(projectionId),null,null);
            return  convertfinalResultLists(list); 
        }
    }
    ...
    public String buildDiscountChartQuery(int projectionId) {
    ...
    public String buildGovtDiscountChartQuery(int projectionId) {

        StringBuilder queryBuilder = new StringBuilder(StringUtils.EMPTY);

        queryBuilder.append("IF Object_id('TEMPDB..#MANDATED') IS NOT NULL\n" +
                            "  DROP TABLE #MANDATED\n" +
                            "\n" +
                            ...
                            "SELECT t.*\n" +
                            "FROM   #MANDATED\n" +
                            "       CROSS APPLY ( VALUES (YEAR,\n" +
                            "                   ACTUAL_SALES,\n" +
                            "                   ACTUAL_MANDATED_DISCOUNT,\n" +
                            "                   PROJECTION_SALES,\n" +
                            "                   PROJECTION_MANDATED_DISCOUNT,\n" +
                            "                   'MANDATED',ProjectionRsales),\n" +
                            "                            (YEAR,\n" +
                            "                   ACTUAL_SALES,\n" +
                            "                   ACTUAL_SUPPLEMENTAL_DISCOUNT,\n" +
                            "                   PROJECTION_SALES,\n" +
                            "                   PROJECTION_SUPPLEMENTAL_DISCOUNT,\n" +
                            "                   'SUPPLEMENTAL',ProjectionRsales) ) t(YEAR, ACTUAL_SALES, ACTUAL_DISCOUNT, PROJECTION_SALES, PROJECTION_DISCOUNT, ProjectionRsales, DISCOUNT_TYPE) ");
        return queryBuilder.toString();
    }
    
    private List convertfinalResultLists(List list) {
    ...
    private List convertfinalAccrualSalesResultLists(List list) {
     ...
     public String buildReturnsSalesChartQuery(int projectionId ) {
      ...
      public  List<Object[]> callGTSProcedure(int projectionId) {
          ResultSet rs = null;
      ...
      public  List<Object[]> callGovtSPRProcedure(int projectionId) {
          ResultSet rs = null;
          List<Object[]> objectList = new ArrayList<Object[]>();
    ...
    public List<CommonLevelDto> getProjectionResultChartData(int projectionId,String projType) {
        
        List<Object[]> list = null;
        if("Non Mandated".equals(projType)){
            list=callGTSProcedure(projectionId);
            return  customizeResults(list);
        }else{
            list=callGovtSPRProcedure(projectionId);
            return customizeResultsForGovt(list);
        }
    ...
    public List<CommonLevelDto> customizeResults(List<Object[]> list){
        ...
        for (Object list1 : list) {
            ...
            String year = String.valueOf(obj[4]);
            ...
            commonLevelDto7.addStringProperties(year, String.valueOf(obj[9]));
            commonLevelDto8.addStringProperties(year, String.valueOf(obj[10]));
            commonLevelDto9.addStringProperties(year, String.valueOf(obj[11]));
            commonLevelDto10.addStringProperties(year, String.valueOf(obj[12]));
            commonLevelDto11.addStringProperties(year, String.valueOf(obj[13]));
            commonLevelDto12.addStringProperties(year, String.valueOf(obj[14]));
            commonLevelDto13.addStringProperties(year, String.valueOf(obj[15]));
            commonLevelDto14.addStringProperties(year, String.valueOf(obj[16]));
            commonLevelDto15.addStringProperties(year, String.valueOf(obj[17]));
            commonLevelDto16.addStringProperties(year, String.valueOf(obj[18]));
            commonLevelDto17.addStringProperties(year, String.valueOf(obj[19]));
            commonLevelDto18.addStringProperties(year, String.valueOf(obj[20]));
              }    
             }
    ...
    return commonDtoList;
     ...
     public List<CommonLevelDto> customizeResultsForGovt(List<Object[]> list){
        ...
        for (Object list1 : list) {
            ...
            commonLevelDto1.addStringProperties(year, String.valueOf(obj[1]));
            commonLevelDto2.addStringProperties(year, String.valueOf(obj[2]));
            commonLevelDto3.addStringProperties(year, String.valueOf(obj[4]));
            commonLevelDto4.addStringProperties(year, String.valueOf(obj[5]));
            commonLevelDto5.addStringProperties(year, String.valueOf(obj[6]));
            commonLevelDto6.addStringProperties(year, String.valueOf(obj[7]));
            commonLevelDto7.addStringProperties(year, String.valueOf(obj[8]));
            commonLevelDto8.addStringProperties(year, String.valueOf(obj[9]));
            ...
            commonLevelDto11.addStringProperties(year, String.valueOf(obj[12]));
            commonLevelDto12.addStringProperties(year, String.valueOf(obj[13]));
            commonLevelDto13.addStringProperties(year, String.valueOf(obj[14]));
            commonLevelDto14.addStringProperties(year, String.valueOf(obj[15]));
            commonLevelDto15.addStringProperties(year, String.valueOf(obj[16]));
            commonLevelDto16.addStringProperties(year, String.valueOf(obj[17]));
            commonLevelDto17.addStringProperties(year, String.valueOf(obj[18]));
            commonLevelDto18.addStringProperties(year, String.valueOf(obj[19]));
            commonLevelDto19.addStringProperties(year, String.valueOf(obj[20]));
            commonLevelDto20.addStringProperties(year, String.valueOf(obj[21]));
            commonLevelDto21.addStringProperties(year, String.valueOf(obj[22]));
            commonLevelDto22.addStringProperties(year, String.valueOf(obj[23]));
              }    
             }
