...
public class CopyContractindex extends VerticalLayout {
    ...
    public final ErrorfulFieldGroup getBinder() {
        ...
        try {
            ...
            Iterator it = binderLocal.getFields().iterator();
    ...
    public void configuretable() throws SystemException {
        try {
            ...
            copycontractResultsTable.setWidth(100, Sizeable.Unit.PERCENTAGE);
            copycontractResultsTable.setHeight(400, Sizeable.Unit.PIXELS);
            copycontractResultsTable.setPageLength(5);
        ...
        new AbstractNotificationUtils() {
            ...
            public void yesMethod() {
                try {
                    ...
                    LOGGER.error(ex.getMessage() + " - in btnreset");
                }
            }
