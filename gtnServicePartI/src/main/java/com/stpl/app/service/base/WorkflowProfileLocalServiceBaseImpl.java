...
import com.stpl.app.service.WorkflowProfileLocalService;
...
/**
 * Provides the base implementation for the workflow profile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.WorkflowProfileLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.WorkflowProfileLocalServiceImpl
 * @see com.stpl.app.service.WorkflowProfileLocalServiceUtil
 * @generated
 */
public abstract class WorkflowProfileLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements WorkflowProfileLocalService,
        IdentifiableBean {
    ...
    private WorkflowProfileLocalServiceClpInvoker _clpInvoker = new WorkflowProfileLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.WorkflowProfileLocalServiceUtil} to access the workflow profile local service.
     */
    ...
    @Override
    public WorkflowProfile addWorkflowProfile(WorkflowProfile workflowProfile)
        throws SystemException {
        workflowProfile.setNew(true);

        return workflowProfilePersistence.update(workflowProfile);
    }
     ...
     */
    @Override
    public WorkflowProfile createWorkflowProfile(int processSid) {
        return workflowProfilePersistence.create(processSid);
    }
    ...
    @Override
    public WorkflowProfile deleteWorkflowProfile(int processSid)
        throws PortalException, SystemException {
        return workflowProfilePersistence.remove(processSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public WorkflowProfile deleteWorkflowProfile(
        WorkflowProfile workflowProfile) throws SystemException {
        return workflowProfilePersistence.remove(workflowProfile);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(WorkflowProfile.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return workflowProfilePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return workflowProfilePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public WorkflowProfile fetchWorkflowProfile(int processSid)
        throws SystemException {
        return workflowProfilePersistence.fetchByPrimaryKey(processSid);
    }
     ...
     */
    @Override
    public WorkflowProfile getWorkflowProfile(int processSid)
        throws PortalException, SystemException {
        return workflowProfilePersistence.findByPrimaryKey(processSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return workflowProfilePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<WorkflowProfile> getWorkflowProfiles(int start, int end)
        throws SystemException {
        return workflowProfilePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getWorkflowProfilesCount() throws SystemException {
        return workflowProfilePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public WorkflowProfile updateWorkflowProfile(
        WorkflowProfile workflowProfile) throws SystemException {
        return workflowProfilePersistence.update(workflowProfile);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.WorkflowProfile",
            workflowProfileLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.WorkflowProfile");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = workflowProfilePersistence.getDataSource();
