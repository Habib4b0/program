...
public interface IvldItemHierarchyPersistence extends BasePersistence<IvldItemHierarchy> {
	...
	*/
	public void cacheResult(
		java.util.List<IvldItemHierarchy> ivldItemHierarchies);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, IvldItemHierarchy> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<IvldItemHierarchy> findAll();
	...
	*/
	public java.util.List<IvldItemHierarchy> findAll(int start, int end);
	...
	*/
	public java.util.List<IvldItemHierarchy> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<IvldItemHierarchy> orderByComparator);
