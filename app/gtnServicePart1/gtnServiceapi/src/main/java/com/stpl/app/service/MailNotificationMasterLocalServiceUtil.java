...
public class MailNotificationMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<MailNotificationMasterLocalService, MailNotificationMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(MailNotificationMasterLocalService.class);
}