...
public class IvldReturnsCacheModel implements CacheModel<IvldReturns>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldReturnsCacheModel)) {
			return false;
		}

		IvldReturnsCacheModel ivldReturnsCacheModel = (IvldReturnsCacheModel)obj;

		if (ivldReturnsSid == ivldReturnsCacheModel.ivldReturnsSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldReturnsSid);
	}
	...
	public IvldReturns toEntityModel() {
		...
		ivldReturnsImpl.setCheckRecord(checkRecord);
