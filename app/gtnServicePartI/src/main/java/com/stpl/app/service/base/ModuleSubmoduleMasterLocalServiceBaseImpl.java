...
public abstract class ModuleSubmoduleMasterLocalServiceBaseImpl
    ...
    private ModuleSubmoduleMasterLocalServiceClpInvoker _clpInvoker = new ModuleSubmoduleMasterLocalServiceClpInvoker();
    ...
    public ModuleSubmoduleMaster deleteModuleSubmoduleMaster(
        int moduleSubmoduleSid) throws PortalException, SystemException {
    ...
    public ModuleSubmoduleMaster fetchModuleSubmoduleMaster(
        int moduleSubmoduleSid) throws SystemException {
     ...
     */
    @Override
    public int getModuleSubmoduleMastersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ModuleSubmoduleMaster",
