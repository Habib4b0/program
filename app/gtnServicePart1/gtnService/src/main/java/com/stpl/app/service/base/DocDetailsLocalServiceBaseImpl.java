...
import com.stpl.app.service.DocDetailsLocalService;
...
/**
 * Provides the base implementation for the doc details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.DocDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.DocDetailsLocalServiceImpl
 * @see com.stpl.app.service.DocDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class DocDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DocDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.DocDetailsLocalServiceUtil} to access the doc details local service.
	 */
	...
	@Override
	public DocDetails addDocDetails(DocDetails docDetails) {
		docDetails.setNew(true);

		return docDetailsPersistence.update(docDetails);
	}
	 ...
	 */
	@Override
	public DocDetails createDocDetails(int docDetailsId) {
		return docDetailsPersistence.create(docDetailsId);
	}
	...
	@Override
	public DocDetails deleteDocDetails(int docDetailsId)
		throws PortalException {
		return docDetailsPersistence.remove(docDetailsId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DocDetails deleteDocDetails(DocDetails docDetails) {
		return docDetailsPersistence.remove(docDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DocDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return docDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return docDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return docDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DocDetails fetchDocDetails(int docDetailsId) {
		return docDetailsPersistence.fetchByPrimaryKey(docDetailsId);
	}
	 ...
	 */
	@Override
	public DocDetails getDocDetails(int docDetailsId) throws PortalException {
		return docDetailsPersistence.findByPrimaryKey(docDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(docDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DocDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("docDetailsId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(docDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DocDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return docDetailsLocalService.deleteDocDetails((DocDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return docDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DocDetails> getDocDetailses(int start, int end) {
		return docDetailsPersistence.findAll(start, end);
	}
	...
	public int getDocDetailsesCount() {
		return docDetailsPersistence.countAll();
	}
	 ...
	 */
	public DocDetailsLocalService getDocDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.DocDetails",
			docDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.DocDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = docDetailsPersistence.getDataSource();
	...
	@BeanReference(type = DocDetailsLocalService.class)
	protected DocDetailsLocalService docDetailsLocalService;
