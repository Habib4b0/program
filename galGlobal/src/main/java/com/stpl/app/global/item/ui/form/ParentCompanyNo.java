...
public final class ParentCompanyNo extends Window {
    ...
    protected void configureFields() throws PortalException, SystemException, Exception {                                                      
        ...
        companyName.addValidator(new RegexpValidator(ValidationUtils.SEARCH_SP_CHAR, ConstantsUtils.COMPANYNAME + " " + ValidationUtils.SEARCH_SPCHAR_MSG));
        ...
        companyNo.addValidator(new RegexpValidator(ValidationUtils.SEARCH_SP_CHAR, "Company No " + " " + ValidationUtils.SEARCH_SPCHAR_MSG));
        companyNo.addValidator(new StringLengthValidator("Company No Should be less than 50 characters", 0, 50, true));
        companyNo.setImmediate(true);
        companyNo.setValidationVisible(true);

        companyId.addValidator(new RegexpValidator(ValidationUtils.SEARCH_SP_CHAR, "Company Id " + " " + ValidationUtils.SEARCH_SPCHAR_MSG));
        companyId.addValidator(new StringLengthValidator("Company ID Should be less than 38 characters", 0, 38, true));
        ...
        btnSelect.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("Entering inside  SELECT  method ");
                ...
                close();
                LOGGER.info("Ending PaymentCompanyNo SELECT  method ");
            }
        });
    }
    ...
    public void btnSearchLogic(Button.ClickEvent event) {
        LOGGER.info("Entering btnSearchLogic - ParentCompanyNo Search operation");
            ...
            if (binder.getField("companyId").getValue().toString().trim().isEmpty() && binder.getField("companyNo").getValue().toString().trim().isEmpty() && binder.getField("companyName").getValue().toString().trim().isEmpty()
                ...
                table.addItemClickListener(new ItemClickEvent.ItemClickListener() {
                    ...
                    public void itemClick(final ItemClickEvent event) {
                        LOGGER.info("Entering btnSearchLogic - ParentCompanyNo Search operation - itemClick");
                        try {
                        ...
                        LOGGER.info("Ending btnSearchLogic - ParentCompanyNo Search operation - itemClick");
        ...
        LOGGER.info("Ending btnSearchLogic - ParentCompanyNo Search operation");
    }
    ...
    public void btnResetLogic(Button.ClickEvent event) {
        LOGGER.info("Entering btnResetLogic - ParentCompanyNo Search operation");
        List<Object> collapsedColumns = new ArrayList<Object>();
        for (Object item : table.getVisibleColumns()) {
            if (table.isColumnCollapsed(item)) {
                collapsedColumns.add(item);
        ...
        searchCriteria.setCustomDirty(true);
        LOGGER.info("Ending btnResetLogic - ParentCompanyNo Search operation");
    }
     ...
     * @throws Exception the exception
     */
    public void itemSelectLogic(final ItemClickEvent event, final LazyBeanItemContainer searchResults) throws Exception {
        LOGGER.info("Entering itemSelectLogic");
        final SearchCompanyForm searchForm = (SearchCompanyForm) searchResults.getItem(event.getItemId()).getBean();
        LOGGER.info("selected item--------->" + searchForm.getCompanyName());
        ...
        btnSelect.setEnabled(true);
        LOGGER.info("Ending itemSelectLogic");
    ...
    public void addToTable() throws SystemException, PortalException {
        ...
        LOGGER.info(" Ends addComponentInGridPosition  ");
