...
import com.stpl.app.parttwo.service.VwIvldReturnReserveLocalService;
...
/**
 * Provides the base implementation for the vw ivld return reserve local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwIvldReturnReserveLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwIvldReturnReserveLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwIvldReturnReserveLocalServiceUtil
 * @generated
 */
public abstract class VwIvldReturnReserveLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements VwIvldReturnReserveLocalService,
        IdentifiableBean {
    ...
    private VwIvldReturnReserveLocalServiceClpInvoker _clpInvoker = new VwIvldReturnReserveLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwIvldReturnReserveLocalServiceUtil} to access the vw ivld return reserve local service.
     */
    ...
    @Override
    public VwIvldReturnReserve addVwIvldReturnReserve(
        VwIvldReturnReserve vwIvldReturnReserve) throws SystemException {
        vwIvldReturnReserve.setNew(true);

        return vwIvldReturnReservePersistence.update(vwIvldReturnReserve);
    }
     ...
     */
    @Override
    public VwIvldReturnReserve createVwIvldReturnReserve(
        int ivldReturnReserveSid) {
        return vwIvldReturnReservePersistence.create(ivldReturnReserveSid);
    }
    ...
    @Override
    public VwIvldReturnReserve deleteVwIvldReturnReserve(
        int ivldReturnReserveSid) throws PortalException, SystemException {
        return vwIvldReturnReservePersistence.remove(ivldReturnReserveSid);
    }
    ...
    public VwIvldReturnReserve deleteVwIvldReturnReserve(
        VwIvldReturnReserve vwIvldReturnReserve) throws SystemException {
        return vwIvldReturnReservePersistence.remove(vwIvldReturnReserve);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(VwIvldReturnReserve.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return vwIvldReturnReservePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwIvldReturnReservePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public VwIvldReturnReserve fetchVwIvldReturnReserve(
        int ivldReturnReserveSid) throws SystemException {
        return vwIvldReturnReservePersistence.fetchByPrimaryKey(ivldReturnReserveSid);
    }
     ...
     */
    @Override
    public VwIvldReturnReserve getVwIvldReturnReserve(int ivldReturnReserveSid)
        throws PortalException, SystemException {
        return vwIvldReturnReservePersistence.findByPrimaryKey(ivldReturnReserveSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return vwIvldReturnReservePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<VwIvldReturnReserve> getVwIvldReturnReserves(int start, int end)
        throws SystemException {
        return vwIvldReturnReservePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getVwIvldReturnReservesCount() throws SystemException {
        return vwIvldReturnReservePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public VwIvldReturnReserve updateVwIvldReturnReserve(
        VwIvldReturnReserve vwIvldReturnReserve) throws SystemException {
        return vwIvldReturnReservePersistence.update(vwIvldReturnReserve);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.VwIvldReturnReserve",
            vwIvldReturnReserveLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.VwIvldReturnReserve");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = vwIvldReturnReservePersistence.getDataSource();
