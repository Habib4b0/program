...
public interface HistItemGroupPersistence extends BasePersistence<HistItemGroup> {
	...
	*/
	public void cacheResult(java.util.List<HistItemGroup> histItemGroups);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, HistItemGroup> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<HistItemGroup> findAll();
	...
	*/
	public java.util.List<HistItemGroup> findAll(int start, int end);
	...
	*/
	public java.util.List<HistItemGroup> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<HistItemGroup> orderByComparator);
