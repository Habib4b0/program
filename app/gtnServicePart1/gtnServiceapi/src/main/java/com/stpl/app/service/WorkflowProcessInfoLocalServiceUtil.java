...
public class WorkflowProcessInfoLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<WorkflowProcessInfoLocalService, WorkflowProcessInfoLocalService> _serviceTracker =
		ServiceTrackerFactory.open(WorkflowProcessInfoLocalService.class);
}