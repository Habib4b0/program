...
public class IvldSalesMasterCacheModel implements CacheModel<IvldSalesMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldSalesMasterCacheModel)) {
			return false;
		}

		IvldSalesMasterCacheModel ivldSalesMasterCacheModel = (IvldSalesMasterCacheModel)obj;

		if (ivldSalesMasterSid == ivldSalesMasterCacheModel.ivldSalesMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldSalesMasterSid);
	}
	...
	public IvldSalesMaster toEntityModel() {
		...
		if (companyStringId == null) {
			ivldSalesMasterImpl.setCompanyStringId(StringPool.BLANK);
		}
		else {
			ivldSalesMasterImpl.setCompanyStringId(companyStringId);
		}
		...
		ivldSalesMasterImpl.setCheckRecord(checkRecord);
