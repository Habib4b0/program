...
public class SalesMasterLocalServiceUtil {
    private static SalesMasterLocalService _service;
    ...
    */
    ...
    public static SalesMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    SalesMasterLocalService.class.getName());

            if (invokableLocalService instanceof SalesMasterLocalService) {
                _service = (SalesMasterLocalService) invokableLocalService;
            } else {
                _service = new SalesMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(SalesMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(SalesMasterLocalService service) {
    }
}
