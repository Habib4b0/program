...
public class AllCustomers extends Window {
    ...
    private CustomTreeContainer<TradingPartnerDTO> companyExcelResultBean = new CustomTreeContainer<TradingPartnerDTO>(TradingPartnerDTO.class);
    ...
    public void excelBtn(Button.ClickEvent event) {
        ...
        ExcelExport excel = new ExcelExport(new ExtCustomTableHolder(companyViewTable), "All Customers", "All Customers", "All Customers.xls", false);
        excel.export();
    ...
    private void configureCompanyExcelResultTable() {
        companyExcelResultBean = new CustomTreeContainer<TradingPartnerDTO>(TradingPartnerDTO.class);
