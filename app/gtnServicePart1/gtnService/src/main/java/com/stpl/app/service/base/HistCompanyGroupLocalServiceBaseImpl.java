...
public abstract class HistCompanyGroupLocalServiceBaseImpl
	...
	public HistCompanyGroup deleteHistCompanyGroup(
		HistCompanyGroupPK histCompanyGroupPK) throws PortalException {
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return histCompanyGroupLocalService.deleteHistCompanyGroup((HistCompanyGroup)persistedModel);
	}
	 ...
	 */
	public HistCompanyGroupLocalService getHistCompanyGroupLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.HistCompanyGroup",
	...
	public String getOSGiServiceIdentifier() {
		return HistCompanyGroupLocalService.class.getName();
	}
	...
	@BeanReference(type = HistCompanyGroupLocalService.class)
	protected HistCompanyGroupLocalService histCompanyGroupLocalService;
