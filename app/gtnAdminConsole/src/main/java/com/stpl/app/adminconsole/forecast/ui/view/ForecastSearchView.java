...
public class ForecastSearchView extends VerticalLayout implements View {
     ...
     */
    public ForecastSearchView() throws SystemException, PortalException {

        super();
        LOGGER.debug("ForecastSearchView constructor initiated ");
        forecastIndex = new ForecastSearchIndex(forecastBinder);
        setSpacing(true);
        addComponent(forecastIndex);
        setStyleName("bootstrap");
        LOGGER.debug("ForecastSearchView constructor ended ");
