 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldAccrualInboundModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldAccrualInboundImpl}.
 * </p>
 *
 * @author
...
public class IvldAccrualInboundModelImpl extends BaseModelImpl<IvldAccrualInbound>
	...
	static {
		TABLE_COLUMNS_MAP.put("RECORD_CREATED_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ACCRUAL_PERIOD_END_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ACCRUAL_PERIOD_START_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ACCRUAL_INTFID", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("POSTING_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("GL_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("IVLD_ACCRUAL_INBOUND_SID", Types.INTEGER);
	...
	public Object clone() {
		...
		ivldAccrualInboundImpl.setCheckRecord(getCheckRecord());
	...
	public CacheModel<IvldAccrualInbound> toCacheModel() {
		...
		ivldAccrualInboundCacheModel.checkRecord = getCheckRecord();
	...
	private static final ClassLoader _classLoader = IvldAccrualInbound.class.getClassLoader();
