...
public class PVParameters implements Serializable, Cloneable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 89 * hash + Objects.hashCode(this.projectionId);
        hash = 89 * hash + Objects.hashCode(this.userId);
        hash = 89 * hash + Objects.hashCode(this.sessionId);
        hash = 89 * hash + Objects.hashCode(this.discountLevel);
        hash = 89 * hash + Objects.hashCode(this.frequency);
        hash = 89 * hash + Objects.hashCode(this.viewIndicator);
        hash = 89 * hash + Objects.hashCode(this.groupFilter);
        hash = 89 * hash + Objects.hashCode(this.groupFilterValue);
        hash = 89 * hash + Objects.hashCode(this.hierarchyNo);
        hash = 89 * hash + Objects.hashCode(this.levelNo);
        hash = 89 * hash + Objects.hashCode(this.viewName);
        hash = 89 * hash + Objects.hashCode(this.discountId);
        hash = 89 * hash + this.customViewMasterSid;
        return hash;
    }
