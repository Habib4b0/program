...
import com.stpl.app.service.StNewNdcLocalService;
...
/**
 * Provides the base implementation for the st new ndc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.StNewNdcLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.StNewNdcLocalServiceImpl
 * @see com.stpl.app.service.StNewNdcLocalServiceUtil
 * @generated
 */
public abstract class StNewNdcLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements StNewNdcLocalService, IdentifiableBean {
    ...
    private StNewNdcLocalServiceClpInvoker _clpInvoker = new StNewNdcLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.StNewNdcLocalServiceUtil} to access the st new ndc local service.
     */
    ...
    @Override
    public StNewNdc addStNewNdc(StNewNdc stNewNdc) throws SystemException {
        stNewNdc.setNew(true);

        return stNewNdcPersistence.update(stNewNdc);
    }
     ...
     */
    @Override
    public StNewNdc createStNewNdc(StNewNdcPK stNewNdcPK) {
        return stNewNdcPersistence.create(stNewNdcPK);
    }
    ...
    @Override
    public StNewNdc deleteStNewNdc(StNewNdcPK stNewNdcPK)
        throws PortalException, SystemException {
        return stNewNdcPersistence.remove(stNewNdcPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public StNewNdc deleteStNewNdc(StNewNdc stNewNdc) throws SystemException {
        return stNewNdcPersistence.remove(stNewNdc);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(StNewNdc.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return stNewNdcPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return stNewNdcPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return stNewNdcPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return stNewNdcPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public StNewNdc fetchStNewNdc(StNewNdcPK stNewNdcPK)
        throws SystemException {
        return stNewNdcPersistence.fetchByPrimaryKey(stNewNdcPK);
    }
     ...
     */
    @Override
    public StNewNdc getStNewNdc(StNewNdcPK stNewNdcPK)
        throws PortalException, SystemException {
        return stNewNdcPersistence.findByPrimaryKey(stNewNdcPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return stNewNdcPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<StNewNdc> getStNewNdcs(int start, int end)
        throws SystemException {
        return stNewNdcPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getStNewNdcsCount() throws SystemException {
        return stNewNdcPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public StNewNdc updateStNewNdc(StNewNdc stNewNdc) throws SystemException {
        return stNewNdcPersistence.update(stNewNdc);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.StNewNdc",
            stNewNdcLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.StNewNdc");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = stNewNdcPersistence.getDataSource();
