 ...
 * @generated
 */
public class ItemMasterLocalServiceClp implements ItemMasterLocalService {
    ...
    public ItemMasterLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addItemMaster";

        _methodParameterTypes0 = new String[] { "com.stpl.app.model.ItemMaster" };

        _methodName1 = "createItemMaster";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteItemMaster";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteItemMaster";

        _methodParameterTypes3 = new String[] { "com.stpl.app.model.ItemMaster" };
        ...
        _methodName10 = "fetchItemMaster";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getItemMaster";
        ...
        _methodName13 = "getItemMasters";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getItemMastersCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateItemMaster";

        _methodParameterTypes15 = new String[] { "com.stpl.app.model.ItemMaster" };
    ...
    public com.stpl.app.model.ItemMaster addItemMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(itemMaster) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ItemMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ItemMaster createItemMaster(int itemMasterSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { itemMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ItemMaster deleteItemMaster(int itemMasterSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { itemMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ItemMaster fetchItemMaster(int itemMasterSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { itemMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ItemMaster getItemMaster(int itemMasterSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { itemMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ItemMaster> getItemMasters(
        ...
        return (java.util.List<com.stpl.app.model.ItemMaster>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List findItemMaster(java.lang.String itemId,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    ClpSerializer.translateInput(itemStatus),
                        
                    ClpSerializer.translateInput(itemType),
                        
                    ClpSerializer.translateInput(itemDesc),
                        
                    ClpSerializer.translateInput(manufacturerId),
                        
                    identifierType,
                        
                    ClpSerializer.translateInput(identifier),
