...
import com.stpl.app.parttwo.service.CffMasterLocalService;
...
/**
 * Provides the base implementation for the cff master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.CffMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.CffMasterLocalServiceImpl
 * @see com.stpl.app.parttwo.service.CffMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CffMasterLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CffMasterLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.CffMasterLocalServiceUtil} to access the cff master local service.
	 */
	...
	@Override
	public CffMaster addCffMaster(CffMaster cffMaster) {
		cffMaster.setNew(true);

		return cffMasterPersistence.update(cffMaster);
	}
	 ...
	 */
	@Override
	public CffMaster createCffMaster(int cffMasterSid) {
		return cffMasterPersistence.create(cffMasterSid);
	}
	...
	@Override
	public CffMaster deleteCffMaster(int cffMasterSid)
		throws PortalException {
		return cffMasterPersistence.remove(cffMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CffMaster deleteCffMaster(CffMaster cffMaster) {
		return cffMasterPersistence.remove(cffMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CffMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cffMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return cffMasterPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cffMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CffMaster fetchCffMaster(int cffMasterSid) {
		return cffMasterPersistence.fetchByPrimaryKey(cffMasterSid);
	}
	 ...
	 */
	@Override
	public CffMaster getCffMaster(int cffMasterSid) throws PortalException {
		return cffMasterPersistence.findByPrimaryKey(cffMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cffMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CffMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("cffMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cffMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CffMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cffMasterLocalService.deleteCffMaster((CffMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cffMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CffMaster> getCffMasters(int start, int end) {
		return cffMasterPersistence.findAll(start, end);
	}
	...
	public int getCffMastersCount() {
		return cffMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CffMaster updateCffMaster(CffMaster cffMaster) {
		return cffMasterPersistence.update(cffMaster);
	}
	 ...
	 */
	public CffMasterLocalService getCffMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.CffMaster",
			cffMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.CffMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CffMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cffMasterPersistence.getDataSource();
	...
	@BeanReference(type = CffMasterLocalService.class)
	protected CffMasterLocalService cffMasterLocalService;
