...
import com.stpl.app.galworkflow.filtergenerator.HistoryTableGenerator;
import com.stpl.app.galworkflow.dto.InboxDashboardDTO;
import com.stpl.app.galworkflow.dto.WorkFlowHistoryLookupDTO;
import com.stpl.app.galworkflow.logic.tablelogic.WorkflowHistoryTableLogic;
...
import com.stpl.app.galworkflow.util.FileUploader;
...
public class WorkFlowHistoryLookup extends Window {
    ...
    public void configureTable() {
        ...
        hLayout.setStyleName("width-auto");
        tableLogic.setSearchData(inboxDashBoardDTOHidden, true);
        results.setFilterDecorator(new ExtDemoFilterDecorator());
        results.setFilterGenerator(new HistoryTableGenerator());
        results.setImmediate(true);
        results.setConverter("modifiedDate", new DateToStringConverter());
    ...
    public void configureFields() {
        ...
        if (inboxDashBoardDTOHidden.getWorkflowId().startsWith(WorkflowConstants.getComWorkflowParameter()) || inboxDashBoardDTOHidden.getWorkflowId().startsWith(WorkflowConstants.getGovWorkflowParameter())) {
            ...
            businessProcess.setValue("Contract Management");
                ...
                if (event.isDoubleClick()) {
                    ...
                    if (historydto.getFileName() != null && !historydto.getFileName().isEmpty()) {
                        ...
                        for (int i = 0; i < list.size(); i++) {
                            ...
                            dto.setUserName(obj[2] != null && !String.valueOf(obj[2]).isEmpty() ? String.valueOf(obj[2]) : StringUtils.EMPTY);
                            dto.setFileType(String.valueOf(obj[3]));
