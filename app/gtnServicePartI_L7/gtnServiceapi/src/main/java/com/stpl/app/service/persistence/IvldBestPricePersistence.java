...
public interface IvldBestPricePersistence extends BasePersistence<IvldBestPrice> {
	...
	*/
	public void cacheResult(java.util.List<IvldBestPrice> ivldBestPrices);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, IvldBestPrice> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<IvldBestPrice> findAll();
	...
	*/
	public java.util.List<IvldBestPrice> findAll(int start, int end);
	...
	*/
	public java.util.List<IvldBestPrice> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<IvldBestPrice> orderByComparator);
