...
import com.stpl.app.service.CompanyGroupLocalService;
...
/**
 * Provides the base implementation for the company group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CompanyGroupLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.CompanyGroupLocalServiceImpl
 * @see com.stpl.app.service.CompanyGroupLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CompanyGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CompanyGroupLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CompanyGroupLocalServiceUtil} to access the company group local service.
	 */
	...
	public CompanyGroup addCompanyGroup(CompanyGroup companyGroup) {
		...
		return companyGroupPersistence.update(companyGroup);
	}
	 ...
	 */
	@Override
	public CompanyGroup createCompanyGroup(int companyGroupSid) {
		return companyGroupPersistence.create(companyGroupSid);
	}
	...
	@Override
	public CompanyGroup deleteCompanyGroup(int companyGroupSid)
		throws PortalException {
		return companyGroupPersistence.remove(companyGroupSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CompanyGroup deleteCompanyGroup(CompanyGroup companyGroup) {
		return companyGroupPersistence.remove(companyGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CompanyGroup.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return companyGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return companyGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CompanyGroup fetchCompanyGroup(int companyGroupSid) {
		return companyGroupPersistence.fetchByPrimaryKey(companyGroupSid);
	}
	 ...
	 */
	@Override
	public CompanyGroup getCompanyGroup(int companyGroupSid)
		throws PortalException {
		return companyGroupPersistence.findByPrimaryKey(companyGroupSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(companyGroupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CompanyGroup.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("companyGroupSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(companyGroupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CompanyGroup.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return companyGroupLocalService.deleteCompanyGroup((CompanyGroup)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return companyGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CompanyGroup> getCompanyGroups(int start, int end) {
		return companyGroupPersistence.findAll(start, end);
	}
	...
	public int getCompanyGroupsCount() {
		return companyGroupPersistence.countAll();
	}
	 ...
	 */
	public CompanyGroupLocalService getCompanyGroupLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.CompanyGroup",
			companyGroupLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.CompanyGroup");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanyGroupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = companyGroupPersistence.getDataSource();
	...
	@BeanReference(type = CompanyGroupLocalService.class)
	protected CompanyGroupLocalService companyGroupLocalService;
