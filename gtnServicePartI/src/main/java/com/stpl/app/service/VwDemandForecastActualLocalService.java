...
/**
 * Provides the local service interface for VwDemandForecastActual. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see VwDemandForecastActualLocalServiceUtil
...
public interface VwDemandForecastActualLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link VwDemandForecastActualLocalServiceUtil} to access the vw demand forecast actual local service. Add custom service methods to {@link com.stpl.app.service.impl.VwDemandForecastActualLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
