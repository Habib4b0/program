...
public class CfpLookUp extends Window {
    ...
    private BeanItemContainer<String> cfpStatusBean = new BeanItemContainer<String>(String.class);
    private BeanItemContainer<String> cfpTypeBean = new BeanItemContainer<String>(String.class);
