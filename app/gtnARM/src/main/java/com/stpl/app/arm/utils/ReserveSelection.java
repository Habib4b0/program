...
public class ReserveSelection {
    ...
    private AdjustmentReserveDTO searchBinderDTO;
    private AdjustmentReserveDTO windowBinderDTO;
    private boolean isGTNDetails;
    private int reserveMasterSid;
    private int gtnDetailsMasterSid;
    ...
    private String adjustmentSummaryTempTableName;
    private String balanceSummaryTempTableName;
    private int methodology;
    private String methodologyDescription;
    private String tabNameForExcel;
    private int reportType;
    private int tabIndex;
    private boolean resetLine = false;

    public ReserveSelection() {
        /*
