 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ItemQualifierModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ItemQualifierImpl}.
 * </p>
 *
 * @author
...
public class ItemQualifierModelImpl extends BaseModelImpl<ItemQualifier>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ITEM_QUALIFIER_NAME", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ITEM_QUALIFIER_VALUE", Types.VARCHAR);
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.stpl.app.service.util.PropsUtil.get(
			...
			true);
	public static final long ITEMQUALIFIERNAME_COLUMN_BITMASK = 1L;
	public static final long ITEMQUALIFIERVALUE_COLUMN_BITMASK = 2L;
	public static final long ITEMQUALIFIERSID_COLUMN_BITMASK = 4L;
	...
	private static final ClassLoader _classLoader = ItemQualifier.class.getClassLoader();
