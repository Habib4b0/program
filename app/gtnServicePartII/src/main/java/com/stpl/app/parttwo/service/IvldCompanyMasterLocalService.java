...
/**
 * Provides the local service interface for IvldCompanyMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldCompanyMasterLocalServiceUtil
...
public interface IvldCompanyMasterLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IvldCompanyMasterLocalServiceUtil} to access the ivld company master local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.IvldCompanyMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
