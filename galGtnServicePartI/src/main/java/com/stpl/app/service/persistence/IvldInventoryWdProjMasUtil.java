...
/**
 * The persistence utility for the ivld inventory wd proj mas service. This utility wraps {@link IvldInventoryWdProjMasPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class IvldInventoryWdProjMasUtil {
    private static IvldInventoryWdProjMasPersistence _persistence;
     ...
     */
    public static void clearCache(IvldInventoryWdProjMas ivldInventoryWdProjMas) {
        getPersistence().clearCache(ivldInventoryWdProjMas);
    }
     ...
     */
    public static List<IvldInventoryWdProjMas> findWithDynamicQuery(
     ...
     */
    public static IvldInventoryWdProjMas update(
        IvldInventoryWdProjMas ivldInventoryWdProjMas)
        throws SystemException {
        return getPersistence().update(ivldInventoryWdProjMas);
    }
    ...
    public static IvldInventoryWdProjMas update(
        ...
        return getPersistence().update(ivldInventoryWdProjMas, serviceContext);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(ivldInventoryWdProjMas);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(ivldInventoryWdProjMases);
    }
    ...
    */
    public static com.stpl.app.model.IvldInventoryWdProjMas create(
        int ivldInventoryWdProjMasSid) {
        return getPersistence().create(ivldInventoryWdProjMasSid);
    }
    ...
    */
    public static com.stpl.app.model.IvldInventoryWdProjMas remove(
        int ivldInventoryWdProjMasSid)
        throws com.stpl.app.NoSuchIvldInventoryWdProjMasException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().remove(ivldInventoryWdProjMasSid);
    }

    public static com.stpl.app.model.IvldInventoryWdProjMas updateImpl(
        com.stpl.app.model.IvldInventoryWdProjMas ivldInventoryWdProjMas)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(ivldInventoryWdProjMas);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.IvldInventoryWdProjMas findByPrimaryKey(
        int ivldInventoryWdProjMasSid)
        throws com.stpl.app.NoSuchIvldInventoryWdProjMasException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().findByPrimaryKey(ivldInventoryWdProjMasSid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.IvldInventoryWdProjMas fetchByPrimaryKey(
        int ivldInventoryWdProjMasSid)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().fetchByPrimaryKey(ivldInventoryWdProjMasSid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.IvldInventoryWdProjMas> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static IvldInventoryWdProjMasPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (IvldInventoryWdProjMasPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    IvldInventoryWdProjMasPersistence.class.getName());

            ReferenceRegistry.registerReference(IvldInventoryWdProjMasUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(IvldInventoryWdProjMasPersistence persistence) {
    }
}
