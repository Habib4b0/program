...
BEGIN
	DROP STATISTICS dbo.PS_CONTRACT.PS_NAME
END
GO
...
IF EXISTS (SELECT 1
           ...
           WHERE  TABLE_NAME = 'PS_CONTRACT'
                  ...
                  AND IS_NULLABLE = 'YES')
  BEGIN
	  UPDATE PS_CONTRACT SET PS_NAME = 0 WHERE PS_NAME IS NULL

      ALTER TABLE PS_CONTRACT
        ALTER COLUMN PS_NAME VARCHAR(100) NOT NULL
  END 
GO
...
BEGIN
	DROP STATISTICS dbo.HIST_PS_CONTRACT.PS_NAME
END
GO
...
IF EXISTS (SELECT 1
           ...
           WHERE  TABLE_NAME = 'HIST_PS_CONTRACT'
                  ...
                  AND IS_NULLABLE = 'YES')
  BEGIN
	  UPDATE HIST_PS_CONTRACT SET PS_NAME = 0 WHERE PS_NAME IS NULL
