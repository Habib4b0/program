...
/**
 * The persistence utility for the imtd rs details service. This utility wraps {@link com.stpl.app.service.persistence.impl.ImtdRsDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ImtdRsDetailsUtil {
	...
	*/
	public static List<ImtdRsDetails> findByTempRsSearch(
	...
	*/
	public static ImtdRsDetails findByTempRsSearch_First(
		java.lang.String usersSid, java.lang.String sessionId,
		Date imtdCreatedDate, OrderByComparator<ImtdRsDetails> orderByComparator)
		throws com.stpl.app.exception.NoSuchImtdRsDetailsException {
		return getPersistence()
	...
	*/
	public static ImtdRsDetails fetchByTempRsSearch_First(
		java.lang.String usersSid, java.lang.String sessionId,
		Date imtdCreatedDate, OrderByComparator<ImtdRsDetails> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchImtdRsDetailsException if a matching imtd rs details could not be found
	*/
	public static ImtdRsDetails findByTempRsSearch_Last(
		java.lang.String usersSid, java.lang.String sessionId,
		Date imtdCreatedDate, OrderByComparator<ImtdRsDetails> orderByComparator)
		throws com.stpl.app.exception.NoSuchImtdRsDetailsException {
		return getPersistence()
	...
	*/
	public static ImtdRsDetails fetchByTempRsSearch_Last(
		java.lang.String usersSid, java.lang.String sessionId,
		Date imtdCreatedDate, OrderByComparator<ImtdRsDetails> orderByComparator) {
		return getPersistence()
	...
	*/
	public static ImtdRsDetails[] findByTempRsSearch_PrevAndNext(
	...
	*/
	public static void cacheResult(ImtdRsDetails imtdRsDetails) {
	...
	*/
	public static void cacheResult(List<ImtdRsDetails> imtdRsDetailses) {
	...
	*/
	public static ImtdRsDetails create(int imtdRsDetailsSid) {
	...
	* @throws NoSuchImtdRsDetailsException if a imtd rs details with the primary key could not be found
	*/
	public static ImtdRsDetails remove(int imtdRsDetailsSid)
		throws com.stpl.app.exception.NoSuchImtdRsDetailsException {
		return getPersistence().remove(imtdRsDetailsSid);
	}

	public static ImtdRsDetails updateImpl(ImtdRsDetails imtdRsDetails) {
	...
	* @throws NoSuchImtdRsDetailsException if a imtd rs details with the primary key could not be found
	*/
	public static ImtdRsDetails findByPrimaryKey(int imtdRsDetailsSid)
		throws com.stpl.app.exception.NoSuchImtdRsDetailsException {
	...
	*/
	public static ImtdRsDetails fetchByPrimaryKey(int imtdRsDetailsSid) {
		return getPersistence().fetchByPrimaryKey(imtdRsDetailsSid);
	}

	public static java.util.Map<java.io.Serializable, ImtdRsDetails> fetchByPrimaryKeys(
	...
	*/
	public static List<ImtdRsDetails> findAll() {
	...
	*/
	public static List<ImtdRsDetails> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<ImtdRsDetailsPersistence, ImtdRsDetailsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(ImtdRsDetailsPersistence.class);
}