...
public abstract class PageTableLogic {
	 ...
	 */
	protected Label totalPagesLabel = new Label(String.valueOf(getTotalAmountOfPages()), ContentMode.HTML);
	/**
	 * The first.
	 */
	 ...
	 * using the component's <code>addPageChangeListener<code> method. When the
	 * pageChange event occurs, that object's appropriate method is invoked.
	 *
	 * @see PageChangeEvent
	 */
	 ...
	 *
	 * @param tempPageLength
	 *            the new temp page length
	 */
	 ...
	 *
	 * @param itemsPerPageSelect
	 *            the items per page select
	 */
	 ...
	 *
	 * @param isLink
	 *            the new control button as link
	 */
	...
	public void setContainerDataSource(Container newDataSource) {
		if (!(newDataSource instanceof Container.Indexed) || !(newDataSource instanceof Container.Filterable)) {
