...
public interface FormulaDetailsMasterLocalService extends BaseLocalService,
	...
	*/
	...
	public FormulaDetailsMaster addFormulaDetailsMaster(
	...
	*/
	public FormulaDetailsMaster createFormulaDetailsMaster(
	...
	*/
	...
	public FormulaDetailsMaster deleteFormulaDetailsMaster(
		FormulaDetailsMaster formulaDetailsMaster);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public FormulaDetailsMaster deleteFormulaDetailsMaster(
		int formulaDetailsMasterSid) throws PortalException;
	...
	*/
	...
	public FormulaDetailsMaster fetchFormulaDetailsMaster(
		int formulaDetailsMasterSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FormulaDetailsMaster getFormulaDetailsMaster(
		int formulaDetailsMasterSid) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FormulaDetailsMaster> getFormulaDetailsMasters(int start,
		int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public FormulaDetailsMaster updateFormulaDetailsMaster(
		FormulaDetailsMaster formulaDetailsMaster);
}