...
/**
 * Provides the local service interface for CffCustHierarchy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CffCustHierarchyLocalServiceUtil
...
public interface CffCustHierarchyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CffCustHierarchyLocalServiceUtil} to access the cff cust hierarchy local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.CffCustHierarchyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
