...
public class IvldGlBalanceCacheModel implements CacheModel<IvldGlBalance>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldGlBalanceCacheModel)) {
			return false;
		}

		IvldGlBalanceCacheModel ivldGlBalanceCacheModel = (IvldGlBalanceCacheModel)obj;

		if (ivldGlBalanceSid == ivldGlBalanceCacheModel.ivldGlBalanceSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldGlBalanceSid);
	}
