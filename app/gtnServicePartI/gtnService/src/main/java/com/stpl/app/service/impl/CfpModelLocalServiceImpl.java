 ...
 *
 * @author
 * @see CfpModelLocalServiceBaseImpl
...
public class CfpModelLocalServiceImpl extends CfpModelLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link com.stpl.app.service.CfpModelLocalServiceUtil} to access the cfp model local service.
	 */
}