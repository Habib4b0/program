...
/**
 * The persistence interface for the deduction group service.
 *
 * <p>
 ...
 */
@ProviderType
public interface DeductionGroupPersistence extends BasePersistence<DeductionGroup> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DeductionGroupUtil} to access the deduction group persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<DeductionGroup> deductionGroups);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, DeductionGroup> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<DeductionGroup> findAll();
	...
	*/
	public java.util.List<DeductionGroup> findAll(int start, int end);
	...
	*/
	public java.util.List<DeductionGroup> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<DeductionGroup> orderByComparator);
