 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.stpl.app.model.UdcsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link UdcsImpl}.
 * </p>
 *
 * @author
 * @see UdcsImpl
 * @see com.stpl.app.model.Udcs
 * @see com.stpl.app.model.UdcsModel
 * @generated
 */
public class UdcsModelImpl extends BaseModelImpl<Udcs> implements UdcsModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a udcs model instance should use the {@link com.stpl.app.model.Udcs} interface instead.
     */
    ...
    private static ClassLoader _classLoader = Udcs.class.getClassLoader();
    private static Class<?>[] _escapedModelInterfaces = new Class[] { Udcs.class };
    private int _udc1;
    private int _udc2;
