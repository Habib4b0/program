 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldItemPricingModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldItemPricingImpl}.
 * </p>
 *
 * @author
...
public class IvldItemPricingModelImpl extends BaseModelImpl<IvldItemPricing>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ITEM_PRICING_INTFID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("IVLD_ITEM_PRICING_SID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("ITEM_PRICE_PRECISION", Types.VARCHAR);
	}
	...
	private static final ClassLoader _classLoader = IvldItemPricing.class.getClassLoader();
