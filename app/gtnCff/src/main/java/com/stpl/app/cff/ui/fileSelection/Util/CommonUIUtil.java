...
public final class CommonUIUtil {
     ...
     */
    public static final Object[] FILE_MGMT_LOOKUP_RES_COLS = new Object[]{"fileType", "country", "fileName", "type", "version", "fromDate", "toDate"};

    /**
     * The Constant FILE_MGT_LOOKUP_RESULT_HEADER.
     */
    public static final String[] FILE_MGMT_LOOKUP_RES_HEADER = new String[]{"File Type", COUNTRY, "File Name", "Type", StringConstantsUtil.VERSION_LABEL, "From Date", "To Date"};
     ...
     */
    public static final Object[] FILE_MGMT_LOOKUP_DETAILS_COLS = new Object[]{"year", MONTH_PROPERTY, ITEM_NO, ITEM_NAME_PROPERTY, START_DATE, PRICE_PROPERTY, UNITS_PROPERTY, "dollars"};
    /**
     * The Constant FILE_MGT_LOOKUP_DETAILS_COLUMNS.
     */
    public static final Object[] FILE_MGMT_LOOKUP_DETAILS_COLS_EXCEL = new Object[]{"year", MONTH_PROPERTY, ITEM_NO, ITEM_NAME_PROPERTY, START_DATE, PRICE_PROPERTY, UNITS_PROPERTY, "dollars"};
     ...
     */
    public static final String[] FILE_MGMT_LOOKUP_DEMAND_DETAILS_HEADER = new String[]{FORECAST_TYPE, FORECAST_YEAR, FORECAST_MONTH_LABEL, ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL,
    ...
    public static final Object[] FILE_MGMT_LOOKUP_DEMAND_DETAILS_COLS = new Object[]{"forecastType", FORCAST_YEAR, StringConstantsUtil.FORECAST_MONTH, StringConstantsUtil.ITEM_ID,
    ...
    public static final String[] FILE_MGMT_LOOKUP_DEMAND_DETAILS_HEADER_EXCEL = new String[]{FORECAST_TYPE, FORECAST_YEAR, FORECAST_MONTH_LABEL,
    ...
    public static final Object[] FILE_MGMT_LOOKUP_DEMAND_DETAILS_COLS_EXCEL = new Object[]{"forecastType", FORCAST_YEAR, StringConstantsUtil.FORECAST_MONTH, StringConstantsUtil.ITEM_ID,
        StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER, StringConstantsUtil.ITEM_IDENTIFIER, BRAND_ID, SEGMENT_PROPERTY, StringConstantsUtil.MARKET_SIZE_UNITS, MARKET_SHARE_RATIO_PROPERTY, MARKET_SHARE_UNITS, UNCAPTURED_UNITS1, UNCAPTURED_UNITS_RATIO1,
         TOTAL_DEMAND_UNITS1, TOTAL_DEMAND_AMOUNT1, StringConstantsUtil.INVENTORY_UNIT_CHANGE, GROSS_UNITS, GROSS_PRICE1, GROSS_AMOUNT1, StringConstantsUtil.NET_SALES_PRICE, NET_SALES_AMOUNT, BATCH_ID_PROPERTY, ORGANIZATION_KEY1};
     ...
     */
    public static final String[] FILE_MGMT_LOOKUP_INV_DETAILS_SUMMARY_HEADER = new String[]{"Year", MONTH_LABEL, "Day", "Week", ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER, UNITS_WITHDRAWN, AMOUNT_WITHDRAWN1, PRICE_LABEL, StringConstantsUtil.BATCH_ID_LABEL, ORGANIZATION_KEY};
    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_COLUMNS
     */
    public static final Object[] FILE_MGMT_INV_DETAILS_SUM_COLS_EXCEL = new Object[]{"year", MONTH_PROPERTY, "day", "week", StringConstantsUtil.ITEM_ID, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER, StringConstantsUtil.ITEM_IDENTIFIER, UNITS_WITHDRAWN1, AMOUNT_WITHDRAWN, PRICE_PROPERTY, BATCH_ID_PROPERTY, ORGANIZATION_KEY1};
    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_HEADER
     */
    public static final String[] FILE_MGMT_LOOKUP_INV_DETAILS_SUM_HEADER = new String[]{"Year", MONTH_LABEL, "Day", "Week", ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER, UNITS_WITHDRAWN, AMOUNT_WITHDRAWN1, PRICE_LABEL, StringConstantsUtil.BATCH_ID_LABEL, ORGANIZATION_KEY};
    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_COLUMNS
     */
    public static final Object[] FILE_MGMT_LOOKUP_INV_DETAILS_COLS = new Object[]{"year", MONTH_PROPERTY, "day", "week", StringConstantsUtil.COMPANY_ID_PROPERTY, "identifierCodeQualifier", "companyIdentifier", StringConstantsUtil.ITEM_ID, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER, StringConstantsUtil.ITEM_IDENTIFIER, UNITS_WITHDRAWN1, AMOUNT_WITHDRAWN, PRICE_PROPERTY, BATCH_ID_PROPERTY, ORGANIZATION_KEY1};
     ...
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_COLUMNS
     */
    public static final Object[] FILE_MGMT_LOOKUP_INV_DETAILS_COLS_EXCEL = new Object[]{"year", MONTH_PROPERTY, "day", "week", StringConstantsUtil.COMPANY_ID_PROPERTY, "identifierCodeQualifier", "companyIdentifier", StringConstantsUtil.ITEM_ID, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER, StringConstantsUtil.ITEM_IDENTIFIER, UNITS_WITHDRAWN1, AMOUNT_WITHDRAWN, PRICE_PROPERTY, BATCH_ID_PROPERTY, ORGANIZATION_KEY1};
    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_HEADER
     */
     ...
     */
    public static final String[] FILE_MGMT_LOOKUP_DETAILS_HEADER = new String[]{"Year", MONTH_LABEL, ITEM_HASH, ITEM_NAME_LABEL, FORECAST_DATE_LABEL, PRICE_LABEL, UNITS_LABEL, DOLLARS};
    public static final String[] FILE_MGMT_LOOKUP_DETAILS_HEADER_EXCEL = new String[]{"Year", MONTH_LABEL, ITEM_HASH, ITEM_NAME_LABEL, FORECAST_DATE_LABEL, PRICE_LABEL, UNITS_LABEL, DOLLARS};

    /**
     * The Constant AC_SEARCH_RESULT_COLUMNS.
     */
    public static final Object[] AC_SEARCH_RESULTS_COLS = new Object[]{"resultRSName", "resultRSDesc", "resultRSType", "resultRSHierarchyName", "versionNo", START_DATE, "createdDate", "modifiedDate",
        "resultCreatedBy"};
     ...
     */
    public static final String[] AC_SEARCH_RESULTS_HEADER = new String[]{"Relationship Name", "Relationship Description", "Relationship Type", "Hierarchy Name", "version No", "Start Date", "Creation Date", MODIFIED_DATE_LABEL, CREATED_BY_LABEL};

    /**
     * The Constant AC_HB_SEARCH_RESULT_COLUMNS.
     */
    public static final Object[] AC_HB_SEARCH_RESULTS_COLS = new Object[]{"hierarchyName", "hierarchyType", "hierarchyCategoryInString", "noOfLevels", "versionNo", "createdDate", "modifiedDate", "createdBy"};

    /**
     * The Constant AC_HB_SEARCH_RESULT_HEADER.
     */
    public static final String[] AC_HB_SEARCH_RES_HEADER = new String[]{"Hierarchy Name", "Hierarchy Type", "Hierarchy Category", "# of Levels", StringConstantsUtil.VERSION_LABEL, "Creation Date", MODIFIED_DATE_LABEL, CREATED_BY_LABEL};

    /**
     * The Constant AC_HB_LEVEL_DEFINITION_COLUMNS.
     */
    public static final Object[] AC_HB_LEVEL_DEF_COLS = new Object[]{"levelNo", "levelName", "tableName", "fieldName", "userDefinedOrLinked"};

    /**
     * The Constant AC_HB_LEVEL_DEFINITION_HEADER.
     */
    public static final String[] AC_HB_LEVEL_DEF_HEADER = new String[]{"Level #", "Level Name", "Table Name", "Field Name", "User Defined/ Linked"};

    /**
     * The Constant AC_HB_LEVEL_VALUES_COLUMNS.
     */
    public static final Object[] AC_HB_LEVEL_VALS_COLS = new Object[]{"levelValues"};
     ...
     */
    public static final Object[] FIELD_LOOKUP_COL = new Object[]{"fieldName"};
     ...
     */
    public static final Object[] RB_SELECTED_LEVEL_COL = new Object[]{"levelValue"};

    /**
     * The Constant RB_AVAILABLE_LEVEL_COLUMN.
     */
    public static final Object[] RB_AVAILABLE_LEVEL_COL = new Object[]{"levelValue"};
     ...
     */
    public static final Object[] ITEM_RESULTS_COLS = new Object[]{
    ...
    public static final String[] FILE_MGMT_LOOKUP_CUS_HEADER = new String[]{FORECAST_YEAR, FORECAST_MONTH_LABEL, ITEM_ID_LABEL, COMPANY_ID_LABEL, UNITS_LABEL, "Price Type", PRICE_LABEL, "Sales Amount", "Sales Inclusion", "Deduction ID",
    ...
    public static final Object[] fileMgtLookupCustomerColumns = new Object[]{FORCAST_YEAR, StringConstantsUtil.FORECAST_MONTH, StringConstantsUtil.ITEM_ID,
    ...
    public static final String[] EXCEL_FILE_MGMT_LOOKUP_DEMAND_DETAILS_HEADER = new String[]{FORECAST_TYPE, FORECAST_YEAR, FORECAST_MONTH_LABEL,
        "Item Id", StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER,
        "Brand Id", StringConstantsUtil.SEGMENT_LABEL, MARKET_SIZE_UNITS, MARKET_SHARE_RATIO_LABEL, StringConstantsUtil.MARKET_SHARE_UNITS_LABEL, UNCAPTURED_UNITS, UNCAPTURED_UNITS_RATIO, TOTAL_DEMAND_UNITS, TOTAL_DEMAND_AMOUNT, INVENTORY_UNIT_CHANGE, GROSS_UNITS_LABEL, GROSS_PRICE, GROSS_AMOUNT, NET_SALES_PRICE, NET_SALE_AMOUNT, "Batch Id", ORGANIZATION_KEY};

    public static final String[] EXCEL_FILE_MGMT_LOOKUP_DETAILS_HEADER = new String[]{"Year", MONTH_LABEL, ITEM_HASH, ITEM_NAME_LABEL, FORECAST_DATE_LABEL, PRICE_LABEL, UNITS_LABEL, DOLLARS};
    ...
    public static final String[] EXCEL_FILE_MGMT_LOOKUP_INV_DETAILS_SUMMARY = new String[]{"Year", MONTH_LABEL, "Day", "Week", ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER, UNITS_WITHDRAWN, AMOUNT_WITHDRAWN1, PRICE_LABEL, StringConstantsUtil.BATCH_ID_LABEL, ORGANIZATION_KEY};
