...
public class GtnFrameworkFormulaPopUpConfig {
	...
	private void addMainLayout(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		FormulaPopUpSearchSearchViewMainCssConfig
				.setComponentId(GtnFrameworkCommonConstants.FORMULA_POPUP_SEARCH_SEARCH_VIEW_MAIN_CSS_LAYOUT);
		...
		cssLayoutConfig
				.setParentComponentId(GtnFrameworkCommonConstants.FORMULA_POPUP_SEARCH_SEARCH_VIEW_MAIN_CSS_LAYOUT);
	...
	private void addFormulaType(List<GtnUIFrameworkComponentConfig> componentList) {
		GtnUIFrameworkLayoutConfig layout = gtnFrameworkConfigurationFactory
				.buildLayoutConfig(GtnUIFrameworkLayoutType.HORIZONTAL_LAYOUT);
		GtnUIFrameworkComponentConfig gtnLayout = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.FORMULA_TYPE_LAYOUT, GtnFrameworkCommonConstants.FORMULA_TYPE_LAYOUT, true,
				GtnUIFrameworkComponentType.LAYOUT);
		...
		GtnUIFrameworkComponentConfig companyType = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.FORMULA_TYPE, "Formula Type", true, GtnUIFrameworkComponentType.COMBOBOX);
	...
	private void addFormulaNo(List<GtnUIFrameworkComponentConfig> componentList) {
		GtnUIFrameworkLayoutConfig layout = gtnFrameworkConfigurationFactory
				.buildLayoutConfig(GtnUIFrameworkLayoutType.HORIZONTAL_LAYOUT);
		GtnUIFrameworkComponentConfig gtnLayout = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.FORMULA_NO_LAYOUT, GtnFrameworkCommonConstants.FORMULA_NO_LAYOUT, true,
				GtnUIFrameworkComponentType.LAYOUT);
		gtnLayout.setParentComponentId(GtnFrameworkCommonConstants.SEARCH_CRITERIALAYOUT);
		gtnLayout.setGtnLayoutConfig(layout);
		componentList.add(gtnLayout);
		...
		GtnUIFrameworkComponentConfig companyNoConfig = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.FORMULA_NO, "Formula NO", true, GtnUIFrameworkComponentType.TEXTBOX);
	...
	private void addFormulaName(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		GtnUIFrameworkLayoutConfig layout = gtnFrameworkConfigurationFactory
				.buildLayoutConfig(GtnUIFrameworkLayoutType.HORIZONTAL_LAYOUT);
		GtnUIFrameworkComponentConfig gtnLayout = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.FORMULA_NAME_LAYOUT, GtnFrameworkCommonConstants.FORMULA_NAME_LAYOUT, true,
				GtnUIFrameworkComponentType.LAYOUT);
		gtnLayout.setParentComponentId(GtnFrameworkCommonConstants.SEARCH_CRITERIALAYOUT);
		gtnLayout.setGtnLayoutConfig(layout);
		componentList.add(gtnLayout);
		...
		GtnUIFrameworkComponentConfig companyNameConfig = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.FORMULA_NAME, "Formula Name", true, GtnUIFrameworkComponentType.TEXTBOX);
	...
	private void addFormulaId(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		GtnUIFrameworkLayoutConfig layout = gtnFrameworkConfigurationFactory
				.buildLayoutConfig(GtnUIFrameworkLayoutType.HORIZONTAL_LAYOUT);
		GtnUIFrameworkComponentConfig gtnLayout = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.FORMULA_ID_LAYOUT, GtnFrameworkCommonConstants.FORMULA_ID_LAYOUT, true,
				GtnUIFrameworkComponentType.LAYOUT);
		gtnLayout.setParentComponentId(GtnFrameworkCommonConstants.SEARCH_CRITERIALAYOUT);
		gtnLayout.setGtnLayoutConfig(layout);
		componentList.add(gtnLayout);
		...
		GtnUIFrameworkComponentConfig companyNameConfig = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.SYSTEM_ID, "Formula Id", true, GtnUIFrameworkComponentType.TEXTBOX);
	...
	private void addSearchButtonComponent(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		loadDataTableActionConfig.setFieldValues(Arrays
				.asList(new String[] { GtnFrameworkCommonConstants.FORMULA_TYPE, GtnFrameworkCommonConstants.FORMULA_NO,
	...
	private void addPagedTableComponent(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		GtnUIFrameworkComponentConfig searchResultConfig = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.FORMULA_POPUP_SEARCH_RESULT_TABLE, GtnFrameworkCommonConstants.RESULTS,
				true, GtnUIFrameworkComponentType.PAGEDTABLE);
		...
		searchResults.setTableColumnMappingId(
				new Object[] { GtnFrameworkCommonConstants.FORMULA_TYPE, GtnFrameworkCommonConstants.SYSTEM_ID,
						GtnFrameworkCommonConstants.FORMULA_NO, GtnFrameworkCommonConstants.FORMULA_NAME });
	...
	private void formulaDetailsResultLayout(List<GtnUIFrameworkComponentConfig> componentList) {
		GtnUIFrameworkComponentConfig layoutConfig = gtnFrameworkConfigurationFactory.buildComponentConfig(
				...
				GtnFrameworkCommonConstants.FORMULA_DETAILS_RESULT_LAYOUT, true, GtnUIFrameworkComponentType.LAYOUT);
	...
	private void formulaDetailsResultDataTable(List<GtnUIFrameworkComponentConfig> componentList) {
		GtnUIFrameworkComponentConfig attachResultConfig = gtnFrameworkConfigurationFactory.buildComponentConfig(
				"FormulaPopUpformulaDetailsattachResultTable", GtnFrameworkCommonConstants.RESULTS, true,
		...
		attachResults.setTableColumnDataType(new Class[] { String.class });
	...
	private void addActionButtonLayout(List<GtnUIFrameworkComponentConfig> componentList) {
		GtnUIFrameworkComponentConfig gtnLayout = gtnFrameworkConfigurationFactory.buildComponentConfig(
				...
				GtnUIFrameworkComponentType.LAYOUT);
		gtnLayout.setComponentWidth(GtnFrameworkCssConstants.HUNDRED_PERCENTAGE);
		gtnLayout.setAuthorizationIncluded(true);
	...
	private void addSelectButtonComponent(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		closeAction.setActionParameterList(
				Arrays.asList(new Object[] { GtnFrameworkCommonConstants.FORMULA_POP_UP_SEARCH_SEARCH_VIEW }));
