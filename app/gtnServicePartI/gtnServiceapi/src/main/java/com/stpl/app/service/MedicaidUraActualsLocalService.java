...
/**
 * Provides the local service interface for MedicaidUraActuals. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see MedicaidUraActualsLocalServiceUtil
...
public interface MedicaidUraActualsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MedicaidUraActualsLocalServiceUtil} to access the medicaid ura actuals local service. Add custom service methods to {@link com.stpl.app.service.impl.MedicaidUraActualsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
