...
public class AccClosureViewMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<AccClosureViewMasterLocalService, AccClosureViewMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AccClosureViewMasterLocalService.class);
}