...
public class IvldInventoryWdProjMasCacheModel implements CacheModel<IvldInventoryWdProjMas>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldInventoryWdProjMasCacheModel)) {
			return false;
		}

		IvldInventoryWdProjMasCacheModel ivldInventoryWdProjMasCacheModel = (IvldInventoryWdProjMasCacheModel)obj;

		if (ivldInventoryWdProjMasSid == ivldInventoryWdProjMasCacheModel.ivldInventoryWdProjMasSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldInventoryWdProjMasSid);
	}
	...
	public IvldInventoryWdProjMas toEntityModel() {
		...
		ivldInventoryWdProjMasImpl.setCheckRecord(checkRecord);
