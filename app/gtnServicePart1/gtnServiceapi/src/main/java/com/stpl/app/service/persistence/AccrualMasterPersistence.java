...
public interface AccrualMasterPersistence extends BasePersistence<AccrualMaster> {
	...
	*/
	public void cacheResult(java.util.List<AccrualMaster> accrualMasters);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, AccrualMaster> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<AccrualMaster> findAll();
	...
	*/
	public java.util.List<AccrualMaster> findAll(int start, int end);
	...
	*/
	public java.util.List<AccrualMaster> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AccrualMaster> orderByComparator);
