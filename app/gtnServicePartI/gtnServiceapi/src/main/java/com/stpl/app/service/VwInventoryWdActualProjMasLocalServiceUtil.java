...
public class VwInventoryWdActualProjMasLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<VwInventoryWdActualProjMasLocalService, VwInventoryWdActualProjMasLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VwInventoryWdActualProjMasLocalService.class);
}