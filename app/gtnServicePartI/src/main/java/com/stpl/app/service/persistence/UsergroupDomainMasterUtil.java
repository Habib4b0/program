...
/**
 * The persistence utility for the usergroup domain master service. This utility wraps {@link UsergroupDomainMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class UsergroupDomainMasterUtil {
    private static UsergroupDomainMasterPersistence _persistence;
     ...
     */
    public static void clearCache(UsergroupDomainMaster usergroupDomainMaster) {
        getPersistence().clearCache(usergroupDomainMaster);
    }
     ...
     */
    public static List<UsergroupDomainMaster> findWithDynamicQuery(
     ...
     */
    public static UsergroupDomainMaster update(
        UsergroupDomainMaster usergroupDomainMaster) throws SystemException {
        return getPersistence().update(usergroupDomainMaster);
    }
    ...
    public static UsergroupDomainMaster update(
        ...
        return getPersistence().update(usergroupDomainMaster, serviceContext);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(usergroupDomainMaster);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(usergroupDomainMasters);
    }
    ...
    */
    public static com.stpl.app.model.UsergroupDomainMaster create(
        int usergroupDomainSid) {
        return getPersistence().create(usergroupDomainSid);
    }
    ...
    */
    public static com.stpl.app.model.UsergroupDomainMaster remove(
        int usergroupDomainSid)
        throws com.stpl.app.NoSuchUsergroupDomainMasterException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().remove(usergroupDomainSid);
    }

    public static com.stpl.app.model.UsergroupDomainMaster updateImpl(
        com.stpl.app.model.UsergroupDomainMaster usergroupDomainMaster)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(usergroupDomainMaster);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.UsergroupDomainMaster findByPrimaryKey(
        int usergroupDomainSid)
        throws com.stpl.app.NoSuchUsergroupDomainMasterException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().findByPrimaryKey(usergroupDomainSid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.UsergroupDomainMaster fetchByPrimaryKey(
        int usergroupDomainSid)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().fetchByPrimaryKey(usergroupDomainSid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.UsergroupDomainMaster> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static UsergroupDomainMasterPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (UsergroupDomainMasterPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    UsergroupDomainMasterPersistence.class.getName());

            ReferenceRegistry.registerReference(UsergroupDomainMasterUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(UsergroupDomainMasterPersistence persistence) {
    }
}
