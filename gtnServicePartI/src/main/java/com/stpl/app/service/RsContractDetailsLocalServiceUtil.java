...
public class RsContractDetailsLocalServiceUtil {
    private static RsContractDetailsLocalService _service;
    ...
    */
    ...
    public static java.lang.Boolean saveRsDetailsAttached(
        ...
        return getService().saveRsDetailsAttached(input, future);
    }

    public static void saveFormulaToContractRs(int contRsdSid, int rsdSid,
        int itemSid) {
        getService().saveFormulaToContractRs(contRsdSid, rsdSid, itemSid);
    }
    ...
    public static RsContractDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    RsContractDetailsLocalService.class.getName());

            if (invokableLocalService instanceof RsContractDetailsLocalService) {
                _service = (RsContractDetailsLocalService) invokableLocalService;
            } else {
                _service = new RsContractDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(RsContractDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(RsContractDetailsLocalService service) {
    }
}
