...
import com.stpl.app.service.CompanyIdentifierLocalService;
...
/**
 * Provides the base implementation for the company identifier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CompanyIdentifierLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class CompanyIdentifierLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements CompanyIdentifierLocalService,
        IdentifiableBean {
    ...
    private CompanyIdentifierLocalServiceClpInvoker _clpInvoker = new CompanyIdentifierLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CompanyIdentifierLocalServiceUtil} to access the company identifier local service.
     */
    ...
    @Override
    public CompanyIdentifier addCompanyIdentifier(
        CompanyIdentifier companyIdentifier) throws SystemException {
        companyIdentifier.setNew(true);

        return companyIdentifierPersistence.update(companyIdentifier);
    }
     ...
     */
    @Override
    public CompanyIdentifier createCompanyIdentifier(int companyIdentifierSid) {
        return companyIdentifierPersistence.create(companyIdentifierSid);
    }
    ...
    @Override
    public CompanyIdentifier deleteCompanyIdentifier(int companyIdentifierSid)
        throws PortalException, SystemException {
        return companyIdentifierPersistence.remove(companyIdentifierSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public CompanyIdentifier deleteCompanyIdentifier(
        CompanyIdentifier companyIdentifier) throws SystemException {
        return companyIdentifierPersistence.remove(companyIdentifier);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CompanyIdentifier.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return companyIdentifierPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return companyIdentifierPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public CompanyIdentifier fetchCompanyIdentifier(int companyIdentifierSid)
        throws SystemException {
        return companyIdentifierPersistence.fetchByPrimaryKey(companyIdentifierSid);
    }
     ...
     */
    @Override
    public CompanyIdentifier getCompanyIdentifier(int companyIdentifierSid)
        throws PortalException, SystemException {
        return companyIdentifierPersistence.findByPrimaryKey(companyIdentifierSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return companyIdentifierPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<CompanyIdentifier> getCompanyIdentifiers(int start, int end)
        throws SystemException {
        return companyIdentifierPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCompanyIdentifiersCount() throws SystemException {
        return companyIdentifierPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public CompanyIdentifier updateCompanyIdentifier(
        CompanyIdentifier companyIdentifier) throws SystemException {
        return companyIdentifierPersistence.update(companyIdentifier);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.CompanyIdentifier",
            companyIdentifierLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = companyIdentifierPersistence.getDataSource();
