...
import com.stpl.app.adminconsole.hierarchybuilder.ui.form.HierarchyBuilderIndex;
...
public class HierarchyBuilderLandingView extends VerticalLayout implements View {
    ...
    private HierarchyBuilderIndex hierarchyBuilderIndex;
     ...
     */
    public HierarchyBuilderLandingView(final SessionDTO sessionDTO) throws SystemException, PortalException, Exception {
        super();
    ...
    public void enter(final ViewChangeEvent event) {
        ...
        try {
            LOGGER.info("enter method started");
            setStyleName("bootstrap");
            LOGGER.info("enter method ended");
        } catch (Exception ex) {
