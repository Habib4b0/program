...
/**
 * Provides the local service interface for HierarchyLevelValues. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see HierarchyLevelValuesLocalServiceUtil
...
public interface HierarchyLevelValuesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HierarchyLevelValuesLocalServiceUtil} to access the hierarchy level values local service. Add custom service methods to {@link com.stpl.app.service.impl.HierarchyLevelValuesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
