...
public class TransferSelectionLogic {
    ...
    private List<TransferFromDTO> configureFromDetails(List<Object[]> resultList, String Category, Integer level) {
        ...
        for (Object[] temp : resultList) {
            ...
            tempDTO.setName(CommonUtil.getPureValue(String.valueOf(temp[2])));
            tempDTO.setContractSid(CommonUtil.getPureValue(String.valueOf(temp[3])));
            if (level == 1) {
                tempDTO.setCfpContractSid(CommonUtil.getPureValue(String.valueOf(temp[4])));
            } else if (level == 2) {
                tempDTO.setCfpContractSid(CommonUtil.getPureValue(String.valueOf(temp[4])));
                tempDTO.setIfpContractSid(CommonUtil.getPureValue(String.valueOf(temp[5])));
            } else if (level == 3) {
                tempDTO.setCfpContractSid(CommonUtil.getPureValue(String.valueOf(temp[4])));
                tempDTO.setIfpContractSid(CommonUtil.getPureValue(String.valueOf(temp[5])));
                tempDTO.setPsContractSid(CommonUtil.getPureValue(String.valueOf(temp[6])));
            } else if (level == 4) {
                tempDTO.setCfpContractSid(CommonUtil.getPureValue(String.valueOf(temp[4])));
                tempDTO.setIfpContractSid(CommonUtil.getPureValue(String.valueOf(temp[5])));
                tempDTO.setPsContractSid(CommonUtil.getPureValue(String.valueOf(temp[6])));
                tempDTO.setRsContractSid(CommonUtil.getPureValue(String.valueOf(temp[7])));
            }
            retList.add(tempDTO);
    ...
    private void getToInput(final Map<String, String> inputMap, final String searchComponent, final String searchField, final String searchValue) {
        if (Constant.CONTRACT_CATEGORY.equals(searchComponent)) {
            ...
            } else if (Constant.CONTRACT_SEARCH[2].equals(searchField)) {
            ...
            } else if (Constant.CFP_SEARCH[2].equals(searchField)) {
