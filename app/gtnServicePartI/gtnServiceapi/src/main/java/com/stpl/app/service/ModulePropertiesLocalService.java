...
/**
 * Provides the local service interface for ModuleProperties. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ModulePropertiesLocalServiceUtil
...
public interface ModulePropertiesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ModulePropertiesLocalServiceUtil} to access the module properties local service. Add custom service methods to {@link com.stpl.app.service.impl.ModulePropertiesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
