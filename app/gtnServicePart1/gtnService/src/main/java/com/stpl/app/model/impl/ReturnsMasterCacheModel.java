...
public class ReturnsMasterCacheModel implements CacheModel<ReturnsMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ReturnsMasterCacheModel)) {
			return false;
		}

		ReturnsMasterCacheModel returnsMasterCacheModel = (ReturnsMasterCacheModel)obj;

		if (returnsMasterSid == returnsMasterCacheModel.returnsMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, returnsMasterSid);
	}
