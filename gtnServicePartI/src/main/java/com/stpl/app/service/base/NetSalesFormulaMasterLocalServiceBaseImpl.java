...
public abstract class NetSalesFormulaMasterLocalServiceBaseImpl
    ...
    private NetSalesFormulaMasterLocalServiceClpInvoker _clpInvoker = new NetSalesFormulaMasterLocalServiceClpInvoker();
    ...
    public NetSalesFormulaMaster deleteNetSalesFormulaMaster(
        int netSalesFormulaMasterSid) throws PortalException, SystemException {
    ...
    public NetSalesFormulaMaster fetchNetSalesFormulaMaster(
        int netSalesFormulaMasterSid) throws SystemException {
     ...
     */
    @Override
    public int getNetSalesFormulaMastersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.NetSalesFormulaMaster",
