...
public class NmSalesProjectionPK implements Comparable<NmSalesProjectionPK>,
    Serializable {
    public int periodSid;
    public int projectionDetailsSid;

    public NmSalesProjectionPK() {
    }

    public NmSalesProjectionPK(int periodSid, int projectionDetailsSid) {
    ...
    @Override
    public int compareTo(NmSalesProjectionPK pk) {
        if (pk == null) {
            return -1;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof NmSalesProjectionPK)) {
            return false;
        }

        NmSalesProjectionPK pk = (NmSalesProjectionPK) obj;
