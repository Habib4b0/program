...
public class ProductGroupLogic {
    ...
    public List<ProductGroupLookUpDTO> convertToProductGroupDTO(List obtainedList) {
        ...
        for (Object record : obtainedList) {
            ...
            productGroupDTO.setItemGroupSid((obtainedObject[2] == null) ? 0 : Integer.valueOf(obtainedObject[2].toString()));
            productGroupDTO.setCompany((obtainedObject[3] == null) ? StringUtils.EMPTY : String.valueOf(obtainedObject[3].toString()));
            productGroupDTO.setCompanySid((obtainedObject[4] == null) ? 0 : Integer.valueOf(obtainedObject[4].toString()));
            productGroupDTO.setProductGroupDescription((obtainedObject[5] == null) ? StringUtils.EMPTY : String.valueOf(obtainedObject[5]));
