...
/**
 * Provides the local service interface for CompanyGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CompanyGroupLocalServiceUtil
...
public interface CompanyGroupLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CompanyGroupLocalServiceUtil} to access the company group local service. Add custom service methods to {@link com.stpl.app.service.impl.CompanyGroupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
