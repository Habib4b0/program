...
public class IvldCompanyTradeClassCacheModel implements CacheModel<IvldCompanyTradeClass>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldCompanyTradeClassCacheModel)) {
			return false;
		}

		IvldCompanyTradeClassCacheModel ivldCompanyTradeClassCacheModel = (IvldCompanyTradeClassCacheModel)obj;

		if (ivldCompanyTradeClassSid == ivldCompanyTradeClassCacheModel.ivldCompanyTradeClassSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldCompanyTradeClassSid);
	}
