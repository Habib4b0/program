...
public interface AccrualDetailsPersistence extends BasePersistence<AccrualDetails> {
	...
	*/
	public void cacheResult(java.util.List<AccrualDetails> accrualDetailses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, AccrualDetails> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<AccrualDetails> findAll();
	...
	*/
	public java.util.List<AccrualDetails> findAll(int start, int end);
	...
	*/
	public java.util.List<AccrualDetails> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AccrualDetails> orderByComparator);
