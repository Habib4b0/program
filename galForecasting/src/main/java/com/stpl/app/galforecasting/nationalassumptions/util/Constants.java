    ...
    public enum CalculatePeriods implements CalendarInterface {
        ...
        CALCULATE {
                    ...
                    public int getSemiAnnualCount() {
                        return (2 * CalendarConstants.HISTORY_YEAR_COUNT.getConstant());
                    }
                    ...
                    public int getQuarterCount() {
                        return (4 * CalendarConstants.HISTORY_YEAR_COUNT.getConstant());
                    }
                    ...
                    public int getMonthCount() {
                        return (12 * CalendarConstants.HISTORY_YEAR_COUNT.getConstant());
                    }
