...
public class ContractHeaderSearchView extends VerticalLayout implements View {
     ...
     * Default constructor.
     */
    public ContractHeaderSearchView(final SessionDTO sessionDTO) throws SystemException, PortalException, Exception {
        super();
        LOGGER.info("Enters ContractHeaderSearchView constructor");
        addStyleName("bootstrap");
        addStyleName("bootstrap-bb");
        setSpacing(true);
        this.sessionDTO=sessionDTO;
        addComponent(new AbstractSearchForm(ConstantUtil.CONTRACT_HEADER,this.sessionDTO));
        LOGGER.info(" ContractHeaderSearchView constructor ends");
    }
