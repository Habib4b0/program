...
/**
 * Provides the local service interface for ImtdDeductionDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ImtdDeductionDetailsLocalServiceUtil
...
public interface ImtdDeductionDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ImtdDeductionDetailsLocalServiceUtil} to access the imtd deduction details local service. Add custom service methods to {@link com.stpl.app.service.impl.ImtdDeductionDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
