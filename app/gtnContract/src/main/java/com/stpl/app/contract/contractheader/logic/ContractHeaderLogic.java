...
public class ContractHeaderLogic implements HeaderLogic {
    ...
    public List<SearchResultsDTO> searchContractMaster(final CustomFieldGroup searchItemForm, final int start, final int end, final List<OrderByColumn> orderByColumns, final BeanSearchCriteria criteria) throws SystemException,
        ...
        filterMap.put(Constants.CONTRACT_STATUS, Constants.ZERO);
        filterMap.put(Constants.CONTRACT_TYPE, Constants.ZERO);
        ...
        LOGGER.debug("Returns searchList size =" + result.size() + "  and  searchContractMaster method ends");
        return searchList;
    }
    ...
    public List<ContractMasterDTO> getCustomizedSearchFormFromModel(final List<ContractMaster> list) throws SystemException, PortalException {
        ...
        LOGGER.debug(" getCustomizedSearchFormFromModel method ends  by returning searchItemList size=" + searchItemList.size());
    ...
    public List<SearchResultsDTO> getCustomizedSearchFilter(final List list) {
        ...
        for (int i = Constants.ZERO; i < list.size(); i++) {
            ...
            searchItemForm.setContractSystemId(Integer.valueOf(String.valueOf(obj[Constants.ZERO])));
            searchItemForm.setContractId(String.valueOf(obj[NumericConstants.ONE]));
            searchItemForm.setContractNo(String.valueOf(obj[NumericConstants.TWO]));
            if (obj[NumericConstants.THREE] != null) {
                searchItemForm.setContractName(String.valueOf(obj[NumericConstants.THREE]));
            }
            searchItemForm.setContractStatus(String.valueOf(obj[NumericConstants.EIGHT] != null && !Constants.SELECT_ONE.equals(String.valueOf(obj[NumericConstants.EIGHT])) ? obj[NumericConstants.EIGHT] : StringUtils.EMPTY));
            searchItemForm.setContractType(String.valueOf(obj[NumericConstants.NINE] != null && !Constants.SELECT_ONE.equals(String.valueOf(obj[NumericConstants.NINE])) ? obj[NumericConstants.NINE] : StringUtils.EMPTY));
            if (obj[NumericConstants.TEN] != null && !String.valueOf(obj[NumericConstants.TEN]).equals(Constants.SELECT_ONE)) {
                searchItemForm.setTradeClass(String.valueOf(obj[NumericConstants.TEN]));
            }
            if (obj[NumericConstants.ELEVEN] != null) {
                searchItemForm.setTradingPartnerName(String.valueOf(obj[NumericConstants.ELEVEN]));
            }
            searchItemForm.setRecordLockStatus(String.valueOf(Boolean.valueOf(String.valueOf(obj[NumericConstants.TWELVE]))));
            searchItemList.add(searchItemForm);
        }
    ...
    public ContractMasterDTO getContractMasterById(final int contractSystemId) throws SystemException, PortalException {
        ...
        LOGGER.debug("entering getContractMasterById method with contractSystemId:" + contractSystemId);
        ...
        LOGGER.debug("ends getContractMasterById method after returning contractMasterDTO ");
    ...
    public String saveContractMaster(final CustomFieldGroup contractMasterForm, final List<ContractAliasMasterDTO> contractAliasList, final List<NotesDTO> availableUploadedInformation, final String addedNotes) throws SystemException, PortalException {
        ...
        LOGGER.debug("entering saveContractMaster method");
        ...
        if (StringUtils.isNotEmpty(contractID)) {
            ...
            if (!contractMasterList.isEmpty()) {
                systemId = String.valueOf(contractMasterList.get(Constants.ZERO).getContractMasterSid());
                flag = true;
            }
        }
        ...
        if (systemId1.equals(Constants.NULL) || Constants.ZEROSTRING.equals(systemId1) || StringUtils.EMPTY.equals(systemId1)) {
            contract = ContractMasterLocalServiceUtil.createContractMaster(Constants.ZERO);
            LOGGER.debug("saving new record ");
        } else {
            LOGGER.debug("updating old record ");
        ...
        if (contractMasterForm.getField(Constants.CONTRACT_TYPE).getValue() != null && ((com.stpl.ifs.util.HelperDTO) contractMasterForm.getField(Constants.CONTRACT_TYPE).getValue()).getId() != Constants.ZERO) {
            contract.setContractType(((com.stpl.ifs.util.HelperDTO) contractMasterForm.getField(Constants.CONTRACT_TYPE).getValue()).getId());
        }
        if (contractMasterForm.getField(Constants.CONTRACT_STATUS).getValue() != null || ((com.stpl.ifs.util.HelperDTO) contractMasterForm.getField(Constants.CONTRACT_STATUS).getValue()).getId() != Constants.ZERO) {
        ...
        contract.setDocumentType(contractMasterForm.getField(Constants.DOC_TYPE).getValue() == null ? Constants.ZERO : ((com.stpl.ifs.util.HelperDTO) contractMasterForm.getField(Constants.DOC_TYPE).getValue()).getId());
        contract.setTerm(contractMasterForm.getField(Constants.TERM).getValue() == null || StringUtils.isEmpty(String.valueOf(contractMasterForm.getField(Constants.TERM).getValue())) ? Constants.ZERO : Integer.valueOf(contractMasterForm.getField(Constants.TERM).getValue().toString()));
        contract.setContractTradeClass(contractMasterForm.getField(Constants.TRADE_CLASS).getValue() == null ? Constants.ZERO : ((com.stpl.ifs.util.HelperDTO) contractMasterForm.getField(Constants.TRADE_CLASS).getValue()).getId());
        ...
        if (contractMasterForm.getField(Constants.COMPANY_LABEL).getValue() != null && StringUtils.isNotBlank(String.valueOf(contractMasterForm.getField(Constants.COMPANY_LABEL).getValue()))) {
            if (contractMasterForm.getField(Constants.COMPANY_NAME).getValue() != null && StringUtils.isNotBlank(String.valueOf(contractMasterForm.getField(Constants.COMPANY_NAME).getValue()))) {
                ...
                contract.setBunitCompanyMasterSid(companyId == Constants.ZERO || StringUtils.isEmpty(String.valueOf(contractMasterForm.getField(Constants.COMPANY_NAME).getValue())) ? null : String.valueOf(companyId));
            } else {
        ...
        if (contractMasterForm.getField(Constants.COMPANY_SYSTEM_ID).getValue() != null) {
            contract.setManfCompanyMasterSid((((HelperDTO) contractMasterForm.getField(Constants.COMPANY_SYSTEM_ID).getValue()).getId()) == Constants.ZERO ? null : String.valueOf(((HelperDTO) contractMasterForm.getField(Constants.COMPANY_SYSTEM_ID).getValue()).getId()));
        } else {
            contract.setManfCompanyMasterSid(null);
        }
        LOGGER.debug("contract.getManfCompanyMasterSid()" + contract.getManfCompanyMasterSid());
        if (contractMasterForm.getField(Constants.DOC_CLASS).getValue() != null) {
            ...
            contract.setDocumentClass(Constants.ZERO);
        }
        ...
        LOGGER.debug("contract.setContHoldCompanyMasterSid(Constants.ZERO)" + contract.getContHoldCompanyMasterSid());
        contract.setAdvanceNoticeDays(StringUtils.isBlank(String.valueOf(contractMasterForm.getField(Constants.ADVANCE_NOTICE_DAYS).getValue())) || "null".equals(String.valueOf(contractMasterForm.getField(Constants.ADVANCE_NOTICE_DAYS).getValue())) ? Constants.ZERO : Double.valueOf(String.valueOf(contractMasterForm.getField(Constants.ADVANCE_NOTICE_DAYS).getValue()).trim().replace(Constants.COMMA, StringUtils.EMPTY)));
        ...
        if (contractMasterForm.getField(Constants.AWARD_STATUS).getValue() != null) {
            ...
            contract.setAwardStatus(Constants.ZERO);
        }
        ...
        if (contractMasterForm.getField(Constants.PAYMENT_TERMS).getValue() != null) {
            ...
            contract.setPaymentTerms(Constants.ZERO);
        }
        ...
        if (systemId1.equals(Constants.NULL) || Constants.ZEROSTRING.equals(systemId1) || StringUtils.EMPTY.equals(systemId1)) {
            ...
            if (StringUtils.isBlank(contract.getContractNo()) || contract.getContractNo().equals(Constants.NULL)) {
                if (contractMaster.size() < Constants.ONE) {
                    ...
                    if (contract.getContractStatus() != Constants.ZERO) {
                    ...
                    if (contract.getContractType() != Constants.ZERO) {
                    ...
                    if (contract.getContractTradeClass() != Constants.ZERO) {
                    ...
                    if (contract.getDocumentType() != Constants.ZERO) {
                    ...
                    if (contract.getDocumentClass() != Constants.ZERO) {
                    ...
                    if (contract.getAwardStatus() != Constants.ZERO) {
                    ...
                    if (contract.getPaymentTerms() != Constants.ZERO) {
                ...
                if (contractMaster.size() < NumericConstants.ONE && contractNoMaster.size() < NumericConstants.ONE) {
                    ...
                    if (result.getAwardStatus() != Constants.ZERO) {
                    ...
                    if (result.getPaymentTerms() != Constants.ZERO) {
                        HelperTable helperTable = HelperTableLocalServiceUtil.fetchHelperTable(result.getAwardStatus());
                        udcCheck.increment(helperTable.getDescription(), UIUtils.PAYMENT_TERMS);
                    }
                    saveContractAliasMasterList(contractAliasList, result);
            ...
            if (count < NumericConstants.ONE && countNo < NumericConstants.ONE) {
                final ContractMaster checkBean = dao.getContractMasterById(contract.getContractMasterSid());
                if (checkBean.getContractStatus() != Constants.ZERO) {
                ...
                if (checkBean.getContractType() != Constants.ZERO) {
                ...
                if (checkBean.getContractTradeClass() != Constants.ZERO) {
                ...
                if (checkBean.getDocumentType() != Constants.ZERO) {
                ...
                if (checkBean.getDocumentClass() != Constants.ZERO) {
                ...
                if (checkBean.getAwardStatus() != Constants.ZERO) {
                ...
                if (checkBean.getPaymentTerms() != Constants.ZERO) {
                ...
                for (int i = Constants.ZERO; i < aliasMasterList.size(); i++) {
                    ...
                    if (udcDeleteCheck.getContractAliasType() != Constants.ZERO) {
        ...
        LOGGER.debug(" ending saveContractMaster method ");
    ...
    public void saveContractAliasMasterList(final List<ContractAliasMasterDTO> aliasList, final ContractMaster result) throws SystemException {
        ...
        LOGGER.debug("enters saveContractAliasMasterList method ");
        ...
        LOGGER.debug(" saveContractAliasMasterList method ends ");
    ...
    public ContractMaster deleteContractMasterById(final int contractSystemId) throws SystemException, PortalException {
        ...
        LOGGER.debug("enters deleteContractMasterById with parameter contractSystemId=" + contractSystemId);
        ...
        LOGGER.debug(" deleteContractMasterById method ends with return value contract ");
    ...
    public List<HelperDTO> getDropDownList(final String listType) throws SystemException {
        ...
        helperList.add(new HelperDTO(Constants.ZERO, Constants.SELECT_ONE));
        if (list != null) {
            for (int i = Constants.ZERO; i < list.size(); i++) {
    ...
    public List<HelperDTO> getDropDownListWithoutNull(final String listType) throws SystemException {
        ...
        final List<HelperTable> list = dao.getHelperTableList(cfpDynamicQuery);
        if (list != null) {
            for (int i = Constants.ONE; i < list.size(); i++) {
    ...
    public List<HelperDTO> getTradingPartnerNameList() throws SystemException {
        ...
        final List<CompanyMaster> resultList = dao.getCompanyMasterList(companyDynamicQuery, Constants.ZERO, NumericConstants.TEN);
        ...
        LOGGER.debug("returns helperList size =" + helperList.size() + " and the getTradingPartnerNameList method ends ");
        return helperList;
    }
    ...
    public List<HelperDTO> getCompanyNameList() throws SystemException {
        ...
        LOGGER.debug("returns helperList size =" + helperList.size() + " and getCompanyNameList method ends");
        return helperList;
    }
    ...
    public int getSearchCount(final CustomFieldGroup searchItemForm, final BeanSearchCriteria criteria) throws SystemException {
        ...
        LOGGER.debug("Value of Contract ID  ---" + contractId);
        if (searchItemForm.getField(Constants.TEXT_TWO) == null || searchItemForm.getField(Constants.TEXT_TWO).getValue().toString() == null) {
            contractNo = Constants.PERCENT;
        } else {
            contractNo = searchItemForm.getField(Constants.TEXT_TWO).getValue().toString().trim();
        ...
        if (contractType != Constants.ZERO) {
        }
        if (contractStatus != Constants.ZERO) {
        }
        if (StringUtils.isNotBlank(tradeClass)) {
            tradeClass = tradeClass.replace(Constants.CHAR_ASTERISK, Constants.CHAR_PERCENT);
        }
        ...
        List count = ContractMasterLocalServiceUtil.getContractList(contractId, contractNo, contractName, contractStatus, contractType, tradeClass, tradingPartner, filterMap, null, null, Constants.ZERO, Constants.ZERO, false);
    ...
    public int getTotalCount() throws SystemException {
        LOGGER.debug("Entering getTotalCount method");

        final int count = dao.getContractMasterCount();
        LOGGER.debug("Ends getTotalCount method ");
        return count;
    }
    ...
    public List<HelperTable> getHelperTableList(final DynamicQuery dynamicQuery) throws SystemException {
        LOGGER.debug("Enters getHelperTableList method");
        final List<HelperTable> helperTableList = dao.getHelperTableList(dynamicQuery);
        LOGGER.debug(" getHelperTableList method ends after returning helperTableList size=" + helperTableList.size());
    ...
    public HelperTable updateHelperTable(final HelperTable helperTable) throws SystemException {
        LOGGER.debug("Enters updateHelperTable method");
        final HelperTable updatehelperTable = dao.updateHelperTable(helperTable);
        LOGGER.debug(" updateHelperTable method ends after returning updatehelperTable ");
    ...
    public List<AdditionalInfoDTO> getAttachmentDTOList(int masterTableSid,
        ...
        try {
            ...
            if (docDetailsList != null && docDetailsList.size() > Constants.ZERO) {
                for (MasterDataFiles docDetails : docDetailsList) {
                    ...
                    attachmentDTO.setDocumentName(filePath.substring(filePath.lastIndexOf("/") + NumericConstants.ONE, filePath.lastIndexOf("_")) + filePath.substring(filePath.lastIndexOf(".")));
     ...
     */
    public Boolean deleteUploadedFile(int docDetailsId,
            String fileName) {
        if (docDetailsId != Constants.ZERO) {
            try {
    ...
    public List<SearchResultsDTO> searchContractResults(final CustomFieldGroup searchItemForm, final int start, final int end, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet) throws SystemException,
        ...
        LOGGER.debug("searchContractResults Returns searchList size =" + result.size() + "  and  searchContractMaster method ends");
        return searchList;
    }
    ...
    public int getContractCount(final CustomFieldGroup searchItemForm, final Set<Container.Filter> filterSet) throws SystemException {
        LOGGER.debug("Entering getContractCount method  ");
        String contractId;
        String contractNo;
        String contractName;
        int contractType;
