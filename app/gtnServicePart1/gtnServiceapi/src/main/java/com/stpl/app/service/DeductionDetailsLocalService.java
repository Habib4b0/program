...
/**
 * Provides the local service interface for DeductionDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see DeductionDetailsLocalServiceUtil
...
public interface DeductionDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DeductionDetailsLocalServiceUtil} to access the deduction details local service. Add custom service methods to {@link com.stpl.app.service.impl.DeductionDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
