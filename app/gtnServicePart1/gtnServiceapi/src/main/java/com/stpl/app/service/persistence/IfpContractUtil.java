...
/**
 * The persistence utility for the ifp contract service. This utility wraps {@link com.stpl.app.service.persistence.impl.IfpContractPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class IfpContractUtil {
	...
	*/
	public static void cacheResult(IfpContract ifpContract) {
	...
	*/
	public static void cacheResult(List<IfpContract> ifpContracts) {
	...
	*/
	public static IfpContract create(int ifpContractSid) {
	...
	*/
	public static IfpContract remove(int ifpContractSid)
		throws com.stpl.app.exception.NoSuchIfpContractException {
		return getPersistence().remove(ifpContractSid);
	}

	public static IfpContract updateImpl(IfpContract ifpContract) {
	...
	* @throws NoSuchIfpContractException if a ifp contract with the primary key could not be found
	*/
	public static IfpContract findByPrimaryKey(int ifpContractSid)
		throws com.stpl.app.exception.NoSuchIfpContractException {
	...
	*/
	public static IfpContract fetchByPrimaryKey(int ifpContractSid) {
		return getPersistence().fetchByPrimaryKey(ifpContractSid);
	}

	public static java.util.Map<java.io.Serializable, IfpContract> fetchByPrimaryKeys(
	...
	*/
	public static List<IfpContract> findAll() {
	...
	*/
	public static List<IfpContract> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IfpContractPersistence, IfpContractPersistence> _serviceTracker =
		ServiceTrackerFactory.open(IfpContractPersistence.class);
}