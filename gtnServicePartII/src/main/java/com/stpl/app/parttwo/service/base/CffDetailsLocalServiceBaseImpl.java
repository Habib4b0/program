...
import com.stpl.app.parttwo.service.CffDetailsLocalService;
...
/**
 * Provides the base implementation for the cff details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.CffDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.CffDetailsLocalServiceImpl
 * @see com.stpl.app.parttwo.service.CffDetailsLocalServiceUtil
 * @generated
 */
public abstract class CffDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements CffDetailsLocalService,
        IdentifiableBean {
    ...
    private CffDetailsLocalServiceClpInvoker _clpInvoker = new CffDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.CffDetailsLocalServiceUtil} to access the cff details local service.
     */
    ...
    @Override
    public CffDetails addCffDetails(CffDetails cffDetails)
        throws SystemException {
        cffDetails.setNew(true);

        return cffDetailsPersistence.update(cffDetails);
    }
     ...
     */
    @Override
    public CffDetails createCffDetails(int cffDetailsSid) {
        return cffDetailsPersistence.create(cffDetailsSid);
    }
    ...
    @Override
    public CffDetails deleteCffDetails(int cffDetailsSid)
        throws PortalException, SystemException {
        return cffDetailsPersistence.remove(cffDetailsSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public CffDetails deleteCffDetails(CffDetails cffDetails)
        throws SystemException {
        return cffDetailsPersistence.remove(cffDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CffDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return cffDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return cffDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return cffDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public CffDetails fetchCffDetails(int cffDetailsSid)
        throws SystemException {
        return cffDetailsPersistence.fetchByPrimaryKey(cffDetailsSid);
    }
     ...
     */
    @Override
    public CffDetails getCffDetails(int cffDetailsSid)
        throws PortalException, SystemException {
        return cffDetailsPersistence.findByPrimaryKey(cffDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return cffDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<CffDetails> getCffDetailses(int start, int end)
        throws SystemException {
        return cffDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCffDetailsesCount() throws SystemException {
        return cffDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public CffDetails updateCffDetails(CffDetails cffDetails)
        throws SystemException {
        return cffDetailsPersistence.update(cffDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.CffDetails",
            cffDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.CffDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = cffDetailsPersistence.getDataSource();
