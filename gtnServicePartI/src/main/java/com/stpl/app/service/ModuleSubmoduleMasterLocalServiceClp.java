 ...
 * @generated
 */
public class ModuleSubmoduleMasterLocalServiceClp
    ...
    public ModuleSubmoduleMasterLocalServiceClp(
    ...
    public com.stpl.app.model.ModuleSubmoduleMaster addModuleSubmoduleMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(moduleSubmoduleMaster)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ModuleSubmoduleMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ModuleSubmoduleMaster createModuleSubmoduleMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { moduleSubmoduleSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ModuleSubmoduleMaster deleteModuleSubmoduleMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { moduleSubmoduleSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ModuleSubmoduleMaster fetchModuleSubmoduleMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { moduleSubmoduleSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ModuleSubmoduleMaster getModuleSubmoduleMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { moduleSubmoduleSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ModuleSubmoduleMaster> getModuleSubmoduleMasters(
        ...
        return (java.util.List<com.stpl.app.model.ModuleSubmoduleMaster>) ClpSerializer.translateOutput(returnObj);
    }
