...
import com.stpl.app.parttwo.service.VwCompanyTradeClassLocalService;
...
/**
 * Provides the base implementation for the vw company trade class local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwCompanyTradeClassLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwCompanyTradeClassLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwCompanyTradeClassLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VwCompanyTradeClassLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VwCompanyTradeClassLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwCompanyTradeClassLocalServiceUtil} to access the vw company trade class local service.
	 */
	...
	@Override
	public VwCompanyTradeClass addVwCompanyTradeClass(
		VwCompanyTradeClass vwCompanyTradeClass) {
		vwCompanyTradeClass.setNew(true);

		return vwCompanyTradeClassPersistence.update(vwCompanyTradeClass);
	}
	 ...
	 */
	@Override
	public VwCompanyTradeClass createVwCompanyTradeClass(
		int companyTradeClassSid) {
		return vwCompanyTradeClassPersistence.create(companyTradeClassSid);
	}
	...
	@Override
	public VwCompanyTradeClass deleteVwCompanyTradeClass(
		int companyTradeClassSid) throws PortalException {
		return vwCompanyTradeClassPersistence.remove(companyTradeClassSid);
	}
	...
	public VwCompanyTradeClass deleteVwCompanyTradeClass(
		VwCompanyTradeClass vwCompanyTradeClass) {
		return vwCompanyTradeClassPersistence.remove(vwCompanyTradeClass);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VwCompanyTradeClass.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vwCompanyTradeClassPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vwCompanyTradeClassPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VwCompanyTradeClass fetchVwCompanyTradeClass(
		int companyTradeClassSid) {
		return vwCompanyTradeClassPersistence.fetchByPrimaryKey(companyTradeClassSid);
	}
	 ...
	 */
	@Override
	public VwCompanyTradeClass getVwCompanyTradeClass(int companyTradeClassSid)
		throws PortalException {
		return vwCompanyTradeClassPersistence.findByPrimaryKey(companyTradeClassSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vwCompanyTradeClassLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VwCompanyTradeClass.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("companyTradeClassSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vwCompanyTradeClassLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VwCompanyTradeClass.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vwCompanyTradeClassLocalService.deleteVwCompanyTradeClass((VwCompanyTradeClass)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vwCompanyTradeClassPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VwCompanyTradeClass> getVwCompanyTradeClasses(int start, int end) {
		return vwCompanyTradeClassPersistence.findAll(start, end);
	}
	...
	public int getVwCompanyTradeClassesCount() {
		return vwCompanyTradeClassPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VwCompanyTradeClass updateVwCompanyTradeClass(
		VwCompanyTradeClass vwCompanyTradeClass) {
		return vwCompanyTradeClassPersistence.update(vwCompanyTradeClass);
	}
	 ...
	 */
	public VwCompanyTradeClassLocalService getVwCompanyTradeClassLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.VwCompanyTradeClass",
			vwCompanyTradeClassLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VwCompanyTradeClassLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vwCompanyTradeClassPersistence.getDataSource();
	...
	@BeanReference(type = VwCompanyTradeClassLocalService.class)
	protected VwCompanyTradeClassLocalService vwCompanyTradeClassLocalService;
