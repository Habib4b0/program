...
//		table.addContainerProperty("moduleName", String.class, null);
//		table.addContainerProperty("subModuleName", String.class, null);
//		table.addContainerProperty("function", String.class, null);
//		table.addContainerProperty("access", CheckBox.class, null);
...
//		            
//		        	SearchBusinessRoleModuleForm searchForm = searchResultbeans.getItem(
//		        			event.getProperty().getValue()).getBean();
//		        	if(searchForm.getAccess()!=null){
//		        		searchResultbeans.
//		        		searchForm.setAccess(false);
//		        	}else{
//		        		searchForm.setAccess(true);
//		        	}
//		        }
