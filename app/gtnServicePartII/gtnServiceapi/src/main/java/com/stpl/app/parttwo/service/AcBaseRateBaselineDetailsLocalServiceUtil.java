...
public class AcBaseRateBaselineDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<AcBaseRateBaselineDetailsLocalService, AcBaseRateBaselineDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AcBaseRateBaselineDetailsLocalService.class);
}