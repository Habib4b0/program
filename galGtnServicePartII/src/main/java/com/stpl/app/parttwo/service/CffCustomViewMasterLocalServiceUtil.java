...
public class CffCustomViewMasterLocalServiceUtil {
    private static CffCustomViewMasterLocalService _service;
    ...
    */
    ...
    public static CffCustomViewMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    CffCustomViewMasterLocalService.class.getName());

            if (invokableLocalService instanceof CffCustomViewMasterLocalService) {
                _service = (CffCustomViewMasterLocalService) invokableLocalService;
            } else {
                _service = new CffCustomViewMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(CffCustomViewMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(CffCustomViewMasterLocalService service) {
    }
}
