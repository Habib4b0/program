...
/**
 * Provides the base implementation for the ivldcompany identifier local service.
 *
 * <p>
...
public abstract class IvldcompanyIdentifierLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldcompanyIdentifierLocalServiceUtil} to access the ivldcompany identifier local service.
	 */

	/**
	 * Adds the ivldcompany identifier to the database. Also notifies the appropriate model listeners.
	 *
	 * @param ivldcompanyIdentifier the ivldcompany identifier
	 * @return the ivldcompany identifier that was added
	 */
	...
	/**
	 * Deletes the ivldcompany identifier with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 ...
	 * @throws PortalException if a ivldcompany identifier with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IvldcompanyIdentifier deleteIvldcompanyIdentifier(
		int ivldcompanyIdentifierSid) throws PortalException {
		return ivldcompanyIdentifierPersistence.remove(ivldcompanyIdentifierSid);
	}

	/**
	 * Deletes the ivldcompany identifier from the database. Also notifies the appropriate model listeners.
	 *
	 * @param ivldcompanyIdentifier the ivldcompany identifier
	 * @return the ivldcompany identifier that was removed
	 */
	...
	/**
	 * Returns the ivldcompany identifier with the primary key.
	 *
	 * @param ivldcompanyIdentifierSid the primary key of the ivldcompany identifier
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldcompanyIdentifierLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldcompanyIdentifier.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldcompanyIdentifierLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldcompanyIdentifier.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldcompanyIdentifierLocalService.deleteIvldcompanyIdentifier((IvldcompanyIdentifier)persistedModel);
	}
	...
	/**
	 * Updates the ivldcompany identifier in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param ivldcompanyIdentifier the ivldcompany identifier
	 * @return the ivldcompany identifier that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	 ...
	 */
	public IvldcompanyIdentifierLocalService getIvldcompanyIdentifierLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.IvldcompanyIdentifier",
	...
	public String getOSGiServiceIdentifier() {
		return IvldcompanyIdentifierLocalService.class.getName();
	}
	...
	@BeanReference(type = IvldcompanyIdentifierLocalService.class)
	protected IvldcompanyIdentifierLocalService ivldcompanyIdentifierLocalService;
