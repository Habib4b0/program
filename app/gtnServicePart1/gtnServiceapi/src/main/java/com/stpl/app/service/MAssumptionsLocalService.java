...
/**
 * Provides the local service interface for MAssumptions. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see MAssumptionsLocalServiceUtil
 * @see com.stpl.app.service.base.MAssumptionsLocalServiceBaseImpl
 * @see com.stpl.app.service.impl.MAssumptionsLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface MAssumptionsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MAssumptionsLocalServiceUtil} to access the m assumptions local service. Add custom service methods to {@link com.stpl.app.service.impl.MAssumptionsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public MAssumptions addMAssumptions(MAssumptions mAssumptions);
	...
	*/
	public MAssumptions createMAssumptions(int mAssumptionsSid);
	...
	*/
	...
	public MAssumptions deleteMAssumptions(int mAssumptionsSid)
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public MAssumptions deleteMAssumptions(MAssumptions mAssumptions);
	...
	*/
	...
	public MAssumptions fetchMAssumptions(int mAssumptionsSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MAssumptions getMAssumptions(int mAssumptionsSid)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MAssumptions> getMAssumptionses(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public MAssumptions updateMAssumptions(MAssumptions mAssumptions);
}