 ...
 * @generated
 */
public class HelperTableLocalServiceClp implements HelperTableLocalService {
    ...
    public HelperTableLocalServiceClp(
        ...
        _methodName19 = "findByHelperTableDetails";

        _methodParameterTypes19 = new String[] { "java.lang.String" };

        _methodName20 = "executeSelectQuery";
        ...
        _methodName22 = "executeUpdateQueryCount";
    ...
    public com.stpl.app.model.HelperTable addHelperTable(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(helperTable) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.HelperTable) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.HelperTable createHelperTable(int helperTableSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { helperTableSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.HelperTable deleteHelperTable(int helperTableSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { helperTableSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.HelperTable fetchHelperTable(int helperTableSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { helperTableSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.HelperTable getHelperTable(int helperTableSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { helperTableSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.HelperTable> getHelperTables(
        ...
        return (java.util.List<com.stpl.app.model.HelperTable>) ClpSerializer.translateOutput(returnObj);
    }
