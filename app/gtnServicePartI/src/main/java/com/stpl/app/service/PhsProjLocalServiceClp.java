 ...
 * @generated
 */
public class PhsProjLocalServiceClp implements PhsProjLocalService {
    ...
    public PhsProjLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.stpl.app.model.PhsProj addPhsProj(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(phsProj) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.PhsProj) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.PhsProj createPhsProj(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(phsProjPK) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.PhsProj> getPhsProjs(int start,
        ...
        return (java.util.List<com.stpl.app.model.PhsProj>) ClpSerializer.translateOutput(returnObj);
    }
