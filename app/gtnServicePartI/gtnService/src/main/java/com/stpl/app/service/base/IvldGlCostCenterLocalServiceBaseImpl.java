...
import com.stpl.app.service.IvldGlCostCenterLocalService;
...
/**
 * Provides the base implementation for the ivld gl cost center local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldGlCostCenterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldGlCostCenterLocalServiceImpl
 * @see com.stpl.app.service.IvldGlCostCenterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldGlCostCenterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldGlCostCenterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldGlCostCenterLocalServiceUtil} to access the ivld gl cost center local service.
	 */
	...
	@Override
	public IvldGlCostCenter addIvldGlCostCenter(
		IvldGlCostCenter ivldGlCostCenter) {
		ivldGlCostCenter.setNew(true);

		return ivldGlCostCenterPersistence.update(ivldGlCostCenter);
	}
	 ...
	 */
	@Override
	public IvldGlCostCenter createIvldGlCostCenter(int ivldGlCostCenterSid) {
		return ivldGlCostCenterPersistence.create(ivldGlCostCenterSid);
	}
	...
	@Override
	public IvldGlCostCenter deleteIvldGlCostCenter(int ivldGlCostCenterSid)
		throws PortalException {
		return ivldGlCostCenterPersistence.remove(ivldGlCostCenterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IvldGlCostCenter deleteIvldGlCostCenter(
		IvldGlCostCenter ivldGlCostCenter) {
		return ivldGlCostCenterPersistence.remove(ivldGlCostCenter);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldGlCostCenter.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldGlCostCenterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldGlCostCenterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldGlCostCenter fetchIvldGlCostCenter(int ivldGlCostCenterSid) {
		return ivldGlCostCenterPersistence.fetchByPrimaryKey(ivldGlCostCenterSid);
	}
	 ...
	 */
	@Override
	public IvldGlCostCenter getIvldGlCostCenter(int ivldGlCostCenterSid)
		throws PortalException {
		return ivldGlCostCenterPersistence.findByPrimaryKey(ivldGlCostCenterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldGlCostCenterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldGlCostCenter.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ivldGlCostCenterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldGlCostCenterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldGlCostCenter.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldGlCostCenterLocalService.deleteIvldGlCostCenter((IvldGlCostCenter)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldGlCostCenterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldGlCostCenter> getIvldGlCostCenters(int start, int end) {
		return ivldGlCostCenterPersistence.findAll(start, end);
	}
	...
	public int getIvldGlCostCentersCount() {
		return ivldGlCostCenterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldGlCostCenter updateIvldGlCostCenter(
		IvldGlCostCenter ivldGlCostCenter) {
		return ivldGlCostCenterPersistence.update(ivldGlCostCenter);
	}
	 ...
	 */
	public IvldGlCostCenterLocalService getIvldGlCostCenterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.IvldGlCostCenter",
			ivldGlCostCenterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.IvldGlCostCenter");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldGlCostCenterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldGlCostCenterPersistence.getDataSource();
	...
	@BeanReference(type = IvldGlCostCenterLocalService.class)
	protected IvldGlCostCenterLocalService ivldGlCostCenterLocalService;
