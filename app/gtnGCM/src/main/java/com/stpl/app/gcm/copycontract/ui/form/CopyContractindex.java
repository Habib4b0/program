...
public class CopyContractindex extends VerticalLayout {
    ...
    public final void configuretable() {
        try {
            ...
            copycontractResultsTable.setEditable(BooleanConstant.getTrueFlag());
            ...
            copycontractResultsTable.setColumnCheckBox(HeaderUtil.CONTRACT_SEARCH_COLUMN[0], BooleanConstant.getTrueFlag());
