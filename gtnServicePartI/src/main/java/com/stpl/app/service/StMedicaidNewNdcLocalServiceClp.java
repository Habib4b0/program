 ...
 * @generated
 */
public class StMedicaidNewNdcLocalServiceClp
    ...
    public StMedicaidNewNdcLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addStMedicaidNewNdc";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.StMedicaidNewNdc"
            };

        _methodName1 = "createStMedicaidNewNdc";

        _methodParameterTypes1 = new String[] {
                "com.stpl.app.service.persistence.StMedicaidNewNdcPK"
            };

        _methodName2 = "deleteStMedicaidNewNdc";

        _methodParameterTypes2 = new String[] {
                "com.stpl.app.service.persistence.StMedicaidNewNdcPK"
            };

        _methodName3 = "deleteStMedicaidNewNdc";
        ...
        _methodName10 = "fetchStMedicaidNewNdc";

        _methodParameterTypes10 = new String[] {
                "com.stpl.app.service.persistence.StMedicaidNewNdcPK"
            };

        _methodName11 = "getStMedicaidNewNdc";
        ...
        _methodName13 = "getStMedicaidNewNdcs";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getStMedicaidNewNdcsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateStMedicaidNewNdc";
    ...
    public com.stpl.app.model.StMedicaidNewNdc addStMedicaidNewNdc(
        ...
        return (com.stpl.app.model.StMedicaidNewNdc) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.StMedicaidNewNdc createStMedicaidNewNdc(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(stMedicaidNewNdcPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.StMedicaidNewNdc> getStMedicaidNewNdcs(
        ...
        return (java.util.List<com.stpl.app.model.StMedicaidNewNdc>) ClpSerializer.translateOutput(returnObj);
    }
