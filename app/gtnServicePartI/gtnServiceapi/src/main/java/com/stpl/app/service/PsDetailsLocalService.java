...
/**
 * Provides the local service interface for PsDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see PsDetailsLocalServiceUtil
...
public interface PsDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PsDetailsLocalServiceUtil} to access the ps details local service. Add custom service methods to {@link com.stpl.app.service.impl.PsDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public PsDetails fetchPsDetails(int psDetailsSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PsDetails getPsDetails(int psDetailsSid) throws PortalException;
