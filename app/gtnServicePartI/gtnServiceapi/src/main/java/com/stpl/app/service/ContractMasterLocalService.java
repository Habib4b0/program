...
/**
 * Provides the local service interface for ContractMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ContractMasterLocalServiceUtil
...
public interface ContractMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContractMasterLocalServiceUtil} to access the contract master local service. Add custom service methods to {@link com.stpl.app.service.impl.ContractMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
