...
public class ItemSearchLogic extends BeanItemContainer<SearchItemForm> implements ItemLogic {
    ...
    public List<ItemIrtIdentifierDTO> deleteIrtQualifer(final int qualifierId) throws SystemException, PortalException {
        ...
        LOGGER.debug("Ending deleteIrtQualifer");
     ...
     */
    @Override
    public List<ItemIrtIdentifierDTO> saveIrtQualifer(final ErrorfulFieldGroup binder,int qualifierSid) throws PortalException, SystemException {

        LOGGER.debug("Entering saveIrtQualifer");
        final int itemIrtQualifierId = qualifierSid;
    ...
    public List<ItemIrtIdentifierDTO> getPricingQualifierForEditList() throws SystemException, PortalException {
        ...
        LOGGER.debug("Ending ItemPricingQualifier size -" + list.size());
        return list;
    ...
    public List<ItemIrtIdentifierDTO> deletePricingQualifer(final int qualifierId) throws SystemException, PortalException {
        ...
        LOGGER.debug("Entering deletePricingQualifer P1: " + qualifierId);
     ...
     * @return the list< item pricing dt o>
     */
    public List<ItemIrtIdentifierDTO> savePricingQualifer(final ErrorfulFieldGroup binder,int qualifierSid) throws PortalException, SystemException {
        LOGGER.debug("Entering savePricingQualifer");
        final int itemPricingQualifierId = qualifierSid;
        ...
        if (itemPricingQualifierId <= 0) {
            ...
            LOGGER.debug("contractNoMaster.size()" + itemNoMaster.size());
        ...
        LOGGER.debug("Ending savePricingQualifier operation");
        return getPricingQualifierForEditList();
    }
    ...
    public List<SearchResultsDTO> getCustomizedSearchFormFromObject(
        ...
        if (list != null) {
            for (int i = 0; i < list.size(); i++) {
                ...
                searchItemForm.setItemNo(HelperUtils.getString(obj[NumericConstants.TWO]));
                ...
                searchItemForm.setItemType(CommonUtils.getDescription(HelperUtils.getInteger(obj[NumericConstants.FIVE])));
                searchItemForm.setItemStatus(CommonUtils.getDescription(HelperUtils.getInteger(obj[NumericConstants.SIX])));

                searchItemForm.setItemIrtQualifierName(new HelperDTO(
                        identifierType));
                if (obj.length == NumericConstants.TWENTY_NINE) {
                    searchItemForm.setItemIdentifier(obj[NumericConstants.TWENTY_EIGHT] == null ? StringUtils.EMPTY : obj[NumericConstants.TWENTY_EIGHT].toString());
                }
                searchItemForm.setRecordLockStatus(Boolean.parseBoolean(HelperUtils
                        .getString(obj[NumericConstants.SEVEN])));
                searchItemForm.setItemCode(HelperUtils.getString(obj[NumericConstants.EIGHT]));
                if (StringUtils.isNotBlank(HelperUtils.getString(obj[NumericConstants.NINE]))) {
                    searchItemForm.setPackageSize(CommonUtils.getDescription(Integer.parseInt(HelperUtils.getString(obj[NumericConstants.NINE]))));
                } else {
                    searchItemForm.setPackageSize(HelperUtils.getString(obj[NumericConstants.NINE]));
                }

                if (obj[NumericConstants.TWELVE] == null) {
                    searchItemForm.setUpps("0.000000");
                } else {
                    searchItemForm.setUpps(FORMATDECIMAL.format(Double.valueOf(HelperUtils.getString(obj[NumericConstants.TEN]))));
                }

                searchItemForm.setItemStartDate(CommonUtils
                        .convertDateToString((Date) obj[NumericConstants.ELEVEN]));
                searchItemForm.setItemEndDate(CommonUtils
                        .convertDateToString((Date) obj[NumericConstants.TWELVE]));

                searchItemForm.setLabelerCode(HelperUtils.getString(obj[NumericConstants.THIRTEEN]));
                searchItemForm.setForm(obj[NumericConstants.FOURTEEN] == null ? StringUtils.EMPTY : obj[NumericConstants.FOURTEEN].toString());
                searchItemForm.setStrength(obj[NumericConstants.FIFTEEN] == null ? StringUtils.EMPTY : obj[NumericConstants.FIFTEEN].toString());
                searchItemForm.setPrimaryUom(CommonUtils.getDescription(HelperUtils.getInteger(obj[NumericConstants.SIXTEEN])));
                searchItemForm.setSecondaryUom(CommonUtils.getDescription(HelperUtils.getInteger(obj[NumericConstants.SEVENTEEN])));
                searchItemForm.setItemClass(CommonUtils.getDescription(HelperUtils.getInteger(obj[NumericConstants.EIGHTEEN])));
                searchItemForm.setPediatricExclusiveStartDate(CommonUtils
                        .convertDateToString((Date) obj[NumericConstants.NINETEEN]));
                searchItemForm.setPediatricExclusiveEndDate(CommonUtils
                        .convertDateToString((Date) obj[NumericConstants.TWENTY]));
                searchItemForm.setClottingFactorStartDate(CommonUtils
                        .convertDateToString((Date) obj[NumericConstants.TWENTY_ONE]));
                searchItemForm.setClottingFactorEndDate(CommonUtils
                        .convertDateToString((Date) obj[NumericConstants.TWENTY_TWO]));
                searchItemForm.setBrand(obj[NumericConstants.TWENTY_THREE] == null ? StringUtils.EMPTY : obj[NumericConstants.TWENTY_THREE].toString());
                HelperDTO ndc8 = new HelperDTO();
                ndc8.setDescription(HelperUtils.getString(obj[NumericConstants.TWENTY_FOUR]));
                searchItemForm.setNdc8(ndc8);
                HelperDTO ndc9 = new HelperDTO();
                ndc9.setDescription(HelperUtils.getString(obj[NumericConstants.TWENTY_FIVE]));
                ...
                searchItemForm.setTherapeuticClass(obj[NumericConstants.TWENTY_SIX] != null && !StringUtils.isEmpty(obj[NumericConstants.TWENTY_SIX].toString()) && !ConstantsUtils.ZERO.equals(obj[NumericConstants.TWENTY_SIX]) && !ConstantsUtils.SELECT_ONE.equals(obj[NumericConstants.TWENTY_SIX])
                        ? HelperUtils.getString(obj[NumericConstants.TWENTY_SIX]) : StringUtils.EMPTY);
                searchItemForm.setItemBatchId(obj[NumericConstants.TWENTY_SEVEN] != null && !StringUtils.isEmpty(obj[NumericConstants.TWENTY_SEVEN].toString()) ? String.valueOf(obj[NumericConstants.TWENTY_SEVEN]) : StringUtils.EMPTY);
    ...
    public List<SearchResultsDTO> getCustomizedSearchFormFromModel(
        ...
        if (list != null) {
            for (int i = 0; i < list.size(); i++) {
                ...
                cfpDynamicQuery.add(RestrictionsFactoryUtil.eq(ConstantsUtils.COMPANY_MASTER_ID, !StringUtils.EMPTY.equals(obj.getManufacturerId()) ? Integer.parseInt(obj.getManufacturerId()) : 0));
        ...
        LOGGER.debug("return searchItemList size " + searchItemList.size());
    ...
    public ItemIdentifier getItemIrtIdentifier(final ItemIrtIdentifierDTO form) throws SystemException, NoSuchItemQualifierException {
        LOGGER.debug("Enters getItemIrtIdentifier() P1: ItemIrtIdentifierDTO ");
     ...
     */
    public ItemPricing getItemPricing(final ItemPricingDTO form) throws SystemException, NoSuchItemPricingQualifierException {
        LOGGER.debug("Enters getItemPricing() P1: ItemPricingDTO");
        ...
        LOGGER.debug("returns ItemPricing class ");
        return pricingForm;
    }
    ...
    public void getMaster(final ErrorfulFieldGroup itemMasterForm) {
        LOGGER.debug("Enters getMaster() P1: itemMasterForm binder");
    ...
    public String saveItemMaster(final ErrorfulFieldGroup itemMasterForm, final List<ItemIrtIdentifierDTO> identifierList, final List<ItemPricingDTO> priceList, final List<NotesDTO> availableUploadedInformation, final String addedNotes, final List<NotesDTO> removedDetailsList, final SessionDTO sessionDTO, final List<ItemPricingDTO> removedItemPriceList) throws SystemException, PortalException {
        ...
        try {
            ...
            ndcDynamicQuery.add(RestrictionsFactoryUtil.ne(ConstantsUtils.INBOUND_STATUS, "D"));
            ...
            if (ConstantsUtils.NULL.equals(systemId) || StringUtils.EMPTY.equals(systemId) || ConstantsUtils.ZERO.equals(systemId)) {
                ...
                if (itemMaster.size() < 1 && ndcList.size() < 1 && itemNoList.size() < 1) {
                    ...
                    LOGGER.debug(ConstantsUtils.DUPLICATE_ITEM_NO);
    ...
    public ItemMasterDTO getItemMasterById(final int identifier1) throws ParseException, SystemException, PortalException {
        ...
        LOGGER.debug("returns ItemMasterDTO");
    ...
    public CompanyMaster getManufacturerDetails(final int systemId) throws SystemException, PortalException {
        LOGGER.debug("Enters getManufacturerDetails() ");

        final CompanyMaster company = DAO.getCompanyMasterBySystemId(systemId);

        LOGGER.debug("returns CompanyMaster");
        return company;
     ...
     */
    public ItemMaster deleteItemMasterById(final int itemSystemId) throws SystemException, PortalException {

        LOGGER.debug("Entering deleteItemMasterById P1: " + itemSystemId);
        ...
        LOGGER.debug("return ItemMaster ");
        return item;
    }
     ...
     * @throws ParseException the parse exception
     */
    public Date convertDateToDateFormat(final Date date) throws ParseException {
        Date formattedDate;
        final DateFormat inputFormat = new SimpleDateFormat(ConstantsUtils.DATEFORMAT);
    ...
    public List<HelperDTO> getPricingQualifier() throws SystemException, PortalException {
        ...
        LOGGER.debug("returns list size " + list.size());
        return list;
    ...
    public String getBrandId(final String brandName) throws SystemException, Exception {
        ...
        LOGGER.debug("Enters getBrandId() P1: brandName " + brandName);
        final DynamicQuery cfpDynamicQuery = DynamicQueryFactoryUtil
                .forClass(BrandMaster.class);
    ...
    private String getManufactureIdFromCompanyMaster(final int companyMasterId) throws PortalException, SystemException {
        ...
        cfpDynamicQuery.add(RestrictionsFactoryUtil.eq(ConstantsUtils.COMPANY_MASTER_ID, companyMasterId));
    ...
    public static List<HelperDTO> getLazyPriceTypeResults(final int startIndex, final int end, final String filter, final boolean editListFlag) throws PortalException, SystemException {
        ...
        if (editListFlag) {
            ...
            if (StringUtils.EMPTY.equals(filterText) && itemPricingQualifierNameCount != 0 && itemPricingQualifierNameCount == end - NumericConstants.TWO) {
                helperTable = new HelperDTO(ConstantsUtils.EDIT_LIST);
                list.add(helperTable);
            }
        }
    ...
    public String getManufactureSid(final String id) throws PortalException, SystemException {
        ...
        LOGGER.debug("Entering getManufactureSid P1: id " + id);
        final DynamicQuery cfpDynamicQuery = DynamicQueryFactoryUtil
                .forClass(CompanyMaster.class);
    ...
    public static List<HelperDTO> getLazyNdc8Results(final int start, final int end, String filterText) throws PortalException, SystemException {
        ...
        LOGGER.debug("return ndc8 size -" + list.size());
        HelperDTO dto;
        if (start == Constants.ZERO) {
            dto = new HelperDTO(ConstantsUtils.SELECT_ONE);
    ...
    public static List<HelperDTO> getLazyNdc9Results(final int start, final int end, String filterText) throws PortalException, SystemException {
        ...
        query.add(RestrictionsFactoryUtil.ilike(ConstantsUtils.NDC9, filterText));
        List<String> list = ItemMasterLocalServiceUtil.dynamicQuery(query);
        LOGGER.debug("return ndc9 size -" + list.size());
        HelperDTO dto;
        if (start == Constants.ZERO) {
            dto = new HelperDTO(ConstantsUtils.SELECT_ONE);
            dto.setDescription(ConstantsUtils.SELECT_ONE);
        ...
        if (list != null) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                if (obj[NumericConstants.SIX] != null) {
                    ...
                    searchCompanyForm.setIdentifierType(new HelperDTO(String.valueOf(obj[NumericConstants.SIX])));
                }
    ...
    private Map<String, Object> getParametersValue(ErrorfulFieldGroup searchItemForm, BeanSearchCriteria criteria) throws PortalException, SystemException {
        ...
        if (StringUtils.isNotBlank(String.valueOf(searchItemForm.getField(ConstantsUtils.TEXT + NumericConstants.TWO).getValue()))) {
            itemId = searchItemForm.getField(ConstantsUtils.TEXT + NumericConstants.TWO).getValue().toString().trim();
            itemId = itemId.replace(CommonUtils.CHAR_ASTERISK, CommonUtils.CHAR_PERCENT);
            parameters.put(ConstantsUtils.ITEM_ID, itemId);
        }
        if (StringUtils.isNotBlank(String.valueOf(searchItemForm.getField(ConstantsUtils.TEXT + NumericConstants.THREE).getValue()))) {
            itemNo = searchItemForm.getField(ConstantsUtils.TEXT + NumericConstants.THREE).getValue().toString().trim();
            itemNo = itemNo.replace(CommonUtils.CHAR_ASTERISK, CommonUtils.CHAR_PERCENT);
            parameters.put(ConstantUtil.ITEM_NO_M, itemNo);
        }
        if (StringUtils.isNotBlank(String.valueOf(searchItemForm.getField(ConstantsUtils.TEXT + NumericConstants.FOUR).getValue()))) {
        ...
        if (criteria != null && criteria.getFilters() != null) {
            ...
            for (Container.Filter filter : criteria.getFilters()) {
                if (filter instanceof SimpleStringFilter) {
                    ...
                    } else if (ConstantsUtils.STRENGTH.equals(stringFilter.getPropertyId())) {
                        parameters.put(ConstantsUtils.STRENGTH + "~", Integer.valueOf(stringFilter.getFilterString()));
                    } else {
    ...
    @Override
    public List<SearchResultsDTO> searchItems(ErrorfulFieldGroup searchItemForm, int start, int end, List<OrderByColumn> orderByColumns, BeanSearchCriteria criteria) throws SystemException, PortalException {
        Map<String, Object> parameters = getParametersValue(searchItemForm, criteria);
    ...
    public List<SearchResultsDTO> getResultsForSearch(ErrorfulFieldGroup searchItemForm, int start, int end, List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet) throws SystemException, PortalException {
        Map<String, Object> parameters = getParametersValueForSearch(searchItemForm, filterSet);
        List<SearchResultsDTO> searchList;
        HelperDTO helperDTO;
        String orderByCol = StringUtils.EMPTY;
            ...
            for (Container.Filter filter : filterSet) {
                if (filter instanceof SimpleStringFilter) {
                    ...
                    if (ConstantUtil.ITEM_STATUS_M.equals(stringFilter.getPropertyId())) {
                        ...
                        if (!stringFilter.getFilterString().equals(ConstantsUtils.SHOW_ALL)) {
...
//                
     ...
     *
     * @param organizationKeyId
     * @return
     */
    public List getOrganizationKey(int organizationKeyId) {

        String query = SQLUtil.getQuery("get-organization-key");
        if (organizationKeyId == 0) {
    ...
    public boolean checkDifferentQualifier(int itemIdentifierId, String itemIdentifier, boolean pricingflag) {
        String query;
        if (pricingflag) {
            query = "SELECT PRICING_QUALIFIER FROM DBO.ITEM_PRICING_QUALIFIER WHERE ITEM_PRICING_QUALIFIER_SID = " + itemIdentifierId;
        } else {
            query = "SELECT ITEM_QUALIFIER_VALUE FROM DBO.ITEM_QUALIFIER WHERE ITEM_QUALIFIER_SID = " + itemIdentifierId;
        }
        List list = HelperTableLocalServiceUtil.executeSelectQuery(query);
