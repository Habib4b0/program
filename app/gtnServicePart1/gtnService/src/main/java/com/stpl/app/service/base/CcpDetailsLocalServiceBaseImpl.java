...
import com.stpl.app.service.CcpDetailsLocalService;
...
/**
 * Provides the base implementation for the ccp details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CcpDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.CcpDetailsLocalServiceImpl
 * @see com.stpl.app.service.CcpDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CcpDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CcpDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CcpDetailsLocalServiceUtil} to access the ccp details local service.
	 */
	...
	@Override
	public CcpDetails addCcpDetails(CcpDetails ccpDetails) {
		ccpDetails.setNew(true);

		return ccpDetailsPersistence.update(ccpDetails);
	}
	 ...
	 */
	@Override
	public CcpDetails createCcpDetails(int ccpDetailsSid) {
		return ccpDetailsPersistence.create(ccpDetailsSid);
	}
	...
	@Override
	public CcpDetails deleteCcpDetails(int ccpDetailsSid)
		throws PortalException {
		return ccpDetailsPersistence.remove(ccpDetailsSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CcpDetails deleteCcpDetails(CcpDetails ccpDetails) {
		return ccpDetailsPersistence.remove(ccpDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CcpDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ccpDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ccpDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ccpDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CcpDetails fetchCcpDetails(int ccpDetailsSid) {
		return ccpDetailsPersistence.fetchByPrimaryKey(ccpDetailsSid);
	}
	 ...
	 */
	@Override
	public CcpDetails getCcpDetails(int ccpDetailsSid)
		throws PortalException {
		return ccpDetailsPersistence.findByPrimaryKey(ccpDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ccpDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CcpDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ccpDetailsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ccpDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CcpDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ccpDetailsLocalService.deleteCcpDetails((CcpDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ccpDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CcpDetails> getCcpDetailses(int start, int end) {
		return ccpDetailsPersistence.findAll(start, end);
	}
	...
	public int getCcpDetailsesCount() {
		return ccpDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CcpDetails updateCcpDetails(CcpDetails ccpDetails) {
		return ccpDetailsPersistence.update(ccpDetails);
	}
	 ...
	 */
	public CcpDetailsLocalService getCcpDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.CcpDetails",
			ccpDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.CcpDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CcpDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ccpDetailsPersistence.getDataSource();
	...
	@BeanReference(type = CcpDetailsLocalService.class)
	protected CcpDetailsLocalService ccpDetailsLocalService;
