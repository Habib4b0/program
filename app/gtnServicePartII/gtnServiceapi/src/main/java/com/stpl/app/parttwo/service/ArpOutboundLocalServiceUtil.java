...
/**
 * Provides the local service utility for ArpOutbound. This utility wraps
 * {@link com.stpl.app.parttwo.service.impl.ArpOutboundLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class ArpOutboundLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.ArpOutboundLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.stpl.app.parttwo.model.ArpOutbound addArpOutbound(
		com.stpl.app.parttwo.model.ArpOutbound arpOutbound) {
		return getService().addArpOutbound(arpOutbound);
	}
	...
	*/
	public static com.stpl.app.parttwo.model.ArpOutbound createArpOutbound(
		com.stpl.app.parttwo.service.persistence.ArpOutboundPK arpOutboundPK) {
		return getService().createArpOutbound(arpOutboundPK);
	}
	...
	*/
	public static com.stpl.app.parttwo.model.ArpOutbound deleteArpOutbound(
		com.stpl.app.parttwo.model.ArpOutbound arpOutbound) {
		return getService().deleteArpOutbound(arpOutbound);
	}
	...
	*/
	public static com.stpl.app.parttwo.model.ArpOutbound deleteArpOutbound(
		...
		return getService().deleteArpOutbound(arpOutboundPK);
	}
	...
	*/
	...
	public static com.stpl.app.parttwo.model.ArpOutbound fetchArpOutbound(
		com.stpl.app.parttwo.service.persistence.ArpOutboundPK arpOutboundPK) {
		return getService().fetchArpOutbound(arpOutboundPK);
	}
	...
	* @throws PortalException if a arp outbound with the primary key could not be found
	*/
	public static com.stpl.app.parttwo.model.ArpOutbound getArpOutbound(
		com.stpl.app.parttwo.service.persistence.ArpOutboundPK arpOutboundPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getArpOutbound(arpOutboundPK);
	}
	...
	*/
	public static java.util.List<com.stpl.app.parttwo.model.ArpOutbound> getArpOutbounds(
		int start, int end) {
		return getService().getArpOutbounds(start, end);
	}
	...
	*/
	public static int getArpOutboundsCount() {
		return getService().getArpOutboundsCount();
	}
	...
	*/
	public static com.stpl.app.parttwo.model.ArpOutbound updateArpOutbound(
		com.stpl.app.parttwo.model.ArpOutbound arpOutbound) {
		return getService().updateArpOutbound(arpOutbound);
	}

	public static ArpOutboundLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<ArpOutboundLocalService, ArpOutboundLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ArpOutboundLocalService.class);
}