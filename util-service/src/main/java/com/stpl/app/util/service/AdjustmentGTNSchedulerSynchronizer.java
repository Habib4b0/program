 ...
 * @author Jayaram
 */
public class AdjustmentGTNSchedulerSynchronizer {

    /**
     * Initializing value
     */
    private static AdjustmentGTNSchedulerSynchronizer process = null;
    /**
     ...
     * @return 
     */
    public static AdjustmentGTNSchedulerSynchronizer getInstance(String className) {
        if (process == null) {
            process = new AdjustmentGTNSchedulerSynchronizer();
        }
        return process;
    }

    private AdjustmentGTNSchedulerSynchronizer() {
    }
