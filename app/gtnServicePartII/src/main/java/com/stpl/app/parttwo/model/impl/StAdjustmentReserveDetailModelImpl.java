 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.stpl.app.parttwo.model.StAdjustmentReserveDetailModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link StAdjustmentReserveDetailImpl}.
 * </p>
 *
 * @author
 * @see StAdjustmentReserveDetailImpl
 * @see com.stpl.app.parttwo.model.StAdjustmentReserveDetail
 * @see com.stpl.app.parttwo.model.StAdjustmentReserveDetailModel
 * @generated
 */
public class StAdjustmentReserveDetailModelImpl extends BaseModelImpl<StAdjustmentReserveDetail>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a st adjustment reserve detail model instance should use the {@link com.stpl.app.parttwo.model.StAdjustmentReserveDetail} interface instead.
     */
    ...
    public static final String TABLE_SQL_CREATE = "create table ST_ADJUSTMENT_RESERVE_DETAIL (ADJUSTMENT_CREATED_DATE DATE null,ETL_CHECK_RECORD BOOLEAN,POSTING_INDICATOR VARCHAR(75) null,MODIFIED_DATE DATE null,ACCOUNT VARCHAR(75) not null IDENTITY,CREDIT VARCHAR(75) null,WORKFLOW_APPROVED_DATE DATE null,SOURCE VARCHAR(75) null,LINE_DESCRIPTION VARCHAR(75) null,LEDGER VARCHAR(75) null,UDC_6 VARCHAR(75) null,UDC_5 VARCHAR(75) null,UDC_4 VARCHAR(75) null,WORKFLOW_CREATED_DATE DATE null,UDC_3 VARCHAR(75) null,UDC_2 VARCHAR(75) null,UDC_1 VARCHAR(75) null,ADJUSTMENT_TYPE VARCHAR(75) not null IDENTITY,MODIFIED_BY VARCHAR(75) null,CHECK_RECORD BOOLEAN,COMPANY VARCHAR(75) not null IDENTITY,DIVISION VARCHAR(75) null,BALANCE_TYPE VARCHAR(75) null,SESSION_ID VARCHAR(75) not null IDENTITY,JOURNAL_NAME VARCHAR(75) null,PROJECT VARCHAR(75) null,DEBIT VARCHAR(75) null,ACCOUNT_TYPE VARCHAR(75) not null IDENTITY,JOURNAL_DESCRIPTION VARCHAR(75) null,CATEGORY VARCHAR(75) null,CREATED_BY VARCHAR(75) null,CREATED_DATE DATE null,BUSINESS_UNIT VARCHAR(75) not null IDENTITY,REVERSAL_PERIOD_DATE DATE null,WORKFLOW_ID VARCHAR(75) not null IDENTITY,CHART_OF_ACCOUNTS VARCHAR(75) null,USER_ID VARCHAR(75) not null IDENTITY,BATCH_NAME VARCHAR(75) null,ARD_DB VARCHAR(75) null,COST_CENTER VARCHAR(75) null,OUTBOUND_STATUS VARCHAR(75) null,DATA_ACCESS_SET VARCHAR(75) null,FUTURE_1 VARCHAR(75) null,FUTURE_2 VARCHAR(75) null,WORKFLOW_NAME VARCHAR(75) null,WORKFLOW_CREATED_BY VARCHAR(75) null,CURRENCY VARCHAR(75) null,BATCH_ID VARCHAR(75) null,ACCOUNT_CATEGORY VARCHAR(75) not null IDENTITY,REVERSE_JOURNAL VARCHAR(75) null,WORKFLOW_APPROVED_BY VARCHAR(75) null,BRAND VARCHAR(75) not null IDENTITY,ACCOUNTING_DATE DATE null,REDEMPTION_PERIOD DATE not null IDENTITY,ORIGINAL_BATCH_ID VARCHAR(75) null,ADJUSTMENT_LEVEL VARCHAR(75) null,primary key (ACCOUNT, ADJUSTMENT_TYPE, COMPANY, SESSION_ID, ACCOUNT_TYPE, BUSINESS_UNIT, WORKFLOW_ID, USER_ID, ACCOUNT_CATEGORY, BRAND, REDEMPTION_PERIOD))";
    public static final String TABLE_SQL_DROP = "drop table ST_ADJUSTMENT_RESERVE_DETAIL";
    public static final String ORDER_BY_JPQL = " ORDER BY stAdjustmentReserveDetail.id.account ASC, stAdjustmentReserveDetail.id.adjustmentType ASC, stAdjustmentReserveDetail.id.glCompanyName ASC, stAdjustmentReserveDetail.id.sessionId ASC, stAdjustmentReserveDetail.id.accountType ASC, stAdjustmentReserveDetail.id.businessUnitId ASC, stAdjustmentReserveDetail.id.workflowId ASC, stAdjustmentReserveDetail.id.userId ASC, stAdjustmentReserveDetail.id.accountCategory ASC, stAdjustmentReserveDetail.id.brand ASC, stAdjustmentReserveDetail.id.redemptionPeriod ASC";
    public static final String ORDER_BY_SQL = " ORDER BY ST_ADJUSTMENT_RESERVE_DETAIL.ACCOUNT ASC, ST_ADJUSTMENT_RESERVE_DETAIL.ADJUSTMENT_TYPE ASC, ST_ADJUSTMENT_RESERVE_DETAIL.COMPANY ASC, ST_ADJUSTMENT_RESERVE_DETAIL.SESSION_ID ASC, ST_ADJUSTMENT_RESERVE_DETAIL.ACCOUNT_TYPE ASC, ST_ADJUSTMENT_RESERVE_DETAIL.BUSINESS_UNIT ASC, ST_ADJUSTMENT_RESERVE_DETAIL.WORKFLOW_ID ASC, ST_ADJUSTMENT_RESERVE_DETAIL.USER_ID ASC, ST_ADJUSTMENT_RESERVE_DETAIL.ACCOUNT_CATEGORY ASC, ST_ADJUSTMENT_RESERVE_DETAIL.BRAND ASC, ST_ADJUSTMENT_RESERVE_DETAIL.REDEMPTION_PERIOD ASC";
    ...
    private static ClassLoader _classLoader = StAdjustmentReserveDetail.class.getClassLoader();
