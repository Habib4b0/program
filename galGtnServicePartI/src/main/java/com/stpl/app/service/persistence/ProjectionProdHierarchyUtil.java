...
/**
 * The persistence utility for the projection prod hierarchy service. This utility wraps {@link ProjectionProdHierarchyPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ProjectionProdHierarchyPersistenceImpl
 * @generated
 */
public class ProjectionProdHierarchyUtil {
    private static ProjectionProdHierarchyPersistence _persistence;
    ...
    */
    public static void cacheResult(
        java.util.List<com.stpl.app.model.ProjectionProdHierarchy> projectionProdHierarchies) {
    ...
    */
    public static com.stpl.app.model.ProjectionProdHierarchy create(
    ...
    */
    public static com.stpl.app.model.ProjectionProdHierarchy remove(
        int projectionProdHierarchySid)
        throws com.stpl.app.NoSuchProjectionProdHierarchyException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().remove(projectionProdHierarchySid);
    }

    public static com.stpl.app.model.ProjectionProdHierarchy updateImpl(
        com.stpl.app.model.ProjectionProdHierarchy projectionProdHierarchy)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.ProjectionProdHierarchy findByPrimaryKey(
        int projectionProdHierarchySid)
        throws com.stpl.app.NoSuchProjectionProdHierarchyException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.ProjectionProdHierarchy fetchByPrimaryKey(
        int projectionProdHierarchySid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.ProjectionProdHierarchy> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static ProjectionProdHierarchyPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (ProjectionProdHierarchyPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    ProjectionProdHierarchyPersistence.class.getName());

            ReferenceRegistry.registerReference(ProjectionProdHierarchyUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(ProjectionProdHierarchyPersistence persistence) {
    }
}
