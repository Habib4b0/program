...
,CPD.BATCH_ID
--,PARENT_DETAILS_INTFID
FROM COMPANY_PARENT_DETAILS CPD
LEFT JOIN COMPANY_MASTER CM ON CPD.COMPANY_MASTER_SID=CM.COMPANY_MASTER_SID AND CM.INBOUND_STATUS<>'D'
LEFT JOIN COMPANY_MASTER PCM ON CPD.PARENT_COMPANY_MASTER_SID=PCM.COMPANY_MASTER_SID AND PCM.INBOUND_STATUS<>'D'
LEFT JOIN COMPANY_MASTER PPCM ON CPD.PRIOR_PARENT_CMPY_MASTER_SID=PPCM.COMPANY_MASTER_SID AND PPCM.INBOUND_STATUS<>'D'
