...
public class IvldFormulaDetailsCacheModel implements CacheModel<IvldFormulaDetails>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldFormulaDetailsCacheModel)) {
			return false;
		}

		IvldFormulaDetailsCacheModel ivldFormulaDetailsCacheModel = (IvldFormulaDetailsCacheModel)obj;

		if (ivldFormulaDetailsSid == ivldFormulaDetailsCacheModel.ivldFormulaDetailsSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldFormulaDetailsSid);
	}
	...
	public IvldFormulaDetails toEntityModel() {
		...
		if (companyStringId == null) {
			ivldFormulaDetailsImpl.setCompanyStringId(StringPool.BLANK);
		}
		else {
			ivldFormulaDetailsImpl.setCompanyStringId(companyStringId);
		}
