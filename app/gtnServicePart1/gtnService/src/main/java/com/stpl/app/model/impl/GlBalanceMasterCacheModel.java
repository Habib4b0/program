...
public class GlBalanceMasterCacheModel implements CacheModel<GlBalanceMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GlBalanceMasterCacheModel)) {
			return false;
		}

		GlBalanceMasterCacheModel glBalanceMasterCacheModel = (GlBalanceMasterCacheModel)obj;

		if (glBalanceMasterSid == glBalanceMasterCacheModel.glBalanceMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, glBalanceMasterSid);
	}
