...
public class MSupplementalDiscProjLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<MSupplementalDiscProjLocalService, MSupplementalDiscProjLocalService> _serviceTracker =
		ServiceTrackerFactory.open(MSupplementalDiscProjLocalService.class);
}