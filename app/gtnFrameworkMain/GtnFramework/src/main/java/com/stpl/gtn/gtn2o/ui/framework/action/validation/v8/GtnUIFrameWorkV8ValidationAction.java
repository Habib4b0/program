...
import com.stpl.gtn.gtn2o.ui.framework.type.GtnUIFrameworkV8SupportedValidationType;
import com.stpl.gtn.gtn2o.ui.framework.type.GtnUIFrameworkValidationType;
import com.stpl.gtn.gtn2o.ws.exception.GtnFrameworkGeneralException;

public class GtnUIFrameWorkV8ValidationAction implements GtnUIFrameWorkAction {
	...
	public void doAction(final String componentId, GtnUIFrameWorkActionConfig gtnUIFrameWorkActionConfig)
		...
		for (int i = 0; i < vaadinVieldValueList.size(); i++) {
			...
			try {
				...
				for (GtnUIFrameworkV8SupportedValidationType currentvalidationType : supportedValidationList) {
	...
	public GtnUIFrameWorkAction createInstance() {
		return GtnUIFrameworkActionType.V8_VALIDATION_ACTION.getSingletonAction();
	}
