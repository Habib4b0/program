...
public class NaProjectionSelectionUtil {
    private static NaProjectionSelectionPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.NaProjectionSelection create(
    ...
    */
    public static com.stpl.app.model.NaProjectionSelection remove(
        int naProjectionSelectionSid)
    ...
    public static com.stpl.app.model.NaProjectionSelection updateImpl(
        com.stpl.app.model.NaProjectionSelection naProjectionSelection)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.NaProjectionSelection findByPrimaryKey(
        int naProjectionSelectionSid)
        throws com.stpl.app.NoSuchNaProjectionSelectionException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.NaProjectionSelection fetchByPrimaryKey(
        int naProjectionSelectionSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.NaProjectionSelection> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static NaProjectionSelectionPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (NaProjectionSelectionPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    NaProjectionSelectionPersistence.class.getName());

            ReferenceRegistry.registerReference(NaProjectionSelectionUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(NaProjectionSelectionPersistence persistence) {
    }
}
