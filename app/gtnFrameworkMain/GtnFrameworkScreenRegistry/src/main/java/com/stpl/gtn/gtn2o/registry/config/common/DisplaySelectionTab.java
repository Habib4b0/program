...
public class DisplaySelectionTab {
	...
	public void addDisplaySelectionTabLayout(List<GtnUIFrameworkComponentConfig> componentList, String nameSpace) {
		GtnUIFrameworkComponentConfig displaySelectionPanel = configProvider.getPanelConfig(nameSpace+"_" +"displaySelectionPanel", false, null);
	...
	public void addFrequencyHistory(List<GtnUIFrameworkComponentConfig> componentList, String nameSpace) {
		GtnUIFrameworkComponentConfig frequencyHistoryLayout = configProvider
				.getVerticalLayoutConfig(nameSpace + "_" + "frequencyHistoryLayout", true, nameSpace + GtnFrameworkScreenRegisteryConstants.DISPLAY_SELECTION_TAB_LAYOUT_PARENT_ID);
	...
	public void addActualsProjDiscountVariables(List<GtnUIFrameworkComponentConfig> componentList, String nameSpace) {
		GtnUIFrameworkComponentConfig actualsProjVariablesLayout = configProvider
				.getVerticalLayoutConfig(nameSpace + "_" + "actualsProjDiscountVariablesLayout", true, nameSpace + GtnFrameworkScreenRegisteryConstants.DISPLAY_SELECTION_TAB_LAYOUT_PARENT_ID);
	...
	public void addActualsProjSalesVariables(List<GtnUIFrameworkComponentConfig> componentList, String nameSpace) {
		GtnUIFrameworkComponentConfig actualsProjVariablesLayout = configProvider
				.getVerticalLayoutConfig(nameSpace + "_" + "actualsProjSalesVariablesLayout", true, nameSpace + GtnFrameworkScreenRegisteryConstants.DISPLAY_SELECTION_TAB_LAYOUT_PARENT_ID);
		actualsProjVariablesLayout.addComponentStyle(GtnFrameworkCssConstants.INLINE_CAPTION_100);
		actualsProjVariablesLayout.setSpacing(true);
		componentList.add(actualsProjVariablesLayout);
	...
	public void addProjPeriodOrderUnitOfmeasure(List<GtnUIFrameworkComponentConfig> componentList, String nameSpace) {
		GtnUIFrameworkComponentConfig projPeriodOrderUnitOfmeasureLayout = configProvider
				.getVerticalLayoutConfig(nameSpace + "_" + "projPeriodOrderUnitOfmeasureLayout", true, nameSpace + GtnFrameworkScreenRegisteryConstants.DISPLAY_SELECTION_TAB_LAYOUT_PARENT_ID);
	...
	public void addDisplayCurrencyFormat(List<GtnUIFrameworkComponentConfig> componentList, String nameSpace) {
		GtnUIFrameworkComponentConfig displayCurrencyFormatLayout = configProvider
				.getVerticalLayoutConfig(nameSpace + "_" + "displayCurrencyFormatLayout", true, nameSpace + GtnFrameworkScreenRegisteryConstants.DISPLAY_SELECTION_TAB_LAYOUT_PARENT_ID);
	...
	public void addHistory(List<GtnUIFrameworkComponentConfig> componentList,String parentComponentId,
		...
		GtnUIFrameworkComponentConfig history = configProvider.getUIFrameworkComponentConfig(
				nameSpace + "_" + "history", true, historyLayout.getComponentId(), GtnUIFrameworkComponentType.COMBOBOX_VAADIN8);
	...
	public void addActualsProjection(List<GtnUIFrameworkComponentConfig> componentList, String parentComponentId,
		...
		actualsProjectionOptionGroupConfig
				.setItemValues(Arrays.asList( "Actuals", "Projection", "Both" ));
		actualsProjectionOptionGroupConfig.setValuesFromService(Boolean.FALSE);
		actualsProjectionOptionGroupConfig.setEnable(Boolean.TRUE);
	...
	public void addSalesProjectionVariables(List<GtnUIFrameworkComponentConfig> componentList, String parentComponentId,
		...
		salesProjectionVariablesOptionGroup.setAddToParent(Boolean.TRUE);
		...
		salesProjectionVariablesOptionGroupConfig.setItemValues(
				Arrays.asList( "Sales", "Units", "Product Growth", "Account Growth" ));
		salesProjectionVariablesOptionGroupConfig.setValuesFromService(Boolean.FALSE);
		salesProjectionVariablesOptionGroupConfig.setEnable(Boolean.TRUE);
		salesProjectionVariablesOptionGroupConfig.setIsMultiSelect(true);
		salesProjectionVariablesOptionGroup
				.setComponentStyle(Arrays.asList(GtnFrameworkCssConstants.HORIZONTAL_LOWER_CASE ));
		salesProjectionVariablesOptionGroup.setGtnUIFrameworkOptionGroupConfig(salesProjectionVariablesOptionGroupConfig);
	...
	public void addDiscountProjectionVariables(List<GtnUIFrameworkComponentConfig> componentList, String parentComponentId,
		...
		discountProjectionVariablesOptionGroup.setAddToParent(Boolean.TRUE);
		discountProjectionVariablesOptionGroup.setParentComponentId(discountProjectionVariablesLayoutConfig.getComponentId());

		GtnUIFrameworkOptionGroupConfig discountProjectionVariablesOptionGroupConfig = new GtnUIFrameworkOptionGroupConfig();
		discountProjectionVariablesOptionGroupConfig.setItemValues(
				Arrays.asList( "Discount Rate", "Rebate Per Unit", "Discount Amount", "Growth" ));
		discountProjectionVariablesOptionGroupConfig.setValuesFromService(Boolean.FALSE);
		discountProjectionVariablesOptionGroupConfig.setEnable(Boolean.TRUE);
		discountProjectionVariablesOptionGroupConfig.setIsMultiSelect(true);
		discountProjectionVariablesOptionGroup
				.setComponentStyle(Arrays.asList( GtnFrameworkCssConstants.HORIZONTAL_LOWER_CASE ));
		discountProjectionVariablesOptionGroup.setGtnUIFrameworkOptionGroupConfig(discountProjectionVariablesOptionGroupConfig);
	...
	public void addProjectionPeriodOrder(List<GtnUIFrameworkComponentConfig> componentList,String parentComponentId, 
		...
		projectionPeriodRadioGroupConfig.setValuesFromService(Boolean.FALSE);
		projectionPeriodRadioGroupConfig.setEnable(Boolean.TRUE);
		projectionPeriodRadioGroup
				.setComponentStyle(Arrays.asList( GtnFrameworkCssConstants.HORIZONTAL_LOWER_CASE ));
