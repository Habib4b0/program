...
public abstract class VwAdjustDemandForecastActLocalServiceBaseImpl
    ...
    implements VwAdjustDemandForecastActLocalService, IdentifiableBean {
    ...
    private VwAdjustDemandForecastActLocalServiceClpInvoker _clpInvoker = new VwAdjustDemandForecastActLocalServiceClpInvoker();
    ...
    public VwAdjustDemandForecastAct deleteVwAdjustDemandForecastAct(
        int adjustedDemandForecastId) throws PortalException, SystemException {
     ...
     */
    @Override
    public int getVwAdjustDemandForecastActsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.VwAdjustDemandForecastAct",
