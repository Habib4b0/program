...
/**
 * Provides the local service interface for IvldDemandForecast. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldDemandForecastLocalServiceUtil
...
public interface IvldDemandForecastLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IvldDemandForecastLocalServiceUtil} to access the ivld demand forecast local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldDemandForecastLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
