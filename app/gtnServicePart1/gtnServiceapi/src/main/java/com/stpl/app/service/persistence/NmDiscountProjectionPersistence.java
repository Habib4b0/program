...
public interface NmDiscountProjectionPersistence extends BasePersistence<NmDiscountProjection> {
	...
	*/
	public void cacheResult(
		java.util.List<NmDiscountProjection> nmDiscountProjections);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, NmDiscountProjection> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<NmDiscountProjection> findAll();
	...
	*/
	public java.util.List<NmDiscountProjection> findAll(int start, int end);
	...
	*/
	public java.util.List<NmDiscountProjection> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<NmDiscountProjection> orderByComparator);
