...
import com.stpl.app.service.ItemGroupDetailsLocalService;
...
/**
 * Provides the base implementation for the item group details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ItemGroupDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class ItemGroupDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ItemGroupDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ItemGroupDetailsLocalServiceUtil} to access the item group details local service.
	 */
	...
	@Override
	public ItemGroupDetails addItemGroupDetails(
		ItemGroupDetails itemGroupDetails) {
		itemGroupDetails.setNew(true);

		return itemGroupDetailsPersistence.update(itemGroupDetails);
	}
	 ...
	 */
	@Override
	public ItemGroupDetails createItemGroupDetails(int itemGroupDetailsSid) {
		return itemGroupDetailsPersistence.create(itemGroupDetailsSid);
	}
	...
	@Override
	public ItemGroupDetails deleteItemGroupDetails(int itemGroupDetailsSid)
		throws PortalException {
		return itemGroupDetailsPersistence.remove(itemGroupDetailsSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ItemGroupDetails deleteItemGroupDetails(
		ItemGroupDetails itemGroupDetails) {
		return itemGroupDetailsPersistence.remove(itemGroupDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ItemGroupDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return itemGroupDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return itemGroupDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ItemGroupDetails fetchItemGroupDetails(int itemGroupDetailsSid) {
		return itemGroupDetailsPersistence.fetchByPrimaryKey(itemGroupDetailsSid);
	}
	 ...
	 */
	@Override
	public ItemGroupDetails getItemGroupDetails(int itemGroupDetailsSid)
		throws PortalException {
		return itemGroupDetailsPersistence.findByPrimaryKey(itemGroupDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(itemGroupDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ItemGroupDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("itemGroupDetailsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(itemGroupDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ItemGroupDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return itemGroupDetailsLocalService.deleteItemGroupDetails((ItemGroupDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return itemGroupDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ItemGroupDetails> getItemGroupDetailses(int start, int end) {
		return itemGroupDetailsPersistence.findAll(start, end);
	}
	...
	public int getItemGroupDetailsesCount() {
		return itemGroupDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ItemGroupDetails updateItemGroupDetails(
		ItemGroupDetails itemGroupDetails) {
		return itemGroupDetailsPersistence.update(itemGroupDetails);
	}
	 ...
	 */
	public ItemGroupDetailsLocalService getItemGroupDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ItemGroupDetails",
			itemGroupDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ItemGroupDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = itemGroupDetailsPersistence.getDataSource();
	...
	@BeanReference(type = ItemGroupDetailsLocalService.class)
	protected ItemGroupDetailsLocalService itemGroupDetailsLocalService;
