...
public final class RebatePlanForm extends StplCustomComponent implements AddBaseForm{
     ...
     */
    public RebatePlanForm(final RebatePlanMasterDTO rebatePlanMasterDTO, final ErrorfulFieldGroup binder,final BeanItemContainer<RebatePlanTierResults> rebatePlanTierResults
        ,final SessionDTO sessionDTO) throws SystemException, PortalException, Exception {
        super();
	 ...
	 * Back button.
	 */
	private void configureBackButton() throws Exception {
		...
		backButton.addClickListener(new ClickListener() {
			 ...
			 */
                    ...
                    LOGGER.info("Entering RebatePlan back button operation from Add");
                    if (mode.equals(ConstantsUtils.VIEW)) {
                            ...
                            MessageBox.showPlain(Icon.QUESTION, "Confirmation", commonMsg.getBackMessage(), new MessageBoxListener() {
                                ...
                                public void buttonClicked(final ButtonId buttonId) {
                                    if (buttonId.name().equals(ConstantsUtils.YES)) {
                                        LOGGER.info("NavigateTo RebatePlanSearchView page");
                                         AbstractSearchView.flag=false;
                                        getUI().getNavigator().navigateTo(AbstractSearchView.NAME);
                                    }
                                }
                        ...
                        LOGGER.info("Ending RebatePlan back button operation from Add");
                    }
                }
            });
            ...
            public void buttonClick(final ClickEvent event) {
                try {
                    if ("Add".equals(mode)||"Copy".equals(mode)) {
                        LOGGER.info("Entering RebatePlan Save operation from Add");
                        ...
                        LOGGER.info("Save Method to save Rebate plan by passing beanItem =" + searchResultbeans + " ," + "binder =" + binder);
                        /**
                         * After clicking delete button, function will be
                         * executed.
                         */
     
                        MessageBox.showPlain(Icon.QUESTION, "Confirmation", commonMsg.getSaveMessage( binder.getField(ConstantsUtils.REBATE_PLAN_NAME).getValue().toString()), new MessageBoxListener() {
                            /**
                             * Called when a Button has been clicked .
                             *
                             */
                            public void buttonClicked(final ButtonId buttonId) {
                                if (buttonId.name().equals(ConstantsUtils.YES)) {
                                    try {
                                        ...
                                        LOGGER.info("After Saving rebate plans ,Return message = " + msg);
                        ...
                        LOGGER.info("Ending RebatePlan Save operation from Add");
                    } else if ("Edit".equals(mode)) {
                        LOGGER.info("Entering Rebate Plan Update opertion from Edit");
                        ...
                        String value = binder.getField(FieldNameUtils.REBATE_PLAN_NAME).getValue().toString().trim();
                        /**
                         * After clicking delete button, function will be
                         * executed.
                         */
                            ...
                            public void buttonClicked(final ButtonId buttonId) {
                                if (buttonId.name().equals(ConstantsUtils.YES)) {
                                    try {
                                        ...
                                        LOGGER.info("Ending Rebate Plan Update opertion from Edit");
                                    } catch (Exception exception) {
     ...
     * reset button.
     */
    private void configureResetButton() throws Exception {
                             ...
                             try {
                                 ...
                                 if (TabNameUtil.RP_CALCULATION.equals(tabsheet.getSelectedTab().getCaption())) {
                                     ...
                                     if (toToValue != null && !toToValue.equals(BigDecimal.ZERO)) {
                                         ...
                                         from.setValue(toToValue.setScale(2, RoundingMode.HALF_UP).toPlainString());
...
private void configureDeleteButton() throws Exception {
        ...
        deleteButton.addClickListener(new ClickListener() {
             ...
             */
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("Entering Rebate Plan Delete opertion from Edit");
                binder.getFields();

                final String value = String.valueOf(binder.getField("rebatePlanId").getValue()).replace(ConstantsUtils.COMMA, StringUtils.EMPTY);

                MessageBox.showPlain(Icon.QUESTION, "Confirmation", commonMsg.getDeleteMessage(binder.getField(ConstantsUtils.REBATE_PLAN_NAME).getValue().toString()), new MessageBoxListener() {
                    /**
                     * Adds the button click listener.
                     */
                    @SuppressWarnings("PMD")
                    public void buttonClicked(final ButtonId buttonId) {
                        try {
                            if (buttonId.name().equals(ConstantsUtils.YES)) {
                                ...
                                LOGGER.info("Entering deleteRebatePlanById P1:" + idValue);
                                ...
                                notif.setStyleName(ConstantsUtils.MY_STYLE);
                                notif.show(Page.getCurrent());
                                LOGGER.info("After deleting  navigateTo AbstractSearchView");
                ...
                LOGGER.info("Ending Rebate Plan Delete opertion from Edit");
            }
        });
    }
    ...
    public void configureOnMode() throws Exception {
        if (mode.equals(ConstantsUtils.VIEW)) {
