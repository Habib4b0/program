...
/**
 * Provides the local service interface for RebatePlanMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see RebatePlanMasterLocalServiceUtil
...
public interface RebatePlanMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RebatePlanMasterLocalServiceUtil} to access the rebate plan master local service. Add custom service methods to {@link com.stpl.app.service.impl.RebatePlanMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
