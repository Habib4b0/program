...
/**
 * Provides the local service interface for CustomerGtsForecast. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CustomerGtsForecastLocalServiceUtil
 * @see com.stpl.app.parttwo.service.base.CustomerGtsForecastLocalServiceBaseImpl
...
public interface CustomerGtsForecastLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CustomerGtsForecastLocalServiceUtil} to access the customer gts forecast local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.CustomerGtsForecastLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
