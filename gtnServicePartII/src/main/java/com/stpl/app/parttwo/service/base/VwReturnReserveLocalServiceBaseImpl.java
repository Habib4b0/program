...
import com.stpl.app.parttwo.service.VwReturnReserveLocalService;
...
/**
 * Provides the base implementation for the vw return reserve local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwReturnReserveLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwReturnReserveLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwReturnReserveLocalServiceUtil
 * @generated
 */
public abstract class VwReturnReserveLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements VwReturnReserveLocalService,
        IdentifiableBean {
    ...
    private VwReturnReserveLocalServiceClpInvoker _clpInvoker = new VwReturnReserveLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwReturnReserveLocalServiceUtil} to access the vw return reserve local service.
     */
    ...
    @Override
    public VwReturnReserve addVwReturnReserve(VwReturnReserve vwReturnReserve)
        throws SystemException {
        vwReturnReserve.setNew(true);

        return vwReturnReservePersistence.update(vwReturnReserve);
    }
     ...
     */
    @Override
    public VwReturnReserve createVwReturnReserve(int returnReserveSid) {
        return vwReturnReservePersistence.create(returnReserveSid);
    }
    ...
    @Override
    public VwReturnReserve deleteVwReturnReserve(int returnReserveSid)
        throws PortalException, SystemException {
        return vwReturnReservePersistence.remove(returnReserveSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public VwReturnReserve deleteVwReturnReserve(
        VwReturnReserve vwReturnReserve) throws SystemException {
        return vwReturnReservePersistence.remove(vwReturnReserve);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(VwReturnReserve.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwReturnReservePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwReturnReservePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public VwReturnReserve fetchVwReturnReserve(int returnReserveSid)
        throws SystemException {
        return vwReturnReservePersistence.fetchByPrimaryKey(returnReserveSid);
    }
     ...
     */
    @Override
    public VwReturnReserve getVwReturnReserve(int returnReserveSid)
        throws PortalException, SystemException {
        return vwReturnReservePersistence.findByPrimaryKey(returnReserveSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return vwReturnReservePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<VwReturnReserve> getVwReturnReserves(int start, int end)
        throws SystemException {
        return vwReturnReservePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getVwReturnReservesCount() throws SystemException {
        return vwReturnReservePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public VwReturnReserve updateVwReturnReserve(
        VwReturnReserve vwReturnReserve) throws SystemException {
        return vwReturnReservePersistence.update(vwReturnReserve);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.VwReturnReserve",
            vwReturnReserveLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.VwReturnReserve");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = vwReturnReservePersistence.getDataSource();
