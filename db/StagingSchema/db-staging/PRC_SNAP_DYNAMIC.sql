...
BEGIN
  ...
  END
   ...
   ELSE IF (@TABLE = 'SNAP_ACCRUAL_INBOUND')
  BEGIN
    SET @VALUES = (SELECT
      STUFF((SELECT
        ', ' + COLUMN_NAME
    ...
    SET @VALUES1 = (SELECT
      ...
      FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = @INTERFACE_TABLE_NAME
	  AND COLUMN_NAME NOT IN ('ADD_CHG_DEL_INDICATOR', 'CONTRACT_NAME', 'CONTRACT_NO', 'CREATED_BY', 'CREATED_DATE','MODIFIED_BY', 'MODIFIED_DATE')
      ORDER BY column_name
      FOR xml PATH (''))
      , 1, 2, ''))
  END
  ...
  END
	ELSE IF (@TABLE = 'SNAP_ITEM_UOM')
  BEGIN 
  SET @VALUES = 'ADD_CHG_DEL_INDICATOR,  BATCH_ID, CREATED_BY, CREATED_DATE, ITEM_ID, ITEM_NAME, ITEM_NO, ITEM_UOM_CONVERSION_ID, MODIFIED_BY, MODIFIED_DATE, PRIMARY_UOM_BASELINE_FACTOR, PRIMARY_UOM_CODE, PRIMARY_UOM_NAME, SECONDARY_UOM_CODE, SECONDARY_UOM_CONVERSION_FACTOR,SECONDARY_UOM_NAME, SOURCE,STATUS, UPLOAD_DATE'
  SET @VALUES1 = 'ADD_CHG_DEL_INDICATOR,  BATCH_ID, CREATED_BY, CREATED_DATE, ITEM_ID, ITEM_NAME, ITEM_NO, ITEM_UOM_CONVERSION_ID, MODIFIED_BY, MODIFIED_DATE, PRIMARY_UOM_BASELINE_FACTOR, PRIMARY_UOM_CODE, PRIMARY_UOM_NAME, SECONDARY_UOM_CODE, SECONDARY_UOM_CONVERSION_FACTOR,SECONDARY_UOM_NAME, SOURCE,STATUS, UPLOAD_DATE'
  END
