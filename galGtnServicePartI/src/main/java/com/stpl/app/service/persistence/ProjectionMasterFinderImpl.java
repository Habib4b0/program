...
public class ProjectionMasterFinderImpl extends BasePersistenceImpl<ProjectionMaster> implements ProjectionMasterFinder {
    ...
    public List getRelationshipHierarchy(final Map<String, Object> parameters) {
        ...
        try {
            LOGGER.info("Entering getRelationshipHierarchy method");
            session = openSession();
...
//            LOGGER.info("\n\n getRelationshipHierarchy query is -----> " + customSql.toString() + "\n\n");
            LOGGER.info("End of getRelationshipHierarchy method");
    ...
    public List getCcpDetails(final Map<String, Object> parameters) {
        Session session = null;
        try {
            LOGGER.info("Entering getCcpDetails method");
            session = openSession();
//            LOGGER.info("QUERY: " + String.valueOf(parameters.get("ccpQuery")));
...
//            LOGGER.info("Customer/Product group query: \n" + queryString.toString() + "\n");
...
//        String and = StringUtils.EMPTY;
        StringBuilder queryString = new StringBuilder(StringUtils.EMPTY);
        try {
            LOGGER.info("Entering searchDsProjection method");
            session = openSession();
...
//                    LOGGER.info("String.valueOf(parameters.get(\"selectValue\"))================================>"+String.valueOf(parameters.get("selectValue")));
//                    LOGGER.info("String.valueOf(parameters.get(\"leftJoinValue\"))===================================================>"+String.valueOf(parameters.get("leftJoinValue")));
...
//            LOGGER.info("Final Search Query: " + queryString.toString());
    ...
    public List getProjection(final int projectionId) {
        ...
        StringBuilder queryString = new StringBuilder(StringUtils.EMPTY);
        try {
            LOGGER.info("Entering getProjection method");
            session = openSession();
...
//            LOGGER.info("getRelationShipValues Final Query: " + queryString.toString());
            Query query = session.createSQLQuery(queryString.toString());
            return query.list();
        } catch (Exception e) {
...
//            LOGGER.info("\n\nParent level query: " + queryBuilder.toString()+"\n\n");
    ...
    public List executeQuery(final Map<String, Object> parameters) {
        LOGGER.info("----inside executeQuery in finder Impl-----------");
        Session session = null;
        StringBuilder queryString = new StringBuilder(StringUtils.EMPTY);
        if (parameters.get("indicator") != null && "hasTradingPartner".equalsIgnoreCase(String.valueOf(parameters.get("indicator")))) {
            ...
            LOGGER.info("--inside getChildLevelRLSid---------------------------->>>>>>>>");
...
//            LOGGER.info("executeQuery queryString for getChildLevelRLSid " + queryString.toString());
...
//            LOGGER.info("executeQuery queryString for getChildLevelRL " + queryString.toString());
            ...
            queryString.replace(queryString.indexOf("?"), queryString.indexOf("?") + 1, String.valueOf(parameters.get("removeLevels")));
//            LOGGER.info("getRemovableChildren queryString " + queryString.toString());
...
//            LOGGER.info("deleteTempOnUpdate queryString " + queryString.toString());
...
//            LOGGER.info("executeQuery " + queryString.toString());
        }
//        LOGGER.info("--query before try------------->>>>>>"+queryString);
        try {
            session = openSession();
            Query query;
...
//                LOGGER.info("-----insaide if loop query------------------>>>>>"+queryString.toString());
                query = session.createSQLQuery(queryString.toString());
            } else {
//                LOGGER.info("--inside else query---------------------->>>>>"+queryString.toString());
...
//            LOGGER.info("executeQuery queryString " + queryString.toString());
...
//            LOGGER.info("getItemsFromBrand: " + queryBuilder.toString());
            Query query = session.createQuery(queryBuilder.toString());
            return query.list();
        } catch (Exception ex) {
    ...
    public List getInnerLevel(Map<String, Object> parameters) {
        ...
        try {
            if (Constants.BUSINESS_PROCESS_TYPE_CHENNALS.equals(parameters.get("screenName"))) {
                if (parameters.get("isNdc") != null && "true".equals(String.valueOf(parameters.get("isNdc")))) {
                    ...
                    queryBuilder.append(" AND RLD.LEVEL_NAME='NDC 11' ");
                    ...
                    queryBuilderNot = getRelationLevelList(queryBuilderNot, parameters);
//                    LOGGER.info("queryBuilderNot  ="+queryBuilderNot.toString());
                    queryBuilder.append(CustomSQLUtil.get("getInnerLevelChannel"));
...
//            queryBuilder = getRelationLevelList(queryBuilder, parameters);
            if ("AccrualRateProjection".equalsIgnoreCase(String.valueOf(parameters.get("screenName"))) && (!"Segment Group".equalsIgnoreCase(String.valueOf(parameters.get("levelName")))&&!"Segment".equalsIgnoreCase(String.valueOf(parameters.get("levelName"))))&&!"Company".equalsIgnoreCase(String.valueOf(parameters.get("levelName")))) {
...
//            LOGGER.info("queryBuilder.toString()======================================>"+queryBuilder.toString());
            session = openSession();
...
//        }
        ...
        try {
            LOGGER.info("Entering saveCcp method ");
...
//                LOGGER.info("\n\n saveCcp query is -----> " + customSql.toString() + "\n\n");
                LOGGER.info("End of saveCcp method");
//            return sqlQuery.list();
            } else {
                List list = null;
                try {
...
//            LOGGER.info("\n\n getCcpMap query is -----> " + customSql.toString() + "\n\n");
    ...
    public List getLevelCcp(final Map<String, Object> parameters) {
        ...
        StringBuilder customSql = new StringBuilder(StringUtils.EMPTY);
        try {
            LOGGER.info("Entering getLevelCcp method ");
...
//            LOGGER.info("\n\n getLevelCcp query is -----> " + customSql.toString() + "\n\n");
            LOGGER.info("End of getLevelCcp method");
            return sqlQuery.list();
        } catch (Exception e) {
...
//                    LOGGER.info("getHierarchyTableDetails: "+customSql);
                }
...
//                    LOGGER.info("getRelationshipLevelValues : " + customSql);
...
//            LOGGER.info("getChildLevels: "+queryBuilder.toString());
//            LOGGER.info("getChildLevels: "+queryBuilder.toString());
            Query query = session.createSQLQuery(queryBuilder.toString());
            return query.list();
        } catch (Exception ex) {
...
//                                            delete = false;
//                                        }
//                                LOGGER.info("****************ccpQueryList.toString********************" + ccpQueryList.toString());
                                Query insertQuery = session.createSQLQuery(ccpQueryList.toString());
                                insertQuery.executeUpdate();
                                ccpQueryList = new StringBuilder();
                                count = 0;
                            ...
                            ccpQuery = new StringBuilder("MERGE CCP_MAP AS TARGET USING ( "
                                    + "SELECT distinct ? RELATIONSHIP_LEVEL_SID ,CCP.CCP_DETAILS_SID FROM CCP_DETAILS CCP ");
//                            LOGGER.info("*************************ccpQuery************************"+ccpQuery.toString());
                        }
...
//            LOGGER.info("Final Search Query: " + queryString);
            Query query = session.createSQLQuery(queryString.toString());
            resultList = query.list();
            return resultList;
        } catch (Exception e) {
...
//			?HIERARCHY_NAME_CONDITION?
        ...
        try {
            ...
            if (parameters.get("indicator") != null
                    ...
                    || ("companyFilter".equalsIgnoreCase(String.valueOf(parameters.get("indicator")))))) {
//                LOGGER.info("..................qury"+queryString.toString());
                query = session.createSQLQuery(queryString.toString());
            } else {
//                 LOGGER.info("..................qury"+queryString.toString());
                query = session.createQuery(queryString.toString());
...
//                queryBuilder.append(")) ");
//            }
//            LOGGER.info("getInnerLevel: " + queryBuilder.toString());
            Query query = session.createSQLQuery(queryBuilder.toString());
            return query.list();
        } catch (Exception ex) {
            LOGGER.error(ex.getMessage() + " in getInnerLevel()");
...
//            LOGGER.info("Parent level query: " + queryBuilder.toString());
            Query query = session.createQuery(queryBuilder.toString());
            return query.list();
        } catch (Exception ex) {
            LOGGER.error(ex.getMessage());
    ...
    public List getChildLevelsforchannel(final Map<String, Object> parameters) {
        ...
        try {
            ...
            queryBuilder.replace(queryBuilder.indexOf("?"), queryBuilder.indexOf("?") + 1, String.valueOf(parameters.get("hierarchyNo")));
            queryBuilder.replace(queryBuilder.indexOf("?"), queryBuilder.indexOf("?") + 1, String.valueOf(parameters.get("lowestLevelNo")));
//            LOGGER.info("Child level query: " + queryBuilder.toString());
            Query query = session.createSQLQuery(queryBuilder.toString());
            return query.list();
        } catch (Exception ex) {
            LOGGER.error(ex.getMessage());
    ...
    public List getProjectionforchannel(final int projectionId) {
        ...
        try {
            ...
            queryString.append(" where PM.projection_Master_Sid = ");
            queryString.append(projectionId);
//            LOGGER.info("Final Query: " + queryString.toString());
            Query query = session.createSQLQuery(queryString.toString());
            return query.list();
        } catch (Exception e) {
            LOGGER.error(e.getMessage());
...
//            LOGGER.info("Delete query: " + sql);
    ...
    private String prepareSearchGroupQuery(final Map<String, Object> parameters) {
        LOGGER.info("Entering prepareSearchGroupQuery method");
