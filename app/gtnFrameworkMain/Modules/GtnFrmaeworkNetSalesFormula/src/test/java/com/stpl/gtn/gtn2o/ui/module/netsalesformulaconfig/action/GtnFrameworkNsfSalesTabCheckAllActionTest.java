...
public class GtnFrameworkNsfSalesTabCheckAllActionTest {
	/**
	 * Run the GtnFrameworkNsfSalesTabCheckAllAction() constructor test.
	 *
	
	 */
	@Test
	public void testGtnFrameworkNsfSalesTabCheckAllAction_1() throws Exception {
		GtnFrameworkNsfSalesTabCheckAllAction result = new GtnFrameworkNsfSalesTabCheckAllAction();
	...
	public void testConfigureParams() throws Exception {
		...
		GtnFrameworkNsfSalesTabCheckAllAction fixture = new GtnFrameworkNsfSalesTabCheckAllAction();
	 ...
	 */
	@Test
	public void testGtnFrameworkNsfSalesTabCheckAll_doAction() throws Exception {
