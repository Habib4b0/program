...
/**
 * The persistence utility for the company parent details service. This utility wraps {@link CompanyParentDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see CompanyParentDetailsPersistenceImpl
 * @generated
 */
public class CompanyParentDetailsUtil {
    private static CompanyParentDetailsPersistence _persistence;
    ...
    */
    public static void cacheResult(
        java.util.List<com.stpl.app.model.CompanyParentDetails> companyParentDetailses) {
    ...
    */
    public static com.stpl.app.model.CompanyParentDetails create(
    ...
    */
    public static com.stpl.app.model.CompanyParentDetails remove(
        int companyParentDetailsSid)
        throws com.stpl.app.NoSuchCompanyParentDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().remove(companyParentDetailsSid);
    }

    public static com.stpl.app.model.CompanyParentDetails updateImpl(
        com.stpl.app.model.CompanyParentDetails companyParentDetails)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.CompanyParentDetails findByPrimaryKey(
        int companyParentDetailsSid)
        throws com.stpl.app.NoSuchCompanyParentDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.CompanyParentDetails fetchByPrimaryKey(
        int companyParentDetailsSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.CompanyParentDetails> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static CompanyParentDetailsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (CompanyParentDetailsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    CompanyParentDetailsPersistence.class.getName());

            ReferenceRegistry.registerReference(CompanyParentDetailsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(CompanyParentDetailsPersistence persistence) {
    }
}
