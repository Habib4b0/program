...
public class ProjNameConfigLogic {
    ...
    public List<ProjectionNameDTO> getBusinessProcessAttributes() {
         final List<ProjectionNameDTO> nameDTOs = new ArrayList<ProjectionNameDTO>();
            ...
            LOGGER.info("getBusinessProcessAttributes method started ");
           ...
           final Date date=new Date();
            ...
            LOGGER.info("getBusinessProcessAttributes method ended ");
            return nameDTOs;
    }
     ...
     */
    public String saveProjNameConfigDetails(final String finalTemplateName)throws SystemException, PortalException, Exception  {       
         LOGGER.info("saveProjNameConfigDetails method started ");
         final int userId = Integer.valueOf((String) VaadinSession.getCurrent().getAttribute(ConstantsUtils.USER_ID));
         
            final String[] names=finalTemplateName.split("~",2);          
          ...
          LOGGER.info("saveProjNameConfigDetails method ended ");
        return "success";
    }
     ...
     * @throws Exception the exception
     */
    public List<ProjectionNameDTO> getAvailableNameTemplate(final String businessProcess)throws SystemException, PortalException, Exception  {
        LOGGER.info("getAvailableNameTemplate method started ");
        final DynamicQuery nameDynamicQuery = DynamicQueryFactoryUtil.forClass(ProjectionNameConfig.class);
         ...
         LOGGER.info("getAvailableNameTemplate method ended ");
         return nameDTOs;
    }
     ...
     * @throws Exception the exception
     */
    public boolean duplicateCheck(final String businessProcess,final String finalName)throws SystemException, PortalException, Exception  {
         LOGGER.info("duplicateCheck method started ");
        int count=0;
        final DynamicQuery nameDynamicQuery = DynamicQueryFactoryUtil.forClass(ProjectionNameConfig.class);
        nameDynamicQuery.add(RestrictionsFactoryUtil.ilike("businessProcessType", businessProcess));
         List<ProjectionNameConfig> nameConfigs=ProjectionNameConfigLocalServiceUtil.dynamicQuery(nameDynamicQuery);
         for (ProjectionNameConfig nameConfig : nameConfigs) {         
          ...
          LOGGER.info("duplicateCheck method ended ");
         if(count > 0){
             return false;
         }else{
             return true;
