...
public final class ConstantsUtils {
    ...
    public static final String KEY = "outboundrelationshipbuilder";
    public static final String NAME = "relationshipbuilderoutboundprocess";
    ...
    public static final String PROD_RELATIONSHIP_BUILDER = "prodRelationshipBuilderSid";
    /**
     * The String Mail Configuration Input Prompt.
     */
    public static final String MAIL_CONFIG_INPUT_PROMPT = "Use comma to seperate multiple email Ids";
    /**
     * The String Space.
     */
    public static final String SPACE = " ";
    /**
     * The String Comma Space.
     */
