...
import com.stpl.app.service.ItemPricingLocalService;
...
/**
 * Provides the base implementation for the item pricing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ItemPricingLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class ItemPricingLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ItemPricingLocalService,
        IdentifiableBean {
    ...
    private ItemPricingLocalServiceClpInvoker _clpInvoker = new ItemPricingLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ItemPricingLocalServiceUtil} to access the item pricing local service.
     */
    ...
    @Override
    public ItemPricing addItemPricing(ItemPricing itemPricing)
        throws SystemException {
        itemPricing.setNew(true);

        return itemPricingPersistence.update(itemPricing);
    }
     ...
     */
    @Override
    public ItemPricing createItemPricing(int itemPricingSid) {
        return itemPricingPersistence.create(itemPricingSid);
    }
    ...
    @Override
    public ItemPricing deleteItemPricing(int itemPricingSid)
        throws PortalException, SystemException {
        return itemPricingPersistence.remove(itemPricingSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ItemPricing deleteItemPricing(ItemPricing itemPricing)
        throws SystemException {
        return itemPricingPersistence.remove(itemPricing);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ItemPricing.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return itemPricingPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return itemPricingPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return itemPricingPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ItemPricing fetchItemPricing(int itemPricingSid)
        throws SystemException {
        return itemPricingPersistence.fetchByPrimaryKey(itemPricingSid);
    }
     ...
     */
    @Override
    public ItemPricing getItemPricing(int itemPricingSid)
        throws PortalException, SystemException {
        return itemPricingPersistence.findByPrimaryKey(itemPricingSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return itemPricingPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ItemPricing> getItemPricings(int start, int end)
        throws SystemException {
        return itemPricingPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getItemPricingsCount() throws SystemException {
        return itemPricingPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ItemPricing updateItemPricing(ItemPricing itemPricing)
        throws SystemException {
        return itemPricingPersistence.update(itemPricing);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ItemPricing",
            itemPricingLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.ItemPricing");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = itemPricingPersistence.getDataSource();
