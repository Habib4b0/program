...
/**
 * Provides the local service interface for SlaCalendarMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see SlaCalendarMasterLocalServiceUtil
...
public interface SlaCalendarMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SlaCalendarMasterLocalServiceUtil} to access the sla calendar master local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.SlaCalendarMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public SlaCalendarMaster addSlaCalendarMaster(
	...
	*/
	public SlaCalendarMaster createSlaCalendarMaster(int slaCalendarMasterSid);
	...
	*/
	...
	public SlaCalendarMaster deleteSlaCalendarMaster(int slaCalendarMasterSid)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public SlaCalendarMaster deleteSlaCalendarMaster(
		SlaCalendarMaster slaCalendarMaster);
	...
	*/
	...
	public SlaCalendarMaster fetchSlaCalendarMaster(int slaCalendarMasterSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SlaCalendarMaster getSlaCalendarMaster(int slaCalendarMasterSid)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SlaCalendarMaster> getSlaCalendarMasters(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public SlaCalendarMaster updateSlaCalendarMaster(
		SlaCalendarMaster slaCalendarMaster);
}