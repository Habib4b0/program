...
/**
 * Provides the local service interface for NmPpaProjection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see NmPpaProjectionLocalServiceUtil
...
public interface NmPpaProjectionLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link NmPpaProjectionLocalServiceUtil} to access the nm ppa projection local service. Add custom service methods to {@link com.stpl.app.service.impl.NmPpaProjectionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
