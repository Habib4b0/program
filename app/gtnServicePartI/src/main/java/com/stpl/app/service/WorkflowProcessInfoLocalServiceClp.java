 ...
 * @generated
 */
public class WorkflowProcessInfoLocalServiceClp
    ...
    public WorkflowProcessInfoLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addWorkflowProcessInfo";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.WorkflowProcessInfo"
            };

        _methodName1 = "createWorkflowProcessInfo";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteWorkflowProcessInfo";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteWorkflowProcessInfo";
        ...
        _methodName10 = "fetchWorkflowProcessInfo";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getWorkflowProcessInfo";
        ...
        _methodName13 = "getWorkflowProcessInfos";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getWorkflowProcessInfosCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateWorkflowProcessInfo";
    ...
    public com.stpl.app.model.WorkflowProcessInfo addWorkflowProcessInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(workflowProcessInfo)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.WorkflowProcessInfo) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.WorkflowProcessInfo createWorkflowProcessInfo(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { workflowProcessInfoSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.WorkflowProcessInfo> getWorkflowProcessInfos(
        ...
        return (java.util.List<com.stpl.app.model.WorkflowProcessInfo>) ClpSerializer.translateOutput(returnObj);
    }
