 ...
 * @author Karthik.Raja
 */
public class FileUploadForm extends CustomComponent
	...
	private void addButtonListeners() {
		submitBtn.addClickListener(new Button.ClickListener() {
			public void buttonClick(final Button.ClickEvent event) {
				if (selectedInterface.getValue() != null
						&& !String.valueOf(selectedInterface.getValue()).equals(Constants.SELECT_ONE)) {
					if (fileSelected) {
	...
	public void uploadSucceeded(SucceededEvent event) {
		try {
			File destinationFile = GtnFileUtil
					.getFile(String.format(pathFormat, selectType.getValue(), selectedInterface.getValue())
							+ event.getFilename());
