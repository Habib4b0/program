...
/**
 * The persistence utility for the projection prod details service. This utility wraps {@link ProjectionProdDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ProjectionProdDetailsUtil {
    private static ProjectionProdDetailsPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.ProjectionProdDetails create(
    ...
    */
    public static com.stpl.app.model.ProjectionProdDetails remove(
        int productDetailsId)
    ...
    public static com.stpl.app.model.ProjectionProdDetails updateImpl(
        com.stpl.app.model.ProjectionProdDetails projectionProdDetails)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.ProjectionProdDetails findByPrimaryKey(
        int productDetailsId)
        throws com.stpl.app.NoSuchProjectionProdDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.ProjectionProdDetails fetchByPrimaryKey(
        int productDetailsId)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.ProjectionProdDetails> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static ProjectionProdDetailsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (ProjectionProdDetailsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    ProjectionProdDetailsPersistence.class.getName());

            ReferenceRegistry.registerReference(ProjectionProdDetailsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(ProjectionProdDetailsPersistence persistence) {
    }
}
