...
/**
 * The persistence utility for the item group service. This utility wraps {@link com.stpl.app.service.persistence.impl.ItemGroupPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ItemGroupUtil {
	...
	*/
	public static void cacheResult(ItemGroup itemGroup) {
	...
	*/
	public static void cacheResult(List<ItemGroup> itemGroups) {
	...
	*/
	public static ItemGroup create(int itemGroupSid) {
	...
	*/
	public static ItemGroup remove(int itemGroupSid)
		throws com.stpl.app.exception.NoSuchItemGroupException {
		return getPersistence().remove(itemGroupSid);
	}

	public static ItemGroup updateImpl(ItemGroup itemGroup) {
	...
	* @throws NoSuchItemGroupException if a item group with the primary key could not be found
	*/
	public static ItemGroup findByPrimaryKey(int itemGroupSid)
		throws com.stpl.app.exception.NoSuchItemGroupException {
	...
	*/
	public static ItemGroup fetchByPrimaryKey(int itemGroupSid) {
		return getPersistence().fetchByPrimaryKey(itemGroupSid);
	}

	public static java.util.Map<java.io.Serializable, ItemGroup> fetchByPrimaryKeys(
	...
	*/
	public static List<ItemGroup> findAll() {
	...
	*/
	public static List<ItemGroup> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<ItemGroupPersistence, ItemGroupPersistence> _serviceTracker =
		ServiceTrackerFactory.open(ItemGroupPersistence.class);
}