...
public interface WorkflowProcessInfoPersistence extends BasePersistence<WorkflowProcessInfo> {
	...
	*/
	public void cacheResult(
		java.util.List<WorkflowProcessInfo> workflowProcessInfos);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, WorkflowProcessInfo> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<WorkflowProcessInfo> findAll();
	...
	*/
	public java.util.List<WorkflowProcessInfo> findAll(int start, int end);
	...
	*/
	public java.util.List<WorkflowProcessInfo> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<WorkflowProcessInfo> orderByComparator);
