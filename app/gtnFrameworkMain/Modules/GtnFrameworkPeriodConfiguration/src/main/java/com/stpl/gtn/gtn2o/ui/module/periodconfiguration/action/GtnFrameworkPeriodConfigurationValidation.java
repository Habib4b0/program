...
public class GtnFrameworkPeriodConfigurationValidation
	...
	private void validateDefaultToDate(GtnWsPeriodConfigurationRequest periodConfigurationRequest, String componentId)
		...
		Calendar toDate = getCalendar(periodConfigurationRequest.getDateTo());
		Calendar defaltToDate = getCalendar(periodConfigurationRequest.getDefaultDateTo());
		if (defaltToDate.compareTo(today) >= 0 && defaltToDate.compareTo(toDate) <= 0) {
			return;
		}
