...
public interface GcmGlobalDetailsPersistence extends BasePersistence<GcmGlobalDetails> {
	...
	*/
	public void cacheResult(java.util.List<GcmGlobalDetails> gcmGlobalDetailses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, GcmGlobalDetails> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<GcmGlobalDetails> findAll();
	...
	*/
	public java.util.List<GcmGlobalDetails> findAll(int start, int end);
	...
	*/
	public java.util.List<GcmGlobalDetails> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<GcmGlobalDetails> orderByComparator);
