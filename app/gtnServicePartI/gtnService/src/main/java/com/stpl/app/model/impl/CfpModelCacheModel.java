...
public class CfpModelCacheModel implements CacheModel<CfpModel>, Externalizable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CfpModelCacheModel)) {
			return false;
		}

		CfpModelCacheModel cfpModelCacheModel = (CfpModelCacheModel)obj;

		if (cfpModelSid == cfpModelCacheModel.cfpModelSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, cfpModelSid);
	}
