...
public class MSupplementalDiscActualsLocalServiceUtil {
    private static MSupplementalDiscActualsLocalService _service;
    ...
    */
    ...
    public static MSupplementalDiscActualsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    MSupplementalDiscActualsLocalService.class.getName());

            if (invokableLocalService instanceof MSupplementalDiscActualsLocalService) {
                _service = (MSupplementalDiscActualsLocalService) invokableLocalService;
            } else {
                _service = new MSupplementalDiscActualsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(MSupplementalDiscActualsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(MSupplementalDiscActualsLocalService service) {
    }
}
