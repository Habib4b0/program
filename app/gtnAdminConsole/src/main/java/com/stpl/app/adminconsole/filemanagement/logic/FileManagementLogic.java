...
public class FileManagementLogic {
     ...
     * @throws Exception the exception
     */
    public FileManagementDTO getDetailsSumm(final String fileName, final String version, final HelperDTO fileType, final String country) throws SystemException {
        ...
        if (ConstantsUtils.EX_FACTORY_SALES.equals(fileType.getDescription())) {
            ...
            sqlString = "SELECT DF.FORECAST_NAME,DF.FORECAST_VER,DF.CREATED_DATE FROM DEMAND_FORECAST DF WHERE FORECAST_NAME like '" + fileName + StringConstantUtils.AND_COUNTRY_LIKE + country + StringConstantUtils.AND_FORECAST_VER_LIKE + version + "'";
            ...
            sqlString = "SELECT INW.FORECAST_NAME,INW.FORECAST_VER,INW.CREATED_DATE FROM INVENTORY_WD_PROJ_MAS INW WHERE INW.FORECAST_NAME like '" + fileName + StringConstantUtils.AND_INW_COUNTRY_LIKE + country + "' AND INW.FORECAST_VER like '" + version + "'";
            List<ForecastingMaster> resultsLists = HelperTableLocalServiceUtil.executeSelectQuery(sqlString);
            if (!resultsLists.isEmpty()) {
                for (Object resultsList1 : resultsLists) {
                    final Object[] obj = (Object[]) resultsList1;
            ...
            sqlString = "SELECT INW.FORECAST_NAME,INW.FORECAST_VER,INW.CREATED_DATE FROM INVENTORY_WD_PROJ_DT INW WHERE INW.FORECAST_NAME like '" + fileName + StringConstantUtils.AND_INW_COUNTRY_LIKE + country + "%' AND INW.FORECAST_VER like '" + version + "'";
            List<ForecastingMaster> resultsLists = HelperTableLocalServiceUtil.executeSelectQuery(sqlString);
            if (!resultsLists.isEmpty()) {
                for (Object resultsList1 : resultsLists) {
                    final Object[] obj = (Object[]) resultsList1;
            ...
            sqlString = "SELECT DF.FORECAST_NAME,DF.FORECAST_VER,DF.CREATED_DATE FROM CUSTOMER_GTS_FORECAST DF WHERE FORECAST_NAME like '" + fileName + StringConstantUtils.AND_COUNTRY_LIKE + country + StringConstantUtils.AND_FORECAST_VER_LIKE + version + "'";
            List<ForecastingMaster> resultsLists = HelperTableLocalServiceUtil.executeSelectQuery(sqlString);
            if (!resultsLists.isEmpty()) {
                for (Object resultsList1 : resultsLists) {
                    final Object[] obj = (Object[]) resultsList1;
            ...
            sqlString = "SELECT FORECAST_NAME, FORECAST_VER, CREATED_DATE FROM dbo.ADJUSTED_DEMAND_FORECAST WHERE FORECAST_NAME like '" + fileName + StringConstantUtils.AND_COUNTRY_LIKE + country + StringConstantUtils.AND_FORECAST_VER_LIKE + version + "'";
            List<ForecastingMaster> resultsLists = HelperTableLocalServiceUtil.executeSelectQuery(sqlString);
            if (!resultsLists.isEmpty()) {
                for (Object resultsList1 : resultsLists) {
                    final Object[] obj = (Object[]) resultsList1;
    ...
    public String saveFileMgtHist(final FileMananagementResultDTO fileMgtDTO, final HelperDTO fileType, final SessionDTO sessionDTO) throws SystemException {
        ...
        if ((fileMgtDTO.getBusinessUnitSysId()) != 0) {
            dynamicQuery.add(RestrictionsFactoryUtil.eq(StringConstantUtils.BUSINESS_UNIT, String.valueOf(fileMgtDTO.getBusinessUnitSysId())));
        }

        if (fileMgtDTO.getCompanyMasterSystemId() != 0) {
            dynamicQuery.add(RestrictionsFactoryUtil.eq(StringConstantUtils.COMPANY, fileMgtDTO.getCompanyMasterSystemId()));
        }
     ...
     * @throws Exception the exception
     */
    public FileManagementDTO getCurrentFileInfo(final HelperDTO fileType, String businessUnit, Object companyMasterSystemId) throws SystemException {
    ...
    public String getLatestVersion(String country, String forecastName, HelperDTO fileType, String version, String selectedFile) throws SystemException {
        ...
        if (fileType.getDescription().equals(ConstantsUtils.EX_FACTORY_SALES)) {
            ...
            String sqlString = "SELECT DISTINCT DF.FORECAST_VER FROM DEMAND_FORECAST DF WHERE FORECAST_NAME like '" + forecastName + StringConstantUtils.AND_COUNTRY_LIKE + country + StringConstantUtils.AND_FORECAST_VER_LIKE + forecastVersion + "'";
            ...
            String sqlString = "SELECT DISTINCT DF.FORECAST_VER FROM ADJUSTED_DEMAND_FORECAST DF WHERE FORECAST_NAME like '" + forecastName + StringConstantUtils.AND_COUNTRY_LIKE + country + StringConstantUtils.AND_FORECAST_VER_LIKE + forecastVersion + "'";
            versions = HelperTableLocalServiceUtil.executeSelectQuery(sqlString);
        } else if (fileType.getDescription().equals(ConstantsUtils.INVENTORY_WITHDRAWAL_SUMMARY)) {
            String sqlString = "SELECT DISTINCT INW.FORECAST_VER FROM INVENTORY_WD_PROJ_MAS INW WHERE INW.FORECAST_NAME like '" + forecastName + StringConstantUtils.AND_INW_COUNTRY_LIKE + country + "' AND INW.FORECAST_VER like '" + forecastVersion + "'";
            versions = HelperTableLocalServiceUtil.executeSelectQuery(sqlString);
        } else if (fileType.getDescription().equals(ConstantsUtils.INVENTORY_WITHDRAWAL_DETAIL)) {
            String sqlString = "SELECT DISTINCT INW.FORECAST_VER FROM INVENTORY_WD_PROJ_DT INW WHERE INW.FORECAST_NAME like '" + forecastName + StringConstantUtils.AND_INW_COUNTRY_LIKE + country + "%' AND INW.FORECAST_VER like '" + forecastVersion + "'";
            versions = HelperTableLocalServiceUtil.executeSelectQuery(sqlString);
        } else if (fileType.getDescription().equals(ConstantsUtils.CUSTOMERGTS)) {
            String sqlString = "SELECT DISTINCT DF.FORECAST_VER FROM CUSTOMER_GTS_FORECAST DF WHERE FORECAST_NAME like '" + forecastName + StringConstantUtils.AND_COUNTRY_LIKE + country + StringConstantUtils.AND_FORECAST_VER_LIKE + forecastVersion + "'";
            versions = HelperTableLocalServiceUtil.executeSelectQuery(sqlString);
        }
            ...
            for (int i = 0; i < itemIds.size(); i++) {
                ...
                if (!beanItem.isRecordLockStatus()) {
                    ...
                    if (fileType.getDescription().equals(ConstantsUtils.EX_FACTORY_SALES)) {
                        ...
                        forecast.setMarketSizeUnits(Double.valueOf(StringUtils.isBlank(beanItem.getMarketSizeUnits()) ? "0" : beanItem.getMarketSizeUnits()));
                        forecast.setMarketShareUnits(Double.valueOf(StringUtils.isBlank(beanItem.getMarketShareUnits()) ? "0" : beanItem.getMarketShareUnits()));
                        forecast.setMarketShareRatio(StringUtils.isBlank(beanItem.getMarketShareRatio()) ? "0" : beanItem.getMarketShareRatio());
                        forecast.setUncapturedUnits(Double.valueOf(StringUtils.isBlank(beanItem.getUncapturedUnits()) ? "0" : beanItem.getUncapturedUnits()));
                        forecast.setUncapturedUnitsRatio(StringUtils.isBlank(beanItem.getUncapturedUnitsRatio()) ? "0" : beanItem.getUncapturedUnitsRatio());
                        forecast.setTotalDemandUnits(Double.valueOf(StringUtils.isBlank(beanItem.getTotalDemandUnits()) ? "0" : beanItem.getTotalDemandUnits()));
                        ...
                        forecast.setTotalDemandAmount(Double.valueOf(StringUtils.isNotBlank(totalDemand) ? totalDemand : "0"));
                        ...
                        forecast.setInventoryUnitChange(Double.valueOf(StringUtils.isNotBlank(inventoryUnit) ? inventoryUnit : "0"));
                        ...
                        forecast.setNetSalesPrice(Double.valueOf(StringUtils.isNotBlank(netSalesPrice) ? netSalesPrice : "0"));
                        ...
                        try {
                            ...
                            adjustedforecast.setMarketSizeUnits(Double.valueOf(StringUtils.isBlank(beanItem.getMarketSizeUnits()) ? "0" : beanItem.getMarketSizeUnits()));
                            adjustedforecast.setMarketShareUnits(Double.valueOf((beanItem.getMarketShareUnits() == null || beanItem.getMarketShareUnits().trim().equals(StringUtils.EMPTY)) ? "0" : beanItem.getMarketShareUnits()));
                            adjustedforecast.setMarketShareRatio(StringUtils.isBlank(beanItem.getMarketShareRatio()) ? "0" : beanItem.getMarketShareRatio());
                            adjustedforecast.setUncapturedUnits(Double.valueOf(StringUtils.isBlank(beanItem.getUncapturedUnits()) ? "0" : beanItem.getUncapturedUnits()));
                            ...
                            adjustedforecast.setTotalDemandAmount(Double.valueOf(StringUtils.isNotBlank(totalDemandadj) ? totalDemandadj : "0"));
                            adjustedforecast.setInventoryUnitChange(Double.valueOf(StringUtils.isNotBlank(beanItem.getInventoryUnitChange()) ? beanItem.getInventoryUnitChange() : "0"));
                            adjustedforecast.setGrossUnits(Double.valueOf(StringUtils.isNotBlank(beanItem.getGrossUnits()) ? beanItem.getGrossUnits() : "0"));
                            adjustedforecast.setGrossPrice(Double.valueOf(StringUtils.isNotBlank(beanItem.getGrossPrice()) ? beanItem.getGrossPrice() : "0"));
                            if (beanItem.getGrossAmount().contains("$")) {
                                grossAmount = beanItem.getGrossAmount().replace("$", "");
                            } else {
                                grossAmount = beanItem.getGrossAmount();
                            }
                            adjustedforecast.setGrossAmount(Double.valueOf(StringUtils.isNotBlank(grossAmount) ? grossAmount : "0"));
                            if (beanItem.getNetSalesPrice().contains("$")) {
                                netSalesPriceadj = beanItem.getNetSalesPrice().replace("$", "");
                            } else {
                                netSalesPriceadj = beanItem.getNetSalesPrice();
                            }
                            adjustedforecast.setNetSalesPrice(Double.valueOf(StringUtils.isNotBlank(netSalesPriceadj) ? netSalesPriceadj : "0"));
                        ...
                        query += StringConstantUtils.A_NULL.equals(buildQuery(beanItem.getMonth())) ? "," + 0 : buildQuery(beanItem.getMonth());
                        query += buildQuery(beanItem.getDay());
                        query += buildQuery(beanItem.getWeek());
                        query += StringConstantUtils.A_NULL.equals(buildQuery(beanItem.getCompanyId())) ? "," + 0 : buildQuery(beanItem.getCompanyId());
                        query += buildQuery(beanItem.getIdentifierCodeQualifier());
                        query += buildQuery(beanItem.getCompanyIdentifier());
                        query += StringConstantUtils.A_NULL.equals(buildQuery(beanItem.getItemId())) ? "," + 0 : buildQuery(beanItem.getItemId());
                        query += buildQuery(beanItem.getItemIdentifierCodeQualifier());
                        query += StringConstantUtils.A_NULL.equals(buildQuery(beanItem.getItemIdentifier())) ? ",'" + 0 + "'" : buildQuery(beanItem.getItemIdentifier());
                        query += StringConstantUtils.A_NULL.equals(buildQuery(beanItem.getUnitsWithdrawn())) ? "," + 0 : buildQuery(beanItem.getUnitsWithdrawn());
                        ...
                        query += ",'" + convertStringToDate(new Date().toString(), DEFAULT_JAVA_DATE_FORMAT, DEFAULT_SQL_DATE_FORMAT) + "'";
                        query += StringConstantUtils.A_NULL.equals(buildQuery(beanItem.getBatchId())) ? ",'" + 0 + "'" : buildQuery(beanItem.getBatchId());
                        query += ",'" + source + "'";
                        query += ",'" + forecastName + "'";
                        query += ",'" + version + "'";
                        query += ",'" + country + "'";
                        query += StringConstantUtils.A_NULL.equals(buildQuery(beanItem.getOrganizationKey())) ? ",'" + 0 + "'" : buildQuery(beanItem.getOrganizationKey());
                        query += StringConstantUtils.A_NULL.equals(buildQuery(beanItem.getCompanyId())) ? ",'" + 0 + "'" : buildQuery(beanItem.getCompanyId());
                        query += StringConstantUtils.A_NULL.equals(buildQuery(beanItem.getItemId())) ? ",'" + 0 + "'" : buildQuery(beanItem.getItemId());
                        query += ");";
     ...
     * @return
     */
    public Object getFileHistoryResults(final HelperDTO fileType, final String country, final String businessUnit, final Object company, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount) throws SystemException {
        ...
        if (businessUnit != null && !businessUnit.isEmpty() && !businessUnit.equalsIgnoreCase("null") && !businessUnit.equalsIgnoreCase("0")) {
            ...
            for (Container.Filter filter : filterSet) {
                if (filter instanceof SimpleStringFilter) {
                    ...
                    if ("file".equals(stringFilter.getPropertyId())) {
                        projectionDynamicQuery.add(RestrictionsFactoryUtil.ilike(CommonUtils.FORECAST_NAME, filterString));
                    }
                    ...
                    if (StringConstantUtils.BUSINESS_UNIT.equals(stringFilter.getPropertyId()) && stringFilter.getFilterString() != null && !stringFilter.getFilterString().isEmpty() && !stringFilter.getFilterString().equalsIgnoreCase("null") && !stringFilter.getFilterString().equalsIgnoreCase("0")) {
                        projectionDynamicQuery.add(RestrictionsFactoryUtil.ilike(StringConstantUtils.BUSINESS_UNIT, filterString));
                    }
                    if (COMPANY_NAME.equals(stringFilter.getPropertyId()) && stringFilter.getFilterString() != null && !stringFilter.getFilterString().isEmpty() && !stringFilter.getFilterString().equalsIgnoreCase("null") && !stringFilter.getFilterString().equalsIgnoreCase("0")) {
                        projectionDynamicQuery.add(RestrictionsFactoryUtil.eq(StringConstantUtils.COMPANY, Integer.valueOf(stringFilter.getFilterString())));
                    }
    ...
    public Object getFileResults(FileMananagementResultDTO resultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount) {
        ...
        try {
            ...
            LOGGER.debug("getResults started with P1:String fileType=" + resultDTO.getHelperType().getDescription() + " P2:String country=" + resultDTO.getCountry() + " P3:String fileName=" + fileName + " P4:String type" + type + " P5:String version"
            ...
            if (ConstantsUtils.EX_FACTORY_SALES.equals(resultDTO.getHelperType().getDescription()) && ConstantsUtils.COUNTRY_US.equals(resultDTO.getCountry())) {
                ...
                searchQuery = SQlUtil.getQuery(isCount ? "adjusted-demand-count-query" : "adjusted-demand-search-query");
                ...
                searchQuery = SQlUtil.getQuery(isCount ? "inventory-withdrawl-summary-count-query" : "inventory-withdrawl-summary-search-query");
                ...
                searchQuery = SQlUtil.getQuery(isCount ? "inventory-with-det-count-query" : "inventory-with-det-search-query");
            ...
            searchQuery = searchQuery.replace("[?COMPANY_MASTER_SID]", StringUtils.EMPTY + resultDTO.getCompanyMasterSystemId());
            ...
            if (resultDTO.getFromPeriod() != null && resultDTO.getToPeriod() != null) {
                searchQuery = searchQuery.replace(StringConstantUtils.DATEQUERY, "WHERE FT_MIN_DATE  = " + "'" + MMDDYY_DATE_FORMAT.format(JAVA_DATE_FORMAT.parse(String.valueOf(resultDTO.getFromPeriod()))) + "'" + " AND FT_MAX_DATE  =" + "'" + MMDDYY_DATE_FORMAT.format(JAVA_DATE_FORMAT.parse(String.valueOf(resultDTO.getToPeriod()))) + "'");
           dateWhereCondition="WHERE FT_MIN_DATE  = " + "'" + MMDDYY_DATE_FORMAT.format(JAVA_DATE_FORMAT.parse(String.valueOf(resultDTO.getFromPeriod()))) + "'" + " AND FT_MAX_DATE  =" + "'" + MMDDYY_DATE_FORMAT.format(JAVA_DATE_FORMAT.parse(String.valueOf(resultDTO.getToPeriod()))) + "'";
            } else if (resultDTO.getFromPeriod() != null) {
                searchQuery = searchQuery.replace(StringConstantUtils.DATEQUERY, "WHERE FT_MIN_DATE  =" + "'" + MMDDYY_DATE_FORMAT.format(JAVA_DATE_FORMAT.parse(String.valueOf(resultDTO.getFromPeriod()))) + "'");
           dateWhereCondition="WHERE FT_MIN_DATE  =" + "'" + MMDDYY_DATE_FORMAT.format(JAVA_DATE_FORMAT.parse(String.valueOf(resultDTO.getFromPeriod()))) + "'";
            } else if (resultDTO.getToPeriod() != null) {
                searchQuery = searchQuery.replace(StringConstantUtils.DATEQUERY, "WHERE FT_MAX_DATE  =" + "'" + MMDDYY_DATE_FORMAT.format(JAVA_DATE_FORMAT.parse(String.valueOf(resultDTO.getToPeriod()))) + "'");
                dateWhereCondition= "WHERE FT_MAX_DATE  =" + "'" + MMDDYY_DATE_FORMAT.format(JAVA_DATE_FORMAT.parse(String.valueOf(resultDTO.getToPeriod()))) + "'";
            }
            ...
            if (filterSet != null) {
                for (Container.Filter filter : filterSet) {
                    if (filter instanceof SimpleStringFilter) {
                        SimpleStringFilter stringFilter = (SimpleStringFilter) filter;
                        String filterString = "%" + stringFilter.getFilterString() + "%";
                        if (StringConstantUtils.BUSINESS_UNIT.equals(stringFilter.getPropertyId()) || COMPANY_NAME.equals(stringFilter.getPropertyId())) {
                            if (stringFilter.getFilterString() != null && !stringFilter.getFilterString().isEmpty() && !stringFilter.getFilterString().equalsIgnoreCase("null") && !stringFilter.getFilterString().equalsIgnoreCase("0")) {
                                condition = condition + StringConstantUtils.AND_SPACE + resultsColumn.get(String.valueOf(stringFilter.getPropertyId())) + StringConstantUtils.LIKE_SPACE + filterString + "'";
                            }
                        } else {
                            condition = condition + StringConstantUtils.AND_SPACE + resultsColumn.get(String.valueOf(stringFilter.getPropertyId())) + StringConstantUtils.LIKE_SPACE + filterString + "'";
                        }
                        ...
                        if (StringConstantUtils.FROM_DATE.equals(stringFilter.getPropertyId())) {
                            if (!dateWhereCondition.isEmpty()) {
                                dateWhereCondition = dateWhereCondition + " AND FT_MIN_DATE >= '" + MMDDYY_DATE_FORMAT.format(filterString) + "' ";
                            } else {
                                dateWhereCondition = dateWhereCondition + " WHERE FT_MIN_DATE >= '" + MMDDYY_DATE_FORMAT.format(filterString) + "' ";
                            }
                            dateWhereCondition = dateWhereCondition + " AND FT_MIN_DATE <= '" + MMDDYY_DATE_FORMAT.format(filterString1) + "' ";
                        }
            ...
            if (!isCount) {
                ...
                if (orderByColumn == null || StringUtils.EMPTY.equals(orderByColumn)) {
                    ...
                    searchQuery = searchQuery.replace("[?ORDER_BY_COLUMN]", orderByColumn + ((!sortOrder) ? ASC_SPACE : DESC_SPACE));
     ...
     * @throws Exception
     */
    public Object getDetailsResults(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isRecordLock) throws SystemException, ParseException {
        ...
        if (detailsResultDTO.getHelperType().getDescription().equals(ConstantsUtils.DEMAND)) {
            resultsList = (List)getDemandDetailsResults(detailsResultDTO, startIndex, endIndex, sortByColumns, filterSet, isCount,isRecordLock);
        } else if (detailsResultDTO.getHelperType().getDescription().equals(ConstantsUtils.ADJUSTED_DEMAND)) {
            resultsList = (List)getAdjustedDemandDetailsResults(detailsResultDTO, startIndex, endIndex, sortByColumns, filterSet, isCount,isRecordLock);
        } else if (detailsResultDTO.getHelperType().getDescription().equals(ConstantsUtils.EX_FACTORY_SALES)) {
            resultsList = (List)getForecastDetails(detailsResultDTO, startIndex, endIndex, sortByColumns, filterSet, isCount,isRecordLock);
        } else if (detailsResultDTO.getHelperType().getDescription().equals(ConstantsUtils.INVENTORY_WITHDRAWAL_SUMMARY)) {
            resultsList = (List)getInventorySummaryResults(detailsResultDTO, startIndex, endIndex, sortByColumns, filterSet, isCount,isRecordLock);
        } else if (detailsResultDTO.getHelperType().getDescription().equals(ConstantsUtils.INVENTORY_WITHDRAWAL_DETAIL)) {
            resultsList = (List)getInventoryDetailsResults(detailsResultDTO, startIndex, endIndex, sortByColumns, filterSet, isCount);
        } else if (detailsResultDTO.getHelperType().getDescription().equals(ConstantsUtils.CUSTOMERGTS)) {
            resultsList = (List)getCustomerSalesResults(detailsResultDTO, startIndex, endIndex, sortByColumns, filterSet, isCount);
        } else {
            resultsList = null;
        }
        if (!isCount && detailsResultDTO.getHelperType().getDescription().equals(ConstantsUtils.EX_FACTORY_SALES)) {
            ...
            LOGGER.debug("getDetailsResults return List<FileMananagementResultDTO> resultsListDTO=" + resultsListDTO.size());
             ...
             for (Object resultsList1 : resultsList) {
                ...
                fmDTO.setForecastMonth(obj[NumericConstants.TWO] != null ? String.valueOf(obj[NumericConstants.TWO]) : ConstantsUtils.EMPTY);
                fmDTO.setItemId(obj[NumericConstants.THREE] != null ? String.valueOf(obj[NumericConstants.THREE]) : ConstantsUtils.EMPTY);
                ...
                fmDTO.setHiddenForecastMonth(obj[NumericConstants.TWO] != null ? String.valueOf(obj[NumericConstants.TWO]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenItemId(obj[NumericConstants.THREE] != null ? String.valueOf(obj[NumericConstants.THREE]) : ConstantsUtils.EMPTY);
                fmDTO.setItemIdentifierCodeQualifier(obj[NumericConstants.FOUR] != null ? String.valueOf(obj[NumericConstants.FOUR]) : ConstantsUtils.EMPTY);
                fmDTO.setItemIdentifier(obj[NumericConstants.FIVE] != null ? String.valueOf(obj[NumericConstants.FIVE]) : ConstantsUtils.EMPTY);
                fmDTO.setBrandId(obj[NumericConstants.SIX] != null ? String.valueOf(obj[NumericConstants.SIX]) : ConstantsUtils.EMPTY);
                fmDTO.setSegment(obj[NumericConstants.SEVEN] != null ? String.valueOf(obj[NumericConstants.SEVEN]) : ConstantsUtils.EMPTY);
                fmDTO.setMarketSizeUnits(obj[NumericConstants.EIGHT] != null ? String.valueOf(obj[NumericConstants.EIGHT]) : ConstantsUtils.EMPTY);
                fmDTO.setMarketShareUnits(obj[NumericConstants.NINE] != null ? String.valueOf(obj[NumericConstants.NINE]) : ConstantsUtils.EMPTY);
                fmDTO.setMarketShareRatio(obj[NumericConstants.TEN] != null ? String.valueOf(obj[NumericConstants.TEN]) : ConstantsUtils.EMPTY);
                fmDTO.setUncapturedUnits(obj[NumericConstants.ELEVEN] != null ? String.valueOf(obj[NumericConstants.ELEVEN]) : ConstantsUtils.EMPTY);
                fmDTO.setUncapturedUnitsRatio(obj[NumericConstants.TWELVE] != null ? String.valueOf(obj[NumericConstants.TWELVE]) : ConstantsUtils.EMPTY);
                fmDTO.setTotalDemandUnits(obj[NumericConstants.THIRTEEN] != null ? String.valueOf(obj[NumericConstants.THIRTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setTotalDemandAmount(obj[NumericConstants.FOURTEEN] != null ? String.valueOf(obj[NumericConstants.FOURTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setInventoryUnitChange(obj[NumericConstants.FIFTEEN] != null ? String.valueOf(obj[NumericConstants.FIFTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setGrossUnits(obj[NumericConstants.SIXTEEN] != null ? String.valueOf(obj[NumericConstants.SIXTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setGrossPrice(obj[NumericConstants.SEVENTEEN] != null ? String.valueOf(obj[NumericConstants.SEVENTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setGrossAmount(obj[NumericConstants.EIGHTEEN] != null ? String.valueOf(obj[NumericConstants.EIGHTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setNetSalesPrice(obj[NumericConstants.NINETEEN] != null ? String.valueOf(obj[NumericConstants.NINETEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setNetSalesAmount(obj[NumericConstants.TWENTY] != null ? String.valueOf(obj[NumericConstants.TWENTY]) : ConstantsUtils.EMPTY);
                fmDTO.setBatchId(obj[NumericConstants.TWENTY_ONE] != null ? String.valueOf(obj[NumericConstants.TWENTY_ONE]) : ConstantsUtils.EMPTY);
                fmDTO.setOrganizationKey(obj[NumericConstants.TWENTY_SIX] != null ? String.valueOf(obj[NumericConstants.TWENTY_SIX]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenOrganisationKey(obj[NumericConstants.TWENTY_SIX] != null ? String.valueOf(obj[NumericConstants.TWENTY_SIX]) : ConstantsUtils.EMPTY);
            ...
            detailsObj = resultsListDTO;
             ...
             for (Object resultsList1 : resultsList) {
                ...
                fmDTO.setDay(obj[NumericConstants.TWO] != null ? String.valueOf(obj[NumericConstants.TWO]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenDay(obj[NumericConstants.TWO] != null ? String.valueOf(obj[NumericConstants.TWO]) : ConstantsUtils.EMPTY);
                fmDTO.setWeek(obj[NumericConstants.THREE] != null ? String.valueOf(obj[NumericConstants.THREE]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenWeek(obj[NumericConstants.THREE] != null ? String.valueOf(obj[NumericConstants.THREE]) : ConstantsUtils.EMPTY);
                fmDTO.setItemId(obj[NumericConstants.FOUR] != null ? String.valueOf(obj[NumericConstants.FOUR]) : ConstantsUtils.EMPTY);
                fmDTO.setItemIdentifierCodeQualifier(obj[NumericConstants.FIVE] != null ? String.valueOf(obj[NumericConstants.FIVE]) : ConstantsUtils.EMPTY);
                fmDTO.setItemIdentifier(obj[NumericConstants.SIX] != null ? String.valueOf(obj[NumericConstants.SIX]) : ConstantsUtils.EMPTY);
                fmDTO.setUnitsWithdrawn(obj[NumericConstants.SEVEN] != null ? String.valueOf(obj[NumericConstants.SEVEN]) : ConstantsUtils.EMPTY);
                fmDTO.setAmountWithdrawn(obj[NumericConstants.EIGHT] != null ? String.valueOf(obj[NumericConstants.EIGHT]) : ConstantsUtils.EMPTY);
                fmDTO.setPrice(obj[NumericConstants.NINE] != null ? String.valueOf(obj[NumericConstants.NINE]) : ConstantsUtils.EMPTY);
                fmDTO.setBatchId(obj[NumericConstants.TEN] != null ? String.valueOf(obj[NumericConstants.TEN]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenbatchId(obj[NumericConstants.TEN] != null ? String.valueOf(obj[NumericConstants.TEN]) : ConstantsUtils.EMPTY);
                fmDTO.setOrganizationKey(obj[NumericConstants.ELEVEN] != null ? String.valueOf(obj[NumericConstants.ELEVEN]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenOrganisationKey(obj[NumericConstants.ELEVEN] != null ? String.valueOf(obj[NumericConstants.ELEVEN]) : ConstantsUtils.EMPTY);
            ...
            Map<String, String> userMap = CommonUtil.getCreatedByUser();
             for (Object resultsList1 : resultsList) {
                ...
                fmDTO.setWeek(obj[NumericConstants.THREE] != null ? String.valueOf(obj[NumericConstants.THREE]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenWeek(obj[NumericConstants.THREE] != null ? String.valueOf(obj[NumericConstants.THREE]) : ConstantsUtils.EMPTY);
                fmDTO.setCompanyId(obj[NumericConstants.FOUR] != null ? String.valueOf(obj[NumericConstants.FOUR]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenCompanyId(obj[NumericConstants.FOUR] != null ? String.valueOf(obj[NumericConstants.FOUR]) : ConstantsUtils.EMPTY);
                fmDTO.setIdentifierCodeQualifier(obj[NumericConstants.FIVE] != null ? String.valueOf(obj[NumericConstants.FIVE]) : ConstantsUtils.EMPTY);
                fmDTO.setCompanyIdentifier(obj[NumericConstants.SIX] != null ? String.valueOf(obj[NumericConstants.SIX]) : ConstantsUtils.EMPTY);
                fmDTO.setItemId(obj[NumericConstants.SEVEN] != null ? String.valueOf(obj[NumericConstants.SEVEN]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenItemId(obj[NumericConstants.SEVEN] != null ? String.valueOf(obj[NumericConstants.SEVEN]) : ConstantsUtils.EMPTY);
                fmDTO.setItemIdentifierCodeQualifier(obj[NumericConstants.EIGHT] != null ? String.valueOf(obj[NumericConstants.EIGHT]) : ConstantsUtils.EMPTY);
                fmDTO.setItemIdentifier(obj[NumericConstants.NINE] != null ? String.valueOf(obj[NumericConstants.NINE]) : ConstantsUtils.EMPTY);
                fmDTO.setUnitsWithdrawn(obj[NumericConstants.TEN] != null ? String.valueOf(obj[NumericConstants.TEN]) : ConstantsUtils.EMPTY);
                fmDTO.setAmountWithdrawn(obj[NumericConstants.ELEVEN] != null ? String.valueOf(obj[NumericConstants.ELEVEN]) : ConstantsUtils.EMPTY);
                fmDTO.setPrice(obj[NumericConstants.TWELVE] != null ? String.valueOf(obj[NumericConstants.TWELVE]) : ConstantsUtils.EMPTY);
                fmDTO.setBatchId(obj[NumericConstants.THIRTEEN] != null ? String.valueOf(obj[NumericConstants.THIRTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenbatchId(obj[NumericConstants.THIRTEEN] != null ? String.valueOf(obj[NumericConstants.THIRTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setOrganizationKey(obj[NumericConstants.FOURTEEN] != null ? String.valueOf(obj[NumericConstants.FOURTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenOrganisationKey(obj[NumericConstants.FOURTEEN] != null ? String.valueOf(obj[NumericConstants.FOURTEEN]) : ConstantsUtils.EMPTY);
                ...
                fmDTO.setInterfaceFlag(ConstantsUtils.CHAR_N);
                fmDTO.setCheck(false);
                fmDTO.setCompanyName(obj[NumericConstants.SEVENTEEN] != null ? String.valueOf(obj[NumericConstants.SEVENTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setItemName(obj[NumericConstants.EIGHTEEN] != null ? String.valueOf(obj[NumericConstants.EIGHTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setSource(obj[NumericConstants.NINETEEN] != null ? String.valueOf(obj[NumericConstants.NINETEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setForecastName(obj[NumericConstants.TWENTY] != null ? String.valueOf(obj[NumericConstants.TWENTY]) : ConstantsUtils.EMPTY);
                fmDTO.setForecastVersion(obj[NumericConstants.TWENTY_ONE] != null ? String.valueOf(obj[NumericConstants.TWENTY_ONE]) : ConstantsUtils.EMPTY);
                fmDTO.setCountry(obj[NumericConstants.TWENTY_TWO] != null ? String.valueOf(obj[NumericConstants.TWENTY_TWO]) : ConstantsUtils.EMPTY);
                fmDTO.setCreatedBy(obj[NumericConstants.TWENTY_THREE] != null ? (userMap.get(String.valueOf(obj[NumericConstants.TWENTY_THREE])) == null ? "" : userMap.get(String.valueOf(obj[NumericConstants.TWENTY_THREE]))) : ConstantsUtils.EMPTY);
                fmDTO.setCreatedDate(obj[NumericConstants.TWENTY_FOUR] != null ? CommonUtils.convertDateToString((Date) obj[NumericConstants.TWENTY_FOUR]) : ConstantsUtils.EMPTY);
                fmDTO.setModifiedBy(obj[NumericConstants.TWENTY_FIVE] != null ? (userMap.get(String.valueOf(obj[NumericConstants.TWENTY_FIVE])) == null ? "" : userMap.get(String.valueOf(obj[NumericConstants.TWENTY_FIVE]))) : ConstantsUtils.EMPTY);
                fmDTO.setModifiedDate(obj[NumericConstants.TWENTY_SIX] != null ? CommonUtils.convertDateToString((Date) obj[NumericConstants.TWENTY_SIX]) : ConstantsUtils.EMPTY);
                fmDTO.setInboundStatus(obj[NumericConstants.TWENTY_SEVEN] != null ? String.valueOf(obj[NumericConstants.TWENTY_SEVEN]) : ConstantsUtils.EMPTY);
                resultsListDTO.add(fmDTO);
            }
            detailsObj = resultsListDTO;
            ...
            for (Object resultsList1 : resultsList) {
                ...
                fmDTO.setHiddenYear(obj[0] != null ? String.valueOf(obj[0]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenMonth(obj[1] != null ? String.valueOf(obj[1]) : ConstantsUtils.EMPTY);
                fmDTO.setItemId(obj[NumericConstants.TWO] != null ? String.valueOf(obj[NumericConstants.TWO]) : ConstantsUtils.EMPTY);
                fmDTO.setCompanyId(obj[NumericConstants.THREE] != null ? String.valueOf(obj[NumericConstants.THREE]) : ConstantsUtils.EMPTY);
                fmDTO.setUnits(obj[NumericConstants.FOUR] != null ? String.valueOf(obj[NumericConstants.FOUR]) : ConstantsUtils.EMPTY);
                fmDTO.setPriceType(obj[NumericConstants.FIVE] != null ? String.valueOf(obj[NumericConstants.FIVE]) : ConstantsUtils.EMPTY);
                fmDTO.setPrice(obj[NumericConstants.SIX] != null ? String.valueOf(obj[NumericConstants.SIX]) : ConstantsUtils.EMPTY);
                fmDTO.setSalesAmount(obj[NumericConstants.SEVEN] != null ? String.valueOf(obj[NumericConstants.SEVEN]) : ConstantsUtils.EMPTY);
                fmDTO.setSalesInclusion(obj[NumericConstants.EIGHT] != null ? String.valueOf(obj[NumericConstants.EIGHT]) : ConstantsUtils.EMPTY);
                fmDTO.setDeductionId(obj[NumericConstants.NINE] != null ? String.valueOf(obj[NumericConstants.NINE]) : ConstantsUtils.EMPTY);
                fmDTO.setDeductionCategory(obj[NumericConstants.TEN] != null ? String.valueOf(obj[NumericConstants.TEN]) : ConstantsUtils.EMPTY);
                fmDTO.setDeductionType(obj[NumericConstants.ELEVEN] != null ? String.valueOf(obj[NumericConstants.ELEVEN]) : ConstantsUtils.EMPTY);
                fmDTO.setDeductionProgramType(obj[NumericConstants.TWELVE] != null ? String.valueOf(obj[NumericConstants.TWELVE]) : ConstantsUtils.EMPTY);
                fmDTO.setAdjustmentCode(obj[NumericConstants.THIRTEEN] != null ? String.valueOf(obj[NumericConstants.THIRTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setDeductionRate(obj[NumericConstants.FOURTEEN] != null ? String.valueOf(obj[NumericConstants.FOURTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setDeductionAmount(obj[NumericConstants.FIFTEEN] != null ? String.valueOf(obj[NumericConstants.FIFTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setDeductionInclusion(obj[NumericConstants.SIXTEEN] != null ? String.valueOf(obj[NumericConstants.SIXTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setForecastValueType(obj[NumericConstants.SEVENTEEN] != null ? String.valueOf(obj[NumericConstants.SEVENTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setBrandId(obj[NumericConstants.EIGHTEEN] != null ? String.valueOf(obj[NumericConstants.EIGHTEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setSegment(obj[NumericConstants.NINETEEN] != null ? String.valueOf(obj[NumericConstants.NINETEEN]) : ConstantsUtils.EMPTY);
                fmDTO.setBatchId(obj[NumericConstants.TWENTY] != null ? String.valueOf(obj[NumericConstants.TWENTY]) : ConstantsUtils.EMPTY);
                fmDTO.setOrganizationKey(obj[NumericConstants.TWENTY_ONE] != null ? String.valueOf(obj[NumericConstants.TWENTY_ONE]) : ConstantsUtils.EMPTY);
                fmDTO.setHiddenOrganisationKey(obj[NumericConstants.TWENTY_ONE] != null ? String.valueOf(obj[NumericConstants.TWENTY_ONE]) : ConstantsUtils.EMPTY);
                fmDTO.setForecastName(obj[NumericConstants.TWENTY_TWO] != null ? String.valueOf(obj[NumericConstants.TWENTY_TWO]) : ConstantsUtils.EMPTY);
                fmDTO.setForecastVersion(obj[NumericConstants.TWENTY_THREE] != null ? String.valueOf(obj[NumericConstants.TWENTY_THREE]) : ConstantsUtils.EMPTY);
                fmDTO.setCountry(obj[NumericConstants.TWENTY_FOUR] != null ? String.valueOf(obj[NumericConstants.TWENTY_FOUR]) : ConstantsUtils.EMPTY);
                fmDTO.setForecastDate(obj[NumericConstants.TWENTY_FIVE] != null ? String.valueOf(formatter.format(obj[NumericConstants.TWENTY_FIVE])) : ConstantsUtils.EMPTY);
                ...
                fmDTO.setCustomerGtsForecastIntfId(obj[NumericConstants.TWENTY_EIGHT] != null ? Integer.parseInt(String.valueOf(obj[NumericConstants.TWENTY_EIGHT])) : 0);
                fmDTO.setInterfaceFlag(ConstantsUtils.CHAR_N);
                fmDTO.setCheck(false);
                resultsListDTO.add(fmDTO);
            }
    ...
    public Object getForecastDetails(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isRecordLock) {
        ...
        if (detailsResultDTO.getVersion().contains("~")) {
            ...
            sqlString = sqlString.concat(StringConstantUtils.AND_SPACE).concat(" (FM.FORECAST_VER='").concat(versionArray[0]).concat("' or FM.FORECAST_VER='").concat(versionArray[1]).concat("')");
        } else {
            sqlString = sqlString.concat(StringConstantUtils.AND_SPACE).concat(" FM.FORECAST_VER='").concat(detailsResultDTO.getVersion()).concat("'");
        }
        ...
        if (filterSet != null) {
            for (Container.Filter filter : filterSet) {
                if (filter instanceof SimpleStringFilter) {
                    ...
                    filterQuery = filterQuery + StringConstantUtils.AND_SPACE + detailsColumn.get(String.valueOf(stringFilter.getPropertyId())) + StringConstantUtils.LIKE_SPACE + filterString + "'";
        ...
        if (!isCount) {
            if (resulList != null && !resulList.isEmpty()) {
                for (int i = 0; i < resulList.size(); i++) {
                    ...
                    dto.setItemNo(obj[NumericConstants.TWO] != null ? obj[NumericConstants.TWO].toString() : ConstantsUtils.EMPTY);
                    dto.setItemDesc(obj[NumericConstants.THREE] != null ? obj[NumericConstants.THREE].toString() : ConstantsUtils.EMPTY);
                    dto.setItemType(obj[NumericConstants.FOUR] != null && !obj[NumericConstants.FOUR].toString().equals(ConstantsUtils.SELECT_ONE) ? obj[NumericConstants.FOUR].toString() : ConstantsUtils.EMPTY);
                    dto.setItemStatus(obj[NumericConstants.FIVE] != null && !obj[NumericConstants.FIVE].toString().equals(ConstantsUtils.SELECT_ONE) ? obj[NumericConstants.FIVE].toString() : ConstantsUtils.EMPTY);
                    dto.setIdentifier(obj[NumericConstants.SIX] != null ? obj[NumericConstants.SIX].toString() : ConstantsUtils.EMPTY);
                    dto.setIdentifierType(obj[NumericConstants.ELEVEN] != null ? obj[NumericConstants.ELEVEN].toString() : ConstantsUtils.EMPTY);
                    dto.setTherapyClass(obj[NumericConstants.SEVEN] != null && !obj[NumericConstants.SEVEN].toString().equals(ConstantsUtils.SELECT_ONE) ? obj[NumericConstants.SEVEN].toString() : ConstantsUtils.EMPTY);
                    dto.setBrand(obj[NumericConstants.EIGHT] != null && !obj[NumericConstants.EIGHT].toString().equals(ConstantsUtils.SELECT_ONE) ? obj[NumericConstants.EIGHT].toString() : ConstantsUtils.EMPTY);
                    dto.setNdc8(obj[NumericConstants.NINE] != null ? obj[NumericConstants.NINE].toString() : ConstantsUtils.EMPTY);
                    dto.setNdc9(obj[NumericConstants.TEN] != null ? obj[NumericConstants.TEN].toString() : ConstantsUtils.EMPTY);
                    dto.setItemId(obj[NumericConstants.TWELVE] != null ? obj[NumericConstants.TWELVE].toString() : ConstantsUtils.EMPTY);
                    resultList.add(dto);
                }
            }
...
//    Query for filter in table
            ...
            if (filterSet != null) {
                for (Container.Filter filter : filterSet) {
                    if (filter instanceof SimpleStringFilter) {
                        SimpleStringFilter stringFilter = (SimpleStringFilter) filter;
                        String filterString = "%" + stringFilter.getFilterString() + "%";
                        if ((StringConstantUtils.BRAND).equals(stringFilter.getPropertyId()) || "identifierType".equals(stringFilter.getPropertyId())) {
                            if (stringFilter.getFilterString() != null && !"null".equals(stringFilter.getFilterString())) {
                                filterQuery = filterQuery + StringConstantUtils.AND_SPACE + itemColumn.get(String.valueOf(stringFilter.getPropertyId())) + StringConstantUtils.LIKE_SPACE + filterString + "'";
                            }
                        } else {
                            filterQuery = filterQuery + StringConstantUtils.AND_SPACE + itemColumn.get(String.valueOf(stringFilter.getPropertyId())) + StringConstantUtils.LIKE_SPACE + filterString + "'";
                        }
    ...
    public Object getDemandDetailsResults(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isRecordLock) {
        ...
        sqlString = sqlString.concat("'").concat(detailsResultDTO.getFileName()).concat("'");
        sqlString = sqlString.concat(StringConstantUtils.AND_DFCOUNTRY).concat(detailsResultDTO.getCountry()).concat("'");
        if (detailsResultDTO.getVersion().contains("~")) {
            String[] versionArray = detailsResultDTO.getVersion().split("~");
            sqlString = sqlString.concat(StringConstantUtils.AND_SPACE).concat(StringConstantUtils.DFFORECAST_VER_IN + versionArray[0] + "',");
            ...
            sqlString = sqlString.concat(StringConstantUtils.AND_SPACE).concat(StringConstantUtils.DFFORECAST_VER).concat(detailsResultDTO.getVersion()).concat("'");
        }
        String filterQuery = ConstantsUtils.EMPTY;
        HashMap<String, String> detailsColumn = new HashMap<>();
    ...
    public Object getAdjustedDemandDetailsResults(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isRecordLock) {
    ...
    public Object getInventorySummaryResults(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isRecordLock) {
        ...
        sqlString = sqlString.concat("'").concat(detailsResultDTO.getFileName()).concat("'");
        sqlString = sqlString.concat(StringConstantUtils.AND_INWCOUNTRY_LIKE).concat(detailsResultDTO.getCountry()).concat("%'");
        if (detailsResultDTO.getVersion().contains("~")) {
            String[] versionArray = detailsResultDTO.getVersion().split("~");
            int x = 0, y = 0;
            ...
            sqlString = sqlString.concat(StringConstantUtils.AND_SPACE).concat(" INW.FORECAST_VER in  ('" + versionArray[0] + "',");
            String tempversionArray = String.valueOf(versionArray[1].toString()).replace(".", "~").trim();
            String[] InnerArray = tempversionArray.split("~");
            int outerSize = Integer.parseInt(InnerArray[0]);
            int innerSize;
            ...
            sqlString = sqlString.concat(StringConstantUtils.AND_SPACE).concat(StringConstantUtils.INWFORECAST_VER).concat(detailsResultDTO.getVersion()).concat("'");
        }
        String filterQuery = ConstantsUtils.EMPTY;
        String finalQuery;
        HashMap<String, String> detailsColumn = new HashMap<>();
        ...
        detailsColumn.put(StringConstantUtils.ITEM_IDENTIFIER_CODE_QUALIFIER, StringConstantUtils.ITEM_IDENTIFIER_CODE_QUALIFIER_LIST);
    ...
    public Object getInventoryDetailsResults(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount) {
    ...
    public static List getInventoryDemandValidationQuery(final List<String> query) {
        ...
        String sqlString = "SELECT\n"
                ...
                + "    INW.INVENTORY_WD_PROJ_DT_SID\n"
                + "     FROM\n"
                + "    INVENTORY_WD_PROJ_DT INW WHERE INW.SOURCE LIKE '" + query.get(0) + "' AND INW.COUNTRY ='" + query.get(NumericConstants.ONE) + "' AND INW.FORECAST_VER LIKE '" + query.get(NumericConstants.TWO) + "' AND INW.FORECAST_NAME LIKE '" + query.get(NumericConstants.THREE) + "'";
    ...
    public Object getCustomerSalesResults(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount) {
        ...
        if (detailsResultDTO.getDeductionCategory() != null && !StringUtils.isEmpty(detailsResultDTO.getDeductionCategory()) && !SELECT_ONE.equals(detailsResultDTO.getDeductionCategory())) {
            whereQuery = "AND DF.DEDUCTION_CATEGORY like '" + detailsResultDTO.getDeductionCategory().replace("*", "%") + "'";
        }
        if (detailsResultDTO.getDeductionType() != null && !StringUtils.isEmpty(detailsResultDTO.getDeductionType()) && !SELECT_ONE.equals(detailsResultDTO.getDeductionType())) {
            whereQuery = "AND DF.DEDUCTION_TYPE like '" + detailsResultDTO.getDeductionType().replace("*", "%") + "'";
        }
        if (detailsResultDTO.getDeductionProgramType() != null && !StringUtils.isEmpty(detailsResultDTO.getDeductionProgramType()) && !SELECT_ONE.equals(detailsResultDTO.getDeductionProgramType())) {
    ...
    public Object getForecastDetails_Excel(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isRecordLock,boolean isExcelFlag) {
        LOGGER.debug("Entering getForecastDetails ");
        List list;
        String sqlString;
        if (isCount) {
    ...
    public Object getDemandDetailsResults_Excel(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isRecordLock,boolean isExcelFlag) {
        ...
        if (isCount) {
           ...
           sqlString = "SELECT DISTINCT DF.FORECAST_TYPE,DF.FORECAST_YEAR,DF.FORECAST_MONTH,"
                    ...
                    + "DF.UNCAPTURED_UNITS_RATIO,DF.TOTAL_DEMAND_UNITS,DF.TOTAL_DEMAND_AMOUNT,"
                    + "DF.INVENTORY_UNIT_CHANGE,DF.GROSS_UNITS,DF.GROSS_PRICE,"
                    + "DF.GROSS_AMOUNT,DF.NET_SALES_PRICE,DF.NET_SALES_AMOUNT,DF.BATCH_ID,"
                    + "DF.ORGANIZATION_KEY "
                    + "FROM DEMAND_FORECAST DF WHERE DF.FORECAST_NAME =";
  ...
  public Object getAdjustedDemandDetailsResults_Excel(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isRecordLock,boolean isExcelflag) {
...
public Object getInventorySummaryResults_Excel(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isRecordLock,boolean isExcelflag) {
...
public Object getInventoryDetailsResults_Excel(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isExcelflag) throws Exception{
...
public Object getCustomerSalesResults_Excel(FileMananagementResultDTO detailsResultDTO, final int startIndex, final int endIndex, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, boolean isCount,boolean isExcelflag) {
