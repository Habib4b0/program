...
public interface ImtdDeductionDetailsPersistence extends BasePersistence<ImtdDeductionDetails> {
	...
	*/
	public void cacheResult(
		java.util.List<ImtdDeductionDetails> imtdDeductionDetailses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ImtdDeductionDetails> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ImtdDeductionDetails> findAll();
	...
	*/
	public java.util.List<ImtdDeductionDetails> findAll(int start, int end);
	...
	*/
	public java.util.List<ImtdDeductionDetails> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ImtdDeductionDetails> orderByComparator);
