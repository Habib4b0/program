...
public class ItemManagementIndex extends CustomComponent {
    ...
    public ItemManagementIndex(SelectionDTO selection) throws Exception {
    ...
    private void configureSearch() throws Exception {
    ...
    private void loadAllDdlb() throws Exception {
        loadForm();
        loadBrand();
        loadStrength();
        loadItemType();
    ...
    public void searchButtonLogic(Button.ClickEvent event) throws SystemException, PortalException, Exception {
        LOGGER.info("searchButtonLogic starts");
        try {
            ...
            if ((binderDto.getItemId() == null || binderDto.getItemId().isEmpty())
                    ...
                    && (binderDto.getPlaceHolder_DTO() == null || binderDto.getPlaceHolder_DTO().getId() == 11)
        ...
        LOGGER.info("searchButtonLogic ends");
    }
    ...
    public void tableResetButtonLogic(Button.ClickEvent event) throws SystemException, PortalException, Exception {
        new AbstractNotificationUtils() {
            @Override
            public void yesMethod() {
    ...
    @UiHandler("addBtn")
    public void addButtonLogic(Button.ClickEvent event) throws SystemException, PortalException, Exception {
    ...
    public void transferButtonLogic(Button.ClickEvent event) throws SystemException, PortalException, Exception {
        LOGGER.info("Entering Transfer Button");
        if (!selecteditemList.isEmpty()) {
            SelectionDTO selection = createSessionId();
        ...
        LOGGER.info("Ending Transfer Button");
    }

    @UiHandler("editBtn")
    public void editButtonLogic(Button.ClickEvent event) throws SystemException, PortalException, Exception {
        if (!selecteditemList.isEmpty()) {
            SelectionDTO selection = createSessionId();
    ...
    @UiHandler("deleteBtn")
    public void deleteButtonLogic(Button.ClickEvent event) throws SystemException, PortalException, Exception {
        if (!selecteditemList.isEmpty()) {
            SelectionDTO selection = createSessionId();
    ...
    private void loadStrength() throws Exception {
    ...
    private void setSecurityMap() throws Exception {
        if (selection.getButtonMode().equals(ConstantsUtil.ADD)) {
            functionHM = stplSecurity.getBusinessFunctionPermission(userId, SecurityConstants.ITEM_ADD, SecurityConstants.GCM);
        } else if (selection.getButtonMode().equals(ConstantsUtil.EDIT)) {
            functionHM = stplSecurity.getBusinessFunctionPermission(userId, SecurityConstants.ITEM_UPDATE, SecurityConstants.GCM);
        } else if (selection.getButtonMode().equals(ConstantsUtil.DELETE)) {
            functionHM = stplSecurity.getBusinessFunctionPermission(userId, SecurityConstants.ITEM_REMOVE, SecurityConstants.GCM);
        } else if (selection.getButtonMode().equals(ConstantsUtil.TRANSFER)) {
            functionHM = stplSecurity.getBusinessFunctionPermission(userId, SecurityConstants.ITEM_TRANSFER, SecurityConstants.GCM);
        }
    }
    ...
    private void setButtonSecurity() {
        ...
        SecurityLogic.isPermitted(functionHM, "excelBtn", excel);
        SecurityLogic.isPermitted(functionHM, "tableReset", tableReset);
        SecurityLogic.isPermitted(functionHM, "addBtn", addBtn);
        SecurityLogic.isPermitted(functionHM, "editBtn", editBtn);
        SecurityLogic.isPermitted(functionHM, "deleteBtn", deleteBtn);
        SecurityLogic.isPermitted(functionHM, "transferBtn", transferBtn);
