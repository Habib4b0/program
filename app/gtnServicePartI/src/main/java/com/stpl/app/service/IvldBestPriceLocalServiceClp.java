 ...
 * @generated
 */
public class IvldBestPriceLocalServiceClp implements IvldBestPriceLocalService {
    ...
    public IvldBestPriceLocalServiceClp(
    ...
    public com.stpl.app.model.IvldBestPrice addIvldBestPrice(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(ivldBestPrice) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.IvldBestPrice) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.IvldBestPrice createIvldBestPrice(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { ivldBestPriceSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IvldBestPrice deleteIvldBestPrice(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { ivldBestPriceSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IvldBestPrice fetchIvldBestPrice(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { ivldBestPriceSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IvldBestPrice getIvldBestPrice(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { ivldBestPriceSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.IvldBestPrice> getIvldBestPrices(
        ...
        return (java.util.List<com.stpl.app.model.IvldBestPrice>) ClpSerializer.translateOutput(returnObj);
    }
