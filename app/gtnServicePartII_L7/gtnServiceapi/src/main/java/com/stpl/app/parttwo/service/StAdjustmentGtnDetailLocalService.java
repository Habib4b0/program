...
/**
 * Provides the local service interface for StAdjustmentGtnDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StAdjustmentGtnDetailLocalServiceUtil
...
public interface StAdjustmentGtnDetailLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StAdjustmentGtnDetailLocalServiceUtil} to access the st adjustment gtn detail local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.StAdjustmentGtnDetailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public StAdjustmentGtnDetail deleteStAdjustmentGtnDetail(
		java.lang.String workflowId) throws PortalException;
