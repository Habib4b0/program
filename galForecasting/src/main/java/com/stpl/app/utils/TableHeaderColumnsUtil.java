...
public class TableHeaderColumnsUtil {
     ...
     */
    public static final Object[] DATASELECTION_COLUMNS = new Object[]{Constant.PROJECTION_NAME, Constant.DESCRIPTION, "customerHierarchy", "customerHierarchyLevel", "productHierarchy", "productHierarchyLevel", "createdBy", "createdDateSearch", "modifiedDateSearch"};
    /**
     ...
     * Dataselection results visible columns
     */
    public static final Object[] DATASELECTION_COLUMNS_ACCRUAL = new Object[]{Constant.PROJECTION_NAME, Constant.DESCRIPTION,"deductionLevel","deductionValue", "customerHierarchy", "customerHierarchyLevel", "productHierarchy", "productHierarchyLevel", "createdBy", "createdDateSearch", "modifiedDateSearch"};
    /**
     * Dataselection results column headers
     */
    public static final String[] DATASELECTION_HEADERS_ACCRUAL = new String[]{"Projection Name", "Description", "Deduction Level","Deduction Value","Customer Hierarchy", "Customer Level", "Product Hierarchy", "Product Level", "Created By", "Created Date", "Last Modified Date"};
    
        /**
     * Dataselection results visible columns
     */
    public static final Object[] DATASELECTION_COLUMNS_RETURNS = new Object[]{Constant.PROJECTION_NAME, Constant.DESCRIPTION, "productHierarchy", "productHierarchyLevel", "createdBy", "createdDateSearch", "modifiedDateSearch"};
    /**
     * Dataselection results column headers
     */
     ...
     */
    public static final Object[] VIEW_LOOKUP_COLUMNS = new Object[]{"viewName", Constant.DESCRIPTION, "from", "to", "customerHierarchy", "customerLevel", "customerGroup", "company", "brandType", "productHierarchy", "productLevel", "productGroup", "createdDateSearch", "modifiedDateSearch", "createdBy"};

    public static final Object[] VIEW_LOOKUP_COLUMNS_ARP = new Object[]{"viewName", Constant.DESCRIPTION, "from", "to","deductionLevel" ,"deductionValue","customerHierarchy", "customerLevel", "customerGroup", "company", "brandType", "productHierarchy", "productLevel", "productGroup", "createdDateSearch", "modifiedDateSearch", "createdBy"};
   public static final String[] VIEW_LOOKUP_HEADERS_ARP = new String[]{"View Name", "Description", "Time Period: From", "Time Period: To","Deduction Level","Deduction Value", "Customer Hierarchy", "Customer Level", "Customer Group", Constant.COMPANY_SMALL, "Brand Type", "Product Hierarchy", "Product Level", "Product Group", "Created Date", "Modified Date", "Created By"};
    public static final Object[] VIEW_LOOKUP_COLUMNS_RETURNS = new Object[]{"viewName", Constant.DESCRIPTION, "from", "to", "company","productHierarchy", "productLevel", "productGroup", "createdDateSearch", "modifiedDateSearch", "createdBy"};
    /**
     * Column headers for public/private view lookup tables
     */
    public static final String[] VIEW_LOOKUP_HEADERS = new String[]{"View Name", "Description", "Time Period: From", "Time Period: To", "Customer Hierarchy", "Customer Level", "Customer Group", Constant.COMPANY_SMALL, "Brand Type", "Product Hierarchy", "Product Level", "Product Group", "Created Date", "Modified Date", "Created By"};

    public static final String[] VIEW_LOOKUP_HEADERS_RETURNS = new String[]{"View Name", "Description", "Time Period: From", "Time Period: To", Constant.COMPANY_SMALL, "Product Hierarchy", "Product Level", "Product Group", "Created Date", "Modified Date", "Created By"};
    /**
