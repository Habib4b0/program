...
public class VwIvldAdjDemandForeActualCacheModel implements CacheModel<VwIvldAdjDemandForeActual>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof VwIvldAdjDemandForeActualCacheModel)) {
			return false;
		}

		VwIvldAdjDemandForeActualCacheModel vwIvldAdjDemandForeActualCacheModel = (VwIvldAdjDemandForeActualCacheModel)obj;

		if (ivldAdjustedDemandForecastSid == vwIvldAdjDemandForeActualCacheModel.ivldAdjustedDemandForecastSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldAdjustedDemandForecastSid);
	}
