...
public class VwReturnReserveLocalServiceUtil {
    private static VwReturnReserveLocalService _service;
    ...
    */
    ...
    public static VwReturnReserveLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    VwReturnReserveLocalService.class.getName());

            if (invokableLocalService instanceof VwReturnReserveLocalService) {
                _service = (VwReturnReserveLocalService) invokableLocalService;
            } else {
                _service = new VwReturnReserveLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(VwReturnReserveLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(VwReturnReserveLocalService service) {
    }
}
