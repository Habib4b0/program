...
/**
 * The Class FreezeTable.
 *
 * @author Abhiram
 */
public class FreezeTable extends HorizontalSplitPanel {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 1L;
    
    /** The left table. */
    private ExtCustomTable leftTable = new ExtCustomTable();
    
    /** The right table. */
    private ExtCustomTable rightTable = new ExtCustomTable();
    
    /**
     * Instantiates a new freeze table.
     */
    public FreezeTable() {
        super();
        init();
     ...
     */
    public FreezeTable(String caption) {
        super();
        setCaption(caption);
        init();
    }
     ...
     */
    public FreezeTable(String caption, Container newDataSource) {
        super();
        setCaption(caption);
     ...
     */
    public ExtCustomTable getLeftFreezeAsTable(){
        return leftTable;
    }
     ...
     */
    public ExtCustomTable getRightFreezeAsTable(){
        return rightTable;
    }
