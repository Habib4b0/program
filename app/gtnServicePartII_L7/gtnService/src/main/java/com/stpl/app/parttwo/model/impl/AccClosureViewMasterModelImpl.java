 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link AccClosureViewMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AccClosureViewMasterImpl}.
 * </p>
 *
 * @author
...
public class AccClosureViewMasterModelImpl extends BaseModelImpl<AccClosureViewMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ACC_CLOSURE_VIEW_MASTER_SID", Types.INTEGER);
	...
	private static final ClassLoader _classLoader = AccClosureViewMaster.class.getClassLoader();
