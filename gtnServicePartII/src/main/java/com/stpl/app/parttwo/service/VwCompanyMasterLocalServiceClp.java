 ...
 * @generated
 */
public class VwCompanyMasterLocalServiceClp
    ...
    public VwCompanyMasterLocalServiceClp(
    ...
    public com.stpl.app.parttwo.model.VwCompanyMaster addVwCompanyMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(vwCompanyMaster) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.parttwo.model.VwCompanyMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.parttwo.model.VwCompanyMaster createVwCompanyMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { companyMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.parttwo.model.VwCompanyMaster deleteVwCompanyMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { companyMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.parttwo.model.VwCompanyMaster fetchVwCompanyMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { companyMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.parttwo.model.VwCompanyMaster getVwCompanyMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { companyMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.parttwo.model.VwCompanyMaster> getVwCompanyMasters(
        ...
        return (java.util.List<com.stpl.app.parttwo.model.VwCompanyMaster>) ClpSerializer.translateOutput(returnObj);
    }
