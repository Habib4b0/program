...
public class RebatePlanSearchLogic extends BeanItemContainer<RebatePlanMaster> implements RebatePlanLogic {
                                ...
                                if (ConstantsUtils.REBATE_PLAN_TYPE.equals(stringFilter.getPropertyId())) {
                                    ...
                                    if (ConstantsUtils.REBATE_BASED_ON.equals(stringFilter.getPropertyId())) {
                                        ...
                                        if (ConstantsUtils.REBATE_STRUCTURE.equals(stringFilter.getPropertyId())) {
                                            ...
                                            if (ConstantsUtils.REBATE_RANGE_BASED_ON.equals(stringFilter.getPropertyId()) && filterValue != 0) {
     ...
     */
    public DynamicQuery getDynamicQuerySearch(final ErrorfulFieldGroup searchItemForm,final BeanSearchCriteria searchCriteria) {
        LOGGER.debug("Enters getDynamicQuerySearch p1:ErrorfulFieldGroup");
        String rebatePlanId = StringUtils.EMPTY;
        String rebatePlanNo = StringUtils.EMPTY;
        String rebatePlanName = StringUtils.EMPTY;
        ...
        LOGGER.debug("Ends getDynamicQuerySearch with rebatePlanDynamicQuery");
    ...
    public RebatePlanMasterDTO getRebatePlanMasterById(final int idValue)
        ...
        LOGGER.debug("Enters getRebatePlanMasterById p1:id " + idValue);
        ...
        LOGGER.debug("Ends  getRebatePlanMasterById rebatePlanMasterDTO and its rebate plan id -----" + rebatePlanMasterDTO.getRebatePlanId());
    ...
    public String saveRebatePlan(final ErrorfulFieldGroup rebatePlanForm, final BeanItemContainer<RebatePlanTierResults> rebatePlanTiers, final List<NotesDTO> availableUploadedInformation, final String addedNotes,final List<NotesDTO> removedDetailsList
                ,final SessionDTO sessionDTO) throws SystemException, IllegalAccessException, InvocationTargetException, PortalException, ParseException {

        LOGGER.debug("Entering saveRebatePlan");
...
//          Second Tab
            ...
            String nsfSid= ((TextField)rebatePlanForm.getField(ConstantsUtils.NET_SALES_FORMULAID)).getData() != null ? ((TextField)rebatePlanForm.getField(ConstantsUtils.NET_SALES_FORMULAID)).getData().toString() : "0";
            if(!nsfSid.equals("0")){
                rebatePlanMaster.setNetSalesFormulaMasterSid(nsfSid);
            }
            ...
            LOGGER.debug("rebatePlanSystemId = " + rebatePlanSystemId);
//          First Tab
...
//          Second Tab
            ...
            if (count < GeneralCommonUtils.ONE && noCount < GeneralCommonUtils.ONE && nameCount < GeneralCommonUtils.ONE) {
                ...
                LOGGER.debug("Entering getRebatePlanMasterBySystemId -" + rebatePlanMaster.getRebatePlanMasterSid());
     ...
     */
    public int getIntValue(final String value) throws ParseException {
        LOGGER.debug("getIntValue p1:Vlaue = " + value);
        int integerValue = 0;
        ...
        LOGGER.debug("Return integerValue =" + integerValue);
     ...
     */
    public RebatePlanMaster getRebatePlanById(final Integer rebatePlanMasterId) throws SystemException, PortalException {
        RebatePlanMaster master;

        LOGGER.debug("getRebatePlanById method, p1 :rebatePlanMasterId " + rebatePlanMasterId);
    ...
    public List<RebatePlanTierResults> getRebatePlanTiersfromId(
            final int rebatePlanMasterId, final RebatePlanMasterDTO rebatePlanMasterDTO) throws IllegalAccessException, InvocationTargetException, SystemException, PortalException {
        List<RebatePlanTier> results;
        LOGGER.debug("Inside getRebatePlanTiersfromId p1 : rebatePlanMasterId " + rebatePlanMasterId);
        ...
        LOGGER.debug("getRebatePlanTierList p1:rebatePlanTierDynamicQuery ");
        ...
        LOGGER.debug("Ends  getRebatePlanTiersfromId with listr size" + rebatePlanTiers.size());
     ...
     */
    public RebatePlanMaster deleteRebatePlanById(final int systemId,final RebatePlanMasterDTO rebatePlanMasterDTO) throws SystemException, PortalException, IllegalAccessException, InvocationTargetException {
        

        LOGGER.debug("Entering deleteRebatePlanMaster P1: " + systemId);
        ...
        LOGGER.debug("Ending deleteRebatePlanMaster");

        LOGGER.debug("Return RebatePlanMaster");
    ...
    public List<SearchResultsDTO> loadAllActualss(final int startIndex,
            final int endIndex) throws SystemException, PortalException {
        List<SearchResultsDTO> result = null;

        LOGGER.debug("Method getRebatePlanMasterByLimit p1:startIndex ,p2:End index");
     ...
     */
    @SuppressWarnings(ConstantsUtils.UNCHECK)
    public static List<String> getTierFormulaName() throws SystemException, PortalException {
     ...
     */
    @SuppressWarnings(ConstantsUtils.UNCHECK)
    public static List<RebatePlanMasterDTO> getSelectedTierFormulaId() throws SystemException {
        ...
        LOGGER.debug("End of  resultList getSelectedTierFormulaId size  " + resultList.size());
     ...
     */
    public RebatePlanMasterDTO getFormulaById(final int idValue) throws SystemException, PortalException {
        
        final RebatePlanMasterDTO rebatePlanMasterDTO = new RebatePlanMasterDTO();
        final RebatePlanDAO staticDao = new RebatePlanSearchLogicDAOImpl();

        LOGGER.debug("getFormulaById methjod with id =" + idValue);
        ...
        LOGGER.debug("rebatePlanMasterDTO dto  with TierFormulaId  ---- " + rebatePlanMasterDTO.getTierFormulaId());
    ...
    public static long getRecordCount(final RebatePlanSearchLogic rebatePlanLogic, final ErrorfulFieldGroup binder) throws SystemException {
        ...
        LOGGER.debug("return count -" + result);
        return result;
        }
    ...
    public int getItemPriceTypesCount(String filter) throws SystemException {
        ...
        LOGGER.debug("Ending getLazyTierFormulaIdCount method with filterText with count :" + count);
    ...
    @Override
    public String saveRebatePlan(ErrorfulFieldGroup rebatePlanForm, BeanItemContainer<RebatePlanTierResults> rebatePlanTiers) throws SystemException, IllegalAccessException, InvocationTargetException, PortalException, ParseException {
    ...
    public int getRebatePlanResultsCount(
        ...
        if (searchRebatePlanForm.getField(ConstantsUtils.TEXT1).getValue() != null && StringUtils.isNotBlank(String.valueOf(searchRebatePlanForm.getField(ConstantsUtils.TEXT1).getValue()))) {
            rebatePlanId = searchRebatePlanForm.getField(ConstantsUtils.TEXT1)
                    .getValue().toString().trim();
            if (rebatePlanId.contains("%")) {
                rebatePlanId = rebatePlanId.replace("%", "\\%");
                escapeFlag = true;
            }
            rebatePlanId = rebatePlanId.replace(GeneralCommonUtils.CHAR_ASTERISK,
                    GeneralCommonUtils.CHAR_PERCENT);
        ...
        if (searchRebatePlanForm.getField(ConstantsUtils.TEXT2).getValue() != null && StringUtils.isNotBlank(String.valueOf(searchRebatePlanForm.getField(ConstantsUtils.TEXT2).getValue()))) {
            rebatePlanNo = searchRebatePlanForm.getField(ConstantsUtils.TEXT2)
                    .getValue().toString().trim();
            if (rebatePlanNo.contains("%")) {
                rebatePlanNo = rebatePlanNo.replace("%", "\\%");
                escapeFlag = true;
            }
            rebatePlanNo = rebatePlanNo.replace(GeneralCommonUtils.CHAR_ASTERISK,
                    GeneralCommonUtils.CHAR_PERCENT);
        ...
        if (searchRebatePlanForm.getField(ConstantsUtils.TEXT3).getValue() != null && StringUtils.isNotBlank(String.valueOf(searchRebatePlanForm.getField(ConstantsUtils.TEXT3).getValue()))) {
            rebatePlanName = searchRebatePlanForm.getField(ConstantsUtils.TEXT3)
                    .getValue().toString().trim();
            if (rebatePlanName.contains("%")) {
                rebatePlanName = rebatePlanName.replace("%", "\\%");
                escapeFlag = true;
            }
            ...
            for (Container.Filter filter : filterSet) {
                ...
                if (filter instanceof SimpleStringFilter) {
                    ...
                    if (ConstantsUtils.REBATE_PLAN_STATUS.equals(stringFilter.getPropertyId())) {
                        ...
                        if(ConstantsUtils.MODIFIEDBY.equals(stringFilter.getPropertyId()) && !ConstantsUtils.ZERO.equals(stringFilter.getFilterString())){
...
"            RPM.INBOUND_STATUS <> 'D'";
        ...
        if (filterSet != null) {
            for (Container.Filter filter : filterSet) {
                ...
                if (filter instanceof SimpleStringFilter) {
                    ...
                    if (startValue != null) {
                        sql+=ConstantsUtils.AND+(constantProperties.getString(stringFilter.getPropertyId().toString()))+" >= '"+startValue+"' ";
                    } 
                    if (endValue != null) {
                      sql+=ConstantsUtils.AND+(constantProperties.getString(stringFilter.getPropertyId().toString()))+" <= '"+endValue+"' ";
                    ...
                    if (stringFilter.getValue() instanceof Date) {
                      ...
                      sql+=ConstantsUtils.AND+(constantProperties.getString(stringFilter.getPropertyId().toString()))+" >= '"+filterString+"' ";
                       } else {
                      sql+=ConstantsUtils.AND+(constantProperties.getString(stringFilter.getPropertyId().toString()))+" <= '"+filterString+"' ";
                        }
                    }
    ...
    public Map getColumnMap() {
        ...
        map.put(ConstantsUtils.CREATEDDATE_RPM, "RPM.CREATED_DATE");
        map.put(ConstantsUtils.CREATEDBY, "RPM.CREATED_BY");
        map.put(ConstantsUtils.MODIFIEDDATE_RPM, "RPM.MODIFIED_DATE");
    ...
    public List<SearchResultsDTO> getCustomizedSearchFormToDTO(
        ...
        if (list != null) {
            for (int i = 0; i < list.size(); i++) {
                ...
                searchRebatePlanDTO.setRebatePlanName(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.TWO])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.TWO])) ? String.valueOf(object[NumericConstants.TWO]) : StringUtils.EMPTY);
                searchRebatePlanDTO.setRebatePlanStatus(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.THREE])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.THREE])) ? String.valueOf(object[NumericConstants.THREE]) : StringUtils.EMPTY);                
                searchRebatePlanDTO.setRebatePlanType(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.FOUR])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.FOUR])) && !ConstantsUtils.SELECT_ONE.equals(String.valueOf(object[NumericConstants.FOUR])) ? String.valueOf(object[NumericConstants.FOUR]) : StringUtils.EMPTY);                
                searchRebatePlanDTO.setFormulaType(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.FIVE])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.FIVE])) ? String.valueOf(object[NumericConstants.FIVE]) : StringUtils.EMPTY);                
                searchRebatePlanDTO.setRebateBasedOn(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.SIX])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.SIX])) ? String.valueOf(object[NumericConstants.SIX]) : StringUtils.EMPTY);                
                searchRebatePlanDTO.setRebateStructure(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.SEVEN])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.SEVEN])) ? String.valueOf(object[NumericConstants.SEVEN]) : StringUtils.EMPTY);                
                
                searchRebatePlanDTO.setRebateRangeBasedOn(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.EIGHT])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.EIGHT])) ? String.valueOf(object[NumericConstants.EIGHT]) : StringUtils.EMPTY);                
                searchRebatePlanDTO.setSecondaryRebatePlanId(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.NINE])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.NINE])) ? String.valueOf(object[NumericConstants.NINE]) : StringUtils.EMPTY);
                searchRebatePlanDTO.setSecondaryRebatePlanNo(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.TEN])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.TEN])) ? String.valueOf(object[NumericConstants.TEN]) : StringUtils.EMPTY);
                searchRebatePlanDTO.setSecondaryRebatePlanName(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.ELEVEN])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.ELEVEN])) ? String.valueOf(object[NumericConstants.ELEVEN]) : StringUtils.EMPTY);
                
                searchRebatePlanDTO.setBatchId(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.TWELVE])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.TWELVE])) ? String.valueOf(object[NumericConstants.TWELVE]) : StringUtils.EMPTY);
                searchRebatePlanDTO.setRecordLockStatus((Boolean) object[NumericConstants.THIRTEEN]);
                searchRebatePlanDTO.setSystemID(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.FOURTEEN])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.FOURTEEN])) ? String.valueOf(object[NumericConstants.FOURTEEN]) : StringUtils.EMPTY);
                searchRebatePlanDTO.setModifiedBy(userMap.get(Integer.valueOf(String.valueOf(object[NumericConstants.FIFTEEN]))) == null ? StringUtils.EMPTY : userMap.get(Integer.valueOf(String.valueOf(object[NumericConstants.FIFTEEN]))));
                searchRebatePlanDTO.setCreatedBy(userMap.get(Integer.valueOf(String.valueOf(object[NumericConstants.SIXTEEN]))) == null ? StringUtils.EMPTY : userMap.get(Integer.valueOf(String.valueOf(object[NumericConstants.SIXTEEN]))));
                searchRebatePlanDTO.setRebateNsfName(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.SEVENTEEN])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.SEVENTEEN])) ? String.valueOf(object[NumericConstants.SEVENTEEN]) : StringUtils.EMPTY);
                searchRebatePlanDTO.setRebateRuleName(!ConstantsUtils.NULL.equals(String.valueOf(object[NumericConstants.EIGHTEEN])) && StringUtils.isNotBlank(String.valueOf(object[NumericConstants.EIGHTEEN])) ? String.valueOf(object[NumericConstants.EIGHTEEN]) : StringUtils.EMPTY);
                  if (object[NumericConstants.NINETEEN] != null) {
                        Date date = (Date) object[NumericConstants.NINETEEN];
                  ...
                  if (object[NumericConstants.TWENTY] != null) {
                        Date modifyDate = (Date) object[NumericConstants.TWENTY];
