...
DROP CONSTRAINT "UQ_ITEM_IDENTIFIER_ITEM_IDENTIFIER_VALUE_ITEM_QUALIFIER_SID_START_DATE_ITEM_MASTER_SID"
  END
END
GO
...
BEGIN
	IF NOT EXISTS (SELECT 1
               ...
               WHERE  TYPE_DESC = 'UNIQUE_CONSTRAINT'
                      AND PARENT_OBJECT_ID = Object_id('ITEM_IDENTIFIER')
                      AND NAME = 'UQ_ITEM_IDENTIFIER_ITEM_IDENTIFIER_VALUE_ITEM_QUALIFIER_SID_START_DATE_ITEM_MASTER_SID_INBOUND_STATUS')
  BEGIN
      ALTER TABLE ITEM_IDENTIFIER
        ADD CONSTRAINT UQ_ITEM_IDENTIFIER_ITEM_IDENTIFIER_VALUE_ITEM_QUALIFIER_SID_START_DATE_ITEM_MASTER_SID_INBOUND_STATUS UNIQUE(ITEM_IDENTIFIER_VALUE,ITEM_QUALIFIER_SID,START_DATE,ITEM_MASTER_SID,INBOUND_STATUS)
  END
END
GO
