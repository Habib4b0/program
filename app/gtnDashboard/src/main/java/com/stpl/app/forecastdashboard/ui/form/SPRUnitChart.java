...
public class SPRUnitChart {
    ...
    ChartCommonLogic chartlogic = new ChartCommonLogic();
     ...
     */
    public SPRUnitChart(int projId, String projType, List<CommonLevelDto> list, List<String> xasis, ChartType chartType, boolean isStack) {
        System.out.println("chart type at constructor" + chartType);
        this.projId = projId;
...
//        commonLevelDtoList = chartlogic.getResults(projId,freq,projType);
            //  List<CommonLevelDto> commonLevelDtoList = new ArrayList<CommonLevelDto>();
...
//        System.out.println("commonLevelDtoList.get(0).getxAxis() UNITTTTTTTTTTTTTTTTTTTTTTT::::"+xasis.size());
//        for(String value:xasis){
//            System.out.println("xasis:=====================>"+value);
//        }
...
//        }
            ...
            for (Object key : xSet) {
                ...
                listSeries3.addData(Double.valueOf(!"null".equalsIgnoreCase((String) commonLevelDtoList.get(4).getPropertyValue(key)) ? (String) commonLevelDtoList.get(4).getPropertyValue(key) : "0"));
                listSeries4.addData(Double.valueOf(!"null".equalsIgnoreCase((String) commonLevelDtoList.get(5).getPropertyValue(key)) ? (String) commonLevelDtoList.get(5).getPropertyValue(key) : "0"));
        ...
        frquency.addValueChangeListener(new Property.ValueChangeListener() {
            ...
            public void valueChange(Property.ValueChangeEvent event) {
                ...
                if ("Non Mandated".equals(projType)) {
                    commonLevelDtoList = (List<CommonLevelDto>) list.get(1);
                    xasis = (List<String>) list.get(2);
                } else {
                    commonLevelDtoList = (List<CommonLevelDto>) list.get(0);
