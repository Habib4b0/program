...
public class RateExcelDTO extends ExtMapDTO implements Comparator<RateExcelDTO> {
    ...
    public RateExcelDTO(Integer rateConfigDetailsSid, String month, String dateType, String price, String exclusionDetails, String rateBasis, String rateFrequency, String ratePeriod, Integer viewMasterSid) {
    ...
    public RateExcelDTO(Integer rateConfigDetailsSid, String month, String inventoryCustomer, String inventoryCalculation, String price, String reserveDate, String rateBasis, String rateFrequency, String ratePeriod, String inventoryDetails) {
        this.rateConfigDetailsSid = rateConfigDetailsSid;
        this.month = month;
