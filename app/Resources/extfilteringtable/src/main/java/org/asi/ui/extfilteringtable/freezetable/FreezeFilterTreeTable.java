...
/**
 * The Class FreezeFilterTreeTable.
 *
 * @author Abhiram
 */
public class FreezeFilterTreeTable extends HorizontalSplitPanel {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 1L;
    
    /** The left table. */
    private ExtFilterTreeTable leftTable = new ExtFilterTreeTable();
    
    /** The right table. */
    private ExtFilterTreeTable rightTable = new ExtFilterTreeTable();
    ...
    /**
     * Instantiates a new freeze filter tree table.
     */
    public FreezeFilterTreeTable() {
        super();
        init();
    }
     ...
     */
    public FreezeFilterTreeTable(String caption) {
        super();
        setCaption(caption);
        init();
    }
     ...
     */
    public FreezeFilterTreeTable(String caption, Container newDataSource) {
        super();
        setCaption(caption);
    ...
    public void constructLeftFreeze(boolean reConstruct){
        ...
        leftTable = new ExtFilterTreeTable();        
        if(reConstruct){
    ...
    public void constructRightFreeze(boolean reConstruct){
        ...
        rightTable = new ExtFilterTreeTable();
    ...
    private void init(){
        ...
        rightTable.paintTreeRowIcon(false);
        addStyleName("freeze-filter-tree-table");
   ...
   public void setDoubleHeaderVisible(boolean doubleHeaderVisible) {
     ...
     */
    public ExtFilterTreeTable getLeftFreezeAsTable(){
        return leftTable;
    }
     ...
     */
    public ExtFilterTreeTable getRightFreezeAsTable(){
        return rightTable;
    }
