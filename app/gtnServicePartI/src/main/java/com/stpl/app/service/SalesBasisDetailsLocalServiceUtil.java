...
public class SalesBasisDetailsLocalServiceUtil {
    private static SalesBasisDetailsLocalService _service;
    ...
    */
    ...
    public static SalesBasisDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    SalesBasisDetailsLocalService.class.getName());

            if (invokableLocalService instanceof SalesBasisDetailsLocalService) {
                _service = (SalesBasisDetailsLocalService) invokableLocalService;
            } else {
                _service = new SalesBasisDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(SalesBasisDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(SalesBasisDetailsLocalService service) {
    }
}
