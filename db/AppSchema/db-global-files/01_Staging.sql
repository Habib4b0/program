...
IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'STAG_CFP' AND COLUMN_NAME  = 'CFP_ELIGIBILITY_DATE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
----------STAG_COMPANY_PARENT As per ALG-3895------------------
IF NOT EXISTS (
		SELECT 1
		FROM INFORMATION_SCHEMA.COLUMNS
		WHERE TABLE_NAME = 'STAG_COMPANY_PARENT'
...
BEGIN
	ALTER TABLE STAG_COMPANY_PARENT
...
------ADD COLUMN -----
    ...
    IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'STAG_CONTRACT_HEADER' AND COLUMN_NAME  = 'CONTRACT_ELIGIBLE_DATE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
BEGIN
	DROP STATISTICS STAG_PRICE_SCHEDULE.NET_BASE_PRICE
END 
GO
...
IF NOT EXISTS (
		SELECT 1
		FROM INFORMATION_SCHEMA.COLUMNS
		WHERE TABLE_NAME = 'STAG_ITEM_UOM'
			AND COLUMN_NAME = 'STAG_ITEM_UOM_SID'
			AND TABLE_SCHEMA = 'DBO'
		)
BEGIN
	ALTER TABLE STAG_ITEM_UOM ADD STAG_ITEM_UOM_SID INT IDENTITY (
		1
		,1
		) NOT NULL
END
GO
---------PRIMARY KEY CONSTRAINTS FOR STAG_ITEM_UOM----------------------

     IF NOT EXISTS (
		SELECT 1
		FROM SYS.KEY_CONSTRAINTS
		WHERE Object_name(PARENT_OBJECT_ID) = 'STAG_ITEM_UOM'
			AND Schema_name(SCHEMA_ID) = 'DBO'
			AND NAME = 'PK_STAG_ITEM_UOM_STAG_ITEM_UOM_SID'
			AND TYPE = 'PK'
		)
BEGIN
	ALTER TABLE [DBO].STAG_ITEM_UOM ADD CONSTRAINT PK_STAG_ITEM_UOM_STAG_ITEM_UOM_SID PRIMARY KEY (STAG_ITEM_UOM_SID)
END
GO
...
IF NOT EXISTS (
		...
		FROM INFORMATION_SCHEMA.COLUMNS
		WHERE TABLE_NAME = 'STAG_RETURN_RATE_FORECAST'
			AND COLUMN_NAME = 'STAG_RETURN_RATE_FORECAST_SID'
			AND TABLE_SCHEMA = 'DBO'
		)
BEGIN
	ALTER TABLE STAG_RETURN_RATE_FORECAST ADD STAG_RETURN_RATE_FORECAST_SID INT IDENTITY (
		1
		,1
		) NOT NULL
END
...
---------PRIMARY KEY CONSTRAINTS FOR STAG_RETURN_RATE_FORECAST----------------------
     IF NOT EXISTS (
		SELECT 1
		FROM SYS.KEY_CONSTRAINTS
		WHERE Object_name(PARENT_OBJECT_ID) = 'STAG_RETURN_RATE_FORECAST'
			AND Schema_name(SCHEMA_ID) = 'DBO'
			AND NAME = 'PK_STAG_RETURN_RATE_FORECAST_RETURN_RATE_FORECAST_SID'
			AND TYPE = 'PK'
		)
BEGIN
