...
import com.stpl.app.service.ItemGroupLocalService;
...
/**
 * Provides the base implementation for the item group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ItemGroupLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class ItemGroupLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ItemGroupLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ItemGroupLocalServiceUtil} to access the item group local service.
	 */
	...
	public ItemGroup addItemGroup(ItemGroup itemGroup) {
		...
		return itemGroupPersistence.update(itemGroup);
	}
	...
	public ItemGroup createItemGroup(int itemGroupSid) {
		return itemGroupPersistence.create(itemGroupSid);
	}
	...
	public ItemGroup deleteItemGroup(int itemGroupSid)
		...
		return itemGroupPersistence.remove(itemGroupSid);
	}
	...
	public ItemGroup deleteItemGroup(ItemGroup itemGroup) {
		return itemGroupPersistence.remove(itemGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ItemGroup.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return itemGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return itemGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return itemGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ItemGroup fetchItemGroup(int itemGroupSid) {
		return itemGroupPersistence.fetchByPrimaryKey(itemGroupSid);
	}
	...
	public ItemGroup getItemGroup(int itemGroupSid) throws PortalException {
		return itemGroupPersistence.findByPrimaryKey(itemGroupSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(itemGroupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ItemGroup.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("itemGroupSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(itemGroupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ItemGroup.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return itemGroupLocalService.deleteItemGroup((ItemGroup)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return itemGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ItemGroup> getItemGroups(int start, int end) {
		return itemGroupPersistence.findAll(start, end);
	}
	...
	public int getItemGroupsCount() {
		return itemGroupPersistence.countAll();
	}
	 ...
	 */
	public ItemGroupLocalService getItemGroupLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ItemGroup",
			itemGroupLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ItemGroup");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ItemGroupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = itemGroupPersistence.getDataSource();
	...
	@BeanReference(type = ItemGroupLocalService.class)
	protected ItemGroupLocalService itemGroupLocalService;
