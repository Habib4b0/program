...
import com.stpl.app.service.StMedicaidNewNdcLocalService;
...
/**
 * Provides the base implementation for the st medicaid new ndc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.StMedicaidNewNdcLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.StMedicaidNewNdcLocalServiceImpl
 * @see com.stpl.app.service.StMedicaidNewNdcLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StMedicaidNewNdcLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StMedicaidNewNdcLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.StMedicaidNewNdcLocalServiceUtil} to access the st medicaid new ndc local service.
	 */
	...
	@Override
	public StMedicaidNewNdc addStMedicaidNewNdc(
		StMedicaidNewNdc stMedicaidNewNdc) {
		stMedicaidNewNdc.setNew(true);

		return stMedicaidNewNdcPersistence.update(stMedicaidNewNdc);
	}
	 ...
	 */
	@Override
	public StMedicaidNewNdc createStMedicaidNewNdc(
		StMedicaidNewNdcPK stMedicaidNewNdcPK) {
		return stMedicaidNewNdcPersistence.create(stMedicaidNewNdcPK);
	}
	...
	@Override
	public StMedicaidNewNdc deleteStMedicaidNewNdc(
		StMedicaidNewNdcPK stMedicaidNewNdcPK) throws PortalException {
		return stMedicaidNewNdcPersistence.remove(stMedicaidNewNdcPK);
	}
	...
	public StMedicaidNewNdc deleteStMedicaidNewNdc(
		StMedicaidNewNdc stMedicaidNewNdc) {
		return stMedicaidNewNdcPersistence.remove(stMedicaidNewNdc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StMedicaidNewNdc.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stMedicaidNewNdcPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stMedicaidNewNdcPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StMedicaidNewNdc fetchStMedicaidNewNdc(
		StMedicaidNewNdcPK stMedicaidNewNdcPK) {
		return stMedicaidNewNdcPersistence.fetchByPrimaryKey(stMedicaidNewNdcPK);
	}
	 ...
	 */
	@Override
	public StMedicaidNewNdc getStMedicaidNewNdc(
		StMedicaidNewNdcPK stMedicaidNewNdcPK) throws PortalException {
		return stMedicaidNewNdcPersistence.findByPrimaryKey(stMedicaidNewNdcPK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stMedicaidNewNdcLocalService.deleteStMedicaidNewNdc((StMedicaidNewNdc)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stMedicaidNewNdcPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StMedicaidNewNdc> getStMedicaidNewNdcs(int start, int end) {
		return stMedicaidNewNdcPersistence.findAll(start, end);
	}
	...
	public int getStMedicaidNewNdcsCount() {
		return stMedicaidNewNdcPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StMedicaidNewNdc updateStMedicaidNewNdc(
		StMedicaidNewNdc stMedicaidNewNdc) {
		return stMedicaidNewNdcPersistence.update(stMedicaidNewNdc);
	}
	 ...
	 */
	public StMedicaidNewNdcLocalService getStMedicaidNewNdcLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.StMedicaidNewNdc",
			stMedicaidNewNdcLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.StMedicaidNewNdc");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StMedicaidNewNdcLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stMedicaidNewNdcPersistence.getDataSource();
	...
	@BeanReference(type = StMedicaidNewNdcLocalService.class)
	protected StMedicaidNewNdcLocalService stMedicaidNewNdcLocalService;
