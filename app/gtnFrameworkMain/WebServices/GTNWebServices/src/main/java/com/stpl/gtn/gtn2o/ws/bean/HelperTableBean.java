 ...
 * @author
 */
public class HelperTableBean implements Serializable, Comparable<HelperTableBean> {
	 ...
	 * The Constant LOGGER.
	 */
	private static final GtnWSLogger LOGGER = GtnWSLogger.getGTNLogger(HelperTableBean.class);

	/**
	 * Empty Constructor
	 */
	public HelperTableBean() {
		// Empty Constructor
	}
	 ...
	 *            the description
	 */
	public HelperTableBean(final int systemId, final String description) {
	 ...
	 *            the description
	 */
	public HelperTableBean(final String description) {
		this.systemId = 0;
		this.description = description;
	}
	...
	public int hashCode() {
		...
		try {
			...
			LOGGER.error("Error in getting hashcode", e);
		}
		return result;
	}
	...
	public boolean equals(final Object obj) {
		try {
			...
			final HelperTableBean other = (HelperTableBean) obj;
			if (description == null) {
			...
			LOGGER.error("Error in equals", e);
		}
		return true;
	}

	@Override
	public int compareTo(HelperTableBean object) {
