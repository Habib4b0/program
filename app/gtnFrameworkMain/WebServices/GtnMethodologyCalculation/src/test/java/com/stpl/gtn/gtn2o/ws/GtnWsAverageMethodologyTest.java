...
public class GtnWsAverageMethodologyTest {

	@Test
	public void testAverageMethodology() {
	...
	/*
	 * AVERAGE_ will be appended before PROJECTED_RETURN_AMOUNT and
	 * PROJECTED_RPU in the formula properties file.
	 * 
	 * Will be like AVERAGE_PROJECTED_RETURN_AMOUNT and
	 * AVERAGE_PROJECTED_RPU.
	 */
