...
public interface ChSalesProjectionMasterPersistence extends BasePersistence<ChSalesProjectionMaster> {
	...
	*/
	public void cacheResult(
		java.util.List<ChSalesProjectionMaster> chSalesProjectionMasters);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ChSalesProjectionMaster> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ChSalesProjectionMaster> findAll();
	...
	*/
	public java.util.List<ChSalesProjectionMaster> findAll(int start, int end);
	...
	*/
	public java.util.List<ChSalesProjectionMaster> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ChSalesProjectionMaster> orderByComparator);
