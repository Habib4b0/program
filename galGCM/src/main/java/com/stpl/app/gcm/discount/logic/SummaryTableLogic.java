...
public class SummaryTableLogic extends PageTreeTableLogic {
    ...
    public Object configureContainer(Object object, Container datasource) {
        ...
        ((CustomTreeContainer<DiscountDTO>) datasource).addBean(dto);
        if (dto.getParent() == 1) {
            ((CustomTreeContainer<DiscountDTO>) datasource).setChildrenAllowed(dto, true);
        } else {
            ((CustomTreeContainer<DiscountDTO>) datasource).setChildrenAllowed(dto, false);
        }
        return dto;
    }
