...
import com.stpl.app.service.NmPpaProjectionMasterLocalService;
...
/**
 * Provides the base implementation for the nm ppa projection master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.NmPpaProjectionMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class NmPpaProjectionMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NmPpaProjectionMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.NmPpaProjectionMasterLocalServiceUtil} to access the nm ppa projection master local service.
	 */
	...
	@Override
	public NmPpaProjectionMaster addNmPpaProjectionMaster(
		NmPpaProjectionMaster nmPpaProjectionMaster) {
		nmPpaProjectionMaster.setNew(true);

		return nmPpaProjectionMasterPersistence.update(nmPpaProjectionMaster);
	}
	 ...
	 */
	@Override
	public NmPpaProjectionMaster createNmPpaProjectionMaster(
		int projectionDetailsSid) {
		return nmPpaProjectionMasterPersistence.create(projectionDetailsSid);
	}
	...
	@Override
	public NmPpaProjectionMaster deleteNmPpaProjectionMaster(
		int projectionDetailsSid) throws PortalException {
		return nmPpaProjectionMasterPersistence.remove(projectionDetailsSid);
	}
	...
	public NmPpaProjectionMaster deleteNmPpaProjectionMaster(
		NmPpaProjectionMaster nmPpaProjectionMaster) {
		return nmPpaProjectionMasterPersistence.remove(nmPpaProjectionMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NmPpaProjectionMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return nmPpaProjectionMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return nmPpaProjectionMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NmPpaProjectionMaster fetchNmPpaProjectionMaster(
		int projectionDetailsSid) {
		return nmPpaProjectionMasterPersistence.fetchByPrimaryKey(projectionDetailsSid);
	}
	 ...
	 */
	@Override
	public NmPpaProjectionMaster getNmPpaProjectionMaster(
		int projectionDetailsSid) throws PortalException {
		return nmPpaProjectionMasterPersistence.findByPrimaryKey(projectionDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(nmPpaProjectionMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NmPpaProjectionMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(nmPpaProjectionMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NmPpaProjectionMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return nmPpaProjectionMasterLocalService.deleteNmPpaProjectionMaster((NmPpaProjectionMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return nmPpaProjectionMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NmPpaProjectionMaster> getNmPpaProjectionMasters(int start,
		int end) {
		return nmPpaProjectionMasterPersistence.findAll(start, end);
	}
	...
	public int getNmPpaProjectionMastersCount() {
		return nmPpaProjectionMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NmPpaProjectionMaster updateNmPpaProjectionMaster(
		NmPpaProjectionMaster nmPpaProjectionMaster) {
		return nmPpaProjectionMasterPersistence.update(nmPpaProjectionMaster);
	}
	 ...
	 */
	public NmPpaProjectionMasterLocalService getNmPpaProjectionMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.NmPpaProjectionMaster",
			nmPpaProjectionMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return NmPpaProjectionMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = nmPpaProjectionMasterPersistence.getDataSource();
	...
	@BeanReference(type = NmPpaProjectionMasterLocalService.class)
	protected NmPpaProjectionMasterLocalService nmPpaProjectionMasterLocalService;
