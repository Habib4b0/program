...
import com.stpl.app.parttwo.service.CustomerGtsActualLocalService;
...
/**
 * Provides the base implementation for the customer gts actual local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.CustomerGtsActualLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.CustomerGtsActualLocalServiceImpl
 * @see com.stpl.app.parttwo.service.CustomerGtsActualLocalServiceUtil
 * @generated
 */
public abstract class CustomerGtsActualLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements CustomerGtsActualLocalService,
        IdentifiableBean {
    ...
    private CustomerGtsActualLocalServiceClpInvoker _clpInvoker = new CustomerGtsActualLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.CustomerGtsActualLocalServiceUtil} to access the customer gts actual local service.
     */
    ...
    public CustomerGtsActual addCustomerGtsActual(
        CustomerGtsActual customerGtsActual) throws SystemException {
        customerGtsActual.setNew(true);

        return customerGtsActualPersistence.update(customerGtsActual);
    }
    ...
    public CustomerGtsActual createCustomerGtsActual(int customerGtsActualSid) {
        return customerGtsActualPersistence.create(customerGtsActualSid);
    }
    ...
    public CustomerGtsActual deleteCustomerGtsActual(int customerGtsActualSid)
        ...
        return customerGtsActualPersistence.remove(customerGtsActualSid);
    }
    ...
    public CustomerGtsActual deleteCustomerGtsActual(
        CustomerGtsActual customerGtsActual) throws SystemException {
        return customerGtsActualPersistence.remove(customerGtsActual);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CustomerGtsActual.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return customerGtsActualPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return customerGtsActualPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public CustomerGtsActual fetchCustomerGtsActual(int customerGtsActualSid)
        throws SystemException {
        return customerGtsActualPersistence.fetchByPrimaryKey(customerGtsActualSid);
    }
    ...
    public CustomerGtsActual getCustomerGtsActual(int customerGtsActualSid)
        throws PortalException, SystemException {
        return customerGtsActualPersistence.findByPrimaryKey(customerGtsActualSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return customerGtsActualPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public List<CustomerGtsActual> getCustomerGtsActuals(int start, int end)
        throws SystemException {
        return customerGtsActualPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCustomerGtsActualsCount() throws SystemException {
        return customerGtsActualPersistence.countAll();
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.CustomerGtsActual",
            customerGtsActualLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = customerGtsActualPersistence.getDataSource();
