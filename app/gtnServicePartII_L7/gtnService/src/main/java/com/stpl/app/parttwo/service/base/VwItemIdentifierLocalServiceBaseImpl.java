...
import com.stpl.app.parttwo.service.VwItemIdentifierLocalService;
...
/**
 * Provides the base implementation for the vw item identifier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwItemIdentifierLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwItemIdentifierLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwItemIdentifierLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VwItemIdentifierLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VwItemIdentifierLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwItemIdentifierLocalServiceUtil} to access the vw item identifier local service.
	 */
	...
	@Override
	public VwItemIdentifier addVwItemIdentifier(
		VwItemIdentifier vwItemIdentifier) {
		vwItemIdentifier.setNew(true);

		return vwItemIdentifierPersistence.update(vwItemIdentifier);
	}
	 ...
	 */
	@Override
	public VwItemIdentifier createVwItemIdentifier(int itemIdentifierSid) {
		return vwItemIdentifierPersistence.create(itemIdentifierSid);
	}
	...
	@Override
	public VwItemIdentifier deleteVwItemIdentifier(int itemIdentifierSid)
		throws PortalException {
		return vwItemIdentifierPersistence.remove(itemIdentifierSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VwItemIdentifier deleteVwItemIdentifier(
		VwItemIdentifier vwItemIdentifier) {
		return vwItemIdentifierPersistence.remove(vwItemIdentifier);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VwItemIdentifier.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vwItemIdentifierPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vwItemIdentifierPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VwItemIdentifier fetchVwItemIdentifier(int itemIdentifierSid) {
		return vwItemIdentifierPersistence.fetchByPrimaryKey(itemIdentifierSid);
	}
	 ...
	 */
	@Override
	public VwItemIdentifier getVwItemIdentifier(int itemIdentifierSid)
		throws PortalException {
		return vwItemIdentifierPersistence.findByPrimaryKey(itemIdentifierSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vwItemIdentifierLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VwItemIdentifier.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("itemIdentifierSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vwItemIdentifierLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VwItemIdentifier.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vwItemIdentifierLocalService.deleteVwItemIdentifier((VwItemIdentifier)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vwItemIdentifierPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VwItemIdentifier> getVwItemIdentifiers(int start, int end) {
		return vwItemIdentifierPersistence.findAll(start, end);
	}
	...
	public int getVwItemIdentifiersCount() {
		return vwItemIdentifierPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VwItemIdentifier updateVwItemIdentifier(
		VwItemIdentifier vwItemIdentifier) {
		return vwItemIdentifierPersistence.update(vwItemIdentifier);
	}
	 ...
	 */
	public VwItemIdentifierLocalService getVwItemIdentifierLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.VwItemIdentifier",
			vwItemIdentifierLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.VwItemIdentifier");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VwItemIdentifierLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vwItemIdentifierPersistence.getDataSource();
	...
	@BeanReference(type = VwItemIdentifierLocalService.class)
	protected VwItemIdentifierLocalService vwItemIdentifierLocalService;
