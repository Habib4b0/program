...
public class CustomWindowDemo extends VerticalLayout implements View{
    ...
    public void makeWindowStyles(CustomWindow win){
        if(getUI().getTheme().equalsIgnoreCase("customValoTheme")){
            win.removeStyleName("reinder-theme-customwindow");
        win.addStyleName("valo-theme-customwindow");
    }else{
            
            win.removeStyleName("valo-theme-customwindow");
            win.addStyleName("reinder-theme-customwindow");
        }
    }
