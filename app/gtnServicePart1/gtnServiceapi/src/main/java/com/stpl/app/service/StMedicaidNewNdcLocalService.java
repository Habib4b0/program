...
/**
 * Provides the local service interface for StMedicaidNewNdc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StMedicaidNewNdcLocalServiceUtil
...
public interface StMedicaidNewNdcLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StMedicaidNewNdcLocalServiceUtil} to access the st medicaid new ndc local service. Add custom service methods to {@link com.stpl.app.service.impl.StMedicaidNewNdcLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
