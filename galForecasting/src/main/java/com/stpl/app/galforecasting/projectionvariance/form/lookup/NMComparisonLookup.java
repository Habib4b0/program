 ...
 */
package com.stpl.app.galforecasting.projectionvariance.form.lookup;

import com.stpl.app.galforecasting.abstractforecast.ForecastPVComparisonLookup;
import static com.stpl.app.galforecasting.abstractforecast.ForecastPVComparisonLookup.COMPARISON_RESULTS_COLUMNS;
...
public class NMComparisonLookup extends ForecastPVComparisonLookup {
    ...
    protected void searchBtnLogic() {
        ...
        com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO comparisonLookup = new com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO();
        try {
    ...
    protected void addItemsButtonClick(final Button.ClickEvent event) {
        final java.util.Set<com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO> itemMasterDetailsList = (java.util.Set<com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO>) resultsTable.getValue();
        boolean flag = false;
        List<com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO> addedItem = new ArrayList<com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO>();
        if ((itemMasterDetailsList.size()) <= (5 - selectedResultsBean.getItemIds().size())) {
            for (final Iterator<com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO> iterator = itemMasterDetailsList.iterator(); iterator.hasNext();) {
                final com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO item = iterator.next();
                flag = false;
            ...
            for (com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO item : addedItem) {
    ...
    protected void removeItemsButtonClick(final Button.ClickEvent event) {
        ...
        final java.util.Set<com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO> itemMasterDetailsList = (java.util.Set<com.stpl.app.galforecasting.projectionvariance.dto.ComparisonLookupDTO>) projectionTable.getValue();
