...
public abstract class AbstractSearchButtonLayout extends HorizontalLayout {
    ...
    public AbstractSearchButtonLayout(final CustomFieldGroup binder, final LazyBeanItemContainer searchResultbeans, final ExtFilterTable table, final String okLabel, final String resetLabel,
            final String exportButton, final String moduleName) throws SystemException, PortalException, Exception {
        super();
        LOGGER.info("Enters AbstractSearchButtonLayout ");
        this.binder = binder;
        ...
        this.table = table;
        init();
        LOGGER.info("End of AbstractSearchButtonLayout ");
    }
     ...
     */
    private void init() {
        LOGGER.info("Enters init method ");
     ...
     */
    public Map<String, AppPermission> setHashMap(final String moduleName) throws SystemException, PortalException, Exception {

        LOGGER.info("Enters setHashMap method ");
        ...
        if (moduleName.equals(UISecurityUtil.CONTRACT_HEADER)) {
            ...
            LOGGER.info("End of setHashMap method with hashMap size=" + hashMap.size());
            return hashMap;
        }
    ...
    private void searchButton() {
        LOGGER.info("Enters searchButton method ");
        ...
        btnSearch.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                try {
                    LOGGER.info("Enters btnSearch click listener");
                    binder.getFields();
                    binder.commit();

                    searchResultbeans.removeAllItems();
                    LOGGER.info("btnSearchLogic()");
                    btnSearchLogic();
                    LOGGER.info("ends btnSearch click listener");
    ...
    private void resetButton() {
        ...
        btnReset.addClickListener(new ClickListener() {
             ...
             */
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("Enters btnReset buttonClick()");
                ...
                LOGGER.info("Ends of btnReset buttonClick()");
            }
        });
     ...
     */
    protected abstract void btnSearchLogic() throws CommitException, PortalException, SystemException, Exception;
	 ...
	 */
    protected abstract void excelExportLogic() throws SystemException, PortalException, Exception;
}
