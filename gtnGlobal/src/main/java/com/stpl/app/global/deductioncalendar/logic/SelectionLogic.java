...
public class SelectionLogic {
        ...
        if (filterSet != null) {
            for (Container.Filter filter : filterSet) {
                if (filter instanceof SimpleStringFilter) {
                    ...
                    if ("customerType".equals(stringFilter.getPropertyId()) && filterValue != null && !filterValue.equals(ConstantsUtils.NULL)) {
                            try {
                    ...
                    if ("customerStatus".equals(stringFilter.getPropertyId()) && filterValue != null && !filterValue.equals(ConstantsUtils.NULL)) {
                            try {
    ...
    public List<SelectionDTO> getAvailableTableResult(ErrorfulFieldGroup searchItemForm, int start, int end, List<SortByColumn> columns, final Set<Container.Filter> filterSet)/*,  BeanSearchCriteria criteria)*/ throws SystemException, PortalException, ParseException {
    ...
    public int getAvailableTableCount(ErrorfulFieldGroup searchItemForm, List<SortByColumn> columns, final Set<Container.Filter> filterSet)/*, List<OrderByColumn> orderByColumns, BeanSearchCriteria criteria)*/ throws SystemException, PortalException {
        int count = 0;
        StringBuilder queryBuilder = new StringBuilder();
    ...
    public List<SelectionDTO> getSelectedTableResult(SessionDTO sessionDTO, int start, int end, List<SortByColumn> columns, final Set<Container.Filter> filterSet) throws SystemException, PortalException, ParseException {
        List<SelectionDTO> selectionDTO;
        StringBuilder queryBuilder = new StringBuilder();
    ...
    public int getSelectedTableCount(SessionDTO sessionDTO, List<SortByColumn> columns, final Set<Container.Filter> filterSet) throws SystemException, PortalException {
        int count = 0;
        StringBuilder queryBuilder = new StringBuilder();
    ...
    private StringBuilder buildSearchQuery(ErrorfulFieldGroup searchFields, boolean isCount, final int start, final int end, final String itemSystemId, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet, final boolean isSelected) {
        ...
        if (searchFields != null) {
            ...
            for (String fields : keys) {
                ...
                if ("itemDesc".equals(fields) && selectionDTO.getItemDesc() != null && !selectionDTO.getItemDesc().trim().isEmpty() &&!"*".equals(selectionDTO.getItemDesc().trim())) {
    ...
    public List<SelectionDTO> getCustomizedSearchFormFromObject(
            final List list) throws PortalException, SystemException, ParseException {
        ...
        if (list != null) {
            for (int i = 0; i < list.size(); i++) {
                ...
                if (obj[NumericConstants.TWELVE] == null) {
                    ...
                    searchItemForm.setPsUP(FORMATDECIMAL.format(Double.valueOf(HelperUtils.getString(obj[NumericConstants.TEN]))));
                }
                ...
                searchItemForm.setPsNDC8(HelperUtils.getString(obj[NumericConstants.TWENTY_FOUR]));
                searchItemForm.setPsNDC9(HelperUtils.getString(obj[NumericConstants.TWENTY_FIVE]));
    ...
    public List addToTempTable(ErrorfulFieldGroup searchItemForm)/*, List<OrderByColumn> orderByColumns, BeanSearchCriteria criteria)*/ throws SystemException, PortalException {
        StringBuilder queryBuilder = new StringBuilder();
