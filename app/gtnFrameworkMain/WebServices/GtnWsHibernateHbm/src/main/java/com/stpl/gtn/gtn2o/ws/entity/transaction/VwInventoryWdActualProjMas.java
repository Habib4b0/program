...
public class VwInventoryWdActualProjMas implements java.io.Serializable {

	private int inventoryWdActualProjMasSid;
	...
	public int getInventoryWdActualProjMasSid() {
		return inventoryWdActualProjMasSid;
	}

	public void setInventoryWdActualProjMasSid(int inventoryWdActualProjMasSid) {
		this.inventoryWdActualProjMasSid = inventoryWdActualProjMasSid;
	}
