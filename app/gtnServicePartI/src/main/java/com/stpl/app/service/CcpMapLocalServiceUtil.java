...
public class CcpMapLocalServiceUtil {
    private static CcpMapLocalService _service;
    ...
    */
    ...
    public static CcpMapLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    CcpMapLocalService.class.getName());

            if (invokableLocalService instanceof CcpMapLocalService) {
                _service = (CcpMapLocalService) invokableLocalService;
            } else {
                _service = new CcpMapLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(CcpMapLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(CcpMapLocalService service) {
    }
}
