...
/**
 * Provides the local service interface for VwUserTables. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see VwUserTablesLocalServiceUtil
...
public interface VwUserTablesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VwUserTablesLocalServiceUtil} to access the vw user tables local service. Add custom service methods to {@link com.stpl.app.service.impl.VwUserTablesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VwUserTables getVwUserTables(int uniqueId) throws PortalException;
