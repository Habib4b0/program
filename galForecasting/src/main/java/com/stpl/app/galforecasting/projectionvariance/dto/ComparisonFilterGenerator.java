...
public class ComparisonFilterGenerator implements ExtFilterGenerator {
    ...
    public ComparisonFilterGenerator(PVSelectionDTO projectionVarianceSelectionDTO, ProjectionVarianceTableLogic tableLogic, boolean detailFlag) {
    ...
    public AbstractField<?> getCustomFilterComponent(Object propertyId) {
        ...
        if ("relationshipLevelName".equals(propertyId) && pvFlag) {
            ...
            if (detailFlag && !Constant.CUSTOM.equals(pvSelectionDTO.getView())) {
                ...
                List<Leveldto> list = CommonLogic.getAllHierarchyLevels(levelNo, pvSelectionDTO.getProjectionId(), indicator);
