...
--------------------------------------Adroit Removal of interfaces AGN-914----------------------------------------------
  IF EXISTS (
		SELECT 1
		FROM WORKFLOW_PROFILE
...
BEGIN
	DELETE FROM WORKFLOW_PROFILE WHERE PROCESS_NAME = 'CONTRACT_PRGMMKT_INTERFACE'
END
GO
...
BEGIN
	DELETE FROM WORKFLOW_PROFILE WHERE PROCESS_NAME = 'PSTG_CUSTOMER_GTS_FORECAST_INTERFACE'
END
GO
...
BEGIN
	DELETE FROM WORKFLOW_PROFILE WHERE PROCESS_NAME = 'PSTG_CUSTOMER_GTS_ACTUAL_INTERFACE'
END
GO