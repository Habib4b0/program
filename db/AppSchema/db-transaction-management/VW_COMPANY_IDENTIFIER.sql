...
,CI.BATCH_ID
FROM COMPANY_IDENTIFIER CI JOIN COMPANY_MASTER CM ON CM.COMPANY_MASTER_SID=CI.COMPANY_MASTER_SID
JOIN COMPANY_QUALIFIER CQ ON CQ.COMPANY_QUALIFIER_SID=CI.COMPANY_QUALIFIER_SID
LEFT JOIN HELPER_TABLE HT ON HT.HELPER_TABLE_SID=CI.IDENTIFIER_STATUS
