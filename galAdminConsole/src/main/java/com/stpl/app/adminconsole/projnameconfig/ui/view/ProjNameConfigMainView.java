...
public class ProjNameConfigMainView extends VerticalLayout implements View {
     ...
     */
    public ProjNameConfigMainView() throws SystemException, PortalException, Exception {

        super();
        LOGGER.info("ProjNameConfigMainView constructor initiated ");
        nameIndex = new ProjNameConfigIndex();
        setSpacing(true);
        addComponent(nameIndex);
        LOGGER.info("ProjNameConfigMainView constructor ended ");
