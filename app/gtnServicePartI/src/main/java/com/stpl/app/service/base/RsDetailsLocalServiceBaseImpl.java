...
import com.stpl.app.service.RsDetailsLocalService;
...
/**
 * Provides the base implementation for the rs details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.RsDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.RsDetailsLocalServiceImpl
 * @see com.stpl.app.service.RsDetailsLocalServiceUtil
 * @generated
 */
public abstract class RsDetailsLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements RsDetailsLocalService, IdentifiableBean {
    ...
    private RsDetailsLocalServiceClpInvoker _clpInvoker = new RsDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.RsDetailsLocalServiceUtil} to access the rs details local service.
     */
    ...
    @Override
    public RsDetails addRsDetails(RsDetails rsDetails)
        throws SystemException {
        rsDetails.setNew(true);

        return rsDetailsPersistence.update(rsDetails);
    }
     ...
     */
    @Override
    public RsDetails createRsDetails(int rsDetailsSid) {
        return rsDetailsPersistence.create(rsDetailsSid);
    }
    ...
    @Override
    public RsDetails deleteRsDetails(int rsDetailsSid)
        throws PortalException, SystemException {
        return rsDetailsPersistence.remove(rsDetailsSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public RsDetails deleteRsDetails(RsDetails rsDetails)
        throws SystemException {
        return rsDetailsPersistence.remove(rsDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(RsDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return rsDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return rsDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return rsDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public RsDetails fetchRsDetails(int rsDetailsSid) throws SystemException {
        return rsDetailsPersistence.fetchByPrimaryKey(rsDetailsSid);
    }
     ...
     */
    @Override
    public RsDetails getRsDetails(int rsDetailsSid)
        throws PortalException, SystemException {
        return rsDetailsPersistence.findByPrimaryKey(rsDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return rsDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<RsDetails> getRsDetailses(int start, int end)
        throws SystemException {
        return rsDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getRsDetailsesCount() throws SystemException {
        return rsDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public RsDetails updateRsDetails(RsDetails rsDetails)
        throws SystemException {
        return rsDetailsPersistence.update(rsDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.RsDetails",
            rsDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.RsDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = rsDetailsPersistence.getDataSource();
