...
public class RebateTab extends VerticalLayout {
    ...
    private CustomTreeContainer<RebateTabDTO> resultBean = new CustomTreeContainer<RebateTabDTO>(RebateTabDTO.class);
    /**
    ...
    private CustomTreeContainer<RebateTabDTO> excelResultBean = new CustomTreeContainer<RebateTabDTO>(RebateTabDTO.class);
    ...
    public void configureTable() {
        ...
        rightDTO = HeaderUtils.getSalesAndRebateColumns(tableHeader, fullHeader, 4, "Quarterly", false);
        resultBean = new CustomTreeContainer<RebateTabDTO>(RebateTabDTO.class);
    ...
    private void configureExcelResultTable() {
        excelResultBean = new CustomTreeContainer<>(RebateTabDTO.class);
    ...
    private void loadExcelResultTable() {
        ...
        List<RebateTabDTO> resultList = tabLogic.getConfiguredRebateTabResults(new Object(), 0, count, selectionDTO, true);
    ...
    public void addLowerLevelsForExport(Object id) {
        ...
        List<RebateTabDTO> resultList = tabLogic.getConfiguredRebateTabResults(id, 0, count, selectionDTO, true);
