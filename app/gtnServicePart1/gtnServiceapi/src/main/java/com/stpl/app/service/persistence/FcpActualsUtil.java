...
/**
 * The persistence utility for the fcp actuals service. This utility wraps {@link com.stpl.app.service.persistence.impl.FcpActualsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class FcpActualsUtil {
	...
	*/
	public static void cacheResult(FcpActuals fcpActuals) {
	...
	*/
	public static void cacheResult(List<FcpActuals> fcpActualses) {
	...
	*/
	public static FcpActuals create(FcpActualsPK fcpActualsPK) {
	...
	*/
	public static FcpActuals remove(FcpActualsPK fcpActualsPK)
		throws com.stpl.app.exception.NoSuchFcpActualsException {
		return getPersistence().remove(fcpActualsPK);
	}

	public static FcpActuals updateImpl(FcpActuals fcpActuals) {
	...
	* @throws NoSuchFcpActualsException if a fcp actuals with the primary key could not be found
	*/
	public static FcpActuals findByPrimaryKey(FcpActualsPK fcpActualsPK)
		throws com.stpl.app.exception.NoSuchFcpActualsException {
	...
	*/
	public static FcpActuals fetchByPrimaryKey(FcpActualsPK fcpActualsPK) {
		return getPersistence().fetchByPrimaryKey(fcpActualsPK);
	}

	public static java.util.Map<java.io.Serializable, FcpActuals> fetchByPrimaryKeys(
	...
	*/
	public static List<FcpActuals> findAll() {
	...
	*/
	public static List<FcpActuals> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<FcpActualsPersistence, FcpActualsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(FcpActualsPersistence.class);
}