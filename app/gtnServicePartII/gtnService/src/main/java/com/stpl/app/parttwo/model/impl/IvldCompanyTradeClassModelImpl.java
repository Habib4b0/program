 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldCompanyTradeClassModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldCompanyTradeClassImpl}.
 * </p>
 *
 * @author
...
public class IvldCompanyTradeClassModelImpl extends BaseModelImpl<IvldCompanyTradeClass>
	...
	static {
		TABLE_COLUMNS_MAP.put("IVLD_COMPANY_TRADE_CLASS_SID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("PRIOR_TRADE_CLASS_START_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("TRADE_CLASS_END_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("TRADE_CLASS_INTFID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("TRADE_CLASS_START_DATE", Types.VARCHAR);
	...
	private static final ClassLoader _classLoader = IvldCompanyTradeClass.class.getClassLoader();
