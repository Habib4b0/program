...
public class IvldActualMasterCacheModel implements CacheModel<IvldActualMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldActualMasterCacheModel)) {
			return false;
		}

		IvldActualMasterCacheModel ivldActualMasterCacheModel = (IvldActualMasterCacheModel)obj;

		if (ivldActualMasterSid == ivldActualMasterCacheModel.ivldActualMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldActualMasterSid);
	}
