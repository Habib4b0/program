...
public interface UsergroupDomainMasterLocalService extends BaseLocalService,
	...
	*/
	...
	public UsergroupDomainMaster addUsergroupDomainMaster(
	...
	*/
	public UsergroupDomainMaster createUsergroupDomainMaster(
	...
	*/
	...
	public UsergroupDomainMaster deleteUsergroupDomainMaster(
		int usergroupDomainSid) throws PortalException;
	...
	*/
	...
	public UsergroupDomainMaster fetchUsergroupDomainMaster(
		int usergroupDomainSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UsergroupDomainMaster getUsergroupDomainMaster(
		int usergroupDomainSid) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UsergroupDomainMaster> getUsergroupDomainMasters(int start,
		int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public UsergroupDomainMaster updateUsergroupDomainMaster(
		UsergroupDomainMaster usergroupDomainMaster);
}