...
public interface StMSupplementalDiscActualsPersistence extends BasePersistence<StMSupplementalDiscActuals> {
	...
	*/
	public void cacheResult(
		java.util.List<StMSupplementalDiscActuals> stMSupplementalDiscActualses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, StMSupplementalDiscActuals> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<StMSupplementalDiscActuals> findAll();
	...
	*/
	public java.util.List<StMSupplementalDiscActuals> findAll(int start, int end);
	...
	*/
	public java.util.List<StMSupplementalDiscActuals> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<StMSupplementalDiscActuals> orderByComparator);
