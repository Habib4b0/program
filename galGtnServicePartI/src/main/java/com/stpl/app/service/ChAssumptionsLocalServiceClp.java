 ...
 * @generated
 */
public class ChAssumptionsLocalServiceClp implements ChAssumptionsLocalService {
    ...
    public ChAssumptionsLocalServiceClp(
    ...
    public com.stpl.app.model.ChAssumptions addChAssumptions(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(chAssumptions) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ChAssumptions) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ChAssumptions createChAssumptions(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { chAssumptionsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ChAssumptions deleteChAssumptions(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { chAssumptionsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ChAssumptions fetchChAssumptions(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { chAssumptionsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ChAssumptions getChAssumptions(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { chAssumptionsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ChAssumptions> getChAssumptionses(
        ...
        return (java.util.List<com.stpl.app.model.ChAssumptions>) ClpSerializer.translateOutput(returnObj);
    }
