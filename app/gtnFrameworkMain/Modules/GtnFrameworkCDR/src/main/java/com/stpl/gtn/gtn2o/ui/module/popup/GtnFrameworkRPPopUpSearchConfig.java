...
public class GtnFrameworkRPPopUpSearchConfig {
	...
	private void addResultLayout(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		GtnUIFrameworkComponentConfig gtnLayout = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.RESULTLAYOUT, GtnFrameworkCommonConstants.RESULTLAYOUT, true,
	...
	private void addSearchButtonComponent(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		validationActionConfig
				.setFieldValues(Arrays.asList(new String[] { GtnFrameworkCommonConstants.SECONDARY_REBATE_PLAN_NO }));
		...
		loadDataTableActionConfig
				.setFieldValues(Arrays.asList(new String[] { GtnFrameworkCommonConstants.REBATE_PLAN_ID }));
	...
	private void addPagedTableComponent(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		GtnUIFrameworkComponentConfig searchResultConfig = gtnFrameworkConfigurationFactory.buildComponentConfig(
				GtnFrameworkCommonConstants.RP_POP_UP_SEARCH_RESULT_TABLE, "Results", true,
		...
		searchResults.setTableVisibleHeader(new String[] { "Rebate Plan ID", "Rebate Plan No", "Rebate Plan Name",
				...
				"Modified By" });
		searchResults.setTableColumnMappingId(new Object[] { GtnFrameworkCommonConstants.REBATE_PLAN_ID,
				GtnFrameworkCommonConstants.SECONDARY_REBATE_PLAN_NO,
				GtnFrameworkCommonConstants.SECONDARY_REBATE_PLAN_NAME, "rebatePlanStatus", "rpPopUpRebatePlanType",
	...
	private void addSelectButtonComponent(List<GtnUIFrameworkComponentConfig> componentList) {
		...
		closeAction.setActionParameterList(
				Arrays.asList(new Object[] { GtnFrameworkCommonConstants.REBATE_PLAN_POPUP_SEARCH_VIEW }));
