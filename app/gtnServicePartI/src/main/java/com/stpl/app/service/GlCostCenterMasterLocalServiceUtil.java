...
public class GlCostCenterMasterLocalServiceUtil {
    private static GlCostCenterMasterLocalService _service;
    ...
    */
    ...
    public static GlCostCenterMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    GlCostCenterMasterLocalService.class.getName());

            if (invokableLocalService instanceof GlCostCenterMasterLocalService) {
                _service = (GlCostCenterMasterLocalService) invokableLocalService;
            } else {
                _service = new GlCostCenterMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(GlCostCenterMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(GlCostCenterMasterLocalService service) {
    }
}
