...
import com.stpl.app.service.ImtdDeductionDetailsLocalService;
...
/**
 * Provides the base implementation for the imtd deduction details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ImtdDeductionDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ImtdDeductionDetailsLocalServiceImpl
 * @see com.stpl.app.service.ImtdDeductionDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ImtdDeductionDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ImtdDeductionDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ImtdDeductionDetailsLocalServiceUtil} to access the imtd deduction details local service.
	 */
	...
	@Override
	public ImtdDeductionDetails addImtdDeductionDetails(
		ImtdDeductionDetails imtdDeductionDetails) {
		imtdDeductionDetails.setNew(true);

		return imtdDeductionDetailsPersistence.update(imtdDeductionDetails);
	}
	 ...
	 */
	@Override
	public ImtdDeductionDetails createImtdDeductionDetails(
		int imtdDeductionDetailsSid) {
		return imtdDeductionDetailsPersistence.create(imtdDeductionDetailsSid);
	}
	...
	@Override
	public ImtdDeductionDetails deleteImtdDeductionDetails(
		int imtdDeductionDetailsSid) throws PortalException {
		return imtdDeductionDetailsPersistence.remove(imtdDeductionDetailsSid);
	}
	...
	public ImtdDeductionDetails deleteImtdDeductionDetails(
		ImtdDeductionDetails imtdDeductionDetails) {
		return imtdDeductionDetailsPersistence.remove(imtdDeductionDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ImtdDeductionDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return imtdDeductionDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return imtdDeductionDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ImtdDeductionDetails fetchImtdDeductionDetails(
		int imtdDeductionDetailsSid) {
		return imtdDeductionDetailsPersistence.fetchByPrimaryKey(imtdDeductionDetailsSid);
	}
	 ...
	 */
	@Override
	public ImtdDeductionDetails getImtdDeductionDetails(
		int imtdDeductionDetailsSid) throws PortalException {
		return imtdDeductionDetailsPersistence.findByPrimaryKey(imtdDeductionDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(imtdDeductionDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ImtdDeductionDetails.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(imtdDeductionDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ImtdDeductionDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return imtdDeductionDetailsLocalService.deleteImtdDeductionDetails((ImtdDeductionDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return imtdDeductionDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ImtdDeductionDetails> getImtdDeductionDetailses(int start,
		int end) {
		return imtdDeductionDetailsPersistence.findAll(start, end);
	}
	...
	public int getImtdDeductionDetailsesCount() {
		return imtdDeductionDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ImtdDeductionDetails updateImtdDeductionDetails(
		ImtdDeductionDetails imtdDeductionDetails) {
		return imtdDeductionDetailsPersistence.update(imtdDeductionDetails);
	}
	 ...
	 */
	public ImtdDeductionDetailsLocalService getImtdDeductionDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ImtdDeductionDetails",
			imtdDeductionDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ImtdDeductionDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ImtdDeductionDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = imtdDeductionDetailsPersistence.getDataSource();
	...
	@BeanReference(type = ImtdDeductionDetailsLocalService.class)
	protected ImtdDeductionDetailsLocalService imtdDeductionDetailsLocalService;
