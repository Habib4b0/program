...
import com.stpl.app.galforecasting.dto.DiscountProjectionResultsDTO;
...
public class DiscountProjectionResultsLogic {
                        ...
                        for (int j = 0; j < list.size(); j++) {
                            ...
                            if (year == selectedYear && Quarter == selectedQuarter) {
                                ...
                                if (j == list.size() - 1) {
                                    ...
                                    projectedSales = 0;
                                    projectedAmount = 0;
                                    commonColumn = Constant.Q + object[6] + object[0];
    ...
    public String getGroupFilterQuery(int projectionMasterId, String userGroup, int levelNo, int sessionId) {
        String query = "Select Distinct HLD.RELATIONSHIP_LEVEL_VALUES FROM (SELECT RLD.RELATIONSHIP_LEVEL_VALUES, RLD.HIERARCHY_NO,"
    ...
    public String getGroup(int projectionMasterId, int sessionId) {
        String query = "SELECT DISTINCT M.USER_GROUP FROM ST_NM_DISCOUNT_PROJ_MASTER M"
