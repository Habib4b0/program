...
public class MessageUtils {
    ...
    public static final String WFP_START_ERROR = "You dont have permission to create a projection.";
    public static final String WFP_EDIT_ERROR = "You dont have permission to edit a projection.";
    public static final String WFP_SUBMIT_PER_ERROR = "You dont have permission to submit a projection.";
    public static final String WFP_APPROVE_PER_ERROR = "You dont have permission to approve a projection.";
