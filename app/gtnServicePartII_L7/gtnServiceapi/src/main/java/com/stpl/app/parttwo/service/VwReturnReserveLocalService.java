...
/**
 * Provides the local service interface for VwReturnReserve. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see VwReturnReserveLocalServiceUtil
...
public interface VwReturnReserveLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VwReturnReserveLocalServiceUtil} to access the vw return reserve local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.VwReturnReserveLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
