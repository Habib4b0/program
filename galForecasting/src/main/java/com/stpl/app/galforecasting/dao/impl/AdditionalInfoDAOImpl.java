...
import com.stpl.app.galforecasting.dao.AdditionalInfoDAO;
...
public class AdditionalInfoDAOImpl implements AdditionalInfoDAO {
     ...
     */
    @Override
    public List getAttachmentDTOList(final DynamicQuery dynamicQuery) throws SystemException, Exception {
     ...
     */
    @Override
    public void addDocDetails(final DocDetails docDetails) throws SystemException, Exception {
     ...
     */
    @Override
    public void updateDocDetails(final DocDetails docDetails) throws SystemException, Exception {
     ...
     */
    @Override
    public void deleteDocDetails(final int docDetailsId) throws SystemException, PortalException, Exception {
     ...
     */
    @Override
    public void saveNotes(final AdditionalNotes additionalNotesList) throws SystemException, Exception {
     ...
     */
    @Override
    public List getNotes(final DynamicQuery dynamicQuery) throws SystemException, Exception {
