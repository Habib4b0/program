...
public class GcmContractDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<GcmContractDetailsLocalService, GcmContractDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(GcmContractDetailsLocalService.class);
}