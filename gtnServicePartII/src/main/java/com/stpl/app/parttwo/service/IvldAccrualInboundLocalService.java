...
/**
 * Provides the local service interface for IvldAccrualInbound. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldAccrualInboundLocalServiceUtil
...
public interface IvldAccrualInboundLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IvldAccrualInboundLocalServiceUtil} to access the ivld accrual inbound local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.IvldAccrualInboundLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
