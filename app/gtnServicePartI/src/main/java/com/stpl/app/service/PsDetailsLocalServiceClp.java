 ...
 * @generated
 */
public class PsDetailsLocalServiceClp implements PsDetailsLocalService {
    ...
    public PsDetailsLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "getItemAndPricingForPs";

        _methodParameterTypes19 = new String[] { "int" };

        _methodName20 = "findByPriceScheduleMasterDetails";

        _methodParameterTypes20 = new String[] { "int" };

        _methodName21 = "getPsSearchList";
    ...
    public com.stpl.app.model.PsDetails addPsDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(psDetails) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.PsDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.PsDetails createPsDetails(int psDetailsSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { psDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.PsDetails deletePsDetails(int psDetailsSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { psDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.PsDetails fetchPsDetails(int psDetailsSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { psDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.PsDetails getPsDetails(int psDetailsSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { psDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.PsDetails> getPsDetailses(
        ...
        return (java.util.List<com.stpl.app.model.PsDetails>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List getItemAndPricingForPs(int psSystemId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { psSystemId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.PsDetails> findByPriceScheduleMasterDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    _methodParameterTypes20, new Object[] { psModelSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List getPsSearchList(java.lang.String psId,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName21,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(psId),
                        
                    ClpSerializer.translateInput(psNo),
                        
                    ClpSerializer.translateInput(psName),
