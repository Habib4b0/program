...
import com.stpl.app.service.MasterDataFilesLocalService;
...
/**
 * Provides the base implementation for the master data files local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.MasterDataFilesLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.MasterDataFilesLocalServiceImpl
 * @see com.stpl.app.service.MasterDataFilesLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class MasterDataFilesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MasterDataFilesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.MasterDataFilesLocalServiceUtil} to access the master data files local service.
	 */
	...
	@Override
	public MasterDataFiles addMasterDataFiles(MasterDataFiles masterDataFiles) {
		masterDataFiles.setNew(true);

		return masterDataFilesPersistence.update(masterDataFiles);
	}
	 ...
	 */
	@Override
	public MasterDataFiles createMasterDataFiles(int masterDataFilesSid) {
		return masterDataFilesPersistence.create(masterDataFilesSid);
	}
	...
	@Override
	public MasterDataFiles deleteMasterDataFiles(int masterDataFilesSid)
		throws PortalException {
		return masterDataFilesPersistence.remove(masterDataFilesSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterDataFiles deleteMasterDataFiles(
		MasterDataFiles masterDataFiles) {
		return masterDataFilesPersistence.remove(masterDataFiles);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MasterDataFiles.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterDataFilesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterDataFilesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MasterDataFiles fetchMasterDataFiles(int masterDataFilesSid) {
		return masterDataFilesPersistence.fetchByPrimaryKey(masterDataFilesSid);
	}
	 ...
	 */
	@Override
	public MasterDataFiles getMasterDataFiles(int masterDataFilesSid)
		throws PortalException {
		return masterDataFilesPersistence.findByPrimaryKey(masterDataFilesSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterDataFilesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterDataFiles.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("masterDataFilesSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(masterDataFilesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MasterDataFiles.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return masterDataFilesLocalService.deleteMasterDataFiles((MasterDataFiles)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return masterDataFilesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterDataFiles> getMasterDataFileses(int start, int end) {
		return masterDataFilesPersistence.findAll(start, end);
	}
	...
	public int getMasterDataFilesesCount() {
		return masterDataFilesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterDataFiles updateMasterDataFiles(
		MasterDataFiles masterDataFiles) {
		return masterDataFilesPersistence.update(masterDataFiles);
	}
	 ...
	 */
	public MasterDataFilesLocalService getMasterDataFilesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.MasterDataFiles",
			masterDataFilesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.MasterDataFiles");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterDataFilesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterDataFilesPersistence.getDataSource();
	...
	@BeanReference(type = MasterDataFilesLocalService.class)
	protected MasterDataFilesLocalService masterDataFilesLocalService;
