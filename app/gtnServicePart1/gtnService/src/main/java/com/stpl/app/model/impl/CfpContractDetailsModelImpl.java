 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link CfpContractDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CfpContractDetailsImpl}.
 * </p>
 *
 * @author
...
public class CfpContractDetailsModelImpl extends BaseModelImpl<CfpContractDetails>
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.stpl.app.service.util.PropsUtil.get(
			...
			true);
	public static final long CFPCONTRACTSID_COLUMN_BITMASK = 1L;
	public static final long COMPANYMASTERSID_COLUMN_BITMASK = 2L;
	public static final long CFPCONTRACTDETAILSSID_COLUMN_BITMASK = 4L;
	...
	private static final ClassLoader _classLoader = CfpContractDetails.class.getClassLoader();
