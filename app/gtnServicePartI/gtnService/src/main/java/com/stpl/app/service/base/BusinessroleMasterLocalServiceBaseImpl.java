...
import com.stpl.app.service.BusinessroleMasterLocalService;
...
/**
 * Provides the base implementation for the businessrole master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.BusinessroleMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.BusinessroleMasterLocalServiceImpl
 * @see com.stpl.app.service.BusinessroleMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class BusinessroleMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BusinessroleMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.BusinessroleMasterLocalServiceUtil} to access the businessrole master local service.
	 */
	...
	@Override
	public BusinessroleMaster addBusinessroleMaster(
		BusinessroleMaster businessroleMaster) {
		businessroleMaster.setNew(true);

		return businessroleMasterPersistence.update(businessroleMaster);
	}
	 ...
	 */
	@Override
	public BusinessroleMaster createBusinessroleMaster(
		int businessroleMasterSid) {
		return businessroleMasterPersistence.create(businessroleMasterSid);
	}
	...
	@Override
	public BusinessroleMaster deleteBusinessroleMaster(
		int businessroleMasterSid) throws PortalException {
		return businessroleMasterPersistence.remove(businessroleMasterSid);
	}
	...
	public BusinessroleMaster deleteBusinessroleMaster(
		BusinessroleMaster businessroleMaster) {
		return businessroleMasterPersistence.remove(businessroleMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BusinessroleMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return businessroleMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return businessroleMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BusinessroleMaster fetchBusinessroleMaster(int businessroleMasterSid) {
		return businessroleMasterPersistence.fetchByPrimaryKey(businessroleMasterSid);
	}
	 ...
	 */
	@Override
	public BusinessroleMaster getBusinessroleMaster(int businessroleMasterSid)
		throws PortalException {
		return businessroleMasterPersistence.findByPrimaryKey(businessroleMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(businessroleMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BusinessroleMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(businessroleMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BusinessroleMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return businessroleMasterLocalService.deleteBusinessroleMaster((BusinessroleMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return businessroleMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BusinessroleMaster> getBusinessroleMasters(int start, int end) {
		return businessroleMasterPersistence.findAll(start, end);
	}
	...
	public int getBusinessroleMastersCount() {
		return businessroleMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BusinessroleMaster updateBusinessroleMaster(
		BusinessroleMaster businessroleMaster) {
		return businessroleMasterPersistence.update(businessroleMaster);
	}
	 ...
	 */
	public BusinessroleMasterLocalService getBusinessroleMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.BusinessroleMaster",
			businessroleMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BusinessroleMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = businessroleMasterPersistence.getDataSource();
	...
	@BeanReference(type = BusinessroleMasterLocalService.class)
	protected BusinessroleMasterLocalService businessroleMasterLocalService;
