...
public interface StChProjectionDiscountPersistence extends BasePersistence<StChProjectionDiscount> {
	...
	*/
	public void cacheResult(
		java.util.List<StChProjectionDiscount> stChProjectionDiscounts);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, StChProjectionDiscount> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<StChProjectionDiscount> findAll();
	...
	*/
	public java.util.List<StChProjectionDiscount> findAll(int start, int end);
	...
	*/
	public java.util.List<StChProjectionDiscount> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<StChProjectionDiscount> orderByComparator);
