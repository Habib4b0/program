...
import com.stpl.app.service.IvldCpiLocalService;
...
/**
 * Provides the base implementation for the ivld cpi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldCpiLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldCpiLocalServiceImpl
 * @see com.stpl.app.service.IvldCpiLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldCpiLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements IvldCpiLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldCpiLocalServiceUtil} to access the ivld cpi local service.
	 */
	...
	@Override
	public IvldCpi addIvldCpi(IvldCpi ivldCpi) {
		ivldCpi.setNew(true);

		return ivldCpiPersistence.update(ivldCpi);
	}
	 ...
	 */
	@Override
	public IvldCpi createIvldCpi(int ivldCpiSid) {
		return ivldCpiPersistence.create(ivldCpiSid);
	}
	...
	@Override
	public IvldCpi deleteIvldCpi(int ivldCpiSid) throws PortalException {
		return ivldCpiPersistence.remove(ivldCpiSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IvldCpi deleteIvldCpi(IvldCpi ivldCpi) {
		return ivldCpiPersistence.remove(ivldCpi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldCpi.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldCpiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ivldCpiPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return ivldCpiPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldCpiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return ivldCpiPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public IvldCpi fetchIvldCpi(int ivldCpiSid) {
		return ivldCpiPersistence.fetchByPrimaryKey(ivldCpiSid);
	}
	 ...
	 */
	@Override
	public IvldCpi getIvldCpi(int ivldCpiSid) throws PortalException {
		return ivldCpiPersistence.findByPrimaryKey(ivldCpiSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldCpiLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldCpi.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ivldCpiSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldCpiLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldCpi.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("ivldCpiSid");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldCpiLocalService.deleteIvldCpi((IvldCpi)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldCpiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldCpi> getIvldCpis(int start, int end) {
		return ivldCpiPersistence.findAll(start, end);
	}
	...
	public int getIvldCpisCount() {
		return ivldCpiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldCpi updateIvldCpi(IvldCpi ivldCpi) {
		return ivldCpiPersistence.update(ivldCpi);
	}
	 ...
	 */
	public IvldCpiLocalService getIvldCpiLocalService() {
	 ...
	 */
	public void setIvldCpiLocalService(IvldCpiLocalService ivldCpiLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.IvldCpi",
			ivldCpiLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.IvldCpi");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldCpiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldCpiPersistence.getDataSource();
	...
	@BeanReference(type = IvldCpiLocalService.class)
	protected IvldCpiLocalService ivldCpiLocalService;
