...
import com.stpl.app.service.ModuleSubmoduleMasterLocalService;
...
/**
 * Provides the base implementation for the module submodule master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ModuleSubmoduleMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ModuleSubmoduleMasterLocalServiceImpl
 * @see com.stpl.app.service.ModuleSubmoduleMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ModuleSubmoduleMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ModuleSubmoduleMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ModuleSubmoduleMasterLocalServiceUtil} to access the module submodule master local service.
	 */
	...
	@Override
	public ModuleSubmoduleMaster addModuleSubmoduleMaster(
		ModuleSubmoduleMaster moduleSubmoduleMaster) {
		moduleSubmoduleMaster.setNew(true);

		return moduleSubmoduleMasterPersistence.update(moduleSubmoduleMaster);
	}
	 ...
	 */
	@Override
	public ModuleSubmoduleMaster createModuleSubmoduleMaster(
		int moduleSubmoduleSid) {
		return moduleSubmoduleMasterPersistence.create(moduleSubmoduleSid);
	}
	...
	@Override
	public ModuleSubmoduleMaster deleteModuleSubmoduleMaster(
		int moduleSubmoduleSid) throws PortalException {
		return moduleSubmoduleMasterPersistence.remove(moduleSubmoduleSid);
	}
	...
	public ModuleSubmoduleMaster deleteModuleSubmoduleMaster(
		ModuleSubmoduleMaster moduleSubmoduleMaster) {
		return moduleSubmoduleMasterPersistence.remove(moduleSubmoduleMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ModuleSubmoduleMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return moduleSubmoduleMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return moduleSubmoduleMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ModuleSubmoduleMaster fetchModuleSubmoduleMaster(
		int moduleSubmoduleSid) {
		return moduleSubmoduleMasterPersistence.fetchByPrimaryKey(moduleSubmoduleSid);
	}
	...
	public ModuleSubmoduleMaster getModuleSubmoduleMaster(
		int moduleSubmoduleSid) throws PortalException {
		return moduleSubmoduleMasterPersistence.findByPrimaryKey(moduleSubmoduleSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(moduleSubmoduleMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ModuleSubmoduleMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("moduleSubmoduleSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(moduleSubmoduleMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ModuleSubmoduleMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return moduleSubmoduleMasterLocalService.deleteModuleSubmoduleMaster((ModuleSubmoduleMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return moduleSubmoduleMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ModuleSubmoduleMaster> getModuleSubmoduleMasters(int start,
		int end) {
		return moduleSubmoduleMasterPersistence.findAll(start, end);
	}
	...
	public int getModuleSubmoduleMastersCount() {
		return moduleSubmoduleMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ModuleSubmoduleMaster updateModuleSubmoduleMaster(
		ModuleSubmoduleMaster moduleSubmoduleMaster) {
		return moduleSubmoduleMasterPersistence.update(moduleSubmoduleMaster);
	}
	 ...
	 */
	public ModuleSubmoduleMasterLocalService getModuleSubmoduleMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ModuleSubmoduleMaster",
			moduleSubmoduleMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ModuleSubmoduleMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ModuleSubmoduleMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = moduleSubmoduleMasterPersistence.getDataSource();
	...
	@BeanReference(type = ModuleSubmoduleMasterLocalService.class)
	protected ModuleSubmoduleMasterLocalService moduleSubmoduleMasterLocalService;
