...
/**
 * The persistence utility for the cdr details service. This utility wraps {@link CdrDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CdrDetailsUtil {
    private static CdrDetailsPersistence _persistence;
    ...
    */
    public static void cacheResult(com.stpl.app.model.CdrDetails cdrDetails) {
    ...
    */
    public static com.stpl.app.model.CdrDetails create(int cdrDetailsSid) {
    ...
    */
    public static com.stpl.app.model.CdrDetails remove(int cdrDetailsSid)
        throws com.stpl.app.NoSuchCdrDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().remove(cdrDetailsSid);
    }

    public static com.stpl.app.model.CdrDetails updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.CdrDetails findByPrimaryKey(
        int cdrDetailsSid)
        throws com.stpl.app.NoSuchCdrDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.CdrDetails fetchByPrimaryKey(
        int cdrDetailsSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.CdrDetails> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static CdrDetailsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (CdrDetailsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    CdrDetailsPersistence.class.getName());

            ReferenceRegistry.registerReference(CdrDetailsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(CdrDetailsPersistence persistence) {
    }
}
