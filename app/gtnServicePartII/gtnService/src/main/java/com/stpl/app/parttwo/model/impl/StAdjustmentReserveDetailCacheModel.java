...
public class StAdjustmentReserveDetailCacheModel implements CacheModel<StAdjustmentReserveDetail>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof StAdjustmentReserveDetailCacheModel)) {
			return false;
		}

		StAdjustmentReserveDetailCacheModel stAdjustmentReserveDetailCacheModel = (StAdjustmentReserveDetailCacheModel)obj;

		if (workflowId.equals(stAdjustmentReserveDetailCacheModel.workflowId)) {
			return true;
		}
