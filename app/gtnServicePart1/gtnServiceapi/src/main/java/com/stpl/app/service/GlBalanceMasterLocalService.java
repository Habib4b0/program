...
/**
 * Provides the local service interface for GlBalanceMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see GlBalanceMasterLocalServiceUtil
...
public interface GlBalanceMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GlBalanceMasterLocalServiceUtil} to access the gl balance master local service. Add custom service methods to {@link com.stpl.app.service.impl.GlBalanceMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public GlBalanceMaster addGlBalanceMaster(GlBalanceMaster glBalanceMaster);
	...
	*/
	public GlBalanceMaster createGlBalanceMaster(int glBalanceMasterSid);
	...
	*/
	...
	public GlBalanceMaster deleteGlBalanceMaster(
		GlBalanceMaster glBalanceMaster);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public GlBalanceMaster deleteGlBalanceMaster(int glBalanceMasterSid)
	...
	*/
	...
	public GlBalanceMaster fetchGlBalanceMaster(int glBalanceMasterSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GlBalanceMaster getGlBalanceMaster(int glBalanceMasterSid)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GlBalanceMaster> getGlBalanceMasters(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public GlBalanceMaster updateGlBalanceMaster(
		GlBalanceMaster glBalanceMaster);
}