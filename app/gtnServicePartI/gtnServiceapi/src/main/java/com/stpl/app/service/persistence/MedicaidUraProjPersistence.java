...
public interface MedicaidUraProjPersistence extends BasePersistence<MedicaidUraProj> {
	...
	*/
	public void cacheResult(java.util.List<MedicaidUraProj> medicaidUraProjs);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, MedicaidUraProj> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<MedicaidUraProj> findAll();
	...
	*/
	public java.util.List<MedicaidUraProj> findAll(int start, int end);
	...
	*/
	public java.util.List<MedicaidUraProj> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MedicaidUraProj> orderByComparator);
