...
import com.stpl.app.service.NmProjectionSelectionLocalService;
...
/**
 * Provides the base implementation for the nm projection selection local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.NmProjectionSelectionLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.NmProjectionSelectionLocalServiceImpl
 * @see com.stpl.app.service.NmProjectionSelectionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class NmProjectionSelectionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NmProjectionSelectionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.NmProjectionSelectionLocalServiceUtil} to access the nm projection selection local service.
	 */
	...
	@Override
	public NmProjectionSelection addNmProjectionSelection(
		NmProjectionSelection nmProjectionSelection) {
		nmProjectionSelection.setNew(true);

		return nmProjectionSelectionPersistence.update(nmProjectionSelection);
	}
	 ...
	 */
	@Override
	public NmProjectionSelection createNmProjectionSelection(
		int nmProjectionSelectionSid) {
		return nmProjectionSelectionPersistence.create(nmProjectionSelectionSid);
	}
	...
	@Override
	public NmProjectionSelection deleteNmProjectionSelection(
		int nmProjectionSelectionSid) throws PortalException {
		return nmProjectionSelectionPersistence.remove(nmProjectionSelectionSid);
	}
	...
	public NmProjectionSelection deleteNmProjectionSelection(
		NmProjectionSelection nmProjectionSelection) {
		return nmProjectionSelectionPersistence.remove(nmProjectionSelection);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NmProjectionSelection.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return nmProjectionSelectionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return nmProjectionSelectionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NmProjectionSelection fetchNmProjectionSelection(
		int nmProjectionSelectionSid) {
		return nmProjectionSelectionPersistence.fetchByPrimaryKey(nmProjectionSelectionSid);
	}
	 ...
	 */
	@Override
	public NmProjectionSelection getNmProjectionSelection(
		int nmProjectionSelectionSid) throws PortalException {
		return nmProjectionSelectionPersistence.findByPrimaryKey(nmProjectionSelectionSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(nmProjectionSelectionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NmProjectionSelection.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(nmProjectionSelectionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NmProjectionSelection.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return nmProjectionSelectionLocalService.deleteNmProjectionSelection((NmProjectionSelection)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return nmProjectionSelectionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NmProjectionSelection> getNmProjectionSelections(int start,
		int end) {
		return nmProjectionSelectionPersistence.findAll(start, end);
	}
	...
	public int getNmProjectionSelectionsCount() {
		return nmProjectionSelectionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NmProjectionSelection updateNmProjectionSelection(
		NmProjectionSelection nmProjectionSelection) {
		return nmProjectionSelectionPersistence.update(nmProjectionSelection);
	}
	 ...
	 */
	public NmProjectionSelectionLocalService getNmProjectionSelectionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.NmProjectionSelection",
			nmProjectionSelectionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return NmProjectionSelectionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = nmProjectionSelectionPersistence.getDataSource();
	...
	@BeanReference(type = NmProjectionSelectionLocalService.class)
	protected NmProjectionSelectionLocalService nmProjectionSelectionLocalService;
