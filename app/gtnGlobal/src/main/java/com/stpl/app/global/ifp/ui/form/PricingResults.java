...
public final class PricingResults extends CustomComponent {
     ...
     */
    public PricingResults(final BeanItemContainer<ItemPricingDTO> pricingTableBean) throws PortalException, SystemException {
        super();
    ...
    private GridLayout addToGrid() {
        final GridLayout grid = new GridLayout(6, NumericConstants.THREE);
