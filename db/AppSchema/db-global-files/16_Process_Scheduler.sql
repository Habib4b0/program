...
IF EXISTS (
		SELECT 1
		FROM WORKFLOW_PROFILE
		WHERE EMAIL_NOTIFICATION_FAILURE_TO IS NULL OR EMAIL_NOTIFICATION_SUCCESS_TO IS NULL
			AND PROCESS_NAME = 'RETURN_RATE_FORECAST_INTERFACE'
		)
BEGIN
	UPDATE WORKFLOW_PROFILE
	SET EMAIL_NOTIFICATION_FAILURE_TO = 'support@sysbiz.com', EMAIL_NOTIFICATION_SUCCESS_TO='support@sysbiz.com',
	EMAIL_NOTIFICATION_FAILURE_CC='support@sysbiz.com', EMAIL_NOTIFICATION_SUCCESS_CC='support@sysbiz.com'
	WHERE PROCESS_NAME = 'RETURN_RATE_FORECAST_INTERFACE'
END
GO
