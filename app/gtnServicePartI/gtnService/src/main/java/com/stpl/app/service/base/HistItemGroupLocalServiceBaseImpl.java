...
import com.stpl.app.service.HistItemGroupLocalService;
...
/**
 * Provides the base implementation for the hist item group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.HistItemGroupLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.HistItemGroupLocalServiceImpl
 * @see com.stpl.app.service.HistItemGroupLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class HistItemGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements HistItemGroupLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.HistItemGroupLocalServiceUtil} to access the hist item group local service.
	 */
	...
	@Override
	public HistItemGroup addHistItemGroup(HistItemGroup histItemGroup) {
		histItemGroup.setNew(true);

		return histItemGroupPersistence.update(histItemGroup);
	}
	 ...
	 */
	@Override
	public HistItemGroup createHistItemGroup(HistItemGroupPK histItemGroupPK) {
		return histItemGroupPersistence.create(histItemGroupPK);
	}
	...
	@Override
	public HistItemGroup deleteHistItemGroup(HistItemGroupPK histItemGroupPK)
		throws PortalException {
		return histItemGroupPersistence.remove(histItemGroupPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public HistItemGroup deleteHistItemGroup(HistItemGroup histItemGroup) {
		return histItemGroupPersistence.remove(histItemGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(HistItemGroup.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return histItemGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return histItemGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public HistItemGroup fetchHistItemGroup(HistItemGroupPK histItemGroupPK) {
		return histItemGroupPersistence.fetchByPrimaryKey(histItemGroupPK);
	}
	 ...
	 */
	@Override
	public HistItemGroup getHistItemGroup(HistItemGroupPK histItemGroupPK)
		throws PortalException {
		return histItemGroupPersistence.findByPrimaryKey(histItemGroupPK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return histItemGroupLocalService.deleteHistItemGroup((HistItemGroup)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return histItemGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HistItemGroup> getHistItemGroups(int start, int end) {
		return histItemGroupPersistence.findAll(start, end);
	}
	...
	public int getHistItemGroupsCount() {
		return histItemGroupPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HistItemGroup updateHistItemGroup(HistItemGroup histItemGroup) {
		return histItemGroupPersistence.update(histItemGroup);
	}
	 ...
	 */
	public HistItemGroupLocalService getHistItemGroupLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.HistItemGroup",
			histItemGroupLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HistItemGroupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = histItemGroupPersistence.getDataSource();
	...
	@BeanReference(type = HistItemGroupLocalService.class)
	protected HistItemGroupLocalService histItemGroupLocalService;
