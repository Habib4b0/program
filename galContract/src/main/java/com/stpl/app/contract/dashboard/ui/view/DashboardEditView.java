...
public class DashboardEditView extends VerticalLayout implements View {
     ...
     */
    public DashboardEditView(final SessionDTO sessionDTO) throws SystemException, PortalException, Exception {
        super();
        LOGGER.info("Entering DashboardEditView ");
        addStyleName("bootstrap");
        addStyleName("bootstrap-bb");
        this.sessionDTO = sessionDTO;
        dashBoardLogic = new DashBoardLogic(this.sessionDTO);
        LOGGER.info("End of DashboardEditView ");
    }
    ...
    public void enter(final ViewChangeEvent event) {
        try {
            LOGGER.info("Entering  DashboardEditView enter method");
            ...
            pricingBinderEdit.getField("priceScheduleNo").setReadOnly(true);
            pricingBinderEdit.getField("priceScheduleName").setReadOnly(true);
            ...
            rebateBinder.getField("rebateScheduleNo").setReadOnly(true);
            rebateBinder.getField("rebateScheduleName").setReadOnly(true);
            contractMasterBinderEdit.getField("contractId").setReadOnly(true);
            contractMasterBinderEdit.getField(Constants.CONTRACT_NO).setReadOnly(true);
            contractMasterBinderEdit.getField("contractName").setReadOnly(true);
            contractMasterBinderEdit.getField("internalNotes").setReadOnly(true);
            ...
            LOGGER.info("End of DashboardEditView enter method");
