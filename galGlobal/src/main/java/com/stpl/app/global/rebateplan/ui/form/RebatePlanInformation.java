...
public class RebatePlanInformation extends CustomComponent {
     ...
     * @throws Exception 
     */
    public RebatePlanInformation(final ErrorfulFieldGroup binder, final RebatePlanMasterDTO rebatePlanMasterDTO, final SessionDTO sessionDTO) throws PortalException, SystemException, Exception {
