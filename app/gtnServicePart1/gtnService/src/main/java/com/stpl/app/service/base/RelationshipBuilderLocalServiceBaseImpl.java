...
import com.stpl.app.service.RelationshipBuilderLocalService;
...
/**
 * Provides the base implementation for the relationship builder local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.RelationshipBuilderLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class RelationshipBuilderLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RelationshipBuilderLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.RelationshipBuilderLocalServiceUtil} to access the relationship builder local service.
	 */
	...
	public RelationshipBuilder addRelationshipBuilder(
		...
		return relationshipBuilderPersistence.update(relationshipBuilder);
	}
	...
	public RelationshipBuilder createRelationshipBuilder(
		...
		return relationshipBuilderPersistence.create(relationshipBuilderSid);
	}
	...
	public RelationshipBuilder deleteRelationshipBuilder(
		...
		return relationshipBuilderPersistence.remove(relationshipBuilderSid);
	}
	...
	public RelationshipBuilder deleteRelationshipBuilder(
		RelationshipBuilder relationshipBuilder) {
		return relationshipBuilderPersistence.remove(relationshipBuilder);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RelationshipBuilder.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return relationshipBuilderPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return relationshipBuilderPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public RelationshipBuilder fetchRelationshipBuilder(
		int relationshipBuilderSid) {
		return relationshipBuilderPersistence.fetchByPrimaryKey(relationshipBuilderSid);
	}
	...
	public RelationshipBuilder getRelationshipBuilder(
		int relationshipBuilderSid) throws PortalException {
		return relationshipBuilderPersistence.findByPrimaryKey(relationshipBuilderSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(relationshipBuilderLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RelationshipBuilder.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(relationshipBuilderLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RelationshipBuilder.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return relationshipBuilderLocalService.deleteRelationshipBuilder((RelationshipBuilder)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return relationshipBuilderPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<RelationshipBuilder> getRelationshipBuilders(int start, int end) {
		return relationshipBuilderPersistence.findAll(start, end);
	}
	...
	public int getRelationshipBuildersCount() {
		return relationshipBuilderPersistence.countAll();
	}
	 ...
	 */
	public RelationshipBuilderLocalService getRelationshipBuilderLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.RelationshipBuilder",
			relationshipBuilderLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RelationshipBuilderLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = relationshipBuilderPersistence.getDataSource();
	...
	@BeanReference(type = RelationshipBuilderLocalService.class)
	protected RelationshipBuilderLocalService relationshipBuilderLocalService;
