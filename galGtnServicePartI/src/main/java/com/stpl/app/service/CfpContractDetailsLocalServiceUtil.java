...
/**
 * Provides the local service utility for CfpContractDetails. This utility wraps
 * {@link com.stpl.app.service.impl.CfpContractDetailsLocalServiceImpl} and is the
 ...
 * @generated
 */
public class CfpContractDetailsLocalServiceUtil {
    private static CfpContractDetailsLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.stpl.app.service.impl.CfpContractDetailsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.stpl.app.model.CfpContractDetails addCfpContractDetails(
        com.stpl.app.model.CfpContractDetails cfpContractDetails)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().addCfpContractDetails(cfpContractDetails);
    }
    ...
    */
    public static com.stpl.app.model.CfpContractDetails createCfpContractDetails(
        int cfpContractDetailsSid) {
        return getService().createCfpContractDetails(cfpContractDetailsSid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.CfpContractDetails deleteCfpContractDetails(
        int cfpContractDetailsSid)
        throws com.stpl.portal.kernel.exception.PortalException,
            com.stpl.portal.kernel.exception.SystemException {
        return getService().deleteCfpContractDetails(cfpContractDetailsSid);
    }
    ...
    */
    public static com.stpl.app.model.CfpContractDetails deleteCfpContractDetails(
        com.stpl.app.model.CfpContractDetails cfpContractDetails)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().deleteCfpContractDetails(cfpContractDetails);
    }
    ...
    */
    ...
    public static com.stpl.app.model.CfpContractDetails fetchCfpContractDetails(
        int cfpContractDetailsSid)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().fetchCfpContractDetails(cfpContractDetailsSid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.CfpContractDetails getCfpContractDetails(
        int cfpContractDetailsSid)
        throws com.stpl.portal.kernel.exception.PortalException,
            com.stpl.portal.kernel.exception.SystemException {
        return getService().getCfpContractDetails(cfpContractDetailsSid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.CfpContractDetails> getCfpContractDetailses(
        int start, int end)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().getCfpContractDetailses(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getCfpContractDetailsesCount()
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().getCfpContractDetailsesCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.CfpContractDetails updateCfpContractDetails(
        com.stpl.app.model.CfpContractDetails cfpContractDetails)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().updateCfpContractDetails(cfpContractDetails);
    }
    ...
    */
    ...
    public static java.lang.Boolean saveCfpDetailsAttached(
        ...
        return getService().saveCfpDetailsAttached(input, future);
    }
    ...
    public static CfpContractDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    CfpContractDetailsLocalService.class.getName());

            if (invokableLocalService instanceof CfpContractDetailsLocalService) {
                _service = (CfpContractDetailsLocalService) invokableLocalService;
            } else {
                _service = new CfpContractDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(CfpContractDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(CfpContractDetailsLocalService service) {
    }
}
