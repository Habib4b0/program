...
public class PromoteTpToChEdit extends VerticalLayout {
     ...
     * @throws Exception
     */
    public PromoteTpToChEdit(final SessionDTO session, final PromoteTpToChDto promoteTpToChDto, final PromoteTpToChWindow editWindow, final ExtFilterTable resultTable) throws Exception {
