		...
		if (mode == GtnUIFrameworkModeType.EDIT || mode == GtnUIFrameworkModeType.ADD) {
			...
			case "Rebate Plan":
				...
				visibleColumnList = Arrays.asList(checkRecordId, GtnFrameworkCommonConstants.ITEM_NO,
						...
						GtnFrameworkRSConstants.RS_BUNDLE_NO, GtnFrameworkRSConstants.REBATE_PLAN_NO1, GtnFrameworkRSConstants.REBATE_PLAN_NAME,
				...
				fieldFactoryColumnList = Arrays.asList(GtnFrameworkCommonConstants.CHECK_RECORD_ID,
						...
						GtnFrameworkRSConstants.REBATE_PLAN_NO1, GtnFrameworkRSConstants.REBATE_PLAN_NAME,GtnFrameworkCommonConstants.NET_SALES_FORMULA_NAME,
