...
public class GtnFrameworkCustomerAndProductGroupLookup {
	...
	public void getForecastCustomerHierarchyComponentForPopUp(List<GtnUIFrameworkComponentConfig> componentList,
		...
		forecastCustomerProductGroupGtnLayout.setComponentId(namespace + "_" + GtnFrameworkCommonConstants.ROOT_VERTICAL_LAYOUT);
		forecastCustomerProductGroupGtnLayout.setParentComponentId(
				namespace + "_" + "forecastCustomerProductGroupConfig");
	...
	private void forecastCustomerProductGroupSearchCriteriaPanel(List<GtnUIFrameworkComponentConfig> componentList,
		...
		forecastCustomerProductGroupSearchCriteriaPanel.setComponentId(namespace
				+ GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerProductGroupSearchCriteriaPanel");
	...
	private void forecastCustomerProductGroupSearchCriteriaLayout(List<GtnUIFrameworkComponentConfig> componentList,
		...
		forecastCustomerProductGroupSearchCriteriaLayout.setParentComponentId(namespace
				+ GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerProductGroupSearchCriteriaPanel");
		GtnUIFrameworkLayoutConfig forecastCustomerHierarchySearchCriteriaConfig = new GtnUIFrameworkLayoutConfig();
		forecastCustomerProductGroupSearchCriteriaLayout.setGtnLayoutConfig(forecastCustomerHierarchySearchCriteriaConfig);
		forecastCustomerProductGroupSearchCriteriaLayout.addComponentStyle(GtnFrameworkCssConstants.POPUP_TEXTBOX_STYLE);
	...
	private void addForecastCustomerProductGroupNameTextBox(List<GtnUIFrameworkComponentConfig> componentList,
		...
		forecastCustomerProductGroupNameTextBox.setComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + GtnFrameworkForecastingStringConstants.FORECAST_CUSTOMER_PRODUCT_GROUP_NAME_TEXTBOX);
		...
		forecastCustomerProductGroupNameTextBox.setParentComponentId(namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE
				+ GtnFrameworkForecastingStringConstants.FORECAST_CUSTOMER_PRODUCT_GROUP_SEARCH_CRITERIA_LAYOUT);
		
		GtnUIFrameworkValidationConfig forecastProductGroupNameValidationConfig = new GtnUIFrameworkValidationConfig();
		forecastProductGroupNameValidationConfig.setConditionList(Arrays.asList(GtnUIFrameworkConditionalValidationType.NOT_EMPTY));
		forecastCustomerProductGroupNameTextBox.setGtnUIFrameworkValidationConfig(forecastProductGroupNameValidationConfig);
	...
	private void addForecastCustomerProductGroupNoTextBox(List<GtnUIFrameworkComponentConfig> componentList,
		...
		forecastCustomerProductGroupNoTextBox.setComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + GtnFrameworkForecastingStringConstants.FORECAST_CUSTOMER_PRODUCT_GROUP_NO_TEXTBOX);
		...
		forecastCustomerProductGroupNoTextBox.setParentComponentId(namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE
				+ GtnFrameworkForecastingStringConstants.FORECAST_CUSTOMER_PRODUCT_GROUP_SEARCH_CRITERIA_LAYOUT);
		
		GtnUIFrameworkValidationConfig forecastProductGroupNoValidationConfig = new GtnUIFrameworkValidationConfig();
		forecastProductGroupNoValidationConfig.setConditionList(Arrays.asList(GtnUIFrameworkConditionalValidationType.NOT_EMPTY));
	...
	private void forecastCustomerProductGroupSearchAndResetButtonLayout(List<GtnUIFrameworkComponentConfig> componentList,
			String namespace) {
		...
		forecastCustomerProductGroupSearchAndResetLayout.setGtnLayoutConfig(forecastCustomerHierarchySearchAndResetConfig);
		...
		forecastCustomerProductGroupSearchButton.setComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerProductGroupSearchButton");
		...
		forecastCustomerProductGroupSearchButton.setGtnUIFrameWorkActionConfigList(customerAndProductGroupActionConfigList);
		...
		forecastCustomerProductGroupResetButton.setComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerProductGroupResetButton");
		forecastCustomerProductGroupResetButton.setComponentName("RESET");
		forecastCustomerProductGroupResetButton.setParentComponentId(namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE
				+ GtnFrameworkForecastingStringConstants.FORECAST_CUSTOMER_PRODUCT_GROUP_SEARCH_AND_RESULT_LAYOUT);
		...
		forecastCustomerProductGroupResetButton.setGtnUIFrameWorkActionConfigList(customerAndProductGroupResetActionConfigList);
	...
	private void forecastCustomerProductGroupResultsPanel(List<GtnUIFrameworkComponentConfig> componentList,
		...
		forecastCustomerProductGroupResultsPanel.setComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerProductGroupResultsPanel");
	...
	private void forecastCustomerProductGroupResultLayout(List<GtnUIFrameworkComponentConfig> componentList,
		...
		forecastCustomerProductGroupResultConfig.setComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerProductGroupResultConfig");

		forecastCustomerProductGroupResultConfig.setParentComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerProductGroupResultsPanel");
	...
	private void addCustomerProductGroupPagedTableComponent(List<GtnUIFrameworkComponentConfig> componentList,
		...
		customerProductGroupPagedTableComponent.setComponentId(namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE
				+ GtnFrameworkForecastingStringConstants.CUSTOMER_AND_PRODUCT_GROUP_SEARCH_RESULT_TABLE);
		customerProductGroupPagedTableComponent.setComponentName("Results");
		customerProductGroupPagedTableComponent.setParentComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerProductGroupResultConfig");
		...
		customerProductGroupPagedTableConfig.setTableColumnDataType(
				namespace.contains("Customer") ? GtnFrameworkForecastingStringConstants.getForecastCustomerGroupTableColumnsDataType()
						: GtnFrameworkForecastingStringConstants.getForecastProductGroupTableColumnsDataType());
		customerProductGroupPagedTableConfig.setColumnHeaders(Arrays.asList(
				namespace.contains("Customer") ? GtnFrameworkForecastingStringConstants.getForecastCustomerGroupTableColumnsVisibleHeader():GtnFrameworkForecastingStringConstants.getForecastProductGroupTableColumnsVisibleHeader()));
		customerProductGroupPagedTableConfig.setTableColumnMappingId(
				namespace.contains("Customer") ? GtnFrameworkForecastingStringConstants.getForecastCustomerGroupTableColumnsMappingId():GtnFrameworkForecastingStringConstants.getForecastProductGroupTableColumnsMappingId());
		...
		customerProductGroupPagedTableConfig.setCountUrl(GtnFrameworkForecastNewArchitectureConstants.CUSTOMER_AND_PRODUCT_GROUP_RESULTS_SERVICE_REGISTRY_URL);
		customerProductGroupPagedTableConfig.setResultSetUrl(GtnFrameworkForecastNewArchitectureConstants.CUSTOMER_AND_PRODUCT_GROUP_RESULTS_SERVICE_REGISTRY_URL);
		customerProductGroupPagedTableConfig.setPagedTableWsUrl(GtnFrameworkForecastNewArchitectureConstants.CUSTOMER_AND_PRODUCT_GROUP_RESULTS_URL);
		customerProductGroupPagedTableConfig.setRegisteredWebContext(GtnFrameworkForecastNewArchitectureConstants.CUSTOMER_AND_PRODUCT_GROUP_RESULTS_REGISTERED_WEB_CONTEXT);
		customerProductGroupPagedTableConfig.setModuleName(GtnFrameworkForecastNewArchitectureConstants.CUSTOMER_AND_PRODUCT_GROUP_RESULTS_END_POINT_URL_NAME);
	...
	private void forecastCustomerProductGroupControlPopUpButtonLayout(List<GtnUIFrameworkComponentConfig> componentList,
		...
		forecastCustomerProductGroupSelectButton.setComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerProductGroupSelectButton");
...
//		forecastCustomerHierarchySelectButton.addDependentComponent("Commercial_Forecasting_customerSelectionRelationship");
		...
		forecastCustomerProductGroupCancelButton.setComponentId(
				namespace + GtnFrameworkForecastingStringConstants.UNDERSCORE + "forecastCustomerHierarchyCancelButton");
