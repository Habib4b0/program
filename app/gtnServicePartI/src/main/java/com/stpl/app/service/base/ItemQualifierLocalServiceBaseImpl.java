...
import com.stpl.app.service.ItemQualifierLocalService;
...
/**
 * Provides the base implementation for the item qualifier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ItemQualifierLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class ItemQualifierLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ItemQualifierLocalService,
        IdentifiableBean {
    ...
    private ItemQualifierLocalServiceClpInvoker _clpInvoker = new ItemQualifierLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ItemQualifierLocalServiceUtil} to access the item qualifier local service.
     */
    ...
    @Override
    public ItemQualifier addItemQualifier(ItemQualifier itemQualifier)
        throws SystemException {
        itemQualifier.setNew(true);

        return itemQualifierPersistence.update(itemQualifier);
    }
     ...
     */
    @Override
    public ItemQualifier createItemQualifier(int itemQualifierSid) {
        return itemQualifierPersistence.create(itemQualifierSid);
    }
    ...
    @Override
    public ItemQualifier deleteItemQualifier(int itemQualifierSid)
        throws PortalException, SystemException {
        return itemQualifierPersistence.remove(itemQualifierSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ItemQualifier deleteItemQualifier(ItemQualifier itemQualifier)
        throws SystemException {
        return itemQualifierPersistence.remove(itemQualifier);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ItemQualifier.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return itemQualifierPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return itemQualifierPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ItemQualifier fetchItemQualifier(int itemQualifierSid)
        throws SystemException {
        return itemQualifierPersistence.fetchByPrimaryKey(itemQualifierSid);
    }
     ...
     */
    @Override
    public ItemQualifier getItemQualifier(int itemQualifierSid)
        throws PortalException, SystemException {
        return itemQualifierPersistence.findByPrimaryKey(itemQualifierSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return itemQualifierPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ItemQualifier> getItemQualifiers(int start, int end)
        throws SystemException {
        return itemQualifierPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getItemQualifiersCount() throws SystemException {
        return itemQualifierPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ItemQualifier updateItemQualifier(ItemQualifier itemQualifier)
        throws SystemException {
        return itemQualifierPersistence.update(itemQualifier);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ItemQualifier",
            itemQualifierLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = itemQualifierPersistence.getDataSource();
