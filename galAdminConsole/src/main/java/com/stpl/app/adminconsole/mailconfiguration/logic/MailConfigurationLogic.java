...
public class MailConfigurationLogic {
    ...
    public static void save(MailConfigurationDTO maildto,final SessionDTO sessionDTO) throws Exception {
    ...
    public static WfMailConfig LoadOnClick(MailConfigurationDTO maildto) throws Exception {
          LOGGER.info("Inside Loading of Data");
    ...
    public void sendingEmailLogic(MailConfigurationDTO mailConfigurationDTO,String toMail) throws MessagingException {
        LOGGER.info("Setting Mail Server Properties..");
    ...
    public List<ProcessSchedulerDTO> loadProcessNameDDlb() {
        ...
        if (list != null && !list.isEmpty()) {
            for (int i = 0; i < list.size(); i++) {
                ...
                dto.setSuccessTo(String.valueOf(obj[2]));
                dto.setSuccessCC(String.valueOf(obj[3]));
                dto.setFailTo(String.valueOf(obj[4]));
                dto.setFailCC(String.valueOf(obj[5]));
                dto.setSuccessSubject(String.valueOf(obj[6]));
                dto.setSuccessText(String.valueOf(obj[7]));
                dto.setFailSubject(String.valueOf(obj[8]));
                dto.setFailText(String.valueOf(obj[9]));
                processList.add(dto);
            }
