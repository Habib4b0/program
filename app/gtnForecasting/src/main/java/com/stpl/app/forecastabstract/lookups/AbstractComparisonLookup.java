...
public abstract class AbstractComparisonLookup extends AbstractLookup {
    ...
    private Panel addSearchCriteria() {
        ...
        searchLayout.addComponent(UiUtils.makeLabel(WORKFLOW_STATUS.getConstant(),NumericConstants.FLOAT_ONE_FIVE_FOUR,Unit.PIXELS));
        searchLayout.addComponent(workflowStatus);
        searchLayout.addComponent(UiUtils.makeLabel(LEVEL_MARKET_TYPE.getConstant(),NumericConstants.FLOAT_ONE_ONE_SIX,Unit.PIXELS));
        searchLayout.addComponent(marketType);
        searchLayout.addComponent(UiUtils.makeLabel(BRAND.getConstant(),NumericConstants.FLOAT_EIGHTY_SEVEN,Unit.PIXELS));
        searchLayout.addComponent(brand);
        searchLayout.addComponent(UiUtils.makeLabel(PROJECTION_NAME.getConstant(),NumericConstants.FLOAT_ONE_FIVE_FOUR,Unit.PIXELS));
        searchLayout.addComponent(projectionName);
        searchLayout.addComponent(UiUtils.makeLabel(LEVEL_CONTRACT_HOLDER.getConstant(),NumericConstants.FLOAT_ONE_ONE_SIX,Unit.PIXELS));
        searchLayout.addComponent(contractHolder);
        searchLayout.addComponent(UiUtils.makeLabel(NDC_NO.getConstant(),NumericConstants.FLOAT_EIGHTY_SEVEN,Unit.PIXELS));
        searchLayout.addComponent(ndcNo);
        searchLayout.addComponent(UiUtils.makeLabel(PROJECTION_DESCRIPTION.getConstant(),NumericConstants.FLOAT_ONE_SIX_FIVE,Unit.PIXELS));
        searchLayout.addComponent(projectionDescription);
        searchLayout.addComponent(UiUtils.makeLabel(CONTRACT.getConstant(),NumericConstants.FLOAT_ONE_ONE_SIX,Unit.PIXELS));
        searchLayout.addComponent(contract);
        searchLayout.addComponent(UiUtils.makeLabel(NDC_NAME.getConstant(),NumericConstants.FLOAT_EIGHTY_SEVEN,Unit.PIXELS));
