...
import com.stpl.app.parttwo.service.AccClosureDetailsLocalService;
...
/**
 * Provides the base implementation for the acc closure details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.AccClosureDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.AccClosureDetailsLocalServiceImpl
 * @see com.stpl.app.parttwo.service.AccClosureDetailsLocalServiceUtil
 * @generated
 */
public abstract class AccClosureDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements AccClosureDetailsLocalService,
        IdentifiableBean {
    ...
    private AccClosureDetailsLocalServiceClpInvoker _clpInvoker = new AccClosureDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.AccClosureDetailsLocalServiceUtil} to access the acc closure details local service.
     */
    ...
    @Override
    public AccClosureDetails addAccClosureDetails(
        AccClosureDetails accClosureDetails) throws SystemException {
        accClosureDetails.setNew(true);

        return accClosureDetailsPersistence.update(accClosureDetails);
    }
     ...
     */
    @Override
    public AccClosureDetails createAccClosureDetails(int accClosureDetailsSid) {
        return accClosureDetailsPersistence.create(accClosureDetailsSid);
    }
    ...
    @Override
    public AccClosureDetails deleteAccClosureDetails(int accClosureDetailsSid)
        throws PortalException, SystemException {
        return accClosureDetailsPersistence.remove(accClosureDetailsSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public AccClosureDetails deleteAccClosureDetails(
        AccClosureDetails accClosureDetails) throws SystemException {
        return accClosureDetailsPersistence.remove(accClosureDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(AccClosureDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return accClosureDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return accClosureDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public AccClosureDetails fetchAccClosureDetails(int accClosureDetailsSid)
        throws SystemException {
        return accClosureDetailsPersistence.fetchByPrimaryKey(accClosureDetailsSid);
    }
     ...
     */
    @Override
    public AccClosureDetails getAccClosureDetails(int accClosureDetailsSid)
        throws PortalException, SystemException {
        return accClosureDetailsPersistence.findByPrimaryKey(accClosureDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return accClosureDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<AccClosureDetails> getAccClosureDetailses(int start, int end)
        throws SystemException {
        return accClosureDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getAccClosureDetailsesCount() throws SystemException {
        return accClosureDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public AccClosureDetails updateAccClosureDetails(
        AccClosureDetails accClosureDetails) throws SystemException {
        return accClosureDetailsPersistence.update(accClosureDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.AccClosureDetails",
            accClosureDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.AccClosureDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = accClosureDetailsPersistence.getDataSource();
