...
/**
 * Provides the local service interface for StAdjustmentReserveDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StAdjustmentReserveDetailLocalServiceUtil
...
public interface StAdjustmentReserveDetailLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link StAdjustmentReserveDetailLocalServiceUtil} to access the st adjustment reserve detail local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.StAdjustmentReserveDetailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
