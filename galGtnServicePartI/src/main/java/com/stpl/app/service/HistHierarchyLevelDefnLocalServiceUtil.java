...
public class HistHierarchyLevelDefnLocalServiceUtil {
    private static HistHierarchyLevelDefnLocalService _service;
    ...
    */
    ...
    public static HistHierarchyLevelDefnLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    HistHierarchyLevelDefnLocalService.class.getName());

            if (invokableLocalService instanceof HistHierarchyLevelDefnLocalService) {
                _service = (HistHierarchyLevelDefnLocalService) invokableLocalService;
            } else {
                _service = new HistHierarchyLevelDefnLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(HistHierarchyLevelDefnLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(HistHierarchyLevelDefnLocalService service) {
    }
}
