 ...
 */
public class NmPpaProjectionMasterFinderImpl extends BasePersistenceImpl<NmPpaProjectionMaster> implements NmPpaProjectionMasterFinder {
    private static final Logger LOGGER = Logger.getLogger(NmPpaProjectionMasterFinderImpl.class);
