...
import com.stpl.app.service.StNmActualPpaLocalService;
...
/**
 * Provides the base implementation for the st nm actual ppa local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.StNmActualPpaLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.StNmActualPpaLocalServiceImpl
 * @see com.stpl.app.service.StNmActualPpaLocalServiceUtil
 * @generated
 */
public abstract class StNmActualPpaLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements StNmActualPpaLocalService,
        IdentifiableBean {
    ...
    private StNmActualPpaLocalServiceClpInvoker _clpInvoker = new StNmActualPpaLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.StNmActualPpaLocalServiceUtil} to access the st nm actual ppa local service.
     */
    ...
    @Override
    public StNmActualPpa addStNmActualPpa(StNmActualPpa stNmActualPpa)
        throws SystemException {
        stNmActualPpa.setNew(true);

        return stNmActualPpaPersistence.update(stNmActualPpa);
    }
     ...
     */
    @Override
    public StNmActualPpa createStNmActualPpa(StNmActualPpaPK stNmActualPpaPK) {
        return stNmActualPpaPersistence.create(stNmActualPpaPK);
    }
    ...
    @Override
    public StNmActualPpa deleteStNmActualPpa(StNmActualPpaPK stNmActualPpaPK)
        throws PortalException, SystemException {
        return stNmActualPpaPersistence.remove(stNmActualPpaPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public StNmActualPpa deleteStNmActualPpa(StNmActualPpa stNmActualPpa)
        throws SystemException {
        return stNmActualPpaPersistence.remove(stNmActualPpa);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(StNmActualPpa.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return stNmActualPpaPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return stNmActualPpaPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public StNmActualPpa fetchStNmActualPpa(StNmActualPpaPK stNmActualPpaPK)
        throws SystemException {
        return stNmActualPpaPersistence.fetchByPrimaryKey(stNmActualPpaPK);
    }
     ...
     */
    @Override
    public StNmActualPpa getStNmActualPpa(StNmActualPpaPK stNmActualPpaPK)
        throws PortalException, SystemException {
        return stNmActualPpaPersistence.findByPrimaryKey(stNmActualPpaPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return stNmActualPpaPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<StNmActualPpa> getStNmActualPpas(int start, int end)
        throws SystemException {
        return stNmActualPpaPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getStNmActualPpasCount() throws SystemException {
        return stNmActualPpaPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public StNmActualPpa updateStNmActualPpa(StNmActualPpa stNmActualPpa)
        throws SystemException {
        return stNmActualPpaPersistence.update(stNmActualPpa);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.StNmActualPpa",
            stNmActualPpaLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = stNmActualPpaPersistence.getDataSource();
