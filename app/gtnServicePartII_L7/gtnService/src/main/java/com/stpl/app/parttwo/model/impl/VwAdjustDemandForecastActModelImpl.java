 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link VwAdjustDemandForecastActModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link VwAdjustDemandForecastActImpl}.
 * </p>
 *
 * @author
...
public class VwAdjustDemandForecastActModelImpl extends BaseModelImpl<VwAdjustDemandForecastAct>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("MARKET_SHARE_RATIO", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("ADJUSTED_DEMAND_FORECAST_ID", Types.INTEGER);
	...
	private static final ClassLoader _classLoader = VwAdjustDemandForecastAct.class.getClassLoader();
