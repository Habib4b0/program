 ...
 * @author vinodhini
 */
public class ForecastTableLogic extends PageTableLogic {

    private static final Logger LOGGER = Logger.getLogger(FileResultsTableLogic.class);
    final ForecastLogic searchLogic = new ForecastLogic();
    ...
    public Object configureContainer(Object object, Container container) {
        ForecastDTO dto = (ForecastDTO) object;
        ((BeanItemContainer<ForecastDTO>) container).addBean(dto);
        return dto;
    }
