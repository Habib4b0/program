...
public class PsContractDetailsCacheModel implements CacheModel<PsContractDetails>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PsContractDetailsCacheModel)) {
			return false;
		}

		PsContractDetailsCacheModel psContractDetailsCacheModel = (PsContractDetailsCacheModel)obj;

		if (psContractDetailsSid == psContractDetailsCacheModel.psContractDetailsSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, psContractDetailsSid);
	}
