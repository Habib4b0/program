...
public class GtnFrameworkCompanyAdditionTabLoadAction implements GtnUIFrameWorkAction,GtnUIFrameworkDynamicClass {
	...
	public void doAction(String componentId, GtnUIFrameWorkActionConfig gtnUIFrameWorkActionConfig)
		...
		if (!processDataBean.isCompanyAddLoaded()) {
			processDataBean.setCompanyAddLoaded(true);
			processDataBean.setCompanyAddTableLoad(true);
			processDataBean.setCompanyAdditionRightTableId(parameters.get(3).toString());
		...
		if (processDataBean.isCompanyAddTableLoad()) {
			processDataBean.setCompanyAddTableLoad(false);
			loadTable(componentId, processDataBean.getCompanyAdditionRightTableId());
		}
	}
