...
public class GtnFrameworkPSConstants {
	...
	private static final List<String> PRICE_PROTECTION_DDLB_PROPERTIES = Arrays.asList("psPPStatus", "psPPPriceType",
			"psBasePriceType", "psNetBasePrice", "psSubseqPeriodPriceType", "psNetBSubseqPeriodPrice",
			"psToleranceInterval", "psToleranceFreq", "psToleranceType", "psResetEligible", "psResetType",
			"psResetInterval", "psResetFrequency", "psResetPriceType", "psNetResetPriceType", "psNetPriceType");
	...
	private static final String[] CUSTOM_FILTER_PROPERTY_IDS = { GtnFrameworkCommonConstants.IFP_STATUS,
			GtnFrameworkCommonConstants.PROPERTY_IFP_TYPE, GtnFrameworkCommonConstants.PROPERTY_IFP_CATEGORY };
	...
	private static final Object[] ADD_ENABLE_FIELD = new String[] { GtnFrameworkCommonConstants.NOTES_TAB,
			...
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_END_DATE, GtnFrameworkCommonConstants.PRICE_SCHEDULE_START_DATE,
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_TYPE1, GtnFrameworkCommonConstants.PRICE_SCHEDULE_DESIGNATION,
	...
	private static final Object[] ADD_VIEW_DISABLE_FIELD = new Object[] { GtnFrameworkCommonConstants.NOTES_TAB,
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_END_DATE, GtnFrameworkCommonConstants.PRICE_SCHEDULE_START_DATE,
			"priceScheduleTradeClass", "priceScheduleCategory", GtnFrameworkCommonConstants.PRICE_SCHEDULE_TYPE1,
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_DESIGNATION, GtnFrameworkCommonConstants.PRICE_SCHEDULE_STATUS1,
			GtnFrameworkCommonConstants.CREATED_BY, GtnFrameworkCommonConstants.MODIFIED_BY,
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_ID_TOP, GtnFrameworkCommonConstants.PRICE_SCHEDULE_NO_TOP,
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_NAME_TOP, GtnFrameworkCommonConstants.PRICE_SCHEDULE_ID1,
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_NO1, GtnFrameworkCommonConstants.PRICE_SCHEDULE_NAME1,
			GtnFrameworkCommonConstants.PARENT_PRICE_SCHEDULE_NAME, GtnFrameworkCommonConstants.CREATED_DATE,
			GtnFrameworkCommonConstants.MODIFIED_DATE, GtnFrameworkCommonConstants.PS_ITEM_ADDITION_MOVE_RIGHT_BUTTONS,
			GtnFrameworkCommonConstants.PS_ITEM_ADDITION_MOVE_LEFT_BUTTONS };
	private static final Object[] ADD_VIEW_VISIBLE_FIELD = new String[] {
	...
	private static final Object[] ADD_EDIT_ENABLE_FIELD = new String[] { GtnFrameworkCommonConstants.NOTES_TAB,
			...
			"psPriceProtectionTabResultDataTable", "psPricingTabResultDataTable",
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_END_DATE, GtnFrameworkCommonConstants.PRICE_SCHEDULE_START_DATE,
			"priceScheduleTradeClass", GtnFrameworkCommonConstants.PRICE_SCHEDULE_TYPE1,
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_DESIGNATION, GtnFrameworkCommonConstants.PRICE_SCHEDULE_STATUS1,
			GtnFrameworkCommonConstants.CREATED_BY, GtnFrameworkCommonConstants.MODIFIED_BY,
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_ID_TOP, GtnFrameworkCommonConstants.PRICE_SCHEDULE_NO_TOP,
			GtnFrameworkCommonConstants.PRICE_SCHEDULE_NAME_TOP, GtnFrameworkCommonConstants.PRICE_SCHEDULE_ID1,
	...
	private static final Object[] ADD_EDIT_DISABLE_FIELD = new Object[] { GtnFrameworkCommonConstants.CREATED_BY,
			...
			GtnFrameworkCommonConstants.PS_PRICE_PROTECTION_TAB_POPULATE_BUTTON,
			GtnFrameworkCommonConstants.PS_PRICE_PROTECTION_TAB_POPULATE_ALL_BUTTON };
	private static final String[] ADD_EDIT_VISIBLE_FIELD = new String[] {
	...
	private static final Object[] PRICE_PROTECTION_COLUMN_ALIGNMENT_HEADER = {
			GtnFrameworkCommonConstants.PS_DETAILS_PRICE_TOL };
