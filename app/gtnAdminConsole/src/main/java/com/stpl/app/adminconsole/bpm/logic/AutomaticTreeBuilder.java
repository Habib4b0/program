        ...
        try {
            ...
            if (listOfLevels != null && !listOfLevels.isEmpty()) {
                for (int i = 0; i < listOfLevels.size(); i++) {
                    ...
                    if (!hierarchyLevelDef.getLevelValueReference().equals(CommonUtils.USER_DEFINED)) {
                    ...
                    if (i == 0) {
                        ...
                        for (int j = 0; j < parents.size(); j++) {
                            ...
                            if (levelNo < availableLevelsBeanList.size()) {
                                ...
                                } else if (hierarchyLevelDef.getLevelValueReference().equals(CommonUtils.USER_DEFINED)) {
                                    LOGGER.debug("Current Index: " + i + " with type: " + hierarchyLevelDef.getLevelValueReference());
                ...
                for (HierarchyLevelsDTO parent : parents) {
                    ...
                    if (childs != null && !childs.isEmpty()) {
                        for (final Iterator<?> childIt = childs.iterator(); childIt.hasNext();) {
                            ...
                            if (listOfLevels.get(i).getLevelValueReference().equals(CommonUtils.USER_DEFINED)) {
