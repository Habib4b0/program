...
public class CompanyParentDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<CompanyParentDetailsLocalService, CompanyParentDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(CompanyParentDetailsLocalService.class);
}