...
public class Trx7SalesSearchResult extends AbstractSearchResults {
    ...
    public void generateButtonLogic(Trx7SelectionDTO selection, boolean isEditButtonClick) {
        ...
        Trx7SalesFieldFactory salesFieldFactory = new Trx7SalesFieldFactory(getSummaryLogic(), selection.getProjectionMasterSid(), selection.getSessionDTO().getSessionId(), selection);
