...
import com.stpl.app.service.MParityLookupLocalService;
...
/**
 * Provides the base implementation for the m parity lookup local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.MParityLookupLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.MParityLookupLocalServiceImpl
 * @see com.stpl.app.service.MParityLookupLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class MParityLookupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MParityLookupLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.MParityLookupLocalServiceUtil} to access the m parity lookup local service.
	 */
	...
	@Override
	public MParityLookup addMParityLookup(MParityLookup mParityLookup) {
		mParityLookup.setNew(true);

		return mParityLookupPersistence.update(mParityLookup);
	}
	 ...
	 */
	@Override
	public MParityLookup createMParityLookup(int mParityLookupSid) {
		return mParityLookupPersistence.create(mParityLookupSid);
	}
	...
	@Override
	public MParityLookup deleteMParityLookup(int mParityLookupSid)
		throws PortalException {
		return mParityLookupPersistence.remove(mParityLookupSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MParityLookup deleteMParityLookup(MParityLookup mParityLookup) {
		return mParityLookupPersistence.remove(mParityLookup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MParityLookup.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return mParityLookupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return mParityLookupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MParityLookup fetchMParityLookup(int mParityLookupSid) {
		return mParityLookupPersistence.fetchByPrimaryKey(mParityLookupSid);
	}
	 ...
	 */
	@Override
	public MParityLookup getMParityLookup(int mParityLookupSid)
		throws PortalException {
		return mParityLookupPersistence.findByPrimaryKey(mParityLookupSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(mParityLookupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MParityLookup.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("mParityLookupSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(mParityLookupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MParityLookup.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return mParityLookupLocalService.deleteMParityLookup((MParityLookup)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return mParityLookupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MParityLookup> getMParityLookups(int start, int end) {
		return mParityLookupPersistence.findAll(start, end);
	}
	...
	public int getMParityLookupsCount() {
		return mParityLookupPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MParityLookup updateMParityLookup(MParityLookup mParityLookup) {
		return mParityLookupPersistence.update(mParityLookup);
	}
	 ...
	 */
	public MParityLookupLocalService getMParityLookupLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.MParityLookup",
			mParityLookupLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.MParityLookup");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MParityLookupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = mParityLookupPersistence.getDataSource();
	...
	@BeanReference(type = MParityLookupLocalService.class)
	protected MParityLookupLocalService mParityLookupLocalService;
