 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link CompanyMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CompanyMasterImpl}.
 * </p>
 *
 * @author
...
public class CompanyMasterModelImpl extends BaseModelImpl<CompanyMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("COMPANY_CATEGORY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("LAST_UPDATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("LIVES", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("COMPANY_TYPE", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("COMPANY_STATUS", Types.INTEGER);
	...
	public static final long COMPANYNO_COLUMN_BITMASK = 2L;
	public static final long COMPANYSTATUS_COLUMN_BITMASK = 4L;
	public static final long COMPANYSTRINGID_COLUMN_BITMASK = 8L;
	public static final long COMPANYTYPE_COLUMN_BITMASK = 16L;
	public static final long COMPANYMASTERSID_COLUMN_BITMASK = 32L;
	...
	public Object clone() {
		...
		companyMasterImpl.setCompanyStringId(getCompanyStringId());
	...
	public void resetOriginalValues() {
		...
		companyMasterModelImpl._originalCompanyStringId = companyMasterModelImpl._companyStringId;
	...
	public CacheModel<CompanyMaster> toCacheModel() {
		...
		companyMasterCacheModel.companyStringId = getCompanyStringId();

		String companyStringId = companyMasterCacheModel.companyStringId;

		if ((companyStringId != null) && (companyStringId.length() == 0)) {
			companyMasterCacheModel.companyStringId = null;
		}
	...
	private static final ClassLoader _classLoader = CompanyMaster.class.getClassLoader();
