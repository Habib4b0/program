...
-----------------------------------------------------GALUAT-821 ETL Intermediate tables
IF Object_id('ARM_HIST_ADJ_RES_CON_MASTER') IS NOT NULL
  DROP TABLE ARM_HIST_ADJ_RES_CON_MASTER
...
IF Object_id('ARM_HIST_ADJ_RES_CON_DETAILS') IS NOT NULL
  DROP TABLE ARM_HIST_ADJ_RES_CON_DETAILS
...
IF Object_id('ARM_HIST_ADJUSTMENTS') IS NOT NULL
  DROP TABLE ARM_HIST_ADJUSTMENTS
