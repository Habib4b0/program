...
import com.stpl.app.service.DeductionCalendarDetailsLocalService;
...
/**
 * Provides the base implementation for the deduction calendar details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.DeductionCalendarDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.DeductionCalendarDetailsLocalServiceImpl
 * @see com.stpl.app.service.DeductionCalendarDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class DeductionCalendarDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DeductionCalendarDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.DeductionCalendarDetailsLocalServiceUtil} to access the deduction calendar details local service.
	 */
	...
	@Override
	public DeductionCalendarDetails addDeductionCalendarDetails(
		DeductionCalendarDetails deductionCalendarDetails) {
		deductionCalendarDetails.setNew(true);

		return deductionCalendarDetailsPersistence.update(deductionCalendarDetails);
	}
	 ...
	 */
	@Override
	public DeductionCalendarDetails createDeductionCalendarDetails(
		DeductionCalendarDetailsPK deductionCalendarDetailsPK) {
		return deductionCalendarDetailsPersistence.create(deductionCalendarDetailsPK);
	}
	...
	@Override
	public DeductionCalendarDetails deleteDeductionCalendarDetails(
		DeductionCalendarDetailsPK deductionCalendarDetailsPK)
		throws PortalException {
		return deductionCalendarDetailsPersistence.remove(deductionCalendarDetailsPK);
	}
	...
	public DeductionCalendarDetails deleteDeductionCalendarDetails(
		DeductionCalendarDetails deductionCalendarDetails) {
		return deductionCalendarDetailsPersistence.remove(deductionCalendarDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DeductionCalendarDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return deductionCalendarDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return deductionCalendarDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DeductionCalendarDetails fetchDeductionCalendarDetails(
		DeductionCalendarDetailsPK deductionCalendarDetailsPK) {
		return deductionCalendarDetailsPersistence.fetchByPrimaryKey(deductionCalendarDetailsPK);
	}
	 ...
	 */
	@Override
	public DeductionCalendarDetails getDeductionCalendarDetails(
		DeductionCalendarDetailsPK deductionCalendarDetailsPK)
		throws PortalException {
		return deductionCalendarDetailsPersistence.findByPrimaryKey(deductionCalendarDetailsPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(deductionCalendarDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DeductionCalendarDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName(
			"primaryKey.deductionCalendarMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(deductionCalendarDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DeductionCalendarDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return deductionCalendarDetailsLocalService.deleteDeductionCalendarDetails((DeductionCalendarDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return deductionCalendarDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DeductionCalendarDetails> getDeductionCalendarDetailses(
		int start, int end) {
		return deductionCalendarDetailsPersistence.findAll(start, end);
	}
	...
	public int getDeductionCalendarDetailsesCount() {
		return deductionCalendarDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DeductionCalendarDetails updateDeductionCalendarDetails(
		DeductionCalendarDetails deductionCalendarDetails) {
		return deductionCalendarDetailsPersistence.update(deductionCalendarDetails);
	}
	 ...
	 */
	public DeductionCalendarDetailsLocalService getDeductionCalendarDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.DeductionCalendarDetails",
			deductionCalendarDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.DeductionCalendarDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeductionCalendarDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = deductionCalendarDetailsPersistence.getDataSource();
	...
	@BeanReference(type = DeductionCalendarDetailsLocalService.class)
	protected DeductionCalendarDetailsLocalService deductionCalendarDetailsLocalService;
