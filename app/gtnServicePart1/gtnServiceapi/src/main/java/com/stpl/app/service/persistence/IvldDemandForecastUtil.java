...
/**
 * The persistence utility for the ivld demand forecast service. This utility wraps {@link com.stpl.app.service.persistence.impl.IvldDemandForecastPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.stpl.app.service.persistence.impl.IvldDemandForecastPersistenceImpl
 * @generated
 */
@ProviderType
public class IvldDemandForecastUtil {
	...
	*/
	public static void cacheResult(IvldDemandForecast ivldDemandForecast) {
	...
	*/
	public static void cacheResult(List<IvldDemandForecast> ivldDemandForecasts) {
	...
	*/
	public static IvldDemandForecast create(int ivldDemandForecastSid) {
	...
	*/
	public static IvldDemandForecast remove(int ivldDemandForecastSid)
		throws com.stpl.app.exception.NoSuchIvldDemandForecastException {
		return getPersistence().remove(ivldDemandForecastSid);
	}

	public static IvldDemandForecast updateImpl(
		IvldDemandForecast ivldDemandForecast) {
	...
	* @throws NoSuchIvldDemandForecastException if a ivld demand forecast with the primary key could not be found
	*/
	public static IvldDemandForecast findByPrimaryKey(int ivldDemandForecastSid)
		throws com.stpl.app.exception.NoSuchIvldDemandForecastException {
	...
	*/
	public static IvldDemandForecast fetchByPrimaryKey(
		int ivldDemandForecastSid) {
		return getPersistence().fetchByPrimaryKey(ivldDemandForecastSid);
	}

	public static java.util.Map<java.io.Serializable, IvldDemandForecast> fetchByPrimaryKeys(
	...
	*/
	public static List<IvldDemandForecast> findAll() {
	...
	*/
	public static List<IvldDemandForecast> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IvldDemandForecastPersistence, IvldDemandForecastPersistence> _serviceTracker =
		ServiceTrackerFactory.open(IvldDemandForecastPersistence.class);
}