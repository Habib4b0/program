...
public interface VwAccrualMasterLocalService extends BaseLocalService,
	...
	*/
	...
	public VwAccrualMaster addVwAccrualMaster(VwAccrualMaster vwAccrualMaster);
	...
	*/
	public VwAccrualMaster createVwAccrualMaster(int accrualMasterSid);
	...
	*/
	...
	public VwAccrualMaster deleteVwAccrualMaster(int accrualMasterSid)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public VwAccrualMaster deleteVwAccrualMaster(
		VwAccrualMaster vwAccrualMaster);
	...
	*/
	...
	public VwAccrualMaster fetchVwAccrualMaster(int accrualMasterSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VwAccrualMaster getVwAccrualMaster(int accrualMasterSid)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VwAccrualMaster> getVwAccrualMasters(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public VwAccrualMaster updateVwAccrualMaster(
		VwAccrualMaster vwAccrualMaster);
}