...
import com.stpl.app.service.NmPpaProjectionLocalService;
...
/**
 * Provides the base implementation for the nm ppa projection local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.NmPpaProjectionLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.NmPpaProjectionLocalServiceImpl
 * @see com.stpl.app.service.NmPpaProjectionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class NmPpaProjectionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NmPpaProjectionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.NmPpaProjectionLocalServiceUtil} to access the nm ppa projection local service.
	 */
	...
	@Override
	public NmPpaProjection addNmPpaProjection(NmPpaProjection nmPpaProjection) {
		nmPpaProjection.setNew(true);

		return nmPpaProjectionPersistence.update(nmPpaProjection);
	}
	 ...
	 */
	@Override
	public NmPpaProjection createNmPpaProjection(
		NmPpaProjectionPK nmPpaProjectionPK) {
		return nmPpaProjectionPersistence.create(nmPpaProjectionPK);
	}
	...
	@Override
	public NmPpaProjection deleteNmPpaProjection(
		NmPpaProjectionPK nmPpaProjectionPK) throws PortalException {
		return nmPpaProjectionPersistence.remove(nmPpaProjectionPK);
	}
	...
	@Override
	public NmPpaProjection deleteNmPpaProjection(
		NmPpaProjection nmPpaProjection) {
		return nmPpaProjectionPersistence.remove(nmPpaProjection);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NmPpaProjection.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return nmPpaProjectionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return nmPpaProjectionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NmPpaProjection fetchNmPpaProjection(
		NmPpaProjectionPK nmPpaProjectionPK) {
		return nmPpaProjectionPersistence.fetchByPrimaryKey(nmPpaProjectionPK);
	}
	 ...
	 */
	@Override
	public NmPpaProjection getNmPpaProjection(
		NmPpaProjectionPK nmPpaProjectionPK) throws PortalException {
		return nmPpaProjectionPersistence.findByPrimaryKey(nmPpaProjectionPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(nmPpaProjectionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NmPpaProjection.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(nmPpaProjectionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NmPpaProjection.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return nmPpaProjectionLocalService.deleteNmPpaProjection((NmPpaProjection)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return nmPpaProjectionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NmPpaProjection> getNmPpaProjections(int start, int end) {
		return nmPpaProjectionPersistence.findAll(start, end);
	}
	...
	public int getNmPpaProjectionsCount() {
		return nmPpaProjectionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NmPpaProjection updateNmPpaProjection(
		NmPpaProjection nmPpaProjection) {
		return nmPpaProjectionPersistence.update(nmPpaProjection);
	}
	 ...
	 */
	public NmPpaProjectionLocalService getNmPpaProjectionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.NmPpaProjection",
			nmPpaProjectionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.NmPpaProjection");
	}
	...
	public String getOSGiServiceIdentifier() {
		return NmPpaProjectionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = nmPpaProjectionPersistence.getDataSource();
	...
	@BeanReference(type = NmPpaProjectionLocalService.class)
	protected NmPpaProjectionLocalService nmPpaProjectionLocalService;
