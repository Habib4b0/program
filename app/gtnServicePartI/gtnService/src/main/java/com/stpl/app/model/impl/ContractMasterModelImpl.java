 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ContractMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ContractMasterImpl}.
 * </p>
 *
 * @author
...
public class ContractMasterModelImpl extends BaseModelImpl<ContractMaster>
	...
	static {
		TABLE_COLUMNS_MAP.put("PROPOSAL_END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("RENEGOTIATION_END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("OUTSIDE_ADDITIONAL_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("MANF_COMPANY_MASTER_SID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("RENEGOTIATION_START_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("INSIDE_AUTHOR", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ADVANCE_NOTICE_DAYS", Types.DOUBLE);
		TABLE_COLUMNS_MAP.put("OUTSIDE_OWNER", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MOST_FAVORED_NATION", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("INSIDE_ADDITIONAL_PHONE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ORIGINAL_START_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CREATED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("PROPOSAL_START_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CONTRACT_TRADE_CLASS", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("OUTSIDE_ADDITIONAL", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PROCESS_STATUS", Types.BOOLEAN);
		TABLE_COLUMNS_MAP.put("INSIDE_ADDITIONAL_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CONTRACT_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CONTRACT_STATUS", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CONTRACT_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CONTRACT_TYPE", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("AWARD_STATUS", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("INSIDE_OWNER", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("SOURCE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("SHIPPING_TERMS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PRICE_ESCALATION_CLAUSE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("OUTSIDE_ADDITIONAL_PHONE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("TERM", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CONTRACT_NO", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("BATCH_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("DOCUMENT_CLASS", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("ORIGINAL_END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("PAYMENT_TERMS", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("INSIDE_ADDITIONAL", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("AFFILIATED_CONTRACT_INFO", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CATEGORY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("OUTSIDE_PHONE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PRICEPROTECTION_START_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("PRICEPROTECTION_END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("DOCUMENT_TYPE", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("EXEMPT_FROM_LOW_PRICE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ORGANIZATION_KEY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CURRENCY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("INSIDE_PHONE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("BUNIT_COMPANY_MASTER_SID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("OUTSIDE_AUTHOR", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CONT_HOLD_COMPANY_MASTER_SID", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("PRICE_RESET_INDICATOR", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MINIMUM_ORDER", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CANCELLATION_CLAUSE", Types.VARCHAR);
	...
	private static final ClassLoader _classLoader = ContractMaster.class.getClassLoader();
