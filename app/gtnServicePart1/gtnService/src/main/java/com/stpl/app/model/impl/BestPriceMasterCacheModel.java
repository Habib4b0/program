...
public class BestPriceMasterCacheModel implements CacheModel<BestPriceMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof BestPriceMasterCacheModel)) {
			return false;
		}

		BestPriceMasterCacheModel bestPriceMasterCacheModel = (BestPriceMasterCacheModel)obj;

		if (bestPriceMasterSid == bestPriceMasterCacheModel.bestPriceMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, bestPriceMasterSid);
	}
