...
public class GtnFrameworkForecastButtonOneClickNextButtonCustomAction
		implements GtnUIFrameWorkAction, GtnUIFrameworkDynamicClass {

	private final GtnWSLogger gtnLogger = GtnWSLogger
			.getGTNLogger(GtnFrameworkForecastButtonOneClickNextButtonCustomAction.class);
	...
	public void doAction(String componentId, GtnUIFrameWorkActionConfig gtnUIFrameWorkActionConfig)
		...
		gtnLogger.info(" inside GtnFrameworkForecastButtonOneClickNextButtonCustomAction");
		...
		final TabSheet tabSheet = (TabSheet) getAbstractComponent(actionParameterList.get(10).toString(), componentId);
		...
		saveValuesInDataSelectionEdit(gtnForecastBean,
		...
		GtnUIFrameworkBaseComponent gtnUIFrameworkBaseComponent = GtnUIFrameworkGlobalUI
				.getVaadinBaseComponent(actionParameterList.get(9).toString(), componentId);
	...
	private AbstractComponent getAbstractComponent(String componentId, String sourceComponentId) {
		return GtnUIFrameworkGlobalUI.getVaadinComponent(componentId, sourceComponentId);
	}
	...
	private void saveValuesInDataSelectionEdit(GtnForecastBean gtnForecastBean, String namespace,
		...
		dataSelectionBean
				.setProjectionName(getStringValue(namespace + fieldValuesParameterList.get(9), sourceComponentId));
		dataSelectionBean.setProjectionDescription(
				getStringValue(namespace + fieldValuesParameterList.get(10), sourceComponentId));

		dataSelectionBean
				.setGlCompanyId(getIntegerValue(namespace + fieldValuesParameterList.get(5), sourceComponentId));
		dataSelectionBean
				.setBusinessUnitId(getIntegerValue(namespace + fieldValuesParameterList.get(7), sourceComponentId));

		dataSelectionBean.setFromDate(getIntegerValue(namespace + fieldValuesParameterList.get(12), sourceComponentId));
		dataSelectionBean.setToDate(getIntegerValue(namespace + fieldValuesParameterList.get(14), sourceComponentId));

		dataSelectionBean.setProductHierarchyId(
				(Serializable) getSelectedId(namespace + fieldValuesParameterList.get(16), sourceComponentId));
		dataSelectionBean.setProductHierarchyName(
				getStringValue(namespace + fieldValuesParameterList.get(16), sourceComponentId));

		dataSelectionBean.setRelationshipBuilderId(
				getStringValue(namespace + fieldValuesParameterList.get(17), sourceComponentId));
		dataSelectionBean
				.setForecastLevelId(getStringValue(namespace + fieldValuesParameterList.get(18), sourceComponentId));

		dataSelectionBean.setProductGroupName("");
		dataSelectionBean.setInnerProductLevelId(
				getIntegerValue(namespace + fieldValuesParameterList.get(23), sourceComponentId));
