...
/**
 * The persistence utility for the returns master service. This utility wraps {@link com.stpl.app.service.persistence.impl.ReturnsMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ReturnsMasterUtil {
	...
	*/
	public static void cacheResult(ReturnsMaster returnsMaster) {
	...
	*/
	public static void cacheResult(List<ReturnsMaster> returnsMasters) {
	...
	*/
	public static ReturnsMaster create(int returnsMasterSid) {
	...
	*/
	public static ReturnsMaster remove(int returnsMasterSid)
		throws com.stpl.app.exception.NoSuchReturnsMasterException {
		return getPersistence().remove(returnsMasterSid);
	}

	public static ReturnsMaster updateImpl(ReturnsMaster returnsMaster) {
	...
	* @throws NoSuchReturnsMasterException if a returns master with the primary key could not be found
	*/
	public static ReturnsMaster findByPrimaryKey(int returnsMasterSid)
		throws com.stpl.app.exception.NoSuchReturnsMasterException {
	...
	*/
	public static ReturnsMaster fetchByPrimaryKey(int returnsMasterSid) {
		return getPersistence().fetchByPrimaryKey(returnsMasterSid);
	}

	public static java.util.Map<java.io.Serializable, ReturnsMaster> fetchByPrimaryKeys(
	...
	*/
	public static List<ReturnsMaster> findAll() {
	...
	*/
	public static List<ReturnsMaster> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<ReturnsMasterPersistence, ReturnsMasterPersistence> _serviceTracker =
		ServiceTrackerFactory.open(ReturnsMasterPersistence.class);
}