...
/**
 * The persistence utility for the sales basis details service. This utility wraps {@link SalesBasisDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SalesBasisDetailsUtil {
    private static SalesBasisDetailsPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.SalesBasisDetails create(
    ...
    */
    public static com.stpl.app.model.SalesBasisDetails remove(
        int salesBasisDetailsSid)
    ...
    public static com.stpl.app.model.SalesBasisDetails updateImpl(
        com.stpl.app.model.SalesBasisDetails salesBasisDetails)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.SalesBasisDetails findByPrimaryKey(
        int salesBasisDetailsSid)
        throws com.stpl.app.NoSuchSalesBasisDetailsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.SalesBasisDetails fetchByPrimaryKey(
        int salesBasisDetailsSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.SalesBasisDetails> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static SalesBasisDetailsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (SalesBasisDetailsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    SalesBasisDetailsPersistence.class.getName());

            ReferenceRegistry.registerReference(SalesBasisDetailsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(SalesBasisDetailsPersistence persistence) {
    }
}
