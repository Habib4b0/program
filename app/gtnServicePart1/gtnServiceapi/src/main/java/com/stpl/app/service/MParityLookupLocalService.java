...
/**
 * Provides the local service interface for MParityLookup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see MParityLookupLocalServiceUtil
...
public interface MParityLookupLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MParityLookupLocalServiceUtil} to access the m parity lookup local service. Add custom service methods to {@link com.stpl.app.service.impl.MParityLookupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
