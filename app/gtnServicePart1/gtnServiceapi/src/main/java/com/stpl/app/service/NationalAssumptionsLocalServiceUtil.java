...
public class NationalAssumptionsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<NationalAssumptionsLocalService, NationalAssumptionsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(NationalAssumptionsLocalService.class);
}