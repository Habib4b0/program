...
public class ItemHierarchy extends TestBenchTestCase{
	...
	public void setUp() throws Exception {		
		...
		findElement(By.xpath(".//span[contains(text(),' Item Hierarchy')]")).click();
		
	}
	@Test
	public void itemHierarchy1() {
