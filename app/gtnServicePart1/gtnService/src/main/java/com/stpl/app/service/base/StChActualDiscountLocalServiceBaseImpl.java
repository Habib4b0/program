...
import com.stpl.app.service.StChActualDiscountLocalService;
...
/**
 * Provides the base implementation for the st ch actual discount local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.StChActualDiscountLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.StChActualDiscountLocalServiceImpl
 * @see com.stpl.app.service.StChActualDiscountLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StChActualDiscountLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StChActualDiscountLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.StChActualDiscountLocalServiceUtil} to access the st ch actual discount local service.
	 */
	...
	@Override
	public StChActualDiscount addStChActualDiscount(
		StChActualDiscount stChActualDiscount) {
		stChActualDiscount.setNew(true);

		return stChActualDiscountPersistence.update(stChActualDiscount);
	}
	 ...
	 */
	@Override
	public StChActualDiscount createStChActualDiscount(
		StChActualDiscountPK stChActualDiscountPK) {
		return stChActualDiscountPersistence.create(stChActualDiscountPK);
	}
	...
	@Override
	public StChActualDiscount deleteStChActualDiscount(
		StChActualDiscountPK stChActualDiscountPK) throws PortalException {
		return stChActualDiscountPersistence.remove(stChActualDiscountPK);
	}
	...
	public StChActualDiscount deleteStChActualDiscount(
		StChActualDiscount stChActualDiscount) {
		return stChActualDiscountPersistence.remove(stChActualDiscount);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StChActualDiscount.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stChActualDiscountPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stChActualDiscountPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StChActualDiscount fetchStChActualDiscount(
		StChActualDiscountPK stChActualDiscountPK) {
		return stChActualDiscountPersistence.fetchByPrimaryKey(stChActualDiscountPK);
	}
	 ...
	 */
	@Override
	public StChActualDiscount getStChActualDiscount(
		StChActualDiscountPK stChActualDiscountPK) throws PortalException {
		return stChActualDiscountPersistence.findByPrimaryKey(stChActualDiscountPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stChActualDiscountLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StChActualDiscount.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(stChActualDiscountLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StChActualDiscount.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stChActualDiscountLocalService.deleteStChActualDiscount((StChActualDiscount)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stChActualDiscountPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StChActualDiscount> getStChActualDiscounts(int start, int end) {
		return stChActualDiscountPersistence.findAll(start, end);
	}
	...
	public int getStChActualDiscountsCount() {
		return stChActualDiscountPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StChActualDiscount updateStChActualDiscount(
		StChActualDiscount stChActualDiscount) {
		return stChActualDiscountPersistence.update(stChActualDiscount);
	}
	 ...
	 */
	public StChActualDiscountLocalService getStChActualDiscountLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.StChActualDiscount",
			stChActualDiscountLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.StChActualDiscount");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StChActualDiscountLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stChActualDiscountPersistence.getDataSource();
	...
	@BeanReference(type = StChActualDiscountLocalService.class)
	protected StChActualDiscountLocalService stChActualDiscountLocalService;
