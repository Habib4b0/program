...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'AMP'
			AND LIST_NAME = 'MEDICAID_URA_AMP'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		...
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'Best Price'
			AND LIST_NAME = 'MEDICAID_URA_BEST_PRICE'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'Basic URA'
			AND LIST_NAME = 'MEDICAID_URA_BASIC_URA'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		...
		WHERE DESCRIPTION = 'CPI-U'
			AND LIST_NAME = 'MEDICAID_URA_CPI_U'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'CPI URA'
			AND LIST_NAME = 'MEDICAID_URA_CPI_URA'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'Medicaid URA'
			AND LIST_NAME = 'MEDICAID_URA_TOTAL_URA'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'WAC (CMS Unit Price)'
			AND LIST_NAME = 'MEDICAID_URA_WAC_CMS_UNIT'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'WAC Increase %'
			AND LIST_NAME = 'MEDICAID_URA_WAC_INCREASE'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'CMS Units'
			AND LIST_NAME = 'MEDICAID_URA_CMS_UNIT'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'PHS Price'
			AND LIST_NAME = 'PHS_PRICE'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		...
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'WAC (CMS Unit Price)'
			AND LIST_NAME = 'PHS_WAC_CMS_UNIT_PRICE'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		...
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'WAC Increase %'
			AND LIST_NAME = 'PHS_WAC_INCREASE'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'Maximum FSS Price (OGA)'
			AND LIST_NAME = 'FCP_MAXIMUM_FSS_PRICE_OGA'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'Non-FAMP'
			AND LIST_NAME = 'FCP_NON_FAMP'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'CPI-U Additional Discount'
			AND LIST_NAME = 'FCP_CPI_U'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'Reported FCP- (Calendar Year)'
			AND LIST_NAME = 'FCP_REPORTED_FCP_CALENDAR_YEAR'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'Forecast FCP Calculated'
			AND LIST_NAME = 'FCP_FORECAST_FCP_CALCULATED'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'Retail (Rebate)'
			AND LIST_NAME = 'FCP_RETAIL_REBATE'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'WAC'
			AND LIST_NAME = 'FCP_WAC'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		...
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'WAC Increase %'
			AND LIST_NAME = 'FCP_WAC_INCREASE'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'WAC-FCP'
			AND LIST_NAME = 'FCP_WAC_FCP'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
...
IF NOT EXISTS (
		SELECT 1
		FROM HELPER_TABLE
		WHERE DESCRIPTION = 'WAC-FSS'
			AND LIST_NAME = 'FCP_WAC_FSS'
		)
BEGIN
	INSERT INTO HELPER_TABLE (
		DESCRIPTION
