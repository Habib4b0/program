...
/**
 * Provides the local service interface for CustomViewDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CustomViewDetailsLocalServiceUtil
...
public interface CustomViewDetailsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CustomViewDetailsLocalServiceUtil} to access the custom view details local service. Add custom service methods to {@link com.stpl.app.service.impl.CustomViewDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
