...
public class AvailableCustomerTableLogic extends PageTableLogic{
    ...
    public static final Logger LOGGER = Logger.getLogger(AvailableCustomerTableLogic.class);

    public AvailableCustomerTableLogic() {
    }
    ...
    public int getCount() {
        ...
        if (generate) {
            try {
                ...
                count=dataSelectionLogic.getAvailableCustomersCount(binderDto,getFilters());
            } catch (Exception ex) {
               LOGGER.error(ex);
            }
        }
    ...
    public List loadData(int start, int offset) {
        ...
        try {
            ...
            resultList=dataSelectionLogic.getAvailableCustomers(binderDto,getFilters());
        } catch (Exception ex) {
            LOGGER.error(ex);
        }
         return resultList;
