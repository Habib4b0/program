...
/**
 * The persistence utility for the phs proj service. This utility wraps {@link com.stpl.app.service.persistence.impl.PhsProjPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.stpl.app.service.persistence.impl.PhsProjPersistenceImpl
 * @generated
 */
@ProviderType
public class PhsProjUtil {
	 ...
	 */
	public static PhsProj update(PhsProj phsProj) {
	...
	*/
	public static void cacheResult(PhsProj phsProj) {
	...
	*/
	public static void cacheResult(List<PhsProj> phsProjs) {
	...
	*/
	public static PhsProj create(PhsProjPK phsProjPK) {
	...
	*/
	public static PhsProj remove(PhsProjPK phsProjPK)
		throws com.stpl.app.exception.NoSuchPhsProjException {
		return getPersistence().remove(phsProjPK);
	}

	public static PhsProj updateImpl(PhsProj phsProj) {
	...
	* @throws NoSuchPhsProjException if a phs proj with the primary key could not be found
	*/
	public static PhsProj findByPrimaryKey(PhsProjPK phsProjPK)
		throws com.stpl.app.exception.NoSuchPhsProjException {
	...
	*/
	public static PhsProj fetchByPrimaryKey(PhsProjPK phsProjPK) {
		return getPersistence().fetchByPrimaryKey(phsProjPK);
	}

	public static java.util.Map<java.io.Serializable, PhsProj> fetchByPrimaryKeys(
	...
	*/
	public static List<PhsProj> findAll() {
	...
	*/
	public static List<PhsProj> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<PhsProjPersistence, PhsProjPersistence> _serviceTracker =
		ServiceTrackerFactory.open(PhsProjPersistence.class);
}