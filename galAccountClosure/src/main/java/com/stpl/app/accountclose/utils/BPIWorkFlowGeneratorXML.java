...
public class BPIWorkFlowGeneratorXML {
	...
	/*public static void main(String args[]) {
		new BPIWorkFlowGeneratorXML()
				.generateId(
						"E:/Satheesh/BPI_R2/Jboss/jboss-7.1.1/WorkflowXML/BPIGeneratorIDs.xml",
						"NM");
	}*/
	 ...
	 * Inside the XML.
	 * 
	 * @param hmBPIConterAndUpdateValues
	 *            - HashMap Input - 1) Date to Update 2) Counter to Update, 3)
	 *            Module Name
	 * @param fileWithPath
	 * @param modName
	 * @return
