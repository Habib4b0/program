...
public abstract class VwDemandForecastActualLocalServiceBaseImpl
    ...
    private VwDemandForecastActualLocalServiceClpInvoker _clpInvoker = new VwDemandForecastActualLocalServiceClpInvoker();
    ...
    public VwDemandForecastActual deleteVwDemandForecastActual(
        int demandForecastActualSid) throws PortalException, SystemException {
    ...
    public VwDemandForecastActual fetchVwDemandForecastActual(
        int demandForecastActualSid) throws SystemException {
     ...
     */
    @Override
    public int getVwDemandForecastActualsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.VwDemandForecastActual",
