...
public class StplCreateUserService {
    ...
    private static final Logger LOGGER = Logger.getLogger(StplCreateUserService.class);
    ...
    public User addUser(HttpServletRequest request, long companyid, String firstName, String lastName, String email,
        ...
        try {
            ...
            User user = UserLocalServiceUtil.addUser(id, companyid, true, password, password, true, screenName,
