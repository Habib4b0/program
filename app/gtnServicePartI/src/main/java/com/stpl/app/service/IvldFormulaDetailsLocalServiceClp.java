 ...
 * @generated
 */
public class IvldFormulaDetailsLocalServiceClp
    ...
    public IvldFormulaDetailsLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addIvldFormulaDetails";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.IvldFormulaDetails"
            };

        _methodName1 = "createIvldFormulaDetails";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteIvldFormulaDetails";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteIvldFormulaDetails";
        ...
        _methodName10 = "fetchIvldFormulaDetails";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getIvldFormulaDetails";
        ...
        _methodName13 = "getIvldFormulaDetailses";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getIvldFormulaDetailsesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateIvldFormulaDetails";
    ...
    public com.stpl.app.model.IvldFormulaDetails addIvldFormulaDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(ivldFormulaDetails)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.IvldFormulaDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.IvldFormulaDetails createIvldFormulaDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ivldFormulaDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.IvldFormulaDetails> getIvldFormulaDetailses(
        ...
        return (java.util.List<com.stpl.app.model.IvldFormulaDetails>) ClpSerializer.translateOutput(returnObj);
    }
