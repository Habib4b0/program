 ...
 */
public class GtnUIFrameworkContractHeaderTest {
    
    
    @Mock
    GtnUIFrameworkEngine gtnUIFrameworkEngine;
    @InjectMocks
    GtnUIFrameworkContractHeader instance;
    public GtnUIFrameworkContractHeaderTest() {
    }
    ...
    /**
     * Test of init method, of class GtnUIFrameworkContractHeader.
     */
    @Test
    public void testInit() {
        ...
        GtnUIFrameworkContractHeaderDynamicClassFiller fil = Mockito.mock(GtnUIFrameworkContractHeaderDynamicClassFiller.class);
        ...
        PowerMockito.whenNew(GtnUIFrameworkContractHeaderDynamicClassFiller.class).withNoArguments().thenReturn(fil);

        doNothing().when(engine).buildVaadinScreen(root, nav, request, ui, "Contract Header", fil);
