...
/**
 * Provides the local service interface for HistItemGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see HistItemGroupLocalServiceUtil
...
public interface HistItemGroupLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link HistItemGroupLocalServiceUtil} to access the hist item group local service. Add custom service methods to {@link com.stpl.app.service.impl.HistItemGroupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
