...
public class InventoryWdProjMasLocalServiceUtil {
    private static InventoryWdProjMasLocalService _service;
    ...
    */
    ...
    public static InventoryWdProjMasLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    InventoryWdProjMasLocalService.class.getName());

            if (invokableLocalService instanceof InventoryWdProjMasLocalService) {
                _service = (InventoryWdProjMasLocalService) invokableLocalService;
            } else {
                _service = new InventoryWdProjMasLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(InventoryWdProjMasLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(InventoryWdProjMasLocalService service) {
    }
}
