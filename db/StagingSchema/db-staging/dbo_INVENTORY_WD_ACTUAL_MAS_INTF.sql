--------------------------------------INVENTORY_WD_ACTUAL_MAS_INTF--------------------------------------
IF NOT EXISTS (SELECT 'X'
               FROM   INFORMATION_SCHEMA.TABLES
               WHERE  TABLE_NAME = 'INVENTORY_WD_ACTUAL_MAS_INTF'
                      AND TABLE_SCHEMA = 'DBO')
  BEGIN
      CREATE TABLE [DBO].[INVENTORY_WD_ACTUAL_MAS_INTF]
        (
...
IF  EXISTS (SELECT 1
               ...
               WHERE  TABLE_NAME = 'INVENTORY_WD_ACTUAL_MAS_INTF'
					  ...
					  AND TABLE_SCHEMA='DBO')
begin
exec sp_RENAME 'INVENTORY_WD_ACTUAL_MAS_INTF.INVENTORY_WD_ACTUAL_MAS_INTF_ID' , 'INVENTORY_WD_ACT_MAS_INTF_ID', 'COLUMN'
end
go 
