...
public class TransactionModuleDetailsLocalServiceUtil {
    private static TransactionModuleDetailsLocalService _service;
    ...
    */
    ...
    public static TransactionModuleDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    TransactionModuleDetailsLocalService.class.getName());

            if (invokableLocalService instanceof TransactionModuleDetailsLocalService) {
                _service = (TransactionModuleDetailsLocalService) invokableLocalService;
            } else {
                _service = new TransactionModuleDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(TransactionModuleDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(TransactionModuleDetailsLocalService service) {
    }
}
