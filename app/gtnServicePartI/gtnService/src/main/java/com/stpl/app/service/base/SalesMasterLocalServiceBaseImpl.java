...
import com.stpl.app.service.SalesMasterLocalService;
...
/**
 * Provides the base implementation for the sales master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.SalesMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.SalesMasterLocalServiceImpl
 * @see com.stpl.app.service.SalesMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class SalesMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SalesMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.SalesMasterLocalServiceUtil} to access the sales master local service.
	 */
	...
	@Override
	public SalesMaster addSalesMaster(SalesMaster salesMaster) {
		salesMaster.setNew(true);

		return salesMasterPersistence.update(salesMaster);
	}
	 ...
	 */
	@Override
	public SalesMaster createSalesMaster(int salesMasterSid) {
		return salesMasterPersistence.create(salesMasterSid);
	}
	...
	@Override
	public SalesMaster deleteSalesMaster(int salesMasterSid)
		throws PortalException {
		return salesMasterPersistence.remove(salesMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SalesMaster deleteSalesMaster(SalesMaster salesMaster) {
		return salesMasterPersistence.remove(salesMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SalesMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return salesMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return salesMasterPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return salesMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SalesMaster fetchSalesMaster(int salesMasterSid) {
		return salesMasterPersistence.fetchByPrimaryKey(salesMasterSid);
	}
	 ...
	 */
	@Override
	public SalesMaster getSalesMaster(int salesMasterSid)
		throws PortalException {
		return salesMasterPersistence.findByPrimaryKey(salesMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(salesMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SalesMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("salesMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(salesMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SalesMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return salesMasterLocalService.deleteSalesMaster((SalesMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return salesMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SalesMaster> getSalesMasters(int start, int end) {
		return salesMasterPersistence.findAll(start, end);
	}
	...
	public int getSalesMastersCount() {
		return salesMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SalesMaster updateSalesMaster(SalesMaster salesMaster) {
		return salesMasterPersistence.update(salesMaster);
	}
	 ...
	 */
	public SalesMasterLocalService getSalesMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.SalesMaster",
			salesMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.SalesMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return SalesMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = salesMasterPersistence.getDataSource();
	...
	@BeanReference(type = SalesMasterLocalService.class)
	protected SalesMasterLocalService salesMasterLocalService;
