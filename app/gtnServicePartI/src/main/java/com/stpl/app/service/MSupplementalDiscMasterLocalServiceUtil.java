...
public class MSupplementalDiscMasterLocalServiceUtil {
    private static MSupplementalDiscMasterLocalService _service;
    ...
    */
    ...
    public static MSupplementalDiscMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    MSupplementalDiscMasterLocalService.class.getName());

            if (invokableLocalService instanceof MSupplementalDiscMasterLocalService) {
                _service = (MSupplementalDiscMasterLocalService) invokableLocalService;
            } else {
                _service = new MSupplementalDiscMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(MSupplementalDiscMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(MSupplementalDiscMasterLocalService service) {
    }
}
