...
/**
 * The persistence utility for the acc closure view master service. This utility wraps {@link com.stpl.app.parttwo.service.persistence.impl.AccClosureViewMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class AccClosureViewMasterUtil {
	...
	*/
	public static void cacheResult(AccClosureViewMaster accClosureViewMaster) {
	...
	*/
	public static void cacheResult(
		List<AccClosureViewMaster> accClosureViewMasters) {
	...
	*/
	public static AccClosureViewMaster create(int accClosureViewMasterSid) {
	...
	*/
	public static AccClosureViewMaster remove(int accClosureViewMasterSid)
		throws com.stpl.app.parttwo.exception.NoSuchAccClosureViewMasterException {
		return getPersistence().remove(accClosureViewMasterSid);
	}

	public static AccClosureViewMaster updateImpl(
		AccClosureViewMaster accClosureViewMaster) {
	...
	* @throws NoSuchAccClosureViewMasterException if a acc closure view master with the primary key could not be found
	*/
	public static AccClosureViewMaster findByPrimaryKey(
	...
	*/
	public static AccClosureViewMaster fetchByPrimaryKey(
		int accClosureViewMasterSid) {
		return getPersistence().fetchByPrimaryKey(accClosureViewMasterSid);
	}

	public static java.util.Map<java.io.Serializable, AccClosureViewMaster> fetchByPrimaryKeys(
	...
	*/
	public static List<AccClosureViewMaster> findAll() {
	...
	*/
	public static List<AccClosureViewMaster> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<AccClosureViewMasterPersistence, AccClosureViewMasterPersistence> _serviceTracker =
		ServiceTrackerFactory.open(AccClosureViewMasterPersistence.class);
}