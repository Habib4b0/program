...
public class GtnWsServiceRegistryConstants {
	...
	public static final String SESSION_ID="20156";public static final String USER_ID="20156";public static final String LOAD_DATE_URL="/gtnPeriodConfigurationController/loadDate";
