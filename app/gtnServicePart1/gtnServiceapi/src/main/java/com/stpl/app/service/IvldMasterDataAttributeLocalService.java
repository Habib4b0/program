...
/**
 * Provides the local service interface for IvldMasterDataAttribute. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldMasterDataAttributeLocalServiceUtil
...
public interface IvldMasterDataAttributeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldMasterDataAttributeLocalServiceUtil} to access the ivld master data attribute local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldMasterDataAttributeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
