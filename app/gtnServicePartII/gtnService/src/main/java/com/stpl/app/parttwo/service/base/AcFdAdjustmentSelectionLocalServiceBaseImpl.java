...
import com.stpl.app.parttwo.service.AcFdAdjustmentSelectionLocalService;
...
/**
 * Provides the base implementation for the ac fd adjustment selection local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.AcFdAdjustmentSelectionLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.AcFdAdjustmentSelectionLocalServiceImpl
 * @see com.stpl.app.parttwo.service.AcFdAdjustmentSelectionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AcFdAdjustmentSelectionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AcFdAdjustmentSelectionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.AcFdAdjustmentSelectionLocalServiceUtil} to access the ac fd adjustment selection local service.
	 */
	...
	@Override
	public AcFdAdjustmentSelection addAcFdAdjustmentSelection(
		AcFdAdjustmentSelection acFdAdjustmentSelection) {
		acFdAdjustmentSelection.setNew(true);

		return acFdAdjustmentSelectionPersistence.update(acFdAdjustmentSelection);
	}
	 ...
	 */
	@Override
	public AcFdAdjustmentSelection createAcFdAdjustmentSelection(
		int accClosureMasterSid) {
		return acFdAdjustmentSelectionPersistence.create(accClosureMasterSid);
	}
	...
	@Override
	public AcFdAdjustmentSelection deleteAcFdAdjustmentSelection(
		int accClosureMasterSid) throws PortalException {
		return acFdAdjustmentSelectionPersistence.remove(accClosureMasterSid);
	}
	...
	public AcFdAdjustmentSelection deleteAcFdAdjustmentSelection(
		AcFdAdjustmentSelection acFdAdjustmentSelection) {
		return acFdAdjustmentSelectionPersistence.remove(acFdAdjustmentSelection);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AcFdAdjustmentSelection.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return acFdAdjustmentSelectionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return acFdAdjustmentSelectionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AcFdAdjustmentSelection fetchAcFdAdjustmentSelection(
		int accClosureMasterSid) {
		return acFdAdjustmentSelectionPersistence.fetchByPrimaryKey(accClosureMasterSid);
	}
	 ...
	 */
	@Override
	public AcFdAdjustmentSelection getAcFdAdjustmentSelection(
		int accClosureMasterSid) throws PortalException {
		return acFdAdjustmentSelectionPersistence.findByPrimaryKey(accClosureMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(acFdAdjustmentSelectionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AcFdAdjustmentSelection.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accClosureMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(acFdAdjustmentSelectionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AcFdAdjustmentSelection.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return acFdAdjustmentSelectionLocalService.deleteAcFdAdjustmentSelection((AcFdAdjustmentSelection)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return acFdAdjustmentSelectionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AcFdAdjustmentSelection> getAcFdAdjustmentSelections(
		int start, int end) {
		return acFdAdjustmentSelectionPersistence.findAll(start, end);
	}
	...
	public int getAcFdAdjustmentSelectionsCount() {
		return acFdAdjustmentSelectionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AcFdAdjustmentSelection updateAcFdAdjustmentSelection(
		AcFdAdjustmentSelection acFdAdjustmentSelection) {
		return acFdAdjustmentSelectionPersistence.update(acFdAdjustmentSelection);
	}
	 ...
	 */
	public AcFdAdjustmentSelectionLocalService getAcFdAdjustmentSelectionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.AcFdAdjustmentSelection",
			acFdAdjustmentSelectionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.AcFdAdjustmentSelection");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcFdAdjustmentSelectionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = acFdAdjustmentSelectionPersistence.getDataSource();
	...
	@BeanReference(type = AcFdAdjustmentSelectionLocalService.class)
	protected AcFdAdjustmentSelectionLocalService acFdAdjustmentSelectionLocalService;
