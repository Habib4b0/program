...
public interface PsContractDetailsPersistence extends BasePersistence<PsContractDetails> {
	...
	*/
	public void cacheResult(
		java.util.List<PsContractDetails> psContractDetailses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, PsContractDetails> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<PsContractDetails> findAll();
	...
	*/
	public java.util.List<PsContractDetails> findAll(int start, int end);
	...
	*/
	public java.util.List<PsContractDetails> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<PsContractDetails> orderByComparator);
