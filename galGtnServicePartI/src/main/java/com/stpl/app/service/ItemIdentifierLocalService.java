...
/**
 * Provides the local service interface for ItemIdentifier. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ItemIdentifierLocalServiceUtil
...
public interface ItemIdentifierLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ItemIdentifierLocalServiceUtil} to access the item identifier local service. Add custom service methods to {@link com.stpl.app.service.impl.ItemIdentifierLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
