...
/**
 * Provides the local service interface for DeductionCalendarMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see DeductionCalendarMasterLocalServiceUtil
...
public interface DeductionCalendarMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DeductionCalendarMasterLocalServiceUtil} to access the deduction calendar master local service. Add custom service methods to {@link com.stpl.app.service.impl.DeductionCalendarMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
