...
import com.stpl.app.service.IvldGlBalanceLocalService;
...
/**
 * Provides the base implementation for the ivld gl balance local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldGlBalanceLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldGlBalanceLocalServiceImpl
 * @see com.stpl.app.service.IvldGlBalanceLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldGlBalanceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldGlBalanceLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldGlBalanceLocalServiceUtil} to access the ivld gl balance local service.
	 */
	...
	@Override
	public IvldGlBalance addIvldGlBalance(IvldGlBalance ivldGlBalance) {
		ivldGlBalance.setNew(true);

		return ivldGlBalancePersistence.update(ivldGlBalance);
	}
	 ...
	 */
	@Override
	public IvldGlBalance createIvldGlBalance(int ivldGlBalanceSid) {
		return ivldGlBalancePersistence.create(ivldGlBalanceSid);
	}
	...
	@Override
	public IvldGlBalance deleteIvldGlBalance(int ivldGlBalanceSid)
		throws PortalException {
		return ivldGlBalancePersistence.remove(ivldGlBalanceSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IvldGlBalance deleteIvldGlBalance(IvldGlBalance ivldGlBalance) {
		return ivldGlBalancePersistence.remove(ivldGlBalance);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldGlBalance.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldGlBalancePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldGlBalancePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldGlBalance fetchIvldGlBalance(int ivldGlBalanceSid) {
		return ivldGlBalancePersistence.fetchByPrimaryKey(ivldGlBalanceSid);
	}
	 ...
	 */
	@Override
	public IvldGlBalance getIvldGlBalance(int ivldGlBalanceSid)
		throws PortalException {
		return ivldGlBalancePersistence.findByPrimaryKey(ivldGlBalanceSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldGlBalanceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldGlBalance.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ivldGlBalanceSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldGlBalanceLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldGlBalance.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldGlBalanceLocalService.deleteIvldGlBalance((IvldGlBalance)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldGlBalancePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldGlBalance> getIvldGlBalances(int start, int end) {
		return ivldGlBalancePersistence.findAll(start, end);
	}
	...
	public int getIvldGlBalancesCount() {
		return ivldGlBalancePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldGlBalance updateIvldGlBalance(IvldGlBalance ivldGlBalance) {
		return ivldGlBalancePersistence.update(ivldGlBalance);
	}
	 ...
	 */
	public IvldGlBalanceLocalService getIvldGlBalanceLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.IvldGlBalance",
			ivldGlBalanceLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.IvldGlBalance");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldGlBalanceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldGlBalancePersistence.getDataSource();
	...
	@BeanReference(type = IvldGlBalanceLocalService.class)
	protected IvldGlBalanceLocalService ivldGlBalanceLocalService;
