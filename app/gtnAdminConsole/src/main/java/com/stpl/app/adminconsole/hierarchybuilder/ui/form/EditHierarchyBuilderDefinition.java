...
public final class EditHierarchyBuilderDefinition extends CustomComponent implements View {
    ...
    public EditHierarchyBuilderDefinition(final BeanItemContainer<HierarchyBuilderLevelDTO> hierarchyBuilderLevelDTOBean, final HierarchyBuilderDTO hierarchyBuilderDTO) throws SystemException {
        ...
        init();
        getBinder();
        LOGGER.debug("EditHierarchyBuilderDefinition constructor Ended ");
    }
    ...
    private CustomFieldGroup getBinder() {
        ...
        LOGGER.debug("getBinder method RETURNS hierarchyBuilderBinder-Binder ");
        return hierarchyBuilderBinder;
    }
    ...
    private void configureFields() throws SystemException {
        ...
        excelExportLevels.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                LOGGER.debug("In configureFields excelExportLevels.addClickListener started");
                ...
                LOGGER.debug("In configureFields excelExportLevels.addClickListener Ended");
            }
        });
    ...
    private static CustomGridLayout addSpace() {
        ...
        LOGGER.debug("addSpace method Started ");
        gridLayout.addComponent(new Label(ConstantsUtils.EMPTY));
        LOGGER.debug("addSpace method Ended ");
        return gridLayout;
    }
    ...
    private Panel levelDefinitionSection() {
        LOGGER.debug("levelDefinitionSection Method started");
        final Panel panel = new Panel();
        ...
        LOGGER.debug("levelDefinitionSection Method returns panel");
        return panel;
    }
    ...
    public Button getBackButton() {
        LOGGER.debug("getBackButton Method started");
        ...
        LOGGER.debug("getBackButton Method Ended");
        return backButton;
    }
    ...
    private Component addrstButton() {
        ...
        btnReset.addClickListener(new Button.ClickListener() {
            ...
            @SuppressWarnings("PMD")
            public void buttonClick(final ClickEvent event) {
                LOGGER.debug("In addrstButton btnReset.addClickListener Started");
                if (event != null) {
                ...
                LOGGER.debug("In addrstButton btnReset.addClickListener Ended");
            }
        });
    ...
    public HorizontalLayout addLevelButtons() {
        LOGGER.debug("addLevelButtons method started ");
        final HorizontalLayout layout = new HorizontalLayout();
        ...
        LOGGER.debug("addLevelButtons method Returns Layout ");
        return layout;
    ...
    private Panel levelValueSection() {
        LOGGER.debug("levelValueSection method started ");
        ...
        panel.setContent(content);
        LOGGER.debug("levelValueSection method returns Panel");
        return panel;
    }
    ...
    public HorizontalLayout addValueButtons() {
        LOGGER.debug("addValueButtons method started ");
        final HorizontalLayout layout = new HorizontalLayout();
        layout.setSpacing(true);
        layout.setMargin(true);
        layout.addComponent(addLevelValues());
        layout.addComponent(deleteLevelValues());
        LOGGER.debug("addValueButtons method returns layout ");
        return layout;
    ...
    public ExtFilterTable levelDefinitionListTable() {
        ...
        levelDefinitionTable.addItemClickListener(new ItemClickEvent.ItemClickListener() {
            ...
            public void itemClick(final ItemClickEvent event) {
                ...
                if (event != null) {
                    LOGGER.debug("In levelDefinitionListTable levelDefinitionTable.addItemClickListener Started");
                    deleteRowFlag = false;
                    ...
                    LOGGER.debug("In levelDefinitionListTable levelDefinitionTable.addItemClickListener Ended");
                }
            }
        });
    ...
    private Button removeButton() {
        btnLevDelete.addClickListener(new ClickListener() {
            ...
            @SuppressWarnings("PMD")
            public void buttonClick(final ClickEvent event) {
                LOGGER.debug("In RemoveButton btnLevDelete.addClickListener Started");
                if (hierarchyBuilderLevelDTOBean.size() > ConstantsUtils.ZERO_NUM) {
                    if (deleteRowFlag) {
                ...
                LOGGER.debug("In RemoveButton btnLevDelete.addClickListener Ended");
            }
        });
        return btnLevDelete;
    }
