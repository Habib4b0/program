 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link NaProjMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link NaProjMasterImpl}.
 * </p>
 *
 * @author
...
public class NaProjMasterModelImpl extends BaseModelImpl<NaProjMaster>
	...
	static {
		TABLE_COLUMNS_MAP.put("NA_PROJ_NAME", Types.VARCHAR);
	...
	public Object clone() {
		...
		naProjMasterImpl.setBusinessUnit(getBusinessUnit());
	...
	public CacheModel<NaProjMaster> toCacheModel() {
		...
		naProjMasterCacheModel.businessUnit = getBusinessUnit();
	...
	private static final ClassLoader _classLoader = NaProjMaster.class.getClassLoader();
