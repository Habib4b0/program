 ...
 */
@ProviderType
public class NmActualPpaPK implements Comparable<NmActualPpaPK>, Serializable {
	public int periodSid;
	public int projectionDetailsSid;

	public NmActualPpaPK() {
	}

	public NmActualPpaPK(int periodSid, int projectionDetailsSid) {
	...
	@Override
	public int compareTo(NmActualPpaPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof NmActualPpaPK)) {
			return false;
		}

		NmActualPpaPK pk = (NmActualPpaPK)obj;
