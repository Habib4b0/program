...
public class RebatePlanLookup extends Window {
     ...
     * @throws Exception
     */
    public RebatePlanLookup() throws Exception {
        this.setModal(true);
         center();
        setClosable(true);
        setModal(true);
    ...
    private void configureFields() throws Exception  {      
        ...
        rebatePlanId.setMaxLength(38);
        rebatePlanId.addValidator(new StringLengthValidator(" Rebate Plan Id Should be less than 38 characters", 0, 38, true));

        rebatePlanNo.setImmediate(true);
        rebatePlanNo.setMaxLength(50);
        rebatePlanNo.addValidator(new StringLengthValidator(" Rebate Plan Id Should be less than 50 characters", 0, 50, true));

        rebatePlanName.setImmediate(true);
        rebatePlanName.setMaxLength(100);
        rebatePlanName.addValidator(new StringLengthValidator(" Rebate Plan Id Should be less than 38 characters", 0, 100, true));
