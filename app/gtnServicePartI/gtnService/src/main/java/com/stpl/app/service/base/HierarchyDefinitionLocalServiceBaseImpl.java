...
import com.stpl.app.service.HierarchyDefinitionLocalService;
...
/**
 * Provides the base implementation for the hierarchy definition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.HierarchyDefinitionLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class HierarchyDefinitionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements HierarchyDefinitionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.HierarchyDefinitionLocalServiceUtil} to access the hierarchy definition local service.
	 */
	...
	@Override
	public HierarchyDefinition addHierarchyDefinition(
		HierarchyDefinition hierarchyDefinition) {
		hierarchyDefinition.setNew(true);

		return hierarchyDefinitionPersistence.update(hierarchyDefinition);
	}
	 ...
	 */
	@Override
	public HierarchyDefinition createHierarchyDefinition(
		int hierarchyDefinitionSid) {
		return hierarchyDefinitionPersistence.create(hierarchyDefinitionSid);
	}
	...
	@Override
	public HierarchyDefinition deleteHierarchyDefinition(
		int hierarchyDefinitionSid) throws PortalException {
		return hierarchyDefinitionPersistence.remove(hierarchyDefinitionSid);
	}
	...
	public HierarchyDefinition deleteHierarchyDefinition(
		HierarchyDefinition hierarchyDefinition) {
		return hierarchyDefinitionPersistence.remove(hierarchyDefinition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(HierarchyDefinition.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return hierarchyDefinitionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return hierarchyDefinitionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public HierarchyDefinition fetchHierarchyDefinition(
		int hierarchyDefinitionSid) {
		return hierarchyDefinitionPersistence.fetchByPrimaryKey(hierarchyDefinitionSid);
	}
	...
	public HierarchyDefinition getHierarchyDefinition(
		int hierarchyDefinitionSid) throws PortalException {
		return hierarchyDefinitionPersistence.findByPrimaryKey(hierarchyDefinitionSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(hierarchyDefinitionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(HierarchyDefinition.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(hierarchyDefinitionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(HierarchyDefinition.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return hierarchyDefinitionLocalService.deleteHierarchyDefinition((HierarchyDefinition)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return hierarchyDefinitionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HierarchyDefinition> getHierarchyDefinitions(int start, int end) {
		return hierarchyDefinitionPersistence.findAll(start, end);
	}
	...
	public int getHierarchyDefinitionsCount() {
		return hierarchyDefinitionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HierarchyDefinition updateHierarchyDefinition(
		HierarchyDefinition hierarchyDefinition) {
		return hierarchyDefinitionPersistence.update(hierarchyDefinition);
	}
	 ...
	 */
	public HierarchyDefinitionLocalService getHierarchyDefinitionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.HierarchyDefinition",
			hierarchyDefinitionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HierarchyDefinitionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = hierarchyDefinitionPersistence.getDataSource();
	...
	@BeanReference(type = HierarchyDefinitionLocalService.class)
	protected HierarchyDefinitionLocalService hierarchyDefinitionLocalService;
