...
import com.stpl.app.service.IvldMasterDataAttributeLocalService;
...
/**
 * Provides the base implementation for the ivld master data attribute local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldMasterDataAttributeLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldMasterDataAttributeLocalServiceImpl
 * @see com.stpl.app.service.IvldMasterDataAttributeLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldMasterDataAttributeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldMasterDataAttributeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldMasterDataAttributeLocalServiceUtil} to access the ivld master data attribute local service.
	 */
	...
	@Override
	public IvldMasterDataAttribute addIvldMasterDataAttribute(
		IvldMasterDataAttribute ivldMasterDataAttribute) {
		ivldMasterDataAttribute.setNew(true);

		return ivldMasterDataAttributePersistence.update(ivldMasterDataAttribute);
	}
	 ...
	 */
	@Override
	public IvldMasterDataAttribute createIvldMasterDataAttribute(
		int ivldMasterDataAtbteSid) {
		return ivldMasterDataAttributePersistence.create(ivldMasterDataAtbteSid);
	}
	...
	@Override
	public IvldMasterDataAttribute deleteIvldMasterDataAttribute(
		int ivldMasterDataAtbteSid) throws PortalException {
		return ivldMasterDataAttributePersistence.remove(ivldMasterDataAtbteSid);
	}
	...
	public IvldMasterDataAttribute deleteIvldMasterDataAttribute(
		IvldMasterDataAttribute ivldMasterDataAttribute) {
		return ivldMasterDataAttributePersistence.remove(ivldMasterDataAttribute);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldMasterDataAttribute.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldMasterDataAttributePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldMasterDataAttributePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldMasterDataAttribute fetchIvldMasterDataAttribute(
		int ivldMasterDataAtbteSid) {
		return ivldMasterDataAttributePersistence.fetchByPrimaryKey(ivldMasterDataAtbteSid);
	}
	 ...
	 */
	@Override
	public IvldMasterDataAttribute getIvldMasterDataAttribute(
		int ivldMasterDataAtbteSid) throws PortalException {
		return ivldMasterDataAttributePersistence.findByPrimaryKey(ivldMasterDataAtbteSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldMasterDataAttributeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldMasterDataAttribute.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldMasterDataAttributeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldMasterDataAttribute.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldMasterDataAttributeLocalService.deleteIvldMasterDataAttribute((IvldMasterDataAttribute)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldMasterDataAttributePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldMasterDataAttribute> getIvldMasterDataAttributes(
		int start, int end) {
		return ivldMasterDataAttributePersistence.findAll(start, end);
	}
	...
	public int getIvldMasterDataAttributesCount() {
		return ivldMasterDataAttributePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldMasterDataAttribute updateIvldMasterDataAttribute(
		IvldMasterDataAttribute ivldMasterDataAttribute) {
		return ivldMasterDataAttributePersistence.update(ivldMasterDataAttribute);
	}
	 ...
	 */
	public IvldMasterDataAttributeLocalService getIvldMasterDataAttributeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.IvldMasterDataAttribute",
			ivldMasterDataAttributeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.IvldMasterDataAttribute");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldMasterDataAttributeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldMasterDataAttributePersistence.getDataSource();
	...
	@BeanReference(type = IvldMasterDataAttributeLocalService.class)
	protected IvldMasterDataAttributeLocalService ivldMasterDataAttributeLocalService;
