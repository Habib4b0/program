...
import com.stpl.app.parttwo.service.StArpOutboundLocalService;
...
/**
 * Provides the base implementation for the st arp outbound local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.StArpOutboundLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.StArpOutboundLocalServiceImpl
 * @see com.stpl.app.parttwo.service.StArpOutboundLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StArpOutboundLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StArpOutboundLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.StArpOutboundLocalServiceUtil} to access the st arp outbound local service.
	 */
	...
	@Override
	public StArpOutbound addStArpOutbound(StArpOutbound stArpOutbound) {
		stArpOutbound.setNew(true);

		return stArpOutboundPersistence.update(stArpOutbound);
	}
	 ...
	 */
	@Override
	public StArpOutbound createStArpOutbound(StArpOutboundPK stArpOutboundPK) {
		return stArpOutboundPersistence.create(stArpOutboundPK);
	}
	...
	@Override
	public StArpOutbound deleteStArpOutbound(StArpOutboundPK stArpOutboundPK)
		throws PortalException {
		return stArpOutboundPersistence.remove(stArpOutboundPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StArpOutbound deleteStArpOutbound(StArpOutbound stArpOutbound) {
		return stArpOutboundPersistence.remove(stArpOutbound);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StArpOutbound.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stArpOutboundPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stArpOutboundPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StArpOutbound fetchStArpOutbound(StArpOutboundPK stArpOutboundPK) {
		return stArpOutboundPersistence.fetchByPrimaryKey(stArpOutboundPK);
	}
	 ...
	 */
	@Override
	public StArpOutbound getStArpOutbound(StArpOutboundPK stArpOutboundPK)
		throws PortalException {
		return stArpOutboundPersistence.findByPrimaryKey(stArpOutboundPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stArpOutboundLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StArpOutbound.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName(
			"primaryKey.companyMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(stArpOutboundLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StArpOutbound.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stArpOutboundLocalService.deleteStArpOutbound((StArpOutbound)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stArpOutboundPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StArpOutbound> getStArpOutbounds(int start, int end) {
		return stArpOutboundPersistence.findAll(start, end);
	}
	...
	public int getStArpOutboundsCount() {
		return stArpOutboundPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StArpOutbound updateStArpOutbound(StArpOutbound stArpOutbound) {
		return stArpOutboundPersistence.update(stArpOutbound);
	}
	 ...
	 */
	public StArpOutboundLocalService getStArpOutboundLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.StArpOutbound",
			stArpOutboundLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.StArpOutbound");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StArpOutboundLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stArpOutboundPersistence.getDataSource();
	...
	@BeanReference(type = StArpOutboundLocalService.class)
	protected StArpOutboundLocalService stArpOutboundLocalService;
