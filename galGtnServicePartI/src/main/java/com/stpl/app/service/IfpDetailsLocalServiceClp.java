 ...
 * @generated
 */
public class IfpDetailsLocalServiceClp implements IfpDetailsLocalService {
    ...
    public IfpDetailsLocalServiceClp(
        ...
        _methodName19 = "findByItemFamilyPlanDetails";
    ...
    public com.stpl.app.model.IfpDetails addIfpDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(ifpDetails) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.IfpDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.IfpDetails createIfpDetails(int ifpDetailsSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { ifpDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IfpDetails deleteIfpDetails(int ifpDetailsSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { ifpDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IfpDetails fetchIfpDetails(int ifpDetailsSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { ifpDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IfpDetails getIfpDetails(int ifpDetailsSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { ifpDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.IfpDetails> getIfpDetailses(
        ...
        return (java.util.List<com.stpl.app.model.IfpDetails>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.stpl.app.model.IfpDetails> findByItemFamilyPlanDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { ifpModelSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
