...
public class DeductionTableGenerator extends DefaultFieldFactory {
    ...
    public DeductionTableGenerator(ExtPagedTable table, final SessionDTO sessionDTO, Deductions deductions) {
    ...
    public Field<?> createField(final Container container, final Object itemId, final Object propertyId, final Component uiContext) {
        ...
        final NetSalesRuleLookUp formulaNameLookup = new NetSalesRuleLookUp(new CustomTextField(),"Deduction");
        ...
        if ("selectedCheck".equals(propertyId)) {
            ...
            checkbox.addValueChangeListener(new Property.ValueChangeListener() {
                public void valueChange(Property.ValueChangeEvent event) {
                    try {
                        logic.updateTempTable((boolean) event.getProperty().getValue(), (DeductionDto) itemId);
        ...
        if (ConstantsUtils.NET_SALES_RULENO.equals(propertyId)) {
            ...
            final NetSalesRuleLookUp formulaLookup = new NetSalesRuleLookUp(formulaNo,"Deduction");
        ...
        if (ConstantsUtils.NET_SALES_RULE_NAME.equals(propertyId)) {
            ...
            if (list != null) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    formulaNameLookup.ruleType.setValue(helperListUtil.getIdHelperDTOMap().get(obj[NumericConstants.TWO] != null ? Integer.valueOf(String.valueOf(obj[NumericConstants.TWO])) : 0));
                    formulaNameLookup.ruleCategory.setValue(helperListUtil.getIdHelperDTOMap().get(obj[NumericConstants.THREE] != null ? Integer.valueOf(String.valueOf(obj[NumericConstants.THREE])) : 0));
                    formulaNameLookup.configureSearchdata(obj[NumericConstants.FOUR] != null ? String.valueOf(obj[NumericConstants.FOUR]) : StringUtils.EMPTY);
                }
            }
            LOGGER.debug("Entering NetSales Rule Name pop up upadate");
...
//                   
            ...
            netSalesRuleName.addValueChangeListener(new Property.ValueChangeListener() {
                @Override
                public void valueChange(Property.ValueChangeEvent event) {
                    LOGGER.debug("Entering NetSales Rule Name value Change");
                    ...
                    LOGGER.debug("Entering NetSales Rule Name pop up update");
                    formulaNameLookup.disableComponents(false);
                }
            });
