...
public class NetPriceTypeFormulaLookup extends Window {
     ...
     * @throws Exception 
     */
    public NetPriceTypeFormulaLookup() throws Exception {
        this.itemId = "%";
        init();
    }
    
    public NetPriceTypeFormulaLookup(CustomTextField tierFormula) throws Exception {
     ...
     * @throws Exception 
     */
    public NetPriceTypeFormulaLookup(String itemId) throws Exception {
        this.itemId = itemId;
