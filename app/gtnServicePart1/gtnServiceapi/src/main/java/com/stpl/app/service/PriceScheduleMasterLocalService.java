...
/**
 * Provides the local service interface for PriceScheduleMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see PriceScheduleMasterLocalServiceUtil
 * @see com.stpl.app.service.base.PriceScheduleMasterLocalServiceBaseImpl
 * @see com.stpl.app.service.impl.PriceScheduleMasterLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface PriceScheduleMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PriceScheduleMasterLocalServiceUtil} to access the price schedule master local service. Add custom service methods to {@link com.stpl.app.service.impl.PriceScheduleMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public PriceScheduleMaster addPriceScheduleMaster(
	...
	*/
	public PriceScheduleMaster createPriceScheduleMaster(
	...
	*/
	...
	public PriceScheduleMaster deletePriceScheduleMaster(
		int priceScheduleSystemId) throws PortalException;
	...
	*/
	...
	public PriceScheduleMaster fetchPriceScheduleMaster(
		int priceScheduleSystemId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PriceScheduleMaster getPriceScheduleMaster(int priceScheduleSystemId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PriceScheduleMaster> getPriceScheduleMasters(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public PriceScheduleMaster updatePriceScheduleMaster(
		PriceScheduleMaster priceScheduleMaster);
}