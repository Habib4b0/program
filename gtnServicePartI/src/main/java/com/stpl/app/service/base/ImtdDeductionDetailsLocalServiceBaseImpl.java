...
public abstract class ImtdDeductionDetailsLocalServiceBaseImpl
    ...
    private ImtdDeductionDetailsLocalServiceClpInvoker _clpInvoker = new ImtdDeductionDetailsLocalServiceClpInvoker();
    ...
    public ImtdDeductionDetails deleteImtdDeductionDetails(
        int imtdDeductionDetailsSid) throws PortalException, SystemException {
    ...
    public ImtdDeductionDetails fetchImtdDeductionDetails(
        int imtdDeductionDetailsSid) throws SystemException {
     ...
     */
    @Override
    public int getImtdDeductionDetailsesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ImtdDeductionDetails",
