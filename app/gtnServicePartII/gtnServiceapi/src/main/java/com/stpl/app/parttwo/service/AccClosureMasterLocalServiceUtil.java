...
public class AccClosureMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<AccClosureMasterLocalService, AccClosureMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AccClosureMasterLocalService.class);
}