...
import com.stpl.app.service.VwUserTablesLocalService;
...
/**
 * Provides the base implementation for the vw user tables local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.VwUserTablesLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.VwUserTablesLocalServiceImpl
 * @see com.stpl.app.service.VwUserTablesLocalServiceUtil
 * @generated
 */
public abstract class VwUserTablesLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements VwUserTablesLocalService,
        IdentifiableBean {
    ...
    private VwUserTablesLocalServiceClpInvoker _clpInvoker = new VwUserTablesLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.VwUserTablesLocalServiceUtil} to access the vw user tables local service.
     */
    ...
    @Override
    public VwUserTables addVwUserTables(VwUserTables vwUserTables)
        throws SystemException {
        vwUserTables.setNew(true);

        return vwUserTablesPersistence.update(vwUserTables);
    }
     ...
     */
    @Override
    public VwUserTables createVwUserTables(int uniqueId) {
        return vwUserTablesPersistence.create(uniqueId);
    }
    ...
    @Override
    public VwUserTables deleteVwUserTables(int uniqueId)
        throws PortalException, SystemException {
        return vwUserTablesPersistence.remove(uniqueId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public VwUserTables deleteVwUserTables(VwUserTables vwUserTables)
        throws SystemException {
        return vwUserTablesPersistence.remove(vwUserTables);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(VwUserTables.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwUserTablesPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwUserTablesPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public VwUserTables fetchVwUserTables(int uniqueId)
        throws SystemException {
        return vwUserTablesPersistence.fetchByPrimaryKey(uniqueId);
    }
     ...
     */
    @Override
    public VwUserTables getVwUserTables(int uniqueId)
        throws PortalException, SystemException {
        return vwUserTablesPersistence.findByPrimaryKey(uniqueId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return vwUserTablesPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<VwUserTables> getVwUserTableses(int start, int end)
        throws SystemException {
        return vwUserTablesPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getVwUserTablesesCount() throws SystemException {
        return vwUserTablesPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public VwUserTables updateVwUserTables(VwUserTables vwUserTables)
        throws SystemException {
        return vwUserTablesPersistence.update(vwUserTables);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.VwUserTables",
            vwUserTablesLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.VwUserTables");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = vwUserTablesPersistence.getDataSource();
