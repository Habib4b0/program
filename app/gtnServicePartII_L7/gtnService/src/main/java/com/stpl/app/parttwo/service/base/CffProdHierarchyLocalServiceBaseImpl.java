...
import com.stpl.app.parttwo.service.CffProdHierarchyLocalService;
...
/**
 * Provides the base implementation for the cff prod hierarchy local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.CffProdHierarchyLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.CffProdHierarchyLocalServiceImpl
 * @see com.stpl.app.parttwo.service.CffProdHierarchyLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CffProdHierarchyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CffProdHierarchyLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.CffProdHierarchyLocalServiceUtil} to access the cff prod hierarchy local service.
	 */
	...
	public CffProdHierarchy addCffProdHierarchy(
		...
		return cffProdHierarchyPersistence.update(cffProdHierarchy);
	}
	...
	public CffProdHierarchy createCffProdHierarchy(int cffProdHierarchySid) {
		return cffProdHierarchyPersistence.create(cffProdHierarchySid);
	}
	...
	public CffProdHierarchy deleteCffProdHierarchy(int cffProdHierarchySid)
		...
		return cffProdHierarchyPersistence.remove(cffProdHierarchySid);
	}
	...
	public CffProdHierarchy deleteCffProdHierarchy(
		CffProdHierarchy cffProdHierarchy) {
		return cffProdHierarchyPersistence.remove(cffProdHierarchy);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CffProdHierarchy.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cffProdHierarchyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cffProdHierarchyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CffProdHierarchy fetchCffProdHierarchy(int cffProdHierarchySid) {
		return cffProdHierarchyPersistence.fetchByPrimaryKey(cffProdHierarchySid);
	}
	...
	public CffProdHierarchy getCffProdHierarchy(int cffProdHierarchySid)
		throws PortalException {
		return cffProdHierarchyPersistence.findByPrimaryKey(cffProdHierarchySid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cffProdHierarchyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CffProdHierarchy.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("cffProdHierarchySid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cffProdHierarchyLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CffProdHierarchy.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cffProdHierarchyLocalService.deleteCffProdHierarchy((CffProdHierarchy)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cffProdHierarchyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CffProdHierarchy> getCffProdHierarchies(int start, int end) {
		return cffProdHierarchyPersistence.findAll(start, end);
	}
	...
	public int getCffProdHierarchiesCount() {
		return cffProdHierarchyPersistence.countAll();
	}
	 ...
	 */
	public CffProdHierarchyLocalService getCffProdHierarchyLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.CffProdHierarchy",
			cffProdHierarchyLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CffProdHierarchyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cffProdHierarchyPersistence.getDataSource();
	...
	@BeanReference(type = CffProdHierarchyLocalService.class)
	protected CffProdHierarchyLocalService cffProdHierarchyLocalService;
