...
public class StNmDiscountProjMasterLocalServiceUtil {
    private static StNmDiscountProjMasterLocalService _service;
    ...
    */
    ...
    public static StNmDiscountProjMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StNmDiscountProjMasterLocalService.class.getName());

            if (invokableLocalService instanceof StNmDiscountProjMasterLocalService) {
                _service = (StNmDiscountProjMasterLocalService) invokableLocalService;
            } else {
                _service = new StNmDiscountProjMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StNmDiscountProjMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StNmDiscountProjMasterLocalService service) {
    }
}
