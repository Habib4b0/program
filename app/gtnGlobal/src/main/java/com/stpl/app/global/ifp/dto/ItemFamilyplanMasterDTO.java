 ...
 */
public class ItemFamilyplanMasterDTO implements Serializable{
	...
	private HelperDTO itemFamilyplanStatus = new HelperDTO(0, ConstantsUtils.SELECT_ONE);
        ...
        private String itemFamilyplanStatusValue= StringUtils.EMPTY;

	
	/** The item familyplan category. */
	private HelperDTO itemFamilyplanCategory = new HelperDTO(0, ConstantsUtils.SELECT_ONE);
        
        private String itemFamilyplanCategoryValue= StringUtils.EMPTY;
	...
	private HelperDTO itemFamilyplanType = new HelperDTO(0, ConstantsUtils.SELECT_ONE);
        ...
        private String itemFamilyplanTypeValue= StringUtils.EMPTY;     
	...
	private HelperDTO itemFamilyplanDesignation = new HelperDTO(0, ConstantsUtils.SELECT_ONE);
        ...
        private String itemFamilyplanDesignationValue= StringUtils.EMPTY;
	 ...
	 */
	public void setItemFamilyplanCategory(final HelperDTO itemFamilyplanCategory) {
	 ...
	 */
	public void setItemFamilyplanType(final HelperDTO itemFamilyplanType) {
	 ...
	 */
	public void setItemFamilyplanDesignation(final HelperDTO itemFamilyplanDesignation) {
    ...
    public String getItemFamilyplanCategoryValue() {
        return itemFamilyplanCategoryValue;
    }

    public void setItemFamilyplanCategoryValue(String itemFamilyplanCategoryValue) {
        this.itemFamilyplanCategoryValue = itemFamilyplanCategoryValue;
    }
    ...
    public String getItemFamilyplanStatusValue() {
        return itemFamilyplanStatusValue;
    }

    public String getItemFamilyplanTypeValue() {
        return itemFamilyplanTypeValue;
    }

    public void setItemFamilyplanTypeValue(String itemFamilyplanTypeValue) {
        this.itemFamilyplanTypeValue = itemFamilyplanTypeValue;
    }

    public String getItemFamilyplanDesignationValue() {
        return itemFamilyplanDesignationValue;
    }

    public void setItemFamilyplanDesignationValue(String itemFamilyplanDesignationValue) {
        this.itemFamilyplanDesignationValue = itemFamilyplanDesignationValue;
    }

    public void setItemFamilyplanStatusValue(String itemFamilyplanStatusValue) {
        this.itemFamilyplanStatusValue = itemFamilyplanStatusValue;
    }
