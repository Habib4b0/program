...
public class AdditionalInformation extends CustomComponent implements View {
     ...
     * The module name.
     */
    private final static String GTNMODULENAME = "GTN";
    /**
     * The error msg.
     */
     ...
     * The file name.
     */
    private final static String FILENAME = "Notes_History_GTN_Balance";
    /**
     * The move back
     */
    /**
    ...
    public Component getContent() {
        ...
        layout.addComponent(Clara.create(getClass().getResourceAsStream("/gtnBalanceAdditionalInfo.xml"), this));
