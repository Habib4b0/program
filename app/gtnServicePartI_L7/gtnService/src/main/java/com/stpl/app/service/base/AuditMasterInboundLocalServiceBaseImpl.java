...
import com.stpl.app.service.AuditMasterInboundLocalService;
...
/**
 * Provides the base implementation for the audit master inbound local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.AuditMasterInboundLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.AuditMasterInboundLocalServiceImpl
 * @see com.stpl.app.service.AuditMasterInboundLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AuditMasterInboundLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AuditMasterInboundLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.AuditMasterInboundLocalServiceUtil} to access the audit master inbound local service.
	 */
	...
	@Override
	public AuditMasterInbound addAuditMasterInbound(
		AuditMasterInbound auditMasterInbound) {
		auditMasterInbound.setNew(true);

		return auditMasterInboundPersistence.update(auditMasterInbound);
	}
	 ...
	 */
	@Override
	public AuditMasterInbound createAuditMasterInbound(int auditInboundSid) {
		return auditMasterInboundPersistence.create(auditInboundSid);
	}
	...
	@Override
	public AuditMasterInbound deleteAuditMasterInbound(int auditInboundSid)
		throws PortalException {
		return auditMasterInboundPersistence.remove(auditInboundSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AuditMasterInbound deleteAuditMasterInbound(
		AuditMasterInbound auditMasterInbound) {
		return auditMasterInboundPersistence.remove(auditMasterInbound);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AuditMasterInbound.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return auditMasterInboundPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return auditMasterInboundPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AuditMasterInbound fetchAuditMasterInbound(int auditInboundSid) {
		return auditMasterInboundPersistence.fetchByPrimaryKey(auditInboundSid);
	}
	 ...
	 */
	@Override
	public AuditMasterInbound getAuditMasterInbound(int auditInboundSid)
		throws PortalException {
		return auditMasterInboundPersistence.findByPrimaryKey(auditInboundSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(auditMasterInboundLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AuditMasterInbound.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("auditInboundSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(auditMasterInboundLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AuditMasterInbound.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return auditMasterInboundLocalService.deleteAuditMasterInbound((AuditMasterInbound)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return auditMasterInboundPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AuditMasterInbound> getAuditMasterInbounds(int start, int end) {
		return auditMasterInboundPersistence.findAll(start, end);
	}
	...
	public int getAuditMasterInboundsCount() {
		return auditMasterInboundPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AuditMasterInbound updateAuditMasterInbound(
		AuditMasterInbound auditMasterInbound) {
		return auditMasterInboundPersistence.update(auditMasterInbound);
	}
	 ...
	 */
	public AuditMasterInboundLocalService getAuditMasterInboundLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.AuditMasterInbound",
			auditMasterInboundLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.AuditMasterInbound");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AuditMasterInboundLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = auditMasterInboundPersistence.getDataSource();
	...
	@BeanReference(type = AuditMasterInboundLocalService.class)
	protected AuditMasterInboundLocalService auditMasterInboundLocalService;
