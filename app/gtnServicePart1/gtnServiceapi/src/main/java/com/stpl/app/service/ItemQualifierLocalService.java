...
/**
 * Provides the local service interface for ItemQualifier. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ItemQualifierLocalServiceUtil
...
public interface ItemQualifierLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ItemQualifierLocalServiceUtil} to access the item qualifier local service. Add custom service methods to {@link com.stpl.app.service.impl.ItemQualifierLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
