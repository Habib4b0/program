...
public class StFederalNewNdcLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<StFederalNewNdcLocalService, StFederalNewNdcLocalService> _serviceTracker =
		ServiceTrackerFactory.open(StFederalNewNdcLocalService.class);
}