...
-------------------------------- CHECK_RECORD COLUMN ADDITION IN DEDUCTION_DETAILS TABLE ----------------------------------
...
IF NOT EXISTS (SELECT 1
			   ...
			   WHERE TABLE_NAME = 'DEDUCTION_DETAILS'
					 ...
					 AND TABLE_SCHEMA = 'DBO')
  BEGIN
	ALTER TABLE DEDUCTION_DETAILS ADD CHECK_RECORD BIT
	END

GO


-------------------------------- INDICATOR_STRING COLUMN ADDITION IN IMTD_DEDUCTION_DETAILS TABLE ----------------------------------    
IF NOT EXISTS (SELECT 1
			   FROM INFORMATION_SCHEMA.COLUMNS
			   WHERE TABLE_NAME = 'IMTD_DEDUCTION_DETAILS'
			         AND COLUMN_NAME = 'INDICATOR_STRING'
					 AND TABLE_SCHEMA = 'DBO')
  BEGIN
	ALTER TABLE IMTD_DEDUCTION_DETAILS ADD INDICATOR_STRING VARCHAR(10)
  END
