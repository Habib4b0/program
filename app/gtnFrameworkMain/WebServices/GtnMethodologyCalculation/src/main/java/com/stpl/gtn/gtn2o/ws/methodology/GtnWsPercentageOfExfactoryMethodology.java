...
public class GtnWsPercentageOfExfactoryMethodology implements GtnWsMethodology {
	...
	public void calculateBaseline() {
		try {
			GtnWsBaseline baseline = GtnWsBaselineType.PERCENTAGE_OF_EXFACTORY.getBaseline();
	...
	/**
	 * Method reads the files required and stores it as List in
	 * GtnWsMethodologyBean.
	 * 
	 * @param methodologyBean
	 * @throws Exception
	 */
