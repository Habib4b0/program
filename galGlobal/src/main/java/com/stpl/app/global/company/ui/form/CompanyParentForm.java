...
public class CompanyParentForm extends StplCustomComponent {
    ...
    public Component getContent(ErrorfulFieldGroup binder, final BeanItemContainer<CompanyMasterDTO> parentCompanyResultsBean, SessionDTO sessionDTO) {
        ...
        try {
            ...
            final Map<String, AppPermission> fieldCompanyHM = stplSecurity.getFieldOrColumnPermission(userId, UISecurityUtil.COMPANY_MASTER+ConstantsUtils.COMMA+"Parent Company",false);
            final Map<String, AppPermission> functionHM = stplSecurity.getBusinessFunctionPermission(userId, UISecurityUtil.COMPANY_MASTER+ConstantsUtils.COMMA+"Parent Company");
    ...
    private void configurePermission(final Map<String, AppPermission> fieldCompanyHM, final Map<String, AppPermission> functionHM) {
        ...
        List<Object> resultList = ifpLogic.getFieldsForSecurity(UISecurityUtil.COMPANY_MASTER,"Parent Company");
    ...
    public void configureFields() throws PortalException, SystemException, Exception {
        ...
        parentCompanyNo.addValidator(new RegexpValidator(ValidationUtils.specialCharacter, ValidationUtils.specialCharacterMessage));
        parentCompanyNo.addValidator(new StringLengthValidator("Parent Company No Should be less than 50 characters", 0, 50, true));
        ...
        final StplSecurity stplSecurity = new StplSecurity();
        String userId = String.valueOf(VaadinSession.getCurrent().getAttribute(ConstantsUtils.USER_ID));
        final Map<String, AppPermission> fieldIfpHM = stplSecurity.getFieldOrColumnPermission(userId, UISecurityUtil.COMPANY_MASTER+ConstantsUtils.COMMA+"Parent Company",false);
        ...
        parentDetailsTable.setPageLength(3);
                        ...
                        public void click(CustomTextField.ClickEvent event) {
                            try {
                                ...
                                lookUp.addCloseListener(new Window.CloseListener() {
                                    ...
                                    public void windowClose(final Window.CloseEvent e) {
                                        if (itemId != null) {
                                            if (!sessionDTO.getParentLookUpId().equals("0000")) {
        ...
        attachButton.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                try {
                    ...
                    if(parentCompanyNo.getValue().equals(selectedId))
                    ...
                    if (flag) {
                        ...
                        if (identForm.getParentStartDate() == null) {
                                binder.getErrorDisplay().setError("Parent Company Start Date is Mandatory in Parent Company Tab");
                                return;
                            }
    ...
    public void addResponsiveVerticalTabFiveLayout(final VerticalLayout verticalLayout) {
        ...
        reloadVerticalLayoutTabFiveMap.put(1516, true);
        reloadVerticalLayoutTabFiveMap.put(1300, true);
        reloadVerticalLayoutTabFiveMap.put(1024, true);
        reloadVerticalLayoutTabFiveMap.put(978, true);
        reloadVerticalLayoutTabFiveMap.put(800, true);
        reloadVerticalLayoutTabFiveMap.put(480, true);
        reloadVerticalLayoutTabFiveMap.put(380, true);
        ...
        Page.getCurrent().addBrowserWindowResizeListener(
                new Page.BrowserWindowResizeListener() {
                    ...
                    public void browserWindowResized(
                        ...
                        if (browserWidth > 1516 && reloadVerticalLayoutTabFiveMap.get(1516)) {
                            reloadVerticalLayoutTabFiveMap.put(1516, false);
                            reloadVerticalLayoutTabFiveMap.put(1300, true);
                            reloadVerticalLayoutTabFiveMap.put(1024, true);
                            reloadVerticalLayoutTabFiveMap.put(978, true);
                            reloadVerticalLayoutTabFiveMap.put(800, true);
                        ...
                        } else if (browserWidth < 1516 && browserWidth > 1300 && reloadVerticalLayoutTabFiveMap.get(1300)) {
                            reloadVerticalLayoutTabFiveMap.put(1516, true);
                            reloadVerticalLayoutTabFiveMap.put(1300, false);
                            reloadVerticalLayoutTabFiveMap.put(1024, true);
                            reloadVerticalLayoutTabFiveMap.put(978, true);
                            reloadVerticalLayoutTabFiveMap.put(800, true);
                            reloadVerticalLayoutTabFiveMap.put(480, true);
                            ...
                            reloadVerticalLayoutTabFiveMap.put(0, true);
                            getCollapsibleColumnsDefault(parentDetailsTable);
                        } else if (browserWidth < 1300 && browserWidth > 1024 && reloadVerticalLayoutTabFiveMap.get(1024)) {
                            reloadVerticalLayoutTabFiveMap.put(1516, true);
                            reloadVerticalLayoutTabFiveMap.put(1300, true);
                            reloadVerticalLayoutTabFiveMap.put(1024, false);
                            reloadVerticalLayoutTabFiveMap.put(978, true);
                            reloadVerticalLayoutTabFiveMap.put(800, true);
                            reloadVerticalLayoutTabFiveMap.put(480, true);
                            reloadVerticalLayoutTabFiveMap.put(380, true);
                            reloadVerticalLayoutTabFiveMap.put(0, true);
                        } else if (browserWidth < 1024 && browserWidth > 978 && reloadVerticalLayoutTabFiveMap.get(978)) {
                            reloadVerticalLayoutTabFiveMap.put(1516, true);
                            reloadVerticalLayoutTabFiveMap.put(1300, true);
                            reloadVerticalLayoutTabFiveMap.put(1024, true);
                            reloadVerticalLayoutTabFiveMap.put(978, false);
                            reloadVerticalLayoutTabFiveMap.put(800, true);
                            reloadVerticalLayoutTabFiveMap.put(480, true);
                            reloadVerticalLayoutTabFiveMap.put(380, true);
                            reloadVerticalLayoutTabFiveMap.put(0, true);
                        } else if (browserWidth < 978 && browserWidth > 800 && reloadVerticalLayoutTabFiveMap.get(800)) {
                            reloadVerticalLayoutTabFiveMap.put(1516, true);
                            reloadVerticalLayoutTabFiveMap.put(1300, true);
                            reloadVerticalLayoutTabFiveMap.put(1024, true);
                            reloadVerticalLayoutTabFiveMap.put(978, true);
                            reloadVerticalLayoutTabFiveMap.put(800, false);
                            reloadVerticalLayoutTabFiveMap.put(480, true);
                            reloadVerticalLayoutTabFiveMap.put(380, true);
                            reloadVerticalLayoutTabFiveMap.put(0, true);

                        } else if (browserWidth <= 800 && browserWidth > 480 && reloadVerticalLayoutTabFiveMap.get(480)) {
                            reloadVerticalLayoutTabFiveMap.put(1516, true);
                            reloadVerticalLayoutTabFiveMap.put(1300, true);
                            reloadVerticalLayoutTabFiveMap.put(1024, true);
                            reloadVerticalLayoutTabFiveMap.put(978, true);
                            reloadVerticalLayoutTabFiveMap.put(800, true);
                            reloadVerticalLayoutTabFiveMap.put(480, false);
                            reloadVerticalLayoutTabFiveMap.put(380, true);
                            reloadVerticalLayoutTabFiveMap.put(0, true);
                        } else if (browserWidth < 480 && browserWidth > 380 && reloadVerticalLayoutTabFiveMap.get(380)) {
                            reloadVerticalLayoutTabFiveMap.put(1516, true);
                            reloadVerticalLayoutTabFiveMap.put(1300, true);
                            reloadVerticalLayoutTabFiveMap.put(1024, true);
                            reloadVerticalLayoutTabFiveMap.put(978, true);
                            reloadVerticalLayoutTabFiveMap.put(800, true);
                            reloadVerticalLayoutTabFiveMap.put(480, true);
                            reloadVerticalLayoutTabFiveMap.put(380, false);
                            reloadVerticalLayoutTabFiveMap.put(0, true);
                            getCollapsibleOneColumn(parentDetailsTable);
                        } else if (browserWidth < 380 && reloadVerticalLayoutTabFiveMap.get(0)) {
