...
public class AccrualMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<AccrualMasterLocalService, AccrualMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AccrualMasterLocalService.class);
}