...
/**
 * The Class ExtFilterTreeTable.
 *
 * @author Abhiram
 */

@SuppressWarnings("serial")
public class ExtFilterTreeTable extends ExtCustomTreeTable implements IFilterTable {
     ...
     */
    public ExtFilterTreeTable(String caption) {
        super(caption);
     ...
     */
    protected class CollapsibleStrategy extends ExtCustomTreeTable.CollapsibleStrategy{
     ...
     */
    protected class HierarchicalStrategy extends ExtCustomTreeTable.HierarchicalStrategy{
    ...
    /**
     * Removes the filter value change listeners.
     */
    public void removeFilterValueChangeListeners(){
        generator.removeValueChangeListeners();
    }
    
    /**
     * Adds the filter value change listeners.
     */
    public void addFilterValueChangeListeners(){
        generator.addValueChangeListeners();
    }
    /**
