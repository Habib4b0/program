...
/**
 * Provides the local service interface for HistCompanyGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see HistCompanyGroupLocalServiceUtil
...
public interface HistCompanyGroupLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link HistCompanyGroupLocalServiceUtil} to access the hist company group local service. Add custom service methods to {@link com.stpl.app.service.impl.HistCompanyGroupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
