...
/**
 * The persistence utility for the cff master service. This utility wraps {@link com.stpl.app.parttwo.service.persistence.impl.CffMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CffMasterUtil {
	...
	*/
	public static void cacheResult(CffMaster cffMaster) {
	...
	*/
	public static void cacheResult(List<CffMaster> cffMasters) {
	...
	*/
	public static CffMaster create(int cffMasterSid) {
	...
	*/
	public static CffMaster remove(int cffMasterSid)
		throws com.stpl.app.parttwo.exception.NoSuchCffMasterException {
		return getPersistence().remove(cffMasterSid);
	}

	public static CffMaster updateImpl(CffMaster cffMaster) {
	...
	* @throws NoSuchCffMasterException if a cff master with the primary key could not be found
	*/
	public static CffMaster findByPrimaryKey(int cffMasterSid)
		throws com.stpl.app.parttwo.exception.NoSuchCffMasterException {
	...
	*/
	public static CffMaster fetchByPrimaryKey(int cffMasterSid) {
		return getPersistence().fetchByPrimaryKey(cffMasterSid);
	}

	public static java.util.Map<java.io.Serializable, CffMaster> fetchByPrimaryKeys(
	...
	*/
	public static List<CffMaster> findAll() {
	...
	*/
	public static List<CffMaster> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<CffMasterPersistence, CffMasterPersistence> _serviceTracker =
		ServiceTrackerFactory.open(CffMasterPersistence.class);
}