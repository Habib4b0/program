package com.stpl.gtn.gtn2o.ws.periodconf.constants;

public class GtnWsPeriodConfigurationConstants {
	private GtnWsPeriodConfigurationConstants() {
		super();
	}

	public static final String GTN_PERIOD_DATE_FORMAT = "yyyy-mm-dd HH:mm:ss.SSSZ";
	public static final String GTN_PERIOD_SID_DATE_FORMAT = "yyyy-mm-dd";
