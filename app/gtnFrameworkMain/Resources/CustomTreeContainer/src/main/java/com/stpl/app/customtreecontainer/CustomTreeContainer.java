 ...
 * @param <BEANTYPE>
 */
public class CustomTreeContainer<BEANTYPE> extends CustomContainer<BEANTYPE> implements
        Hierarchical {
    ...
    public CustomTreeContainer(Class<? super BEANTYPE> type)
...
//    }
//    public CustomTreeContainer(Collection<? extends BEANTYPE> collection)
//            throws IllegalArgumentException {
//        super(collection);
//    }
    ...
    public BeanItem<BEANTYPE> addItem(Object itemId) {
        ...
        try {
            ...
            BeanInfo info = Introspector.getBeanInfo(itemId.getClass());
                ...
                if (descriptior.getPropertyType() != null && !descriptior.getPropertyType().equals(Class.class)) {
                    if (descriptior.getPropertyType().equals(Map.class)) {
                        ...
                        for (Iterator it = results.keySet().iterator(); it.hasNext();) {
                            ...
                            if (this.getItem(itemId).getItemProperty(key) != null) {
                                this.getItem(itemId).getItemProperty(key).setValue(results.get(key));
                            }
                        }
