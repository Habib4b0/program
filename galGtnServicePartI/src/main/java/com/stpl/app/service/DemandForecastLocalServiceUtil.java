...
public class DemandForecastLocalServiceUtil {
    private static DemandForecastLocalService _service;
    ...
    */
    ...
    public static DemandForecastLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    DemandForecastLocalService.class.getName());

            if (invokableLocalService instanceof DemandForecastLocalService) {
                _service = (DemandForecastLocalService) invokableLocalService;
            } else {
                _service = new DemandForecastLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(DemandForecastLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(DemandForecastLocalService service) {
    }
}
