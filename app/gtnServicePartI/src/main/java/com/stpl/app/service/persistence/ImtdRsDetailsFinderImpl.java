...
//
    ...
    public Object insertTempRsDetailsInADD(String userId, String sessionId, String createdDate, String ifpSystemId, Object idValue, Object future2, Object future3, Object future4) {
        ...
        try {
            ...
            session = openSession();
            insertQuery.append("INSERT INTO dbo.IMTD_RS_DETAILS (IFP_MODEL_SID, ITEM_MASTER_SID, ITEM_ID, ITEM_NO, ITEM_NAME,RS_DETAILS_ATTACHED_STATUS, RS_DETAILS_ATTACHED_DATE, \"Operation\", SESSION_ID, IMTD_CREATED_DATE, USERS_SID, CHECK_RECORD,RS_MODEL_SID,RS_DETAILS_CREATED_BY)");
