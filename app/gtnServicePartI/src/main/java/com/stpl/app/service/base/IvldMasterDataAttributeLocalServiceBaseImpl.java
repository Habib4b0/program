...
public abstract class IvldMasterDataAttributeLocalServiceBaseImpl
    ...
    private IvldMasterDataAttributeLocalServiceClpInvoker _clpInvoker = new IvldMasterDataAttributeLocalServiceClpInvoker();
    ...
    public IvldMasterDataAttribute deleteIvldMasterDataAttribute(
        int ivldMasterDataAtbteSid) throws PortalException, SystemException {
    ...
    public IvldMasterDataAttribute fetchIvldMasterDataAttribute(
        int ivldMasterDataAtbteSid) throws SystemException {
     ...
     */
    @Override
    public int getIvldMasterDataAttributesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.IvldMasterDataAttribute",
