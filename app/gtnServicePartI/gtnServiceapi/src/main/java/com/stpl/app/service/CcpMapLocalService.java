...
/**
 * Provides the local service interface for CcpMap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CcpMapLocalServiceUtil
...
public interface CcpMapLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CcpMapLocalServiceUtil} to access the ccp map local service. Add custom service methods to {@link com.stpl.app.service.impl.CcpMapLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CcpMap addCcpMap(CcpMap ccpMap);
	...
	*/
	...
	public CcpMap deleteCcpMap(CcpMap ccpMap);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CcpMap deleteCcpMap(int ccpMapSid) throws PortalException;
	...
	*/
	...
	public CcpMap fetchCcpMap(int ccpMapSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CcpMap getCcpMap(int ccpMapSid) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CcpMap updateCcpMap(CcpMap ccpMap);
}