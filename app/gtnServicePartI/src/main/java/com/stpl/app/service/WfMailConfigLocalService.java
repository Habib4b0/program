...
/**
 * Provides the local service interface for WfMailConfig. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see WfMailConfigLocalServiceUtil
...
public interface WfMailConfigLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link WfMailConfigLocalServiceUtil} to access the wf mail config local service. Add custom service methods to {@link com.stpl.app.service.impl.WfMailConfigLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
