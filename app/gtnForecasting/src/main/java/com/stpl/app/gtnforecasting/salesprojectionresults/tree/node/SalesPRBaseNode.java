 ...
 * @author Abishek.Ram
 */
public abstract class SalesPRBaseNode implements TreeNode, Comparable<SalesPRBaseNode> {
    ...
    public void setStatic(boolean statiCLevel) {
        isStatic = statiCLevel;
    }
    ...
    public String getPreviousOppositeHieararchy(String indicator) {
        ...
        if (parentNode.getHierarchyIndicator() == null) {
