...
public class VwIvldDemandForecastActualLocalServiceUtil {
    private static VwIvldDemandForecastActualLocalService _service;
    ...
    */
    ...
    public static VwIvldDemandForecastActualLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    VwIvldDemandForecastActualLocalService.class.getName());

            if (invokableLocalService instanceof VwIvldDemandForecastActualLocalService) {
                _service = (VwIvldDemandForecastActualLocalService) invokableLocalService;
            } else {
                _service = new VwIvldDemandForecastActualLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(VwIvldDemandForecastActualLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(VwIvldDemandForecastActualLocalService service) {
    }
}
