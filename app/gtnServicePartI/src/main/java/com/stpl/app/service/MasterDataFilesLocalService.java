...
/**
 * Provides the local service interface for MasterDataFiles. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see MasterDataFilesLocalServiceUtil
...
public interface MasterDataFilesLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link MasterDataFilesLocalServiceUtil} to access the master data files local service. Add custom service methods to {@link com.stpl.app.service.impl.MasterDataFilesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
