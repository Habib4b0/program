 ...
 * @generated
 */
public class StChProjectionDiscountLocalServiceClp
    ...
    public StChProjectionDiscountLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addStChProjectionDiscount";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.StChProjectionDiscount"
            };

        _methodName1 = "createStChProjectionDiscount";

        _methodParameterTypes1 = new String[] {
                "com.stpl.app.service.persistence.StChProjectionDiscountPK"
            };

        _methodName2 = "deleteStChProjectionDiscount";

        _methodParameterTypes2 = new String[] {
                "com.stpl.app.service.persistence.StChProjectionDiscountPK"
            };

        _methodName3 = "deleteStChProjectionDiscount";
        ...
        _methodName10 = "fetchStChProjectionDiscount";

        _methodParameterTypes10 = new String[] {
                "com.stpl.app.service.persistence.StChProjectionDiscountPK"
            };

        _methodName11 = "getStChProjectionDiscount";
        ...
        _methodName13 = "getStChProjectionDiscounts";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getStChProjectionDiscountsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateStChProjectionDiscount";
    ...
    public com.stpl.app.model.StChProjectionDiscount addStChProjectionDiscount(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(stChProjectionDiscount)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.StChProjectionDiscount) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.StChProjectionDiscount createStChProjectionDiscount(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(stChProjectionDiscountPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.StChProjectionDiscount> getStChProjectionDiscounts(
        ...
        return (java.util.List<com.stpl.app.model.StChProjectionDiscount>) ClpSerializer.translateOutput(returnObj);
    }
