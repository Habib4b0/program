...
import com.stpl.gtn.gtn2o.ui.module.processscheduler.config.lookups.GtnFrameworkCffOutBoundLookUpConfig;
...
public class GtnFrameworkProcessSchedulerConfig {
	...
	public GtnUIFrameworkRootConfig getProcessSchedulerRootConfig() {
		...
		viewList.add(new GtnFrameworkCffOutBoundLookUpConfig().getCffOutBoundLookUpView());
