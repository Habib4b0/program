...
public class StChDiscountProjMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<StChDiscountProjMasterLocalService, StChDiscountProjMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(StChDiscountProjMasterLocalService.class);
}