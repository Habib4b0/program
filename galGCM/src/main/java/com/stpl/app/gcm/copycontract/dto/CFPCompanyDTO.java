...
public class CFPCompanyDTO implements Serializable {
     ...
     */
    private String companyFamilyPlanStartDate = StringUtils.EMPTY;
    ;
    /**
     * The company family plan end date.
     */
    private String companyFamilyPlanEndDate = StringUtils.EMPTY;
    ;
    /**
     * The checkbox.
     */
     ...
     */
    private int companyFamilyPlanStatus;
    /**
     * The company family plan type.
     */
    private int companyFamilyPlanType;
    /**
     * The trade class.
     */
    private int companyFamilyPlanTradeClass;
    /**
     * The companyFamilyPlanCategory
     */
    private int companyFamilyPlanCategory;
    /**
    ...
    private String companyCategoryValue = StringUtils.EMPTY;
    private String companyGroupValue = StringUtils.EMPTY;
    private String tradeClassValue = StringUtils.EMPTY;
    ...
    private String searchFields = StringUtils.EMPTY;
     ...
     */
    public int getCompanyFamilyPlanStatus() {
     ...
     */
    public void setCompanyFamilyPlanStatus(final int companyFamilyPlanStatus) {
        this.companyFamilyPlanStatus = companyFamilyPlanStatus;
    }

    public int getCompanyFamilyPlanType() {
        return companyFamilyPlanType;
    }

    public void setCompanyFamilyPlanType(int companyFamilyPlanType) {
    ...
    public void setCompanyFamilyPlanTradeClass(int companyFamilyPlanTradeClass) {
    ...
    public void setCompanyFamilyPlanCategory(int companyFamilyPlanCategory) {
    ...
    public CFPCompanyDTO(final String companySystemId, final String companyFamilyPlanId,
            final int companyFamilyPlanSystemId, final String companyFamilyPlanName,
            final String companyFamilyPlanNo, final int companyFamilyPlanStatus, final int companyFamilyPlanType,
            ...
            final int status, final String companyFamilyPlanStartDate,
            final String companyFamilyPlanEndDate, final String companyType, final boolean checkBox, final Date createdDate) {
     ...
     */
    public void setCompanyFamilyPlanStartDate(final String companyFamilyPlanStartDate) {
        this.companyFamilyPlanStartDate = companyFamilyPlanStartDate;
    }
     ...
     */
    public void setCompanyFamilyPlanEndDate(final String companyFamilyPlanEndDate) {
        this.companyFamilyPlanEndDate = companyFamilyPlanEndDate;
    }
