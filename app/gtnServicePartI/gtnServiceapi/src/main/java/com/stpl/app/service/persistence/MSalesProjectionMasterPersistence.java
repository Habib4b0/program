...
public interface MSalesProjectionMasterPersistence extends BasePersistence<MSalesProjectionMaster> {
	...
	*/
	public void cacheResult(
		java.util.List<MSalesProjectionMaster> mSalesProjectionMasters);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, MSalesProjectionMaster> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<MSalesProjectionMaster> findAll();
	...
	*/
	public java.util.List<MSalesProjectionMaster> findAll(int start, int end);
	...
	*/
	public java.util.List<MSalesProjectionMaster> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MSalesProjectionMaster> orderByComparator);
