	...
	protected void init(final VaadinRequest request) {
		...
		try {
                    ...
                    /*final Date tempDate=new Date();
                     ...
                     VaadinSession.getCurrent().setAttribute(ConstantsUtils.SESSION_DATE, fmt.format(tempDate));
                     VaadinSession.getCurrent().setAttribute(ConstantsUtils.TEMP_ID, fmtID.format(tempDate));*/
