...
public interface DataSelectionDAO {
     ...
     * @throws Exception
     */
    ProjectionMaster getProjectionMaster(int id) throws Exception;
     ...
     * @throws Exception 
     */
    ProjectionMaster updateProjectionMaster(ProjectionMaster projectionMaster) throws Exception;
