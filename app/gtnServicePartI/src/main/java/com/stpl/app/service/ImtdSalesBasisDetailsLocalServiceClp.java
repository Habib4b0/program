 ...
 * @generated
 */
public class ImtdSalesBasisDetailsLocalServiceClp
    ...
    public ImtdSalesBasisDetailsLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addImtdSalesBasisDetails";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.ImtdSalesBasisDetails"
            };

        _methodName1 = "createImtdSalesBasisDetails";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteImtdSalesBasisDetails";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteImtdSalesBasisDetails";
        ...
        _methodName10 = "fetchImtdSalesBasisDetails";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getImtdSalesBasisDetails";
        ...
        _methodName13 = "getImtdSalesBasisDetailses";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getImtdSalesBasisDetailsesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateImtdSalesBasisDetails";
    ...
    public com.stpl.app.model.ImtdSalesBasisDetails addImtdSalesBasisDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(imtdSalesBasisDetails)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ImtdSalesBasisDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ImtdSalesBasisDetails createImtdSalesBasisDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { imtdSalesBasisDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ImtdSalesBasisDetails> getImtdSalesBasisDetailses(
        ...
        return (java.util.List<com.stpl.app.model.ImtdSalesBasisDetails>) ClpSerializer.translateOutput(returnObj);
    }
