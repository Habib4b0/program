...
public class NdcPopupForm extends Window {
    ...
    public NdcPopupForm(NewNdcDTO newNdcDto, Map<Integer, Object> medicaidMap, Map<Integer, Object> federalMap) throws Exception {
        super("New NDC Setup");
        this.newNdcDto = newNdcDto;
        this.medicaidNdcPopUp = new MedicaidNdcPopUp(newNdcDto, medicaidMap);
        this.federalNdcPopup = new FederalNdcPopup(newNdcDto, federalMap);
        init();
        checkFlag = false;
    }
    ...
    public void add(Button.ClickEvent event) throws Exception {
        if (addLogic()) {
    ...
    protected TabSheet addTab() {
        LOGGER.info("NdcPopupForm addTab() starts ");
        ...
        LOGGER.info("NdcPopupForm addTab() ends ");
        return tabSheet;
    }
    ...
    public boolean addLogic() throws Exception {
