...
public class ItemHierarchyMasterCacheModel implements CacheModel<ItemHierarchyMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ItemHierarchyMasterCacheModel)) {
			return false;
		}

		ItemHierarchyMasterCacheModel itemHierarchyMasterCacheModel = (ItemHierarchyMasterCacheModel)obj;

		if (itemHierarchyMasterSid == itemHierarchyMasterCacheModel.itemHierarchyMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, itemHierarchyMasterSid);
	}
