...
public abstract class ImtdItemPriceRebateDetailsLocalServiceBaseImpl
    ...
    implements ImtdItemPriceRebateDetailsLocalService, IdentifiableBean {
    ...
    private ImtdItemPriceRebateDetailsLocalServiceClpInvoker _clpInvoker = new ImtdItemPriceRebateDetailsLocalServiceClpInvoker();
    ...
    public ImtdItemPriceRebateDetails deleteImtdItemPriceRebateDetails(
        int imtdItemPriceRebateSid) throws PortalException, SystemException {
     ...
     */
    @Override
    public int getImtdItemPriceRebateDetailsesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ImtdItemPriceRebateDetails",
