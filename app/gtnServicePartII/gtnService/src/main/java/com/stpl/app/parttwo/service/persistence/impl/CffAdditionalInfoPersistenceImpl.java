 ...
 * @see com.stpl.app.parttwo.service.persistence.CffAdditionalInfoUtil
 * @generated
 */
@ProviderType
public class CffAdditionalInfoPersistenceImpl extends BasePersistenceImpl<CffAdditionalInfo>
	...
	public CffAdditionalInfoPersistenceImpl() {
		...
		try {
			...
			dbColumnNames.put("cffAdditionalInfoSid", "CFF_ADDITIONAL_INFO_SID");
	...
	public void cacheResult(CffAdditionalInfo cffAdditionalInfo) {
		entityCache.putResult(CffAdditionalInfoModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache() {
		entityCache.clearCache(CffAdditionalInfoImpl.class);
	...
	public void clearCache(CffAdditionalInfo cffAdditionalInfo) {
		entityCache.removeResult(CffAdditionalInfoModelImpl.ENTITY_CACHE_ENABLED,
			CffAdditionalInfoImpl.class, cffAdditionalInfo.getPrimaryKey());
	...
	public CffAdditionalInfo updateImpl(CffAdditionalInfo cffAdditionalInfo) {
		...
		try {
			...
			if (cffAdditionalInfo.isNew()) {
				...
				cffAdditionalInfo = (CffAdditionalInfo)session.merge(cffAdditionalInfo);
			}
		}
		catch (Exception e) {
			throw processException(e);
	...
	/**
	 * Returns the cff additional info with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the cff additional info
	...
	public CffAdditionalInfo fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(CffAdditionalInfoModelImpl.ENTITY_CACHE_ENABLED,
		...
		CffAdditionalInfo cffAdditionalInfo = (CffAdditionalInfo)serializable;
		...
		if (cffAdditionalInfo == null) {
			...
			try {
				...
				if (cffAdditionalInfo != null) {
					...
					entityCache.putResult(CffAdditionalInfoModelImpl.ENTITY_CACHE_ENABLED,
						CffAdditionalInfoImpl.class, primaryKey, nullModel);
				}
			}
			catch (Exception e) {
				entityCache.removeResult(CffAdditionalInfoModelImpl.ENTITY_CACHE_ENABLED,
	...
	@Override
	public Map<Serializable, CffAdditionalInfo> fetchByPrimaryKeys(
		Set<Serializable> primaryKeys) {
		if (primaryKeys.isEmpty()) {
			return Collections.emptyMap();
		}

		Map<Serializable, CffAdditionalInfo> map = new HashMap<Serializable, CffAdditionalInfo>();
		...
		if (primaryKeys.size() == 1) {
			...
			if (cffAdditionalInfo != null) {
				map.put(primaryKey, cffAdditionalInfo);
			}
		...
		for (Serializable primaryKey : primaryKeys) {
			...
			if (serializable != nullModel) {
				if (serializable == null) {
					...
					map.put(primaryKey, (CffAdditionalInfo)serializable);
				}
			}
		}
		...
		query.append(_SQL_SELECT_CFFADDITIONALINFO_WHERE_PKS_IN);
		...
		try {
			...
			for (CffAdditionalInfo cffAdditionalInfo : (List<CffAdditionalInfo>)q.list()) {
				map.put(cffAdditionalInfo.getPrimaryKeyObj(), cffAdditionalInfo);

				cacheResult(cffAdditionalInfo);

				uncachedPrimaryKeys.remove(cffAdditionalInfo.getPrimaryKeyObj());
			}
	 ...
	 */
	@Override
	public List<CffAdditionalInfo> findAll() {
	...
	public List<CffAdditionalInfo> findAll(int start, int end,
		...
		List<CffAdditionalInfo> list = null;

		if (retrieveFromCache) {
			list = (List<CffAdditionalInfo>)finderCache.getResult(finderPath,
					finderArgs, this);
		}
	...
	protected Map<String, Integer> getTableColumnsMap() {
		return CffAdditionalInfoModelImpl.TABLE_COLUMNS_MAP;
	}
	...
	public void destroy() {
		entityCache.removeCache(CffAdditionalInfoImpl.class.getName());
	...
	private static final String _SQL_SELECT_CFFADDITIONALINFO_WHERE_PKS_IN = "SELECT cffAdditionalInfo FROM CffAdditionalInfo cffAdditionalInfo WHERE CFF_ADDITIONAL_INFO_SID IN (";
	...
	private static final Log _log = LogFactoryUtil.getLog(CffAdditionalInfoPersistenceImpl.class);
