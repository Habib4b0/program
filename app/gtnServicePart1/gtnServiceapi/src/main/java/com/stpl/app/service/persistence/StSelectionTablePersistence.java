...
public interface StSelectionTablePersistence extends BasePersistence<StSelectionTable> {
	...
	*/
	public void cacheResult(java.util.List<StSelectionTable> stSelectionTables);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, StSelectionTable> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<StSelectionTable> findAll();
	...
	*/
	public java.util.List<StSelectionTable> findAll(int start, int end);
	...
	*/
	public java.util.List<StSelectionTable> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<StSelectionTable> orderByComparator);
