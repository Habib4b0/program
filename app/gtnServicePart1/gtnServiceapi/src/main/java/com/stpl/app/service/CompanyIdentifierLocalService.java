...
/**
 * Provides the local service interface for CompanyIdentifier. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CompanyIdentifierLocalServiceUtil
...
public interface CompanyIdentifierLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CompanyIdentifierLocalServiceUtil} to access the company identifier local service. Add custom service methods to {@link com.stpl.app.service.impl.CompanyIdentifierLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CompanyIdentifier deleteCompanyIdentifier(
		int companyStringIdentifierSid) throws PortalException;
	...
	*/
	...
	public CompanyIdentifier fetchCompanyIdentifier(
		int companyStringIdentifierSid);
