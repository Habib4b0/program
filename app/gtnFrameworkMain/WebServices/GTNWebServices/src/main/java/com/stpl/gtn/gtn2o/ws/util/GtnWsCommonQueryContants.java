...
public class GtnWsCommonQueryContants {
	...
	public static final String GTN_COMMON_NOTE_TAB_ATTACHMENT_SELECT = "Select MASTER_TABLE_NAME,FILE_NAME, CREATED_DATE, CREATED_BY ,ATTACHMENT_SID,FILE_DATA from ATTACHMENT where ATTACHMENT_TABLE_SID= ";
}
