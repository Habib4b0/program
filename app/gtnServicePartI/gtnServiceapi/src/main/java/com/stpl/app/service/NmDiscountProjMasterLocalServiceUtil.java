...
public class NmDiscountProjMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<NmDiscountProjMasterLocalService, NmDiscountProjMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(NmDiscountProjMasterLocalService.class);
}