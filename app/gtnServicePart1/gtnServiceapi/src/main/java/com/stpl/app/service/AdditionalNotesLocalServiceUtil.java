...
public class AdditionalNotesLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<AdditionalNotesLocalService, AdditionalNotesLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AdditionalNotesLocalService.class);
}