...
public class UpdatePreviousNextCloseSubmitButton {
	...
	public void addCommonButtonLayout(List<GtnUIFrameworkComponentConfig> componentList, String parentComponentId,
			String nameSpace) {
		...
		commonButtonLayout.setAddToParent(true);
	...
	public void addUpdateButton(List<GtnUIFrameworkComponentConfig> componentList, String nameSpace) {
		...
		updateButtonConfig
				.setParentComponentId(nameSpace + GtnFrameworkScreenRegisteryConstants.COMMON_BUTTON_LAYOUT_PARENT_ID);
