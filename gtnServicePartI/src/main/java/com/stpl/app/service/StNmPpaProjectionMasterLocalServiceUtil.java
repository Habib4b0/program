...
public class StNmPpaProjectionMasterLocalServiceUtil {
    private static StNmPpaProjectionMasterLocalService _service;
    ...
    */
    ...
    public static StNmPpaProjectionMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StNmPpaProjectionMasterLocalService.class.getName());

            if (invokableLocalService instanceof StNmPpaProjectionMasterLocalService) {
                _service = (StNmPpaProjectionMasterLocalService) invokableLocalService;
            } else {
                _service = new StNmPpaProjectionMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StNmPpaProjectionMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StNmPpaProjectionMasterLocalService service) {
    }
}
