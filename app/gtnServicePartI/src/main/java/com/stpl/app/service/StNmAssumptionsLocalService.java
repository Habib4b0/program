...
/**
 * Provides the local service interface for StNmAssumptions. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StNmAssumptionsLocalServiceUtil
...
public interface StNmAssumptionsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link StNmAssumptionsLocalServiceUtil} to access the st nm assumptions local service. Add custom service methods to {@link com.stpl.app.service.impl.StNmAssumptionsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
