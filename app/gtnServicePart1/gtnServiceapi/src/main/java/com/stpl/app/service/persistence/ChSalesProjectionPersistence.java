...
public interface ChSalesProjectionPersistence extends BasePersistence<ChSalesProjection> {
	...
	*/
	public void cacheResult(
		java.util.List<ChSalesProjection> chSalesProjections);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ChSalesProjection> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ChSalesProjection> findAll();
	...
	*/
	public java.util.List<ChSalesProjection> findAll(int start, int end);
	...
	*/
	public java.util.List<ChSalesProjection> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ChSalesProjection> orderByComparator);
