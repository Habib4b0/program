 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link DeductionGroupDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DeductionGroupDetailsImpl}.
 * </p>
 *
 * @author
...
public class DeductionGroupDetailsModelImpl extends BaseModelImpl<DeductionGroupDetails>
	...
	static {
		TABLE_COLUMNS_MAP.put("DEDUCTION_GROUP_DETAILS_SID", Types.INTEGER);
	...
	private static final ClassLoader _classLoader = DeductionGroupDetails.class.getClassLoader();
