...
import com.stpl.app.service.PhsProjLocalService;
...
/**
 * Provides the base implementation for the phs proj local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.PhsProjLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.PhsProjLocalServiceImpl
 * @see com.stpl.app.service.PhsProjLocalServiceUtil
 * @generated
 */
public abstract class PhsProjLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PhsProjLocalService, IdentifiableBean {
    ...
    private PhsProjLocalServiceClpInvoker _clpInvoker = new PhsProjLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.PhsProjLocalServiceUtil} to access the phs proj local service.
     */
    ...
    @Override
    public PhsProj addPhsProj(PhsProj phsProj) throws SystemException {
        phsProj.setNew(true);

        return phsProjPersistence.update(phsProj);
    }
     ...
     */
    @Override
    public PhsProj createPhsProj(PhsProjPK phsProjPK) {
        return phsProjPersistence.create(phsProjPK);
    }
    ...
    @Override
    public PhsProj deletePhsProj(PhsProjPK phsProjPK)
        throws PortalException, SystemException {
        return phsProjPersistence.remove(phsProjPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public PhsProj deletePhsProj(PhsProj phsProj) throws SystemException {
        return phsProjPersistence.remove(phsProj);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(PhsProj.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return phsProjPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return phsProjPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return phsProjPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return phsProjPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return phsProjPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public PhsProj fetchPhsProj(PhsProjPK phsProjPK) throws SystemException {
        return phsProjPersistence.fetchByPrimaryKey(phsProjPK);
    }
     ...
     */
    @Override
    public PhsProj getPhsProj(PhsProjPK phsProjPK)
        throws PortalException, SystemException {
        return phsProjPersistence.findByPrimaryKey(phsProjPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return phsProjPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<PhsProj> getPhsProjs(int start, int end)
        throws SystemException {
        return phsProjPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getPhsProjsCount() throws SystemException {
        return phsProjPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public PhsProj updatePhsProj(PhsProj phsProj) throws SystemException {
        return phsProjPersistence.update(phsProj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.PhsProj",
            phsProjLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.PhsProj");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = phsProjPersistence.getDataSource();
