...
/**
 * Provides the local service interface for ChAssumptions. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ChAssumptionsLocalServiceUtil
...
public interface ChAssumptionsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChAssumptionsLocalServiceUtil} to access the ch assumptions local service. Add custom service methods to {@link com.stpl.app.service.impl.ChAssumptionsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
