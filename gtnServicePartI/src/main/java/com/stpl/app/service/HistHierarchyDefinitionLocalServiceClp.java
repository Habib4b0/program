 ...
 * @generated
 */
public class HistHierarchyDefinitionLocalServiceClp
    ...
    public HistHierarchyDefinitionLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addHistHierarchyDefinition";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.HistHierarchyDefinition"
            };

        _methodName1 = "createHistHierarchyDefinition";

        _methodParameterTypes1 = new String[] {
                "com.stpl.app.service.persistence.HistHierarchyDefinitionPK"
            };

        _methodName2 = "deleteHistHierarchyDefinition";

        _methodParameterTypes2 = new String[] {
                "com.stpl.app.service.persistence.HistHierarchyDefinitionPK"
            };

        _methodName3 = "deleteHistHierarchyDefinition";
        ...
        _methodName10 = "fetchHistHierarchyDefinition";

        _methodParameterTypes10 = new String[] {
                "com.stpl.app.service.persistence.HistHierarchyDefinitionPK"
            };

        _methodName11 = "getHistHierarchyDefinition";
        ...
        _methodName13 = "getHistHierarchyDefinitions";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getHistHierarchyDefinitionsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateHistHierarchyDefinition";
    ...
    public com.stpl.app.model.HistHierarchyDefinition addHistHierarchyDefinition(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(histHierarchyDefinition)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.HistHierarchyDefinition) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.HistHierarchyDefinition createHistHierarchyDefinition(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(histHierarchyDefinitionPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.HistHierarchyDefinition> getHistHierarchyDefinitions(
        ...
        return (java.util.List<com.stpl.app.model.HistHierarchyDefinition>) ClpSerializer.translateOutput(returnObj);
    }
