 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link AuditMasterInboundModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AuditMasterInboundImpl}.
 * </p>
 *
 * @author
...
public class AuditMasterInboundModelImpl extends BaseModelImpl<AuditMasterInbound>
	...
	static {
		TABLE_COLUMNS_MAP.put("RECEIVED_RECORD_AMOUNT_ATTR", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("INTERFACE_RUN_END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("APPLICATION_PROCESS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("DISCREPANCY_AMOUNT", Types.DOUBLE);
		TABLE_COLUMNS_MAP.put("BATCH_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("FILE_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("SENT_RECORD_AMOUNT_ATTRIBUTE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("STATUS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("RECEIVED_RECORD_AMOUNT", Types.DOUBLE);
		TABLE_COLUMNS_MAP.put("VALID_RECORD_AMOUNT", Types.DOUBLE);
		TABLE_COLUMNS_MAP.put("INVALID_RECORD_COUNT", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("RECEIVED_RECORD_COUNT", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CREATED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CHANGE_COUNT", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("UNPROCESSED_RECORDS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("DELETE_COUNT", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("AUDIT_INBOUND_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("SENT_RECORD_AMOUNT", Types.DOUBLE);
		TABLE_COLUMNS_MAP.put("SENT_RECORD_COUNT", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("ADD_COUNT", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("SOURCE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("INVALID_RECORD_AMOUNT", Types.DOUBLE);
		TABLE_COLUMNS_MAP.put("INTERFACE_RUN_START_DATE", Types.TIMESTAMP);
	}
	...
	private static final ClassLoader _classLoader = AuditMasterInbound.class.getClassLoader();
