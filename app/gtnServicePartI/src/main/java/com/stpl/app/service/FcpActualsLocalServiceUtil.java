 ...
 * {@link com.stpl.app.service.impl.FcpActualsLocalServiceImpl} and is the
...
public class FcpActualsLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.stpl.app.service.impl.FcpActualsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.stpl.app.model.FcpActuals addFcpActuals(
        com.stpl.app.model.FcpActuals fcpActuals)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().addFcpActuals(fcpActuals);
    }
    ...
    */
    public static com.stpl.app.model.FcpActuals createFcpActuals(
        com.stpl.app.service.persistence.FcpActualsPK fcpActualsPK) {
        return getService().createFcpActuals(fcpActualsPK);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.FcpActuals deleteFcpActuals(
        com.stpl.app.service.persistence.FcpActualsPK fcpActualsPK)
        throws com.stpl.portal.kernel.exception.PortalException,
            com.stpl.portal.kernel.exception.SystemException {
        return getService().deleteFcpActuals(fcpActualsPK);
    }
    ...
    */
    public static com.stpl.app.model.FcpActuals deleteFcpActuals(
        com.stpl.app.model.FcpActuals fcpActuals)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().deleteFcpActuals(fcpActuals);
    }
    ...
    */
    ...
    public static com.stpl.app.model.FcpActuals fetchFcpActuals(
        com.stpl.app.service.persistence.FcpActualsPK fcpActualsPK)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().fetchFcpActuals(fcpActualsPK);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.FcpActuals getFcpActuals(
        com.stpl.app.service.persistence.FcpActualsPK fcpActualsPK)
        throws com.stpl.portal.kernel.exception.PortalException,
            com.stpl.portal.kernel.exception.SystemException {
        return getService().getFcpActuals(fcpActualsPK);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.FcpActuals> getFcpActualses(
        int start, int end)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().getFcpActualses(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getFcpActualsesCount()
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().getFcpActualsesCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.FcpActuals updateFcpActuals(
        com.stpl.app.model.FcpActuals fcpActuals)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().updateFcpActuals(fcpActuals);
    }
    ...
    */
    ...
    public static FcpActualsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    FcpActualsLocalService.class.getName());

            if (invokableLocalService instanceof FcpActualsLocalService) {
                _service = (FcpActualsLocalService) invokableLocalService;
            } else {
                _service = new FcpActualsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(FcpActualsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(FcpActualsLocalService service) {
    }
}
