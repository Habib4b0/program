...
public class IfpModelCacheModel implements CacheModel<IfpModel>, Externalizable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IfpModelCacheModel)) {
			return false;
		}

		IfpModelCacheModel ifpModelCacheModel = (IfpModelCacheModel)obj;

		if (ifpModelSid == ifpModelCacheModel.ifpModelSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ifpModelSid);
	}
