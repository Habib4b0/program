...
import com.stpl.app.parttwo.service.StCffOutboundMasterLocalService;
...
/**
 * Provides the base implementation for the st cff outbound master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.StCffOutboundMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.StCffOutboundMasterLocalServiceImpl
 * @see com.stpl.app.parttwo.service.StCffOutboundMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StCffOutboundMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StCffOutboundMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.StCffOutboundMasterLocalServiceUtil} to access the st cff outbound master local service.
	 */
	...
	@Override
	public StCffOutboundMaster addStCffOutboundMaster(
		StCffOutboundMaster stCffOutboundMaster) {
		stCffOutboundMaster.setNew(true);

		return stCffOutboundMasterPersistence.update(stCffOutboundMaster);
	}
	 ...
	 */
	@Override
	public StCffOutboundMaster createStCffOutboundMaster(
		StCffOutboundMasterPK stCffOutboundMasterPK) {
		return stCffOutboundMasterPersistence.create(stCffOutboundMasterPK);
	}
	...
	@Override
	public StCffOutboundMaster deleteStCffOutboundMaster(
		StCffOutboundMasterPK stCffOutboundMasterPK) throws PortalException {
		return stCffOutboundMasterPersistence.remove(stCffOutboundMasterPK);
	}
	...
	public StCffOutboundMaster deleteStCffOutboundMaster(
		StCffOutboundMaster stCffOutboundMaster) {
		return stCffOutboundMasterPersistence.remove(stCffOutboundMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StCffOutboundMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stCffOutboundMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stCffOutboundMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StCffOutboundMaster fetchStCffOutboundMaster(
		StCffOutboundMasterPK stCffOutboundMasterPK) {
		return stCffOutboundMasterPersistence.fetchByPrimaryKey(stCffOutboundMasterPK);
	}
	 ...
	 */
	@Override
	public StCffOutboundMaster getStCffOutboundMaster(
		StCffOutboundMasterPK stCffOutboundMasterPK) throws PortalException {
		return stCffOutboundMasterPersistence.findByPrimaryKey(stCffOutboundMasterPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stCffOutboundMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StCffOutboundMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName(
			"primaryKey.cffDetailsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(stCffOutboundMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StCffOutboundMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stCffOutboundMasterLocalService.deleteStCffOutboundMaster((StCffOutboundMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stCffOutboundMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StCffOutboundMaster> getStCffOutboundMasters(int start, int end) {
		return stCffOutboundMasterPersistence.findAll(start, end);
	}
	...
	public int getStCffOutboundMastersCount() {
		return stCffOutboundMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StCffOutboundMaster updateStCffOutboundMaster(
		StCffOutboundMaster stCffOutboundMaster) {
		return stCffOutboundMasterPersistence.update(stCffOutboundMaster);
	}
	 ...
	 */
	public StCffOutboundMasterLocalService getStCffOutboundMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.StCffOutboundMaster",
			stCffOutboundMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.StCffOutboundMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StCffOutboundMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stCffOutboundMasterPersistence.getDataSource();
	...
	@BeanReference(type = StCffOutboundMasterLocalService.class)
	protected StCffOutboundMasterLocalService stCffOutboundMasterLocalService;
