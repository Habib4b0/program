...
import com.stpl.app.service.NationalAssumptionsProjLocalService;
...
/**
 * Provides the base implementation for the national assumptions proj local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.NationalAssumptionsProjLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.NationalAssumptionsProjLocalServiceImpl
 * @see com.stpl.app.service.NationalAssumptionsProjLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class NationalAssumptionsProjLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NationalAssumptionsProjLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.NationalAssumptionsProjLocalServiceUtil} to access the national assumptions proj local service.
	 */
	...
	@Override
	public NationalAssumptionsProj addNationalAssumptionsProj(
		NationalAssumptionsProj nationalAssumptionsProj) {
		nationalAssumptionsProj.setNew(true);

		return nationalAssumptionsProjPersistence.update(nationalAssumptionsProj);
	}
	 ...
	 */
	@Override
	public NationalAssumptionsProj createNationalAssumptionsProj(
		NationalAssumptionsProjPK nationalAssumptionsProjPK) {
		return nationalAssumptionsProjPersistence.create(nationalAssumptionsProjPK);
	}
	...
	@Override
	public NationalAssumptionsProj deleteNationalAssumptionsProj(
		NationalAssumptionsProjPK nationalAssumptionsProjPK)
		throws PortalException {
		return nationalAssumptionsProjPersistence.remove(nationalAssumptionsProjPK);
	}
	...
	public NationalAssumptionsProj deleteNationalAssumptionsProj(
		NationalAssumptionsProj nationalAssumptionsProj) {
		return nationalAssumptionsProjPersistence.remove(nationalAssumptionsProj);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NationalAssumptionsProj.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return nationalAssumptionsProjPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return nationalAssumptionsProjPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NationalAssumptionsProj fetchNationalAssumptionsProj(
		NationalAssumptionsProjPK nationalAssumptionsProjPK) {
		return nationalAssumptionsProjPersistence.fetchByPrimaryKey(nationalAssumptionsProjPK);
	}
	 ...
	 */
	@Override
	public NationalAssumptionsProj getNationalAssumptionsProj(
		NationalAssumptionsProjPK nationalAssumptionsProjPK)
		throws PortalException {
		return nationalAssumptionsProjPersistence.findByPrimaryKey(nationalAssumptionsProjPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(nationalAssumptionsProjLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NationalAssumptionsProj.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("primaryKey.periodSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(nationalAssumptionsProjLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NationalAssumptionsProj.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName(
			"primaryKey.periodSid");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return nationalAssumptionsProjLocalService.deleteNationalAssumptionsProj((NationalAssumptionsProj)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return nationalAssumptionsProjPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NationalAssumptionsProj> getNationalAssumptionsProjs(
		int start, int end) {
		return nationalAssumptionsProjPersistence.findAll(start, end);
	}
	...
	public int getNationalAssumptionsProjsCount() {
		return nationalAssumptionsProjPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NationalAssumptionsProj updateNationalAssumptionsProj(
		NationalAssumptionsProj nationalAssumptionsProj) {
		return nationalAssumptionsProjPersistence.update(nationalAssumptionsProj);
	}
	 ...
	 */
	public NationalAssumptionsProjLocalService getNationalAssumptionsProjLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.NationalAssumptionsProj",
			nationalAssumptionsProjLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.NationalAssumptionsProj");
	}
	...
	public String getOSGiServiceIdentifier() {
		return NationalAssumptionsProjLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = nationalAssumptionsProjPersistence.getDataSource();
	...
	@BeanReference(type = NationalAssumptionsProjLocalService.class)
	protected NationalAssumptionsProjLocalService nationalAssumptionsProjLocalService;
