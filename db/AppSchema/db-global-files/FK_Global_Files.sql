...
-------------------NEW ARCHITECTURE FKS
------------------------FK'S-------------------------------------
IF NOT EXISTS(SELECT 1
              FROM   SYS.FOREIGN_KEYS
              WHERE  Object_name(PARENT_OBJECT_ID) = 'GTN_MODULE_COMPONENT_MASTER'
                     AND Schema_name(SCHEMA_ID) = 'DBO'
                     AND NAME = 'FK_GTN_MODULE_COMPONENT_MASTER_MODULE_SUBMODULE_MASTER_MODULE_SUBMODULE_MASTER_SID'
                     AND TYPE = 'F')
  BEGIN
      ALTER TABLE [DBO].GTN_MODULE_COMPONENT_MASTER
        ADD CONSTRAINT FK_GTN_MODULE_COMPONENT_MASTER_MODULE_SUBMODULE_MASTER_MODULE_SUBMODULE_MASTER_SID FOREIGN KEY(MODULE_SUBMODULE_MASTER_SID) REFERENCES MODULE_SUBMODULE_MASTER (MODULE_SUBMODULE_SID)
  END
...
IF NOT EXISTS(SELECT 1
              ...
              WHERE  Object_name(PARENT_OBJECT_ID) = 'GTN_UITABLE_COMPONENT_DETAILS'
                     AND Schema_name(SCHEMA_ID) = 'DBO'
                     AND NAME = 'FK_GTN_UITABLE_COMPONENT_DETAILS_GTN_MODULE_COMPONENT_MASTER_GTN_MODULE_COMPONENT_MASTER_SID'
                     AND TYPE = 'F')
  BEGIN
      ALTER TABLE [DBO].GTN_UITABLE_COMPONENT_DETAILS
        ADD CONSTRAINT FK_GTN_UITABLE_COMPONENT_DETAILS_GTN_MODULE_COMPONENT_MASTER_GTN_MODULE_COMPONENT_MASTER_SID FOREIGN KEY(GTN_MODULE_COMPONENT_MASTER_SID) REFERENCES GTN_MODULE_COMPONENT_MASTER (GTN_MODULE_COMPONENT_MASTER_SID)
  END
...
IF NOT EXISTS(SELECT 1
              ...
              WHERE  Object_name(PARENT_OBJECT_ID) = 'GTN_UITABLE_COMPONENT_DETAILS'
                     AND Schema_name(SCHEMA_ID) = 'DBO'
                     AND NAME = 'FK_GTN_UITABLE_COMPONENT_DETAILS_MODULE_SUBMODULE_MASTER_MODULE_SUBMODULE_MASTER_SID'
                     AND TYPE = 'F')
  BEGIN
      ALTER TABLE [DBO].GTN_UITABLE_COMPONENT_DETAILS
        ADD CONSTRAINT FK_GTN_UITABLE_COMPONENT_DETAILS_MODULE_SUBMODULE_MASTER_MODULE_SUBMODULE_MASTER_SID FOREIGN KEY(MODULE_SUBMODULE_MASTER_SID) REFERENCES MODULE_SUBMODULE_MASTER (MODULE_SUBMODULE_SID)
  END
