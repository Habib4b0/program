...
/**
 * The persistence utility for the ivld actual master service. This utility wraps {@link com.stpl.app.service.persistence.impl.IvldActualMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class IvldActualMasterUtil {
	...
	*/
	public static void cacheResult(IvldActualMaster ivldActualMaster) {
	...
	*/
	public static void cacheResult(List<IvldActualMaster> ivldActualMasters) {
	...
	*/
	public static IvldActualMaster create(int ivldActualMasterSid) {
	...
	*/
	public static IvldActualMaster remove(int ivldActualMasterSid)
		throws com.stpl.app.exception.NoSuchIvldActualMasterException {
		return getPersistence().remove(ivldActualMasterSid);
	}

	public static IvldActualMaster updateImpl(IvldActualMaster ivldActualMaster) {
	...
	* @throws NoSuchIvldActualMasterException if a ivld actual master with the primary key could not be found
	*/
	public static IvldActualMaster findByPrimaryKey(int ivldActualMasterSid)
		throws com.stpl.app.exception.NoSuchIvldActualMasterException {
	...
	*/
	public static IvldActualMaster fetchByPrimaryKey(int ivldActualMasterSid) {
		return getPersistence().fetchByPrimaryKey(ivldActualMasterSid);
	}

	public static java.util.Map<java.io.Serializable, IvldActualMaster> fetchByPrimaryKeys(
	...
	*/
	public static List<IvldActualMaster> findAll() {
	...
	*/
	public static List<IvldActualMaster> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IvldActualMasterPersistence, IvldActualMasterPersistence> _serviceTracker =
		ServiceTrackerFactory.open(IvldActualMasterPersistence.class);
}