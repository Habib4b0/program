 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link StMAssumptionsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link StMAssumptionsImpl}.
 * </p>
 *
 * @author
...
public class StMAssumptionsModelImpl extends BaseModelImpl<StMAssumptions>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ST_M_ASSUMPTIONS_SID", Types.VARCHAR);
	...
	public CacheModel<StMAssumptions> toCacheModel() {
		...
		stMAssumptionsCacheModel.stMAssumptionsPK = getPrimaryKey();
	...
	private static final ClassLoader _classLoader = StMAssumptions.class.getClassLoader();
