...
public abstract class RelationshipLevelDefinitionLocalServiceBaseImpl
    ...
    implements RelationshipLevelDefinitionLocalService, IdentifiableBean {
    ...
    private RelationshipLevelDefinitionLocalServiceClpInvoker _clpInvoker = new RelationshipLevelDefinitionLocalServiceClpInvoker();
    ...
    public RelationshipLevelDefinition deleteRelationshipLevelDefinition(
        int relationshipLevelSid) throws PortalException, SystemException {
     ...
     */
    @Override
    public int getRelationshipLevelDefinitionsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.RelationshipLevelDefinition",
