...
/**
 * The persistence utility for the hist relationship builder service. This utility wraps {@link HistRelationshipBuilderPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class HistRelationshipBuilderUtil {
    private static HistRelationshipBuilderPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.HistRelationshipBuilder create(
    ...
    */
    public static com.stpl.app.model.HistRelationshipBuilder remove(
        HistRelationshipBuilderPK histRelationshipBuilderPK)
    ...
    public static com.stpl.app.model.HistRelationshipBuilder updateImpl(
        com.stpl.app.model.HistRelationshipBuilder histRelationshipBuilder)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.HistRelationshipBuilder findByPrimaryKey(
        HistRelationshipBuilderPK histRelationshipBuilderPK)
        throws com.stpl.app.NoSuchHistRelationshipBuilderException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.HistRelationshipBuilder fetchByPrimaryKey(
        HistRelationshipBuilderPK histRelationshipBuilderPK)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.HistRelationshipBuilder> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static HistRelationshipBuilderPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (HistRelationshipBuilderPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    HistRelationshipBuilderPersistence.class.getName());

            ReferenceRegistry.registerReference(HistRelationshipBuilderUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(HistRelationshipBuilderPersistence persistence) {
    }
}
