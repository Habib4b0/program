...
public interface DemandForecastPersistence extends BasePersistence<DemandForecast> {
	...
	*/
	public void cacheResult(java.util.List<DemandForecast> demandForecasts);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, DemandForecast> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<DemandForecast> findAll();
	...
	*/
	public java.util.List<DemandForecast> findAll(int start, int end);
	...
	*/
	public java.util.List<DemandForecast> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<DemandForecast> orderByComparator);
