...
public class IfpContractDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<IfpContractDetailsLocalService, IfpContractDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(IfpContractDetailsLocalService.class);
}