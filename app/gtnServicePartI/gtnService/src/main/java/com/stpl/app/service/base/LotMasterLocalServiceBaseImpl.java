...
import com.stpl.app.service.LotMasterLocalService;
...
/**
 * Provides the base implementation for the lot master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.LotMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class LotMasterLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LotMasterLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.LotMasterLocalServiceUtil} to access the lot master local service.
	 */
	...
	@Override
	public LotMaster addLotMaster(LotMaster lotMaster) {
		lotMaster.setNew(true);

		return lotMasterPersistence.update(lotMaster);
	}
	 ...
	 */
	@Override
	public LotMaster createLotMaster(int lotMasterSid) {
		return lotMasterPersistence.create(lotMasterSid);
	}
	...
	@Override
	public LotMaster deleteLotMaster(int lotMasterSid)
		throws PortalException {
		return lotMasterPersistence.remove(lotMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LotMaster deleteLotMaster(LotMaster lotMaster) {
		return lotMasterPersistence.remove(lotMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LotMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return lotMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return lotMasterPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return lotMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LotMaster fetchLotMaster(int lotMasterSid) {
		return lotMasterPersistence.fetchByPrimaryKey(lotMasterSid);
	}
	 ...
	 */
	@Override
	public LotMaster getLotMaster(int lotMasterSid) throws PortalException {
		return lotMasterPersistence.findByPrimaryKey(lotMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(lotMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LotMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("lotMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(lotMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LotMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return lotMasterLocalService.deleteLotMaster((LotMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return lotMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LotMaster> getLotMasters(int start, int end) {
		return lotMasterPersistence.findAll(start, end);
	}
	...
	public int getLotMastersCount() {
		return lotMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LotMaster updateLotMaster(LotMaster lotMaster) {
		return lotMasterPersistence.update(lotMaster);
	}
	 ...
	 */
	public LotMasterLocalService getLotMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.LotMaster",
			lotMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.LotMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LotMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = lotMasterPersistence.getDataSource();
	...
	@BeanReference(type = LotMasterLocalService.class)
	protected LotMasterLocalService lotMasterLocalService;
