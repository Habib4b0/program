 ...
 * @author Santanukumar
 */
public class CustomerLookupResultTableLogic extends PageTableLogic {

    boolean generate = false;
    GroupDTO binderDto;
    CommonLogic commonLogic = new CommonLogic();
    public static final Logger LOGGER = Logger.getLogger(CustomerLookupResultTableLogic.class);
