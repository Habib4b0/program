...
/**
 * The persistence utility for the na projection selection service. This utility wraps {@link com.stpl.app.service.persistence.impl.NaProjectionSelectionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class NaProjectionSelectionUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(NaProjectionSelection naProjectionSelection) {
		getPersistence().clearCache(naProjectionSelection);
	}
	 ...
	 */
	public static List<NaProjectionSelection> findWithDynamicQuery(
	 ...
	 */
	public static NaProjectionSelection update(
		NaProjectionSelection naProjectionSelection) {
		return getPersistence().update(naProjectionSelection);
	}
	...
	public static NaProjectionSelection update(
		...
		return getPersistence().update(naProjectionSelection, serviceContext);
	}
	...
	*/
	public static void cacheResult(NaProjectionSelection naProjectionSelection) {
		getPersistence().cacheResult(naProjectionSelection);
	}
	...
	*/
	public static void cacheResult(
		List<NaProjectionSelection> naProjectionSelections) {
		getPersistence().cacheResult(naProjectionSelections);
	}
	...
	*/
	public static NaProjectionSelection create(int naProjectionSelectionSid) {
		return getPersistence().create(naProjectionSelectionSid);
	}
	...
	*/
	public static NaProjectionSelection remove(int naProjectionSelectionSid)
		throws com.stpl.app.exception.NoSuchNaProjectionSelectionException {
		return getPersistence().remove(naProjectionSelectionSid);
	}

	public static NaProjectionSelection updateImpl(
		NaProjectionSelection naProjectionSelection) {
		return getPersistence().updateImpl(naProjectionSelection);
	}
	...
	* @throws NoSuchNaProjectionSelectionException if a na projection selection with the primary key could not be found
	*/
	public static NaProjectionSelection findByPrimaryKey(
		int naProjectionSelectionSid)
		throws com.stpl.app.exception.NoSuchNaProjectionSelectionException {
		return getPersistence().findByPrimaryKey(naProjectionSelectionSid);
	}
	...
	*/
	public static NaProjectionSelection fetchByPrimaryKey(
		int naProjectionSelectionSid) {
		return getPersistence().fetchByPrimaryKey(naProjectionSelectionSid);
	}

	public static java.util.Map<java.io.Serializable, NaProjectionSelection> fetchByPrimaryKeys(
	...
	*/
	public static List<NaProjectionSelection> findAll() {
	...
	*/
	public static List<NaProjectionSelection> findAll(int start, int end) {
	...
	*/
	...
	public static NaProjectionSelectionPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<NaProjectionSelectionPersistence, NaProjectionSelectionPersistence> _serviceTracker =
		ServiceTrackerFactory.open(NaProjectionSelectionPersistence.class);
}