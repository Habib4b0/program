...
public class HierarchyBuilderDefinition extends CustomComponent implements View {
    ...
    public HierarchyBuilderDefinition(final HierarchyBuilderDTO hierarchyBuilderDTO, final BeanItemContainer<HierarchyBuilderLevelDTO> hierarchyBuilderLevelDTOBean,
        ...
        super();
        LOGGER.info("HierarchyBuilderDefinition constructor started");
        this.hierarchyBuilderDTO = hierarchyBuilderDTO;
        this.hierarchyBuilderLevelDTOBean = hierarchyBuilderLevelDTOBean;
        this.sessionDTO = sessionDTO;
        logic = new HierarchyBuilderLogic(sessionDTO);
        init();
        LOGGER.info("HierarchyBuilderDefinition constructor Ended");
    }
    ...
    private CustomFieldGroup getBinder() {
        ...
        LOGGER.info("getBinder Method returns hierarchyBuilderBinder");
        return hierarchyBuilderBinder;
    }
    ...
    public void excelButtonLogic(Button.ClickEvent event) {
        LOGGER.info("excelButtonLogic Started");
        ...
        LOGGER.info("excelButtonLogic Ended");
    }
    ...
    public void addSaveButton() {
        saveBtn.addClickListener(new Button.ClickListener() {
            ...
            @SuppressWarnings("PMD")
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("In addSaveButton btnUpdate.addClickListener started");
                saveBtnLogic(event);
            }
        });
    }
    ...
    private Panel levelDefinitionSection() {
        ...
        gridLayout.addComponent(levelNo);
        ...
        gridLayout.addComponent(userDefinedOrLinked);
    ...
    public void displayBtnLogic(Button.ClickEvent event) {
        LOGGER.info("displayBtnLogic Started");
        ...
        LOGGER.info("displayBtnLogic Ended");
    }
    ...
    public void saveBtnLogic(Button.ClickEvent event) {
        LOGGER.info("addSaveButton Method started");
        saveButtonLogic(event, true);
        LOGGER.info("addSaveButton Method Ended");
    }
     ...
     */
    @UiHandler("resetBtn")
    public void resetBtnLogic(Button.ClickEvent event) throws PortalException, Exception {
        ...
        MessageBox.showPlain(Icon.QUESTION, "Confirmation", "Any unsaved information will not be saved. Do you want to proceed?", new MessageBoxListener() {
            ...
            public void buttonClicked(final ButtonId buttonId) {
                if (buttonId.name().equals("YES")) {
                    ...
                    LOGGER.info("Ending back button method from Add");
                }
            }
    ...
    public void addRowBtnLogic(Button.ClickEvent event) {
        LOGGER.info("addRowBtnLogic Started");
        if (event != null) {
            hierarchyBuilderBinder.getErrorDisplay().clearError();
        ...
        LOGGER.info("addRowBtnLogic Ended");
    }
    ...
    private Panel levelValueSection() {
        ...
        levelValuesPanel.setCaption("Level Values ");
        levelValuesPanel.setSizeFull();
        ...
        gridLayout.addComponent(new Label("Level #:"));
        gridLayout.addComponent(displayLevelNo);
        gridLayout.addComponent(new Label("Level Name:"));
        gridLayout.addComponent(displayLevelName);
        content.setMargin(true);
        content.setSpacing(true);
        ...
        levelValuesPanel.setContent(addSpace());

        levelValuesPanel.setContent(content);
    ...
    public void displayAddRowBtnLogic(Button.ClickEvent event) {
        LOGGER.info("displayAddRowBtn Started");
        if (event != null) {
            hierarchyBuilderBinder.getErrorDisplay().clearError();
        ...
        LOGGER.info("displayAddRowBtn Ended");
    }
    ...
    public void displayDeleteRowBtnLogic(Button.ClickEvent event) {
        LOGGER.info("In deleteButtonLevelValues btnLevValuesDelete.addClickListener Started");
        ...
        LOGGER.info("In deleteButtonLevelValues btnLevValuesDelete.addClickListener Ended");
    }
    ...
    public ExtFilterTable levelDefinitionListTable() {
        ...
        levelDefinitionTable.addItemClickListener(new ItemClickEvent.ItemClickListener() {
            ...
            public void itemClick(final ItemClickEvent event) {
                LOGGER.info("In levelDefinitionListTable levelDefinitionTable.addClickListener Started");
                if (event != null) {
                    deleteRowFlag = false;
                ...
                LOGGER.info("In levelDefinitionListTable levelDefinitionTable.addClickListener Ended");
            }
        });
        ...
        LOGGER.info("levelDefinitionListTable Method retuns levelDefinitionTable");
        return levelDefinitionTable;
    }

    @UiHandler("deleteRowBtn")
    public void deleteRowBtnLogic(Button.ClickEvent event) {
        LOGGER.info("deleteRowBtnLogic Started");
        ...
        LOGGER.info("deleteRowBtnLogic Ended");
    }
    ...
    public Table levelValuesListTable() {
        LOGGER.info("levelValuesListTable Method started");
        ...
        levelValuesPagedTable.setPageLength(7);
        ...
        LOGGER.info("levelValuesListTable Method returns levelValuesTable");
        ...
        try {
            ...
            if (ConstantsUtils.EMPTY.equals(hierarchyType.getValue()) && ConstantsUtils.EMPTY.equals(hierarchyName.getValue().trim())) {
                ...
                if (event != null) {
                    ...
                    } else if (!levelvalues.isEmpty() && levelvalues.size() < 2) {
...
//                                                getUI().getNavigator().navigateTo(HierarchyBuilderLandingView.NAME);
            ...
            LOGGER.info("In addSaveButton btnSave.addClickListener Ended");
        } catch (SystemException ex) {
            final String errorMsg = ErrorCodeUtil.getErrorMessage(ex);
            AbstractNotificationUtils.getErrorNotification(ErrorCodeUtil.getEC(ErrorCodes.ERROR_CODE_1001), errorMsg);
            LOGGER.error(ex);
