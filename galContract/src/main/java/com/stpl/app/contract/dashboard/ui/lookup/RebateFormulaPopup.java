...
public class RebateFormulaPopup extends Window {
    ...
    private int imtdRsdFrSid;
    
    private int imtdContRsdSid;
    
    private int contRsdFrSid;
    
    private int contRsdSid;
    ...
    public RebateFormulaPopup(int imtdContRsdSid,int contRsdFrSid,int contRsdSid,int itemSid,String itemId, final SessionDTO sessionDTO){
        ...
        this.contRsdFrSid=contRsdFrSid;
        this.contRsdSid=contRsdSid;
    ...
    public void addAvailableTable() {
      ...
      availableTable.setPageLength(10);
    ...
    public void addButtons() {
        LOGGER.info("Entering addButtons");
        add();
        remove();
        addAll();
        removeAll();
        LOGGER.info("Ending addButtons");
    }  
                                     ...
                                     boolean flag=true;
                                            if(formula!=null){     
                                                 if(availableTable.getValue()!= null){
                                                    ...
                                                    if(flag){    
                                                        selectedBeanItemContainer.addBean(logic.addToSelectedFormulaList(formula, imtdContRsdSid, 0, 0, itemSid, itemId));
                                                    }                                           
                                                 }else{
     ...
     public Button remove() {
        ...
        btnRemove.setErrorHandler(new ErrorHandler() {
            ...
            @SuppressWarnings("PMD")
            public void error(final com.vaadin.server.ErrorEvent event) {
                LOGGER.info("Error in Single record remove button");
            }
        });
     ...
     public Button addAll() {
        ...
        btnMoveAll.setErrorHandler(new ErrorHandler() {
         ...
         btnMoveAll.addClickListener(new Button.ClickListener() {
			...
			@SuppressWarnings("unchecked")
			public void buttonClick(final Button.ClickEvent event) {
                             LOGGER.info("Entering inside  MOVE_RIGHT ALL  method ");
					...
					LOGGER.error(exception);
                        ...
                        LOGGER.info("Ending MOVE_RIGHT ALL method ");
    ...
    public void addSelectedTable() {
        ...
        selectedTable.setPageLength(10);
