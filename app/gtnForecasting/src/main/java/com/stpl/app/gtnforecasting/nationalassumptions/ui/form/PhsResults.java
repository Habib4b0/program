...
public class PhsResults extends CustomComponent implements View {
     ...
     * The Constant LOGGER.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(PhsResults.class);
                ...
                if (tableDto.getParent() == 1) {
                    ...
                    ndcLinkBtn.addClickListener(new Button.ClickListener() {
                        ...
                        public void buttonClick(final Button.ClickEvent event) {
                            ...
                            final List<String> phsColumns = new ArrayList<>(projectionDTO.getColumns());
                            ...
                            lookUp.addCloseListener(new Window.CloseListener() {
                                ...
                                public void windowClose(Window.CloseEvent e) {
                                    ...
                                    lookUp.closeLogic();
                                    projectionDTO.setColumns(phsColumns);
                                    if (lookUp.isSubmit()) {
                                        loadResultTable();
                                    }
                                }
