...
public class GcmCompanyLinkLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<GcmCompanyLinkLocalService, GcmCompanyLinkLocalService> _serviceTracker =
		ServiceTrackerFactory.open(GcmCompanyLinkLocalService.class);
}