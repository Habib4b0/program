...
/**
 * Provides the local service interface for StNewNdc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StNewNdcLocalServiceUtil
...
public interface StNewNdcLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link StNewNdcLocalServiceUtil} to access the st new ndc local service. Add custom service methods to {@link com.stpl.app.service.impl.StNewNdcLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
