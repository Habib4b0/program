 ...
 */
@Service
public class GtnWsReturnsMassUpdateGrowthRate implements GtnWsReturnsCalculation {
	...
	public void calculations(GtnForecastBean gtnForecastBean) throws GtnFrameworkGeneralException {
		...
		List<GtnWsTreeNode> treeNode = calculationUtilService.getCheckedMassUpdateNodeForGrowth(gtnForecastBean);
	...
	private void updateGrowthRate(final List<Object> fileList, final Integer[] period, final int columnLength,
			final String growthRate) throws EvaluationException, GtnFrameworkGeneralException {
