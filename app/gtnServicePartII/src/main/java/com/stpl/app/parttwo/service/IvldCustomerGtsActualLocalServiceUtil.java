...
public class IvldCustomerGtsActualLocalServiceUtil {
    private static IvldCustomerGtsActualLocalService _service;
    ...
    */
    ...
    public static IvldCustomerGtsActualLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    IvldCustomerGtsActualLocalService.class.getName());

            if (invokableLocalService instanceof IvldCustomerGtsActualLocalService) {
                _service = (IvldCustomerGtsActualLocalService) invokableLocalService;
            } else {
                _service = new IvldCustomerGtsActualLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(IvldCustomerGtsActualLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(IvldCustomerGtsActualLocalService service) {
    }
}
