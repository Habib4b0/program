...
/**
    ...
    private void configureTable() {
        ...
        AccrualRateUtils.getRightHeadersForAccrual(tableHeaderDTO, historyDdlb.getValue(), accrualRateSelectionDTO,AccrualRateUtils.RATES,null);
    ...
    public void generateBtnLogic(Button.ClickEvent event) {
        try {
            ...
            LOGGER.error(ex.getClass() + AccrualRateUtils.DASH + ex.getMessage());
        }
    }
    ...
    public void configureAndLoadDataForExcel(final ExtCustomTable excelTable, final ExtContainer<AccrualRateProjectionDTO> excelContainer) {
        ...
        excelContainer.addAll(accrualRateProjectionLogic.getDataForRates(accrualRateSelectionDTO,0,0,true));
    ...
    private void generateLogic() {
        LOGGER.info("Enters Generate Logic");    
        tableLogic.setRequiredData(AccrualRateUtils.RATES, accrualRateSelectionDTO,null);        
        LOGGER.info("Exits Generate Logic");
    }
