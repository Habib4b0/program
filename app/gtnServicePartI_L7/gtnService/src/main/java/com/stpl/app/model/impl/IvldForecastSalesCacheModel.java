...
public class IvldForecastSalesCacheModel implements CacheModel<IvldForecastSales>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldForecastSalesCacheModel)) {
			return false;
		}

		IvldForecastSalesCacheModel ivldForecastSalesCacheModel = (IvldForecastSalesCacheModel)obj;

		if (ivldForecastSalesSid == ivldForecastSalesCacheModel.ivldForecastSalesSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldForecastSalesSid);
	}
