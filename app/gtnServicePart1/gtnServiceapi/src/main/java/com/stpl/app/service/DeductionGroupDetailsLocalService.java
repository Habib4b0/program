...
/**
 * Provides the local service interface for DeductionGroupDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see DeductionGroupDetailsLocalServiceUtil
...
public interface DeductionGroupDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DeductionGroupDetailsLocalServiceUtil} to access the deduction group details local service. Add custom service methods to {@link com.stpl.app.service.impl.DeductionGroupDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public DeductionGroupDetails addDeductionGroupDetails(
	...
	*/
	public DeductionGroupDetails createDeductionGroupDetails(
	...
	*/
	...
	public DeductionGroupDetails deleteDeductionGroupDetails(
		DeductionGroupDetails deductionGroupDetails);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public DeductionGroupDetails deleteDeductionGroupDetails(
		int deductionGroupDetailsSid) throws PortalException;
	...
	*/
	...
	public DeductionGroupDetails fetchDeductionGroupDetails(
		int deductionGroupDetailsSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DeductionGroupDetails getDeductionGroupDetails(
		int deductionGroupDetailsSid) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DeductionGroupDetails> getDeductionGroupDetailses(int start,
		int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public DeductionGroupDetails updateDeductionGroupDetails(
		DeductionGroupDetails deductionGroupDetails);
}