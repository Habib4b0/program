...
public final class CommonUIUtil {
    ...
    public static final Object[] FILE_MGT_HISTORY_RESULT_COLUMNS = new Object[]{"file", "companyName", "businessUnit", "effectiveDate", "type", "version", "fromPeriod", "toPeriod"};

    public static final String[] FILE_MGT_HISTORY_RESULT_HEADER = new String[]{"File", "Company", "Business Unit", "Effective Date", "Type", CommonUtil.VERSION, "From Period", "To Period"};

    public static final Object[] FILE_MGT_LOOKUP_RESULT_COLUMNS = new Object[]{"fileType", "companyName", "businessUnit", "country", "fileName", "type", "version", "fromDate", "toDate"};

    public static final String[] FILE_MGT_LOOKUP_RESULT_HEADER = new String[]{"File Type", "Company", "Business Unit", "Country", "File Name", "Type", CommonUtil.VERSION, "From Date", "To Date"};

    public static final Object[] FILE_MGT_LOOKUP_DETAILS_COLUMNS = new Object[]{CommonUtil.CHECK, "year", "month", "itemNo", "itemName", "startDate", "price", "units", "dollars"};
    ...
    public static final Object[] FILE_MGT_LOOKUP_DEMAND_DETAILS_COLUMNS = new Object[]{CommonUtil.CHECK, "forecastType", CommonUtil.FORECAST_YEAR, "forecastMonth", "itemId",
    ...
    public static final Object[] FILE_MGT_LOOKUP_ADJUSTED_DEMAND_DETAILS_COLUMNS = new Object[]{CommonUtil.CHECK, "itemId", "itemName", "brandId", "brandName", "segment",
        CommonUtil.FORECAST_YEAR, "forecastMonth", "marketSizeUnits", "marketShareRatio", "marketShareUnits", "uncapturedUnits", "uncapturedUnitsRatio", "totalDemandUnits", "totalDemandAmount", "inventoryUnitChange", "grossUnits", "grossPrice", "grossAmount", "netSalesPrice", "netSalesAmount", "batchId", "source", "organizationKey"};

    public static final Object[] FILE_MGT_LOOKUP_INVENTORY_DETAILS_SUMMARY_COLUMNS = new Object[]{CommonUtil.CHECK, "year", "month", "day", "week", "itemId", "itemIdentifierCodeQualifier", "itemIdentifier",
    ...
    public static final Object[] FILE_MGT_LOOKUP_INVENTORY_DETAILS_DETAILS_COLUMNS = new Object[]{CommonUtil.CHECK, "year", "month", "day", "week", "companyId", "companyName", "itemId", "itemName", 
    ...
    public static final String[] AC_HB_SEARCH_RESULT_HEADER = new String[]{"Hierarchy Name", "Hierarchy Type", "Hierarchy Category", "# of Levels", CommonUtil.VERSION, "Creation Date", "Modified Date", "Created By"};
    ...
    public static final Object[] HIERARCHY_OUTBOUND_SEARCH_COLUMNS = new Object[]{CommonUtil.CHECK, "hierarchyName", "hierarchyTypeDto", "hierarchyCategory", "noOfLevels", "versionNo", "createdDate", "modifiedDate", "createdBy"};

    public static final String[] HIERARCHY_OUTBOUND_SEARCH_HEADER = new String[]{"", "Hierarchy Name", "Hierarchy Type", "Hierarchy Category", "# of Levels", CommonUtil.VERSION, "Creation Date", "Modified Date", "Created By"};

    public static final Object[] RELATIONSHIP_OUTBOUND_SEARCH_COLUMNS = new Object[]{CommonUtil.CHECK,
    ...
    public static final Object[] FILE_MGT_LOOKUP_CUSTOMER_COLUMNS = new Object[]{CommonUtil.FORECAST_YEAR, "forecastMonth", "itemId",
    ...
    public static final String[] EXCEL_FILE_MGT_LOOKUP_ADJUSTED_DEMAND_DETAILS_HEADER = new String[]{"Item ID", "Item Name", "Brand ID", "Brand Name", "Segment", "Year",
        "Month", "Market Size Units", "Market Share Ratio", "Market Share Units", "Uncaptured Units",
        "Uncaptured Units Ratio", "Total Demand Units", "Total Demand Amount", "Inventory Unit Change",
        "Gross Units", "Gross Price", "Gross Amount", "Net Sales Price", "Net Sales Amount",
        "Batch ID", "Source", "Organization Key"};

    public static final String[] EXCEL_FILE_MGT_LOOKUP_DEMAND_DETAILS_HEADER = new String[]{"Forecast Type", "Forecast Year", "Forecast Month",
        "Item Id", "Item Identifier Code Qualifier", "Item Identifier",
        "Brand Id", "Segment", "Market Size Units", "Market Share Ratio",
        "Market Share Units", "Uncaptured Units", "Uncaptured Units Ratio",
        "Total Demand Units", "Total Demand Amount", "Inventory Unit Change",
    ...
    public static final String[] EXCEL_FILE_MGT_LOOKUP_DETAILS_HEADER = new String[]{"Year", "Month", "Item #", "Item Name", "Forecast Date", "Price", "Units", "Dollars"};

    public static final String[] EXCEL_FILE_MGT_LOOKUP_INVENTORY_DETAILS_DETAILS_HEADER = new String[]{"Year", "Month", "Day", "Week", "Company ID", "Company Name", "Item ID", "Item Name",
        "Units Withdrawn", "Amount Withdrawn", "Price", "Created By", "Created Date", "Modified By", "Modified Date", "Add Chg Del Indicator", "Batch ID", "Source ID", "Forecast Name", "Forecast Ver", "Country", "Organization Key"};

    public static final String[] EXCEL_FILE_MGT_LOOKUP_INVENTORY_DETAILS_SUMMARY_HEADER = new String[]{"Year", "Month", "Day", "Week", "Item ID", "Item Identifier Code Qualifier", "Item Identifier",
        "Units Withdrawn", "Amount Withdrawn", "Price", "Batch ID", "Organization Key"};
