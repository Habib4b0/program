 ...
 * @generated
 */
public class RsContractDetailsFrLocalServiceClp
    ...
    public RsContractDetailsFrLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addRsContractDetailsFr";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.RsContractDetailsFr"
            };

        _methodName1 = "createRsContractDetailsFr";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteRsContractDetailsFr";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteRsContractDetailsFr";
        ...
        _methodName10 = "fetchRsContractDetailsFr";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getRsContractDetailsFr";
        ...
        _methodName13 = "getRsContractDetailsFrs";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getRsContractDetailsFrsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateRsContractDetailsFr";
    ...
    public com.stpl.app.model.RsContractDetailsFr addRsContractDetailsFr(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(rsContractDetailsFr)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.RsContractDetailsFr) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.RsContractDetailsFr createRsContractDetailsFr(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { rsContractDetailsFrSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.RsContractDetailsFr> getRsContractDetailsFrs(
        ...
        return (java.util.List<com.stpl.app.model.RsContractDetailsFr>) ClpSerializer.translateOutput(returnObj);
    }
