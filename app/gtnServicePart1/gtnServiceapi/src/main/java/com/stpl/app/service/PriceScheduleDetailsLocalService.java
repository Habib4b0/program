...
/**
 * Provides the local service interface for PriceScheduleDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see PriceScheduleDetailsLocalServiceUtil
...
public interface PriceScheduleDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PriceScheduleDetailsLocalServiceUtil} to access the price schedule details local service. Add custom service methods to {@link com.stpl.app.service.impl.PriceScheduleDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
