...
public final class HelperUtils {
	...
	public static List<String> getStatus() {
		...
		try {
			status.add("Active");
			status.add("Inactive");
			LOGGER.info("Ends getStatus with status size  :::: " + status.size());
		} catch (Exception e) {
	...
	public static List<String> getMfpPopulateList() {
		LOGGER.info("Entering getMfpPopulateList");
		final List<String> status = new ArrayList<String>();
		try {
			...
			LOGGER.info("Ends getMfpPopulateList with status size  :::: " + status.size());
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		}
		return status;
	...
	public static List<String> getIfpPopulateList() {
		LOGGER.info("Entering getIfpPopulateList");
		final List<String> status = new ArrayList<String>();
		try {
			status.add(START_DATE);
			status.add(END_DATE);
			...
			status.add("Attached Status");
			LOGGER.info("Ends getIfpPopulateList with status size  :::: " + status.size());
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		}
		return status;
	...
	public static List<String> getCfpPopulateList() {
		LOGGER.info("Entering getCfpPopulateList");
		final List<String> status = new ArrayList<String>();
		try {
			status.add(START_DATE);
			status.add(END_DATE);
			...
			status.add("TradeClass EndDate");
			status.add("Attached Status");
			LOGGER.info("Ends getCfpPopulateList with status size  :::: " + status.size());
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		}
		return status;
	...
	public static List<String> getPsPopulateList() {
		LOGGER.info("Entering getPsPopulateList");
		final List<String> status = new ArrayList<String>();
		try {
			status.add(START_DATE);
			status.add(END_DATE);
			status.add("RevisionDate");
			LOGGER.info("Ends getPsPopulateList with status size  :::: " + status.size());
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		}
		return status;
	...
	public static List<String> geRsPopulateList() {
		LOGGER.info("Entering geRsPopulateList");
		final List<String> status = new ArrayList<String>();
		try {
			...
			status.add(START_DATE);
			status.add(END_DATE);
			LOGGER.info("Ends geRsPopulateList with status size  :::: " + status.size());
		} catch (Exception e) {
			LOGGER.error(e.getMessage());
		}
		return status;
