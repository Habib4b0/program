...
public class ItemGroupView extends VerticalLayout implements View {
     ...
     */
    public ItemGroupView(final SessionDTO sessionDTO) throws SystemException, PortalException, Exception {
        super();
        try {
    ...
    public void enter(final ViewChangeListener.ViewChangeEvent event) {
        LOGGER.info("enter ViewChangeListener Started");
        try {
            ...
            if (itemGroupSystemId == ConstantsUtils.ZERO_NUM) {
                ...
                if (!ConstantsUtils.LOWERCASE_COPY.equalsIgnoreCase(pageName)) {
                    if (!availableContainer.isEmpty()) {
        ...
        LOGGER.info("enter ViewChangeListener Ended");
    }
}
