...
//    GridLayout gridLayout;
    ...
    private void configureTable() {
        ...
        AccrualRateUtils.getRightHeadersForAccrual(rightHeaderDTO, historyDdlb.getValue(), accrualRateSelectionDTO, AccrualRateUtils.SALES, selectedVariables);
        ...
        resultsTable.setSplitPosition(30);
        resultsTable.setDoubleHeaderVisible(true);
    ...
    public void resetBtn(Button.ClickEvent event) {
        ...
        }.getConfirmationMessage("Reset Confirmation", alertMsg.getString("ACCRUAL_SALES_02"));
    ...
    private void resetBtnLogic() {
        ...
        fromDdlb.select(StringUtils.EMPTY);
        toDdlb.select(StringUtils.EMPTY);
        LOGGER.info("resetBtnLogic end");
    }
    
    private void generateBtnLogic() {
        LOGGER.info("generateBtnLogic starts");
        tableLogic.setRequiredData(AccrualRateUtils.SALES, accrualRateSelectionDTO, selectedVariables);
    ...
    public void configureAndLoadDataForExcel(final ExtCustomTable excelTable, final ExtContainer<AccrualRateProjectionDTO> excelContainer) {
        ...
        AccrualRateUtils.getRightHeadersForAccrual(excelHeaderDTO, historyDdlb.getValue(), accrualRateSelectionDTO, AccrualRateUtils.SALES, selectedVariables);
        ...
        excelContainer.addAll(accrualRateProjectionLogic.getDataForSales(accrualRateSelectionDTO, selectedVariables, 0, 0, true));
