...
public class ImtdItemPriceRebateDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<ImtdItemPriceRebateDetailsLocalService, ImtdItemPriceRebateDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ImtdItemPriceRebateDetailsLocalService.class);
}