 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldSalesMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldSalesMasterImpl}.
 * </p>
 *
 * @author
...
public class IvldSalesMasterModelImpl extends BaseModelImpl<IvldSalesMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("SALES_INTFID", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("IVLD_SALES_MASTER_SID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("ACCOUNT_CODE_QUALIFIER", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PARENT_ITEM_ID", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("WHOLESALE_OWNER_ID", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("CUSTOMER_SUBTYPE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PARENT_ITEM_NO", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ORDER_RECEIVED_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ORDER_SUBTYPE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("CUSTOMER_COMPANY_CODE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ORDER_TYPE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("COMPANY_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("BRAND_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("INVOICE_DATE", Types.VARCHAR);
	...
	public Object clone() {
		...
		ivldSalesMasterImpl.setCompanyStringId(getCompanyStringId());
	...
	public CacheModel<IvldSalesMaster> toCacheModel() {
		...
		ivldSalesMasterCacheModel.companyStringId = getCompanyStringId();

		String companyStringId = ivldSalesMasterCacheModel.companyStringId;

		if ((companyStringId != null) && (companyStringId.length() == 0)) {
			ivldSalesMasterCacheModel.companyStringId = null;
		}
	...
	private static final ClassLoader _classLoader = IvldSalesMaster.class.getClassLoader();
