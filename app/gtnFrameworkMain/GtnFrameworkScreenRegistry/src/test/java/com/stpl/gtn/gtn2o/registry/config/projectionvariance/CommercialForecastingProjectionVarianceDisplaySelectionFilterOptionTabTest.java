...
public class CommercialForecastingProjectionVarianceDisplaySelectionFilterOptionTabTest {

	@Test
    public void testMainScreenConfigPrivateMethod1() {
        String methodName = "addTabSheet";
        CommercialForecastingProjectionVarianceDisplaySelectionFilterOptionTab instance = new CommercialForecastingProjectionVarianceDisplaySelectionFilterOptionTab();
        testComponentConfig(methodName, instance);
    }

	 public void testComponentConfig(String gtnFrameworkConfigMethodName, CommercialForecastingProjectionVarianceDisplaySelectionFilterOptionTab gtnFrameworkClassName) {
	    ...
	    private List<GtnUIFrameworkComponentConfig> getComponentList(Method method, CommercialForecastingProjectionVarianceDisplaySelectionFilterOptionTab gtnFrameworkSalesProjectionTabConfig) throws SecurityException {
