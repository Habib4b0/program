...
public abstract class ChProjectionSelectionLocalServiceBaseImpl
    ...
    private ChProjectionSelectionLocalServiceClpInvoker _clpInvoker = new ChProjectionSelectionLocalServiceClpInvoker();
    ...
    public ChProjectionSelection deleteChProjectionSelection(
        int chProjectionSelectionSid) throws PortalException, SystemException {
    ...
    public ChProjectionSelection fetchChProjectionSelection(
        int chProjectionSelectionSid) throws SystemException {
     ...
     */
    @Override
    public int getChProjectionSelectionsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ChProjectionSelection",
