...
public class AuditMasterInboundLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<AuditMasterInboundLocalService, AuditMasterInboundLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AuditMasterInboundLocalService.class);
}