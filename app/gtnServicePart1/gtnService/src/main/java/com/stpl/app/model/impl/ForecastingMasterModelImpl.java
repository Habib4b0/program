 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ForecastingMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ForecastingMasterImpl}.
 * </p>
 *
 * @author
...
public class ForecastingMasterModelImpl extends BaseModelImpl<ForecastingMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ACTUAL_SALES_PERCENTAGE_MONTH", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("PERCENTAGE_ESTIMATE_YEAR", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("RECORD_LOCK_STATUS", Types.BOOLEAN);
		TABLE_COLUMNS_MAP.put("SOURCE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("FORECAST_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("FORECASTED_SALES_PERCENT_MONTH", Types.INTEGER);
	...
	public static final long FORECASTMONTH_COLUMN_BITMASK = 4L;
	public static final long FORECASTSTARTDATE_COLUMN_BITMASK = 8L;
	public static final long FORECASTYEAR_COLUMN_BITMASK = 16L;
	public static final long NDC_COLUMN_BITMASK = 32L;
	public static final long FORECASTMASTERSID_COLUMN_BITMASK = 64L;
	...
	private static final ClassLoader _classLoader = ForecastingMaster.class.getClassLoader();
