...
public class RatesReturnReserveSearchResults extends AbstractRatesSearchResults {
    ...
    public void rateProcedureCall(AbstractSelectionDTO selectionDTO) {
        ...
        CommonUtils.callInsertProcedure("PRC_ARM_RETURN_RATE", orderedArgs);
    }
    ...
    public Object[] getExcelHierarchy() {
        Object[] value = null;
        if (customerProductView.getValue().equals(ARMConstants.getDeductionContract())) {
    ...
    protected void configureRightTable() {
        RatesTableGenerator fieldFactory = new RatesTableGenerator(getSummaryLogic(), getSelection(), true, (Object[]) ARMUtils.getReturnReserveRatesColumns());
