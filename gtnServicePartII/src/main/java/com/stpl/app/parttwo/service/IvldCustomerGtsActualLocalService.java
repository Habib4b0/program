...
/**
 * Provides the local service interface for IvldCustomerGtsActual. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldCustomerGtsActualLocalServiceUtil
...
public interface IvldCustomerGtsActualLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IvldCustomerGtsActualLocalServiceUtil} to access the ivld customer gts actual local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.IvldCustomerGtsActualLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
