...
public class StMSupplementalDiscActualsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<StMSupplementalDiscActualsLocalService, StMSupplementalDiscActualsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(StMSupplementalDiscActualsLocalService.class);
}