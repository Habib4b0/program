...
/**
 * Provides the local service interface for NmActualPpa. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see NmActualPpaLocalServiceUtil
...
public interface NmActualPpaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NmActualPpaLocalServiceUtil} to access the nm actual ppa local service. Add custom service methods to {@link com.stpl.app.service.impl.NmActualPpaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
