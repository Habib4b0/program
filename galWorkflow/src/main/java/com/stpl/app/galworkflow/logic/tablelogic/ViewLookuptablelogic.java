...
public class ViewLookuptablelogic extends PageTableLogic {
    ...
    @Override
    public int getCount() {
        LOGGER.info("Entering workflowtablelogic WorkflowinboxCount");
        int count = 0;
        try {
            if (isFirstLoad) {
    ...
    public List loadData(int start, int offset) {
        LOGGER.info("Entering workflowtablelogic loadData");
    ...
    public Object configureContainer(Object object, Container container) {
        LOGGER.info("Entering workflowtablelogic configureContainer");
    ...
    public void configureSearchData(InboxDashboardDTO inboxDashboardDTO) {
        LOGGER.info("Entering workflowtablelogic configureSearchData");
        clearAll();
        this.inboxDashboardDTO = inboxDashboardDTO;
        setRequiredCount(true);
        isFirstLoad = true;
        isReset = false;
        LOGGER.info("Ending workflowtablelogic configureSearchData");
    }
