...
import com.stpl.app.service.NmSalesProjectionMasterLocalService;
...
/**
 * Provides the base implementation for the nm sales projection master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.NmSalesProjectionMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class NmSalesProjectionMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NmSalesProjectionMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.NmSalesProjectionMasterLocalServiceUtil} to access the nm sales projection master local service.
	 */
	...
	@Override
	public NmSalesProjectionMaster addNmSalesProjectionMaster(
		NmSalesProjectionMaster nmSalesProjectionMaster) {
		nmSalesProjectionMaster.setNew(true);

		return nmSalesProjectionMasterPersistence.update(nmSalesProjectionMaster);
	}
	 ...
	 */
	@Override
	public NmSalesProjectionMaster createNmSalesProjectionMaster(
		int projectionDetailsSid) {
		return nmSalesProjectionMasterPersistence.create(projectionDetailsSid);
	}
	...
	@Override
	public NmSalesProjectionMaster deleteNmSalesProjectionMaster(
		int projectionDetailsSid) throws PortalException {
		return nmSalesProjectionMasterPersistence.remove(projectionDetailsSid);
	}
	...
	public NmSalesProjectionMaster deleteNmSalesProjectionMaster(
		NmSalesProjectionMaster nmSalesProjectionMaster) {
		return nmSalesProjectionMasterPersistence.remove(nmSalesProjectionMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NmSalesProjectionMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return nmSalesProjectionMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return nmSalesProjectionMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NmSalesProjectionMaster fetchNmSalesProjectionMaster(
		int projectionDetailsSid) {
		return nmSalesProjectionMasterPersistence.fetchByPrimaryKey(projectionDetailsSid);
	}
	 ...
	 */
	@Override
	public NmSalesProjectionMaster getNmSalesProjectionMaster(
		int projectionDetailsSid) throws PortalException {
		return nmSalesProjectionMasterPersistence.findByPrimaryKey(projectionDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(nmSalesProjectionMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NmSalesProjectionMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(nmSalesProjectionMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NmSalesProjectionMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return nmSalesProjectionMasterLocalService.deleteNmSalesProjectionMaster((NmSalesProjectionMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return nmSalesProjectionMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NmSalesProjectionMaster> getNmSalesProjectionMasters(
		int start, int end) {
		return nmSalesProjectionMasterPersistence.findAll(start, end);
	}
	...
	public int getNmSalesProjectionMastersCount() {
		return nmSalesProjectionMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NmSalesProjectionMaster updateNmSalesProjectionMaster(
		NmSalesProjectionMaster nmSalesProjectionMaster) {
		return nmSalesProjectionMasterPersistence.update(nmSalesProjectionMaster);
	}
	 ...
	 */
	public NmSalesProjectionMasterLocalService getNmSalesProjectionMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.NmSalesProjectionMaster",
			nmSalesProjectionMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return NmSalesProjectionMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = nmSalesProjectionMasterPersistence.getDataSource();
	...
	@BeanReference(type = NmSalesProjectionMasterLocalService.class)
	protected NmSalesProjectionMasterLocalService nmSalesProjectionMasterLocalService;
