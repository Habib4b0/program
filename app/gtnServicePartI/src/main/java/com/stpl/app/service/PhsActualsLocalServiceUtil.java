...
public class PhsActualsLocalServiceUtil {
    private static PhsActualsLocalService _service;
    ...
    */
    ...
    public static PhsActualsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    PhsActualsLocalService.class.getName());

            if (invokableLocalService instanceof PhsActualsLocalService) {
                _service = (PhsActualsLocalService) invokableLocalService;
            } else {
                _service = new PhsActualsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(PhsActualsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(PhsActualsLocalService service) {
    }
}
