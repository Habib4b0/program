...
import com.stpl.app.service.IvldDemandForecastLocalService;
...
/**
 * Provides the base implementation for the ivld demand forecast local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldDemandForecastLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldDemandForecastLocalServiceImpl
 * @see com.stpl.app.service.IvldDemandForecastLocalServiceUtil
 * @generated
 */
public abstract class IvldDemandForecastLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements IvldDemandForecastLocalService,
        IdentifiableBean {
    ...
    private IvldDemandForecastLocalServiceClpInvoker _clpInvoker = new IvldDemandForecastLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldDemandForecastLocalServiceUtil} to access the ivld demand forecast local service.
     */
    ...
    @Override
    public IvldDemandForecast addIvldDemandForecast(
        IvldDemandForecast ivldDemandForecast) throws SystemException {
        ivldDemandForecast.setNew(true);

        return ivldDemandForecastPersistence.update(ivldDemandForecast);
    }
     ...
     */
    @Override
    public IvldDemandForecast createIvldDemandForecast(
        int ivldDemandForecastSid) {
        return ivldDemandForecastPersistence.create(ivldDemandForecastSid);
    }
    ...
    @Override
    public IvldDemandForecast deleteIvldDemandForecast(
        int ivldDemandForecastSid) throws PortalException, SystemException {
        return ivldDemandForecastPersistence.remove(ivldDemandForecastSid);
    }
    ...
    public IvldDemandForecast deleteIvldDemandForecast(
        IvldDemandForecast ivldDemandForecast) throws SystemException {
        return ivldDemandForecastPersistence.remove(ivldDemandForecast);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IvldDemandForecast.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return ivldDemandForecastPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldDemandForecastPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public IvldDemandForecast fetchIvldDemandForecast(int ivldDemandForecastSid)
        throws SystemException {
        return ivldDemandForecastPersistence.fetchByPrimaryKey(ivldDemandForecastSid);
    }
     ...
     */
    @Override
    public IvldDemandForecast getIvldDemandForecast(int ivldDemandForecastSid)
        throws PortalException, SystemException {
        return ivldDemandForecastPersistence.findByPrimaryKey(ivldDemandForecastSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ivldDemandForecastPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IvldDemandForecast> getIvldDemandForecasts(int start, int end)
        throws SystemException {
        return ivldDemandForecastPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIvldDemandForecastsCount() throws SystemException {
        return ivldDemandForecastPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IvldDemandForecast updateIvldDemandForecast(
        IvldDemandForecast ivldDemandForecast) throws SystemException {
        return ivldDemandForecastPersistence.update(ivldDemandForecast);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.IvldDemandForecast",
            ivldDemandForecastLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.IvldDemandForecast");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ivldDemandForecastPersistence.getDataSource();
