...
import com.stpl.app.parttwo.service.AccClosureViewMasterLocalService;
...
/**
 * Provides the base implementation for the acc closure view master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.AccClosureViewMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.AccClosureViewMasterLocalServiceImpl
 * @see com.stpl.app.parttwo.service.AccClosureViewMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AccClosureViewMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccClosureViewMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.AccClosureViewMasterLocalServiceUtil} to access the acc closure view master local service.
	 */
	...
	public AccClosureViewMaster addAccClosureViewMaster(
		...
		return accClosureViewMasterPersistence.update(accClosureViewMaster);
	}
	...
	public AccClosureViewMaster createAccClosureViewMaster(
		...
		return accClosureViewMasterPersistence.create(accClosureViewMasterSid);
	}
	...
	public AccClosureViewMaster deleteAccClosureViewMaster(
		...
		return accClosureViewMasterPersistence.remove(accClosureViewMasterSid);
	}
	...
	public AccClosureViewMaster deleteAccClosureViewMaster(
		AccClosureViewMaster accClosureViewMaster) {
		return accClosureViewMasterPersistence.remove(accClosureViewMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccClosureViewMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accClosureViewMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accClosureViewMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AccClosureViewMaster fetchAccClosureViewMaster(
		int accClosureViewMasterSid) {
		return accClosureViewMasterPersistence.fetchByPrimaryKey(accClosureViewMasterSid);
	}
	...
	public AccClosureViewMaster getAccClosureViewMaster(
		int accClosureViewMasterSid) throws PortalException {
		return accClosureViewMasterPersistence.findByPrimaryKey(accClosureViewMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accClosureViewMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccClosureViewMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accClosureViewMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccClosureViewMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accClosureViewMasterLocalService.deleteAccClosureViewMaster((AccClosureViewMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return accClosureViewMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AccClosureViewMaster> getAccClosureViewMasters(int start,
		int end) {
		return accClosureViewMasterPersistence.findAll(start, end);
	}
	...
	public int getAccClosureViewMastersCount() {
		return accClosureViewMasterPersistence.countAll();
	}
	 ...
	 */
	public AccClosureViewMasterLocalService getAccClosureViewMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.AccClosureViewMaster",
			accClosureViewMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccClosureViewMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accClosureViewMasterPersistence.getDataSource();
	...
	@BeanReference(type = AccClosureViewMasterLocalService.class)
	protected AccClosureViewMasterLocalService accClosureViewMasterLocalService;
