...
/**
 * Provides the local service interface for AcBrMethodologyDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see AcBrMethodologyDetailsLocalServiceUtil
...
public interface AcBrMethodologyDetailsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AcBrMethodologyDetailsLocalServiceUtil} to access the ac br methodology details local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.AcBrMethodologyDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
