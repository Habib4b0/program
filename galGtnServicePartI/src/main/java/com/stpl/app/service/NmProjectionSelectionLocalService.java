...
/**
 * Provides the local service interface for NmProjectionSelection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see NmProjectionSelectionLocalServiceUtil
...
public interface NmProjectionSelectionLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link NmProjectionSelectionLocalServiceUtil} to access the nm projection selection local service. Add custom service methods to {@link com.stpl.app.service.impl.NmProjectionSelectionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
