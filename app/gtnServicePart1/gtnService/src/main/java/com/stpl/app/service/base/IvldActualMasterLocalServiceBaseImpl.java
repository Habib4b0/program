...
import com.stpl.app.service.IvldActualMasterLocalService;
...
/**
 * Provides the base implementation for the ivld actual master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldActualMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldActualMasterLocalServiceImpl
 * @see com.stpl.app.service.IvldActualMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldActualMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldActualMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldActualMasterLocalServiceUtil} to access the ivld actual master local service.
	 */
	...
	@Override
	public IvldActualMaster addIvldActualMaster(
		IvldActualMaster ivldActualMaster) {
		ivldActualMaster.setNew(true);

		return ivldActualMasterPersistence.update(ivldActualMaster);
	}
	 ...
	 */
	@Override
	public IvldActualMaster createIvldActualMaster(int ivldActualMasterSid) {
		return ivldActualMasterPersistence.create(ivldActualMasterSid);
	}
	...
	@Override
	public IvldActualMaster deleteIvldActualMaster(int ivldActualMasterSid)
		throws PortalException {
		return ivldActualMasterPersistence.remove(ivldActualMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IvldActualMaster deleteIvldActualMaster(
		IvldActualMaster ivldActualMaster) {
		return ivldActualMasterPersistence.remove(ivldActualMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldActualMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldActualMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldActualMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldActualMaster fetchIvldActualMaster(int ivldActualMasterSid) {
		return ivldActualMasterPersistence.fetchByPrimaryKey(ivldActualMasterSid);
	}
	 ...
	 */
	@Override
	public IvldActualMaster getIvldActualMaster(int ivldActualMasterSid)
		throws PortalException {
		return ivldActualMasterPersistence.findByPrimaryKey(ivldActualMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldActualMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldActualMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ivldActualMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldActualMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldActualMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldActualMasterLocalService.deleteIvldActualMaster((IvldActualMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldActualMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldActualMaster> getIvldActualMasters(int start, int end) {
		return ivldActualMasterPersistence.findAll(start, end);
	}
	...
	public int getIvldActualMastersCount() {
		return ivldActualMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldActualMaster updateIvldActualMaster(
		IvldActualMaster ivldActualMaster) {
		return ivldActualMasterPersistence.update(ivldActualMaster);
	}
	 ...
	 */
	public IvldActualMasterLocalService getIvldActualMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.IvldActualMaster",
			ivldActualMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldActualMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldActualMasterPersistence.getDataSource();
	...
	@BeanReference(type = IvldActualMasterLocalService.class)
	protected IvldActualMasterLocalService ivldActualMasterLocalService;
