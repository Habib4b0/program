...
public class IfpDetailsCacheModel implements CacheModel<IfpDetails>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IfpDetailsCacheModel)) {
			return false;
		}

		IfpDetailsCacheModel ifpDetailsCacheModel = (IfpDetailsCacheModel)obj;

		if (ifpDetailsSid == ifpDetailsCacheModel.ifpDetailsSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ifpDetailsSid);
	}
