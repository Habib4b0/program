...
import com.stpl.app.parttwo.service.IvldCompanyMasterLocalService;
...
/**
 * Provides the base implementation for the ivld company master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.IvldCompanyMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.IvldCompanyMasterLocalServiceImpl
 * @see com.stpl.app.parttwo.service.IvldCompanyMasterLocalServiceUtil
 * @generated
 */
public abstract class IvldCompanyMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements IvldCompanyMasterLocalService,
        IdentifiableBean {
    ...
    private IvldCompanyMasterLocalServiceClpInvoker _clpInvoker = new IvldCompanyMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldCompanyMasterLocalServiceUtil} to access the ivld company master local service.
     */
    ...
    @Override
    public IvldCompanyMaster addIvldCompanyMaster(
        IvldCompanyMaster ivldCompanyMaster) throws SystemException {
        ivldCompanyMaster.setNew(true);

        return ivldCompanyMasterPersistence.update(ivldCompanyMaster);
    }
     ...
     */
    @Override
    public IvldCompanyMaster createIvldCompanyMaster(int ivldCompanyMasterSid) {
        return ivldCompanyMasterPersistence.create(ivldCompanyMasterSid);
    }
    ...
    @Override
    public IvldCompanyMaster deleteIvldCompanyMaster(int ivldCompanyMasterSid)
        throws PortalException, SystemException {
        return ivldCompanyMasterPersistence.remove(ivldCompanyMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public IvldCompanyMaster deleteIvldCompanyMaster(
        IvldCompanyMaster ivldCompanyMaster) throws SystemException {
        return ivldCompanyMasterPersistence.remove(ivldCompanyMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IvldCompanyMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return ivldCompanyMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldCompanyMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public IvldCompanyMaster fetchIvldCompanyMaster(int ivldCompanyMasterSid)
        throws SystemException {
        return ivldCompanyMasterPersistence.fetchByPrimaryKey(ivldCompanyMasterSid);
    }
     ...
     */
    @Override
    public IvldCompanyMaster getIvldCompanyMaster(int ivldCompanyMasterSid)
        throws PortalException, SystemException {
        return ivldCompanyMasterPersistence.findByPrimaryKey(ivldCompanyMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ivldCompanyMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IvldCompanyMaster> getIvldCompanyMasters(int start, int end)
        throws SystemException {
        return ivldCompanyMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIvldCompanyMastersCount() throws SystemException {
        return ivldCompanyMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IvldCompanyMaster updateIvldCompanyMaster(
        IvldCompanyMaster ivldCompanyMaster) throws SystemException {
        return ivldCompanyMasterPersistence.update(ivldCompanyMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.IvldCompanyMaster",
            ivldCompanyMasterLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ivldCompanyMasterPersistence.getDataSource();
