...
public class IvldGlCostCenterCacheModel implements CacheModel<IvldGlCostCenter>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldGlCostCenterCacheModel)) {
			return false;
		}

		IvldGlCostCenterCacheModel ivldGlCostCenterCacheModel = (IvldGlCostCenterCacheModel)obj;

		if (ivldGlCostCenterSid == ivldGlCostCenterCacheModel.ivldGlCostCenterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldGlCostCenterSid);
	}
