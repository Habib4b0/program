package com.stpl.app.galforecasting.additionalinformation.form;

import com.stpl.app.galforecasting.abstractforecast.AbsAdditionalInformation;
import com.stpl.app.galforecasting.additionalinformation.logic.NotesTabLogic;
...
import static com.stpl.app.galforecasting.nationalassumptions.util.Constants.LabelConstants.ADDITIONAL_INFORMATION;
...
public class AdditionalInformationForm extends AbsAdditionalInformation {
    ...
    private final String userName = StringUtils.EMPTY;
    ...
    public AdditionalInformationForm(String moduleName, String dbModuleName, int projectionIds, String mode) throws Exception {
        ...
        if (!StringUtils.EMPTY.equals(String.valueOf(newNote.getValue()).trim()) && !Constant.NULL.equals(String.valueOf(newNote.getValue()))) {
            new AbstractNotificationUtils() {
                ...
                public void yesMethod() {
                    ...
                    internalNotes.setValue(internalNotes.getValue() + "<" + format.format(new Date()) + ">" + CommonUtils.getUserNameById(userId) + " :" + ":" + String.valueOf(newNote.getValue()) + "\n");
    ...
    public void addSecurity() {
        ...
        try {
            final Map<String, AppPermission> tabItemHM = stplSecurity.getBusinessFunctionPermission(userId, NATIONAL_ASSUMPTIONS + "," + ADDITIONAL_INFORMATION);
