...
public class GtnFrameworkSelectButtonEnableActionInHierarchyLookup implements GtnUIFrameWorkAction, GtnUIFrameworkDynamicClass  {

	private GtnWSLogger logger = GtnWSLogger.getGTNLogger(GtnFrameworkSelectButtonEnableActionInHierarchyLookup.class);
