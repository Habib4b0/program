...
import com.stpl.app.parttwo.service.IvldCompanyIdentifierLocalService;
...
/**
 * Provides the base implementation for the ivld company identifier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.IvldCompanyIdentifierLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.IvldCompanyIdentifierLocalServiceImpl
 * @see com.stpl.app.parttwo.service.IvldCompanyIdentifierLocalServiceUtil
 * @generated
 */
public abstract class IvldCompanyIdentifierLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements IvldCompanyIdentifierLocalService,
        IdentifiableBean {
    ...
    private IvldCompanyIdentifierLocalServiceClpInvoker _clpInvoker = new IvldCompanyIdentifierLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldCompanyIdentifierLocalServiceUtil} to access the ivld company identifier local service.
     */
    ...
    @Override
    public IvldCompanyIdentifier addIvldCompanyIdentifier(
        IvldCompanyIdentifier ivldCompanyIdentifier) throws SystemException {
        ivldCompanyIdentifier.setNew(true);

        return ivldCompanyIdentifierPersistence.update(ivldCompanyIdentifier);
    }
     ...
     */
    @Override
    public IvldCompanyIdentifier createIvldCompanyIdentifier(
        int ivldCompanyIdentifierSid) {
        return ivldCompanyIdentifierPersistence.create(ivldCompanyIdentifierSid);
    }
    ...
    @Override
    public IvldCompanyIdentifier deleteIvldCompanyIdentifier(
        int ivldCompanyIdentifierSid) throws PortalException, SystemException {
        return ivldCompanyIdentifierPersistence.remove(ivldCompanyIdentifierSid);
    }
    ...
    public IvldCompanyIdentifier deleteIvldCompanyIdentifier(
        IvldCompanyIdentifier ivldCompanyIdentifier) throws SystemException {
        return ivldCompanyIdentifierPersistence.remove(ivldCompanyIdentifier);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IvldCompanyIdentifier.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return ivldCompanyIdentifierPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldCompanyIdentifierPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public IvldCompanyIdentifier fetchIvldCompanyIdentifier(
        int ivldCompanyIdentifierSid) throws SystemException {
        return ivldCompanyIdentifierPersistence.fetchByPrimaryKey(ivldCompanyIdentifierSid);
    }
     ...
     */
    @Override
    public IvldCompanyIdentifier getIvldCompanyIdentifier(
        int ivldCompanyIdentifierSid) throws PortalException, SystemException {
        return ivldCompanyIdentifierPersistence.findByPrimaryKey(ivldCompanyIdentifierSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ivldCompanyIdentifierPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IvldCompanyIdentifier> getIvldCompanyIdentifiers(int start,
        int end) throws SystemException {
        return ivldCompanyIdentifierPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIvldCompanyIdentifiersCount() throws SystemException {
        return ivldCompanyIdentifierPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IvldCompanyIdentifier updateIvldCompanyIdentifier(
        IvldCompanyIdentifier ivldCompanyIdentifier) throws SystemException {
        return ivldCompanyIdentifierPersistence.update(ivldCompanyIdentifier);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.IvldCompanyIdentifier",
            ivldCompanyIdentifierLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.IvldCompanyIdentifier");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ivldCompanyIdentifierPersistence.getDataSource();
