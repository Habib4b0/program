 ...
 */
@ProviderType
public class MSupplementalDiscActualsPK implements Comparable<MSupplementalDiscActualsPK>,
	Serializable {
	public int periodSid;
	public int projectionDetailsSid;

	public MSupplementalDiscActualsPK() {
	}

	public MSupplementalDiscActualsPK(int periodSid, int projectionDetailsSid) {
	...
	@Override
	public int compareTo(MSupplementalDiscActualsPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MSupplementalDiscActualsPK)) {
			return false;
		}

		MSupplementalDiscActualsPK pk = (MSupplementalDiscActualsPK)obj;
