...
IF EXISTS (SELECT 1
  ...
  BEGIN
      ALTER TABLE NM_SALES_PROJECTION_MASTER
        DROP CONSTRAINT PK_NM_SALES_PROJECTION_MASTER_PROJECTION_DETAILS_SID
  END
...
----------------------------
IF EXISTS(SELECT 1
          FROM   NM_SALES_PROJECTION_MASTER
  ...
  FROM   NM_SALES_PROJECTION_MASTER TARGET
...
IF NOT EXISTS (SELECT 1
               ...
               WHERE  Object_name(PARENT_OBJECT_ID) = 'NM_SALES_PROJECTION_MASTER'
                      AND Schema_name(SCHEMA_ID) = 'DBO'
                      AND NAME = 'PK_NM_SALES_PROJECTION_MASTER_PROJECTION_MASTER_SID_CCP_DETAILS_SID'
                      AND TYPE = 'PK')
  BEGIN
      ALTER TABLE NM_SALES_PROJECTION_MASTER
        ADD CONSTRAINT PK_NM_SALES_PROJECTION_MASTER_PROJECTION_MASTER_SID_CCP_DETAILS_SID PRIMARY KEY ( PROJECTION_MASTER_SID, CCP_DETAILS_SID )
  END
...
IF EXISTS (SELECT 1
  ...
  BEGIN
      ALTER TABLE NM_ACTUAL_SALES
        DROP CONSTRAINT PK_NM_ACTUAL_SALES_PROJECTION_DETAILS_SID_PERIOD_SID
  END
...
IF NOT EXISTS (SELECT 1
               ...
               WHERE  Object_name(PARENT_OBJECT_ID) = 'NM_ACTUAL_SALES'
                      AND Schema_name(SCHEMA_ID) = 'DBO'
                      AND NAME = 'PK_NM_ACTUAL_SALES_PROJECTION_MASTER_SID_CCP_DETAILS_SID_PERIOD_SID'
                      AND TYPE = 'PK')
  BEGIN
      ALTER TABLE NM_ACTUAL_SALES
        ADD CONSTRAINT PK_NM_ACTUAL_SALES_PROJECTION_MASTER_SID_CCP_DETAILS_SID_PERIOD_SID PRIMARY KEY ( PROJECTION_MASTER_SID, CCP_DETAILS_SID, PERIOD_SID )
  END
...
IF EXISTS (SELECT 1
  ...
  BEGIN
      ALTER TABLE NM_SALES_PROJECTION
        DROP CONSTRAINT PK_NM_SALES_PROJECTION_PROJECTION_DETAILS_SID_PERIOD_SID
  END
...
IF EXISTS(SELECT 1
  ...
  BEGIN
      ...
      SET    TARGET.PROJECTION_MASTER_SID = PD.PROJECTION_MASTER_SID,
             TARGET.CCP_DETAILS_SID = PD.CCP_DETAILS_SID
      FROM   NM_SALES_PROJECTION TARGET
             JOIN PROJECTION_DETAILS PD
               ON PD.PROJECTION_DETAILS_SID = TARGET.PROJECTION_DETAILS_SID
      WHERE  ( TARGET.CCP_DETAILS_SID IS NULL
                OR TARGET.PROJECTION_MASTER_SID IS NULL )
...
IF NOT EXISTS (SELECT 1
               ...
               WHERE  Object_name(PARENT_OBJECT_ID) = 'NM_SALES_PROJECTION'
                      AND Schema_name(SCHEMA_ID) = 'DBO'
                      AND NAME = 'PK_NM_SALES_PROJECTION_PROJECTION_MASTER_SID_CCP_DETAILS_SID_PERIOD_SID'
                      AND TYPE = 'PK')
  BEGIN
      ALTER TABLE NM_SALES_PROJECTION
        ADD CONSTRAINT PK_NM_SALES_PROJECTION_PROJECTION_MASTER_SID_CCP_DETAILS_SID_PERIOD_SID PRIMARY KEY ( PROJECTION_MASTER_SID, CCP_DETAILS_SID, PERIOD_SID )
  END
