...
public class IvldInventoryWdActualMasCacheModel implements CacheModel<IvldInventoryWdActualMas>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldInventoryWdActualMasCacheModel)) {
			return false;
		}

		IvldInventoryWdActualMasCacheModel ivldInventoryWdActualMasCacheModel = (IvldInventoryWdActualMasCacheModel)obj;

		if (ivldInventoryWdActualMasSid == ivldInventoryWdActualMasCacheModel.ivldInventoryWdActualMasSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldInventoryWdActualMasSid);
	}
