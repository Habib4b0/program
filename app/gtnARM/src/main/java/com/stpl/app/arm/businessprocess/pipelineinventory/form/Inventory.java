...
public class Inventory extends VerticalLayout implements View, GenerateAble, DefaultFocusable, LeaveConfirmMessageAble, LeaveCheckAble {
    ...
    InventorySearchResults inventoryResults;
    InventoryCustomerLookup inventoryCustomerLookup;
    int projectionId = 0;
    List<String> propertyList = new ArrayList<>();
    InventoryCustomerGroupLookup inventoryCustomerGroupLookup;
    public int cgViewSid = 0;
    public boolean arcCgInitialView = false;
    public int custViewSid = 0;
    public boolean arcCustInitialView = false;
    ...
    public void inventoryDetailsDdlbValueChange(Property.ValueChangeEvent event) {
        inventoryDetails = String.valueOf(event.getProperty().getValue());
    }
            ...
            public void buttonClick(Button.ClickEvent event) {
                ...
                try {
                    ...
                    if (validateGenearteButton(selectionDto)) {
                        notifier.getErrorNotification(ARMMessages.getGenerateMessageName_001(), ARMMessages.getGenerateMessage_Demand());
                    } else {
