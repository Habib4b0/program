...
public interface RebatePlanTierPersistence extends BasePersistence<RebatePlanTier> {
	...
	*/
	public void cacheResult(java.util.List<RebatePlanTier> rebatePlanTiers);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, RebatePlanTier> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<RebatePlanTier> findAll();
	...
	*/
	public java.util.List<RebatePlanTier> findAll(int start, int end);
	...
	*/
	public java.util.List<RebatePlanTier> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<RebatePlanTier> orderByComparator);
