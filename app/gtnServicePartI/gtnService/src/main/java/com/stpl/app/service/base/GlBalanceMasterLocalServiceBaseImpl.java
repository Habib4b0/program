...
import com.stpl.app.service.GlBalanceMasterLocalService;
...
/**
 * Provides the base implementation for the gl balance master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.GlBalanceMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class GlBalanceMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GlBalanceMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.GlBalanceMasterLocalServiceUtil} to access the gl balance master local service.
	 */
	...
	public GlBalanceMaster addGlBalanceMaster(GlBalanceMaster glBalanceMaster) {
		...
		return glBalanceMasterPersistence.update(glBalanceMaster);
	}
	...
	public GlBalanceMaster createGlBalanceMaster(int glBalanceMasterSid) {
		return glBalanceMasterPersistence.create(glBalanceMasterSid);
	}
	...
	public GlBalanceMaster deleteGlBalanceMaster(int glBalanceMasterSid)
		...
		return glBalanceMasterPersistence.remove(glBalanceMasterSid);
	}
	...
	public GlBalanceMaster deleteGlBalanceMaster(
		...
		return glBalanceMasterPersistence.remove(glBalanceMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GlBalanceMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return glBalanceMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return glBalanceMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public GlBalanceMaster fetchGlBalanceMaster(int glBalanceMasterSid) {
		return glBalanceMasterPersistence.fetchByPrimaryKey(glBalanceMasterSid);
	}
	...
	public GlBalanceMaster getGlBalanceMaster(int glBalanceMasterSid)
		throws PortalException {
		return glBalanceMasterPersistence.findByPrimaryKey(glBalanceMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(glBalanceMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(GlBalanceMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("glBalanceMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(glBalanceMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(GlBalanceMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return glBalanceMasterLocalService.deleteGlBalanceMaster((GlBalanceMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return glBalanceMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<GlBalanceMaster> getGlBalanceMasters(int start, int end) {
		return glBalanceMasterPersistence.findAll(start, end);
	}
	...
	public int getGlBalanceMastersCount() {
		return glBalanceMasterPersistence.countAll();
	}
	 ...
	 */
	public GlBalanceMasterLocalService getGlBalanceMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.GlBalanceMaster",
			glBalanceMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return GlBalanceMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = glBalanceMasterPersistence.getDataSource();
	...
	@BeanReference(type = GlBalanceMasterLocalService.class)
	protected GlBalanceMasterLocalService glBalanceMasterLocalService;
