...
public class TransferContract extends VerticalLayout implements View {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(TransferContract.class);
    /**
...
//empty
    ...
    protected void initializeTabs() {
        ...
        try {
            tabSheet.addTab(transferComponents, Constants.IndicatorConstants.TAB_PROMOTE_TP_TRANSFER_COMPONENTS.getConstant(), null, 0);
            tabSheet.addTab(newComponents, Constants.IndicatorConstants.TAB_PROMOTE_TP_NEW_COMPONENTS.getConstant(), null, 1);
            tabSheet.addTab(existingComponents, Constants.IndicatorConstants.TAB_PROMOTE_TP_EXISTING_COMPONENTS.getConstant(), null, NumericConstants.TWO);
    ...
    public void populateBtn1Logic(Button.ClickEvent event) throws ParseException, SystemException {
        ...
        if (StringUtils.EMPTY.equals(cName) || StringUtils.EMPTY.equals(cNo) || Constants.NULL.equals(sDate) || Constants.NULL.equals(eDate) || mType.equals(Constants.NULL) || StringUtils.EMPTY.equals(cHolder)
