...
import com.stpl.app.service.MedicaidUraActualsLocalService;
...
/**
 * Provides the base implementation for the medicaid ura actuals local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.MedicaidUraActualsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.MedicaidUraActualsLocalServiceImpl
 * @see com.stpl.app.service.MedicaidUraActualsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class MedicaidUraActualsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MedicaidUraActualsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.MedicaidUraActualsLocalServiceUtil} to access the medicaid ura actuals local service.
	 */
	...
	@Override
	public MedicaidUraActuals addMedicaidUraActuals(
		MedicaidUraActuals medicaidUraActuals) {
		medicaidUraActuals.setNew(true);

		return medicaidUraActualsPersistence.update(medicaidUraActuals);
	}
	 ...
	 */
	@Override
	public MedicaidUraActuals createMedicaidUraActuals(
		MedicaidUraActualsPK medicaidUraActualsPK) {
		return medicaidUraActualsPersistence.create(medicaidUraActualsPK);
	}
	...
	@Override
	public MedicaidUraActuals deleteMedicaidUraActuals(
		MedicaidUraActualsPK medicaidUraActualsPK) throws PortalException {
		return medicaidUraActualsPersistence.remove(medicaidUraActualsPK);
	}
	...
	public MedicaidUraActuals deleteMedicaidUraActuals(
		MedicaidUraActuals medicaidUraActuals) {
		return medicaidUraActualsPersistence.remove(medicaidUraActuals);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MedicaidUraActuals.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return medicaidUraActualsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return medicaidUraActualsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MedicaidUraActuals fetchMedicaidUraActuals(
		MedicaidUraActualsPK medicaidUraActualsPK) {
		return medicaidUraActualsPersistence.fetchByPrimaryKey(medicaidUraActualsPK);
	}
	 ...
	 */
	@Override
	public MedicaidUraActuals getMedicaidUraActuals(
		MedicaidUraActualsPK medicaidUraActualsPK) throws PortalException {
		return medicaidUraActualsPersistence.findByPrimaryKey(medicaidUraActualsPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(medicaidUraActualsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MedicaidUraActuals.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(medicaidUraActualsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MedicaidUraActuals.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return medicaidUraActualsLocalService.deleteMedicaidUraActuals((MedicaidUraActuals)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return medicaidUraActualsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MedicaidUraActuals> getMedicaidUraActualses(int start, int end) {
		return medicaidUraActualsPersistence.findAll(start, end);
	}
	...
	public int getMedicaidUraActualsesCount() {
		return medicaidUraActualsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MedicaidUraActuals updateMedicaidUraActuals(
		MedicaidUraActuals medicaidUraActuals) {
		return medicaidUraActualsPersistence.update(medicaidUraActuals);
	}
	 ...
	 */
	public MedicaidUraActualsLocalService getMedicaidUraActualsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.MedicaidUraActuals",
			medicaidUraActualsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MedicaidUraActualsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = medicaidUraActualsPersistence.getDataSource();
	...
	@BeanReference(type = MedicaidUraActualsLocalService.class)
	protected MedicaidUraActualsLocalService medicaidUraActualsLocalService;
