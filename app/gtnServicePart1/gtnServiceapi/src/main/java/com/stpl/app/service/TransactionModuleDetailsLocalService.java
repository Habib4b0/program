...
/**
 * Provides the local service interface for TransactionModuleDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see TransactionModuleDetailsLocalServiceUtil
...
public interface TransactionModuleDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TransactionModuleDetailsLocalServiceUtil} to access the transaction module details local service. Add custom service methods to {@link com.stpl.app.service.impl.TransactionModuleDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
