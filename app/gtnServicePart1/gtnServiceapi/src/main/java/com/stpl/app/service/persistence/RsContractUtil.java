...
/**
 * The persistence utility for the rs contract service. This utility wraps {@link com.stpl.app.service.persistence.impl.RsContractPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class RsContractUtil {
	...
	*/
	public static void cacheResult(RsContract rsContract) {
	...
	*/
	public static void cacheResult(List<RsContract> rsContracts) {
	...
	*/
	public static RsContract create(int rsContractSid) {
	...
	*/
	public static RsContract remove(int rsContractSid)
		throws com.stpl.app.exception.NoSuchRsContractException {
		return getPersistence().remove(rsContractSid);
	}

	public static RsContract updateImpl(RsContract rsContract) {
	...
	* @throws NoSuchRsContractException if a rs contract with the primary key could not be found
	*/
	public static RsContract findByPrimaryKey(int rsContractSid)
		throws com.stpl.app.exception.NoSuchRsContractException {
	...
	*/
	public static RsContract fetchByPrimaryKey(int rsContractSid) {
		return getPersistence().fetchByPrimaryKey(rsContractSid);
	}

	public static java.util.Map<java.io.Serializable, RsContract> fetchByPrimaryKeys(
	...
	*/
	public static List<RsContract> findAll() {
	...
	*/
	public static List<RsContract> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<RsContractPersistence, RsContractPersistence> _serviceTracker =
		ServiceTrackerFactory.open(RsContractPersistence.class);
}