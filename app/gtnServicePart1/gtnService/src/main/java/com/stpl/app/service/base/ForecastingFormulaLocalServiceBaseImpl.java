...
import com.stpl.app.service.ForecastingFormulaLocalService;
...
/**
 * Provides the base implementation for the forecasting formula local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ForecastingFormulaLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class ForecastingFormulaLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ForecastingFormulaLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ForecastingFormulaLocalServiceUtil} to access the forecasting formula local service.
	 */
	...
	public ForecastingFormula addForecastingFormula(
		...
		return forecastingFormulaPersistence.update(forecastingFormula);
	}
	...
	public ForecastingFormula createForecastingFormula(
		...
		return forecastingFormulaPersistence.create(forecastingFormulaSid);
	}
	...
	public ForecastingFormula deleteForecastingFormula(
		...
		return forecastingFormulaPersistence.remove(forecastingFormulaSid);
	}
	...
	public ForecastingFormula deleteForecastingFormula(
		ForecastingFormula forecastingFormula) {
		return forecastingFormulaPersistence.remove(forecastingFormula);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ForecastingFormula.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return forecastingFormulaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return forecastingFormulaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ForecastingFormula fetchForecastingFormula(int forecastingFormulaSid) {
		return forecastingFormulaPersistence.fetchByPrimaryKey(forecastingFormulaSid);
	}
	...
	public ForecastingFormula getForecastingFormula(int forecastingFormulaSid)
		...
		return forecastingFormulaPersistence.findByPrimaryKey(forecastingFormulaSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(forecastingFormulaLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ForecastingFormula.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(forecastingFormulaLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ForecastingFormula.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return forecastingFormulaLocalService.deleteForecastingFormula((ForecastingFormula)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return forecastingFormulaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ForecastingFormula> getForecastingFormulas(int start, int end) {
		return forecastingFormulaPersistence.findAll(start, end);
	}
	...
	public int getForecastingFormulasCount() {
		return forecastingFormulaPersistence.countAll();
	}
	 ...
	 */
	public ForecastingFormulaLocalService getForecastingFormulaLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ForecastingFormula",
			forecastingFormulaLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ForecastingFormulaLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = forecastingFormulaPersistence.getDataSource();
	...
	@BeanReference(type = ForecastingFormulaLocalService.class)
	protected ForecastingFormulaLocalService forecastingFormulaLocalService;
