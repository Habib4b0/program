...
public class StAdjustmentGtnDetailSoap implements Serializable {
    ...
    public void setPrimaryKey(StAdjustmentGtnDetailPK pk) {
        setRedemptionPeriod(pk.redemptionPeriod);
        setDeductionId(pk.deductionId);
        setAccount(pk.account);
        setAdjustmentType(pk.adjustmentType);
        setSessionId(pk.sessionId);
        setGlCompanyId(pk.glCompanyId);
        setItemId(pk.itemId);
        setAccountType(pk.accountType);
        setWorkflowId(pk.workflowId);
        setContractId(pk.contractId);
        setBusinessUnitId(pk.businessUnitId);
        setUserId(pk.userId);
        setCompanyId(pk.companyId);
        setAccountCategory(pk.accountCategory);
    }
