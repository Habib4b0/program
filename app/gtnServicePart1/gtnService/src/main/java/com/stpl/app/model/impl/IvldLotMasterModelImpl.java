 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldLotMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldLotMasterImpl}.
 * </p>
 *
 * @author
...
public class IvldLotMasterModelImpl extends BaseModelImpl<IvldLotMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("IVLD_LOT_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CREATED_BY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("SOURCE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("LAST_LOT_SOLD_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("LOT_EXPIRATION_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("LOT_MASTER_INTFID", Types.VARCHAR);
	...
	private static final ClassLoader _classLoader = IvldLotMaster.class.getClassLoader();
