...
public class CommonUtil {
    ...
    public static Date setDate(int num, Date tempDate) {
        Date date = (Date) tempDate.clone();
        date.setDate(num);
        return date;
    }

    public static Date setMonth(int num, Date tempDate) {
        Date date = (Date) tempDate.clone();
        date.setMonth(num);
        return date;
    }

    public static Date setYear(int num, Date tempDate) {
        Date date = (Date) tempDate.clone();
        date.setYear(num);
        return date;
    }
