...
AS
SELECT
  ADF.ADJUSTED_DEMAND_FORECAST_SID AS ADJUSTED_DEMAND_FORECAST_ID,
  ADF.FORECAST_NAME,
  ADF.FORECAST_TYPE,
  ADF.FORECAST_VER AS FORECAST_VERSION,
  ADF.YEAR,
  ADF.MONTH,
  ADF.ITEM_ID,
  IM.ITEM_NAME,
  ...
  ADF.TOTAL_DEMAND_UNITS AS TOTAL_ADJUSTED_DEMAND_UNITS,
  ADF.TOTAL_DEMAND_AMOUNT AS TOTAL_ADJUSTED_DEMAND_AMOUNT,
...
LEFT JOIN dbo.BRAND_MASTER BM
  ON BM.BRAND_ID = ADF.BRAND_ID
LEFT JOIN dbo.COMPANY_MASTER CM
  ON CM.COMPANY_ID = ADF.ORGANIZATION_KEY
LEFT JOIN dbo.ITEM_MASTER IM
  ON IM.ITEM_ID = ADF.ITEM_ID
UNION ALL
SELECT
  ADF.ADJUSTED_DEMAND_ACTUAL_SID AS ADJUSTED_DEMAND_FORECAST_ID,
  NULL FORECAST_NAME,
  ADF.FORECAST_TYPE,
  NULL FORECAST_VER,
  ADF.FORECAST_YEAR AS YEAR,
  ADF.FORECAST_MONTH AS MONTH,
  ADF.ITEM_ID,
  IM.ITEM_NAME,
  ADF.BRAND_ID,
  BM.BRAND_NAME,
