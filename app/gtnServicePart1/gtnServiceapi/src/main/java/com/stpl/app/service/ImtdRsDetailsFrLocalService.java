...
/**
 * Provides the local service interface for ImtdRsDetailsFr. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ImtdRsDetailsFrLocalServiceUtil
...
public interface ImtdRsDetailsFrLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ImtdRsDetailsFrLocalServiceUtil} to access the imtd rs details fr local service. Add custom service methods to {@link com.stpl.app.service.impl.ImtdRsDetailsFrLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ImtdRsDetailsFr deleteImtdRsDetailsFr(
		ImtdRsDetailsFr imtdRsDetailsFr);
