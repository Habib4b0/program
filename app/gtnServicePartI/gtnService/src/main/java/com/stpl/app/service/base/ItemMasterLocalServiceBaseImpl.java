...
import com.stpl.app.service.ItemMasterLocalService;
...
/**
 * Provides the base implementation for the item master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ItemMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class ItemMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ItemMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ItemMasterLocalServiceUtil} to access the item master local service.
	 */
	...
	public ItemMaster addItemMaster(ItemMaster itemMaster) {
		...
		return itemMasterPersistence.update(itemMaster);
	}
	 ...
	 */
	@Override
	public ItemMaster createItemMaster(int itemMasterSid) {
		return itemMasterPersistence.create(itemMasterSid);
	}
	...
	@Override
	public ItemMaster deleteItemMaster(int itemMasterSid)
		throws PortalException {
		return itemMasterPersistence.remove(itemMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ItemMaster deleteItemMaster(ItemMaster itemMaster) {
		return itemMasterPersistence.remove(itemMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ItemMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return itemMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return itemMasterPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return itemMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ItemMaster fetchItemMaster(int itemMasterSid) {
		return itemMasterPersistence.fetchByPrimaryKey(itemMasterSid);
	}
	...
	public ItemMaster getItemMaster(int itemMasterSid)
		throws PortalException {
		return itemMasterPersistence.findByPrimaryKey(itemMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(itemMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ItemMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("itemMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(itemMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ItemMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return itemMasterLocalService.deleteItemMaster((ItemMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return itemMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ItemMaster> getItemMasters(int start, int end) {
		return itemMasterPersistence.findAll(start, end);
	}
	...
	public int getItemMastersCount() {
		return itemMasterPersistence.countAll();
	}
	 ...
	 */
	public ItemMasterLocalService getItemMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ItemMaster",
			itemMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ItemMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ItemMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = itemMasterPersistence.getDataSource();
	...
	@BeanReference(type = ItemMasterLocalService.class)
	protected ItemMasterLocalService itemMasterLocalService;
