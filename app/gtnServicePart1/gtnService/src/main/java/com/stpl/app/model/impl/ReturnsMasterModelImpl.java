 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ReturnsMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ReturnsMasterImpl}.
 * </p>
 *
 * @author
...
public class ReturnsMasterModelImpl extends BaseModelImpl<ReturnsMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("FIRST_RETURN", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("ASP", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MAX_EXPIRED_MONS_PLUSCUTOFF", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("POS_ESTIMATED_RETURN_UNITS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ORIG_SALE_MONTH_CUT_OFF", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CALC_USED", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("BRAND_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("LAST_RETURN", Types.TIMESTAMP);
		...
		TABLE_COLUMNS_MAP.put("RETURNS_MASTER_SID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("LOAD_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("MAX_EXPIRED_MONTH", Types.TIMESTAMP);
		...
		TABLE_COLUMNS_MAP.put("ORIG_SALE_MONTH", Types.TIMESTAMP);
	...
	private static final ClassLoader _classLoader = ReturnsMaster.class.getClassLoader();
