 ...
 */
package com.stpl.app.galforecasting.dataassumptions.logic.tableLogic;

import com.stpl.app.galforecasting.dataassumptions.dto.DataAssumptionDTO;
import com.stpl.app.galforecasting.dataassumptions.logic.DataAssumptionsLogic;
...
public class DataAssumptionstableLogic extends PageTableLogic {
    ...
    public int getCount() {
        ...
        LOGGER.info("DataAssumptionstableLogic Count ----->" + count);
        return count;
    }
    ...
    public List loadData(int start, int offset) {
        ...
        if (isFirstLoad) {
            try {
                ...
                LOGGER.info("DataAssumptionstableLogic loadData-----*>> " + headerList.size());
