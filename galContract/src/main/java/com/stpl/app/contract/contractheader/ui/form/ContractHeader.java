...
public class ContractHeader extends CustomComponent {
  ...
  /** The common util. */
     ...
     *
     */
    public ContractHeader(final CustomFieldGroup binder,final ContractMasterDTO contractMasterDTO,final String mode) throws PortalException, SystemException, Exception {
    ...
    public class DateValidatorContract extends AbstractValidator {
        ...
        protected boolean isValidValue(final Object value) {
            ...
            if (startDate.getValue() != null && endDate.getValue() != null) {
                final boolean isValid = startDate.getValue().compareTo(endDate.getValue()) <= 0;
    ...
    public class DateValidatorReNegotiation extends AbstractValidator {
        ...
        public void validate(final Object value) throws InvalidValueException {
            LOGGER.info("Entering validate method for renegotiationStartDate and renegotiationEndDate");
        ...
        @Override
        protected boolean isValidValue(final Object value) {
            LOGGER.info("Entering validValue method for renegotiationDate ");
            if (renegotiationStartDate.getValue() != null && renegotiationEndDate.getValue() != null) {
                final boolean valid = renegotiationStartDate.getValue().compareTo(renegotiationEndDate.getValue()) <= 0;
                LOGGER.info("isValidValue method ended and returns valid=" + valid);
                return valid;
            }
            LOGGER.info("isValidValue method ended and returns true");
            return true;
        }
    ...
    public class DateValidatorPriceProtection extends AbstractValidator {
        ...
        protected boolean isValidValue(final Object value) {
            ...
            if (priceprotectionStartDate.getValue() != null && priceprotectionEndDate.getValue() != null) {
                final boolean isValid = priceprotectionStartDate.getValue().compareTo(priceprotectionEndDate.getValue()) <= 0;
                LOGGER.info("isValidValue method ends with isValid = " + isValid);
                return isValid;
            }
