...
public class MailNotificationForm extends CustomComponent {
    ...
    private void configureFields() {
        ...
        LOGGER.info("Out configureFields");
    }
    ...
    private boolean validateEmailAddresses() {
        ...
        if (successCc.getValue() != null && !successCc.getValue().equals(StringUtils.EMPTY)) {
            if (!validateEmail(emailSeperator(successCc.getValue()))) {
        ...
        if (failureCc.getValue() != null && !failureCc.getValue().equals(StringUtils.EMPTY)) {
            if (!validateEmail(emailSeperator(failureCc.getValue()))) {
