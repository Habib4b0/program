...
public class GtnWsQuartileMethodologyTest {

	@Test
	public void testQuartileMethodology() {
	...
	private GtnWsMethodologyBean createMethodologyBean() {
		...
		methodologyBean.setBaselineFormula("EXPECTED_RETURN_RATE");
		methodologyBean.setBaselinePeriodList(getBaselinePeriodList());

		methodologyBean.setProjectionFormula("BASELINE");
	...
	/*
	 * QUARTILE_ will be appended before PROJECTED_RETURN_AMOUNT and
	 * PROJECTED_RPU in the formula properties file.
	 * 
	 * Will be like QUARTILE_PROJECTED_RETURN_AMOUNT and QUARTILE_PROJECTED_RPU.
	 */
