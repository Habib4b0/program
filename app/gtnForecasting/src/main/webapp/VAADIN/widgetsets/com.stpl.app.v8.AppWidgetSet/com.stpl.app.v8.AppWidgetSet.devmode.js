...
var __gwtModuleFunction = $wnd.com_stpl_app_v8_AppWidgetSet;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.com.stpl.app.v8.AppWidgetSet=");
    idx += (13 + "com.stpl.app.v8.AppWidgetSet".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=com.stpl.app.v8.AppWidgetSet-0.js
