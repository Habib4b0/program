...
/**
 * The Class ExtCustomTreeTableConnector.
 *
 * @author Abhiram
 */
@Connect(ExtCustomTreeTable.class)
public class ExtCustomTreeTableConnector extends ExtCustomTableConnector{
     ...
     */
    @Override
    public VExtCustomTreeTable getWidget() {
        return (VExtCustomTreeTable) super.getWidget();
    }
