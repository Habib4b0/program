...
public class ErrorCodeUtilTest {
   ...
   /**
    ...
    public void testPositiveGetEC(){
       ...
       Assert.assertEquals(ERROR_CODE_1001, ErrorCodeUtil.getEC(assertPositiveList.get(1)));
       Assert.assertEquals(ERROR_CODE_1002, ErrorCodeUtil.getEC(assertPositiveList.get(2)));
    }
