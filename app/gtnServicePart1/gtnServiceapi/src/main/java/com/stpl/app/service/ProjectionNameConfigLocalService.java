...
/**
 * Provides the local service interface for ProjectionNameConfig. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ProjectionNameConfigLocalServiceUtil
...
public interface ProjectionNameConfigLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProjectionNameConfigLocalServiceUtil} to access the projection name config local service. Add custom service methods to {@link com.stpl.app.service.impl.ProjectionNameConfigLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
