...
public class IvldItemPricingWrapper implements IvldItemPricing,
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String itemPriceprecision = (String)attributes.get("itemPriceprecision");
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<IvldItemPricing> toCacheModel() {
	...
	public boolean equals(Object obj) {
		...
		if (Objects.equals(_ivldItemPricing,
	...
	public boolean isEntityCacheEnabled() {
		return _ivldItemPricing.isEntityCacheEnabled();
	}

	@Override
	public boolean isFinderCacheEnabled() {
		return _ivldItemPricing.isFinderCacheEnabled();
	}
	...
	private final IvldItemPricing _ivldItemPricing;
}