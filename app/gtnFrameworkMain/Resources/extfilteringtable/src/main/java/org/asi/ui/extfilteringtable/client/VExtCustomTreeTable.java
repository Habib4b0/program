...
/**
 * The Class VExtCustomTreeTable.
 *
 * @author Abhiram
 */
public class VExtCustomTreeTable extends VExtCustomScrollTable{
    ...
    /** For internal use only. May be removed or replaced in the future. */
    public LinkedList<PendingNavigationEvent> pendingNavigationEvents = new LinkedList<VExtCustomTreeTable.PendingNavigationEvent>();
            ...
            private void setIndent() {
                if (getIndentWidth() > 0) {
                    ...
                    if (colWidth > 0 && getIndent() > colWidth) {                        
                        VExtCustomTreeTable.this.setColWidth(
  ...
  @Override
    public boolean handleNavigation(int keycode, boolean ctrl, boolean shift) {
        ...
        VExtCustomTreeTable.VTreeTableScrollBody.VTreeTableRow focusedRow = (VExtCustomTreeTable.VTreeTableScrollBody.VTreeTableRow) getFocusedRow();
        if (focusedRow != null) {
            if (focusedRow.canHaveChildren
                ...
                VExtCustomTreeTable.VTreeTableScrollBody.VTreeTableRow next = null;
                while (iterator.hasNext()) {
                    next = (VExtCustomTreeTable.VTreeTableScrollBody.VTreeTableRow) iterator
                            .next();
                    if (next == focusedRow) {
                        next = (VExtCustomTreeTable.VTreeTableScrollBody.VTreeTableRow) iterator
                                .next();
