...
/**
 * The persistence utility for the ps contract details service. This utility wraps {@link com.stpl.app.service.persistence.impl.PsContractDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.stpl.app.service.persistence.impl.PsContractDetailsPersistenceImpl
 * @generated
 */
@ProviderType
public class PsContractDetailsUtil {
	...
	*/
	public static void cacheResult(PsContractDetails psContractDetails) {
	...
	*/
	public static void cacheResult(List<PsContractDetails> psContractDetailses) {
	...
	*/
	public static PsContractDetails create(int psContractDetailsSid) {
	...
	*/
	public static PsContractDetails remove(int psContractDetailsSid)
		throws com.stpl.app.exception.NoSuchPsContractDetailsException {
		return getPersistence().remove(psContractDetailsSid);
	}

	public static PsContractDetails updateImpl(
	...
	* @throws NoSuchPsContractDetailsException if a ps contract details with the primary key could not be found
	*/
	public static PsContractDetails findByPrimaryKey(int psContractDetailsSid)
		throws com.stpl.app.exception.NoSuchPsContractDetailsException {
	...
	*/
	public static PsContractDetails fetchByPrimaryKey(int psContractDetailsSid) {
		return getPersistence().fetchByPrimaryKey(psContractDetailsSid);
	}

	public static java.util.Map<java.io.Serializable, PsContractDetails> fetchByPrimaryKeys(
	...
	*/
	public static List<PsContractDetails> findAll() {
	...
	*/
	public static List<PsContractDetails> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<PsContractDetailsPersistence, PsContractDetailsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(PsContractDetailsPersistence.class);
}