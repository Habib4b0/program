...
//        content.setMargin(margininfo);
    ...
    private Component addForecastLabel() {
        ...
        String activatedFile=logic.getActivatedFileName();
...
//        String endDateString = formatter.format(endDate);
        ...
        forecastLabel.setValue("<div style=\"/*background: dodgerblue;color: white;*/ font-weight: 500; text-align:left\"> <marquee style=\"width:100%\"><b>Forecast Configuration Period :</b> Commercial - " 
                ...
                + ", National Assumptions - "+ formatter.format(configurationDates[6]) + " to " + formatter.format(configurationDates[7]) + " , <b> Current Active Files : </b>" +activatedFile
                + " </marquee>"
                + "</div>");
        //&nbsp;&nbsp; <br/><b><center><a href=\"" + url + "\" /*style=\"color: yellow;*/ \">Click Here to change </a></center></b>
