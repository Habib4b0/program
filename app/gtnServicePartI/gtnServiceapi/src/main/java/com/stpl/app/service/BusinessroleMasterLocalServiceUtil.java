...
public class BusinessroleMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<BusinessroleMasterLocalService, BusinessroleMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(BusinessroleMasterLocalService.class);
}