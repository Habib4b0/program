...
/**
 * Provides the local service interface for IvldInventoryWdActualMas. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldInventoryWdActualMasLocalServiceUtil
...
public interface IvldInventoryWdActualMasLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldInventoryWdActualMasLocalServiceUtil} to access the ivld inventory wd actual mas local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldInventoryWdActualMasLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public IvldInventoryWdActualMas addIvldInventoryWdActualMas(
	...
	*/
	public IvldInventoryWdActualMas createIvldInventoryWdActualMas(
	...
	*/
	...
	public IvldInventoryWdActualMas deleteIvldInventoryWdActualMas(
		int ivldInventoryWdActualMasSid) throws PortalException;
	...
	*/
	...
	public IvldInventoryWdActualMas fetchIvldInventoryWdActualMas(
		int ivldInventoryWdActualMasSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public IvldInventoryWdActualMas getIvldInventoryWdActualMas(
		int ivldInventoryWdActualMasSid) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<IvldInventoryWdActualMas> getIvldInventoryWdActualMases(
		int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public IvldInventoryWdActualMas updateIvldInventoryWdActualMas(
		IvldInventoryWdActualMas ivldInventoryWdActualMas);
}