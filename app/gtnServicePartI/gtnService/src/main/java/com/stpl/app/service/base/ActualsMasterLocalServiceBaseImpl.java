...
import com.stpl.app.service.ActualsMasterLocalService;
...
/**
 * Provides the base implementation for the actuals master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ActualsMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ActualsMasterLocalServiceImpl
 * @see com.stpl.app.service.ActualsMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ActualsMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ActualsMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ActualsMasterLocalServiceUtil} to access the actuals master local service.
	 */
	...
	@Override
	public ActualsMaster addActualsMaster(ActualsMaster actualsMaster) {
		actualsMaster.setNew(true);

		return actualsMasterPersistence.update(actualsMaster);
	}
	 ...
	 */
	@Override
	public ActualsMaster createActualsMaster(int actualsMasterSid) {
		return actualsMasterPersistence.create(actualsMasterSid);
	}
	...
	@Override
	public ActualsMaster deleteActualsMaster(int actualsMasterSid)
		throws PortalException {
		return actualsMasterPersistence.remove(actualsMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ActualsMaster deleteActualsMaster(ActualsMaster actualsMaster) {
		return actualsMasterPersistence.remove(actualsMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ActualsMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return actualsMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return actualsMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ActualsMaster fetchActualsMaster(int actualsMasterSid) {
		return actualsMasterPersistence.fetchByPrimaryKey(actualsMasterSid);
	}
	 ...
	 */
	@Override
	public ActualsMaster getActualsMaster(int actualsMasterSid)
		throws PortalException {
		return actualsMasterPersistence.findByPrimaryKey(actualsMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(actualsMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ActualsMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("actualsMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(actualsMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ActualsMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return actualsMasterLocalService.deleteActualsMaster((ActualsMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return actualsMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ActualsMaster> getActualsMasters(int start, int end) {
		return actualsMasterPersistence.findAll(start, end);
	}
	...
	public int getActualsMastersCount() {
		return actualsMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ActualsMaster updateActualsMaster(ActualsMaster actualsMaster) {
		return actualsMasterPersistence.update(actualsMaster);
	}
	 ...
	 */
	public ActualsMasterLocalService getActualsMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ActualsMaster",
			actualsMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ActualsMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ActualsMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = actualsMasterPersistence.getDataSource();
	...
	@BeanReference(type = ActualsMasterLocalService.class)
	protected ActualsMasterLocalService actualsMasterLocalService;
