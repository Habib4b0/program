...
public class StAccClosureDetailsLocalServiceUtil {
    private static StAccClosureDetailsLocalService _service;
    ...
    */
    ...
    public static StAccClosureDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StAccClosureDetailsLocalService.class.getName());

            if (invokableLocalService instanceof StAccClosureDetailsLocalService) {
                _service = (StAccClosureDetailsLocalService) invokableLocalService;
            } else {
                _service = new StAccClosureDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StAccClosureDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StAccClosureDetailsLocalService service) {
    }
}
