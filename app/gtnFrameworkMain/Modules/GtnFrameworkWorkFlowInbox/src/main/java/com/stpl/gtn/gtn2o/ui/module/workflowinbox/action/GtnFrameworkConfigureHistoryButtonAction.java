...
public class GtnFrameworkConfigureHistoryButtonAction implements GtnUIFrameWorkAction, GtnUIFrameworkDynamicClass {
    ...
    public void doAction(String componentId, GtnUIFrameWorkActionConfig gtnUIFrameWorkActionConfig)
        ...
        if (combocomponent.equals(GtnFrameworkCommonStringConstants.ARM)) {
            ...
            setVisibleCompanyNameAndBusinessUnitNameComponent(true);
            ...
            if (combocomponent.equalsIgnoreCase(GtnFrameworkCommonStringConstants.CONTRACT_MANAGEMENT)) {
                setVisibleCompanyNameAndBusinessUnitNameComponent(false);
                return;
            }
            setVisibleCompanyNameAndBusinessUnitNameComponent(true);
        }
    ...
    private void setVisibleCompanyNameAndBusinessUnitNameComponent(boolean visible) {
