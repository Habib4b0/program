...
import com.stpl.gtn.gtn2o.ws.module.companymaster.controller.GtnWsCMasterAdd;
...
@Ignore
public class CompanyMasterAddWebserviceTest {

	public CompanyMasterAddWebserviceTest() {
		// constructor
	}
	...
	public void testsaveCompanyMaster() {
		...
		GtnWsCMasterAdd instance = (GtnWsCMasterAdd) ServiceContextUtil.instance().getBean("cmAddServiceSave");
		...
		instance.saveCompanyMaster(gtnWsRequest);
