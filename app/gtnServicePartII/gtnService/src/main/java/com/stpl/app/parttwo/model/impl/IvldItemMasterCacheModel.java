...
public class IvldItemMasterCacheModel implements CacheModel<IvldItemMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldItemMasterCacheModel)) {
			return false;
		}

		IvldItemMasterCacheModel ivldItemMasterCacheModel = (IvldItemMasterCacheModel)obj;

		if (ivldItemMasterSid == ivldItemMasterCacheModel.ivldItemMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldItemMasterSid);
	}
