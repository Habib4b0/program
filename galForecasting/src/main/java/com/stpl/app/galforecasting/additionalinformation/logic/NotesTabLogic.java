 ...
 */
package com.stpl.app.galforecasting.additionalinformation.logic;
...
public class NotesTabLogic {
    ...
    public List<NotesDTO> getAttachmentDTOList(final int projectionId, final String moduleName, String fileUploadPath) throws SystemException, PortalException {
        ...
        if (docDetailsList != null && !docDetailsList.isEmpty()) {
            for (final Iterator<DocDetails> iterator = docDetailsList.iterator(); iterator.hasNext();) {
                ...
                StringBuilder sb = new StringBuilder(docDetails.getFileName());
    ...
    public List<NotesDTO> getAttachmentDTOList(int projectionId, String moduleName, File filepath) {
    ...
    public static String configureDownloader(String fileName, String filePath) {
