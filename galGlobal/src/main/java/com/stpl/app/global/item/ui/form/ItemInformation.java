...
CommonSecurityLogic commonSecurityLogic = new CommonSecurityLogic();
    ...
    public ItemInformation(final ErrorfulFieldGroup binder, final String mode) throws Exception {
        this.binder = binder;
        this.mode=mode;
    ...
    private void configureFields() {
        ...
        try {
            ...
            itemId.setData("maxlengthvalidation,maxlengthvalidationitemid,alphaNumericCharsWithoutStar,specialcharvalidationitemid");
            ...
            itemNo.setValidationVisible(true);
              itemNo.setData("maxlengthvalidationfifty,maxlengthvalidationitemno,alphaNumericCharsWithoutStar,specialcharvalidationitemno");
            ...
            itemName.addValidator(new RegexpValidator(
                    ValidationUtils.APOSTROPHE_SP_CHAR,
                    ValidationUtils.SPECIAL_CHAR_MSGS));
          ...
          labelerCode.setData("maxlengthvalidationtwentyfive,maxlengthvalidationlabelercode,alphaNumericCharsWithoutStar,specialcharvalidationlabelercode");
            ...
            packageSizeCode.addValidator(new StringLengthValidator(
                    "Package Size Code should be less than 25 characters", 0, 25,
                    true));
            ...
            manufacturerIdDDLB.setPageLength(7);
