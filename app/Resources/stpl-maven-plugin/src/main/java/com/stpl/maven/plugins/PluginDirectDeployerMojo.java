...
import com.stpl.maven.plugins.util.CopyTask;
import com.stpl.maven.plugins.util.FileUtil;
...
public class PluginDirectDeployerMojo extends AbstractLiferayMojo {
	...
	protected void deployExtWeb(File extWebDocrootDir) throws Exception {
		...
		executeTool(
			"com.stpl.portal.tools.WebXMLBuilder", getProjectClassLoader(),
			args);
	...
	protected void deployHook() throws Exception {
		...
		executeTool(
			"com.stpl.portal.tools.deploy.HookDeployer",
			getProjectClassLoader(), args);
	}

	protected void deployLayoutTemplate() throws Exception {
		executeTool(
			"com.stpl.portal.tools.deploy.LayoutTemplateDeployer",
	...
	protected void deployPortlet() throws Exception {
		...
		executeTool(
			"com.stpl.portal.tools.deploy.PortletDeployer",
			getProjectClassLoader(), args);
	}
	...
	protected void deployTheme() throws Exception {
		...
		executeTool(
			"com.stpl.portal.tools.deploy.ThemeDeployer",
			getProjectClassLoader(), args);
	}
	...
	protected void deployWeb() throws Exception {
		...
		executeTool(
			"com.stpl.portal.tools.deploy.WebDeployer",
			getProjectClassLoader(), args);
	}
