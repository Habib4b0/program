...
public class GtnWsWorkflowQueryContants {
    ...
    public static final String GL_COMP = "GL_COMp";
    public static final String COMPANY_NAME = "COMPANY_NAME";
    public static final String COMPANY_MASTER_SID = "COMPANY_MASTER_SID";
    public static final String UDCS_JOIN = " JOIN UDCS ON UDCS.MASTER_SID=rs.RS_MODEL_SID ";
    public static final String LEFT_JOIN_USER_ON_USERID_WITH_WM_APPROVED_BY = "LEFT JOIN @SYS.dbo.User_ USER_APPROVED_BY ON USER_APPROVED_BY.userId=WM.APPROVED_BY ";
    public static final String LEFT_JOIN_USER_ON_USERID_WITH_WM_CREATED_BY = "LEFT JOIN @SYS.dbo.User_ USER_CREATED_BY ON USER_CREATED_BY.userId=WM.CREATED_BY ";
    public static final String JOIN_CCP_DETAILS_CCP_ON_CCP_DETAILS_SID_WITH_PD = "JOIN CCP_DETAILS CCP ON CCP.CCP_DETAILS_SID = PD.CCP_DETAILS_SID ";
    public static final String JOIN_ITEM_MASTER_IM_ON_ITEM_MASTER_SID_WITH_CCP = "JOIN ITEM_MASTER IM ON IM.ITEM_MASTER_SID = CCP.ITEM_MASTER_SID ";
    public static final String JOIN_HELPER_TABLE_HT_STATUS_ON_HELPER_TABLE_SID_WITH_WM = "JOIN dbo.HELPER_TABLE HT_STATUS on HT_STATUS.HELPER_TABLE_SID = WM.WORKFLOW_STATUS_ID ";
    public static final String JOIN_PROJECTION_MASTER_PM_ON_PROJECTION_MASTER_SID_WITH_WM = "JOIN PROJECTION_MASTER PM on WM.PROJECTION_MASTER_SID = PM.PROJECTION_MASTER_SID ";
    public static final String JOIN_COMPANY_MASTER_GL_COMP_ON_COMPANY_MASTER_SID_WITH_PM = "JOIN COMPANY_MASTER GL_COMp on GL_COMp.COMPANY_MASTER_SID=PM.COMPANY_MASTER_SID ";
    ...
    public static final String GTN_WF_ARP_COUNT = " SELECT count (DISTINCT WM.WORKFLOW_ID) ";
    public static final String GTN_WF_ARP_COUNT_QUERY = GtnFrameworkWebserviceConstant.FROM_WORKFLOW_MASTER_WM_JOIN_DBO_HELPER_T
            + "JOIN ACCRUAL_PROJ_DETAILS PD ON PD.PROJECTION_MASTER_SID = PM.PROJECTION_MASTER_SID "
            + JOIN_CCP_DETAILS_CCP_ON_CCP_DETAILS_SID_WITH_PD
            + "JOIN CONTRACT_MASTER CNM ON CNM.CONTRACT_MASTER_SID = CCP.CONTRACT_MASTER_SID "
            + JOIN_ITEM_MASTER_IM_ON_ITEM_MASTER_SID_WITH_CCP
            + "JOIN ACCRUAL_PROJ_SELECTION APS ON APS.PROJECTION_MASTER_SID = PM.PROJECTION_MASTER_SID ";
    public static final String GTN_WF_ARP_SEARCH_QUERY = "FROM WORKFLOW_MASTER WM "
            + JOIN_HELPER_TABLE_HT_STATUS_ON_HELPER_TABLE_SID_WITH_WM
            + JOIN_PROJECTION_MASTER_PM_ON_PROJECTION_MASTER_SID_WITH_WM
            + JOIN_COMPANY_MASTER_GL_COMP_ON_COMPANY_MASTER_SID_WITH_PM
            + "JOIN COMPANY_MASTER BU_COMp on BU_COMp.COMPANY_MASTER_SID=PM.BUSINESS_UNIT "
            + "JOIN ACCRUAL_PROJ_DETAILS PD ON PD.PROJECTION_MASTER_SID = PM.PROJECTION_MASTER_SID "
            + JOIN_CCP_DETAILS_CCP_ON_CCP_DETAILS_SID_WITH_PD
            + "JOIN CONTRACT_MASTER CNM ON CNM.CONTRACT_MASTER_SID = CCP.CONTRACT_MASTER_SID "
            + JOIN_ITEM_MASTER_IM_ON_ITEM_MASTER_SID_WITH_CCP
    ...
    public static final String GTN_WF_ARM_COUNT = " SELECT count (DISTINCT WM.WORKFLOW_ID) ";

    public static final String GTN_WF_ARM_COUNT_QUERY = "  FROM WORKFLOW_MASTER WM "
            + JOIN_HELPER_TABLE_HT_STATUS_ON_HELPER_TABLE_SID_WITH_WM
            + JOIN_PROJECTION_MASTER_PM_ON_PROJECTION_MASTER_SID_WITH_WM
            + "JOIN ARM_ADJUSTMENT_MASTER arm_M on arm_M.PROJECTION_MASTER_SID=PM.PROJECTION_MASTER_SID "
            + "JOIN HELPER_TABLE CONF_NAME on CONF_NAME.HELPER_TABLE_SID = arm_M.CONFIGURATION_TYPE "
            + JOIN_COMPANY_MASTER_GL_COMP_ON_COMPANY_MASTER_SID_WITH_PM
            + "JOIN COMPANY_MASTER BU_COMp on BU_COMp.COMPANY_MASTER_SID=arm_M.BU_COMPANY_MASTER_SID "
            ...
            + "JOIN ARM_ADJUSTMENT_DETAILS PD ON PD.PROJECTION_MASTER_SID = PM.PROJECTION_MASTER_SID "
            + JOIN_CCP_DETAILS_CCP_ON_CCP_DETAILS_SID_WITH_PD
            + JOIN_ITEM_MASTER_IM_ON_ITEM_MASTER_SID_WITH_CCP
            + "JOIN RS_CONTRACT rs ON rs.RS_MODEL_SID = PD.RS_MODEL_SID "
            + "JOIN BRAND_MASTER BM ON IM.BRAND_MASTER_SID=BM.BRAND_MASTER_SID "
            + "JOIN UDCS udcs ON udcs.MASTER_SID=rs.RS_MODEL_SID ";

    public static final String GTN_WF_ARM_SEARCH_QUERY = " FROM WORKFLOW_MASTER WM "
            + JOIN_HELPER_TABLE_HT_STATUS_ON_HELPER_TABLE_SID_WITH_WM
            + JOIN_PROJECTION_MASTER_PM_ON_PROJECTION_MASTER_SID_WITH_WM
            + "JOIN ARM_ADJUSTMENT_MASTER arm_M on arm_M.PROJECTION_MASTER_SID=PM.PROJECTION_MASTER_SID "
            + "JOIN HELPER_TABLE CONF_NAME on CONF_NAME.HELPER_TABLE_SID = arm_M.CONFIGURATION_TYPE "
