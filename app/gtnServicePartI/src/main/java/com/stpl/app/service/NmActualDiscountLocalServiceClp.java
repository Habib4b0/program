 ...
 * @generated
 */
public class NmActualDiscountLocalServiceClp
    ...
    public NmActualDiscountLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addNmActualDiscount";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.NmActualDiscount"
            };

        _methodName1 = "createNmActualDiscount";

        _methodParameterTypes1 = new String[] {
                "com.stpl.app.service.persistence.NmActualDiscountPK"
            };

        _methodName2 = "deleteNmActualDiscount";

        _methodParameterTypes2 = new String[] {
                "com.stpl.app.service.persistence.NmActualDiscountPK"
            };

        _methodName3 = "deleteNmActualDiscount";
        ...
        _methodName10 = "fetchNmActualDiscount";

        _methodParameterTypes10 = new String[] {
                "com.stpl.app.service.persistence.NmActualDiscountPK"
            };

        _methodName11 = "getNmActualDiscount";
        ...
        _methodName13 = "getNmActualDiscounts";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getNmActualDiscountsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateNmActualDiscount";
    ...
    public com.stpl.app.model.NmActualDiscount addNmActualDiscount(
        ...
        return (com.stpl.app.model.NmActualDiscount) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.NmActualDiscount createNmActualDiscount(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(nmActualDiscountPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.NmActualDiscount> getNmActualDiscounts(
        ...
        return (java.util.List<com.stpl.app.model.NmActualDiscount>) ClpSerializer.translateOutput(returnObj);
    }
