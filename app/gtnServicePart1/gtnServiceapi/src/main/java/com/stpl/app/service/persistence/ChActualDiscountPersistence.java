...
public interface ChActualDiscountPersistence extends BasePersistence<ChActualDiscount> {
	...
	*/
	public void cacheResult(java.util.List<ChActualDiscount> chActualDiscounts);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ChActualDiscount> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ChActualDiscount> findAll();
	...
	*/
	public java.util.List<ChActualDiscount> findAll(int start, int end);
	...
	*/
	public java.util.List<ChActualDiscount> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ChActualDiscount> orderByComparator);
