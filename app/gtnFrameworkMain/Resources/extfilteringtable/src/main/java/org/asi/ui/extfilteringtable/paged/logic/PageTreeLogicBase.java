 ...
 */
 public abstract class PageTreeLogicBase implements TreeLogicBase{
            ...
            if (getTables().contains(table)) {
                if (getTables().remove(table)) {
                    ...
                    if (controlTable != null) {
                        if (table.equals(controlTable) && getTables().size() > 0) {
    ...
    protected class LevelMap {
        ...
        /** The column id to filter value. */
        private Map<Object, Object> columnIdToFilterValue;
         ...
         * @param columnIdToFilterValue the column id to filter value
         */
        public LevelMap(int count, Map<Object, Object> columnIdToFilterValue) {
            this.count = count;
            this.columnIdToFilterValue = new HashMap<Object, Object>(columnIdToFilterValue);
        }
         ...
         * @param columnIdToFilterValue the column id to filter value
         */
        public LevelMap(int index, int count, Map<Object, Object> columnIdToFilterValue) {
            this.index = index;
            this.count = count;
            this.columnIdToFilterValue = new HashMap<Object, Object>(columnIdToFilterValue);
        }
         ...
         * @param columnIdToFilterValue the column id to filter value
         */
        public LevelMap(int start, int end, int page, int pageLength, int index, Map<Object, Object> columnIdToFilterValue) {
            this.start = start;
            this.end = end;
            this.page = page;
         ...
         * @return the column id to filter value
         */
        public Map<Object, Object> getColumnIdToFilterValue() {
            return columnIdToFilterValue;
        }
         ...
         * @param columnIdToFilterValue the column id to filter value
         */
        public void setColumnIdToFilterValue(Map<Object, Object> columnIdToFilterValue) {
