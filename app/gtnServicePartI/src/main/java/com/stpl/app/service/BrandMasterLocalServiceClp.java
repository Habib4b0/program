 ...
 * @generated
 */
public class BrandMasterLocalServiceClp implements BrandMasterLocalService {
    ...
    public BrandMasterLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addBrandMaster";

        _methodParameterTypes0 = new String[] { "com.stpl.app.model.BrandMaster" };

        _methodName1 = "createBrandMaster";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteBrandMaster";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteBrandMaster";

        _methodParameterTypes3 = new String[] { "com.stpl.app.model.BrandMaster" };
        ...
        _methodName10 = "fetchBrandMaster";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getBrandMaster";
        ...
        _methodName13 = "getBrandMasters";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getBrandMastersCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateBrandMaster";

        _methodParameterTypes15 = new String[] { "com.stpl.app.model.BrandMaster" };
    ...
    public com.stpl.app.model.BrandMaster addBrandMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(brandMaster) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.BrandMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.BrandMaster createBrandMaster(int brandMasterSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { brandMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.BrandMaster deleteBrandMaster(int brandMasterSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { brandMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.BrandMaster fetchBrandMaster(int brandMasterSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { brandMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.BrandMaster getBrandMaster(int brandMasterSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { brandMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.BrandMaster> getBrandMasters(
        ...
        return (java.util.List<com.stpl.app.model.BrandMaster>) ClpSerializer.translateOutput(returnObj);
    }
