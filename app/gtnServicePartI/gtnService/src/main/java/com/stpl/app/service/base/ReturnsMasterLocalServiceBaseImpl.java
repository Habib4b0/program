...
import com.stpl.app.service.ReturnsMasterLocalService;
...
/**
 * Provides the base implementation for the returns master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ReturnsMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class ReturnsMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ReturnsMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ReturnsMasterLocalServiceUtil} to access the returns master local service.
	 */
	...
	@Override
	public ReturnsMaster addReturnsMaster(ReturnsMaster returnsMaster) {
		returnsMaster.setNew(true);

		return returnsMasterPersistence.update(returnsMaster);
	}
	 ...
	 */
	@Override
	public ReturnsMaster createReturnsMaster(int returnsMasterSid) {
		return returnsMasterPersistence.create(returnsMasterSid);
	}
	...
	@Override
	public ReturnsMaster deleteReturnsMaster(int returnsMasterSid)
		throws PortalException {
		return returnsMasterPersistence.remove(returnsMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ReturnsMaster deleteReturnsMaster(ReturnsMaster returnsMaster) {
		return returnsMasterPersistence.remove(returnsMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ReturnsMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return returnsMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return returnsMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ReturnsMaster fetchReturnsMaster(int returnsMasterSid) {
		return returnsMasterPersistence.fetchByPrimaryKey(returnsMasterSid);
	}
	 ...
	 */
	@Override
	public ReturnsMaster getReturnsMaster(int returnsMasterSid)
		throws PortalException {
		return returnsMasterPersistence.findByPrimaryKey(returnsMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(returnsMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ReturnsMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("returnsMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(returnsMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ReturnsMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return returnsMasterLocalService.deleteReturnsMaster((ReturnsMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return returnsMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ReturnsMaster> getReturnsMasters(int start, int end) {
		return returnsMasterPersistence.findAll(start, end);
	}
	...
	public int getReturnsMastersCount() {
		return returnsMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ReturnsMaster updateReturnsMaster(ReturnsMaster returnsMaster) {
		return returnsMasterPersistence.update(returnsMaster);
	}
	 ...
	 */
	public ReturnsMasterLocalService getReturnsMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ReturnsMaster",
			returnsMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ReturnsMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ReturnsMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = returnsMasterPersistence.getDataSource();
	...
	@BeanReference(type = ReturnsMasterLocalService.class)
	protected ReturnsMasterLocalService returnsMasterLocalService;
