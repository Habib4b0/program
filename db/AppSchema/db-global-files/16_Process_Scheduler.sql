...
----------------------------------------------DTX_ACTUALS_MASTER_REBATE_INTERFACE----------------------------------------------------------
IF NOT EXISTS (
		SELECT 1
		FROM WORKFLOW_PROFILE
		WHERE PROCESS_NAME = 'DTX_ACTUALS_MASTER_REBATE_INTERFACE'
		)
BEGIN
	INSERT [dbo].[WORKFLOW_PROFILE] (
		[PROCESS_NAME]		
	...
	VALUES (
		...
		,1
		,1
        ,'Dtx_Actuals_Master_Rebate_Intf.sh'
		,'DTX_ACTUALS_MASTER_REBATE_INTERFACE'
		,'N'
		,'SUCCESS - DTX_ACTUALS_MASTER_REBATE_INTERFACE'
		,'DTX_ACTUALS_MASTER_REBATE_INTERFACE SUCCESS'
		,'FAILURE - DTX_ACTUALS_MASTER_REBATE_INTERFACE '
		,'DTX_ACTUALS_MASTER_REBATE_INTERFACE FAILURE'
		,'support@bpitechnologies.com'
		,'support@bpitechnologies.com' 
		)
END
...
----------------------------------------------DTX_ACTUAL_MASTER_CHARGEBACK_INTERFACE----------------------------------------------------------
IF NOT EXISTS (
		SELECT 1
		FROM WORKFLOW_PROFILE
		WHERE PROCESS_NAME = 'DTX_ACTUAL_MASTER_CHARGEBACK_INTERFACE'
		)
BEGIN
	INSERT [dbo].[WORKFLOW_PROFILE] (
		[PROCESS_NAME]		
	...
	VALUES (
		...
		,1
		,1
        ,'Dtx_Actual_Master_Chargeback_Intf.sh'
		,'DTX_ACTUAL_MASTER_CHARGEBACK_INTERFACE'
		,'N'
		,'SUCCESS - DTX_ACTUAL_MASTER_CHARGEBACK_INTERFACE'
		,'DTX_ACTUAL_MASTER_CHARGEBACK_INTERFACE SUCCESS'
		,'FAILURE - DTX_ACTUAL_MASTER_CHARGEBACK_INTERFACE '
		,'DTX_ACTUAL_MASTER_CHARGEBACK_INTERFACE FAILURE'
		,'support@bpitechnologies.com'
		,'support@bpitechnologies.com' 
		)
END
