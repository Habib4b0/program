 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link DeductionCalendarDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DeductionCalendarDetailsImpl}.
 * </p>
 *
 * @author
...
public class DeductionCalendarDetailsModelImpl extends BaseModelImpl<DeductionCalendarDetails>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ADJUSTMENT_VALUE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ADJUSTMENT_ALLOCATION_METHODOLOGY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("COMPANY_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("DISCOUNT_AMOUNT", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("ADJUSTMENT_VARIABLE", Types.VARCHAR);
	...
	public CacheModel<DeductionCalendarDetails> toCacheModel() {
		...
		deductionCalendarDetailsCacheModel.deductionCalendarDetailsPK = getPrimaryKey();
	...
	private static final ClassLoader _classLoader = DeductionCalendarDetails.class.getClassLoader();
