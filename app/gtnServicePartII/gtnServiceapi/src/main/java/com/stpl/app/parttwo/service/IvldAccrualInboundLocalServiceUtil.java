...
public class IvldAccrualInboundLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<IvldAccrualInboundLocalService, IvldAccrualInboundLocalService> _serviceTracker =
		ServiceTrackerFactory.open(IvldAccrualInboundLocalService.class);
}