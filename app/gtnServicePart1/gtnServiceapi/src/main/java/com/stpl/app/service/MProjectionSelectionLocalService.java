...
/**
 * Provides the local service interface for MProjectionSelection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see MProjectionSelectionLocalServiceUtil
...
public interface MProjectionSelectionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MProjectionSelectionLocalServiceUtil} to access the m projection selection local service. Add custom service methods to {@link com.stpl.app.service.impl.MProjectionSelectionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
