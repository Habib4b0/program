...
public class RSInfoTabForm extends CustomComponent {
   ...
   private TextField evaluationSystemId=new TextField();
    ...
    public RSInfoTabForm(final RebateScheduleLogic rebateLogic, final RebateScheduleAddForm tabForm, final ErrorfulFieldGroup binder, final String mode) {
    ...
    private void configureFields() {
        ...
        endDate.addValueChangeListener(new Property.ValueChangeListener() {
            ...
            rebateScheduleId.addValidator(new RegexpValidator(ValidationUtils.SPECIAL_CHAR, ValidationUtils.SPECIAL_CHAR_MSG));
            rebateScheduleId.setImmediate(true);
            rebateScheduleId.setValidationVisible(true);
            rebateScheduleId.setData("maxlengthvalidationfifty,maxlengthvalidationrebatescheduleid,splcharvalidation,splcharacters");
            ...
            rebateScheduleNo.addValidator(new RegexpValidator(ValidationUtils.SPECIAL_CHAR, ValidationUtils.SPECIAL_CHAR_MSG));
            rebateScheduleNo.setImmediate(true);
            rebateScheduleNo.setValidationVisible(true);
            rebateScheduleNo.setData("maxlengthvalidationfifty,maxlengthvalidationrebatescheduleno,splcharvalidation,splcharacters");
            ...
            rebateScheduleName.addValidator(new RegexpValidator(ValidationUtils.SPECIAL_CHAR, ValidationUtils.SPECIAL_CHAR_MSG));
            rebateScheduleName.setData("maxlengthvalidationhundred,maxlengthvalidationrebateschedulename,splcharvalidation,splcharacters");
            ...
            LOGGER.info("In configureFields lodding-RebateScheduleStatus Dblb ListType=" + GeneralCommonUtils.RS_STATUS);
            ...
            parentRebateScheduleName.addValidator(new StringLengthValidator("Parent Rebate Schedule Name should be less than 100 Characters", 0, 100, true));
            parentRebateScheduleId.addClickListener(new CustomTextField.ClickListener() {
                ...
                public void click(final CustomTextField.ClickEvent event) {
                    if (lookUp == null) {
                        LOGGER.info("Entering parent Rebate Schedule look up");
                        LOGGER.info("In configureFields ParentRebateScheduleId Listener parentRebateScheduleId=" + parentRebateScheduleId.getValue() + " parentRebateScheduleName="
                        ...
                        public void windowClose(final Window.CloseEvent event) {
                            if (lookUp.isItemCliked()) {
                               ...
                               lookUp = null;
                            LOGGER.info("Ending parent Rebate Schedule look up");
                        }
                    });
                    }
                }
            ...
            rebateScheduleTransRefNo.addValidator(new StringLengthValidator("Rebate Schedule Reference No should be less than 100 Characters", 0, 100, true));
            ...
            rebateScheduleTransRefName.addValidator(new StringLengthValidator("Rebate Schedule Reference Name should be less than 100 Characters", 0, 100, true));
                ...
                public void click(final CustomTextField.ClickEvent event) {
                    if (lookUp == null) {
                        ...
                        public void windowClose(final Window.CloseEvent e) {
                            ...
                            lookUp = null;
                            LOGGER.info("Ending RS Transaction Ref ID lookup");
                        }
                    });
                    }
            ...
            LOGGER.info("In configureFields lodding-RebatePlanLevel Dblb ListType=" + GeneralCommonUtils.REBATE_PLAN_LEVEL);
