 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.stpl.app.parttwo.model.StAdjustmentGtnDetailModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link StAdjustmentGtnDetailImpl}.
 * </p>
 *
 * @author
 * @see StAdjustmentGtnDetailImpl
 * @see com.stpl.app.parttwo.model.StAdjustmentGtnDetail
 * @see com.stpl.app.parttwo.model.StAdjustmentGtnDetailModel
 * @generated
 */
public class StAdjustmentGtnDetailModelImpl extends BaseModelImpl<StAdjustmentGtnDetail>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a st adjustment gtn detail model instance should use the {@link com.stpl.app.parttwo.model.StAdjustmentGtnDetail} interface instead.
     */
    ...
    public static final String TABLE_SQL_CREATE = "create table ST_ADJUSTMENT_GTN_DETAIL (ADJUSTMENT_CREATED_DATE DATE null,ETL_CHECK_RECORD BOOLEAN,BUSINESS_UNIT_NO VARCHAR(75) null,REDEMPTION_PERIOD DATE not null IDENTITY,DEDUCTION_ID VARCHAR(75) not null IDENTITY,GL_YEAR INTEGER,BRAND_NAME VARCHAR(75) null,MODIFIED_DATE DATE null,ACCOUNT VARCHAR(75) not null IDENTITY,SOURCE VARCHAR(75) null,WORKFLOW_APPROVED_DATE DATE null,UDC_6 VARCHAR(75) null,BUSINESS_UNIT_NAME VARCHAR(75) null,UDC_5 VARCHAR(75) null,WORKFLOW_CREATED_DATE DATE null,UDC_4 VARCHAR(75) null,UDC_3 VARCHAR(75) null,UDC_2 VARCHAR(75) null,UDC_1 VARCHAR(75) null,ADJUSTMENT_TYPE VARCHAR(75) not null IDENTITY,MODIFIED_BY VARCHAR(75) null,DEDUCTION_TYPE VARCHAR(75) null,CHECK_RECORD BOOLEAN,CONTRACT_NAME VARCHAR(75) null,DEDUCTION_RATE VARCHAR(75) null,DEDUCTION_CATEGORY VARCHAR(75) null,DEDUCTION_NO VARCHAR(75) null,COMPANY_NO VARCHAR(75) null,SESSION_ID VARCHAR(75) not null IDENTITY,GL_COMPANY_ID VARCHAR(75) not null IDENTITY,ITEM_NAME VARCHAR(75) null,DEDUCTION_INCLUSION VARCHAR(75) null,DEDUCTION_AMOUNT VARCHAR(75) null,COMPANY_NAME VARCHAR(75) null,PROJECT VARCHAR(75) null,DEDUCTION_UDC_3 VARCHAR(75) null,DEDUCTION_UDC_4 VARCHAR(75) null,DEDUCTION_UDC_1 VARCHAR(75) null,ITEM_ID VARCHAR(75) not null IDENTITY,DEDUCTION_UDC_2 VARCHAR(75) null,ACCOUNT_TYPE VARCHAR(75) not null IDENTITY,GL_STRING VARCHAR(75) null,CREATED_DATE DATE null,CREATED_BY VARCHAR(75) null,DEDUCTION_UDC_6 VARCHAR(75) null,DEDUCTION_UDC_5 VARCHAR(75) null,GL_COMPANY_NAME VARCHAR(75) null,WORKFLOW_ID VARCHAR(75) not null IDENTITY,ITEM_NO VARCHAR(75) null,CONTRACT_ID VARCHAR(75) not null IDENTITY,DEDUCTION_PROGRAM VARCHAR(75) null,BUSINESS_UNIT_ID VARCHAR(75) not null IDENTITY,USER_ID VARCHAR(75) not null IDENTITY,COST_CENTER VARCHAR(75) null,COMPANY_ID VARCHAR(75) not null IDENTITY,OUTBOUND_STATUS VARCHAR(75) null,FUTURE_1 VARCHAR(75) null,BRAND_ID VARCHAR(75) null,DEDUCTION_NAME VARCHAR(75) null,FUTURE_2 VARCHAR(75) null,WORKFLOW_NAME VARCHAR(75) null,GL_DATE DATE null,WORKFLOW_CREATED_BY VARCHAR(75) null,GL_MONTH INTEGER,BATCH_ID VARCHAR(75) null,ACCOUNT_CATEGORY VARCHAR(75) not null IDENTITY,GL_COMPANY_NO VARCHAR(75) null,WORKFLOW_APPROVED_BY VARCHAR(75) null,CONTRACT_NO VARCHAR(75) null,ORIGINAL_BATCH_ID VARCHAR(75) null,ADJUSTMENT_LEVEL VARCHAR(75) null,primary key (REDEMPTION_PERIOD, DEDUCTION_ID, ACCOUNT, ADJUSTMENT_TYPE, SESSION_ID, GL_COMPANY_ID, ITEM_ID, ACCOUNT_TYPE, WORKFLOW_ID, CONTRACT_ID, BUSINESS_UNIT_ID, USER_ID, COMPANY_ID, ACCOUNT_CATEGORY))";
    public static final String TABLE_SQL_DROP = "drop table ST_ADJUSTMENT_GTN_DETAIL";
    public static final String ORDER_BY_JPQL = " ORDER BY stAdjustmentGtnDetail.id.redemptionPeriod ASC, stAdjustmentGtnDetail.id.deductionId ASC, stAdjustmentGtnDetail.id.account ASC, stAdjustmentGtnDetail.id.adjustmentType ASC, stAdjustmentGtnDetail.id.sessionId ASC, stAdjustmentGtnDetail.id.glCompanyId ASC, stAdjustmentGtnDetail.id.itemId ASC, stAdjustmentGtnDetail.id.accountType ASC, stAdjustmentGtnDetail.id.workflowId ASC, stAdjustmentGtnDetail.id.contractId ASC, stAdjustmentGtnDetail.id.businessUnitId ASC, stAdjustmentGtnDetail.id.userId ASC, stAdjustmentGtnDetail.id.companyId ASC, stAdjustmentGtnDetail.id.accountCategory ASC";
    public static final String ORDER_BY_SQL = " ORDER BY ST_ADJUSTMENT_GTN_DETAIL.REDEMPTION_PERIOD ASC, ST_ADJUSTMENT_GTN_DETAIL.DEDUCTION_ID ASC, ST_ADJUSTMENT_GTN_DETAIL.ACCOUNT ASC, ST_ADJUSTMENT_GTN_DETAIL.ADJUSTMENT_TYPE ASC, ST_ADJUSTMENT_GTN_DETAIL.SESSION_ID ASC, ST_ADJUSTMENT_GTN_DETAIL.GL_COMPANY_ID ASC, ST_ADJUSTMENT_GTN_DETAIL.ITEM_ID ASC, ST_ADJUSTMENT_GTN_DETAIL.ACCOUNT_TYPE ASC, ST_ADJUSTMENT_GTN_DETAIL.WORKFLOW_ID ASC, ST_ADJUSTMENT_GTN_DETAIL.CONTRACT_ID ASC, ST_ADJUSTMENT_GTN_DETAIL.BUSINESS_UNIT_ID ASC, ST_ADJUSTMENT_GTN_DETAIL.USER_ID ASC, ST_ADJUSTMENT_GTN_DETAIL.COMPANY_ID ASC, ST_ADJUSTMENT_GTN_DETAIL.ACCOUNT_CATEGORY ASC";
    ...
    private static ClassLoader _classLoader = StAdjustmentGtnDetail.class.getClassLoader();
