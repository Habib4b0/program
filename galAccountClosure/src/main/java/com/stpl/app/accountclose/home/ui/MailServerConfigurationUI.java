...
import com.stpl.app.accountclose.ui.view.MailServerConfigurationMainView;
 ...
 * @author alok.v
 */
public class MailServerConfigurationUI extends UI implements VaadinPortletSession.PortletListener {
     ...
     * The Constant LOGGER.
     */
    private static final Logger LOGGER = Logger.getLogger(MailServerConfigurationUI.class);
    /**
     * 
     * @param request 
     */
    ...
    protected void init(VaadinRequest request) {
        ...
        try {
            navigator.addView(MailServerConfigurationMainView.NAME, new MailServerConfigurationMainView());
        } catch (Exception e) {
            LOGGER.error(e);
        }
    ...
    public void handleRenderRequest(RenderRequest request, RenderResponse response, UI uI) {
       PortletConfig portletConfig = (PortletConfig) request.getAttribute(JavaConstants.JAVAX_PORTLET_CONFIG);
        ...
        getUI().getNavigator().navigateTo(MailServerConfigurationMainView.NAME);
    }
