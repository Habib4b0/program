...
public class IFPItemAddition extends CustomComponent {
    ...
    public IFPItemAddition(final ErrorfulFieldGroup binder, ItemFamilyplanMasterDTO ifpMaster, final String mode, final SessionDTO sessionDTO) throws Exception {
        ...
        searchFields.addValueChangeListener(new Property.ValueChangeListener() {
            ...
            public void valueChange(final Property.ValueChangeEvent event) {
                try {
                    ...
                    java.util.logging.Logger.getLogger(IFPTabsheetForm.class.getName()).log(Level.SEVERE, null, ex);
                } catch (Exception ex) {
        ...
        searchBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                try {
                    ...
                    int value = 0;
                    LOGGER.info("Entering inside IFPTabsheetForm SEARCH  method ");
                    ...
                    LOGGER.info("Ending IFPTabsheetForm SEARCH method ");
    ...
    public void addAll() {
        ...
        btnMoveAll.addClickListener(new Button.ClickListener() {
             ...
             */
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("Entering inside IFPTabsheetForm MOVE_ALL_RIGHT  method ");
                ...
                //}
                LOGGER.info("Ending IFPTabsheetForm MOVE_ALL_RIGHT  method ");
            }
        });
    }
     ...
     */
    private void addAllCompanyButtonClick(final Button.ClickEvent event) throws SystemException, PortalException, Exception {
    ...
    public void removeAll() {
        ...
        btnRemoveAll.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                ...
                LOGGER.info("Ending  MOVE_ALL_LEFT  method ");
            }
        });
    }
     ...
     */
    public void addSelectedTable() throws Exception {
