...
/**
 * Provides the local service interface for CompanyQualifier. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see CompanyQualifierLocalServiceUtil
...
public interface CompanyQualifierLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CompanyQualifierLocalServiceUtil} to access the company qualifier local service. Add custom service methods to {@link com.stpl.app.service.impl.CompanyQualifierLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
