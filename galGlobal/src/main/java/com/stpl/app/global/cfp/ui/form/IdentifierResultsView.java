...
public class IdentifierResultsView extends CustomComponent {
     ...
     */
    private void init() {
        LOGGER.info("Entering IdentifierResultsView init");
        space.setHeight(ConstantsUtils.HEIGHT);
        binder.bindMemberFields(this);
        addToContent();
        LOGGER.info("Ending IdentifierResultsView init");
    ...
    private void addToContent() {
        LOGGER.info("Entering IdentifierResultsView addToContent");
        ...
        LOGGER.info("Ending IdentifierResultsView addToContent");
    }
    ...
    private Table addToTable() {
        LOGGER.info("Entering IdentifierResultsView addToTable");
        ...
        LOGGER.info("Ending IdentifierResultsView addToTable");
        return table;
    }   
}
