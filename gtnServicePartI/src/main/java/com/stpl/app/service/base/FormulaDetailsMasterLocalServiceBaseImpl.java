...
public abstract class FormulaDetailsMasterLocalServiceBaseImpl
    ...
    private FormulaDetailsMasterLocalServiceClpInvoker _clpInvoker = new FormulaDetailsMasterLocalServiceClpInvoker();
    ...
    public FormulaDetailsMaster deleteFormulaDetailsMaster(
        int formulaDetailsMasterSid) throws PortalException, SystemException {
    ...
    public FormulaDetailsMaster fetchFormulaDetailsMaster(
        int formulaDetailsMasterSid) throws SystemException {
     ...
     */
    @Override
    public int getFormulaDetailsMastersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.FormulaDetailsMaster",
