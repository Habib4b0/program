    ...
    public void setBusinessUnit(String businessUnit) {
        ...
        if (_fileManagementRemoteModel != null) {
            try {
                ...
                method.invoke(_fileManagementRemoteModel, businessUnit);
            } catch (Exception e) {
                throw new UnsupportedOperationException(e);
            }
        }
    ...
    public void setCompany(int company) {
        ...
        if (_fileManagementRemoteModel != null) {
            try {
                ...
                Method method = clazz.getMethod("setCompany", int.class);

                method.invoke(_fileManagementRemoteModel, company);
            } catch (Exception e) {
                throw new UnsupportedOperationException(e);
            }
        }
