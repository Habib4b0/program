...
/**
 * The persistence utility for the businessrole module service. This utility wraps {@link BusinessroleModulePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class BusinessroleModuleUtil {
    private static BusinessroleModulePersistence _persistence;
    ...
    */
    public static com.stpl.app.model.BusinessroleModule create(
    ...
    */
    public static com.stpl.app.model.BusinessroleModule remove(
        int businessroleModuleSid)
    ...
    public static com.stpl.app.model.BusinessroleModule updateImpl(
        com.stpl.app.model.BusinessroleModule businessroleModule)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.BusinessroleModule findByPrimaryKey(
        int businessroleModuleSid)
        throws com.stpl.app.NoSuchBusinessroleModuleException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.BusinessroleModule fetchByPrimaryKey(
        int businessroleModuleSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.BusinessroleModule> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static BusinessroleModulePersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (BusinessroleModulePersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    BusinessroleModulePersistence.class.getName());

            ReferenceRegistry.registerReference(BusinessroleModuleUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(BusinessroleModulePersistence persistence) {
    }
}
