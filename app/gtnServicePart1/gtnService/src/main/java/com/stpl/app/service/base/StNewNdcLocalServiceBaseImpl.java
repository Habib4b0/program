...
public abstract class StNewNdcLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements StNewNdcLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	@Override
	public StNewNdc addStNewNdc(StNewNdc stNewNdc) {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public StNewNdc deleteStNewNdc(StNewNdc stNewNdc) {
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stNewNdcLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StNewNdc.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName(
			"primaryKey.naProjDetailsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(stNewNdcLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StNewNdc.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stNewNdcLocalService.deleteStNewNdc((StNewNdc)persistedModel);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StNewNdc updateStNewNdc(StNewNdc stNewNdc) {
		return stNewNdcPersistence.update(stNewNdc);
	}
	 ...
	 */
	public StNewNdcLocalService getStNewNdcLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.StNewNdc",
	...
	public String getOSGiServiceIdentifier() {
		return StNewNdcLocalService.class.getName();
	}
	...
	@BeanReference(type = StNewNdcLocalService.class)
	protected StNewNdcLocalService stNewNdcLocalService;
