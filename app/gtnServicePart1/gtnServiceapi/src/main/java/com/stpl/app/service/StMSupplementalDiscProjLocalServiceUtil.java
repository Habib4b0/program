...
public class StMSupplementalDiscProjLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<StMSupplementalDiscProjLocalService, StMSupplementalDiscProjLocalService> _serviceTracker =
		ServiceTrackerFactory.open(StMSupplementalDiscProjLocalService.class);
}