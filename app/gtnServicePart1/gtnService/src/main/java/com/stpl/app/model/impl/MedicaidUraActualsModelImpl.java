 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link MedicaidUraActualsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link MedicaidUraActualsImpl}.
 * </p>
 *
 * @author
...
public class MedicaidUraActualsModelImpl extends BaseModelImpl<MedicaidUraActuals>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("BASE_YEAR", Types.DOUBLE);
	}
	...
	public CacheModel<MedicaidUraActuals> toCacheModel() {
		...
		medicaidUraActualsCacheModel.medicaidUraActualsPK = getPrimaryKey();
	...
	private static final ClassLoader _classLoader = MedicaidUraActuals.class.getClassLoader();
