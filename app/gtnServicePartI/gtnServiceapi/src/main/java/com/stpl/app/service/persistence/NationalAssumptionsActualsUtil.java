...
/**
 * The persistence utility for the national assumptions actuals service. This utility wraps {@link com.stpl.app.service.persistence.impl.NationalAssumptionsActualsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class NationalAssumptionsActualsUtil {
	...
	*/
	public static NationalAssumptionsActuals create(
	...
	*/
	public static NationalAssumptionsActuals remove(
		NationalAssumptionsActualsPK nationalAssumptionsActualsPK)
		throws com.stpl.app.exception.NoSuchNationalAssumptionsActualsException {
		return getPersistence().remove(nationalAssumptionsActualsPK);
	}

	public static NationalAssumptionsActuals updateImpl(
		NationalAssumptionsActuals nationalAssumptionsActuals) {
	...
	* @throws NoSuchNationalAssumptionsActualsException if a national assumptions actuals with the primary key could not be found
	*/
	public static NationalAssumptionsActuals findByPrimaryKey(
		NationalAssumptionsActualsPK nationalAssumptionsActualsPK)
		throws com.stpl.app.exception.NoSuchNationalAssumptionsActualsException {
	...
	*/
	public static NationalAssumptionsActuals fetchByPrimaryKey(
		NationalAssumptionsActualsPK nationalAssumptionsActualsPK) {
		return getPersistence().fetchByPrimaryKey(nationalAssumptionsActualsPK);
	}

	public static java.util.Map<java.io.Serializable, NationalAssumptionsActuals> fetchByPrimaryKeys(
	...
	*/
	public static List<NationalAssumptionsActuals> findAll() {
	...
	*/
	public static List<NationalAssumptionsActuals> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<NationalAssumptionsActualsPersistence, NationalAssumptionsActualsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(NationalAssumptionsActualsPersistence.class);
}