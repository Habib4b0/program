...
public class ArchiveIndex extends CustomComponent implements View {
    ...
    private Panel addFirstPanel() {
        LOGGER.info("addFirstPanel Method Started ");
        ...
        LOGGER.info("addFirstPanel Method RETURNS panel ");
        return panel;
    }

    private Panel addResultsTables() {
        final Panel tablesPanel = new Panel();
        final GridLayout tableLayout = new GridLayout(2, 1);
    ...
    private Panel addResultsColumnTable() {
        LOGGER.info("addResultsColumnTable method started ");
        ...
        resultsColumnTable.setPageLength(5);
        ...
        LOGGER.info("addResultsColumnTable method RETURNS Table-results ");
        return panel;
    }
    ...
    public void configureFields() {
        LOGGER.info("configureFields started");
        ...
        archive.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                ...
                ArchiveDTO dto1 = (ArchiveDTO) ValueObj;
                if (businessProcess.getValue() == null || StringUtils.EMPTY.equals(String.valueOf(businessProcess.getValue()))) {
                    AbstractNotificationUtils.getErrorNotification("Archive Error", "Business Process should be selected");
                    return;
                }
                if (obj == null) {
                    AbstractNotificationUtils.getErrorNotification("Archive Error", "Please select Field Name");
                    return;
                }
                if (ValueObj == null) {
                    ...
                    if (fromdate == null || to == null) {
                        AbstractNotificationUtils.getErrorNotification("Archive Error", "Please check Date or Value");
                    }
                } else {
