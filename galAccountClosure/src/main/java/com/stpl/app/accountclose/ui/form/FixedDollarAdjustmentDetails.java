...
public class FixedDollarAdjustmentDetails extends CustomComponent implements View {
    ...
    private ExtTreeContainer<FixedDollarDTO> resultsTreeContainer = new ExtTreeContainer<FixedDollarDTO>(FixedDollarDTO.class);
    ...
    @UiField("exportBtn")
    Button exportBtn;
    ExtTreeContainer<FixedDollarDTO> excelContainer = new ExtTreeContainer<FixedDollarDTO>(FixedDollarDTO.class);
    ...
    public void excelBtnClick(Button.ClickEvent event) {
        ...
        try {
            ...
            excelContainer = new ExtTreeContainer<FixedDollarDTO>(FixedDollarDTO.class);
