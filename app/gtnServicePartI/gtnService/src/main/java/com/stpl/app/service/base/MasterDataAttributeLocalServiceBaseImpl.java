...
import com.stpl.app.service.MasterDataAttributeLocalService;
...
/**
 * Provides the base implementation for the master data attribute local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.MasterDataAttributeLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class MasterDataAttributeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MasterDataAttributeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.MasterDataAttributeLocalServiceUtil} to access the master data attribute local service.
	 */
	...
	@Override
	public MasterDataAttribute addMasterDataAttribute(
		MasterDataAttribute masterDataAttribute) {
		masterDataAttribute.setNew(true);

		return masterDataAttributePersistence.update(masterDataAttribute);
	}
	 ...
	 */
	@Override
	public MasterDataAttribute createMasterDataAttribute(
		int masterDataAttributeSid) {
		return masterDataAttributePersistence.create(masterDataAttributeSid);
	}
	...
	@Override
	public MasterDataAttribute deleteMasterDataAttribute(
		int masterDataAttributeSid) throws PortalException {
		return masterDataAttributePersistence.remove(masterDataAttributeSid);
	}
	...
	public MasterDataAttribute deleteMasterDataAttribute(
		MasterDataAttribute masterDataAttribute) {
		return masterDataAttributePersistence.remove(masterDataAttribute);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MasterDataAttribute.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterDataAttributePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterDataAttributePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MasterDataAttribute fetchMasterDataAttribute(
		int masterDataAttributeSid) {
		return masterDataAttributePersistence.fetchByPrimaryKey(masterDataAttributeSid);
	}
	...
	public MasterDataAttribute getMasterDataAttribute(
		int masterDataAttributeSid) throws PortalException {
		return masterDataAttributePersistence.findByPrimaryKey(masterDataAttributeSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterDataAttributeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterDataAttribute.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(masterDataAttributeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MasterDataAttribute.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return masterDataAttributeLocalService.deleteMasterDataAttribute((MasterDataAttribute)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return masterDataAttributePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterDataAttribute> getMasterDataAttributes(int start, int end) {
		return masterDataAttributePersistence.findAll(start, end);
	}
	...
	public int getMasterDataAttributesCount() {
		return masterDataAttributePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterDataAttribute updateMasterDataAttribute(
		MasterDataAttribute masterDataAttribute) {
		return masterDataAttributePersistence.update(masterDataAttribute);
	}
	 ...
	 */
	public MasterDataAttributeLocalService getMasterDataAttributeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.MasterDataAttribute",
			masterDataAttributeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.MasterDataAttribute");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterDataAttributeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterDataAttributePersistence.getDataSource();
	...
	@BeanReference(type = MasterDataAttributeLocalService.class)
	protected MasterDataAttributeLocalService masterDataAttributeLocalService;
