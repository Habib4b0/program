...
public class StringLengthValidatorWithComma extends AbstractStringValidator {
     ...
     */
    public StringLengthValidatorWithComma(String errorMessage) {
        super(errorMessage);
    }
     ...
     */
    public StringLengthValidatorWithComma(String errorMessage, Integer minLength,
