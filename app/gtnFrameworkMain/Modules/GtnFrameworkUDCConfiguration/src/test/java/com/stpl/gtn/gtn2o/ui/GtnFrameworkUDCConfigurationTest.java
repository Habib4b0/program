...
public class GtnFrameworkUDCConfigurationTest {

	private transient GtnWSLogger gtnLogger = GtnWSLogger.getGTNLogger(GtnFrameworkUDCConfigurationTest.class); 

	@Mock
	GtnUIFrameworkEngine gtnUIFrameworkEngine;
	@InjectMocks
	GtnFrameworkUDCConfiguration instance;
    ...
    public void testInit() {
        ...
        GtnUIFrameworkUDCConfigurationDynamicFiller fil = Mockito.mock(GtnUIFrameworkUDCConfigurationDynamicFiller.class);
        ...
        PowerMockito.whenNew(GtnUIFrameworkUDCConfigurationDynamicFiller.class).withNoArguments().thenReturn(fil);

        doNothing().when(engine).buildVaadinScreen(root, nav, request, ui, "UDC Configuration", fil);
