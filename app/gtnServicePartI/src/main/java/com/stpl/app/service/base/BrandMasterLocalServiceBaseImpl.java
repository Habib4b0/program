...
import com.stpl.app.service.BrandMasterLocalService;
...
/**
 * Provides the base implementation for the brand master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.BrandMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class BrandMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements BrandMasterLocalService,
        IdentifiableBean {
    ...
    private BrandMasterLocalServiceClpInvoker _clpInvoker = new BrandMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.BrandMasterLocalServiceUtil} to access the brand master local service.
     */
    ...
    @Override
    public BrandMaster addBrandMaster(BrandMaster brandMaster)
        throws SystemException {
        brandMaster.setNew(true);

        return brandMasterPersistence.update(brandMaster);
    }
     ...
     */
    @Override
    public BrandMaster createBrandMaster(int brandMasterSid) {
        return brandMasterPersistence.create(brandMasterSid);
    }
    ...
    @Override
    public BrandMaster deleteBrandMaster(int brandMasterSid)
        throws PortalException, SystemException {
        return brandMasterPersistence.remove(brandMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public BrandMaster deleteBrandMaster(BrandMaster brandMaster)
        throws SystemException {
        return brandMasterPersistence.remove(brandMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(BrandMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return brandMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return brandMasterPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return brandMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public BrandMaster fetchBrandMaster(int brandMasterSid)
        throws SystemException {
        return brandMasterPersistence.fetchByPrimaryKey(brandMasterSid);
    }
     ...
     */
    @Override
    public BrandMaster getBrandMaster(int brandMasterSid)
        throws PortalException, SystemException {
        return brandMasterPersistence.findByPrimaryKey(brandMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return brandMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<BrandMaster> getBrandMasters(int start, int end)
        throws SystemException {
        return brandMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getBrandMastersCount() throws SystemException {
        return brandMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public BrandMaster updateBrandMaster(BrandMaster brandMaster)
        throws SystemException {
        return brandMasterPersistence.update(brandMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.BrandMaster",
            brandMasterLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.BrandMaster");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = brandMasterPersistence.getDataSource();
