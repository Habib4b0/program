...
public abstract class VwCompanyTradeClassLocalServiceBaseImpl
    ...
    private VwCompanyTradeClassLocalServiceClpInvoker _clpInvoker = new VwCompanyTradeClassLocalServiceClpInvoker();
    ...
    public VwCompanyTradeClass deleteVwCompanyTradeClass(
        int companyTradeClassSid) throws PortalException, SystemException {
    ...
    public VwCompanyTradeClass fetchVwCompanyTradeClass(
        int companyTradeClassSid) throws SystemException {
     ...
     */
    @Override
    public int getVwCompanyTradeClassesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.VwCompanyTradeClass",
