...
/**
 * Provides the local service interface for StChDiscountProjMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StChDiscountProjMasterLocalServiceUtil
...
public interface StChDiscountProjMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StChDiscountProjMasterLocalServiceUtil} to access the st ch discount proj master local service. Add custom service methods to {@link com.stpl.app.service.impl.StChDiscountProjMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
