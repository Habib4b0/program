            ...
            privateView.addClickListener(new CustomTextField.ClickListener() {
                ...
                if (list != null && !list.isEmpty()) {
                    for (Object[] object : list) {
                        ...
                        businessUnit.setItemCaption(object[0], object[NumericConstants.TWO] + Constants.SPACE + Constants.DASH_NO_DATA + Constants.SPACE + object[NumericConstants.THREE]);
                    }
                }
                ...
                if (companyList != null && !companyList.isEmpty()) {
                    for (Object[] object : companyList) {
                        ...
                        company.setItemCaption(object[0], object[NumericConstants.TWO] + Constants.SPACE + Constants.DASH_NO_DATA + Constants.SPACE + object[NumericConstants.THREE]);
                    }
                }
                company.select(0);
