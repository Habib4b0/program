...
/**
 * Provides the local service interface for DemandForecast. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see DemandForecastLocalServiceUtil
...
public interface DemandForecastLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DemandForecastLocalServiceUtil} to access the demand forecast local service. Add custom service methods to {@link com.stpl.app.service.impl.DemandForecastLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
