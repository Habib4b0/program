            ...
            return new TextField() {
                {
                    ...
                    if (moduleProperty.getTableName().equals("CPI_INDEX_MASTER") && moduleProperty.getPropertyName().equals("STATUS")) {
                        ...
                        if (moduleProperty.getPropertyName().trim().equals("BASE_CPI")) {
                            ...
                            setValue(value == null ? StringUtils.EMPTY : String.valueOf(format2.format(Double.valueOf(value.toString()))).concat("%"));
                        } else {
                            setValue(value == null ? StringUtils.EMPTY : String.valueOf(decimalformatper.format(Double.valueOf(value.toString()))).concat("%"));
                        }
                        addStyleName(ValoTheme.DATEFIELD_ALIGN_RIGHT);
                        ...
                        setValue(String.valueOf("$"+format2.format(Double.valueOf(String.valueOf(value)))));
                        addStyleName(ValoTheme.DATEFIELD_ALIGN_RIGHT);
