...
public abstract class AbstractNotesTab extends CustomComponent implements View {
    ...
    private void addAttachments() {
        ...
        fileNameField.addValidator(new StringLengthValidator(" File Name Should be less than 250 characters", 0, 250, true));
...
//                fileNameLb.addStyleName("mandatory");
        ...
        newNote.addValidator(new StringLengthValidator(" New Note Should be less than 1000 characters", 0, 1000, true));
        ...
        // public void buttonClick(Button.ClickEvent event) {
        // if (tableBeanId == null) {
        // CommonUIUtils.getMessageNotification("Please select a File to Download");
        // }
        // }
        // });
        ...
        table.addItemClickListener(new ItemClickEvent.ItemClickListener() {
            ...
            public void itemClick(ItemClickEvent event) {
                try {
                    ...
                    LOGGER.error("Error while clicking the Item :" + e.getMessage());
                }
            }
        });
    ...
    private void createExportDocs() {
        ...
        if (wordFile.exists() != true) {
            try {
                ...
                LOGGER.error("Error in Creating new Word File :" + ex.getMessage());
            }
        }
        if (pdfFile.exists() != true) {
            try {
                ...
                LOGGER.error("Error in Creating new PDF File :" + ex.getMessage());
            }
        }
    ...
    public void addResponsiveVerticalTabFiveLayout(final ExtFilterTable table) {
        ...
        Page.getCurrent().addBrowserWindowResizeListener(new Page.BrowserWindowResizeListener() {
            ...
            public void browserWindowResized(final Page.BrowserWindowResizeEvent event) {
                ...
                if (browserWidth > 480 && reloadVerticalLayoutTabFiveMap.get(480)) {
                    reloadVerticalLayoutTabFiveMap.put(480, false);
                    reloadVerticalLayoutTabFiveMap.put(380, true);
                    reloadVerticalLayoutTabFiveMap.put(0, true);
                    table.setWidth("500px");
                    getCollapsibleColumnsDefault(table, 3);
                    ...
                    getCollapsibleColumnsDefault(table, 2);
