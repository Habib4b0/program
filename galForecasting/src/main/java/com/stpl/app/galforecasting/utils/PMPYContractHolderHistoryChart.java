...
public class PMPYContractHolderHistoryChart {
    ...
    public PMPYContractHolderHistoryChart(final List<PMPYRowDto> dto, final String contractName, List<Object> headeres) {
        LOGGER.info("Entering PMPYContractHolderHistoryChart method ");

        this.contractName = contractName;
        this.dto = dto;
        this.headeres = headeres;
        LOGGER.info("End of PMPYContractHolderHistoryChart method ");
    ...
    public Component getCharts() {
        ...
        ListSeries listSeries = new ListSeries(contractName);
        if (dto != null && !dto.isEmpty()) {
            ...
            String temp[] = new String[headeres.size()];
            for (Object key : headeres) {
        ...
        ListSeries listSeries1 = new ListSeries(contractName);
        if (dto != null && !dto.isEmpty()) {
            ...
            for (String key : values1.keySet()) {
                if (!key.equals("type")) {
                    listSeries1.addData(Double.valueOf(values1.get(key)));
                }
        ...
        ListSeries listSeries2 = new ListSeries(contractName);
        if (dto != null && !dto.isEmpty()) {
            final PMPYRowDto pDto = dto.get(2);
