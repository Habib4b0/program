...
/**
 * Provides the local service interface for IvldCompanyTradeClass. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldCompanyTradeClassLocalServiceUtil
...
public interface IvldCompanyTradeClassLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldCompanyTradeClassLocalServiceUtil} to access the ivld company trade class local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.IvldCompanyTradeClassLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
