 ...
 * @see com.stpl.app.service.persistence.impl.IvldItemHierarchyPersistenceImpl
 * @generated
 */
@ProviderType
public class IvldItemHierarchyUtil {
	...
	*/
	public static void cacheResult(IvldItemHierarchy ivldItemHierarchy) {
	...
	*/
	public static void cacheResult(List<IvldItemHierarchy> ivldItemHierarchies) {
	...
	*/
	public static IvldItemHierarchy create(int ivldItemHierarchySid) {
	...
	*/
	public static IvldItemHierarchy remove(int ivldItemHierarchySid)
		throws com.stpl.app.exception.NoSuchIvldItemHierarchyException {
		return getPersistence().remove(ivldItemHierarchySid);
	}

	public static IvldItemHierarchy updateImpl(
	...
	* @throws NoSuchIvldItemHierarchyException if a ivld item hierarchy with the primary key could not be found
	*/
	public static IvldItemHierarchy findByPrimaryKey(int ivldItemHierarchySid)
		throws com.stpl.app.exception.NoSuchIvldItemHierarchyException {
	...
	*/
	public static IvldItemHierarchy fetchByPrimaryKey(int ivldItemHierarchySid) {
		return getPersistence().fetchByPrimaryKey(ivldItemHierarchySid);
	}

	public static java.util.Map<java.io.Serializable, IvldItemHierarchy> fetchByPrimaryKeys(
	...
	*/
	public static List<IvldItemHierarchy> findAll() {
	...
	*/
	public static List<IvldItemHierarchy> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IvldItemHierarchyPersistence, IvldItemHierarchyPersistence> _serviceTracker =
		ServiceTrackerFactory.open(IvldItemHierarchyPersistence.class);
}