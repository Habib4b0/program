...
public class PMPYCalculator extends Window {
    ...
    private Panel addTradingPartnerInformation() {
        LOGGER.info("Entering addTradingPartnerInformation method");
        final VerticalLayout vLayout = new VerticalLayout();
        final GridLayout gridLayout = new GridLayout(6, 1);
        final Panel panel = new Panel();
        ...
        LOGGER.info("End of addTradingPartnerInformation method");
    ...
    private Panel addSelectionCriteria() {
        ...
        final Panel panel = new Panel();
        gridLayout.setStyleName("adjust-label");
        LOGGER.info("Entering addSelectionCriteria method");
        gridLayout.setSpacing(true);
        gridLayout.setMargin(false);
        ...
        LOGGER.info("End of addSelectionCriteria method");
    ...
    private Component addButton() {
        ...
        LOGGER.info("Entering addButton method");
        ...
        LOGGER.info("End of addButton method");
    ...
    public Button resetButton() {
        ...
        LOGGER.info("End of resetButton method");
    ...
    private Panel getCustomerHistory() {
        ...
        LOGGER.info("Entering getCustomerHistory method");
        content.setSpacing(true);
        ...
        panel.setSizeFull();
        panel.setWidth("100%");
        LOGGER.info("End of getCustomerHistory method");
    ...
    private GridLayout getResultLayout() {
        final GridLayout content = new GridLayout(3, 1);
        final VerticalLayout verticalContent = new VerticalLayout();
        content.setSpacing(true);
        LOGGER.info("Entering getResultLayout method");
        ...
        LOGGER.info("End of getResultLayout method");
    ...
    private Panel getCalculatorPanel() {
        ...
        LOGGER.info("Entering getCalculatorPanel method");
        panel.setCaption("Calculator");
        panel.setContent(getCalculator());

        LOGGER.info("End of getCalculatorPanel method");
    ...
    public Button getCloseButton() {
        LOGGER.info("Entering getCloseButton method");
        ...
        LOGGER.info("End of getCloseButton method");
        return btnRemove;
    }
    ...
    private HorizontalLayout addChExportButtons() {
        ...
        LOGGER.info("Entering of addChExportButtons method");
        ...
        LOGGER.info("End of addChExportButtons method");
    ...
    private HorizontalLayout addTpExportButtons() {
        ...
        LOGGER.info("Entering of addTpExportButtons method");
        exportButtons.addComponentAsFirst(space);
        exportButtons.setSpacing(true);
        exportButtons.addComponent(totalLivesChartTp);
        exportButtons.addComponent(excelExportTp);
        LOGGER.info("End of addTpExportButtons method");
    ...
    public SalesProjectionResultsDTO getBeanFromId(final Object identifier) {
        ...
        LOGGER.info("Entering of getBeanFromId method");
    ...
    public void configureAttributes() {
        ...
        contractHolderTable.setWidth(900, UNITS_PIXELS);
        tradingHistoryTable.setWidth(900, UNITS_PIXELS);
        ...
        for (Object obj : visiColumn) {
            ...
            contractHolderTable.getRightFreezeAsTable().setColumnWidth(obj, 130);
            tradingHistoryTable.getRightFreezeAsTable().setColumnWidth(obj, 130);
        }
