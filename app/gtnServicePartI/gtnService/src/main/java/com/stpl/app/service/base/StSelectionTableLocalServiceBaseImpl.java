...
import com.stpl.app.service.StSelectionTableLocalService;
...
/**
 * Provides the base implementation for the st selection table local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.StSelectionTableLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.StSelectionTableLocalServiceImpl
 * @see com.stpl.app.service.StSelectionTableLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StSelectionTableLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StSelectionTableLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.StSelectionTableLocalServiceUtil} to access the st selection table local service.
	 */
	...
	public StSelectionTable addStSelectionTable(
		...
		return stSelectionTablePersistence.update(stSelectionTable);
	}
	...
	public StSelectionTable createStSelectionTable(
		...
		return stSelectionTablePersistence.create(stSelectionTablePK);
	}
	...
	public StSelectionTable deleteStSelectionTable(
		...
		return stSelectionTablePersistence.remove(stSelectionTablePK);
	}
	...
	public StSelectionTable deleteStSelectionTable(
		StSelectionTable stSelectionTable) {
		return stSelectionTablePersistence.remove(stSelectionTable);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StSelectionTable.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stSelectionTablePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stSelectionTablePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public StSelectionTable fetchStSelectionTable(
		StSelectionTablePK stSelectionTablePK) {
		return stSelectionTablePersistence.fetchByPrimaryKey(stSelectionTablePK);
	}
	...
	public StSelectionTable getStSelectionTable(
		StSelectionTablePK stSelectionTablePK) throws PortalException {
		return stSelectionTablePersistence.findByPrimaryKey(stSelectionTablePK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stSelectionTableLocalService.deleteStSelectionTable((StSelectionTable)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stSelectionTablePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<StSelectionTable> getStSelectionTables(int start, int end) {
		return stSelectionTablePersistence.findAll(start, end);
	}
	...
	public int getStSelectionTablesCount() {
		return stSelectionTablePersistence.countAll();
	}
	 ...
	 */
	public StSelectionTableLocalService getStSelectionTableLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.StSelectionTable",
			stSelectionTableLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StSelectionTableLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stSelectionTablePersistence.getDataSource();
	...
	@BeanReference(type = StSelectionTableLocalService.class)
	protected StSelectionTableLocalService stSelectionTableLocalService;
