...
import com.stpl.app.service.FederalNewNdcLocalService;
...
/**
 * Provides the base implementation for the federal new ndc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.FederalNewNdcLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.FederalNewNdcLocalServiceImpl
 * @see com.stpl.app.service.FederalNewNdcLocalServiceUtil
 * @generated
 */
public abstract class FederalNewNdcLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements FederalNewNdcLocalService,
        IdentifiableBean {
    ...
    private FederalNewNdcLocalServiceClpInvoker _clpInvoker = new FederalNewNdcLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.FederalNewNdcLocalServiceUtil} to access the federal new ndc local service.
     */
    ...
    @Override
    public FederalNewNdc addFederalNewNdc(FederalNewNdc federalNewNdc)
        throws SystemException {
        federalNewNdc.setNew(true);

        return federalNewNdcPersistence.update(federalNewNdc);
    }
     ...
     */
    @Override
    public FederalNewNdc createFederalNewNdc(int itemMasterSid) {
        return federalNewNdcPersistence.create(itemMasterSid);
    }
    ...
    @Override
    public FederalNewNdc deleteFederalNewNdc(int itemMasterSid)
        throws PortalException, SystemException {
        return federalNewNdcPersistence.remove(itemMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public FederalNewNdc deleteFederalNewNdc(FederalNewNdc federalNewNdc)
        throws SystemException {
        return federalNewNdcPersistence.remove(federalNewNdc);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(FederalNewNdc.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return federalNewNdcPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return federalNewNdcPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public FederalNewNdc fetchFederalNewNdc(int itemMasterSid)
        throws SystemException {
        return federalNewNdcPersistence.fetchByPrimaryKey(itemMasterSid);
    }
     ...
     */
    @Override
    public FederalNewNdc getFederalNewNdc(int itemMasterSid)
        throws PortalException, SystemException {
        return federalNewNdcPersistence.findByPrimaryKey(itemMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return federalNewNdcPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<FederalNewNdc> getFederalNewNdcs(int start, int end)
        throws SystemException {
        return federalNewNdcPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getFederalNewNdcsCount() throws SystemException {
        return federalNewNdcPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public FederalNewNdc updateFederalNewNdc(FederalNewNdc federalNewNdc)
        throws SystemException {
        return federalNewNdcPersistence.update(federalNewNdc);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.FederalNewNdc",
            federalNewNdcLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.FederalNewNdc");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = federalNewNdcPersistence.getDataSource();
