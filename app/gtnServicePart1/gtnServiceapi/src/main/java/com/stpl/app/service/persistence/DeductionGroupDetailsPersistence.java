...
public interface DeductionGroupDetailsPersistence extends BasePersistence<DeductionGroupDetails> {
	...
	*/
	public void cacheResult(
		java.util.List<DeductionGroupDetails> deductionGroupDetailses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, DeductionGroupDetails> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<DeductionGroupDetails> findAll();
	...
	*/
	public java.util.List<DeductionGroupDetails> findAll(int start, int end);
	...
	*/
	public java.util.List<DeductionGroupDetails> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<DeductionGroupDetails> orderByComparator);
