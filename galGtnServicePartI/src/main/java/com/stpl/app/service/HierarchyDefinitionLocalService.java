...
/**
 * Provides the local service interface for HierarchyDefinition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see HierarchyDefinitionLocalServiceUtil
...
public interface HierarchyDefinitionLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link HierarchyDefinitionLocalServiceUtil} to access the hierarchy definition local service. Add custom service methods to {@link com.stpl.app.service.impl.HierarchyDefinitionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
