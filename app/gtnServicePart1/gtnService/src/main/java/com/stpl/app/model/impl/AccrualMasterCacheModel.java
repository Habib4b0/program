...
public class AccrualMasterCacheModel implements CacheModel<AccrualMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AccrualMasterCacheModel)) {
			return false;
		}

		AccrualMasterCacheModel accrualMasterCacheModel = (AccrualMasterCacheModel)obj;

		if (accrualMasterSid == accrualMasterCacheModel.accrualMasterSid) {
			return true;
		}
	...
	public AccrualMaster toEntityModel() {
		...
		if (companyStringId == null) {
			accrualMasterImpl.setCompanyStringId(StringPool.BLANK);
		}
		else {
			accrualMasterImpl.setCompanyStringId(companyStringId);
		}
