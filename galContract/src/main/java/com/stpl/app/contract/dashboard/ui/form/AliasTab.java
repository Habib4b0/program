...
public final class AliasTab extends CustomComponent implements View {
     ...
     */
    public AliasTab(final CustomFieldGroup systemBinder, final BeanItemContainer<ContractAliasMasterDTO> aliasResultsBean, final boolean isEditable) throws SystemException, PortalException, Exception {
        super();
        ...
        LOGGER.info("Entering AliasTab");
        init();
        LOGGER.info("End of AliasTab");
    }
    ...
    private void addToTable() {
        ...
        try {
            ...
            LOGGER.info("End of addToTable method");
    ...
    private void configureFields() throws SystemException, Exception {
        ...
        contractAliasNo.addValidator(new StringLengthValidator("Contract Alias No should be less than 38 characters", 0, 38, true));
        ...
        contractAliasName.addValidator(new StringLengthValidator("Contract Alias Name length should be less than 50 characters", 0, 50, true));
        ...
        tradingName.addValidator(new StringLengthValidator("Trading Partner Name should be less than 100 characters", 0, 100, true));
    ...
    public void createWorkSheetContent(final Integer start, final Integer end, final PrintWriter printWriter) throws SystemException, PortalException, Exception {
        ...
        for (int rowCount = 0; rowCount < searchList.size(); rowCount++) {
            ...
            String type = dto.getContractAliasType() != null ? ((HelperDTO) (dto.getContractAliasType())).getDescription() : StringUtils.EMPTY;
    ...
    public void populateButton() {
        ...
        btnAdd.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                try {
                    LOGGER.info("Entering btnPopulaooote buttonClick method ");
        ...
        LOGGER.info("End of populateButton method");
    }
    ...
    public Button removeButton() {
        ...
        btnRemove.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                if (table.getValue() != null) {
                    ...
                    ContractAliasMasterDTO aliasList = (ContractAliasMasterDTO) table.getValue();
        ...
        LOGGER.info("End of removeButton method");
        return btnRemove;
    }
