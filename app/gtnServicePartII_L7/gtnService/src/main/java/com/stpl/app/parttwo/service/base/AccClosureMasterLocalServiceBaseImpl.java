...
import com.stpl.app.parttwo.service.AccClosureMasterLocalService;
...
/**
 * Provides the base implementation for the acc closure master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.AccClosureMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class AccClosureMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccClosureMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.AccClosureMasterLocalServiceUtil} to access the acc closure master local service.
	 */
	...
	@Override
	public AccClosureMaster addAccClosureMaster(
		AccClosureMaster accClosureMaster) {
		accClosureMaster.setNew(true);

		return accClosureMasterPersistence.update(accClosureMaster);
	}
	 ...
	 */
	@Override
	public AccClosureMaster createAccClosureMaster(int accClosureMasterSid) {
		return accClosureMasterPersistence.create(accClosureMasterSid);
	}
	...
	@Override
	public AccClosureMaster deleteAccClosureMaster(int accClosureMasterSid)
		throws PortalException {
		return accClosureMasterPersistence.remove(accClosureMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AccClosureMaster deleteAccClosureMaster(
		AccClosureMaster accClosureMaster) {
		return accClosureMasterPersistence.remove(accClosureMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccClosureMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accClosureMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accClosureMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AccClosureMaster fetchAccClosureMaster(int accClosureMasterSid) {
		return accClosureMasterPersistence.fetchByPrimaryKey(accClosureMasterSid);
	}
	 ...
	 */
	@Override
	public AccClosureMaster getAccClosureMaster(int accClosureMasterSid)
		throws PortalException {
		return accClosureMasterPersistence.findByPrimaryKey(accClosureMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accClosureMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccClosureMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accClosureMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccClosureMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accClosureMasterLocalService.deleteAccClosureMaster((AccClosureMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return accClosureMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AccClosureMaster> getAccClosureMasters(int start, int end) {
		return accClosureMasterPersistence.findAll(start, end);
	}
	...
	public int getAccClosureMastersCount() {
		return accClosureMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AccClosureMaster updateAccClosureMaster(
		AccClosureMaster accClosureMaster) {
		return accClosureMasterPersistence.update(accClosureMaster);
	}
	 ...
	 */
	public AccClosureMasterLocalService getAccClosureMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.AccClosureMaster",
			accClosureMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccClosureMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accClosureMasterPersistence.getDataSource();
	...
	@BeanReference(type = AccClosureMasterLocalService.class)
	protected AccClosureMasterLocalService accClosureMasterLocalService;
