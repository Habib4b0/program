...
import com.stpl.app.service.TransactionModuleMasterLocalService;
...
/**
 * Provides the base implementation for the transaction module master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.TransactionModuleMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.TransactionModuleMasterLocalServiceImpl
 * @see com.stpl.app.service.TransactionModuleMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class TransactionModuleMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TransactionModuleMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.TransactionModuleMasterLocalServiceUtil} to access the transaction module master local service.
	 */
	...
	@Override
	public TransactionModuleMaster addTransactionModuleMaster(
		TransactionModuleMaster transactionModuleMaster) {
		transactionModuleMaster.setNew(true);

		return transactionModuleMasterPersistence.update(transactionModuleMaster);
	}
	 ...
	 */
	@Override
	public TransactionModuleMaster createTransactionModuleMaster(
		int transactionModuleMasterSid) {
		return transactionModuleMasterPersistence.create(transactionModuleMasterSid);
	}
	...
	@Override
	public TransactionModuleMaster deleteTransactionModuleMaster(
		int transactionModuleMasterSid) throws PortalException {
		return transactionModuleMasterPersistence.remove(transactionModuleMasterSid);
	}
	...
	public TransactionModuleMaster deleteTransactionModuleMaster(
		TransactionModuleMaster transactionModuleMaster) {
		return transactionModuleMasterPersistence.remove(transactionModuleMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TransactionModuleMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return transactionModuleMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return transactionModuleMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TransactionModuleMaster fetchTransactionModuleMaster(
		int transactionModuleMasterSid) {
		return transactionModuleMasterPersistence.fetchByPrimaryKey(transactionModuleMasterSid);
	}
	 ...
	 */
	@Override
	public TransactionModuleMaster getTransactionModuleMaster(
		int transactionModuleMasterSid) throws PortalException {
		return transactionModuleMasterPersistence.findByPrimaryKey(transactionModuleMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(transactionModuleMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TransactionModuleMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(transactionModuleMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(TransactionModuleMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return transactionModuleMasterLocalService.deleteTransactionModuleMaster((TransactionModuleMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return transactionModuleMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TransactionModuleMaster> getTransactionModuleMasters(
		int start, int end) {
		return transactionModuleMasterPersistence.findAll(start, end);
	}
	...
	public int getTransactionModuleMastersCount() {
		return transactionModuleMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TransactionModuleMaster updateTransactionModuleMaster(
		TransactionModuleMaster transactionModuleMaster) {
		return transactionModuleMasterPersistence.update(transactionModuleMaster);
	}
	 ...
	 */
	public TransactionModuleMasterLocalService getTransactionModuleMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.TransactionModuleMaster",
			transactionModuleMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.TransactionModuleMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return TransactionModuleMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = transactionModuleMasterPersistence.getDataSource();
	...
	@BeanReference(type = TransactionModuleMasterLocalService.class)
	protected TransactionModuleMasterLocalService transactionModuleMasterLocalService;
