...
IF NOT  EXISTS (
		...
		FROM INFORMATION_SCHEMA.COLUMNS
		WHERE TABLE_NAME = 'HIERARCHY_RESTRICTION_MASTER'
			AND COLUMN_NAME = 'JOIN_SEQUENCE'
			AND TABLE_SCHEMA = 'DBO'
		)
BEGIN
	ALTER TABLE HIERARCHY_RESTRICTION_MASTER ADD  JOIN_SEQUENCE INT
END
GO
...
BEGIN
	ALTER TABLE HIERARCHY_RESTRICTION_MASTER ADD OPERATOR_TYPE VARCHAR(100)
END
GO
...
BEGIN
	ALTER TABLE [DBO].HIERARCHY_RESTRICTION_MASTER

	DROP CONSTRAINT PK_HIERARCHY_RESTRICTION_MASTER_HIERARCHY_TABLE_MASTER_SID
END
GO
...
IF EXISTS (
		...
		FROM INFORMATION_SCHEMA.COLUMNS
		WHERE TABLE_NAME = 'HIERARCHY_RESTRICTION_MASTER'
			AND COLUMN_NAME = 'REFERENCE_COLUMN_NAME'
			AND TABLE_SCHEMA = 'DBO'
		)
BEGIN
	ALTER TABLE HIERARCHY_RESTRICTION_MASTER

	ALTER COLUMN REFERENCE_COLUMN_NAME VARCHAR(100) NULL
END
GO
...
IF EXISTS (
		...
		FROM INFORMATION_SCHEMA.COLUMNS
		WHERE TABLE_NAME = 'HIERARCHY_RESTRICTION_MASTER'
			AND COLUMN_NAME = 'RESTRICTION_COLUMN_NAME'
			AND TABLE_SCHEMA = 'DBO'
		)
BEGIN
	ALTER TABLE HIERARCHY_RESTRICTION_MASTER

	ALTER COLUMN RESTRICTION_COLUMN_NAME VARCHAR(100) NULL
END
GO
...
IF EXISTS (
		...
		FROM INFORMATION_SCHEMA.COLUMNS
		WHERE TABLE_NAME = 'HIERARCHY_RESTRICTION_MASTER'
			AND COLUMN_NAME = 'RESTRICTION_VALUE'
			AND TABLE_SCHEMA = 'DBO'
		)
BEGIN
	ALTER TABLE HIERARCHY_RESTRICTION_MASTER

	ALTER COLUMN RESTRICTION_VALUE VARCHAR(100) NULL
END
GO
...
BEGIN
	ALTER TABLE HIERARCHY_TABLE_MASTER ADD VALUE VARCHAR(100)
END
GO
...
BEGIN
	ALTER TABLE HIERARCHY_TABLE_MASTER ADD PRIMARY_KEY_COLUMN VARCHAR(500)
END
GO
