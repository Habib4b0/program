...
//            LOGGER.debug("Final sql statement----------->" + sql);
    ...
    public List getItemGroupDetails(String itemType, String itemDesc, String brand, String strength, String itemNoCriteria, String therapeuticCriteria, String formCriteria,String selectedItemIds) {
        Session session = null;
        try {
            session = openSession();
...
//				String zip = String.valueOf(formCriteria);
            ...
            sql+=" and IM.item_Master_Sid not in (" + selectedItemIds+ ")";
            }
            LOGGER.debug("Sql Queryyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy++++++++++:::::::"+sql);
