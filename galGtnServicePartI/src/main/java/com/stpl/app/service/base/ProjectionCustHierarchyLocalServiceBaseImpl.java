...
public abstract class ProjectionCustHierarchyLocalServiceBaseImpl
    ...
    private ProjectionCustHierarchyLocalServiceClpInvoker _clpInvoker = new ProjectionCustHierarchyLocalServiceClpInvoker();
    ...
    public ProjectionCustHierarchy deleteProjectionCustHierarchy(
        int projectionCustHierarchySid) throws PortalException, SystemException {
     ...
     */
    @Override
    public int getProjectionCustHierarchiesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ProjectionCustHierarchy",
