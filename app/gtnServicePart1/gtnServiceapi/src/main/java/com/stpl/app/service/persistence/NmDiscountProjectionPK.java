 ...
 */
@ProviderType
public class NmDiscountProjectionPK implements Comparable<NmDiscountProjectionPK>,
	Serializable {
	public int periodSid;
	public int projectionDetailsSid;

	public NmDiscountProjectionPK() {
	}

	public NmDiscountProjectionPK(int periodSid, int projectionDetailsSid) {
	...
	@Override
	public int compareTo(NmDiscountProjectionPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof NmDiscountProjectionPK)) {
			return false;
		}

		NmDiscountProjectionPK pk = (NmDiscountProjectionPK)obj;
