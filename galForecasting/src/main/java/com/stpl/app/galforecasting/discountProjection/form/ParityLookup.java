...
public class ParityLookup extends Window {
    ...
    public ParityLookup(CustomTextField parity, SessionDTO sessionDto, boolean populateFlag) {
        ...
        center();
        setModal(true);
        setWidth(59f, Sizeable.Unit.PERCENTAGE);
        setHeight(35f, Sizeable.Unit.PERCENTAGE);
        init();
        LOGGER.info("ParityLookup constructor ends");   
    }
	 ...
	 */
	public void init() {
		LOGGER.info("ParityLookup init method started");
                setContent(Clara.create(getClass().getResourceAsStream("/mandated/ParityLookup.xml"), this));
		configureFields();
                contractDdlb.focus();
		LOGGER.info("ParityLookup init method ends");
	}
    ...
    private void configureFields() {
        ...
        ndc.addValidator(new StringLengthValidator(
                "Ndc# should be less than 50 characters", 0, 50, true));
        ...
        ndcDesc.addValidator(new StringLengthValidator(
                "Brand Name should be less than 100 characters", 0, 100, true));
        ...
        ndc.addValidator(new StringLengthValidator(
                "Brand Name should be less than 50 characters", 0, 50, true));
	...
	public void searchBtn(Button.ClickEvent event) {    
                ...
                List<Object> parityList = sdpLogic.loadParityLookup(sessionDto,lookUpDTO,false);
                    ...
                    for (Object list1 : parityList) {
                        ...
                        parityDto.setContractName(String.valueOf(obj[2]==null?StringUtils.EMPTY:obj[2]));
                        parityDto.setBrandName(String.valueOf(obj[3]==null?StringUtils.EMPTY:obj[3]));
                        parityDto.setItemNo(String.valueOf(obj[4]==null?StringUtils.EMPTY:obj[4]));
                        parityDto.setItemDesc(String.valueOf(obj[5]==null?StringUtils.EMPTY:obj[5]));
       ...
       boolean validateFields() {
        StringLengthValidator sd = new StringLengthValidator("Brand Name Should be less than 50 characters", 0, 50, true);
        StringLengthValidator sd2 = new StringLengthValidator("NDC DESC Should be less than 100 characters", 0, 100, true);
                ...
                public void yesMethod() {
                    ...
                    if (populateFlag) {
                     ...
                     // Gets the current date and time
                        ...
                        processParity(year, period, dtoList);
                    }
