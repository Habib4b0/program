...
public class AuditMasterInboundCacheModel implements CacheModel<AuditMasterInbound>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AuditMasterInboundCacheModel)) {
			return false;
		}

		AuditMasterInboundCacheModel auditMasterInboundCacheModel = (AuditMasterInboundCacheModel)obj;

		if (auditInboundSid == auditMasterInboundCacheModel.auditInboundSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, auditInboundSid);
	}
