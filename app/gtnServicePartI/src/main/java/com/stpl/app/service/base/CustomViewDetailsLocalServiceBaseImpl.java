...
import com.stpl.app.service.CustomViewDetailsLocalService;
...
/**
 * Provides the base implementation for the custom view details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CustomViewDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.CustomViewDetailsLocalServiceImpl
 * @see com.stpl.app.service.CustomViewDetailsLocalServiceUtil
 * @generated
 */
public abstract class CustomViewDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements CustomViewDetailsLocalService,
        IdentifiableBean {
    ...
    private CustomViewDetailsLocalServiceClpInvoker _clpInvoker = new CustomViewDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CustomViewDetailsLocalServiceUtil} to access the custom view details local service.
     */
    ...
    @Override
    public CustomViewDetails addCustomViewDetails(
        CustomViewDetails customViewDetails) throws SystemException {
        customViewDetails.setNew(true);

        return customViewDetailsPersistence.update(customViewDetails);
    }
     ...
     */
    @Override
    public CustomViewDetails createCustomViewDetails(int customViewDetailsSid) {
        return customViewDetailsPersistence.create(customViewDetailsSid);
    }
    ...
    @Override
    public CustomViewDetails deleteCustomViewDetails(int customViewDetailsSid)
        throws PortalException, SystemException {
        return customViewDetailsPersistence.remove(customViewDetailsSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public CustomViewDetails deleteCustomViewDetails(
        CustomViewDetails customViewDetails) throws SystemException {
        return customViewDetailsPersistence.remove(customViewDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CustomViewDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return customViewDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return customViewDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public CustomViewDetails fetchCustomViewDetails(int customViewDetailsSid)
        throws SystemException {
        return customViewDetailsPersistence.fetchByPrimaryKey(customViewDetailsSid);
    }
     ...
     */
    @Override
    public CustomViewDetails getCustomViewDetails(int customViewDetailsSid)
        throws PortalException, SystemException {
        return customViewDetailsPersistence.findByPrimaryKey(customViewDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return customViewDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<CustomViewDetails> getCustomViewDetailses(int start, int end)
        throws SystemException {
        return customViewDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCustomViewDetailsesCount() throws SystemException {
        return customViewDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public CustomViewDetails updateCustomViewDetails(
        CustomViewDetails customViewDetails) throws SystemException {
        return customViewDetailsPersistence.update(customViewDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.CustomViewDetails",
            customViewDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.CustomViewDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = customViewDetailsPersistence.getDataSource();
