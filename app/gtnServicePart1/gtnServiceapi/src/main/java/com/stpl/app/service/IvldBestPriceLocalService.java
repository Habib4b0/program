...
/**
 * Provides the local service interface for IvldBestPrice. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldBestPriceLocalServiceUtil
...
public interface IvldBestPriceLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldBestPriceLocalServiceUtil} to access the ivld best price local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldBestPriceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
