...
import com.stpl.app.service.RebatePlanTierLocalService;
...
/**
 * Provides the base implementation for the rebate plan tier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.RebatePlanTierLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.RebatePlanTierLocalServiceImpl
 * @see com.stpl.app.service.RebatePlanTierLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class RebatePlanTierLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RebatePlanTierLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.RebatePlanTierLocalServiceUtil} to access the rebate plan tier local service.
	 */
	...
	@Override
	public RebatePlanTier addRebatePlanTier(RebatePlanTier rebatePlanTier) {
		rebatePlanTier.setNew(true);

		return rebatePlanTierPersistence.update(rebatePlanTier);
	}
	 ...
	 */
	@Override
	public RebatePlanTier createRebatePlanTier(int rebatePlanTierSid) {
		return rebatePlanTierPersistence.create(rebatePlanTierSid);
	}
	...
	@Override
	public RebatePlanTier deleteRebatePlanTier(int rebatePlanTierSid)
		throws PortalException {
		return rebatePlanTierPersistence.remove(rebatePlanTierSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RebatePlanTier deleteRebatePlanTier(RebatePlanTier rebatePlanTier) {
		return rebatePlanTierPersistence.remove(rebatePlanTier);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RebatePlanTier.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return rebatePlanTierPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return rebatePlanTierPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RebatePlanTier fetchRebatePlanTier(int rebatePlanTierSid) {
		return rebatePlanTierPersistence.fetchByPrimaryKey(rebatePlanTierSid);
	}
	 ...
	 */
	@Override
	public RebatePlanTier getRebatePlanTier(int rebatePlanTierSid)
		throws PortalException {
		return rebatePlanTierPersistence.findByPrimaryKey(rebatePlanTierSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(rebatePlanTierLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RebatePlanTier.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("rebatePlanTierSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(rebatePlanTierLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RebatePlanTier.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return rebatePlanTierLocalService.deleteRebatePlanTier((RebatePlanTier)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return rebatePlanTierPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RebatePlanTier> getRebatePlanTiers(int start, int end) {
		return rebatePlanTierPersistence.findAll(start, end);
	}
	...
	public int getRebatePlanTiersCount() {
		return rebatePlanTierPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RebatePlanTier updateRebatePlanTier(RebatePlanTier rebatePlanTier) {
		return rebatePlanTierPersistence.update(rebatePlanTier);
	}
	 ...
	 */
	public RebatePlanTierLocalService getRebatePlanTierLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.RebatePlanTier",
			rebatePlanTierLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.RebatePlanTier");
	}
	...
	public String getOSGiServiceIdentifier() {
		return RebatePlanTierLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rebatePlanTierPersistence.getDataSource();
	...
	@BeanReference(type = RebatePlanTierLocalService.class)
	protected RebatePlanTierLocalService rebatePlanTierLocalService;
