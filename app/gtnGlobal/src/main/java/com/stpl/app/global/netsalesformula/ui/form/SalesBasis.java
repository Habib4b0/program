...
public class SalesBasis extends CustomComponent {
    ...
    /**
     * To initialize and configure the fields in Sales Basis.
     */
    private void init() {
        try {
            configureFields();
    ...
    /**
     * To Configure the fields in Sales Basis.
     * @throws Exception 
     */
    private void configureFields() {
        ...
        availableContractsTable.setWidth(NumericConstants.HUNDRED, UNITS_PERCENTAGE);
        ...
        customerTableLogic.setPageLength(NumericConstants.TEN);
        ...
        availableCustomersTable.setWidth(NumericConstants.HUNDRED, UNITS_PERCENTAGE);
        ...
        availableCustomersTable.setFilterBarVisible(true);
        availableCustomersTable.setPageLength(NumericConstants.FIVE);
        ...
        selectedCusTableLogic.setPageLength(NumericConstants.TEN);
        selectedCusTableLogic.sinkItemPerPageWithPageLength(false);

        selectedCustomersTable.setFilterBarVisible(true);
        selectedCustomersTable.setPageLength(NumericConstants.FIVE);
                ...
                public void columnCheck(ExtCustomTable.ColumnCheckEvent event) {
                    if (ConstantsUtils.AVAILABLE_CHECK.equals(event.getPropertyId().toString())) {
                        if (event.isChecked()) {
                            ...
                            logic.checkAllSalesBasisTempTable(Boolean.TRUE, sessiondto.getUiSessionId());
                            ...
                            logic.checkAllSalesBasisTempTable(Boolean.FALSE, sessiondto.getUiSessionId());
                            selectedCustomers.removeAllItems();
                            loadSelectedTable();
                            // this setCurrentPage is used to refresh the lazy conatiner
                            selectedCustomersTable.setCurrentPage(selectedCustomersTable.getCurrentPage());
    ...
    public void addBtnLogic(Button.ClickEvent event) {
        ...
        LOGGER.debug("Entering add available Customers Logic");
            ...
            return;
                     ...
                     try {  
                         ...
                         for (SalesBasisDto item : availableList) {
                             if (item != null && logic.addDuplicateValidation(item, sessiondto)) {
                    ...
                    LOGGER.debug("Ending add available Customers Logic");
    ...
    void loadAvailableCustomersTable(String contractMasterSid) {
        ...
        availableCustomersTable.setFilterGenerator(new NsfFilterGenerator());
        availableCustomersTable.setImmediate(true);
        availableCustomersTable.setWidth(NumericConstants.NINTY_NINE, UNITS_PERCENTAGE);
    ...
    public void loadSearchResults(){
          try {
            ...
            availableContractsTable.setFilterGenerator(new NsfFilterGenerator());
            availableContractsTable.setImmediate(true);
            availableContractsTable.setWidth(NumericConstants.NINTY_NINE, UNITS_PERCENTAGE);
