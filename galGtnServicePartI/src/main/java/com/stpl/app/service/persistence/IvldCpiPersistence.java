...
public interface IvldCpiPersistence extends BasePersistence<IvldCpi> {
    ...
    */
    public void cacheResult(com.stpl.app.model.IvldCpi ivldCpi);
    ...
    */
    public void cacheResult(java.util.List<com.stpl.app.model.IvldCpi> ivldCpis);
    ...
    */
    public com.stpl.app.model.IvldCpi create(int ivldCpiSid);
    ...
    */
    public com.stpl.app.model.IvldCpi remove(int ivldCpiSid)
        throws com.stpl.app.NoSuchIvldCpiException,
            com.stpl.portal.kernel.exception.SystemException;

    public com.stpl.app.model.IvldCpi updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public com.stpl.app.model.IvldCpi findByPrimaryKey(int ivldCpiSid)
        throws com.stpl.app.NoSuchIvldCpiException,
            com.stpl.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public com.stpl.app.model.IvldCpi fetchByPrimaryKey(int ivldCpiSid)
        throws com.stpl.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<com.stpl.app.model.IvldCpi> findAll()
        throws com.stpl.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<com.stpl.app.model.IvldCpi> findAll(int start, int end)
        throws com.stpl.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<com.stpl.app.model.IvldCpi> findAll(int start,
