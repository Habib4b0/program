...
/**
 * Provides the local service interface for AhTempDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see AhTempDetailsLocalServiceUtil
 * @see com.stpl.app.parttwo.service.base.AhTempDetailsLocalServiceBaseImpl
...
public interface AhTempDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AhTempDetailsLocalServiceUtil} to access the ah temp details local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.AhTempDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
