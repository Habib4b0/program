...
public class ChAssumptionsLocalServiceUtil {
    private static ChAssumptionsLocalService _service;
    ...
    */
    ...
    public static ChAssumptionsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ChAssumptionsLocalService.class.getName());

            if (invokableLocalService instanceof ChAssumptionsLocalService) {
                _service = (ChAssumptionsLocalService) invokableLocalService;
            } else {
                _service = new ChAssumptionsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ChAssumptionsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ChAssumptionsLocalService service) {
    }
}
