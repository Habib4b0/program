 ...
 * @generated
 */
public class DeductionCalendarDetailsLocalServiceClp
    ...
    public DeductionCalendarDetailsLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addDeductionCalendarDetails";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.DeductionCalendarDetails"
            };

        _methodName1 = "createDeductionCalendarDetails";

        _methodParameterTypes1 = new String[] {
                "com.stpl.app.service.persistence.DeductionCalendarDetailsPK"
            };

        _methodName2 = "deleteDeductionCalendarDetails";

        _methodParameterTypes2 = new String[] {
                "com.stpl.app.service.persistence.DeductionCalendarDetailsPK"
            };

        _methodName3 = "deleteDeductionCalendarDetails";
        ...
        _methodName10 = "fetchDeductionCalendarDetails";

        _methodParameterTypes10 = new String[] {
                "com.stpl.app.service.persistence.DeductionCalendarDetailsPK"
            };

        _methodName11 = "getDeductionCalendarDetails";
        ...
        _methodName13 = "getDeductionCalendarDetailses";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getDeductionCalendarDetailsesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateDeductionCalendarDetails";
    ...
    public com.stpl.app.model.DeductionCalendarDetails addDeductionCalendarDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(deductionCalendarDetails)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.DeductionCalendarDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.DeductionCalendarDetails createDeductionCalendarDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(deductionCalendarDetailsPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.DeductionCalendarDetails> getDeductionCalendarDetailses(
        ...
        return (java.util.List<com.stpl.app.model.DeductionCalendarDetails>) ClpSerializer.translateOutput(returnObj);
    }
