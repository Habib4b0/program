 ...
 * @generated
 */
public class HistRelationshipLevelDefnLocalServiceClp
    ...
    public HistRelationshipLevelDefnLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addHistRelationshipLevelDefn";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.HistRelationshipLevelDefn"
            };

        _methodName1 = "createHistRelationshipLevelDefn";

        _methodParameterTypes1 = new String[] {
                "com.stpl.app.service.persistence.HistRelationshipLevelDefnPK"
            };

        _methodName2 = "deleteHistRelationshipLevelDefn";

        _methodParameterTypes2 = new String[] {
                "com.stpl.app.service.persistence.HistRelationshipLevelDefnPK"
            };

        _methodName3 = "deleteHistRelationshipLevelDefn";
        ...
        _methodName10 = "fetchHistRelationshipLevelDefn";

        _methodParameterTypes10 = new String[] {
                "com.stpl.app.service.persistence.HistRelationshipLevelDefnPK"
            };

        _methodName11 = "getHistRelationshipLevelDefn";
        ...
        _methodName13 = "getHistRelationshipLevelDefns";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getHistRelationshipLevelDefnsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateHistRelationshipLevelDefn";
    ...
    public com.stpl.app.model.HistRelationshipLevelDefn addHistRelationshipLevelDefn(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(histRelationshipLevelDefn)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.HistRelationshipLevelDefn) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.stpl.app.model.HistRelationshipLevelDefn> getHistRelationshipLevelDefns(
        ...
        return (java.util.List<com.stpl.app.model.HistRelationshipLevelDefn>) ClpSerializer.translateOutput(returnObj);
    }
