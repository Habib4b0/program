 ...
 * @generated
 */
public class MasterDataAttributeLocalServiceClp
    ...
    public MasterDataAttributeLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addMasterDataAttribute";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.MasterDataAttribute"
            };

        _methodName1 = "createMasterDataAttribute";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteMasterDataAttribute";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteMasterDataAttribute";
        ...
        _methodName10 = "fetchMasterDataAttribute";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getMasterDataAttribute";
        ...
        _methodName13 = "getMasterDataAttributes";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getMasterDataAttributesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateMasterDataAttribute";
        ...
        _methodName19 = "getTotalLives";

        _methodParameterTypes19 = new String[] { "java.lang.Object[][]" };

        _methodName20 = "getLives";

        _methodParameterTypes20 = new String[] { "java.lang.Object[][]" };
    }
    ...
    public com.stpl.app.model.MasterDataAttribute addMasterDataAttribute(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(masterDataAttribute)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.MasterDataAttribute) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.MasterDataAttribute createMasterDataAttribute(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { masterDataAttributeSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.MasterDataAttribute> getMasterDataAttributes(
        ...
        return (java.util.List<com.stpl.app.model.MasterDataAttribute>) ClpSerializer.translateOutput(returnObj);
    }
