...
public class NetSalesFormulaLookup extends Window{
     ...
     * @throws Exception 
     */
    public NetSalesFormulaLookup(String itemId) throws Exception {
        init();
    }
    
    public NetSalesFormulaLookup(boolean validatePPA, CustomTextField netSalesNoField) throws Exception {
    ...
    private void configureTable() {
        ...
        for (Object propertyId : resultsTable.getVisibleColumns()) {
                resultsTable.setColumnWidth(propertyId, 200);
            }
