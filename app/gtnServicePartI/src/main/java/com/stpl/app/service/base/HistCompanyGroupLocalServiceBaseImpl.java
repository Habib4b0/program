...
import com.stpl.app.service.HistCompanyGroupLocalService;
...
/**
 * Provides the base implementation for the hist company group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.HistCompanyGroupLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.HistCompanyGroupLocalServiceImpl
 * @see com.stpl.app.service.HistCompanyGroupLocalServiceUtil
 * @generated
 */
public abstract class HistCompanyGroupLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements HistCompanyGroupLocalService,
        IdentifiableBean {
    ...
    private HistCompanyGroupLocalServiceClpInvoker _clpInvoker = new HistCompanyGroupLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.HistCompanyGroupLocalServiceUtil} to access the hist company group local service.
     */
    ...
    @Override
    public HistCompanyGroup addHistCompanyGroup(
        HistCompanyGroup histCompanyGroup) throws SystemException {
        histCompanyGroup.setNew(true);

        return histCompanyGroupPersistence.update(histCompanyGroup);
    }
     ...
     */
    @Override
    public HistCompanyGroup createHistCompanyGroup(
        HistCompanyGroupPK histCompanyGroupPK) {
        return histCompanyGroupPersistence.create(histCompanyGroupPK);
    }
    ...
    @Override
    public HistCompanyGroup deleteHistCompanyGroup(
        HistCompanyGroupPK histCompanyGroupPK)
        throws PortalException, SystemException {
        return histCompanyGroupPersistence.remove(histCompanyGroupPK);
    }
    ...
    public HistCompanyGroup deleteHistCompanyGroup(
        HistCompanyGroup histCompanyGroup) throws SystemException {
        return histCompanyGroupPersistence.remove(histCompanyGroup);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(HistCompanyGroup.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return histCompanyGroupPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return histCompanyGroupPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public HistCompanyGroup fetchHistCompanyGroup(
        HistCompanyGroupPK histCompanyGroupPK) throws SystemException {
        return histCompanyGroupPersistence.fetchByPrimaryKey(histCompanyGroupPK);
    }
     ...
     */
    @Override
    public HistCompanyGroup getHistCompanyGroup(
        HistCompanyGroupPK histCompanyGroupPK)
        throws PortalException, SystemException {
        return histCompanyGroupPersistence.findByPrimaryKey(histCompanyGroupPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return histCompanyGroupPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<HistCompanyGroup> getHistCompanyGroups(int start, int end)
        throws SystemException {
        return histCompanyGroupPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getHistCompanyGroupsCount() throws SystemException {
        return histCompanyGroupPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public HistCompanyGroup updateHistCompanyGroup(
        HistCompanyGroup histCompanyGroup) throws SystemException {
        return histCompanyGroupPersistence.update(histCompanyGroup);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.HistCompanyGroup",
            histCompanyGroupLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = histCompanyGroupPersistence.getDataSource();
