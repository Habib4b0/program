...
public class CompanyIdentifierForm extends StplCustomComponent {
     ...
     */ 
    public Component getContent(ErrorfulFieldGroup binder, final BeanItemContainer<CompanyCrtIdentifierDTO> identifierResultsBean,final SessionDTO sessionDTO) throws PortalException, SystemException, Exception {
    ...
    public void configureFields() {
        ...
        try {
            ...
            companyIdentifier.setData("maxlengthvalidationhundred,maxlengthvalidationidentifier,alphaNumericCharsWithoutStar,specialcharvalidationcompanyidentifier");
            ...
            Object[] obj = UIUtils.IDEN_FORM_COL_ORDER;
