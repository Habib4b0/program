...
public class SummaryTPDetails extends CustomComponent implements View {
    ...
    private BeanItemContainer<CurrentContractDTO> transContractExcelResultBean = new BeanItemContainer<CurrentContractDTO>(CurrentContractDTO.class);
    private ExtCustomTable contractExportPeriodViewTable;
    private ExtCustomTable transContractExportPeriodViewTable;
    ...
    public void configureTransferTradingPartnerTable() {
        ...
        transferTradingPartnerTable.setPageLength(5);
                    ...
                    check.addClickListener(new ExtCustomCheckBox.ClickListener() {
                        public void click(ExtCustomCheckBox.ClickEvent event) {
                            ...
                            if (isCheck) {
                                ...
                                if (selItemList.contains(itemId)) {
