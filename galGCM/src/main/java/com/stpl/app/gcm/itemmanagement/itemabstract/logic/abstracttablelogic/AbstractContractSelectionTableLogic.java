...
public class AbstractContractSelectionTableLogic extends PageTableLogic {
    ...
    public int getCount() {
        if (isGenerated) {
            ...
            appendFilterQuery();
            return logic.getContractCount(selection, selectedItemList, withStringinput);
        }
        return 0;
    }
    ...
    public List loadData(int start, int offset) {
        ...
        return logic.getContractResults(selection, selectedItemList, start, offset, newInput);
    }
