...
public class HistHierarchyLevelValuesLocalServiceUtil {
    private static HistHierarchyLevelValuesLocalService _service;
    ...
    */
    ...
    public static HistHierarchyLevelValuesLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    HistHierarchyLevelValuesLocalService.class.getName());

            if (invokableLocalService instanceof HistHierarchyLevelValuesLocalService) {
                _service = (HistHierarchyLevelValuesLocalService) invokableLocalService;
            } else {
                _service = new HistHierarchyLevelValuesLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(HistHierarchyLevelValuesLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(HistHierarchyLevelValuesLocalService service) {
    }
}
