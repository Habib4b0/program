...
public class GcmItemDetailsCacheModel implements CacheModel<GcmItemDetails>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GcmItemDetailsCacheModel)) {
			return false;
		}

		GcmItemDetailsCacheModel gcmItemDetailsCacheModel = (GcmItemDetailsCacheModel)obj;

		if (gcmItemDetailsSid == gcmItemDetailsCacheModel.gcmItemDetailsSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, gcmItemDetailsSid);
	}
