...
public class RelationshipBuilder extends CustomComponent implements View {
     ...
     */
    public RelationshipBuilder(final CustomFieldGroup relationshipBuilderBinder, final RelationshipBuilderDTO relationshipBuilderDTO) throws SystemException, Exception {
        super();
        LOGGER.info("inside RelationshipBuilder constructor");
        this.relationshipBuilderDTO = relationshipBuilderDTO;
        this.relationshipBuilderBinder = relationshipBuilderBinder;
        init();
        LOGGER.info(" RelationshipBuilder constructor ends");
    }
    ...
    private Component addToContent() throws SystemException, Exception {
        ...
        configureFields();
        LOGGER.info("addToContent method returns component");
        return content;
    }
    ...
    private CustomFieldGroup getRelationBuilderBinder() {
        LOGGER.info("Entering getRelationBuilderBinder method");
        ...
        LOGGER.info("getRelationBuilderBinder method returns CustonFieldGroup");
        return relationshipBuilderBinder;
    }
    ...
    private Panel addRelationshipInfo() {
        LOGGER.info("Entering addRelationshipInfo methods");
        final Panel panel = new Panel();
        final CustomGridLayout gridLayout = new CustomGridLayout(6, 2);
        ...
        LOGGER.info("addRelationshipInfo methods returns panel");
        return panel;
    }
    ...
    private Component addActionButtons() {
        LOGGER.info("Entering addActionButtons methods");
        ...
        LOGGER.info("addActionButtons methods returns Layout");
    ...
    private void configureFields() throws SystemException, Exception {
        LOGGER.info("Entering configureFields methods");
        ...
        save.addClickListener(new Button.ClickListener() {
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("In configureFields save.addValueChangeListener started");
                try {
                            ...
                            if (buttonId.name().equals("YES")) {
                                try {
                                    ...
                                    if (page.equalsIgnoreCase(ConstantsUtils.ADD)) {
                                        ...
                                        VaadinSession.getCurrent().setAttribute("hierarchyVersion", idList.get(2));
                    ...
                    LOGGER.info("In configureFields save.addValueChangeListener Ended");
        ...
        resetAll.addClickListener(new Button.ClickListener() {
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("In configureFields resetAll.addValueChangeListener started");
                ...
                LOGGER.info("In configureFields resetAll.addValueChangeListener Ended");
            }
        });
        /**
        ...
        backButton.addClickListener(new Button.ClickListener() {
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("In configureFields backButton.addValueChangeListener started");
                getUI().getNavigator().navigateTo(RelationshipBuilderIndex.NAME);
                LOGGER.info("In configureFields backButton.addValueChangeListener Ended");
            }
        });
    }
    ...
    private void loadHierarchy() throws SystemException, Exception {
        LOGGER.info("Entering loadHierarchy method");
    }
     ...
     * @throws SystemException
     */
    protected void hierarchyOnChangeEvent(final Object company) throws SystemException, PortalException, Exception {
        LOGGER.info("Entering hierarchyOnChangeEvent method with companyValue " + (company));
     ...
     * @throws SystemException
     */
    public void loadHierarchyLevels() throws SystemException, PortalException, Exception {
        LOGGER.info("Entering loadHierarchyLevels method");
        ...
        LOGGER.info(" loadHierarchyLevels method Ended");
    }
    ...
    private Component addGridButtons(final int values, final int levelCount, final int levelNo) {
        LOGGER.info("Entering addGridButtons with i value:" + values + "and levelcount:" + levelCount + "and levelNo :" + levelNo);
        final VerticalLayout content = new VerticalLayout();
        Button remove;
        /**
         * The add.
        ...
        LOGGER.info("addGridButtons method returns layout");
        return content;
    }
    ...
    private ExtFilterTable addLevelStructure(final String levelName, final List<HierarchyLevelsDTO> levelValues, final int value) {
        LOGGER.info("Entering addLevelStructure method");
            ...
            public void itemClick(final ItemClickEvent event) {
                if (event != null) {
                    if (event.isDoubleClick()) {
                        LOGGER.info("In addLevelStructure availableResults.addListener started");
                        addItemsOnDoubleClick(event, value - 1);
                        LOGGER.info("In addLevelStructure availableResults.addListener Ended");
                    }
                }
            }
        });
        ...
        LOGGER.info("addLevelStructure method Returns");
    ...
    private ExtFilterTable addSelectedLevelValues(final String levelName, final List<HierarchyLevelsDTO> savedLevelValues, final int name) {
        LOGGER.info("Entering addSelectedLevelValues method with levelName " + levelName + "savedLevelValues list size:" + savedLevelValues.size() + "i value:" + name);
            ...
            public void itemClick(final ItemClickEvent event) {
                if (event != null) {
                    if (event.isDoubleClick()) {
                        ...
                        LOGGER.info("In addSelectedLevelValues selectedResults.addListener started");
                        removeItemsOnDoubleClick(event, name - 1);
                        LOGGER.info("In addSelectedLevelValues selectedResults.addListener Ended");
                    }
                }
            }
        });
        ...
        LOGGER.info(" addSelectedLevelValues method Returns ");
    ...
    protected void addItemsButtonClick(final Button.ClickEvent event, final int value, final int levelNo) {
        LOGGER.info("Entering addItemsButtonClick with i value " + value + " and leval no" + levelNo);
        ...
        LOGGER.info("addItemsButtonClick Method Ends here");
    }
    ...
    protected void removeItemsButtonClick(final Button.ClickEvent event, final int value) {
        LOGGER.info("Entering removeItemsButtonClick method with i value:" + value);
    ...
    protected void addItemsOnDoubleClick(final ItemClickEvent event, final int event1) {
        ...
        LOGGER.info("Entering addItemsOnDoubleClick method with i value:" + event1);
    ...
    protected void removeItemsOnDoubleClick(final ItemClickEvent event, final int values) {
        LOGGER.info("Entering removeItemsOnDoubleClick method with i value:" + values);
    ...
    protected void resetButtonClickLogic() {
        LOGGER.info("Entering resetButtonClickLogic method");
        try {
        ...
        LOGGER.info("resetButtonClickLogic method Ends here");
    }
