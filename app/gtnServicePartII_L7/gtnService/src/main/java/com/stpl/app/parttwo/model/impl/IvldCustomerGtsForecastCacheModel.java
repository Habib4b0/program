...
public class IvldCustomerGtsForecastCacheModel implements CacheModel<IvldCustomerGtsForecast>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldCustomerGtsForecastCacheModel)) {
			return false;
		}

		IvldCustomerGtsForecastCacheModel ivldCustomerGtsForecastCacheModel = (IvldCustomerGtsForecastCacheModel)obj;

		if (ivldCustomerGtsForecastSid == ivldCustomerGtsForecastCacheModel.ivldCustomerGtsForecastSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldCustomerGtsForecastSid);
	}
	...
	public IvldCustomerGtsForecast toEntityModel() {
		...
		ivldCustomerGtsForecastImpl.setCheckRecord(checkRecord);
