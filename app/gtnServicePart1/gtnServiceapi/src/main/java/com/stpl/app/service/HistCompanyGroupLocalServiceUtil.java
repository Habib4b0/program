...
public class HistCompanyGroupLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<HistCompanyGroupLocalService, HistCompanyGroupLocalService> _serviceTracker =
		ServiceTrackerFactory.open(HistCompanyGroupLocalService.class);
}