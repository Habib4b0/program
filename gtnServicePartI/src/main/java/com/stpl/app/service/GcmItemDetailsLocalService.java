...
/**
 * Provides the local service interface for GcmItemDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see GcmItemDetailsLocalServiceUtil
...
public interface GcmItemDetailsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link GcmItemDetailsLocalServiceUtil} to access the gcm item details local service. Add custom service methods to {@link com.stpl.app.service.impl.GcmItemDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
