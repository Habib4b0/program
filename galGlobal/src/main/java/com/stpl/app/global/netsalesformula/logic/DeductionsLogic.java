...
public class DeductionsLogic {
    ...
    public List<DeductionDto> getCountAndResultsForRS(final ErrorfulFieldGroup rebateSchForm, int start, int offset, final List<SortByColumn> columns, final boolean fieldFlag, final Set<Container.Filter> filterSet, boolean isCount)
    ...
    List<DeductionDto> getCustomizedDto(List list, boolean isSelected) throws PortalException, SystemException {
        ...
        if (list != null) {
            for (int i = 0; i < list.size(); i++) {
                ...
                searchForm.setDeductionCategory((helperListUtil.getIdHelperDTOMap().get(obj[2] != null ? Integer.valueOf(String.valueOf(obj[2])) : 0)));
                ...
                if (isSelected) {
                    searchForm.setTempItemSystemId(obj[3] != null ? (int) (obj[3]) : 0);
                    searchForm.setIndicator((obj[4] != null && (char)obj[4] != ' ' ? ((char)(obj[4]) == '+' ? "Add" : "Subtract") : ConstantsUtils.SELECT_ONE));
                    searchForm.setNetSalesRuleSystemId(obj[5] != null ? (int) (obj[5]) : 0);
                    searchForm.setSelectedCheck(obj[6] != null ? (boolean)obj[6] == true : false);
                    searchForm.setNetSalesRuleNo(obj[7] != null ? String.valueOf(obj[7]) : StringUtils.EMPTY);
                    searchForm.setNetSalesRuleName(obj[8] != null ? String.valueOf(obj[8]) : StringUtils.EMPTY);
    ...
    private List<DeductionDto> getCustomizedDtoForContract(List list, boolean isSelected) throws PortalException, SystemException, Exception {
        final List<DeductionDto> searchItemList = new ArrayList<>();
        if (list != null) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                searchForm.setDeductionNo(obj[2] != null ? String.valueOf(obj[2]) : StringUtils.EMPTY);
                searchForm.setDeductionName(obj[3] != null ? String.valueOf(obj[3]) : StringUtils.EMPTY);
                searchForm.setDeductionType((helperListUtil.getIdHelperDTOMap().get(obj[4] != null ? Integer.valueOf(String.valueOf(obj[4])) : 0)));
                searchForm.setDeductionTypeTable((searchForm.getDeductionType().getId()==0) ? StringUtils.EMPTY : searchForm.getDeductionType().getDescription());
                searchForm.setDeductionSubType((helperListUtil.getIdHelperDTOMap().get(obj[5] != null ? Integer.valueOf(String.valueOf(obj[5])) : 0)));
                searchForm.setDeductionSubTypeTable((searchForm.getDeductionSubType().getId()==0) ? StringUtils.EMPTY : searchForm.getDeductionSubType().getDescription());
                searchForm.setDeductionCategory((helperListUtil.getIdHelperDTOMap().get(obj[6] != null ? Integer.valueOf(String.valueOf(obj[6])) : 0)));
                searchForm.setDeductionCategoryTable((searchForm.getDeductionCategory().getId()==0) ? StringUtils.EMPTY : searchForm.getDeductionCategory().getDescription());
                searchForm.setMarketType((helperListUtil.getIdHelperDTOMap().get(obj[7] != null ? Integer.valueOf(String.valueOf(obj[7])) : 0)));
                searchForm.setMarketTypeTable((searchForm.getMarketType().getId()==0) ? StringUtils.EMPTY : searchForm.getMarketType().getDescription());
                searchForm.setStartDateString(formatDate(convertNullToEmpty(String.valueOf(obj[8]))));
                searchForm.setStartDate(parsetDate(convertNullToEmpty(String.valueOf(obj[8]))));
                searchForm.setEndDateString(formatDate(convertNullToEmpty(String.valueOf(obj[9]))));
                searchForm.setEndDate(parsetDate(convertNullToEmpty(String.valueOf(obj[9]))));
                searchForm.setContractHolder(obj[10] != null ? String.valueOf(obj[10]) : StringUtils.EMPTY);
                searchForm.setCompanyFamilyPlanNo(obj[11] != null ? String.valueOf(obj[11]) : StringUtils.EMPTY);
                searchForm.setCompanyFamilyPlanName(obj[12] != null ? String.valueOf(obj[12]) : StringUtils.EMPTY);
                searchForm.setItemFamilyPlanNo(obj[13] != null ? String.valueOf(obj[13]) : StringUtils.EMPTY);
                searchForm.setItemFamilyPlanName(obj[14] != null ? String.valueOf(obj[14]) : StringUtils.EMPTY);
                searchForm.setPriceScheduleNo(obj[15] != null ? String.valueOf(obj[15]) : StringUtils.EMPTY);
                searchForm.setPriceScheduleName(obj[16] != null ? String.valueOf(obj[16]) : StringUtils.EMPTY);
                searchForm.setContractMasterSId(obj[17] != null ? (int) (obj[17]) : 0);

                if (isSelected) {
                    searchForm.setTempItemSystemId(obj[18] != null ? (int) (obj[18]) : 0);
                    searchForm.setIndicator((obj[19] != null && (char)obj[19] != ' ' ? ((char)(obj[19]) == '+' ? "Add" : "Subtract") : ConstantsUtils.SELECT_ONE));
                    searchForm.setNetSalesRuleSystemId(obj[20] != null ? (int) (obj[20]) : 0);
                    searchForm.setSelectedCheck(obj[21] != null ? (Boolean) obj[21] : false);
                    searchForm.setNetSalesRuleNo(obj[22] != null ? String.valueOf(obj[22]) : StringUtils.EMPTY);
                    searchForm.setNetSalesRuleName(obj[23] != null ? String.valueOf(obj[23]) : StringUtils.EMPTY);
                    searchForm.setRsContractSid(obj[24] != null ? (int) (obj[24]) : 0);
                } else {
                    searchForm.setRsContractSid(obj[18] != null ? (int) (obj[18]) : 0);
                }
    ...
    public void addToTempTable(DeductionDto item, SessionDTO sessionDTO, boolean isContract, NetSalesRuleLookupDto ruleDto,StringBuilder insertQuery) throws SystemException, PortalException, ParseException {
...
//
    ...
    public void updateTempTable(boolean checkValue, DeductionDto dto, String sessionId) throws PortalException, SystemException {
        StringBuilder query = new StringBuilder(StringUtils.EMPTY);
    ...
    public void populateLogic(boolean netflag,Object... receivedObj) {
        ...
        final DeductionDto dto = (DeductionDto) convertedList.get(5);
        updateForPopulate(netflag,userId, sessionId, createdDate, populateField, populateValue, dto);
    }

    public void updateForPopulate(boolean netflag,String userId, String sessionId, String createdDate, Object populateField, Object populateValue, DeductionDto searchForm) {
        try {
