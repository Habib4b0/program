...
import com.stpl.app.parttwo.service.SlaCalendarMasterLocalService;
...
/**
 * Provides the base implementation for the sla calendar master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.SlaCalendarMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.SlaCalendarMasterLocalServiceImpl
 * @see com.stpl.app.parttwo.service.SlaCalendarMasterLocalServiceUtil
 * @generated
 */
public abstract class SlaCalendarMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements SlaCalendarMasterLocalService,
        IdentifiableBean {
    ...
    private SlaCalendarMasterLocalServiceClpInvoker _clpInvoker = new SlaCalendarMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.SlaCalendarMasterLocalServiceUtil} to access the sla calendar master local service.
     */
    ...
    public SlaCalendarMaster addSlaCalendarMaster(
        SlaCalendarMaster slaCalendarMaster) throws SystemException {
        slaCalendarMaster.setNew(true);

        return slaCalendarMasterPersistence.update(slaCalendarMaster);
    }
    ...
    public SlaCalendarMaster createSlaCalendarMaster(int slaCalendarMasterSid) {
        return slaCalendarMasterPersistence.create(slaCalendarMasterSid);
    }
    ...
    public SlaCalendarMaster deleteSlaCalendarMaster(int slaCalendarMasterSid)
        ...
        return slaCalendarMasterPersistence.remove(slaCalendarMasterSid);
    }
    ...
    public SlaCalendarMaster deleteSlaCalendarMaster(
        SlaCalendarMaster slaCalendarMaster) throws SystemException {
        return slaCalendarMasterPersistence.remove(slaCalendarMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(SlaCalendarMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return slaCalendarMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return slaCalendarMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public SlaCalendarMaster fetchSlaCalendarMaster(int slaCalendarMasterSid)
        throws SystemException {
        return slaCalendarMasterPersistence.fetchByPrimaryKey(slaCalendarMasterSid);
    }
    ...
    public SlaCalendarMaster getSlaCalendarMaster(int slaCalendarMasterSid)
        throws PortalException, SystemException {
        return slaCalendarMasterPersistence.findByPrimaryKey(slaCalendarMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return slaCalendarMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public List<SlaCalendarMaster> getSlaCalendarMasters(int start, int end)
        throws SystemException {
        return slaCalendarMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getSlaCalendarMastersCount() throws SystemException {
        return slaCalendarMasterPersistence.countAll();
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.SlaCalendarMaster",
            slaCalendarMasterLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = slaCalendarMasterPersistence.getDataSource();
