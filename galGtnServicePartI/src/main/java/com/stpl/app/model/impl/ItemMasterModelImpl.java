...
public class ItemMasterModelImpl extends BaseModelImpl<ItemMaster>
    ...
    public CacheModel<ItemMaster> toCacheModel() {
        ...
        String organizationKey = itemMasterCacheModel.organizationKey;

        if ((organizationKey != null) && (organizationKey.length() == 0)) {
            itemMasterCacheModel.organizationKey = null;
        }
