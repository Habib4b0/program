 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldAverageShelfLifeModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldAverageShelfLifeImpl}.
 * </p>
 *
 * @author
...
public class IvldAverageShelfLifeModelImpl extends BaseModelImpl<IvldAverageShelfLife>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("IVLD_AVERAGE_SHELF_LIFE_SID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("AVERAGE_SHELF_LIFE_INTFID", Types.VARCHAR);
	...
	private static final ClassLoader _classLoader = IvldAverageShelfLife.class.getClassLoader();
