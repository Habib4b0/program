...
/**
 * The persistence utility for the rebate plan tier service. This utility wraps {@link com.stpl.app.service.persistence.impl.RebatePlanTierPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.stpl.app.service.persistence.impl.RebatePlanTierPersistenceImpl
 * @generated
 */
@ProviderType
public class RebatePlanTierUtil {
	...
	*/
	public static void cacheResult(RebatePlanTier rebatePlanTier) {
	...
	*/
	public static void cacheResult(List<RebatePlanTier> rebatePlanTiers) {
	...
	*/
	public static RebatePlanTier create(int rebatePlanTierSid) {
	...
	*/
	public static RebatePlanTier remove(int rebatePlanTierSid)
		throws com.stpl.app.exception.NoSuchRebatePlanTierException {
		return getPersistence().remove(rebatePlanTierSid);
	}

	public static RebatePlanTier updateImpl(RebatePlanTier rebatePlanTier) {
	...
	* @throws NoSuchRebatePlanTierException if a rebate plan tier with the primary key could not be found
	*/
	public static RebatePlanTier findByPrimaryKey(int rebatePlanTierSid)
		throws com.stpl.app.exception.NoSuchRebatePlanTierException {
	...
	*/
	public static RebatePlanTier fetchByPrimaryKey(int rebatePlanTierSid) {
		return getPersistence().fetchByPrimaryKey(rebatePlanTierSid);
	}

	public static java.util.Map<java.io.Serializable, RebatePlanTier> fetchByPrimaryKeys(
	...
	*/
	public static List<RebatePlanTier> findAll() {
	...
	*/
	public static List<RebatePlanTier> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<RebatePlanTierPersistence, RebatePlanTierPersistence> _serviceTracker =
		ServiceTrackerFactory.open(RebatePlanTierPersistence.class);
}