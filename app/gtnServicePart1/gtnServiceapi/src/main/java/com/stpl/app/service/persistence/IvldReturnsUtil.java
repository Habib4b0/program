...
/**
 * The persistence utility for the ivld returns service. This utility wraps {@link com.stpl.app.service.persistence.impl.IvldReturnsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class IvldReturnsUtil {
	...
	*/
	public static void cacheResult(IvldReturns ivldReturns) {
	...
	*/
	public static void cacheResult(List<IvldReturns> ivldReturnses) {
	...
	*/
	public static IvldReturns create(int ivldReturnsSid) {
	...
	*/
	public static IvldReturns remove(int ivldReturnsSid)
		throws com.stpl.app.exception.NoSuchIvldReturnsException {
		return getPersistence().remove(ivldReturnsSid);
	}

	public static IvldReturns updateImpl(IvldReturns ivldReturns) {
	...
	* @throws NoSuchIvldReturnsException if a ivld returns with the primary key could not be found
	*/
	public static IvldReturns findByPrimaryKey(int ivldReturnsSid)
		throws com.stpl.app.exception.NoSuchIvldReturnsException {
	...
	*/
	public static IvldReturns fetchByPrimaryKey(int ivldReturnsSid) {
		return getPersistence().fetchByPrimaryKey(ivldReturnsSid);
	}

	public static java.util.Map<java.io.Serializable, IvldReturns> fetchByPrimaryKeys(
	...
	*/
	public static List<IvldReturns> findAll() {
	...
	*/
	public static List<IvldReturns> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IvldReturnsPersistence, IvldReturnsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(IvldReturnsPersistence.class);
}