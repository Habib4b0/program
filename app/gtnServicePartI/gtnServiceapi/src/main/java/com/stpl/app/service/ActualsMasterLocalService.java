...
/**
 * Provides the local service interface for ActualsMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ActualsMasterLocalServiceUtil
...
public interface ActualsMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ActualsMasterLocalServiceUtil} to access the actuals master local service. Add custom service methods to {@link com.stpl.app.service.impl.ActualsMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
