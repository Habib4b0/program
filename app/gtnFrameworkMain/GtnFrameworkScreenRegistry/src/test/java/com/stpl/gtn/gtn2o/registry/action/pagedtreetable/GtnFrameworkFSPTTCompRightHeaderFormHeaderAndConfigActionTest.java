...
public class GtnFrameworkFSPTTCompRightHeaderFormHeaderAndConfigActionTest {

	
	GtnFrameworkFSPTTCompRightHeaderFormHeaderAndConfigAction instance = new GtnFrameworkFSPTTCompRightHeaderFormHeaderAndConfigAction();
