...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'DEMAND_ACTUAL_SALES'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN DEMAND_ACTUAL_SALES NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'DEMAND_ACTUAL_UNITS'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN DEMAND_ACTUAL_UNITS NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'DEMAND_FORECAST_SALES'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN DEMAND_FORECAST_SALES NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'DEMAND_FORECAST_UNITS'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN DEMAND_FORECAST_UNITS NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'ADJUSTED_DEMAND_ACTUAL_SALES'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN ADJUSTED_DEMAND_ACTUAL_SALES NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'ADJUSTED_DEMAND_ACTUAL_UNITS'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN ADJUSTED_DEMAND_ACTUAL_UNITS NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'ADJUSTED_DEMAND_FORECAST_SALES'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN ADJUSTED_DEMAND_FORECAST_SALES NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'ADJUSTED_DEMAND_FORECAST_UNITS'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN ADJUSTED_DEMAND_FORECAST_UNITS NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'INVENTORY_ACTUAL_SALES'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN INVENTORY_ACTUAL_SALES NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'INVENTORY_ACTUAL_UNITS'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN INVENTORY_ACTUAL_UNITS NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'INVENTORY_FORECAST_SALES'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN INVENTORY_FORECAST_SALES NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
           FROM   INFORMATION_SCHEMA.COLUMNS
           WHERE  TABLE_NAME = 'PRODUCT_FILE' 
                  AND COLUMN_NAME = 'INVENTORY_FORECAST_UNITS'
				  AND TABLE_SCHEMA = 'DBO')
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN INVENTORY_FORECAST_UNITS NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
  ...
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN INVENTORY_CUST_ACTUAL_SALES NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
  ...
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN INVENTORY_CUST_ACTUAL_UNITS NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
  ...
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN INVENTORY_CUST_FORECAST_SALES NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
  ...
  BEGIN
      ALTER TABLE PRODUCT_FILE
        ALTER COLUMN INVENTORY_CUST_FORECAST_UNITS NUMERIC(22,6) SPARSE
  END
...
IF EXISTS (SELECT 1
  ...
  BEGIN
      DROP INDEX NIX_CCP_HIERARCHY_CUST_HIERARCHY_NO_INCLUDE_CCP_DETAILS_SID ON CCP_HIERARCHY
  END 
  GO
IF EXISTS (SELECT 1
               FROM   SYS.INDEXES
  ...
  BEGIN
      DROP INDEX NIX_CCP_HIERARCHY_PROD_HIERARCHY_NO_INCLUDE_CCP_DETAILS_SID ON CCP_HIERARCHY
  END

GO 
IF EXISTS (SELECT *
           FROM   SYS.stats
           WHERE  NAME = 'CCP_DETAILS_SID'
                  AND Object_name(object_id) = 'CCP_HIERARCHY')
  BEGIN
      DROP STATISTICS dbo.CCP_HIERARCHY.CCP_DETAILS_SID 
  END 
...
IF NOT EXISTS (SELECT 1
  ...
  CREATE NONCLUSTERED INDEX NIX_CCP_HIERARCHY_PROD_HIERARCHY_NO_INCLUDE_CCP_DETAILS_SID
    ON CCP_HIERARCHY( PROD_HIERARCHY_NO )
    INCLUDE ( [CCP_DETAILS_SID])
