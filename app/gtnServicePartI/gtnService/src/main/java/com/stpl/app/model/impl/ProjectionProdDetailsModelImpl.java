 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ProjectionProdDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ProjectionProdDetailsImpl}.
 * </p>
 *
 * @author
...
public class ProjectionProdDetailsModelImpl extends BaseModelImpl<ProjectionProdDetails>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("PRODUCT_NO", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("SUB_LEDGER_CODE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PRODUCT_DETAILS_ID", Types.INTEGER);
	...
	private static final ClassLoader _classLoader = ProjectionProdDetails.class.getClassLoader();
