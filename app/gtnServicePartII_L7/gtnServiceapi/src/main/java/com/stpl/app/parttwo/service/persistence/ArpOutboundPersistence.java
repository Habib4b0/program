...
public interface ArpOutboundPersistence extends BasePersistence<ArpOutbound> {
	...
	*/
	public void cacheResult(java.util.List<ArpOutbound> arpOutbounds);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ArpOutbound> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ArpOutbound> findAll();
	...
	*/
	public java.util.List<ArpOutbound> findAll(int start, int end);
	...
	*/
	public java.util.List<ArpOutbound> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ArpOutbound> orderByComparator);
