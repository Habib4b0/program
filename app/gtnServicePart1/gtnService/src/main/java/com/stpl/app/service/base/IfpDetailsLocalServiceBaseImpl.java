...
import com.stpl.app.service.IfpDetailsLocalService;
...
/**
 * Provides the base implementation for the ifp details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IfpDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class IfpDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IfpDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IfpDetailsLocalServiceUtil} to access the ifp details local service.
	 */
	...
	@Override
	public IfpDetails addIfpDetails(IfpDetails ifpDetails) {
		ifpDetails.setNew(true);

		return ifpDetailsPersistence.update(ifpDetails);
	}
	 ...
	 */
	@Override
	public IfpDetails createIfpDetails(int ifpDetailsSid) {
		return ifpDetailsPersistence.create(ifpDetailsSid);
	}
	...
	@Override
	public IfpDetails deleteIfpDetails(int ifpDetailsSid)
		throws PortalException {
		return ifpDetailsPersistence.remove(ifpDetailsSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IfpDetails deleteIfpDetails(IfpDetails ifpDetails) {
		return ifpDetailsPersistence.remove(ifpDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IfpDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ifpDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ifpDetailsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ifpDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IfpDetails fetchIfpDetails(int ifpDetailsSid) {
		return ifpDetailsPersistence.fetchByPrimaryKey(ifpDetailsSid);
	}
	 ...
	 */
	@Override
	public IfpDetails getIfpDetails(int ifpDetailsSid)
		throws PortalException {
		return ifpDetailsPersistence.findByPrimaryKey(ifpDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ifpDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IfpDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ifpDetailsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ifpDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IfpDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ifpDetailsLocalService.deleteIfpDetails((IfpDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ifpDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IfpDetails> getIfpDetailses(int start, int end) {
		return ifpDetailsPersistence.findAll(start, end);
	}
	...
	public int getIfpDetailsesCount() {
		return ifpDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IfpDetails updateIfpDetails(IfpDetails ifpDetails) {
		return ifpDetailsPersistence.update(ifpDetails);
	}
	 ...
	 */
	public IfpDetailsLocalService getIfpDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.IfpDetails",
			ifpDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.IfpDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IfpDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ifpDetailsPersistence.getDataSource();
	...
	@BeanReference(type = IfpDetailsLocalService.class)
	protected IfpDetailsLocalService ifpDetailsLocalService;
