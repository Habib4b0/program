...
/**
 * The persistence utility for the ivld gl cost center service. This utility wraps {@link com.stpl.app.service.persistence.impl.IvldGlCostCenterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class IvldGlCostCenterUtil {
	...
	*/
	public static void cacheResult(IvldGlCostCenter ivldGlCostCenter) {
	...
	*/
	public static void cacheResult(List<IvldGlCostCenter> ivldGlCostCenters) {
	...
	*/
	public static IvldGlCostCenter create(int ivldGlCostCenterSid) {
	...
	*/
	public static IvldGlCostCenter remove(int ivldGlCostCenterSid)
		throws com.stpl.app.exception.NoSuchIvldGlCostCenterException {
		return getPersistence().remove(ivldGlCostCenterSid);
	}

	public static IvldGlCostCenter updateImpl(IvldGlCostCenter ivldGlCostCenter) {
	...
	* @throws NoSuchIvldGlCostCenterException if a ivld gl cost center with the primary key could not be found
	*/
	public static IvldGlCostCenter findByPrimaryKey(int ivldGlCostCenterSid)
		throws com.stpl.app.exception.NoSuchIvldGlCostCenterException {
	...
	*/
	public static IvldGlCostCenter fetchByPrimaryKey(int ivldGlCostCenterSid) {
		return getPersistence().fetchByPrimaryKey(ivldGlCostCenterSid);
	}

	public static java.util.Map<java.io.Serializable, IvldGlCostCenter> fetchByPrimaryKeys(
	...
	*/
	public static List<IvldGlCostCenter> findAll() {
	...
	*/
	public static List<IvldGlCostCenter> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<IvldGlCostCenterPersistence, IvldGlCostCenterPersistence> _serviceTracker =
		ServiceTrackerFactory.open(IvldGlCostCenterPersistence.class);
}