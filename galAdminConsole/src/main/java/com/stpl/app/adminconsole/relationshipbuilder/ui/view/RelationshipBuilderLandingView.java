...
import com.stpl.app.adminconsole.relationshipbuilder.ui.form.RelationshipBuilderIndex;
...
public class RelationshipBuilderLandingView extends VerticalLayout implements View {
    ...
    private RelationshipBuilderIndex relationshipBuilderIndex;
     ...
     */
    public RelationshipBuilderLandingView(final SessionDTO sessionDTO) throws SystemException, Exception {
        super();
