...
public class Deductions extends CustomComponent {
    ...
    private void configureFields() {
        ...
        selectedTableLogic.setPageLength(NumericConstants.SEVEN);   

        selectedDeductionTable.setFilterBarVisible(true);
        selectedDeductionTable.setPageLength(NumericConstants.FIVE);
        selectedDeductionTable.addStyleName(ConstantsUtils.FILTER_BAR);
        availableDeductionTable.setFilterBarVisible(true);
        availableDeductionTable.setPageLength(NumericConstants.FIVE);
        ...
        selectedDeductionTable.setTableFieldFactory(new DeductionTableGenerator(selectedDeductionTable, sessiondto, this));
                            ...
                            public void buttonClicked(final ButtonId buttonId) {
                                if (ButtonId.YES.equals(buttonId)) {
                                    try {
                                        ...
                                        LOGGER.error("Deductions:formulaType  Value Change Listener:Error-----" + ex);
                                    }
                                }else{
                                    changedFTOnce=true;
                ...
                if ((ConstantsUtils.PLUS_MINUS_INDICATOR).equals(massField.getValue())) {
                    ...
                    massValue.addClickListener(new CustomTextField.ClickListener() {
                        ...
                        public void click(CustomTextField.ClickEvent event) {
                            try {
                                lookUp = new NetSalesRuleLookUp(massValue,"Deduction");
                ...
                try {
                    if (formulaType.getValue() == null || String.valueOf(formulaType.getValue()).equals(ConstantsUtils.SELECT_ONE)) {
                        ...
                        && (deductionType.getValue() == null || String.valueOf(deductionType.getValue()).equals(ConstantsUtils.SELECT_ONE))
                            ...
                            && StringUtils.isBlank(deductionName.getValue()) && StringUtils.isBlank(deductionAlias.getValue()) && StringUtils.isBlank(deductionNo.getValue())) {
    ...
    private void searchButtonClickLogic() {
        try {
            ...
            deductionBinder.commit();
            availableDeductions.removeAllItems();        
            tableLogic.setSearchData(availableDeductions, deductionBinder, sessiondto, false, false);
            tableLogic.setCurrentPage(tableLogic.getCurrentPage());

            LOGGER.debug("tableLogic.isResultsEmpty()"+tableLogic.isResultsEmpty());
    ...
    public void addBtnLogic(Button.ClickEvent event) {
                ...
                LOGGER.debug("Entering add available Deductions Logic");
                ...
                LOGGER.debug("Ending add available Deductions Logic");
    }
                        ...
                        if (event.isChecked()) {
                            try {
                                ...
                                for (DeductionDto item : itemIds) {
                                    ...
                                    logic.updateTempTable(true, item);
                                }
                            ...
                            try {
                                ...
                                for (DeductionDto item : itemIds) {
                                    ...
                                    logic.updateTempTable(false, item);
                                }
