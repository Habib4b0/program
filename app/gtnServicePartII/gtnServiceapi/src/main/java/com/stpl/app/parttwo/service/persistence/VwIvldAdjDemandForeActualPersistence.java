...
public interface VwIvldAdjDemandForeActualPersistence extends BasePersistence<VwIvldAdjDemandForeActual> {
	...
	*/
	public void cacheResult(
		java.util.List<VwIvldAdjDemandForeActual> vwIvldAdjDemandForeActuals);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, VwIvldAdjDemandForeActual> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<VwIvldAdjDemandForeActual> findAll();
	...
	*/
	public java.util.List<VwIvldAdjDemandForeActual> findAll(int start, int end);
	...
	*/
	public java.util.List<VwIvldAdjDemandForeActual> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<VwIvldAdjDemandForeActual> orderByComparator);
