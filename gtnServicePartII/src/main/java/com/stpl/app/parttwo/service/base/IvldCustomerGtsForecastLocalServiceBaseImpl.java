...
import com.stpl.app.parttwo.service.IvldCustomerGtsForecastLocalService;
...
/**
 * Provides the base implementation for the ivld customer gts forecast local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.IvldCustomerGtsForecastLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.IvldCustomerGtsForecastLocalServiceImpl
 * @see com.stpl.app.parttwo.service.IvldCustomerGtsForecastLocalServiceUtil
 * @generated
 */
public abstract class IvldCustomerGtsForecastLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements IvldCustomerGtsForecastLocalService,
        IdentifiableBean {
    ...
    private IvldCustomerGtsForecastLocalServiceClpInvoker _clpInvoker = new IvldCustomerGtsForecastLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldCustomerGtsForecastLocalServiceUtil} to access the ivld customer gts forecast local service.
     */
    ...
    @Override
    public IvldCustomerGtsForecast addIvldCustomerGtsForecast(
        IvldCustomerGtsForecast ivldCustomerGtsForecast)
        throws SystemException {
        ivldCustomerGtsForecast.setNew(true);

        return ivldCustomerGtsForecastPersistence.update(ivldCustomerGtsForecast);
    }
     ...
     */
    @Override
    public IvldCustomerGtsForecast createIvldCustomerGtsForecast(
        int ivldCustomerGtsForecastSid) {
        return ivldCustomerGtsForecastPersistence.create(ivldCustomerGtsForecastSid);
    }
    ...
    @Override
    public IvldCustomerGtsForecast deleteIvldCustomerGtsForecast(
        int ivldCustomerGtsForecastSid) throws PortalException, SystemException {
        return ivldCustomerGtsForecastPersistence.remove(ivldCustomerGtsForecastSid);
    }
    ...
    public IvldCustomerGtsForecast deleteIvldCustomerGtsForecast(
        IvldCustomerGtsForecast ivldCustomerGtsForecast)
        throws SystemException {
        return ivldCustomerGtsForecastPersistence.remove(ivldCustomerGtsForecast);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IvldCustomerGtsForecast.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldCustomerGtsForecastPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldCustomerGtsForecastPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public IvldCustomerGtsForecast fetchIvldCustomerGtsForecast(
        int ivldCustomerGtsForecastSid) throws SystemException {
        return ivldCustomerGtsForecastPersistence.fetchByPrimaryKey(ivldCustomerGtsForecastSid);
    }
     ...
     */
    @Override
    public IvldCustomerGtsForecast getIvldCustomerGtsForecast(
        int ivldCustomerGtsForecastSid) throws PortalException, SystemException {
        return ivldCustomerGtsForecastPersistence.findByPrimaryKey(ivldCustomerGtsForecastSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ivldCustomerGtsForecastPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IvldCustomerGtsForecast> getIvldCustomerGtsForecasts(
        int start, int end) throws SystemException {
        return ivldCustomerGtsForecastPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIvldCustomerGtsForecastsCount() throws SystemException {
        return ivldCustomerGtsForecastPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IvldCustomerGtsForecast updateIvldCustomerGtsForecast(
        IvldCustomerGtsForecast ivldCustomerGtsForecast)
        throws SystemException {
        return ivldCustomerGtsForecastPersistence.update(ivldCustomerGtsForecast);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.IvldCustomerGtsForecast",
            ivldCustomerGtsForecastLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.IvldCustomerGtsForecast");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ivldCustomerGtsForecastPersistence.getDataSource();
