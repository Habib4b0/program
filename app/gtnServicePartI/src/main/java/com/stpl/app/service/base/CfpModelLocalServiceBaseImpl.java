...
import com.stpl.app.service.CfpModelLocalService;
...
/**
 * Provides the base implementation for the cfp model local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CfpModelLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class CfpModelLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements CfpModelLocalService, IdentifiableBean {
    ...
    private CfpModelLocalServiceClpInvoker _clpInvoker = new CfpModelLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CfpModelLocalServiceUtil} to access the cfp model local service.
     */
    ...
    @Override
    public CfpModel addCfpModel(CfpModel cfpModel) throws SystemException {
        cfpModel.setNew(true);

        return cfpModelPersistence.update(cfpModel);
    }
     ...
     */
    @Override
    public CfpModel createCfpModel(int cfpModelSid) {
        return cfpModelPersistence.create(cfpModelSid);
    }
    ...
    @Override
    public CfpModel deleteCfpModel(int cfpModelSid)
        throws PortalException, SystemException {
        return cfpModelPersistence.remove(cfpModelSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public CfpModel deleteCfpModel(CfpModel cfpModel) throws SystemException {
        return cfpModelPersistence.remove(cfpModel);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CfpModel.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return cfpModelPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return cfpModelPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return cfpModelPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return cfpModelPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public CfpModel fetchCfpModel(int cfpModelSid) throws SystemException {
        return cfpModelPersistence.fetchByPrimaryKey(cfpModelSid);
    }
     ...
     */
    @Override
    public CfpModel getCfpModel(int cfpModelSid)
        throws PortalException, SystemException {
        return cfpModelPersistence.findByPrimaryKey(cfpModelSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return cfpModelPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<CfpModel> getCfpModels(int start, int end)
        throws SystemException {
        return cfpModelPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCfpModelsCount() throws SystemException {
        return cfpModelPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public CfpModel updateCfpModel(CfpModel cfpModel) throws SystemException {
        return cfpModelPersistence.update(cfpModel);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.CfpModel",
            cfpModelLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.CfpModel");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = cfpModelPersistence.getDataSource();
