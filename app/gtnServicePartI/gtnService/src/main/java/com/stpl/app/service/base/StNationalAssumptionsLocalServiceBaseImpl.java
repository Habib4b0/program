...
import com.stpl.app.service.StNationalAssumptionsLocalService;
...
/**
 * Provides the base implementation for the st national assumptions local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.StNationalAssumptionsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.StNationalAssumptionsLocalServiceImpl
 * @see com.stpl.app.service.StNationalAssumptionsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StNationalAssumptionsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StNationalAssumptionsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.StNationalAssumptionsLocalServiceUtil} to access the st national assumptions local service.
	 */
	...
	@Override
	public StNationalAssumptions addStNationalAssumptions(
		StNationalAssumptions stNationalAssumptions) {
		stNationalAssumptions.setNew(true);

		return stNationalAssumptionsPersistence.update(stNationalAssumptions);
	}
	 ...
	 */
	@Override
	public StNationalAssumptions createStNationalAssumptions(
		StNationalAssumptionsPK stNationalAssumptionsPK) {
		return stNationalAssumptionsPersistence.create(stNationalAssumptionsPK);
	}
	...
	@Override
	public StNationalAssumptions deleteStNationalAssumptions(
		StNationalAssumptionsPK stNationalAssumptionsPK)
		throws PortalException {
		return stNationalAssumptionsPersistence.remove(stNationalAssumptionsPK);
	}
	...
	public StNationalAssumptions deleteStNationalAssumptions(
		StNationalAssumptions stNationalAssumptions) {
		return stNationalAssumptionsPersistence.remove(stNationalAssumptions);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StNationalAssumptions.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stNationalAssumptionsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stNationalAssumptionsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StNationalAssumptions fetchStNationalAssumptions(
		StNationalAssumptionsPK stNationalAssumptionsPK) {
		return stNationalAssumptionsPersistence.fetchByPrimaryKey(stNationalAssumptionsPK);
	}
	 ...
	 */
	@Override
	public StNationalAssumptions getStNationalAssumptions(
		StNationalAssumptionsPK stNationalAssumptionsPK)
		throws PortalException {
		return stNationalAssumptionsPersistence.findByPrimaryKey(stNationalAssumptionsPK);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stNationalAssumptionsLocalService.deleteStNationalAssumptions((StNationalAssumptions)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stNationalAssumptionsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StNationalAssumptions> getStNationalAssumptionses(int start,
		int end) {
		return stNationalAssumptionsPersistence.findAll(start, end);
	}
	...
	public int getStNationalAssumptionsesCount() {
		return stNationalAssumptionsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StNationalAssumptions updateStNationalAssumptions(
		StNationalAssumptions stNationalAssumptions) {
		return stNationalAssumptionsPersistence.update(stNationalAssumptions);
	}
	 ...
	 */
	public StNationalAssumptionsLocalService getStNationalAssumptionsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.StNationalAssumptions",
			stNationalAssumptionsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.StNationalAssumptions");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StNationalAssumptionsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stNationalAssumptionsPersistence.getDataSource();
	...
	@BeanReference(type = StNationalAssumptionsLocalService.class)
	protected StNationalAssumptionsLocalService stNationalAssumptionsLocalService;
