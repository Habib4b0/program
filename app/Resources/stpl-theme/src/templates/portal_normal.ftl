...
<html class="${root_css_class}" dir="<@liferay.language key="lang.dir" />" lang="${w3c_language_id}">
	...
	<head>
		...
		<#--  <script src="${themeDisplay.getPathThemeRoot()}/js/jquery-1.12.4.min.js"></script> --> 
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle mobile-nav collapsed" data-toggle="collapse" data-target="#sidebar" aria-expanded="false">        
        <span></span>
        <span></span>
        <span></span>
      </button>
    ...
    <div class="collapse navbar-collapse">           
      <ul class="nav navbar-nav navbar-right">        
        <li class="dropdown profile">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <img src="${themeDisplay.getPathThemeRoot()}/img/user_male_portrait.png" alt=""> <span class="user-full-name"><small>Welcome,</small> ${user_first_name} </span><span class="caret"></span></a>
