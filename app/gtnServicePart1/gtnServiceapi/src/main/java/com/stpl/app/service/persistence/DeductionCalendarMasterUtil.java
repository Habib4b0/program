...
/**
 * The persistence utility for the deduction calendar master service. This utility wraps {@link com.stpl.app.service.persistence.impl.DeductionCalendarMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class DeductionCalendarMasterUtil {
	...
	*/
	public static DeductionCalendarMaster create(int deductionCalendarMasterSid) {
	...
	*/
	public static DeductionCalendarMaster remove(int deductionCalendarMasterSid)
		throws com.stpl.app.exception.NoSuchDeductionCalendarMasterException {
		return getPersistence().remove(deductionCalendarMasterSid);
	}

	public static DeductionCalendarMaster updateImpl(
		DeductionCalendarMaster deductionCalendarMaster) {
	...
	* @throws NoSuchDeductionCalendarMasterException if a deduction calendar master with the primary key could not be found
	*/
	public static DeductionCalendarMaster findByPrimaryKey(
	...
	*/
	public static DeductionCalendarMaster fetchByPrimaryKey(
		int deductionCalendarMasterSid) {
		return getPersistence().fetchByPrimaryKey(deductionCalendarMasterSid);
	}

	public static java.util.Map<java.io.Serializable, DeductionCalendarMaster> fetchByPrimaryKeys(
	...
	*/
	public static List<DeductionCalendarMaster> findAll() {
	...
	*/
	public static List<DeductionCalendarMaster> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<DeductionCalendarMasterPersistence, DeductionCalendarMasterPersistence> _serviceTracker =
		ServiceTrackerFactory.open(DeductionCalendarMasterPersistence.class);
}