...
import com.stpl.app.galforecasting.nationalassumptions.logic.*;
...
public class MasterFcpWorkSheetTableLogic  extends PageTreeTableLogic {
    ...
    public Map<Integer, Object> loadData(int start, int offset) {
        ...
        if (firstGenerated) {
           ...
           List<TableDTO> list = fcpResLogic.getConfiguredFcpWorkSheetResults(getLastParent(), start, offset, projSelDTO);
        int i = start;
    ...
    public void setProjectionResultsData(ProjectionSelectionDTO projSelDTO, int levelNo, String hierarchyNo,boolean isTotal) {
