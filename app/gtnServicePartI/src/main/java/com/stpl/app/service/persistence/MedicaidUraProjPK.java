...
public class MedicaidUraProjPK implements Comparable<MedicaidUraProjPK>,
    Serializable {
    public int periodSid;
    public String priceType;
    public int naProjDetailsSid;

    public MedicaidUraProjPK() {
    }

    public MedicaidUraProjPK(int periodSid, String priceType,
    ...
    @Override
    public int compareTo(MedicaidUraProjPK pk) {
        if (pk == null) {
            return -1;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MedicaidUraProjPK)) {
            return false;
        }

        MedicaidUraProjPK pk = (MedicaidUraProjPK) obj;
