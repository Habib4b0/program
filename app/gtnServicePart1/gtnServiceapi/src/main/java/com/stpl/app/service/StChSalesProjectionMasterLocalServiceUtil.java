...
public class StChSalesProjectionMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<StChSalesProjectionMasterLocalService, StChSalesProjectionMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(StChSalesProjectionMasterLocalService.class);
}