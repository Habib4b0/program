...
public abstract class ItemGroupLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements ItemGroupLocalService, IdentifiableBean {
    ...
    private ItemGroupLocalServiceClpInvoker _clpInvoker = new ItemGroupLocalServiceClpInvoker();
    ...
    @Override
    public ItemGroup fetchItemGroup(int itemGroupSid) throws SystemException {
     ...
     */
    @Override
    public ItemGroup getItemGroup(int itemGroupSid)
        throws PortalException, SystemException {
     ...
     */
    @Override
    public int getItemGroupsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ItemGroup",
