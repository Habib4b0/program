...
public class PSPricingTabForm extends CustomComponent implements View {
	...
	private LazyBeanItemContainer<PSIFPDTO> lazyResultBean;
    ...
    SessionDTO sessionDTO;
	   ...
	   public PSPricingTabForm(ErrorLabel errorMsg, final ErrorfulFieldGroup binder, final PSDTO psMaster, BeanItemContainer<PSIFPDTO> itemDetailsResultBean,
            BeanItemContainer<PSIFPDTO> selectedItemResultBean, TempItemCriteria tempItemCriteria, String userId, String sessionId, String tempCreatedDate, PSLogic psLogic,
  ...
  private void configurePermission(final Map<String, AppPermission> fieldPsHM) {
					...
					try {
						...
						massDate.setValue(null);
                                            if (Constants.CONTRACT_PRICE.equals(value) || Constants.BASE_PRICE.equals(value) || Constants.PRICE_TOLERENCE.equals(value) || Constants.PRICE.equals(value)
                                                ...
                                                massPriceType.select(new HelperDTO(0, ConstantsUtils.SELECT_ONE));
	...
	public void addItemDetailsTable() throws Exception {
		...
		itemDetailsTable.addStyleName(VALO_THEME_EXTFILTERING_TABLE);
                ...
                psPricingTableLogic.setPageLength(7);
		...
		itemDetailsTable.setPageLength(7);
     ...
     * @throws Exception the exception
     */
    public void configurePopulateAllBtn() throws Exception {
    ...
    protected void massCheckOnChangeEvent(final Object value) throws Exception {
        ...
        if (!String.valueOf(value).isEmpty() && Constants.ENABLE.equals(String.valueOf(value))) {
            ...
            if (resultBeans != null) {
                ...
                /* LOGGER.debug("psBeanList--------"+psBeanList.size()); */
                psIfpList.clear();
    ...
    public void createWorkSheetContent(final Integer start, final Integer end, final PrintWriter printWriter) throws PortalException, SystemException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        ...
        if (itemDetailsTable.size() > 0) {
            ...
            dtoList = getCustomizedItemPriceDTO(list, binder, mode, psMaster);
