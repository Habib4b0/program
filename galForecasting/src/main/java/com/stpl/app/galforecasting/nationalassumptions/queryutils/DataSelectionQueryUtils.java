...
import com.stpl.app.galforecasting.nationalassumptions.util.Constants;
...
public class DataSelectionQueryUtils {
    ...
    public List loadResultsTable(String projectionName, String getSelectedProducts, Object companyValueId, Object thearupeticValueId, int productGroupId, int startIndex, int offset, Set<Container.Filter> filters, List<SortByColumn> sortByColumns) throws PortalException, SystemException, ParseException {
    ...
    public int loadResultsTableCount(String projectionName, String getSelectedProducts, Object companyValueId, Object thearupeticValueId, int productGroupId, Set<Container.Filter> filters) throws PortalException, SystemException, ParseException {
    ...
    public List getPriceTypesList(int projectionId) throws PortalException, SystemException {
        String sql = CustomSQLUtil.get("getNaPriceTypes");
        ...
        if (projectionId != 0) {
            sql += " NA_PROJ_MASTER_SID =  "
                    + projectionId + " AND USER_ID=" + userId.intValue() + " AND SESSION_ID=" + sessionId;
        }
    ...
    public List getNdcList(int projectionId) throws PortalException, SystemException {
        String sql = CustomSQLUtil.get("getNdcList");
        Long userId = Long.valueOf((String) VaadinSession.getCurrent()
                .getAttribute(Constant.USER_ID));
        Integer sessionId = (Integer) VaadinSession.getCurrent().getAttribute(SESSION_ID.getConstant());

        sql += " USER_ID=" + userId.intValue() + " AND SESSION_ID=" + sessionId;

        return (List) DAO.executeSelectQuery(sql);
    }

    public List getFederalList(int projectionId) throws PortalException, SystemException {
    ...
    public List getProductGroups(String productGroupNo, String productGroupName, String company, String segment, int startIndex, int offset, Set<Container.Filter> filters, List<SortByColumn> sortByColumns) {
        ...
        try {
            ...
            if ((parameters.get(Constant.ISORDERED) == null || "false".equalsIgnoreCase(String.valueOf(parameters.get(Constant.ISORDERED))))) {
                ...
                if (parameters.get("orderBy~productGroupName") != null && !com.stpl.app.util.Constants.NULL.equals(String.valueOf(parameters.get("orderBy~productGroupName"))) && !StringUtils.isBlank(String.valueOf(parameters.get("orderBy~productGroupName")))) {
                    sql = sql + (" ORDER BY ITEM_GROUP_NAME ");
                    sql = sql + (String.valueOf(parameters.get("orderBy~productGroupName")));
                }

                if (parameters.get("orderBy~productGroup") != null && !com.stpl.app.util.Constants.NULL.equals(String.valueOf(parameters.get("orderBy~productGroup"))) && !StringUtils.isBlank(String.valueOf(parameters.get("orderBy~productGroup")))) {
                    sql = sql + (" ORDER BY ITEM_GROUP_NO ");
                    sql = sql + (String.valueOf(parameters.get("orderBy~productGroup")));
                }
                if (parameters.get("orderBy~company") != null && !com.stpl.app.util.Constants.NULL.equals(String.valueOf(parameters.get("orderBy~company"))) && !StringUtils.isBlank(String.valueOf(parameters.get("orderBy~company")))) {
    ...
    public List getProductGroupresults(Object companyValue, Object therapeuticClassValue, Object productGroupValue) {
        try {
