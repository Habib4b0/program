...
/**
 * The persistence utility for the cff details service. This utility wraps {@link com.stpl.app.parttwo.service.persistence.impl.CffDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CffDetailsUtil {
	...
	*/
	public static void cacheResult(CffDetails cffDetails) {
	...
	*/
	public static void cacheResult(List<CffDetails> cffDetailses) {
	...
	*/
	public static CffDetails create(int cffDetailsSid) {
	...
	*/
	public static CffDetails remove(int cffDetailsSid)
		throws com.stpl.app.parttwo.exception.NoSuchCffDetailsException {
		return getPersistence().remove(cffDetailsSid);
	}

	public static CffDetails updateImpl(CffDetails cffDetails) {
	...
	* @throws NoSuchCffDetailsException if a cff details with the primary key could not be found
	*/
	public static CffDetails findByPrimaryKey(int cffDetailsSid)
		throws com.stpl.app.parttwo.exception.NoSuchCffDetailsException {
	...
	*/
	public static CffDetails fetchByPrimaryKey(int cffDetailsSid) {
		return getPersistence().fetchByPrimaryKey(cffDetailsSid);
	}

	public static java.util.Map<java.io.Serializable, CffDetails> fetchByPrimaryKeys(
	...
	*/
	public static List<CffDetails> findAll() {
	...
	*/
	public static List<CffDetails> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<CffDetailsPersistence, CffDetailsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(CffDetailsPersistence.class);
}