 ...
 * @generated
 */
public class StNewNdcLocalServiceClp implements StNewNdcLocalService {
    ...
    public StNewNdcLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.stpl.app.model.StNewNdc addStNewNdc(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(stNewNdc) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.StNewNdc) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.StNewNdc createStNewNdc(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(stNewNdcPK) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.StNewNdc> getStNewNdcs(int start,
        ...
        return (java.util.List<com.stpl.app.model.StNewNdc>) ClpSerializer.translateOutput(returnObj);
    }
