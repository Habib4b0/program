...
public class LevelDto implements Comparable<LevelDto> {
     ...
     *
     * @param levelValueReference the new level value reference
     */
     ...
     *
     * @param relationshipLevelValue the new relationship level value
     */
     ...
     *
     * @param relationshipLevelSid the new relationship level sid
     */
     ...
     * Sets the level no.
     *
     * @param levelNo the new level no
     */
    ...
    public int hashCode() {
        int hash = 7;
        hash = 29 * hash + Objects.hashCode(this.levelNo);
        return hash;
    }
