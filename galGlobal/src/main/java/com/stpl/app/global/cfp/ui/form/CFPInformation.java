...
public class CFPInformation extends CustomComponent {
    ...
    public CFPInformation(final ErrorfulFieldGroup binder, final SessionDTO sessionDTO) throws Exception {
   ...
   private void configurePermission(final Map<String, AppPermission> fieldCfpHM) {
    ...
    private void configureFields() throws SystemException, PortalException, Exception {
        ...
        companyFamilyPlanNo.setData("maxlengthvalidationfifty,maxlengthvalidationcompanyfamilyplanno,alphaNumericChars,alphaNumericCharsMessage");
        ...
        companyFamilyPlanId.setData("maxlengthvalidationfifty,maxlengthvalidationcompanyfamilyplanId,alphaNumericChars,alphaNumericCharsMessage");
