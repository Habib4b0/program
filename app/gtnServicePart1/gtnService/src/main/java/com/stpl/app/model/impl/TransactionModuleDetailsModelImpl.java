 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link TransactionModuleDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TransactionModuleDetailsImpl}.
 * </p>
 *
 * @author
...
public class TransactionModuleDetailsModelImpl extends BaseModelImpl<TransactionModuleDetails>
	...
	static {
		TABLE_COLUMNS_MAP.put("PROPERTY_INDEX", Types.DOUBLE);
		...
		TABLE_COLUMNS_MAP.put("VALIDATION", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PROPERTY_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("FLAG", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("TRANSACTION_MODULE_DETAILS_SID", Types.INTEGER);
	}
	...
	private static final ClassLoader _classLoader = TransactionModuleDetails.class.getClassLoader();
