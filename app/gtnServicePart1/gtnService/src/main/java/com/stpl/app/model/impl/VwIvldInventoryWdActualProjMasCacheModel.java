...
public class VwIvldInventoryWdActualProjMasCacheModel implements CacheModel<VwIvldInventoryWdActualProjMas>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof VwIvldInventoryWdActualProjMasCacheModel)) {
			return false;
		}

		VwIvldInventoryWdActualProjMasCacheModel vwIvldInventoryWdActualProjMasCacheModel =
			(VwIvldInventoryWdActualProjMasCacheModel)obj;

		if (ivldInventoryWdActualProjMasSid == vwIvldInventoryWdActualProjMasCacheModel.ivldInventoryWdActualProjMasSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldInventoryWdActualProjMasSid);
	}
	...
	public VwIvldInventoryWdActualProjMas toEntityModel() {
		...
		if (companyStringId == null) {
			vwIvldInventoryWdActualProjMasImpl.setCompanyStringId(StringPool.BLANK);
		}
		else {
			vwIvldInventoryWdActualProjMasImpl.setCompanyStringId(companyStringId);
		}
		...
		vwIvldInventoryWdActualProjMasImpl.setCheckRecord(checkRecord);
