...
//                            itemDetailsResultBean.addItem(itemId);
                            IfpLogic.updateTempCheck(sessionDTO, false,psDTO.getTempItemPriceRebateSystemId(),checkbox.getValue());
                        }
                    }
                });
                return checkbox;
...
//                basePrice.addValidator(new RegexpValidator("([|0-9]*.[0-9]{1,2})", "Please Enter Only Numbers with two decimal places"));
...
//                maxIncChange.addValidator(new RegexpValidator("([|0-9]*.[0-9]{1,2})", "Please Enter Only Numbers with two decimal places"));
                ...
                basePriceItemPriceType.setPageLength(7);
                ...
                final ComboBox comboBox = new ComboBox();                
                commonUtil.loadComboBox(comboBox, UIUtils.PRICE_TOLERANCE_INTERVAL, false);
                comboBox.setValue(psDTO.getNetSubsequentPeriodPrice());
                comboBox.addValueChangeListener(new Property.ValueChangeListener() {
                    @Override
                    public void valueChange(Property.ValueChangeEvent event) {
    ...
    public void attachListeners(final AbstractField field, final String component, final Object itemId, final TempPricingDTO temp, final String userId) throws Exception {
