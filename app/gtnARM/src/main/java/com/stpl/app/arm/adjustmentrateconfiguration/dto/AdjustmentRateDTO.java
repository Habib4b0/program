...
public class AdjustmentRateDTO implements Serializable {
    ...
    public AdjustmentRateDTO(int rateConfigDetailsSid, String month, int dateType, String price, String exclusionDetails, int rateBasis, int rateFrequency, Integer ratePeriod, int viewMasterSid) {
    ...
    public AdjustmentRateDTO(int rateConfigDetailsSid, String month, int inventoryCustomer, String inventoryCalculation, String price, int reserveDate, int rateBasis, int rateFrequency, Integer ratePeriod, int inventoryDetails, int viewMasterSid) {
        this.rateConfigDetailsSid = rateConfigDetailsSid;
        this.month = month;
