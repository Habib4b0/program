...
public class HistWorkflowMasterLocalServiceUtil {
    private static HistWorkflowMasterLocalService _service;
    ...
    */
    ...
    public static HistWorkflowMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    HistWorkflowMasterLocalService.class.getName());

            if (invokableLocalService instanceof HistWorkflowMasterLocalService) {
                _service = (HistWorkflowMasterLocalService) invokableLocalService;
            } else {
                _service = new HistWorkflowMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(HistWorkflowMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(HistWorkflowMasterLocalService service) {
    }
}
