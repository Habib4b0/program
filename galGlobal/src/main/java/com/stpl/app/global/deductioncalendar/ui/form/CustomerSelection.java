...
public class CustomerSelection extends CustomComponent {
    ...
    private void configureFields() {
        try {
            ...
            selectionTableLogic.setPageLength(10);
            ...
            list=Arrays.asList(HeaderUtils.CUSTOMER_COLUMNS);
    ...
    private Component loadAvailableTable() {
        availableCustomersTable.setContainerDataSource(availableResultsContainer);
        availableCustomersTable.setSelectable(true);
        availableCustomersTable.setPageLength(10);
        availableCustomersTable.setVisibleColumns(HeaderUtils.CUSTOMER_COLUMNS);
        availableCustomersTable.setColumnHeaders(HeaderUtils.CUSTOMER_HEADERS);
        availableCustomersTable.setFilterBarVisible(true);
        availableCustomersTable.setSizeFull();
        availableCustomersTable.setImmediate(true);
        return availableCustomersTable;
    }

    private Component loadSelectedTable() {
        selectedCustomersTable.clearFilters();
        selectedResultsContainer = new BeanItemContainer<SelectionDTO>(SelectionDTO.class);
        selectedCustomersTable.setContainerDataSource(selectedResultsContainer);
        selectedCustomersTable.setSelectable(true);
        selectedCustomersTable.setPageLength(10);
        selectedCustomersTable.setVisibleColumns(HeaderUtils.CUSTOMER_COLUMNS);
        selectedCustomersTable.setColumnHeaders(HeaderUtils.CUSTOMER_HEADERS);
        selectedCustomersTable.setFilterBarVisible(true);
        selectedCustomersTable.setSizeFull();
        selectedCustomersTable.setImmediate(true);
        return selectedCustomersTable;
    }
    /**
     * The reset Button
     */
                ...
                MessageBox.showPlain(Icon.QUESTION, MessageUtil.getMessage(Message.DC_RESET_HEADER), MessageUtil.getMessage(Message.DC_RESET_MESSAGE), new MessageBoxListener() {
                    ...
                    public void buttonClicked(final ButtonId buttonId) {
                        if (buttonId.name().equals(ConstantsUtils.YES)) {
                            LOGGER.info("Entering reset Button operation in Customer Selection");
                            resetButtonClickLogic();
                            LOGGER.info("Ending reset Button operation in Customer Selection");
                        }
                    }
    ...
    private void searchButton() {
        searchBtn.addClickListener(new Button.ClickListener() {
             ...
             */
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("Entering Search Button operation in Customer Selection");
                try {
                ...
                LOGGER.info("Ending Search Button operation in Customer Selection");
            }
    ...
    private void addButton() {
        addBtn.addClickListener(new Button.ClickListener() {
             ...
             */
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("Entering Add Button operation in Customer Selection");
    ...
    private void addAllButton() {
        addallBtn.addClickListener(new Button.ClickListener() {
             ...
             */
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("Entering Add All Button operation in Customer Selection");
    ...
    private void removeButton() {
        removeBtn.addClickListener(new Button.ClickListener() {
             ...
             */
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("Entering Remove Button operation in Customer Selection");
    ...
    private void removeAllButton() {
        removeallBtn.addClickListener(new Button.ClickListener() {
             ...
             */
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("Entering Remove All Button operation in Customer Selection");
                ...
                LOGGER.info("Ending Remove All Button operation in Customer Selection");
            }
    ...
    public void createWorkSheetContent(final Integer start, final Integer end,  PrintWriter printWriter) throws SystemException, PortalException, Exception {
        try {
        SelectionDTO dto;
