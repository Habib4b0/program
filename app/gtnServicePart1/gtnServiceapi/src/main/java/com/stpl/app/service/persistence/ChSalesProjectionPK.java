 ...
 */
@ProviderType
public class ChSalesProjectionPK implements Comparable<ChSalesProjectionPK>,
	Serializable {
	public int periodSid;
	public int projectionDetailsSid;

	public ChSalesProjectionPK() {
	}

	public ChSalesProjectionPK(int periodSid, int projectionDetailsSid) {
	...
	@Override
	public int compareTo(ChSalesProjectionPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ChSalesProjectionPK)) {
			return false;
		}

		ChSalesProjectionPK pk = (ChSalesProjectionPK)obj;
