...
/**
 * Provides the local service interface for IvldGlCostCenter. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldGlCostCenterLocalServiceUtil
...
public interface IvldGlCostCenterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldGlCostCenterLocalServiceUtil} to access the ivld gl cost center local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldGlCostCenterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
