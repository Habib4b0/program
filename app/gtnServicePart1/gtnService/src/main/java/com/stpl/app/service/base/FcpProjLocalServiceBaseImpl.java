...
import com.stpl.app.service.FcpProjLocalService;
...
/**
 * Provides the base implementation for the fcp proj local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.FcpProjLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class FcpProjLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements FcpProjLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.FcpProjLocalServiceUtil} to access the fcp proj local service.
	 */
	...
	@Override
	public FcpProj addFcpProj(FcpProj fcpProj) {
		fcpProj.setNew(true);

		return fcpProjPersistence.update(fcpProj);
	}
	 ...
	 */
	@Override
	public FcpProj createFcpProj(FcpProjPK fcpProjPK) {
		return fcpProjPersistence.create(fcpProjPK);
	}
	...
	@Override
	public FcpProj deleteFcpProj(FcpProjPK fcpProjPK) throws PortalException {
		return fcpProjPersistence.remove(fcpProjPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FcpProj deleteFcpProj(FcpProj fcpProj) {
		return fcpProjPersistence.remove(fcpProj);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FcpProj.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fcpProjPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return fcpProjPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return fcpProjPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fcpProjPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return fcpProjPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public FcpProj fetchFcpProj(FcpProjPK fcpProjPK) {
		return fcpProjPersistence.fetchByPrimaryKey(fcpProjPK);
	}
	 ...
	 */
	@Override
	public FcpProj getFcpProj(FcpProjPK fcpProjPK) throws PortalException {
		return fcpProjPersistence.findByPrimaryKey(fcpProjPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(fcpProjLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FcpProj.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(fcpProjLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FcpProj.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return fcpProjLocalService.deleteFcpProj((FcpProj)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return fcpProjPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FcpProj> getFcpProjs(int start, int end) {
		return fcpProjPersistence.findAll(start, end);
	}
	...
	public int getFcpProjsCount() {
		return fcpProjPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FcpProj updateFcpProj(FcpProj fcpProj) {
		return fcpProjPersistence.update(fcpProj);
	}
	 ...
	 */
	public FcpProjLocalService getFcpProjLocalService() {
	 ...
	 */
	public void setFcpProjLocalService(FcpProjLocalService fcpProjLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.FcpProj",
			fcpProjLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.FcpProj");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FcpProjLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fcpProjPersistence.getDataSource();
	...
	@BeanReference(type = FcpProjLocalService.class)
	protected FcpProjLocalService fcpProjLocalService;
