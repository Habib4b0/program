 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.stpl.app.model.CompanyQualifierModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CompanyQualifierImpl}.
 * </p>
 *
 * @author
 * @see CompanyQualifierImpl
 * @see com.stpl.app.model.CompanyQualifier
 * @see com.stpl.app.model.CompanyQualifierModel
 * @generated
 */
public class CompanyQualifierModelImpl extends BaseModelImpl<CompanyQualifier>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a company qualifier model instance should use the {@link com.stpl.app.model.CompanyQualifier} interface instead.
     */
    ...
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.stpl.util.service.ServiceProps.get(
            ...
            true);
    public static long COMPANYQUALIFIERNAME_COLUMN_BITMASK = 1L;
    public static long COMPANYQUALIFIERSID_COLUMN_BITMASK = 2L;
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.stpl.util.service.ServiceProps.get(
                "lock.expiration.time.com.stpl.app.model.CompanyQualifier"));
    private static ClassLoader _classLoader = CompanyQualifier.class.getClassLoader();
