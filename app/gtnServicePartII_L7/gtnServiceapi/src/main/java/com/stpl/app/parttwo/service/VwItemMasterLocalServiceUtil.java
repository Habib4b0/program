...
public class VwItemMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<VwItemMasterLocalService, VwItemMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VwItemMasterLocalService.class);
}