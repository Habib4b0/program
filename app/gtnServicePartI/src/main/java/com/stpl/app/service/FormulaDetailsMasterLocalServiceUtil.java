...
public class FormulaDetailsMasterLocalServiceUtil {
    private static FormulaDetailsMasterLocalService _service;
    ...
    */
    ...
    public static FormulaDetailsMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    FormulaDetailsMasterLocalService.class.getName());

            if (invokableLocalService instanceof FormulaDetailsMasterLocalService) {
                _service = (FormulaDetailsMasterLocalService) invokableLocalService;
            } else {
                _service = new FormulaDetailsMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(FormulaDetailsMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(FormulaDetailsMasterLocalService service) {
    }
}
