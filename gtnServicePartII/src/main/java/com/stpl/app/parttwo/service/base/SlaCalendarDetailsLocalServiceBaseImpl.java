...
public abstract class SlaCalendarDetailsLocalServiceBaseImpl
    ...
    private SlaCalendarDetailsLocalServiceClpInvoker _clpInvoker = new SlaCalendarDetailsLocalServiceClpInvoker();
    ...
    public SlaCalendarDetails deleteSlaCalendarDetails(
        int slaCalendarDetailsSid) throws PortalException, SystemException {
     ...
     */
    @Override
    public int getSlaCalendarDetailsesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.SlaCalendarDetails",
