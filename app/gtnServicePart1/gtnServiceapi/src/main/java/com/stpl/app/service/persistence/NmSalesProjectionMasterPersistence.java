...
public interface NmSalesProjectionMasterPersistence extends BasePersistence<NmSalesProjectionMaster> {
	...
	*/
	public void cacheResult(
		java.util.List<NmSalesProjectionMaster> nmSalesProjectionMasters);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, NmSalesProjectionMaster> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<NmSalesProjectionMaster> findAll();
	...
	*/
	public java.util.List<NmSalesProjectionMaster> findAll(int start, int end);
	...
	*/
	public java.util.List<NmSalesProjectionMaster> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<NmSalesProjectionMaster> orderByComparator);
