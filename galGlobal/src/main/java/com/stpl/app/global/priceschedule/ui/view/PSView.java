...
public class PSView extends VerticalLayout implements View {
     ...
     * The Constructor.
     */
    public PSView(final SessionDTO sessionDTO) throws PortalException, SystemException, Exception {
        super();
    ...
    public void enter(final ViewChangeEvent event) {
        try {
            ...
            LOGGER.info("Application logging to the mode :" + mode);
            ...
            if (ConstantsUtils.ADD.equals(mode)) {
                ...
                binder.setItemDataSource(new BeanItem<PSDTO>(dto));
