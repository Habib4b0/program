...
/**
 * Provides the local service interface for MedicaidUraProj. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see MedicaidUraProjLocalServiceUtil
...
public interface MedicaidUraProjLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link MedicaidUraProjLocalServiceUtil} to access the medicaid ura proj local service. Add custom service methods to {@link com.stpl.app.service.impl.MedicaidUraProjLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
