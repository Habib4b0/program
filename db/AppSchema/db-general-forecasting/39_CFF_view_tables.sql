...
IF NOT EXISTS (
		...
		WHERE Object_name(PARENT_OBJECT_ID) = 'CUSTOM_CFF_DISCOUNT'
			AND Schema_name(SCHEMA_ID) = 'DBO'
			AND NAME = 'PK_CUSTOM_CFF_DISCOUNT_HIERARCHY_NO_PERIOD_YEAR_INDICATOR_CFF_MASTER_SID_DEDUCTION_INCLUSION'
			AND TYPE = 'PK'
		)
BEGIN
	ALTER TABLE CUSTOM_CFF_DISCOUNT ADD CONSTRAINT PK_CUSTOM_CFF_DISCOUNT_HIERARCHY_NO_PERIOD_YEAR_INDICATOR_CFF_MASTER_SID_DEDUCTION_INCLUSION PRIMARY KEY (
		HIERARCHY_NO
		,RS_CONTRACT_SID
		,CFF_MASTER_SID
		,PERIOD
