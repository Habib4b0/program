...
public class CommonUtils {
 ...
 public ComboBox getNativeSelect(final ComboBox select, final List<HelperDTO> helperList) {
    ...
    public NativeSelect getPriceTypeNative(final NativeSelect select, final List<HelperDTO> helperList) {
        ...
        LOGGER.debug(STRING_NATIVE_SELECT + select.size());
    ...
    public Container getIdentifier() throws SystemException, PortalException {
        ...
        LOGGER.debug("return Container list size :" + list.size());
     ...
     */
    public NativeSelect getItemStatus(final NativeSelect select) throws SystemException, PortalException {
     ...
     */
    public static boolean isNumeric(final String massValue) {
        LOGGER.debug("isNumeric() P1: str" + massValue);
      boolean flag=false;
      
            if (StringUtils.isNotBlank(massValue) && !massValue.matches(ValidationUtils.REBATE_SCHEDULE_AMT_DOUBLE)) {
                               flag=true;
                             } 
     ...
     * @return the item status
     */
    public ComboBox getItemStatus(final ComboBox select) throws SystemException, PortalException {
    ...
    public static boolean isValidlength(final String massValue) {
        LOGGER.debug("isValidlength() P1: str" + massValue);
      boolean flag=false;
      
            if (StringUtils.isNotBlank(massValue) && !massValue.matches(ValidationUtils.REBATE_SCHEDULE_AMT_SAVE)) {
                               flag=true;
                             } 
    ...
    public ComboBox getNativeSelectNdc(final ComboBox select, final List<ItemMaster> list) {
        select.addItem(ConstantsUtils.SELECT_ONE);
