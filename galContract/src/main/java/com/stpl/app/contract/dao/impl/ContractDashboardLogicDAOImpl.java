 ...
 * @author sibi
 */
public class ContractDashboardLogicDAOImpl implements ContractDashboardDAO {

	/**
	 * Performs a dynamic query on the database and returns the matching rows.
	 *
	 * @param dynamicQuery
	 *            it filter by contractSystemId
	 ...
	 *            to add in CompanyFamilyplanDetails table
	 ...
	 * 
	 * @param cfpDetailsAttached
	 *            is to remove from CompanyFamilyplanDetails table
	 ...
	 * 
	 * @param dynamicQuery
	 *            based on contractSystemId in CfpDetailsAttached table
	 ...
	 *            to add in CfpMasterAttached table
	 ...
	 *
	 * @param cfpMasterAttached
	 *            to delete from CfpMasterAttached table
	 ...
	 *
	 * @param dynamicQuery
	 *            to fetch data based on companyFamilyPlanSystemId table
	 ...
	 * 
	 * @param dynamicQuery
	 *            to execute based on companyFamilyPlanNo from
	 ...
	 *
	 * @param dynamicQuery
	 *            based on contractSystemId from IfpDetailsAttached table
	 ...
	 *            to delete from table IfpDetailsAttached table
	 ...
	 *
	 * @param ifpDetailsAttached
	 *            to add to IfpDetailsAttached table
	 ...
	 *
	 * @param dynamicQuery
	 *            to retrieve data from the table IfpDetailsAttached table
	 ...
	 *            to delete from IfpMasterAttached table
	 ...
	 *
	 * @param ifpMasterAttached
	 *            to add to IfpMasterAttached table
	 ...
	 *
	 * @param dynamicQuery
	 *            to retrieve the data from ItemFamilyplanDetails table
	 ...
	 *
	 * @param dynamicQuery
	 *            to retrieve the data from ItemFamilyplanMaster table.
	 ...
	 * 
	 * @param dynamicQuery
	 *            to get the data from PriceScheduleMaster table
	 ...
	 *
	 * @param id
	 *            to retrieve the data from PriceScheduleMaster
	 ...
	 *
	 * @param dynamicQuery
	 *            to get the data from PsDetailsAttached table
	 ...
	 *            is to remove from PsDetailsAttached
	 ...
	 *
	 * @param psDetailsAttached
	 *            this data is to be add to the database
	 ...
	 *
	 * @param dynamicQuery
	 *            to get the data from PsDetailsAttached
	 ...
	 *            is to remove from PsMasterAttached
	 ...
	 *
	 * @param psMasterAttached
	 *            this data is to be add to the PsMasterAttached
	 ...
	 *
	 * @param dynamicQuery
	 *            o get the data from RebateScheduleDetails
	 ...
	 *
	 * @param dynamicQuery
	 *            to get the data from RebateScheduleMaster
	 ...
	 *
	 * @param id
	 *            - rebateSchedule Id .it is like InternalId
	 * @return row of
	 * @throws SystemException
	 * @throws PortalException
	 */
	 ...
	 *
	 * @param dynamicQuery
	 *            o get the data from RsDetailsAttached
	 ...
	 *            to delete from RsDetailsAttached
	 ...
	 *
	 * @param rsDetailsAttached
	 *            this data is to be add to the RsDetailsAttached
	 ...
	 * Performs a dynamic query on the database and returns the matching rows.
	 *
	 * @param dynamicQueryto
	 *            get the data from RsMasterAttached table
	 ...
	 *            to delete from RsMasterAttached table
	 ...
	 *
	 * @param rsMasterAttached
	 *            this data is to be add to the RsMasterAttached
	 ...
	 * 
	 * @param dynamicQuery
	 *            to get the data from ContractMaster table
	 ...
	 * 
	 * @param id
	 *            to retrieve data based on the id from contract master
	 ...
	 *            to add or update the ContractMaster table
	 ...
	 * 
	 * @param dynamicQuery
	 *            to get the count of data present from ContractMaster table
	 * @return no of data
	 * @throws SystemException
	 */
	...
	/**
	 * Updates the Cfp Master Attached in the CfpMasterAttached or adds it if it does
	 * not yet exist.
	 *
	 * @param cfpMasterAttached
	 *            to add or update the CfpMasterAttached table
	 ...
	 */
        ...
        /**
    	 * Updates the Cfp Details Attached in the CfpDetailsAttached or adds it if it does
    	 * not yet exist.
    	 *
    	 * @param cfpDetailsAttached
    	 *            to add or update the CfpDetailsAttached table
        ...
        /**
    	 * Updates the Ifp Master Attached in the IfpMasterAttached or adds it if it does
    	 * not yet exist.
    	 *
    	 * @param ifpMasterAttached
    	 *            to add or update the IfpMasterAttached table
        ...
        /**
    	 * Updates the Ifp Details Attached in the IfpDetailsAttached or adds it if it does
    	 * not yet exist.
    	 *
    	 * @param ifpDetailsAttached
    	 *            to add or update the IfpDetailsAttached table
        ...
        /**
    	 * Updates the Ps Master Attached in the PsMasterAttached or adds it if it does
    	 * not yet exist.
    	 *
    	 * @param psMasterAttached
    	 *            to add or update the PsMasterAttached table
        ...
        /**
    	 * Updates the Ps Details Attached in the PsDetailsAttached or adds it if it does
    	 * not yet exist.
    	 *
    	 * @param psDetailsAttached
    	 *            to add or update the PsDetailsAttached table
        ...
        /**
    	 * Updates the Rs Master Attached in the RsMasterAttached or adds it if it does
    	 * not yet exist.
    	 *
    	 * @param rsMasterAttached
    	 *            to add or update the RsMasterAttached table
        ...
        /**
    	 * Updates the Rs Details Attached in the RsDetailsAttached or adds it if it does
    	 * not yet exist.
    	 *
    	 * @param rsDetailsAttached
    	 *            to add or update the RsDetailsAttached table
