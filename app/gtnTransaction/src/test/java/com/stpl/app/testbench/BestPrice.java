...
public class BestPrice extends TestBenchTestCase{
	...
	public void setUp() throws Exception {		
		...
		findElement(By.xpath(".//span[contains(text(),' Best Price')]")).click();
		
	}
	@Test
	public void bestPrice1() {
	...
	@Test
	public void bestPrice4() throws Exception {
		$(ButtonElement.class).caption("Search").first().click();
		Assert.assertEquals("Search operation failed", "Search Completed",$(NotificationElement.class).first().getText());
