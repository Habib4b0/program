...
/**
 * Provides the local service interface for PsModel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see PsModelLocalServiceUtil
...
public interface PsModelLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PsModelLocalServiceUtil} to access the ps model local service. Add custom service methods to {@link com.stpl.app.service.impl.PsModelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public PsModel addPsModel(PsModel psModel);
	...
	*/
	...
	public PsModel deletePsModel(int psModelSid) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public PsModel deletePsModel(PsModel psModel);
	...
	*/
	...
	public PsModel fetchPsModel(int psModelSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PsModel getPsModel(int psModelSid) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public PsModel updatePsModel(PsModel psModel);
}