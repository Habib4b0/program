...
public class AccrualDetailsCacheModel implements CacheModel<AccrualDetails>,
    ...
    public String companyIdentifierCodeQualifier;
    ...
    public AccrualDetails toEntityModel() {
        ...
        if (companyIdentifierCodeQualifier == null) {
            accrualDetailsImpl.setCompanyIdentifierCodeQualifier(StringPool.BLANK);
        } else {
            accrualDetailsImpl.setCompanyIdentifierCodeQualifier(companyIdentifierCodeQualifier);
        }
        ...
        if (companyId == null) {
            accrualDetailsImpl.setCompanyId(StringPool.BLANK);
        } else {
            accrualDetailsImpl.setCompanyId(companyId);
        }
    ...
    public void readExternal(ObjectInput objectInput) throws IOException {
        ...
        companyIdentifierCodeQualifier = objectInput.readUTF();
    ...
    public void writeExternal(ObjectOutput objectOutput)
        ...
        if (companyIdentifierCodeQualifier == null) {
            ...
            objectOutput.writeUTF(companyIdentifierCodeQualifier);
        }
