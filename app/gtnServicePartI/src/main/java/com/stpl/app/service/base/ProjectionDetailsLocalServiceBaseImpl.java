...
import com.stpl.app.service.ProjectionDetailsLocalService;
...
/**
 * Provides the base implementation for the projection details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ProjectionDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ProjectionDetailsLocalServiceImpl
 * @see com.stpl.app.service.ProjectionDetailsLocalServiceUtil
 * @generated
 */
public abstract class ProjectionDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ProjectionDetailsLocalService,
        IdentifiableBean {
    ...
    private ProjectionDetailsLocalServiceClpInvoker _clpInvoker = new ProjectionDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ProjectionDetailsLocalServiceUtil} to access the projection details local service.
     */
    ...
    @Override
    public ProjectionDetails addProjectionDetails(
        ProjectionDetails projectionDetails) throws SystemException {
        projectionDetails.setNew(true);

        return projectionDetailsPersistence.update(projectionDetails);
    }
     ...
     */
    @Override
    public ProjectionDetails createProjectionDetails(int projectionDetailsSid) {
        return projectionDetailsPersistence.create(projectionDetailsSid);
    }
    ...
    @Override
    public ProjectionDetails deleteProjectionDetails(int projectionDetailsSid)
        throws PortalException, SystemException {
        return projectionDetailsPersistence.remove(projectionDetailsSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ProjectionDetails deleteProjectionDetails(
        ProjectionDetails projectionDetails) throws SystemException {
        return projectionDetailsPersistence.remove(projectionDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ProjectionDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return projectionDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return projectionDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ProjectionDetails fetchProjectionDetails(int projectionDetailsSid)
        throws SystemException {
        return projectionDetailsPersistence.fetchByPrimaryKey(projectionDetailsSid);
    }
     ...
     */
    @Override
    public ProjectionDetails getProjectionDetails(int projectionDetailsSid)
        throws PortalException, SystemException {
        return projectionDetailsPersistence.findByPrimaryKey(projectionDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return projectionDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ProjectionDetails> getProjectionDetailses(int start, int end)
        throws SystemException {
        return projectionDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getProjectionDetailsesCount() throws SystemException {
        return projectionDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ProjectionDetails updateProjectionDetails(
        ProjectionDetails projectionDetails) throws SystemException {
        return projectionDetailsPersistence.update(projectionDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ProjectionDetails",
            projectionDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.ProjectionDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = projectionDetailsPersistence.getDataSource();
