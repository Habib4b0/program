...
public class GtnWsAverageMethodology implements GtnWsMethodology {
	...
	public void calculateBaseline() {
		try {
			GtnWsBaseline baseline = GtnWsBaselineType.AVERAGE_BASELINE.getBaseline();
	...
	/**
	 * Method writes the output to the given file.
	 * 
	...
	/**
	 * Calculation will be based on a component displayed in screen. This method
	 * is used to calculate the selected component.In Some modules, there will
	 * be no selected components.In that scenario, there will be a predefined
	 * component for calculation.
	 * 
	 * <p>
	 * Example: calculation: Sales Based.
	 * <p>
	 * Then this method is used to calculate the Sales Value.
	 * 
	 * 
	 * @param baselineValue
	...
	/**
	 * The Selected Component is calculated in applyCalculation(...). Other
	 * components displayed in the screen are calculated in this method based on
	 * the result of applyCalculation(...) method. In Some modules, there will
	 * be no selected components.In that scenario, there will be a predefined
	 * component for calculation.
	 * 
	 * 
	...
	/**
	 * Method used to read the files from the given path in methodology bean.
	 * 
	 * @param methodologyBean
	 * @throws Exception
	 */
