...
/**
 * The persistence utility for the module properties service. This utility wraps {@link ModulePropertiesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ModulePropertiesUtil {
    private static ModulePropertiesPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.ModuleProperties create(
    ...
    */
    public static com.stpl.app.model.ModuleProperties remove(
        int modulePropertySid)
    ...
    public static com.stpl.app.model.ModuleProperties updateImpl(
        com.stpl.app.model.ModuleProperties moduleProperties)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.ModuleProperties findByPrimaryKey(
        int modulePropertySid)
        throws com.stpl.app.NoSuchModulePropertiesException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.ModuleProperties fetchByPrimaryKey(
        int modulePropertySid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.ModuleProperties> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static ModulePropertiesPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (ModulePropertiesPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    ModulePropertiesPersistence.class.getName());

            ReferenceRegistry.registerReference(ModulePropertiesUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(ModulePropertiesPersistence persistence) {
    }
}
