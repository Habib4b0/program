...
/**
 * The persistence utility for the vwcompany identifier service. This utility wraps {@link com.stpl.app.parttwo.service.persistence.impl.VwcompanyIdentifierPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class VwcompanyIdentifierUtil {
	...
	*/
	public static void cacheResult(VwcompanyIdentifier vwcompanyIdentifier) {
	...
	*/
	public static void cacheResult(
		List<VwcompanyIdentifier> vwcompanyIdentifiers) {
	...
	*/
	public static VwcompanyIdentifier create(int companyIdentifierSid) {
	...
	*/
	public static VwcompanyIdentifier remove(int companyIdentifierSid)
		throws com.stpl.app.parttwo.exception.NoSuchVwcompanyIdentifierException {
		return getPersistence().remove(companyIdentifierSid);
	}

	public static VwcompanyIdentifier updateImpl(
		VwcompanyIdentifier vwcompanyIdentifier) {
	...
	* @throws NoSuchVwcompanyIdentifierException if a vwcompany identifier with the primary key could not be found
	*/
	public static VwcompanyIdentifier findByPrimaryKey(int companyIdentifierSid)
		throws com.stpl.app.parttwo.exception.NoSuchVwcompanyIdentifierException {
	...
	*/
	public static VwcompanyIdentifier fetchByPrimaryKey(
		int companyIdentifierSid) {
		return getPersistence().fetchByPrimaryKey(companyIdentifierSid);
	}

	public static java.util.Map<java.io.Serializable, VwcompanyIdentifier> fetchByPrimaryKeys(
	...
	*/
	public static List<VwcompanyIdentifier> findAll() {
	...
	*/
	public static List<VwcompanyIdentifier> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<VwcompanyIdentifierPersistence, VwcompanyIdentifierPersistence> _serviceTracker =
		ServiceTrackerFactory.open(VwcompanyIdentifierPersistence.class);
}