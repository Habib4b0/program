 ...
 * @generated
 */
public class MProjectionSelectionLocalServiceClp
    ...
    public MProjectionSelectionLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addMProjectionSelection";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.MProjectionSelection"
            };

        _methodName1 = "createMProjectionSelection";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteMProjectionSelection";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteMProjectionSelection";
        ...
        _methodName10 = "fetchMProjectionSelection";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getMProjectionSelection";
        ...
        _methodName13 = "getMProjectionSelections";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getMProjectionSelectionsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateMProjectionSelection";
    ...
    public com.stpl.app.model.MProjectionSelection addMProjectionSelection(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(mProjectionSelection)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.MProjectionSelection) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.MProjectionSelection createMProjectionSelection(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { mProjectionSelectionSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.MProjectionSelection> getMProjectionSelections(
        ...
        return (java.util.List<com.stpl.app.model.MProjectionSelection>) ClpSerializer.translateOutput(returnObj);
    }
