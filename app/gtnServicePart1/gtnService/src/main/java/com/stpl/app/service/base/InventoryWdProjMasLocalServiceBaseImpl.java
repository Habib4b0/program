...
import com.stpl.app.service.InventoryWdProjMasLocalService;
...
/**
 * Provides the base implementation for the inventory wd proj mas local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.InventoryWdProjMasLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.InventoryWdProjMasLocalServiceImpl
 * @see com.stpl.app.service.InventoryWdProjMasLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class InventoryWdProjMasLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InventoryWdProjMasLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.InventoryWdProjMasLocalServiceUtil} to access the inventory wd proj mas local service.
	 */
	...
	@Override
	public InventoryWdProjMas addInventoryWdProjMas(
		InventoryWdProjMas inventoryWdProjMas) {
		inventoryWdProjMas.setNew(true);

		return inventoryWdProjMasPersistence.update(inventoryWdProjMas);
	}
	 ...
	 */
	@Override
	public InventoryWdProjMas createInventoryWdProjMas(
		int inventoryWdProjMasSid) {
		return inventoryWdProjMasPersistence.create(inventoryWdProjMasSid);
	}
	...
	@Override
	public InventoryWdProjMas deleteInventoryWdProjMas(
		int inventoryWdProjMasSid) throws PortalException {
		return inventoryWdProjMasPersistence.remove(inventoryWdProjMasSid);
	}
	...
	public InventoryWdProjMas deleteInventoryWdProjMas(
		InventoryWdProjMas inventoryWdProjMas) {
		return inventoryWdProjMasPersistence.remove(inventoryWdProjMas);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(InventoryWdProjMas.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return inventoryWdProjMasPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return inventoryWdProjMasPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public InventoryWdProjMas fetchInventoryWdProjMas(int inventoryWdProjMasSid) {
		return inventoryWdProjMasPersistence.fetchByPrimaryKey(inventoryWdProjMasSid);
	}
	 ...
	 */
	@Override
	public InventoryWdProjMas getInventoryWdProjMas(int inventoryWdProjMasSid)
		throws PortalException {
		return inventoryWdProjMasPersistence.findByPrimaryKey(inventoryWdProjMasSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(inventoryWdProjMasLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(InventoryWdProjMas.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(inventoryWdProjMasLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(InventoryWdProjMas.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return inventoryWdProjMasLocalService.deleteInventoryWdProjMas((InventoryWdProjMas)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return inventoryWdProjMasPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<InventoryWdProjMas> getInventoryWdProjMases(int start, int end) {
		return inventoryWdProjMasPersistence.findAll(start, end);
	}
	...
	public int getInventoryWdProjMasesCount() {
		return inventoryWdProjMasPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public InventoryWdProjMas updateInventoryWdProjMas(
		InventoryWdProjMas inventoryWdProjMas) {
		return inventoryWdProjMasPersistence.update(inventoryWdProjMas);
	}
	 ...
	 */
	public InventoryWdProjMasLocalService getInventoryWdProjMasLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.InventoryWdProjMas",
			inventoryWdProjMasLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.InventoryWdProjMas");
	}
	...
	public String getOSGiServiceIdentifier() {
		return InventoryWdProjMasLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = inventoryWdProjMasPersistence.getDataSource();
	...
	@BeanReference(type = InventoryWdProjMasLocalService.class)
	protected InventoryWdProjMasLocalService inventoryWdProjMasLocalService;
