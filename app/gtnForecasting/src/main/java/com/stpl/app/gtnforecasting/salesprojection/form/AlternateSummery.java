                            ...
                            if (!oldValue.equals(newValue)) {
                                try {
                                    ...
                                    if (CommonUtils.BUSINESS_PROCESS_TYPE_RETURNS.equalsIgnoreCase(screenName)) {
                                        ...
                                        salesLogic.saveEditedRecs(propertyId.toString(), changedValue, incOrDecValue, changedProperty, salesRowDto, projectionDTO, new Object[]{checkAll, !tempArray1[0].contains(Constant.GROWTH)});
                                    }
