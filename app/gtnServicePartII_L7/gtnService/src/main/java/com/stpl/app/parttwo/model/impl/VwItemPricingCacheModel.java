...
public class VwItemPricingCacheModel implements CacheModel<VwItemPricing>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof VwItemPricingCacheModel)) {
			return false;
		}

		VwItemPricingCacheModel vwItemPricingCacheModel = (VwItemPricingCacheModel)obj;

		if (itemPricingSid == vwItemPricingCacheModel.itemPricingSid) {
			return true;
		}
