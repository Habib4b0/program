...
public abstract class RsModelLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements RsModelLocalService, IdentifiableBean {
    ...
    private RsModelLocalServiceClpInvoker _clpInvoker = new RsModelLocalServiceClpInvoker();
    ...
    @Override
    public RsModel addRsModel(RsModel rsModel) throws SystemException {
        rsModel.setNew(true);
    ...
    @Override
    public RsModel deleteRsModel(int rsModelSid)
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public RsModel deleteRsModel(RsModel rsModel) throws SystemException {
    ...
    @Override
    public RsModel fetchRsModel(int rsModelSid) throws SystemException {
     ...
     */
    @Override
    public RsModel getRsModel(int rsModelSid)
        throws PortalException, SystemException {
     ...
     */
    @Override
    public int getRsModelsCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public RsModel updateRsModel(RsModel rsModel) throws SystemException {
        return rsModelPersistence.update(rsModel);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.RsModel",
            rsModelLocalService);
    }
