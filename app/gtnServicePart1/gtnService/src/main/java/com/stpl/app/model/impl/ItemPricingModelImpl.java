 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ItemPricingModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ItemPricingImpl}.
 * </p>
 *
 * @author
 * @see ItemPricingImpl
...
public class ItemPricingModelImpl extends BaseModelImpl<ItemPricing>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ITEM_PRICE", Types.DOUBLE);
		...
		TABLE_COLUMNS_MAP.put("ITEM_UOM", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("PRICING_CODE_STATUS", Types.INTEGER);
	...
	public static final long ITEMUOM_COLUMN_BITMASK = 4L;
	public static final long PRICINGCODESTATUS_COLUMN_BITMASK = 8L;
	public static final long STARTDATE_COLUMN_BITMASK = 16L;
	public static final long ITEMPRICINGSID_COLUMN_BITMASK = 32L;
	...
	private static final ClassLoader _classLoader = ItemPricing.class.getClassLoader();
