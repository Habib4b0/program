...
public class RelationshipLevelDefinitionLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<RelationshipLevelDefinitionLocalService, RelationshipLevelDefinitionLocalService> _serviceTracker =
		ServiceTrackerFactory.open(RelationshipLevelDefinitionLocalService.class);
}