...
public class ProductGroupLookUp extends Window {
    ...
    private static final Logger LOGGER = org.jboss.logging.Logger.getLogger(ProductGroupLookUp.class);
     ...
     * @param sidQuery
     */
    public ProductGroupLookUp(final String indicator, final String windowName,
    ...
    public void init() {
        ...
        setContent(Clara.create(getClass().getResourceAsStream("/brprodGroupLook.xml"), this));
        addCustomerTable();
        configureFields();
    }
    ...
    private ExtFilterTable addCustomerTable() {
        ...
        resultTable.setVisibleColumns(HeaderUtils.BR_PROD_VISIBLE_COLUMN);
        resultTable.setColumnHeaders(HeaderUtils.BR_PROD_COLUMN_HEADER);
    ...
    private void configureFields() {
        ...
        productGroupName.setMaxLength(100);
        productGroupNo.setMaxLength(100);
        ...
        try {
            ...
            if ((StringUtils.EMPTY.equals(productGroupName.getValue().trim()) || "null".equals(productGroupName.getValue().trim()))
                ...
                if (INDICATOR_CUSTOMER_GROUP.getConstant().equals(indicator)) {
                    ...
                    AbstractNotificationUtils.getErrorNotification("No Records Found", "Please enter either a Product Group Name, or Product Group #. ");
                }
            } else {
    ...
    protected void btnLookupSelectLogic() {
        if (resultTable != null && resultTable.getValue() != null) {
            ...
            MessageBox.showPlain(Icon.QUESTION, "Notification", " Please select a Product/Group from the Results section.", new MessageBoxListener() {
                public void buttonClicked(ButtonId buttonId) {
                    if (buttonId.name().equals("OK")) {
                        try {
                            close();
