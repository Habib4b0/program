...
public class NotesTextField extends CustomField {
    ...
    private void configureFields() {
        ...
        txtArea.addValidator(new StringLengthValidator("  Adjustment Tool tip length should be less than 500 characters", 0, 201, true));
        textField.addValidator(new StringLengthValidator("  Adjustment field length should be less than 200 characters", 0, 200, true));
