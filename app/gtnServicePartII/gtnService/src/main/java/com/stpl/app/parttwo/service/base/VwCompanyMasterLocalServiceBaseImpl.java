...
import com.stpl.app.parttwo.service.VwCompanyMasterLocalService;
...
/**
 * Provides the base implementation for the vw company master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwCompanyMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwCompanyMasterLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwCompanyMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VwCompanyMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VwCompanyMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwCompanyMasterLocalServiceUtil} to access the vw company master local service.
	 */
	...
	@Override
	public VwCompanyMaster addVwCompanyMaster(VwCompanyMaster vwCompanyMaster) {
		vwCompanyMaster.setNew(true);

		return vwCompanyMasterPersistence.update(vwCompanyMaster);
	}
	 ...
	 */
	@Override
	public VwCompanyMaster createVwCompanyMaster(int companyMasterSid) {
		return vwCompanyMasterPersistence.create(companyMasterSid);
	}
	...
	@Override
	public VwCompanyMaster deleteVwCompanyMaster(int companyMasterSid)
		throws PortalException {
		return vwCompanyMasterPersistence.remove(companyMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VwCompanyMaster deleteVwCompanyMaster(
		VwCompanyMaster vwCompanyMaster) {
		return vwCompanyMasterPersistence.remove(vwCompanyMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VwCompanyMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vwCompanyMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vwCompanyMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VwCompanyMaster fetchVwCompanyMaster(int companyMasterSid) {
		return vwCompanyMasterPersistence.fetchByPrimaryKey(companyMasterSid);
	}
	 ...
	 */
	@Override
	public VwCompanyMaster getVwCompanyMaster(int companyMasterSid)
		throws PortalException {
		return vwCompanyMasterPersistence.findByPrimaryKey(companyMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vwCompanyMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VwCompanyMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("companyMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vwCompanyMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VwCompanyMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vwCompanyMasterLocalService.deleteVwCompanyMaster((VwCompanyMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vwCompanyMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VwCompanyMaster> getVwCompanyMasters(int start, int end) {
		return vwCompanyMasterPersistence.findAll(start, end);
	}
	...
	public int getVwCompanyMastersCount() {
		return vwCompanyMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VwCompanyMaster updateVwCompanyMaster(
		VwCompanyMaster vwCompanyMaster) {
		return vwCompanyMasterPersistence.update(vwCompanyMaster);
	}
	 ...
	 */
	public VwCompanyMasterLocalService getVwCompanyMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.VwCompanyMaster",
			vwCompanyMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VwCompanyMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vwCompanyMasterPersistence.getDataSource();
	...
	@BeanReference(type = VwCompanyMasterLocalService.class)
	protected VwCompanyMasterLocalService vwCompanyMasterLocalService;
