 ...
 *
 * @author
 * @see ItemGroupLocalServiceBaseImpl
...
public class ItemGroupLocalServiceImpl extends ItemGroupLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link com.stpl.app.service.ItemGroupLocalServiceUtil} to access the item group local service.
	 */
}