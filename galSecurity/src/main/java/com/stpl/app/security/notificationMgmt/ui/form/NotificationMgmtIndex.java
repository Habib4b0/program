...
//        table.setFilterDecorator(new DemoFilterDecorator());
        ...
        table.addItemClickListener(new ItemClickEvent.ItemClickListener() {
            ...
            public void itemClick(ItemClickEvent event) {
                try {
                  //  notificationMgmtBinder.commit();
                    if (event.getItem() != null) {
                     //   NotificationMgmtIndexDTO notificationMgmtIndexDTO = (NotificationMgmtIndexDTO) event.getItemId();
...
//                NotificationMgmtIndexDTO notificationMgmtIndexDTO = (NotificationMgmtIndexDTO) (event.getProperty().getValue());
//                mailNotificationSystemId = notificationMgmtIndexDTO.getMailNotificationSystemId();
//                notificationMgmtBinder.setItemDataSource(new BeanItem<NotificationMgmtIndexDTO>(notificationMgmtIndexDTO));
//            }
//        });
...
//        leftVertical.setMargin(true);
//        leftVertical.setSpacing(true);
        GridLayout grigForleftVertical = new GridLayout(2, 4);
...
//        rightVertical.setWidth("95%");
//        rightVertical.addComponent(grigForrightVertical);
    ...
    public void loadTable(Object mode) {
        ...
        if ("Edit".equals(editORDelete) || "Delete".equals(editORDelete)) {
            List<NotificationMgmtIndexDTO> resultBean = notificationLogic.loadTable();
            notificationIndexBean.addAll(resultBean);
        }
    ...
    protected NotificationMgmtIndexDTO resultsItemClick(Object id) {
        if (id != null) {
            /*
             * delete.setEnabled(true); view.setEnabled(true);
