...
import com.stpl.app.parttwo.service.IvldCompanyParentLocalService;
...
/**
 * Provides the base implementation for the ivld company parent local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.IvldCompanyParentLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.IvldCompanyParentLocalServiceImpl
 * @see com.stpl.app.parttwo.service.IvldCompanyParentLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldCompanyParentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldCompanyParentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldCompanyParentLocalServiceUtil} to access the ivld company parent local service.
	 */
	...
	@Override
	public IvldCompanyParent addIvldCompanyParent(
		IvldCompanyParent ivldCompanyParent) {
		ivldCompanyParent.setNew(true);

		return ivldCompanyParentPersistence.update(ivldCompanyParent);
	}
	 ...
	 */
	@Override
	public IvldCompanyParent createIvldCompanyParent(int ivldCompanyParentSid) {
		return ivldCompanyParentPersistence.create(ivldCompanyParentSid);
	}
	...
	@Override
	public IvldCompanyParent deleteIvldCompanyParent(int ivldCompanyParentSid)
		throws PortalException {
		return ivldCompanyParentPersistence.remove(ivldCompanyParentSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IvldCompanyParent deleteIvldCompanyParent(
		IvldCompanyParent ivldCompanyParent) {
		return ivldCompanyParentPersistence.remove(ivldCompanyParent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldCompanyParent.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldCompanyParentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldCompanyParentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldCompanyParent fetchIvldCompanyParent(int ivldCompanyParentSid) {
		return ivldCompanyParentPersistence.fetchByPrimaryKey(ivldCompanyParentSid);
	}
	 ...
	 */
	@Override
	public IvldCompanyParent getIvldCompanyParent(int ivldCompanyParentSid)
		throws PortalException {
		return ivldCompanyParentPersistence.findByPrimaryKey(ivldCompanyParentSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldCompanyParentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldCompanyParent.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ivldCompanyParentSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldCompanyParentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldCompanyParent.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldCompanyParentLocalService.deleteIvldCompanyParent((IvldCompanyParent)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldCompanyParentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldCompanyParent> getIvldCompanyParents(int start, int end) {
		return ivldCompanyParentPersistence.findAll(start, end);
	}
	...
	public int getIvldCompanyParentsCount() {
		return ivldCompanyParentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldCompanyParent updateIvldCompanyParent(
		IvldCompanyParent ivldCompanyParent) {
		return ivldCompanyParentPersistence.update(ivldCompanyParent);
	}
	 ...
	 */
	public IvldCompanyParentLocalService getIvldCompanyParentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.IvldCompanyParent",
			ivldCompanyParentLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldCompanyParentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldCompanyParentPersistence.getDataSource();
	...
	@BeanReference(type = IvldCompanyParentLocalService.class)
	protected IvldCompanyParentLocalService ivldCompanyParentLocalService;
