...
public class StMAssumptionsLocalServiceUtil {
    private static StMAssumptionsLocalService _service;
    ...
    */
    ...
    public static StMAssumptionsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StMAssumptionsLocalService.class.getName());

            if (invokableLocalService instanceof StMAssumptionsLocalService) {
                _service = (StMAssumptionsLocalService) invokableLocalService;
            } else {
                _service = new StMAssumptionsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StMAssumptionsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StMAssumptionsLocalService service) {
    }
}
