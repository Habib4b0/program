...
/**
 * Provides the local service interface for HistCompanyGroupDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see HistCompanyGroupDetailsLocalServiceUtil
...
public interface HistCompanyGroupDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HistCompanyGroupDetailsLocalServiceUtil} to access the hist company group details local service. Add custom service methods to {@link com.stpl.app.service.impl.HistCompanyGroupDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
