...
/**
 * The persistence utility for the ivld company identifier service. This utility wraps {@link IvldCompanyIdentifierPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class IvldCompanyIdentifierUtil {
    private static IvldCompanyIdentifierPersistence _persistence;
    ...
    */
    public static com.stpl.app.parttwo.model.IvldCompanyIdentifier create(
    ...
    */
    public static com.stpl.app.parttwo.model.IvldCompanyIdentifier remove(
        int ivldCompanyIdentifierSid)
    ...
    public static com.stpl.app.parttwo.model.IvldCompanyIdentifier updateImpl(
        com.stpl.app.parttwo.model.IvldCompanyIdentifier ivldCompanyIdentifier)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.IvldCompanyIdentifier findByPrimaryKey(
        int ivldCompanyIdentifierSid)
        throws com.stpl.app.parttwo.NoSuchIvldCompanyIdentifierException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.IvldCompanyIdentifier fetchByPrimaryKey(
        int ivldCompanyIdentifierSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.parttwo.model.IvldCompanyIdentifier> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static IvldCompanyIdentifierPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (IvldCompanyIdentifierPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.parttwo.service.ClpSerializer.getServletContextName(),
                    IvldCompanyIdentifierPersistence.class.getName());

            ReferenceRegistry.registerReference(IvldCompanyIdentifierUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(IvldCompanyIdentifierPersistence persistence) {
    }
}
