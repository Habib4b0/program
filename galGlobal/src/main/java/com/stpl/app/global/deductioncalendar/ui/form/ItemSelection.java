...
public class ItemSelection extends CustomComponent {
    ...
    private void configureFields() {
        try {
            ...
            availableTableLogic.setPageLength(10);
            ...
            availableItemTable.setPageLength(10);
            ...
            list=Arrays.asList(HeaderUtils.ITEM_COLUMNS);
            ...
            selectedTableLogic.setPageLength(10);
            ...
            selectedItemTable.setPageLength(10);
    ...
    public void btnSearchLogic(Button.ClickEvent event) {
        ...
        if ((selectionDTO.getItemTypeDdlb() != null && !ConstantUtil.SELECT_ONE.equals(selectionDTO.getItemTypeDdlb().getDescription()) && !selectionDTO.getItemTypeDdlb().getDescription().trim().isEmpty()) 
            ...
            if(!searchValue){
                    CommonUIUtils.successNotification(com.stpl.app.util.ConstantUtil.NO_RESULTS_COMPLETED);
                    } else {
                    CommonUIUtils.successNotification(com.stpl.app.util.ConstantUtil.SEARCH_COMPLETED);
                    }
    ...
    public void createWorkSheetContent(final Integer start, final Integer end, final PrintWriter printWriter) throws SystemException, PortalException, Exception {
        ...
        for (int rowCount = 0; rowCount < searchList.size(); rowCount++) {
            ...
            printWriter.print(ConstantsUtils.QUOTE + dto.getItemStartDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getItemEndDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            ...
            printWriter.print(ConstantsUtils.QUOTE + dto.getPackageSizeIntroDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            ...
            printWriter.print(ConstantsUtils.QUOTE + dto.getAcquisitionDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getAuthorizedGeneric() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getAuthorizedGenericStartDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getAuthorizedGenericEndDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getFirstSaleDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            ...
            printWriter.print(ConstantsUtils.QUOTE + dto.getMarketTerminationDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            ...
            printWriter.print(ConstantsUtils.QUOTE + dto.getNewFormulationStartDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getNewFormulationEndDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getPediatricExclusiveIndicator() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getPediatricExclusiveEndDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getPediatricExclusiveStartDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getClottingFactorIndicator() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getClottingFactorStartDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getClottingFactorEndDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            ...
            printWriter.print(ConstantsUtils.QUOTE + dto.getDiscontinuationDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            printWriter.print(ConstantsUtils.QUOTE + dto.getLastLotExpirationDate() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
            ...
            printWriter.println(ConstantsUtils.QUOTE + dto.getBaseYearCPI() + ConstantsUtils.QUOTE + ExcelExportUtil.COMMA);
        }
    }
    /**
        ...
        addBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                try {
                    ...
                    LOGGER.info("Entering inside  Add Item Method");
    ...
    public void removeallBtn() {
        ...
        removeallBtn.addClickListener(new Button.ClickListener() {
             ...
             */
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("Entering inside Remove All Item Method");
                try {
                ...
                LOGGER.info("ENDING  Remove All Item Method ");
            }
        });
    }
    ...
    public void disableFieldsOnView(){
         ...
         excludeButtonLayout.setVisible(false);
    ...
    public  void resetBtnLogic(){
       LOGGER.info("Entering reset Button in Deduction Calendar Form");
       binder.getErrorDisplay().clearError();
       ...
       LOGGER.info("Ending reset Button in Deduction Calendar Form");
    }
