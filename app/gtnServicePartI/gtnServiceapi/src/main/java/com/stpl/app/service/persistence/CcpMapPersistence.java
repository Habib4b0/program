...
public interface CcpMapPersistence extends BasePersistence<CcpMap> {
	...
	*/
	public void cacheResult(java.util.List<CcpMap> ccpMaps);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CcpMap> fetchByPrimaryKeys(
	...
	* @return the ccp maps
	*/
	public java.util.List<CcpMap> findAll();
	...
	*/
	public java.util.List<CcpMap> findAll(int start, int end);
	...
	*/
	public java.util.List<CcpMap> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CcpMap> orderByComparator);
