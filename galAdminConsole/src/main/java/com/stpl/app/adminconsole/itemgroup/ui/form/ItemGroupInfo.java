...
public class ItemGroupInfo extends CustomComponent implements View {
    ...
    public ItemGroupInfo(final ItemGroupDTO itemGroupDTO, final ErrorfulFieldGroup itemGroupBinder, final ErrorfulFieldGroup itemBinder, final ItemDetailsDTO itemDetailsDTO,
        ...
        super();
        LOGGER.info("ItemGroupInfo Constructor started");
        try {
            this.itemGroupDTO = itemGroupDTO;
            this.itemGroupBinder = itemGroupBinder;
            this.itemBinder = itemBinder;
        ...
        LOGGER.info("ItemGroupInfo Constructor Ended");
    }
    ...
    private ErrorfulFieldGroup getItemGroupBinder() {
        LOGGER.info("getItemGroupBinder method started");
    ...
    private ErrorfulFieldGroup getItemBinder() {
        ...
        LOGGER.info("getItemBinder method Ended");
        return itemBinder;
    }
     ...
     * @throws Exception the exception
     */
    private ExtFilterTable addItemAvailableResults() throws SystemException, PortalException, Exception {
        try {
            LOGGER.info("addItemAvailableResults method started");
            ...
            availableResults.setPageLength(7);
            ...
            final Object[] obj = new Object[]{"itemStartDate", "itemEndDate", "packageSizeIntroDate", "upps", "manufacturerId", "manufacturerNo", "manufacturerName", "labelerCode", "organizationKey",
                "acquisitionDate", "authorizedGenericStartDate", "authorizedGenericEndDate", "firstSaleDate", "marketTerminationDate", "newFormulationStartDate", "newFormulationEndDate",
                "pediatricExclusiveStartDate", "pediatricExclusiveEndDate", "clottingFactorStartDate", "clottingFactorEndDate", "discontinuationDate", "lastLotExpirationDate"};
            LOGGER.info("addItemAvailableResults method Ended");
     ...
     * @throws Exception the exception
     */
    private ExtFilterTable addItemSelectedResults() throws Exception {
        try {
            LOGGER.info("addItemSelectedResults method started");
            ...
            final Object[] obj = new Object[]{"itemStartDate", "itemEndDate", "packageSizeIntroDate", "upps", "manufacturerId", "manufacturerNo", "manufacturerName", "labelerCode", "organizationKey",
                "acquisitionDate", "authorizedGenericStartDate", "authorizedGenericEndDate", "firstSaleDate", "marketTerminationDate", "newFormulationStartDate", "newFormulationEndDate",
                "pediatricExclusiveStartDate", "pediatricExclusiveEndDate", "clottingFactorStartDate", "clottingFactorEndDate", "discontinuationDate", "lastLotExpirationDate"};
            LOGGER.info("addItemSelectedResults method ended");
    ...
    private void configureFields() throws SystemException {
        ...
        itemGroupName.setMaxLength(100);
        itemGroupNo.setMaxLength(100);
        itemGroupDesc.setMaxLength(100);
        ...
        therapeuticClassDdlb = CommonUtil.getComboBox(therapeuticClassDdlb, "ITEM_THERP_CLASS");
        ...
        availableResultsExcelExport.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("In configureFields availableResultsExcelExport.addClickListener started");
                ...
                LOGGER.info("In configureFields availableResultsExcelExport.addClickListener Ended");
            }
        });
    ...
    public void detachListeners(final AbstractField field) {
        LOGGER.info("detachListeners method started");
        ...
        LOGGER.info("detachListeners method ended");
    }
    ...
    private void save() {
        try {
            ...
            if (!idList.isEmpty() && (page.equalsIgnoreCase("Add") || page.equalsIgnoreCase("Copy"))) {
                LOGGER.info("Inside if 0" + idList.get(0));
                LOGGER.info("Inside if 1" + idList.get(1));
    ...
    protected void companyOnChangeEvent(final Object companyValue) {
        LOGGER.info("companyOnChangeEvent method started with companyValue: " + companyValue);
    ...
    protected void therapeuticClassOnChangeEvent(final Object companyValue) {
        LOGGER.info("therapeuticClassOnChangeEvent method started with companyValue: " + companyValue);
    ...
    protected void itemTypeOnChangeEvent(final Object companyValue) {
        LOGGER.info("itemTypeOnChangeEvent method started with companyValue: " + companyValue);
        try {
    ...
    protected void formOnChangeEvent(final Object formValue) {
        LOGGER.info("formTypeOnChangeEvent method started with formValue: " + formValue);
        try {
    ...
    protected void searchButtonClickLogic(final Button.ClickEvent event) throws SystemException, PortalException, Exception {
        ...
        criteriaCount++;
        final List<ItemDetailsDTO> searchResults = logic.getItemSearch(itemBinder, itemDetailsDTO, criteriaCount);
        searchCriteria += logic.getSearchCriteria(itemBinder, criteriaCount).get(7);
    ...
    protected void resetAllButtonClickLogic() throws SystemException, PortalException, Exception {
        LOGGER.info("resetAllButtonClickLogic method started");
        ...
        if (!StringUtils.isEmpty(itemGroupDTO.getItemFilter())) {
            ...
            if (availableList.size() > 0) {
                availableContainer = logic.getCustomizedItemResults(availableList, null);
            }
        }
    ...
    protected List<Integer> saveButtonClick() throws SystemException, PortalException, Exception {
        LOGGER.info("saveButtonClick method started");
        final List selectedItems = selectedResultsBean.getItemIds();
        List<Integer> idList = logic.saveItemGroup(itemGroupBinder, selectedItems, version, searchCriteria, sessionDTO);
    ...
    public void backButton() {
        ...
        backButton.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("In configureFields backButton.addClickListener navigateTo AbstractSearchForm");
    ...
    public void searchButton() {
        search.addClickListener(new Button.ClickListener() {
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("In configureFields search.addClickListener started");
                try {
                    if (!String.valueOf(itemDesc.getValue()).matches(REGEX_STRING) || !String.valueOf(itemNo.getValue()).matches(REGEX_STRING)) {
                ...
                LOGGER.info("In configureFields search.addClickListener Ended");
            }
        });
    }
    ...
    public void addButton() {
        add.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("In configureFields add.addClickListener started");
                if (recordAddFlag) {
                ...
                LOGGER.info("In configureFields add.addClickListener Ended");
            }
        });
    }
    ...
    public void addAllButton() {
        addAll.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("In configureFields addAll.addClickListener started");
                if (availableResultsBean.size() > ConstantsUtils.ZERO_NUM) {
                    addAllItemsButtonClick(event);
                } else {
                    MessageBox.showPlain(Icon.INFO, ConstantsUtils.ERROR, "No items were selected in the Results list view.  Please select at least one item and try again.", ButtonId.OK);
                }
                LOGGER.info("In configureFields addAll.addClickListener Ended");
            }
        });
    }
    ...
    public void removeButton() {
        ...
        remove.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("In configureFields remove.addClickListener started");
                if (recordRemoveFlag) {
                ...
                LOGGER.info("In configureFields remove.addClickListener Ended");
            }
        });
    }
    ...
    public void removeAllButton() {
        removeAll.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("In configureFields removeAll.addClickListener started");
                if (selectedResultsBean.size() > ConstantsUtils.ZERO_NUM) {
                    removeAllItemsButtonClick(event);
                } else {
                    MessageBox.showPlain(Icon.INFO, ConstantsUtils.ERROR, ConstantsUtils.NO_ITEMS_SELECTED, ButtonId.OK);
                }
                LOGGER.info("In configureFields removeAll.addClickListener Ended");
            }
        });
    }
    ...
    private void getButtonPermission(Map<String, AppPermission> functionCompanyHM) {
        LOGGER.info("Inside Button security");
