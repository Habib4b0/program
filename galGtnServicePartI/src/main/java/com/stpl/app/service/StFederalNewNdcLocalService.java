...
/**
 * Provides the local service interface for StFederalNewNdc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StFederalNewNdcLocalServiceUtil
...
public interface StFederalNewNdcLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link StFederalNewNdcLocalServiceUtil} to access the st federal new ndc local service. Add custom service methods to {@link com.stpl.app.service.impl.StFederalNewNdcLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
