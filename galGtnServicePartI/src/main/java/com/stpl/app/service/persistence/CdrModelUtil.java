...
/**
 * The persistence utility for the cdr model service. This utility wraps {@link CdrModelPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CdrModelUtil {
    private static CdrModelPersistence _persistence;
     ...
     */
    public static CdrModel update(CdrModel cdrModel) throws SystemException {
    ...
    */
    public static void cacheResult(com.stpl.app.model.CdrModel cdrModel) {
    ...
    */
    public static com.stpl.app.model.CdrModel create(int cdrModelSid) {
    ...
    */
    public static com.stpl.app.model.CdrModel remove(int cdrModelSid)
        throws com.stpl.app.NoSuchCdrModelException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().remove(cdrModelSid);
    }

    public static com.stpl.app.model.CdrModel updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.CdrModel findByPrimaryKey(int cdrModelSid)
        throws com.stpl.app.NoSuchCdrModelException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.CdrModel fetchByPrimaryKey(int cdrModelSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.CdrModel> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static CdrModelPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (CdrModelPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    CdrModelPersistence.class.getName());

            ReferenceRegistry.registerReference(CdrModelUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(CdrModelPersistence persistence) {
    }
}
