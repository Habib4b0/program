...
/**
 * Provides the local service interface for ItemGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ItemGroupLocalServiceUtil
...
public interface ItemGroupLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ItemGroupLocalServiceUtil} to access the item group local service. Add custom service methods to {@link com.stpl.app.service.impl.ItemGroupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public ItemGroup createItemGroup(int itemGroupSid);
	...
	*/
	...
	public ItemGroup deleteItemGroup(int itemGroupSid)
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ItemGroup deleteItemGroup(ItemGroup itemGroup);
	...
	*/
	...
	public ItemGroup fetchItemGroup(int itemGroupSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ItemGroup getItemGroup(int itemGroupSid) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ItemGroup> getItemGroups(int start, int end);
