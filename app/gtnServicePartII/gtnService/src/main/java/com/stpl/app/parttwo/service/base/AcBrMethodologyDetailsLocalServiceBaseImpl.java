...
import com.stpl.app.parttwo.service.AcBrMethodologyDetailsLocalService;
...
/**
 * Provides the base implementation for the ac br methodology details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.AcBrMethodologyDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.AcBrMethodologyDetailsLocalServiceImpl
 * @see com.stpl.app.parttwo.service.AcBrMethodologyDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AcBrMethodologyDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AcBrMethodologyDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.AcBrMethodologyDetailsLocalServiceUtil} to access the ac br methodology details local service.
	 */
	...
	@Override
	public AcBrMethodologyDetails addAcBrMethodologyDetails(
		AcBrMethodologyDetails acBrMethodologyDetails) {
		acBrMethodologyDetails.setNew(true);

		return acBrMethodologyDetailsPersistence.update(acBrMethodologyDetails);
	}
	 ...
	 */
	@Override
	public AcBrMethodologyDetails createAcBrMethodologyDetails(
		int acBrMethodologyDetailsSid) {
		return acBrMethodologyDetailsPersistence.create(acBrMethodologyDetailsSid);
	}
	...
	@Override
	public AcBrMethodologyDetails deleteAcBrMethodologyDetails(
		int acBrMethodologyDetailsSid) throws PortalException {
		return acBrMethodologyDetailsPersistence.remove(acBrMethodologyDetailsSid);
	}
	...
	public AcBrMethodologyDetails deleteAcBrMethodologyDetails(
		AcBrMethodologyDetails acBrMethodologyDetails) {
		return acBrMethodologyDetailsPersistence.remove(acBrMethodologyDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AcBrMethodologyDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return acBrMethodologyDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return acBrMethodologyDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AcBrMethodologyDetails fetchAcBrMethodologyDetails(
		int acBrMethodologyDetailsSid) {
		return acBrMethodologyDetailsPersistence.fetchByPrimaryKey(acBrMethodologyDetailsSid);
	}
	 ...
	 */
	@Override
	public AcBrMethodologyDetails getAcBrMethodologyDetails(
		int acBrMethodologyDetailsSid) throws PortalException {
		return acBrMethodologyDetailsPersistence.findByPrimaryKey(acBrMethodologyDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(acBrMethodologyDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AcBrMethodologyDetails.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(acBrMethodologyDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AcBrMethodologyDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return acBrMethodologyDetailsLocalService.deleteAcBrMethodologyDetails((AcBrMethodologyDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return acBrMethodologyDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AcBrMethodologyDetails> getAcBrMethodologyDetailses(int start,
		int end) {
		return acBrMethodologyDetailsPersistence.findAll(start, end);
	}
	...
	public int getAcBrMethodologyDetailsesCount() {
		return acBrMethodologyDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AcBrMethodologyDetails updateAcBrMethodologyDetails(
		AcBrMethodologyDetails acBrMethodologyDetails) {
		return acBrMethodologyDetailsPersistence.update(acBrMethodologyDetails);
	}
	 ...
	 */
	public AcBrMethodologyDetailsLocalService getAcBrMethodologyDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.AcBrMethodologyDetails",
			acBrMethodologyDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.AcBrMethodologyDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcBrMethodologyDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = acBrMethodologyDetailsPersistence.getDataSource();
	...
	@BeanReference(type = AcBrMethodologyDetailsLocalService.class)
	protected AcBrMethodologyDetailsLocalService acBrMethodologyDetailsLocalService;
