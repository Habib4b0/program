 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ItemMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ItemMasterImpl}.
 * </p>
 *
 * @author
 * @see ItemMasterImpl
...
public class ItemMasterModelImpl extends BaseModelImpl<ItemMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ACQUIRED_AMP", Types.DOUBLE);
		...
		TABLE_COLUMNS_MAP.put("OBRA_BAMP", Types.DOUBLE);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("THERAPEUTIC_CLASS", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("ORGANIZATION_KEY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("ACQUIRED_BAMP", Types.DOUBLE);
		...
		TABLE_COLUMNS_MAP.put("SECONDARY_UOM", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("ITEM_CATEGORY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("UPPS", Types.DOUBLE);
		TABLE_COLUMNS_MAP.put("SHELF_LIFE_TYPE", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("FORM", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("BASELINE_AMP", Types.DOUBLE);
		...
		TABLE_COLUMNS_MAP.put("BASE_CPI", Types.DOUBLE);
		TABLE_COLUMNS_MAP.put("LABELER_CODE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_CLASS", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CLOTTING_FACTOR_END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("DRA", Types.DOUBLE);
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.stpl.app.service.util.PropsUtil.get(
			...
			true);
	public static final long FORM_COLUMN_BITMASK = 1L;
	public static final long ITEMID_COLUMN_BITMASK = 2L;
	public static final long ITEMNAME_COLUMN_BITMASK = 4L;
	public static final long ITEMNO_COLUMN_BITMASK = 8L;
	public static final long ITEMSTATUS_COLUMN_BITMASK = 16L;
	public static final long ITEMTYPE_COLUMN_BITMASK = 32L;
	public static final long MANUFACTURERID_COLUMN_BITMASK = 64L;
	public static final long PRIMARYUOM_COLUMN_BITMASK = 128L;
	public static final long STRENGTH_COLUMN_BITMASK = 256L;
	public static final long ITEMMASTERSID_COLUMN_BITMASK = 512L;
	...
	private static final ClassLoader _classLoader = ItemMaster.class.getClassLoader();
