...
public class AbstractSearchForm extends CustomComponent {
    ...
    public void configureFields() throws SystemException, Exception {
        try {
            ...
            option1.addItem("Primary");
            option1.addItem("Secondary");
            option1.select("Primary");
            option1.addItem("Primary");
            option1.setImmediate(true);

            option2.addItem("Primary");
            option2.addItem("Secondary");
            option2.select("Primary");
            option2.addItem("Primary");
    ...
    private ExtFilterGenerator getFilterGenerator(String moduleName) throws Exception {
        if (ConstantsUtils.ITEM_GROUP_MASTER.equals(moduleName)) {
    ...
    public void setTableDefaultConfig(ExtPagedTable resultTable, String key) throws Exception {
                                ...
                                try {
                                    ...
                                    if (ConstantsUtils.CUSTOMER_GROUP_MASTER.equals(moduleName)) {
                                        ...
                                        if (deletedCustomerGroupName != null && !ConstantsUtils.EMPTY.equals(deletedCustomerGroupName)) {
                                            /*GAL-802*/ CommonUIUtils.getMessageNotification(searchForm.getCompanyGroupName() + " has been deleted Successfully");
                                        }
                                    ...
                                    if (ConstantsUtils.ITEM_GROUP_MASTER.equals(moduleName)) {
                                        ...
                                        if (deletedItemGroupName != null && !ConstantsUtils.EMPTY.equals(deletedItemGroupName)) {
                                            CommonUIUtils.getMessageNotification(searchForm.getItemGroupName() + " has been deleted Successfully");
                                        }
                                    }
                                    if (ConstantsUtils.HIERARCHY_DEF.equals(moduleName)) {
                                        ...
                                        if (deletedHrName != null && !ConstantsUtils.EMPTY.equals(deletedHrName)) {
                                            CommonUIUtils.getMessageNotification(searchForm.getHierarchyName() + " has been deleted Successfully");
                                        }
                                    }
                                    if (ConstantsUtils.RELATIONSHIP_BUILDER.equals(moduleName)) {
                                        ...
                                        if (deletedRbName != null && !ConstantsUtils.EMPTY.equals(deletedRbName)) {
                                            /*GAL-808*/ CommonUIUtils.getMessageNotification(searchForm.getRelationshipName() + " has been deleted Successfully");
                                        }
                                    }
                                    if (ConstantsUtils.DEDUCTION_GROUPING.equals(moduleName)) {
                                        ...
                                        if (deletedDeductionGroupName != null && !ConstantsUtils.EMPTY.equals(deletedDeductionGroupName)) {
                                            CommonUIUtils.getMessageNotification(searchForm.getDiscountName() + " has been deleted Successfully");
                                        }
                                    }
    ...
    private void fieldValidation(String moduleName) {
        ...
        if (ConstantsUtils.ITEM_GROUP_MASTER.equals(moduleName)) {
            ...
            date3.setDateFormat("MM/dd/yyyy");
            date4.setDateFormat("MM/dd/yyyy");
            ...
            date1.setDateFormat("MM/dd/yyyy");
            date2.setDateFormat("MM/dd/yyyy");
            date3.setDateFormat("MM/dd/yyyy");
            date4.setDateFormat("MM/dd/yyyy");
    ...
    public void excelButtonLogic(Button.ClickEvent event) {
        try {
            ...
            loadExcelTable(moduleName, binder, searchCriteria, versionNo);
            if (ValidationUtil.getLabel(key) != null && StringUtils.isNotEmpty(ValidationUtil.getLabel(key))) {
     ...
     * @throws Exception
     */
    private void loadExcelTable(String moduleName, ErrorfulFieldGroup binder, String searchCriteria, int versionNo) throws Exception {
        excelTableBean.removeAllItems();
        if (resultTable.size() != 0) {
            int count = searchLogic.getCountBasedOnModules(binder, 0, 0, true, null, null, moduleName, searchCriteria, versionNo);
            List resultList = new ArrayList();

            if (count != 0) {
                resultList = searchLogic.getSearchResultsBasedOnModules(binder, 0, count, false, null, null, moduleName, searchCriteria, versionNo);
            }
    ...
    private void deleteButton() {
        deleteBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                ...
                LOGGER.info("deleteButton method Started ");
                if (resultTable.getValue() == null) {
                    MessageBox.showPlain(Icon.INFO, ConstantsUtils.ERROR, ERROR_MSG, ButtonId.OK);
                } else {
                    final SearchResultsDTO searchForm = (SearchResultsDTO) resultTable.getValue();
                ...
                LOGGER.info("deleteButton method ENDED ");
            }
        });
    }
