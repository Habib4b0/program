...
/**
 * The persistence utility for the brand master service. This utility wraps {@link BrandMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class BrandMasterUtil {
    private static BrandMasterPersistence _persistence;
    ...
    */
    public static void cacheResult(com.stpl.app.model.BrandMaster brandMaster) {
    ...
    */
    public static com.stpl.app.model.BrandMaster create(int brandMasterSid) {
    ...
    */
    public static com.stpl.app.model.BrandMaster remove(int brandMasterSid)
        throws com.stpl.app.NoSuchBrandMasterException,
            com.stpl.portal.kernel.exception.SystemException {
        return getPersistence().remove(brandMasterSid);
    }

    public static com.stpl.app.model.BrandMaster updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.BrandMaster findByPrimaryKey(
        int brandMasterSid)
        throws com.stpl.app.NoSuchBrandMasterException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.BrandMaster fetchByPrimaryKey(
        int brandMasterSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.BrandMaster> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static BrandMasterPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (BrandMasterPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    BrandMasterPersistence.class.getName());

            ReferenceRegistry.registerReference(BrandMasterUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(BrandMasterPersistence persistence) {
    }
}
