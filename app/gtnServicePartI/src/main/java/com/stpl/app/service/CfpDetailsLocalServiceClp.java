 ...
 * @generated
 */
public class CfpDetailsLocalServiceClp implements CfpDetailsLocalService {
    ...
    public CfpDetailsLocalServiceClp(
        ...
        _methodName19 = "findByCfpModelSid";
    ...
    public com.stpl.app.model.CfpDetails addCfpDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(cfpDetails) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.CfpDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.CfpDetails createCfpDetails(int cfpDetailsSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { cfpDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.CfpDetails deleteCfpDetails(int cfpDetailsSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { cfpDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.CfpDetails fetchCfpDetails(int cfpDetailsSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { cfpDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.CfpDetails getCfpDetails(int cfpDetailsSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { cfpDetailsSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.CfpDetails> getCfpDetailses(
        ...
        return (java.util.List<com.stpl.app.model.CfpDetails>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.stpl.app.model.CfpDetails> findByCfpModelSid(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { cfpModelSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
