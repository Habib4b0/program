...
import com.stpl.app.service.MedicaidNewNdcLocalService;
...
/**
 * Provides the base implementation for the medicaid new ndc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.MedicaidNewNdcLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class MedicaidNewNdcLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MedicaidNewNdcLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.MedicaidNewNdcLocalServiceUtil} to access the medicaid new ndc local service.
	 */
	...
	@Override
	public MedicaidNewNdc addMedicaidNewNdc(MedicaidNewNdc medicaidNewNdc) {
		medicaidNewNdc.setNew(true);

		return medicaidNewNdcPersistence.update(medicaidNewNdc);
	}
	 ...
	 */
	@Override
	public MedicaidNewNdc createMedicaidNewNdc(String ndc9) {
		return medicaidNewNdcPersistence.create(ndc9);
	}
	...
	@Override
	public MedicaidNewNdc deleteMedicaidNewNdc(String ndc9)
		throws PortalException {
		return medicaidNewNdcPersistence.remove(ndc9);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MedicaidNewNdc deleteMedicaidNewNdc(MedicaidNewNdc medicaidNewNdc) {
		return medicaidNewNdcPersistence.remove(medicaidNewNdc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MedicaidNewNdc.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return medicaidNewNdcPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return medicaidNewNdcPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MedicaidNewNdc fetchMedicaidNewNdc(String ndc9) {
		return medicaidNewNdcPersistence.fetchByPrimaryKey(ndc9);
	}
	 ...
	 */
	@Override
	public MedicaidNewNdc getMedicaidNewNdc(String ndc9)
		throws PortalException {
		return medicaidNewNdcPersistence.findByPrimaryKey(ndc9);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return medicaidNewNdcLocalService.deleteMedicaidNewNdc((MedicaidNewNdc)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return medicaidNewNdcPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MedicaidNewNdc> getMedicaidNewNdcs(int start, int end) {
		return medicaidNewNdcPersistence.findAll(start, end);
	}
	...
	public int getMedicaidNewNdcsCount() {
		return medicaidNewNdcPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MedicaidNewNdc updateMedicaidNewNdc(MedicaidNewNdc medicaidNewNdc) {
		return medicaidNewNdcPersistence.update(medicaidNewNdc);
	}
	 ...
	 */
	public MedicaidNewNdcLocalService getMedicaidNewNdcLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.MedicaidNewNdc",
			medicaidNewNdcLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.MedicaidNewNdc");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MedicaidNewNdcLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = medicaidNewNdcPersistence.getDataSource();
	...
	@BeanReference(type = MedicaidNewNdcLocalService.class)
	protected MedicaidNewNdcLocalService medicaidNewNdcLocalService;
