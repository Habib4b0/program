...
/**
 * The persistence utility for the cff cust hierarchy service. This utility wraps {@link CffCustHierarchyPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CffCustHierarchyUtil {
    private static CffCustHierarchyPersistence _persistence;
    ...
    */
    public static com.stpl.app.parttwo.model.CffCustHierarchy create(
    ...
    */
    public static com.stpl.app.parttwo.model.CffCustHierarchy remove(
        int cffCustHierarchySid)
    ...
    public static com.stpl.app.parttwo.model.CffCustHierarchy updateImpl(
        com.stpl.app.parttwo.model.CffCustHierarchy cffCustHierarchy)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.CffCustHierarchy findByPrimaryKey(
        int cffCustHierarchySid)
        throws com.stpl.app.parttwo.NoSuchCffCustHierarchyException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.CffCustHierarchy fetchByPrimaryKey(
        int cffCustHierarchySid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.parttwo.model.CffCustHierarchy> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static CffCustHierarchyPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (CffCustHierarchyPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.parttwo.service.ClpSerializer.getServletContextName(),
                    CffCustHierarchyPersistence.class.getName());

            ReferenceRegistry.registerReference(CffCustHierarchyUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(CffCustHierarchyPersistence persistence) {
    }
}
