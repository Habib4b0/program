...
public class RebateScheduleAddView extends VerticalLayout implements View {
     ...
     */
    public RebateScheduleAddView(final SessionDTO sessionDTO) throws SystemException, PortalException, Exception {
        super();
        setSpacing(true);
try{
    ...
    public void enter(final ViewChangeEvent event) {
        try {
            ...
            LOGGER.info("Enters enter method of add mode :" + mode);
            ...
            LOGGER.info(" Ends enter method of add view");
