...
public class HierarchyBuilderEdit extends VerticalLayout implements View {
     ...
     */
    public HierarchyBuilderEdit() throws SystemException, PortalException, Exception {
        super();
        LOGGER.info("HierarchyBuilderEdit Constructor started");
        setSpacing(true);
        addComponent(new EditHierarchyBuilderDefinition(hierarchyBuilderLevelDTOBean, hierarchyBuilderDTO));
        setStyleName("bootstrap");
        LOGGER.info("HierarchyBuilderEdit Constructor Ended");
    }
