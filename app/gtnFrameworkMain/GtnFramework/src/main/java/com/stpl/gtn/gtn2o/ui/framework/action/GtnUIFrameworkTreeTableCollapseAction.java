 ...
 * @author Abishek.Ram
 */
public class GtnUIFrameworkTreeTableCollapseAction implements GtnUIFrameWorkAction {
	...
	public void doAction(String componentId, GtnUIFrameWorkActionConfig gtnUIFrameWorkActionConfig)
		...
		int expandLevelNo = GtnUIFrameworkGlobalUI
				...
				.getIntegerFromField();
		if (expandLevelNo > 0) {
			tableLogic.expandCollapse(expandLevelNo - 1);
		}
	}

	@Override
	public GtnUIFrameWorkAction createInstance() {
		return new GtnUIFrameworkTreeTableCollapseAction();
	}
