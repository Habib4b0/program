...
public class GtnFrameworkForecastReturnPublicViewSearchLookUp {
	...
	public GtnUIFrameworkViewConfig getPublicViewLookUpView(String namespace) {
		...
		view.setViewId(namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE
				+ GtnFrameworkCommonConstants.PUBLIC_VIEW_SEARCH_LOOKUP_VIEW);
	...
	private void addHierarchyNameTextBox(List<GtnUIFrameworkComponentConfig> componentList, String namespace) {
		...
		addHierarchyNameTextBox.setComponentId(
				namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE + GtnFrameworkCommonConstants.VIEW_NAME);
		...
		addHierarchyNameTextBox.setComponentWsFieldId(GtnFrameworkCommonConstants.VIEW_NAME);
	...
	private void searchAndResetButtonLayout(List<GtnUIFrameworkComponentConfig> componentList, String namespace) {
		...
		searchButton
				.setComponentId(namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE + "publicViewSearchButton");
		...
		reset.put(namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE
				+ GtnFrameworkCommonConstants.PUBLIC_SEARCH_RESULT_TABLE, null);
		...
		resetButton.setComponentId(
				namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE + "publicViewResetCriteriaButton");
	...
	private void addPagedTableComponent(List<GtnUIFrameworkComponentConfig> componentList, String namespace) {
		...
		searchResults.setTableColumnDataType(
				GtnForecastReturnsTableConstants.getGtnReturnsForecastPublicViewTableColumnsDataType());
		searchResults
				.setTableVisibleHeader(GtnForecastReturnsTableConstants.getGtnReturnsForecastPublicViewTableHeaders());
		searchResults.setTableColumnMappingId(
				GtnForecastReturnsTableConstants.getGtnReturnsForecastPublicViewTableColumns());
		searchResults.setCountUrl(GtnWsForecastReturnsConstants.GTN_WS_RETURNS_FORECAST_PUBLIC_VIEW_SEARCH_SERVICE);
		searchResults.setResultSetUrl(GtnWsForecastReturnsConstants.GTN_WS_RETURNS_FORECAST_PUBLIC_VIEW_SEARCH_SERVICE);
	...
	private void addControlPopUpButtonLayout(List<GtnUIFrameworkComponentConfig> componentList, String namespace) {
		...
		selectButton
				.setComponentId(namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE + "publicViewSelectButton");
		selectButton.setComponentName("SELECT");
		selectButton.setParentComponentId(
				namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE + "controlPopUpButtonLayout");
		...
		selectAction.addActionParameter("publicViews");
		selectAction.addActionParameter(namespace);
		selectAction.setFieldValues(Arrays.asList(GtnFrameworkCommonConstants.PUBLIC_SEARCH_RESULT_TABLE,
				"privateSearchResultTable", "dsDeleteView", "company", "businessUnit", "projectionName",
				"projectionDescription", "fromPeriod", "toPeriod", "productHierarchy", "relationShipCombobox",
				"forecastLevel", "productGroup", "productLevelComboBox", "dualListBoxComp", "publicViews",
				"privateViews", "returnsForecastMainScreenDataSelection_dataSelectionMainLayout",
				GtnFrameworkCommonConstants.VIEW_NAME, "privateViewName"));
		...
		closeOnSelectAction.addActionParameter(
				namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE + "publicViewSearchLookupView");
		...
		closeButton.setComponentId(namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE + "publicViewCloseButton");
		closeButton.setComponentName("CLOSE");
		closeButton.setParentComponentId(
				namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE + "controlPopUpButtonLayout");
		...
		closeAction.addActionParameter(
				namespace + GtnFrameworkForecastConstantCommon.UNDERSCORE + "publicViewSearchLookupView");
