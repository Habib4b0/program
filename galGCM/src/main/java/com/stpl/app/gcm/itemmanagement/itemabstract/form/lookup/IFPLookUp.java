 ...
 */
public class IFPLookUp extends CustomWindow {
private static final Logger LOGGER = Logger.getLogger(IFPLookUp.class);
    ...
    public String CFP_SEARCH_HEADERS[] = new String[]{Constants.IFP_NO, Constants.IfpNAME, "IFP Type", "IFP Category", "IFP Designation", "IFP Plan ID", "IFP Plan Name", "IFP Status", "IFP Start Date", "IFP End Date"};

    public IFPLookUp(final String component, final CustomTextField componentTextField) {
        this.componentTextField = componentTextField;
        setContent(Clara.create(getClass().getResourceAsStream("/item/ifpLookUp.xml"), this));
    ...
    public void configureFields() {
        ...
        resultsTable.addStyleName(ConstantsUtil.FILTERCOMBOBOX);
    ...
    public void searchButtonLogic(Button.ClickEvent event) throws SystemException, PortalException, Exception {
        binder.commit();
        selection.setOperation(Constants.IFP);
        selection.setCountQueryName("IFP-C Abstract");
        selection.setDataQueryName("IFP Abstract");
