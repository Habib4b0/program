...
public class AdjustedDemandForecastCacheModel implements CacheModel<AdjustedDemandForecast>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof AdjustedDemandForecastCacheModel)) {
			return false;
		}

		AdjustedDemandForecastCacheModel adjustedDemandForecastCacheModel = (AdjustedDemandForecastCacheModel)obj;

		if (adjustedDemandForecastSid == adjustedDemandForecastCacheModel.adjustedDemandForecastSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, adjustedDemandForecastSid);
	}
