...
public class MasterDataAttributeCacheModel implements CacheModel<MasterDataAttribute>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MasterDataAttributeCacheModel)) {
			return false;
		}

		MasterDataAttributeCacheModel masterDataAttributeCacheModel = (MasterDataAttributeCacheModel)obj;

		if (masterDataAttributeSid == masterDataAttributeCacheModel.masterDataAttributeSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, masterDataAttributeSid);
	}
