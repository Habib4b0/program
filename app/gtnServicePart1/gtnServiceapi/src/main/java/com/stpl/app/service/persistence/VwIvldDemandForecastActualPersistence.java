...
public interface VwIvldDemandForecastActualPersistence extends BasePersistence<VwIvldDemandForecastActual> {
	...
	*/
	public void cacheResult(
		java.util.List<VwIvldDemandForecastActual> vwIvldDemandForecastActuals);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, VwIvldDemandForecastActual> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<VwIvldDemandForecastActual> findAll();
	...
	*/
	public java.util.List<VwIvldDemandForecastActual> findAll(int start, int end);
	...
	*/
	public java.util.List<VwIvldDemandForecastActual> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<VwIvldDemandForecastActual> orderByComparator);
