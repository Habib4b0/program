...
public class CompanyGroupLocalServiceUtil {
    private static CompanyGroupLocalService _service;
    ...
    */
    ...
    public static CompanyGroupLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    CompanyGroupLocalService.class.getName());

            if (invokableLocalService instanceof CompanyGroupLocalService) {
                _service = (CompanyGroupLocalService) invokableLocalService;
            } else {
                _service = new CompanyGroupLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(CompanyGroupLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(CompanyGroupLocalService service) {
    }
}
