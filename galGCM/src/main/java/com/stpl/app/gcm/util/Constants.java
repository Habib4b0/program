...
public class Constants {
    ...
    public static final String[] CFP_SEARCH = {"CFP No", "CFP Name", "CFP ID", "CFP Status", "CFP Type"};
    public static final String[] IFP_SEARCH = {Constants.IFP_NO, Constants.IfpNAME, Constants.IFP_ID, "IFP Status", "IFP Type"};
