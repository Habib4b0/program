 ...
 * @generated
 */
public class IfpContractLocalServiceClp implements IfpContractLocalService {
    ...
    public IfpContractLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addIfpContract";

        _methodParameterTypes0 = new String[] { "com.stpl.app.model.IfpContract" };

        _methodName1 = "createIfpContract";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteIfpContract";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteIfpContract";

        _methodParameterTypes3 = new String[] { "com.stpl.app.model.IfpContract" };
        ...
        _methodName10 = "fetchIfpContract";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getIfpContract";
        ...
        _methodName13 = "getIfpContracts";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getIfpContractsCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateIfpContract";

        _methodParameterTypes15 = new String[] { "com.stpl.app.model.IfpContract" };
    ...
    public com.stpl.app.model.IfpContract addIfpContract(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(ifpContract) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.IfpContract) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.IfpContract createIfpContract(int ifpContractSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { ifpContractSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IfpContract deleteIfpContract(int ifpContractSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { ifpContractSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IfpContract fetchIfpContract(int ifpContractSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { ifpContractSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IfpContract getIfpContract(int ifpContractSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { ifpContractSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.IfpContract> getIfpContracts(
        ...
        return (java.util.List<com.stpl.app.model.IfpContract>) ClpSerializer.translateOutput(returnObj);
    }
