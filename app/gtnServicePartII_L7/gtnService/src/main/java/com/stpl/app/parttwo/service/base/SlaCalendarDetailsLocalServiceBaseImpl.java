...
import com.stpl.app.parttwo.service.SlaCalendarDetailsLocalService;
...
/**
 * Provides the base implementation for the sla calendar details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.SlaCalendarDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.SlaCalendarDetailsLocalServiceImpl
 * @see com.stpl.app.parttwo.service.SlaCalendarDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class SlaCalendarDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SlaCalendarDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.SlaCalendarDetailsLocalServiceUtil} to access the sla calendar details local service.
	 */
	...
	public SlaCalendarDetails addSlaCalendarDetails(
		...
		return slaCalendarDetailsPersistence.update(slaCalendarDetails);
	}
	...
	public SlaCalendarDetails createSlaCalendarDetails(
		...
		return slaCalendarDetailsPersistence.create(slaCalendarDetailsSid);
	}
	...
	public SlaCalendarDetails deleteSlaCalendarDetails(
		...
		return slaCalendarDetailsPersistence.remove(slaCalendarDetailsSid);
	}
	...
	public SlaCalendarDetails deleteSlaCalendarDetails(
		SlaCalendarDetails slaCalendarDetails) {
		return slaCalendarDetailsPersistence.remove(slaCalendarDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SlaCalendarDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return slaCalendarDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return slaCalendarDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public SlaCalendarDetails fetchSlaCalendarDetails(int slaCalendarDetailsSid) {
		return slaCalendarDetailsPersistence.fetchByPrimaryKey(slaCalendarDetailsSid);
	}
	...
	public SlaCalendarDetails getSlaCalendarDetails(int slaCalendarDetailsSid)
		...
		return slaCalendarDetailsPersistence.findByPrimaryKey(slaCalendarDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(slaCalendarDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SlaCalendarDetails.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(slaCalendarDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SlaCalendarDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return slaCalendarDetailsLocalService.deleteSlaCalendarDetails((SlaCalendarDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return slaCalendarDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SlaCalendarDetails> getSlaCalendarDetailses(int start, int end) {
		return slaCalendarDetailsPersistence.findAll(start, end);
	}
	...
	public int getSlaCalendarDetailsesCount() {
		return slaCalendarDetailsPersistence.countAll();
	}
	 ...
	 */
	public SlaCalendarDetailsLocalService getSlaCalendarDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.SlaCalendarDetails",
			slaCalendarDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.SlaCalendarDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return SlaCalendarDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = slaCalendarDetailsPersistence.getDataSource();
	...
	@BeanReference(type = SlaCalendarDetailsLocalService.class)
	protected SlaCalendarDetailsLocalService slaCalendarDetailsLocalService;
