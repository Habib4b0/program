...
/**
 * Provides the local service interface for StArpOutbound. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StArpOutboundLocalServiceUtil
...
public interface StArpOutboundLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StArpOutboundLocalServiceUtil} to access the st arp outbound local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.StArpOutboundLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
