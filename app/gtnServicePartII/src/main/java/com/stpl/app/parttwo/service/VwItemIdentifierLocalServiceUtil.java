...
public class VwItemIdentifierLocalServiceUtil {
    private static VwItemIdentifierLocalService _service;
    ...
    */
    ...
    public static VwItemIdentifierLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    VwItemIdentifierLocalService.class.getName());

            if (invokableLocalService instanceof VwItemIdentifierLocalService) {
                _service = (VwItemIdentifierLocalService) invokableLocalService;
            } else {
                _service = new VwItemIdentifierLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(VwItemIdentifierLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(VwItemIdentifierLocalService service) {
    }
}
