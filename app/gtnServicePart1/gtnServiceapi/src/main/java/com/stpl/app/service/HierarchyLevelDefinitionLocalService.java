...
/**
 * Provides the local service interface for HierarchyLevelDefinition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see HierarchyLevelDefinitionLocalServiceUtil
...
public interface HierarchyLevelDefinitionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HierarchyLevelDefinitionLocalServiceUtil} to access the hierarchy level definition local service. Add custom service methods to {@link com.stpl.app.service.impl.HierarchyLevelDefinitionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
