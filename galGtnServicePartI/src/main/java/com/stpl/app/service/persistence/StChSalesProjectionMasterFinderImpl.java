 ...
 */
public class StChSalesProjectionMasterFinderImpl extends BasePersistenceImpl<StChSalesProjectionMaster> implements StChSalesProjectionMasterFinder {

    private static final Logger LOGGER = Logger.getLogger(StChSalesProjectionMasterFinderImpl.class);
...
//            query = query.replace("?PMSID?", String.valueOf(parameters.get("projectionId")));
        ...
        try {
            session = openSession();
//            LOGGER.info("executeQuery queryString for: " + parameters.get(Constants.INDICATOR) + ":\n " + queryString.toString());
