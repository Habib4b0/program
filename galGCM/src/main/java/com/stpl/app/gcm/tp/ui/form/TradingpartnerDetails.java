...
public class TradingpartnerDetails extends CustomTPDetailsLayout {
    ...
    public void configueTradingPartnerDetailsTable() {
        ...
        tradingPartnerDetailsTable.setWidth(100, Unit.PERCENTAGE);
        tradingPartnerDetailsTable.setHeight(400, Unit.PIXELS);
        tradingPartnerDetailsTable.setPageLength(5);
        ...
        new AbstractNotificationUtils() {
            ...
            public void yesMethod() {
                try {
                    ...
                    LOGGER.error(ex.getMessage() + " Inside rebuild Btn");
                }
            }
