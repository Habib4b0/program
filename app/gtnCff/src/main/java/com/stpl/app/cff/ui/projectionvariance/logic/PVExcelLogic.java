...
public class PVExcelLogic {
    ...
    public void executeProcedurePRCPVSELECTION() {
        ...
        callCffDiscountExcelPrc(discountFlag, projectionId, frequency, viewIndicator, levelNo);
...
//        //Discount $ 
    ...
    private void callCffDiscountExcelPrc(boolean discountFlag, String projectionId, String frequency, String viewIndicator, String levelNo) {
        List<Object[]> rawListDiscount;
        if (discountFlag) {
            String discountLevelName = getDiscountLevelName();
    ...
    private String getDiscountLevelName() {
        String discountLevelName = !selection.getDeductionLevelFilter().isEmpty() ? selection.getDeductionLevelValues() : selection.getDiscountLevel();
