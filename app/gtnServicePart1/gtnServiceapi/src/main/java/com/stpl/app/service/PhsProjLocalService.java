...
/**
 * Provides the local service interface for PhsProj. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see PhsProjLocalServiceUtil
...
public interface PhsProjLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PhsProjLocalServiceUtil} to access the phs proj local service. Add custom service methods to {@link com.stpl.app.service.impl.PhsProjLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public PhsProj addPhsProj(PhsProj phsProj);
	...
	*/
	...
	public PhsProj deletePhsProj(PhsProj phsProj);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public PhsProj deletePhsProj(PhsProjPK phsProjPK) throws PortalException;
	...
	*/
	...
	public PhsProj fetchPhsProj(PhsProjPK phsProjPK);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PhsProj getPhsProj(PhsProjPK phsProjPK) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public PhsProj updatePhsProj(PhsProj phsProj);
}