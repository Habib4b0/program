...
/**
 * The persistence utility for the na proj master service. This utility wraps {@link com.stpl.app.service.persistence.impl.NaProjMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class NaProjMasterUtil {
	...
	*/
	public static void cacheResult(NaProjMaster naProjMaster) {
	...
	*/
	public static void cacheResult(List<NaProjMaster> naProjMasters) {
	...
	*/
	public static NaProjMaster create(int naProjMasterSid) {
	...
	*/
	public static NaProjMaster remove(int naProjMasterSid)
		throws com.stpl.app.exception.NoSuchNaProjMasterException {
		return getPersistence().remove(naProjMasterSid);
	}

	public static NaProjMaster updateImpl(NaProjMaster naProjMaster) {
	...
	* @throws NoSuchNaProjMasterException if a na proj master with the primary key could not be found
	*/
	public static NaProjMaster findByPrimaryKey(int naProjMasterSid)
		throws com.stpl.app.exception.NoSuchNaProjMasterException {
	...
	*/
	public static NaProjMaster fetchByPrimaryKey(int naProjMasterSid) {
		return getPersistence().fetchByPrimaryKey(naProjMasterSid);
	}

	public static java.util.Map<java.io.Serializable, NaProjMaster> fetchByPrimaryKeys(
	...
	*/
	public static List<NaProjMaster> findAll() {
	...
	*/
	public static List<NaProjMaster> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<NaProjMasterPersistence, NaProjMasterPersistence> _serviceTracker =
		ServiceTrackerFactory.open(NaProjMasterPersistence.class);
}