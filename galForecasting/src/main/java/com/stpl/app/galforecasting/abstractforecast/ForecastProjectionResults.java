...
import static com.stpl.app.galforecasting.utils.Constant.FrequencyConstants.*;
import static com.stpl.app.galforecasting.utils.Constant.LabelConstants.*;
import static com.stpl.app.galforecasting.utils.Constant.ResourceConstants.*;
import static com.stpl.app.galforecasting.utils.Constant.SessionConstants.*;
import com.stpl.app.galforecasting.utils.NmSPRGraphWindow;
import com.stpl.app.galforecasting.utils.PRChart;
...
public abstract class ForecastProjectionResults extends CustomComponent {
    ...
    protected CustomTreeContainer<ProjectionResultsDTO> resultBeanContainer, excelResultBean = new CustomTreeContainer<>(ProjectionResultsDTO.class);    
     ...
     * @param screenName
     */
    public ForecastProjectionResults(final SessionDTO sessionDTO, final String screenName) throws Exception {
    ...
    /**
     * Init method that reads the UI components from xml and configures the Projection Results Screen.
     */
   ...
   private void configureFields() throws Exception {
    ...
    public void loadFrequency(Property.ValueChangeEvent event) {
        LOGGER.info("Loading Frequency Combo Box");
        loadFrequencyDdlb();
        LOGGER.info("Frequency Combo Box Loaded");
    }
    ...
    protected void loadFrequencyDdlb() {
        LOGGER.info("Loading Frequency Combo Box Initiated");
        ...
        LOGGER.info("Loading Frequency Combo Box Ended");
    }
    ...
    protected final List<String> loadHistoryDdlb(String frequency, String period) {
        ...
        LOGGER.info("Loading History Combo Box Ended");
        return history;
    ...
    /**
     * Loads the level drop down in Commercial, 
     * Government and Other Forecast based on the view
     */
    ...
    /**
     * Generate Logic that will be called during 
     * view change and custom view selection.
     */
    ...
    /**
     * Loads the level, level filter ddlb and projection results grid on view change.
     * @param viewChange 
     */
    ...
    /**
     * New Button Listener. Opens the Custom view pop 
     * up to create a new custom view hierarchy.
     * @param event 
     */
    @UiHandler("newBtn")
    ...
    /**
     * Edit Button listener. Opens the Custom view pop up to edit the 
     * existing custom view hierarchy.
     * @param event the event
     */
    ...
    protected void configureExcelResultTable() {
        excelResultBean = new CustomTreeContainer<>(ProjectionResultsDTO.class);
    ...
    public void saveProjectionResultsSelection() throws Exception{
    ...
    private void loadOnEdit() throws SystemException, Exception {
