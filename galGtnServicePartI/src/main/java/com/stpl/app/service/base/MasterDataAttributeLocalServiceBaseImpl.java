...
public abstract class MasterDataAttributeLocalServiceBaseImpl
    ...
    private MasterDataAttributeLocalServiceClpInvoker _clpInvoker = new MasterDataAttributeLocalServiceClpInvoker();
    ...
    public MasterDataAttribute deleteMasterDataAttribute(
        int masterDataAttributeSid) throws PortalException, SystemException {
    ...
    public MasterDataAttribute fetchMasterDataAttribute(
        int masterDataAttributeSid) throws SystemException {
     ...
     */
    @Override
    public int getMasterDataAttributesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.MasterDataAttribute",
