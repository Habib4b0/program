 ...
 * @generated
 */
public class UsergroupDomainMasterLocalServiceClp
    ...
    public UsergroupDomainMasterLocalServiceClp(
    ...
    public com.stpl.app.model.UsergroupDomainMaster addUsergroupDomainMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(usergroupDomainMaster)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.UsergroupDomainMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.UsergroupDomainMaster createUsergroupDomainMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { usergroupDomainSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.UsergroupDomainMaster deleteUsergroupDomainMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { usergroupDomainSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.UsergroupDomainMaster fetchUsergroupDomainMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { usergroupDomainSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.UsergroupDomainMaster getUsergroupDomainMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { usergroupDomainSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.UsergroupDomainMaster> getUsergroupDomainMasters(
        ...
        return (java.util.List<com.stpl.app.model.UsergroupDomainMaster>) ClpSerializer.translateOutput(returnObj);
    }
