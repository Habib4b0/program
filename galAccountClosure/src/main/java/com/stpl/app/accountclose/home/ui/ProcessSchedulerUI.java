...
import com.stpl.app.accountclose.ui.view.ProcessSchedulerMainView;
 ...
 * @author alok.v
 */
public class ProcessSchedulerUI extends UI implements VaadinPortletSession.PortletListener {
    ...
    protected void init(VaadinRequest request) {
        ...
        try {
            navigator.addView(ProcessSchedulerMainView.NAME, new ProcessSchedulerMainView());
        } catch (Exception e) {
            LOGGER.error(e);
        }
    ...
    public void handleRenderRequest(RenderRequest request, RenderResponse response, UI uI) {
        ...
        getUI().getNavigator().navigateTo(ProcessSchedulerMainView.NAME);
    }
