 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.stpl.app.model.IvldFormulaDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldFormulaDetailsImpl}.
 * </p>
 *
 * @author
 * @see IvldFormulaDetailsImpl
 * @see com.stpl.app.model.IvldFormulaDetails
 * @see com.stpl.app.model.IvldFormulaDetailsModel
 * @generated
 */
public class IvldFormulaDetailsModelImpl extends BaseModelImpl<IvldFormulaDetails>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a ivld formula details model instance should use the {@link com.stpl.app.model.IvldFormulaDetails} interface instead.
     */
    ...
    private static ClassLoader _classLoader = IvldFormulaDetails.class.getClassLoader();
    ...
    public Object clone() {
        ...
        ivldFormulaDetailsImpl.setCompanyId(getCompanyId());
    ...
    public CacheModel<IvldFormulaDetails> toCacheModel() {
        ...
        ivldFormulaDetailsCacheModel.companyId = getCompanyId();

        String companyId = ivldFormulaDetailsCacheModel.companyId;

        if ((companyId != null) && (companyId.length() == 0)) {
            ivldFormulaDetailsCacheModel.companyId = null;
        }
