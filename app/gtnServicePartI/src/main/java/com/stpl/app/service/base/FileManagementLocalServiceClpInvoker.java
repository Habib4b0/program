...
public class FileManagementLocalServiceClpInvoker {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return FileManagementLocalServiceUtil.addFileManagement((com.stpl.app.model.FileManagement) arguments[0]);
        }

        if (_methodName1.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes1, parameterTypes)) {
            return FileManagementLocalServiceUtil.createFileManagement(((Integer) arguments[0]).intValue());
        }

        if (_methodName2.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes2, parameterTypes)) {
            return FileManagementLocalServiceUtil.deleteFileManagement(((Integer) arguments[0]).intValue());
        }

        if (_methodName3.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes3, parameterTypes)) {
            return FileManagementLocalServiceUtil.deleteFileManagement((com.stpl.app.model.FileManagement) arguments[0]);
        }
        ...
        if (_methodName5.equals(name) &&
            ...
            return FileManagementLocalServiceUtil.dynamicQuery((com.stpl.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
        ...
        if (_methodName8.equals(name) &&
            ...
            return FileManagementLocalServiceUtil.dynamicQueryCount((com.stpl.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
        ...
        if (_methodName10.equals(name) &&
            ...
            return FileManagementLocalServiceUtil.fetchFileManagement(((Integer) arguments[0]).intValue());
        }

        if (_methodName11.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes11, parameterTypes)) {
            return FileManagementLocalServiceUtil.getFileManagement(((Integer) arguments[0]).intValue());
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return FileManagementLocalServiceUtil.updateFileManagement((com.stpl.app.model.FileManagement) arguments[0]);
        }
