...
public final class ContractHeaderForm extends CustomComponent {
    ...
    public ContractHeaderForm(final ContractMasterDTO contractMasterDTO, final CustomFieldGroup binder, final BeanItemContainer<ContractAliasMasterDTO> aliasResultsBean, final String mode
            ...
            Exception {
        super();
        LOGGER.info("Entering AddForm constructor ");
        this.contractMasterDTO = contractMasterDTO;
        this.aliasResultsBean = aliasResultsBean;
        this.binder = binder;
        this.mode = mode;
        ...
        init();
        LOGGER.info(" AddForm constructor ends");
    }
    ...
    private void addToContent() throws SystemException, PortalException, Exception {
        ...
        LOGGER.info(" addToContent method ends");
    }
     ...
     */
    public TabSheet addToTabbar() throws PortalException, SystemException, Exception {
        ...
        LOGGER.info(" addToTabbar method returns tabsheet and ends ");
        return tabsheet;
    }
    ...
    private void backButton() {
        ...
        backButton.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("entering backButton listener ");
                ...
                if (isViewMode) {
                    ...
                    LOGGER.info(" backButton listener ends ");
        ...
        LOGGER.info(" backButton method is ended");
    }
    ...
    private void editButton() throws SystemException {
        LOGGER.info(" entering EditButton method");
        if (!isViewMode) {
        ...
        LOGGER.info(" EditButton method ends");
    }
    ...
    private void deleteButton() {
        LOGGER.info("Enters DeleteButton method ");
        ...
        deleteBtn.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                try {
                    LOGGER.info("btnDelete listener is called");
                    final String value = String.valueOf(binder.getField(Constants.CONTRACT_NAME).getValue());
                            ...
                            public void buttonClicked(final ButtonId buttonId) {
                                if (buttonId.name().equals(Constants.YES)) {
                                    try {
                                         ...
                                         * future use-sooriya
                                         */
                                        final ContractMaster contractMaster = contractHL.deleteContractMasterById(systemId);
                    ...
                    LOGGER.info("btnDelete listener ends");
                } catch (Exception e) {
                    LOGGER.error(e);
                    AbstractNotificationUtils.getErrorNotification(ErrorCodeUtil.getEC(ErrorCodes.ERROR_CODE_1001), ErrorCodeUtil.getEC(ErrorCodes.ERROR_CODE_2004));
                }
        ...
        LOGGER.info(" DeleteButton method ends");
    }
    ...
    public void updateMethod() throws PortalException, SystemException {
        try {
            LOGGER.info("Entering btnUpdate listener");
            binder.getFields();
            binder.commit();
           ...
           if (StringUtils.isBlank(String.valueOf(binder.getField(Constants.CONTRACT_ID).getValue()))) {
            ...
            if (String.valueOf(binder.getField(Constants.PRICE_PROTECTION_START_DATE).getValue()).equals(Constants.NULL)
             ...
             if (flag) {
                ...
                LOGGER.info(" btnUpdate listener ends");
            }
    ...
    public void saveMethod() throws PortalException, SystemException {
         boolean flag = false;
        try {
            LOGGER.info("enters btnSave click listener ");
            binder.getErrorDisplay().clearError();
 ...
 String errorMessage = new String("Information for Mandatory fields need to be provided on Contract Header tab: ")+(System.getProperty("line.separator"));
    ...
    private void resetLogicForAddMode() {
        try {
            ...
            if (selectedTabIndex == 1) {
                ...
                ComboBox lowPrice = (ComboBox) binder.getField(CHFieldNameUtils.exemptFromLowPrice);
                lowPrice.setValue(0);
    ...
    private void resetLogicForEditMode() {
        try {
            ...
            LOGGER.info("ContractsystemId=" + systemId);
            LOGGER.info("getContractMasterById(contractSystemId" + systemId + ")");
