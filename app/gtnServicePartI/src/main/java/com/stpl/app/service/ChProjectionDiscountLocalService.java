...
/**
 * Provides the local service interface for ChProjectionDiscount. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ChProjectionDiscountLocalServiceUtil
...
public interface ChProjectionDiscountLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ChProjectionDiscountLocalServiceUtil} to access the ch projection discount local service. Add custom service methods to {@link com.stpl.app.service.impl.ChProjectionDiscountLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
