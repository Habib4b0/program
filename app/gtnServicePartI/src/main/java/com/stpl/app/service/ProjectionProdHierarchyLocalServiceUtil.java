...
public class ProjectionProdHierarchyLocalServiceUtil {
    private static ProjectionProdHierarchyLocalService _service;
    ...
    */
    ...
    public static ProjectionProdHierarchyLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ProjectionProdHierarchyLocalService.class.getName());

            if (invokableLocalService instanceof ProjectionProdHierarchyLocalService) {
                _service = (ProjectionProdHierarchyLocalService) invokableLocalService;
            } else {
                _service = new ProjectionProdHierarchyLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ProjectionProdHierarchyLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ProjectionProdHierarchyLocalService service) {
    }
}
