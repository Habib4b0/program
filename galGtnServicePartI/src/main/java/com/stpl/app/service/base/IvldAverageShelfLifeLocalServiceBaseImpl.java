...
public abstract class IvldAverageShelfLifeLocalServiceBaseImpl
    ...
    private IvldAverageShelfLifeLocalServiceClpInvoker _clpInvoker = new IvldAverageShelfLifeLocalServiceClpInvoker();
    ...
    public IvldAverageShelfLife deleteIvldAverageShelfLife(
        int ivldAverageShelfLifeSid) throws PortalException, SystemException {
    ...
    public IvldAverageShelfLife fetchIvldAverageShelfLife(
        int ivldAverageShelfLifeSid) throws SystemException {
     ...
     */
    @Override
    public int getIvldAverageShelfLifesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.IvldAverageShelfLife",
