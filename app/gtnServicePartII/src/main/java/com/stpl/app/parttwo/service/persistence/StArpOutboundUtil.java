...
/**
 * The persistence utility for the st arp outbound service. This utility wraps {@link StArpOutboundPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StArpOutboundUtil {
    private static StArpOutboundPersistence _persistence;
    ...
    */
    public static com.stpl.app.parttwo.model.StArpOutbound create(
    ...
    */
    public static com.stpl.app.parttwo.model.StArpOutbound remove(
        StArpOutboundPK stArpOutboundPK)
    ...
    public static com.stpl.app.parttwo.model.StArpOutbound updateImpl(
        com.stpl.app.parttwo.model.StArpOutbound stArpOutbound)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.StArpOutbound findByPrimaryKey(
        StArpOutboundPK stArpOutboundPK)
        throws com.stpl.app.parttwo.NoSuchStArpOutboundException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.parttwo.model.StArpOutbound fetchByPrimaryKey(
        StArpOutboundPK stArpOutboundPK)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.parttwo.model.StArpOutbound> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static StArpOutboundPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (StArpOutboundPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.parttwo.service.ClpSerializer.getServletContextName(),
                    StArpOutboundPersistence.class.getName());

            ReferenceRegistry.registerReference(StArpOutboundUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(StArpOutboundPersistence persistence) {
    }
}
