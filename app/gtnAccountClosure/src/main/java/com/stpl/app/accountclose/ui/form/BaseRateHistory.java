...
public class BaseRateHistory extends CustomComponent implements View {
    ...
    private ExtTreeContainer<BaseRateHistoryDTO> baseRateHistoryContainer = new ExtTreeContainer<BaseRateHistoryDTO>(BaseRateHistoryDTO.class);
    ...
    public ExtTreeContainer<BaseRateSummaryDTO> baseRateSummaryContainer;
    ...
    /* The Excel container */
    ExtTreeContainer<BaseRateSummaryDTO> excelContainer = new ExtTreeContainer<BaseRateSummaryDTO>(BaseRateSummaryDTO.class,DataStructureMode.MAP);
    ExtTreeContainer<BaseRateHistoryDTO> transexcelContainer = new ExtTreeContainer<BaseRateHistoryDTO>(BaseRateHistoryDTO.class);
    ...
    public void configureBaseRateSummaryTable() {
        ...
        baseRateSummaryContainer = new ExtTreeContainer<BaseRateSummaryDTO>(BaseRateSummaryDTO.class,DataStructureMode.MAP);
    ...
    public void excelBtnClick(Button.ClickEvent event) {
        ...
        try {
            ...
            excelContainer = new ExtTreeContainer<BaseRateSummaryDTO>(BaseRateSummaryDTO.class,DataStructureMode.MAP);
            if (TRANSACTIONAL.getConstant().equals(value)) {
                transactionExcel();
    ...
    public void transactionExcel() {
        brHistoryTableLayout.addComponent(excelTable);
        excelTable.setVisible(false);
        transexcelContainer = new ExtTreeContainer<BaseRateHistoryDTO>(BaseRateHistoryDTO.class);
        CustomTableHeaderDTO excelHeader = new CustomTableHeaderDTO();
        excelHeader = utils.getSummTableColumns(fullHeader);
        excelContainer.setColumnProperties(excelHeader.getProperties());
        excelTable.setContainerDataSource(excelContainer);
