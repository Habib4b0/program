...
public class GtnWsItemGrpQueryContants {
	...
	public static final String GTN_IFP_AUDIT_SEARCH_QUERY = " FROM DBO.HIST_ITEM_GROUP IG JOIN COMPANY_MASTER IM ON IG.COMPANY_MASTER_SID=IM.COMPANY_MASTER_SID  "  + "JOIN @SYS.dbo.User_ igCreatedBy on igCreatedBy.userId = IG.CREATED_BY";
