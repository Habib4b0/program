...
public class NonMandatedLogic {
     ...
     * @throws Exception the exception
     */
    public int updateProjection(final DataSelectionDTO dataSelectionDTO, int projectionId, final boolean markAsSaved, final String screenName) throws PortalException, SystemException{
    ...
    private List<PMPYCalculatorDTO> getChList(final List chList) {
        ...
        if (sales != null && !sales.isEmpty()) {
            ...
            for (int is = 0; is < 1; is++) { // Setting SALES_SMALL
                ...
                // Yearly
                final Double yearOne = getSales(sales.get(1)) + getSales(sales.get(NumericConstants.TWO)) + getSales(sales.get(NumericConstants.THREE)) + getSales(sales.get(NumericConstants.FOUR));
                final Double yearTwo = getSales(sales.get(NumericConstants.FIVE)) + getSales(sales.get(NumericConstants.SIX)) + getSales(sales.get(NumericConstants.SEVEN)) + getSales(sales.get(NumericConstants.EIGHT));
                final Double yearThree = getSales(sales.get(NumericConstants.NINE)) + getSales(sales.get(NumericConstants.TEN)) + getSales(sales.get(NumericConstants.ELEVEN)) + getSales(sales.get(NumericConstants.TWELVE));
                ...
                final Double s2Y1 = getSales(sales.get(NumericConstants.THREE)) + getSales(sales.get(NumericConstants.FOUR));
                final Double s1Y2 = getSales(sales.get(NumericConstants.FIVE)) + getSales(sales.get(NumericConstants.SIX));
                final Double s2Y2 = getSales(sales.get(NumericConstants.SEVEN)) + getSales(sales.get(NumericConstants.EIGHT));
                final Double s1y3 = getSales(sales.get(NumericConstants.NINE)) + getSales(sales.get(NumericConstants.TEN));
                final Double s2y3 = getSales(sales.get(NumericConstants.ELEVEN)) + getSales(sales.get(NumericConstants.TWELVE));
        ...
        if (units != null && !units.isEmpty()) {
            ...
            for (int iu = 0; iu < 1; iu++) { // Setting UNITS_SMALL
                ...
                dto.setQ1y2Ch(getUnits(units.get(NumericConstants.FIVE))); // q1 of current year - 2
                ...
                dto.setQ1y3Ch(getUnits(units.get(NumericConstants.NINE))); // q1 of current year - 1
                ...
                final Double yearOne = getUnits(units.get(1)) // current year -
                        // 3
                        + getUnits(units.get(NumericConstants.TWO)) + getUnits(units.get(NumericConstants.THREE)) + getUnits(units.get(NumericConstants.FOUR));
                final Double yearTwo = getUnits(units.get(NumericConstants.FIVE)) // current year -
                        // 2
                        + getUnits(units.get(NumericConstants.SIX)) + getUnits(units.get(NumericConstants.SEVEN)) + getUnits(units.get(NumericConstants.EIGHT));
                final Double yearThree = getUnits(units.get(NumericConstants.NINE)) // current year
                        // - 1
                        + getUnits(units.get(NumericConstants.TEN)) + getUnits(units.get(NumericConstants.ELEVEN)) + getUnits(units.get(NumericConstants.TWELVE));
                ...
                final Double s2Y1 = getUnits(units.get(NumericConstants.THREE)) // q3, q4 current
                        // year - 3
                        + getUnits(units.get(NumericConstants.FOUR));
                final Double s1Y2 = getUnits(units.get(NumericConstants.FIVE)) // q1, q2 current
                        // year - 2
                        + getUnits(units.get(NumericConstants.SIX));
                final Double s2Y2 = getUnits(units.get(NumericConstants.SEVEN)) // q3, q4 current
                        // year - 2
                        + getUnits(units.get(NumericConstants.EIGHT));
                final Double s1y3 = getUnits(units.get(NumericConstants.NINE)) // q1, q2 current
                        // year - 1
                        + getUnits(units.get(NumericConstants.TEN));
                final Double s2y3 = getUnits(units.get(NumericConstants.ELEVEN)) // q3, q4 current
                        // year - 1
    ...
    private List<PMPYCalculatorDTO> getTpList(final List tpList) {
        ...
        if (units != null && !units.isEmpty()) {
            ...
            for (int iu = 0; iu < 1; iu++) { // Setting UNITS_SMALL
                ...
                // Yearly
                final Double yearOne = getUnits(units.get(1)) + getUnits(units.get(NumericConstants.TWO)) + getUnits(units.get(NumericConstants.THREE)) + getUnits(units.get(NumericConstants.FOUR));
                final Double yearTwo = getUnits(units.get(NumericConstants.FIVE)) + getUnits(units.get(NumericConstants.SIX)) + getUnits(units.get(NumericConstants.SEVEN)) + getUnits(units.get(NumericConstants.EIGHT));
                final Double yearThree = getUnits(units.get(NumericConstants.NINE)) + getUnits(units.get(NumericConstants.TEN)) + getUnits(units.get(NumericConstants.ELEVEN)) + getUnits(units.get(NumericConstants.TWELVE));
                ...
                final Double s2Y1 = getUnits(units.get(NumericConstants.THREE)) + getUnits(units.get(NumericConstants.FOUR));
                final Double s1Y2 = getUnits(units.get(NumericConstants.FIVE)) + getUnits(units.get(NumericConstants.SIX));
                final Double s2Y2 = getUnits(units.get(NumericConstants.SEVEN)) + getUnits(units.get(NumericConstants.EIGHT));
                final Double s1y3 = getUnits(units.get(NumericConstants.NINE)) + getUnits(units.get(NumericConstants.TEN));
                final Double s2y3 = getUnits(units.get(NumericConstants.ELEVEN)) + getUnits(units.get(NumericConstants.TWELVE));
    ...
    public List<DataSelectionDTO> searchDSProjections(final DataSelectionDTO dataSelectionDTO) throws SystemException, ParseException  {
        ...
        returnList = Converters.searchDsProjection(resultList, CommonUtils.BUSINESS_PROCESS_TYPE_CHANNELS.equals(dataSelectionDTO.getModulName()), !CommonUtils.BUSINESS_PROCESS_TYPE_RETURNS.equals(dataSelectionDTO.getModulName()));
        return returnList;
    }
    ...
    public List<DataSelectionDTO> searchDSProjectionsLazy(final DataSelectionDTO dataSelectionDTO, int startIndex, int offset, Set<Container.Filter> filters, List<SortByColumn> sortByColumns) throws  ParseException, SystemException {
        ...
        resultList = dataSelection.searchDSProjections(parameters);
        returnList = Converters.searchDsProjection(resultList, !CommonUtils.BUSINESS_PROCESS_TYPE_CHANNELS.equals(dataSelectionDTO.getModulName()) ? CommonUtils.BUSINESS_PROCESS_TYPE_ACCRUAL_RATE_PROJECTION.equals(dataSelectionDTO.getModulName()) ? true : false : true, !CommonUtils.BUSINESS_PROCESS_TYPE_RETURNS.equals(dataSelectionDTO.getModulName()));
        return returnList;
    }
    ...
    public void tempInsert(final SessionDTO inputDto, final String customSqlId)  {
        ...
        HelperTableLocalServiceUtil.executeUpdateQuery(QueryUtil.replaceTableNames(customSql,inputDto.getCurrentTableNames()));
    }
    ...
    public int updateBasicsProjectionMaster(final DataSelectionDTO dataSelectionDTO, int projectionId, final boolean markAsSaved) throws PortalException, SystemException{
    ...
    public void insertIntoTempTables(String userId, String sessionId, Date lastModifiedDate, String projectionId) throws PortalException, SystemException {
    ...
    public void insertTempSalesProjectionMaster(String userId, String sessionId, Date lastModifiedDate, String projectionId) throws PortalException,SystemException {
        final SimpleDateFormat fmt = new SimpleDateFormat(Constant.DATE_FORMAT);
    ...
    public void insertTempSalesProjection(String userId, String sessionId, Date lastModifiedDate, String projectionId) throws PortalException,SystemException {
        final SimpleDateFormat fmt = new SimpleDateFormat(Constant.DATE_FORMAT);
        String lastModified = fmt.format(lastModifiedDate);
    ...
    public void insertTempActualSales(String userId, String sessionId, Date lastModifiedDate, String projectionId) throws PortalException,SystemException{
        final SimpleDateFormat fmt = new SimpleDateFormat(Constant.DATE_FORMAT);
        String lastModified = fmt.format(lastModifiedDate);
    ...
    public boolean checkForZeroActuals(final SessionDTO session) throws PortalException,SystemException {
        ...
        List<Object> list = (List<Object>) salesProjectionDAO.executeSelectQuery(QueryUtil.replaceTableNames(query, session.getCurrentTableNames()));
    ...
    public static List getARPView(String viewValue, String forecastType, String userId, String viewType) {
        ...
        String viewQueryARPP = "Select FVM.VIEW_NAME viewName, PM.PROJECTION_DESCRIPTION description, PM.PROJECTION_NAME projectionName, PM.BRAND_TYPE brandType, PM.MODIFIED_DATE modifiedDate, PM.CREATED_BY createdBy,"
                ...
                + "     PM.PROD_RELATIONSHIP_BUILDER_SID prodRelationshipBuilderSid  " + ",APS.FIELD_NAME,APS.FIELD_VALUES,HT.DESCRIPTION AS DEDUCTION_VALUE ,PM.BUSINESS_UNIT AS BUSINESSUNIT, CM1.COMPANY_NAME AS  BUSINESSUNITNAME "
    ...
    /**
     * Used to insert or update the data from temp to main tables(CALLED IN SAVE AND UPDATE). Screen wise
     * all the insert done parallely. sales_master will be in one thread, sales_proj will
     * be in one thread and sales_actual in one thread etc
     * 
     * @param session
     * @param service
    ...
    /**
     * Used to insert the data from main to temp tables(CALLED IN EDIT MODE). table wise
     * all the insert done parallely. sales_master will be in one thread, sales_proj will
     * be in one thread and sales_actual in one thread etc
     * 
     * @param session
