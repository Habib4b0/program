    ...
    public List findItemMaster(String itemId, String itemNo,
        ...
        try {
            ...
            if (parameters.get(ConstantUtil.ITEM_ID_M) != null) {
                String item_Id = CommonUIUtils.getDBinput(parameters.get(ConstantUtil.ITEM_ID_M).toString());
                sql += " and im.itemId like '" + item_Id + "' ";
            }
            if (parameters.get(ConstantUtil.ITEM_NO_M) != null) {
                String item_No = CommonUIUtils.getDBinput(parameters.get(ConstantUtil.ITEM_NO_M).toString());
                sql += " and im.itemNo like '" + item_No + "' ";
            }
            if (parameters.get(ConstantUtil.ITEM_NAME_M) != null) {
                String item_Name = CommonUIUtils.getDBinput(parameters.get(ConstantUtil.ITEM_NAME_M).toString());
                sql += " and im.itemName like '" + item_Name + "' ";
            }
             if (parameters.get(ConstantUtil.ITEM_BATCH_ID) != null) {
                String item_BatchId = CommonUIUtils.getDBinput(parameters.get(ConstantUtil.ITEM_BATCH_ID).toString());
                sql += " and im.batchId like '" + item_BatchId + "' ";
            }
            if (parameters.get(ConstantUtil.ITEM_DESC_M) != null) {
                String item_Desc = CommonUIUtils.getDBinput(parameters.get(ConstantUtil.ITEM_DESC_M).toString());
            ...
            if (parameters.get("identiferId") != null) {
                String identifier_Id = CommonUIUtils.getDBinput(parameters.get("identiferId").toString());
