...
/**
 * Provides the local service interface for IvldItemHierarchy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldItemHierarchyLocalServiceUtil
...
public interface IvldItemHierarchyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldItemHierarchyLocalServiceUtil} to access the ivld item hierarchy local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldItemHierarchyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
