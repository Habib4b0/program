 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link CompanyParentDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CompanyParentDetailsImpl}.
 * </p>
 *
 * @author
...
public class CompanyParentDetailsModelImpl extends BaseModelImpl<CompanyParentDetails>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("PARENT_END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("PARENT_COMPANY_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("RECORD_LOCK_STATUS", Types.BOOLEAN);
		TABLE_COLUMNS_MAP.put("PRIOR_PARENT_START_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("SOURCE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CREATED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("COMPANY_PARENT_DETAILS_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("PRIOR_PARENT_CMPY_MASTER_SID", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("PARENT_START_DATE", Types.TIMESTAMP);
	}
	...
	private static final ClassLoader _classLoader = CompanyParentDetails.class.getClassLoader();
