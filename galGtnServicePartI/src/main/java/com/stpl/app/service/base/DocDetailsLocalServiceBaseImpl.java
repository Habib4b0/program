...
public abstract class DocDetailsLocalServiceBaseImpl
    ...
    private DocDetailsLocalServiceClpInvoker _clpInvoker = new DocDetailsLocalServiceClpInvoker();
     ...
     */
    @Override
    public DocDetails getDocDetails(int docDetailsId)
        throws PortalException, SystemException {
     ...
     */
    @Override
    public int getDocDetailsesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.DocDetails",
