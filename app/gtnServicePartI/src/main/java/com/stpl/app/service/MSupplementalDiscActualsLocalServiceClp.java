 ...
 * @generated
 */
public class MSupplementalDiscActualsLocalServiceClp
    ...
    public MSupplementalDiscActualsLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addMSupplementalDiscActuals";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.MSupplementalDiscActuals"
            };

        _methodName1 = "createMSupplementalDiscActuals";

        _methodParameterTypes1 = new String[] {
                "com.stpl.app.service.persistence.MSupplementalDiscActualsPK"
            };

        _methodName2 = "deleteMSupplementalDiscActuals";

        _methodParameterTypes2 = new String[] {
                "com.stpl.app.service.persistence.MSupplementalDiscActualsPK"
            };

        _methodName3 = "deleteMSupplementalDiscActuals";
        ...
        _methodName10 = "fetchMSupplementalDiscActuals";

        _methodParameterTypes10 = new String[] {
                "com.stpl.app.service.persistence.MSupplementalDiscActualsPK"
            };

        _methodName11 = "getMSupplementalDiscActuals";
        ...
        _methodName13 = "getMSupplementalDiscActualses";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getMSupplementalDiscActualsesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateMSupplementalDiscActuals";
    ...
    public com.stpl.app.model.MSupplementalDiscActuals addMSupplementalDiscActuals(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(mSupplementalDiscActuals)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.MSupplementalDiscActuals) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.MSupplementalDiscActuals createMSupplementalDiscActuals(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(mSupplementalDiscActualsPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.MSupplementalDiscActuals> getMSupplementalDiscActualses(
        ...
        return (java.util.List<com.stpl.app.model.MSupplementalDiscActuals>) ClpSerializer.translateOutput(returnObj);
    }
