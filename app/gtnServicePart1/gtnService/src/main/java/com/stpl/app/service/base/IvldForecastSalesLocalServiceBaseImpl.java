...
import com.stpl.app.service.IvldForecastSalesLocalService;
...
/**
 * Provides the base implementation for the ivld forecast sales local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldForecastSalesLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldForecastSalesLocalServiceImpl
 * @see com.stpl.app.service.IvldForecastSalesLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldForecastSalesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldForecastSalesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldForecastSalesLocalServiceUtil} to access the ivld forecast sales local service.
	 */
	...
	@Override
	public IvldForecastSales addIvldForecastSales(
		IvldForecastSales ivldForecastSales) {
		ivldForecastSales.setNew(true);

		return ivldForecastSalesPersistence.update(ivldForecastSales);
	}
	 ...
	 */
	@Override
	public IvldForecastSales createIvldForecastSales(int ivldForecastSalesSid) {
		return ivldForecastSalesPersistence.create(ivldForecastSalesSid);
	}
	...
	@Override
	public IvldForecastSales deleteIvldForecastSales(int ivldForecastSalesSid)
		throws PortalException {
		return ivldForecastSalesPersistence.remove(ivldForecastSalesSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IvldForecastSales deleteIvldForecastSales(
		IvldForecastSales ivldForecastSales) {
		return ivldForecastSalesPersistence.remove(ivldForecastSales);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldForecastSales.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldForecastSalesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldForecastSalesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldForecastSales fetchIvldForecastSales(int ivldForecastSalesSid) {
		return ivldForecastSalesPersistence.fetchByPrimaryKey(ivldForecastSalesSid);
	}
	 ...
	 */
	@Override
	public IvldForecastSales getIvldForecastSales(int ivldForecastSalesSid)
		throws PortalException {
		return ivldForecastSalesPersistence.findByPrimaryKey(ivldForecastSalesSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldForecastSalesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldForecastSales.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ivldForecastSalesSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldForecastSalesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldForecastSales.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldForecastSalesLocalService.deleteIvldForecastSales((IvldForecastSales)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldForecastSalesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldForecastSales> getIvldForecastSaleses(int start, int end) {
		return ivldForecastSalesPersistence.findAll(start, end);
	}
	...
	public int getIvldForecastSalesesCount() {
		return ivldForecastSalesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldForecastSales updateIvldForecastSales(
		IvldForecastSales ivldForecastSales) {
		return ivldForecastSalesPersistence.update(ivldForecastSales);
	}
	 ...
	 */
	public IvldForecastSalesLocalService getIvldForecastSalesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.IvldForecastSales",
			ivldForecastSalesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.IvldForecastSales");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldForecastSalesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldForecastSalesPersistence.getDataSource();
	...
	@BeanReference(type = IvldForecastSalesLocalService.class)
	protected IvldForecastSalesLocalService ivldForecastSalesLocalService;
