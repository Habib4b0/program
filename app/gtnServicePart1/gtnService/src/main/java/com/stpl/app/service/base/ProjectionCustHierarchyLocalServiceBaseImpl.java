...
import com.stpl.app.service.ProjectionCustHierarchyLocalService;
...
/**
 * Provides the base implementation for the projection cust hierarchy local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ProjectionCustHierarchyLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class ProjectionCustHierarchyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProjectionCustHierarchyLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ProjectionCustHierarchyLocalServiceUtil} to access the projection cust hierarchy local service.
	 */
	...
	@Override
	public ProjectionCustHierarchy addProjectionCustHierarchy(
		ProjectionCustHierarchy projectionCustHierarchy) {
		projectionCustHierarchy.setNew(true);

		return projectionCustHierarchyPersistence.update(projectionCustHierarchy);
	}
	 ...
	 */
	@Override
	public ProjectionCustHierarchy createProjectionCustHierarchy(
		int projectionCustHierarchySid) {
		return projectionCustHierarchyPersistence.create(projectionCustHierarchySid);
	}
	...
	@Override
	public ProjectionCustHierarchy deleteProjectionCustHierarchy(
		int projectionCustHierarchySid) throws PortalException {
		return projectionCustHierarchyPersistence.remove(projectionCustHierarchySid);
	}
	...
	public ProjectionCustHierarchy deleteProjectionCustHierarchy(
		ProjectionCustHierarchy projectionCustHierarchy) {
		return projectionCustHierarchyPersistence.remove(projectionCustHierarchy);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectionCustHierarchy.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectionCustHierarchyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectionCustHierarchyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProjectionCustHierarchy fetchProjectionCustHierarchy(
		int projectionCustHierarchySid) {
		return projectionCustHierarchyPersistence.fetchByPrimaryKey(projectionCustHierarchySid);
	}
	 ...
	 */
	@Override
	public ProjectionCustHierarchy getProjectionCustHierarchy(
		int projectionCustHierarchySid) throws PortalException {
		return projectionCustHierarchyPersistence.findByPrimaryKey(projectionCustHierarchySid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectionCustHierarchyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProjectionCustHierarchy.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectionCustHierarchyLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProjectionCustHierarchy.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectionCustHierarchyLocalService.deleteProjectionCustHierarchy((ProjectionCustHierarchy)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectionCustHierarchyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProjectionCustHierarchy> getProjectionCustHierarchies(
		int start, int end) {
		return projectionCustHierarchyPersistence.findAll(start, end);
	}
	...
	public int getProjectionCustHierarchiesCount() {
		return projectionCustHierarchyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProjectionCustHierarchy updateProjectionCustHierarchy(
		ProjectionCustHierarchy projectionCustHierarchy) {
		return projectionCustHierarchyPersistence.update(projectionCustHierarchy);
	}
	 ...
	 */
	public ProjectionCustHierarchyLocalService getProjectionCustHierarchyLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ProjectionCustHierarchy",
			projectionCustHierarchyLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProjectionCustHierarchyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectionCustHierarchyPersistence.getDataSource();
	...
	@BeanReference(type = ProjectionCustHierarchyLocalService.class)
	protected ProjectionCustHierarchyLocalService projectionCustHierarchyLocalService;
