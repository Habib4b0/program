...
/**
 * Provides the local service interface for ImtdSalesBasisDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ImtdSalesBasisDetailsLocalServiceUtil
...
public interface ImtdSalesBasisDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ImtdSalesBasisDetailsLocalServiceUtil} to access the imtd sales basis details local service. Add custom service methods to {@link com.stpl.app.service.impl.ImtdSalesBasisDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
