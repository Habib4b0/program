 ...
 * @see com.stpl.app.service.persistence.PeriodUtil
 * @generated
 */
@ProviderType
public class PeriodPersistenceImpl extends BasePersistenceImpl<Period>
	...
	public PeriodPersistenceImpl() {
		...
		try {
			...
			dbColumnNames.put("periodDate", "PERIOD_DATE");
			dbColumnNames.put("quarter", "QUARTER");
			dbColumnNames.put("year", "YEAR");
			dbColumnNames.put("semiAnnual", "SEMI_ANNUAL");
	...
	private static final String _SQL_SELECT_PERIOD_WHERE_PKS_IN = "SELECT period FROM Period period WHERE PERIOD_SID IN (";
