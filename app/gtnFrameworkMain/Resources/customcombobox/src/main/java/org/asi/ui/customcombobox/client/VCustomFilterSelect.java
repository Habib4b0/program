...
public class VCustomFilterSelect extends Composite implements Field, KeyDownHandler,
        KeyUpHandler, ClickHandler, FocusHandler, BlurHandler, Focusable,
        SubPartAware, HandlesAriaCaption, HandlesAriaInvalid,
        HandlesAriaRequired {
    public boolean addBlurValue=false;
    /**
    ...
    public class FilterSelectSuggestion implements SuggestOracle.Suggestion, Command {
        ...
        public boolean equals(Object obj) {
            if (!(obj instanceof VCustomFilterSelect.FilterSelectSuggestion)) {
                return false;
            }
            VCustomFilterSelect.FilterSelectSuggestion other = (VCustomFilterSelect.FilterSelectSuggestion) obj;
     ...
     * menu.
     */
    public class SuggestionPopup extends VOverlay implements PopupPanel.PositionCallback,
            CloseHandler<PopupPanel> {

        private static final int Z_INDEX = 30000;

        /** For internal use only. May be removed or replaced in the future. */
        public final VCustomFilterSelect.SuggestionMenu menu;
        ...
        public void showSuggestions(
                final Collection<VCustomFilterSelect.FilterSelectSuggestion> currentSuggestions,
             ...
             */
            final VCustomFilterSelect.SuggestionPopup popup = this;
            Scheduler.get().scheduleDeferred(new Scheduler.ScheduledCommand() {
                ...
                public void execute() {
                    ...
                    final int x = VCustomFilterSelect.this.getAbsoluteLeft();
        ...
        private void setNextButtonActive(boolean active) {
            ...
            if (active) {
                DOM.sinkEvents(down, Event.ONCLICK);
                down.setClassName(VCustomFilterSelect.this.getStylePrimaryName()
                        + "-nextpage");
            } else {
        ...
        private void setPrevButtonActive(boolean active) {
            ...
            if (active) {
                DOM.sinkEvents(up, Event.ONCLICK);
                up.setClassName(VCustomFilterSelect.this.getStylePrimaryName()
                        + "-prevpage");
            } else {
                DOM.sinkEvents(up, 0);
                up.setClassName(VCustomFilterSelect.this.getStylePrimaryName()
        ...
        private void selectItem(final MenuItem newSelectedItem) {
            ...
            // Set the icon.
            VCustomFilterSelect.FilterSelectSuggestion suggestion = (VCustomFilterSelect.FilterSelectSuggestion) newSelectedItem
                    .getCommand();
         ...
         */
        private VCustomFilterSelect.SuggestionPopup.LazyPageScroller lazyPageScroller = new VCustomFilterSelect.SuggestionPopup.LazyPageScroller();
        ...
        public void setPagingEnabled(boolean paging) {
            ...
            if (paging) {
                ...
                down.getStyle().setDisplay(Style.Display.NONE);
                up.getStyle().setDisplay(Style.Display.NONE);
        ...
        public void setPosition(int offsetWidth, int offsetHeight) {
            ...
            if (naturalMenuWidth < desiredWidth) {
                ...
                menuFirstChild.getStyle().setWidth(100, Style.Unit.PCT);
            }
            ...
            final int vfsHeight = VCustomFilterSelect.this.getOffsetHeight();
            ...
            if (offsetWidth + left > Window.getClientWidth()) {
                left = VCustomFilterSelect.this.getAbsoluteLeft()
                        + VCustomFilterSelect.this.getOffsetWidth() - offsetWidth;
                if (left < 0) {
                    left = 0;
        ...
        public void updateStyleNames(UIDL uidl,
            ...
            setStyleName(VCustomFilterSelect.this.getStylePrimaryName()
                    + "-suggestpopup");
            menu.setStyleName(VCustomFilterSelect.this.getStylePrimaryName()
                    + "-suggestmenu");
            status.setClassName(VCustomFilterSelect.this.getStylePrimaryName()
                    + "-status");
    ...
    public class SuggestionMenu extends MenuBar implements SubPartAware,
        ...
        private VLazyExecutor delayedImageLoadExecutioner = new VLazyExecutor(
                100, new Scheduler.ScheduledCommand() {
        ...
        public void setSuggestions(
                Collection<VCustomFilterSelect.FilterSelectSuggestion> suggestions) {
            if (enableDebug) {
            ...
            clearItems();
            final Iterator<VCustomFilterSelect.FilterSelectSuggestion> it = suggestions.iterator();
            while (it.hasNext()) {
                final VCustomFilterSelect.FilterSelectSuggestion s = it.next();
    ...
    /** For internal use only. May be removed or replaced in the future. */
    public final VCustomFilterSelect.SuggestionPopup suggestionPopup;
    ...
    private class IconWidget extends Widget {
        IconWidget(Icon icon) {
            ...
            addDomHandler(VCustomFilterSelect.this, ClickEvent.getType());
        }
    }

    private VCustomFilterSelect.IconWidget selectedItemIcon;
     ...
     * For internal use only. May be removed or replaced in the future.
     */
    public final List<VCustomFilterSelect.FilterSelectSuggestion> currentSuggestions = new ArrayList<VCustomFilterSelect.FilterSelectSuggestion>();
    ...
    /** For internal use only. May be removed or replaced in the future. */
    public VCustomFilterSelect.Select selectPopupItemWhenResponseIsReceived = VCustomFilterSelect.Select.NONE;
     ...
     * For internal use only. May be removed or replaced in the future.
     */
    public VCustomFilterSelect.FilterSelectSuggestion currentSuggestion;
    ...
    /**
     * This method will create the TextBox used by the VCustomFilterSelect instance.
     ...
     * 
     * @since 7.1.5
     * @return TextBox instance used by this VCustomFilterSelect
     */
    protected TextBox createTextBox() {
        return new VCustomFilterSelect.FilterSelectTextBox();
    }

    /**
     * This method will create the SuggestionPopup used by the VCustomFilterSelect
     ...
     * 
     * @since 7.1.5
     * @return SuggestionPopup instance used by this VCustomFilterSelect
     */
    protected VCustomFilterSelect.SuggestionPopup createSuggestionPopup() {
        return new VCustomFilterSelect.SuggestionPopup();
    }
    ...
    private void setText(final String text) {
         ...
         */
        HasDirection.Direction previousDirection = tb.getDirection();
        tb.setDirection(HasDirection.Direction.RTL);
        tb.setText(text);
     ...
     */
    public void onSuggestionSelected(VCustomFilterSelect.FilterSelectSuggestion suggestion) {
        if (enableDebug) {
    ...
    public void setSelectedItemIcon(String iconUri) {
        ...
        if (iconUri == null || iconUri.length() == 0) {
            ...
            selectedItemIcon = new VCustomFilterSelect.IconWidget(client.getIcon(iconUri));
    ...
    private void updateSelectedIconPosition() {
        ...
        selectedItemIcon.getElement().getStyle()
                .setMarginTop(marginTop, Style.Unit.PX);
    }
    ...
    private void popupKeyDown(KeyDownEvent event) {
        ...
        case KeyCodes.KEY_ENTER:
            if (suggestionPopup.menu.getKeyboardSelectedItem() == null) {
                 ...
                 */
                currentSuggestion = ((VCustomFilterSelect.FilterSelectSuggestion) suggestionPopup.menu
    ...
    private void selectPrevPage() {
        if (currentPage > 0) {
            ...
            selectPopupItemWhenResponseIsReceived = VCustomFilterSelect.Select.LAST;
        }
    }
    ...
    private void selectNextPage() {
        if (hasNextPage()) {
            filterOptions(currentPage + 1, lastFilter);
            selectPopupItemWhenResponseIsReceived = VCustomFilterSelect.Select.FIRST;
        }
    }
    ...
    public void updateSuggestionPopupMinWidth() {
        ...
        for (VCustomFilterSelect.FilterSelectSuggestion suggestion : currentSuggestions) {
    ...
    public void onBlur(BlurEvent event) {
        ...
        if (BrowserInfo.get().isIE() && preventNextBlurEventInIE) {
            ...
            if (getElement().isOrHasChild(focusedElement)
                ...
                // IF the suggestion popup or another part of the VCustomFilterSelect
        ...
        if (!readonly) {
            ...
            if (tabPressedWhenPopupOpen||addBlurValue) {
    ...
    private void afterUpdateClientVariables() {
        ...
        selectPopupItemWhenResponseIsReceived = VCustomFilterSelect.Select.NONE;
    }
}