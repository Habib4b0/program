...
public class VwCustomerGtsForecastLocalServiceUtil {
    private static VwCustomerGtsForecastLocalService _service;
    ...
    */
    ...
    public static VwCustomerGtsForecastLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    VwCustomerGtsForecastLocalService.class.getName());

            if (invokableLocalService instanceof VwCustomerGtsForecastLocalService) {
                _service = (VwCustomerGtsForecastLocalService) invokableLocalService;
            } else {
                _service = new VwCustomerGtsForecastLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(VwCustomerGtsForecastLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(VwCustomerGtsForecastLocalService service) {
    }
}
