...
public class WorkflowProfileCacheModel implements CacheModel<WorkflowProfile>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof WorkflowProfileCacheModel)) {
			return false;
		}

		WorkflowProfileCacheModel workflowProfileCacheModel = (WorkflowProfileCacheModel)obj;

		if (processSid == workflowProfileCacheModel.processSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, processSid);
	}
