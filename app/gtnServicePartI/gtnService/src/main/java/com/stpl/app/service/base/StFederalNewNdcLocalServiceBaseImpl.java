...
import com.stpl.app.service.StFederalNewNdcLocalService;
...
/**
 * Provides the base implementation for the st federal new ndc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.StFederalNewNdcLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.StFederalNewNdcLocalServiceImpl
 * @see com.stpl.app.service.StFederalNewNdcLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class StFederalNewNdcLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StFederalNewNdcLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.StFederalNewNdcLocalServiceUtil} to access the st federal new ndc local service.
	 */
	...
	@Override
	public StFederalNewNdc addStFederalNewNdc(StFederalNewNdc stFederalNewNdc) {
		stFederalNewNdc.setNew(true);

		return stFederalNewNdcPersistence.update(stFederalNewNdc);
	}
	 ...
	 */
	@Override
	public StFederalNewNdc createStFederalNewNdc(
		StFederalNewNdcPK stFederalNewNdcPK) {
		return stFederalNewNdcPersistence.create(stFederalNewNdcPK);
	}
	...
	@Override
	public StFederalNewNdc deleteStFederalNewNdc(
		StFederalNewNdcPK stFederalNewNdcPK) throws PortalException {
		return stFederalNewNdcPersistence.remove(stFederalNewNdcPK);
	}
	...
	@Override
	public StFederalNewNdc deleteStFederalNewNdc(
		StFederalNewNdc stFederalNewNdc) {
		return stFederalNewNdcPersistence.remove(stFederalNewNdc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StFederalNewNdc.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stFederalNewNdcPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stFederalNewNdcPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public StFederalNewNdc fetchStFederalNewNdc(
		StFederalNewNdcPK stFederalNewNdcPK) {
		return stFederalNewNdcPersistence.fetchByPrimaryKey(stFederalNewNdcPK);
	}
	 ...
	 */
	@Override
	public StFederalNewNdc getStFederalNewNdc(
		StFederalNewNdcPK stFederalNewNdcPK) throws PortalException {
		return stFederalNewNdcPersistence.findByPrimaryKey(stFederalNewNdcPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stFederalNewNdcLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StFederalNewNdc.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(stFederalNewNdcLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StFederalNewNdc.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stFederalNewNdcLocalService.deleteStFederalNewNdc((StFederalNewNdc)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stFederalNewNdcPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<StFederalNewNdc> getStFederalNewNdcs(int start, int end) {
		return stFederalNewNdcPersistence.findAll(start, end);
	}
	...
	public int getStFederalNewNdcsCount() {
		return stFederalNewNdcPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public StFederalNewNdc updateStFederalNewNdc(
		StFederalNewNdc stFederalNewNdc) {
		return stFederalNewNdcPersistence.update(stFederalNewNdc);
	}
	 ...
	 */
	public StFederalNewNdcLocalService getStFederalNewNdcLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.StFederalNewNdc",
			stFederalNewNdcLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.StFederalNewNdc");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StFederalNewNdcLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stFederalNewNdcPersistence.getDataSource();
	...
	@BeanReference(type = StFederalNewNdcLocalService.class)
	protected StFederalNewNdcLocalService stFederalNewNdcLocalService;
