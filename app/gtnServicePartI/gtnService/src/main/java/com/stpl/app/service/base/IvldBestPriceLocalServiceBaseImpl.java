...
import com.stpl.app.service.IvldBestPriceLocalService;
...
/**
 * Provides the base implementation for the ivld best price local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IvldBestPriceLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.IvldBestPriceLocalServiceImpl
 * @see com.stpl.app.service.IvldBestPriceLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldBestPriceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldBestPriceLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IvldBestPriceLocalServiceUtil} to access the ivld best price local service.
	 */
	...
	@Override
	public IvldBestPrice addIvldBestPrice(IvldBestPrice ivldBestPrice) {
		ivldBestPrice.setNew(true);

		return ivldBestPricePersistence.update(ivldBestPrice);
	}
	 ...
	 */
	@Override
	public IvldBestPrice createIvldBestPrice(int ivldBestPriceSid) {
		return ivldBestPricePersistence.create(ivldBestPriceSid);
	}
	...
	@Override
	public IvldBestPrice deleteIvldBestPrice(int ivldBestPriceSid)
		throws PortalException {
		return ivldBestPricePersistence.remove(ivldBestPriceSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IvldBestPrice deleteIvldBestPrice(IvldBestPrice ivldBestPrice) {
		return ivldBestPricePersistence.remove(ivldBestPrice);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldBestPrice.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldBestPricePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldBestPricePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldBestPrice fetchIvldBestPrice(int ivldBestPriceSid) {
		return ivldBestPricePersistence.fetchByPrimaryKey(ivldBestPriceSid);
	}
	 ...
	 */
	@Override
	public IvldBestPrice getIvldBestPrice(int ivldBestPriceSid)
		throws PortalException {
		return ivldBestPricePersistence.findByPrimaryKey(ivldBestPriceSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldBestPriceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldBestPrice.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ivldBestPriceSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldBestPriceLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldBestPrice.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldBestPriceLocalService.deleteIvldBestPrice((IvldBestPrice)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldBestPricePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldBestPrice> getIvldBestPrices(int start, int end) {
		return ivldBestPricePersistence.findAll(start, end);
	}
	...
	public int getIvldBestPricesCount() {
		return ivldBestPricePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldBestPrice updateIvldBestPrice(IvldBestPrice ivldBestPrice) {
		return ivldBestPricePersistence.update(ivldBestPrice);
	}
	 ...
	 */
	public IvldBestPriceLocalService getIvldBestPriceLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.IvldBestPrice",
			ivldBestPriceLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldBestPriceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldBestPricePersistence.getDataSource();
	...
	@BeanReference(type = IvldBestPriceLocalService.class)
	protected IvldBestPriceLocalService ivldBestPriceLocalService;
