...
import com.stpl.app.service.PriceScheduleMasterLocalService;
...
/**
 * Provides the base implementation for the price schedule master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.PriceScheduleMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class PriceScheduleMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PriceScheduleMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.PriceScheduleMasterLocalServiceUtil} to access the price schedule master local service.
	 */
	...
	public PriceScheduleMaster addPriceScheduleMaster(
		...
		return priceScheduleMasterPersistence.update(priceScheduleMaster);
	}
	...
	public PriceScheduleMaster createPriceScheduleMaster(
		...
		return priceScheduleMasterPersistence.create(priceScheduleSystemId);
	}
	...
	public PriceScheduleMaster deletePriceScheduleMaster(
		...
		return priceScheduleMasterPersistence.remove(priceScheduleSystemId);
	}
	...
	public PriceScheduleMaster deletePriceScheduleMaster(
		PriceScheduleMaster priceScheduleMaster) {
		return priceScheduleMasterPersistence.remove(priceScheduleMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PriceScheduleMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return priceScheduleMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return priceScheduleMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PriceScheduleMaster fetchPriceScheduleMaster(
		int priceScheduleSystemId) {
		return priceScheduleMasterPersistence.fetchByPrimaryKey(priceScheduleSystemId);
	}
	...
	public PriceScheduleMaster getPriceScheduleMaster(int priceScheduleSystemId)
		...
		return priceScheduleMasterPersistence.findByPrimaryKey(priceScheduleSystemId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(priceScheduleMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PriceScheduleMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(priceScheduleMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PriceScheduleMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return priceScheduleMasterLocalService.deletePriceScheduleMaster((PriceScheduleMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return priceScheduleMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PriceScheduleMaster> getPriceScheduleMasters(int start, int end) {
		return priceScheduleMasterPersistence.findAll(start, end);
	}
	...
	public int getPriceScheduleMastersCount() {
		return priceScheduleMasterPersistence.countAll();
	}
	 ...
	 */
	public PriceScheduleMasterLocalService getPriceScheduleMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.PriceScheduleMaster",
			priceScheduleMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.PriceScheduleMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PriceScheduleMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = priceScheduleMasterPersistence.getDataSource();
	...
	@BeanReference(type = PriceScheduleMasterLocalService.class)
	protected PriceScheduleMasterLocalService priceScheduleMasterLocalService;
