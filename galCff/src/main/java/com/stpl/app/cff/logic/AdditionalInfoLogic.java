...
public class AdditionalInfoLogic {
     ...
     */
    public List<NotesDTO> getAttachmentDTOList(final int projectionId, final String moduleName) throws SystemException, Exception {
    ...
    public List<NotesDTO> addUserFile(final List<NotesDTO> list) {
        ...
        LOGGER.info("Entering addUserFile method with list size " + list.size());
     ...
     * @throws Exception the exception
     */
    public String getNotes(final int projectionId, final String moduleName) throws SystemException, Exception {

        LOGGER.info("Entering getNotes method with projectionId " + projectionId + " moduleName " + moduleName);

        final StringBuilder notes = new StringBuilder();
        notes.append(StringUtils.EMPTY);
        SimpleDateFormat dateTimeFormat = new SimpleDateFormat(" <hh/mm/ss> <MM/dd/yyyy>");
    ...
    public Boolean saveUploadedFile(final int projectionId, final String fileName, final String uploadedBy, final Double fileSize, final String moduleName) throws SystemException, Exception {
        ...
        if (docDetailsList == null || docDetailsList.isEmpty()) {
            LOGGER.info("Inside INSRT FOR DOC DETAILS");
            if (fileName.indexOf('.') == -1) {
     ...
     * @throws Exception the exception
     */
    public Boolean deleteUploadedFile(final int docDetailsId) throws SystemException, PortalException, Exception { // changed
        LOGGER.info("Entering deleteUploadedFile method with docDetailsId " + docDetailsId);
