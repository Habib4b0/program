 ...
 */
@ProviderType
public class StMSupplementalDiscProjPK implements Comparable<StMSupplementalDiscProjPK>,
	Serializable {
	public int userId;
	public int projectionDetailsSid;
	public int sessionId;

	public StMSupplementalDiscProjPK() {
	}

	public StMSupplementalDiscProjPK(int userId, int projectionDetailsSid,
		int sessionId) {
		this.userId = userId;
	...
	@Override
	public int compareTo(StMSupplementalDiscProjPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof StMSupplementalDiscProjPK)) {
			return false;
		}

		StMSupplementalDiscProjPK pk = (StMSupplementalDiscProjPK)obj;
