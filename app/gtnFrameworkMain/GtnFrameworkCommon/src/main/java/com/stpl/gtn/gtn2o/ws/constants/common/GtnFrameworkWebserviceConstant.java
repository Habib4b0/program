...
public class GtnFrameworkWebserviceConstant {
	...
	public static final String FROM_WORKFLOW_MASTER_WM_JOIN_DBO_HELPER_T = " FROM WORKFLOW_MASTER WM "
                ...
                + " JOIN NM_DISCOUNT_PROJ_MASTER DP ON DP.PROJECTION_DETAILS_SID = PD.PROJECTION_DETAILS_SID "
                + " JOIN RS_MODEL RS ON RS.RS_MODEL_SID = DP.RS_MODEL_SID";
