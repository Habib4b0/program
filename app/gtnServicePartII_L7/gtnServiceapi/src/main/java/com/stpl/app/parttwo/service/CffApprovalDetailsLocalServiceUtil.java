...
public class CffApprovalDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<CffApprovalDetailsLocalService, CffApprovalDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(CffApprovalDetailsLocalService.class);
}