 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link GcmContractDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link GcmContractDetailsImpl}.
 * </p>
 *
 * @author
...
public class GcmContractDetailsModelImpl extends BaseModelImpl<GcmContractDetails>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("GCM_CONTRACT_DETAILS_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("COMPONENT_ID", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("PLAN_LEVEL", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("COMPONENT_STATUS", Types.VARCHAR);
	...
	private static final ClassLoader _classLoader = GcmContractDetails.class.getClassLoader();
