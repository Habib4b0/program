...
public final class RelationshipBuilderIndex extends CustomComponent implements View {
     ...
     */
    public RelationshipBuilderIndex(final CustomFieldGroup relationshipBuilderBinder, final RelationshipBuilderDTO relationshipBuilderDTO) throws SystemException, PortalException {
        super();
        LOGGER.debug("Entering RelationshipBuilderIndex constructor");
        ...
        LOGGER.debug("RelationshipBuilderIndex constructor Ended ");
    }
    ...
    private Component addToContent() {
        ...
        getBinder();
        configureFields();
        LOGGER.debug("addToContent Method Returns Layout");
        return content;
    }
    ...
    private void configureFields() {
        ...
        relationshipDesc.setTabIndex(NumericConstants.TWO);
        relationshipType.setTabIndex(NumericConstants.THREE);
        hierarchyNameDdlb.setTabIndex(NumericConstants.FOUR);
        startDateFrom.setTabIndex(NumericConstants.FIVE);
        startDateTo.setTabIndex(NumericConstants.SIX);
        creationDateFrom.setTabIndex(NumericConstants.SEVEN);
        creationDateTo.setTabIndex(NumericConstants.EIGHT);
        btnSearch.setTabIndex(NumericConstants.NINE);
        btnReset.setTabIndex(NumericConstants.TEN);
        btnAdd.setTabIndex(NumericConstants.ELEVEN);
        btnEdit.setTabIndex(NumericConstants.TWELVE);
        btnView.setTabIndex(NumericConstants.THIRTEEN);
        btnDelete.setTabIndex(NumericConstants.FOURTEEN);
        btnCopy.setTabIndex(NumericConstants.FIFTEEN);
        ...
        hierarchyNameDdlb.setPageLength(NumericConstants.SEVEN);
        ...
        startDateFrom.addValueChangeListener(new Property.ValueChangeListener() {
            public void valueChange(final Property.ValueChangeEvent event) {
                try {
                    LOGGER.debug("In configureFields startDateFrom.addValueChangeListener started");
                    startDateFrom.setValue(CommonUtils.convert2DigitTo4DigitYearFormat(startDateFrom.getValue()));
                    LOGGER.debug("In configureFields startDateFrom.addValueChangeListener Ended");
        ...
        startDateTo.addValueChangeListener(new Property.ValueChangeListener() {
            public void valueChange(final Property.ValueChangeEvent event) {
                try {
                    LOGGER.debug("In configureFields startDateTo.addValueChangeListener started");
                    startDateTo.setValue(CommonUtils.convert2DigitTo4DigitYearFormat(startDateTo.getValue()));
                    LOGGER.debug("In configureFields startDateTo.addValueChangeListener Ended");
                } catch (SystemException ex) {
                    final String errorMsg = ErrorCodeUtil.getErrorMessage(ex);
                    AbstractNotificationUtils.getErrorNotification(ErrorCodeUtil.getEC(ErrorCodes.ERROR_CODE_1001), errorMsg);
                    LOGGER.error(ex);
        ...
        creationDateFrom.addValueChangeListener(new Property.ValueChangeListener() {
            public void valueChange(final Property.ValueChangeEvent event) {
                try {
                    LOGGER.debug("In configureFields creationDateFrom.addValueChangeListener started");
                    creationDateFrom.setValue(CommonUtils.convert2DigitTo4DigitYearFormat(creationDateFrom.getValue()));
                    LOGGER.debug("In configureFields creationDateFrom.addValueChangeListener Ended");
                } catch (SystemException ex) {
                    final String errorMsg = ErrorCodeUtil.getErrorMessage(ex);
                    AbstractNotificationUtils.getErrorNotification(ErrorCodeUtil.getEC(ErrorCodes.ERROR_CODE_1001), errorMsg);
                    LOGGER.error(ex);
        ...
        creationDateTo.addValueChangeListener(new Property.ValueChangeListener() {
            public void valueChange(final Property.ValueChangeEvent event) {
                try {
                    LOGGER.debug("In configureFields creationDateTo.addValueChangeListener started");
                    creationDateTo.setValue(CommonUtils.convert2DigitTo4DigitYearFormat(creationDateTo.getValue()));
                    LOGGER.debug("In configureFields creationDateTo.addValueChangeListener Ended");
                } catch (SystemException ex) {
                    final String errorMsg = ErrorCodeUtil.getErrorMessage(ex);
                    AbstractNotificationUtils.getErrorNotification(ErrorCodeUtil.getEC(ErrorCodes.ERROR_CODE_1001), errorMsg);
                    LOGGER.error(ex);
        ...
        btnCopy.addClickListener(new ClickListener() {
            public void buttonClick(final ClickEvent event) {
                ...
                LOGGER.debug("In configureFields btnCopy.addClickListener Ended");
            }
        });
        ...
        searchResultsExcelExport.addClickListener(new ClickListener() {
            public void buttonClick(final ClickEvent event) {
                LOGGER.debug("In configureFields searchResultsExcelExport.addClickListener started");
                ...
                LOGGER.debug("In configureFields searchResultsExcelExport.addClickListener Ended");
            }
        });
    ...
    private void addListeners() {
        ...
        btnEdit.addClickListener(new Button.ClickListener() {
            public void buttonClick(final Button.ClickEvent event) {
                ...
                LOGGER.debug("In configureFields btnEdit.addValueChangeListener Ended");
            }
        });
        /**
        ...
        btnSearch.addClickListener(new Button.ClickListener() {
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.debug("In configureFields btnSearch.addClickListener started");
        ...
        auditSearch.addClickListener(new ClickListener() {
             ...
             */
            public void buttonClick(final ClickEvent event) {
                LOGGER.debug("In configureFields auditsearch.addClickListener started");
    ...
    private void securityForButtons() throws PortalException, SystemException {
        ...
        final String userId = String.valueOf(VaadinSession.getCurrent()
                .getAttribute(com.stpl.app.serviceUtils.ConstantsUtils.USER_ID));
    ...
    private HorizontalLayout relationshipSearchSection() {
        LOGGER.debug("relationshipSearchSection Method started");
        ...
        LOGGER.debug("relationshipSearchSection Method returns panel");
        return hlayout1;
    }
    ...
    public ExtFilterTable relationshipResultTable() {
        LOGGER.debug("relationshipResultTable Method started");
        ...
        resultTable.addValueChangeListener(new Property.ValueChangeListener() {
            ...
            @SuppressWarnings("PMD")
            public void valueChange(final Property.ValueChangeEvent event) {
                LOGGER.debug("In relationshipResultTable resultTable.addValueChangeListener started");
                resultsItemClick(event.getProperty().getValue());
                LOGGER.debug("In relationshipResultTable resultTable.addValueChangeListener Ended");
            }
        });
        /**
        ...
        LOGGER.debug("relationshipResultTable Method returns Filtertable");
        return resultTable;
    }
    ...
    private HorizontalLayout relationshipBuilderButtons() {
        LOGGER.debug("relationshipBuilderButtons Method started");
        ...
        LOGGER.debug("relationshipBuilderButtons Method returns Layout");
        return hLayout;
    }
    ...
    private void loadHierarchy() {
        ...
        LOGGER.debug("loadHierarchy Method ended");
