...
public class StDeductionCalendarDetailsLocalServiceUtil {
    private static StDeductionCalendarDetailsLocalService _service;
    ...
    */
    ...
    public static StDeductionCalendarDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StDeductionCalendarDetailsLocalService.class.getName());

            if (invokableLocalService instanceof StDeductionCalendarDetailsLocalService) {
                _service = (StDeductionCalendarDetailsLocalService) invokableLocalService;
            } else {
                _service = new StDeductionCalendarDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StDeductionCalendarDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StDeductionCalendarDetailsLocalService service) {
    }
}
