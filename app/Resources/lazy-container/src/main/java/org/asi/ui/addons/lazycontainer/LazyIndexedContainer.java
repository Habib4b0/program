...
import com.vaadin.v7.data.Container;
 ...
 public class LazyIndexedContainer
   extends IndexedContainer
 {
   ...
   public LazyIndexedContainer(Class type, DAO dao, SearchCriteria criteria)
   {
   ...
   private List<Object> findItems(int startIndex, int numberOfIds)
   {
     List<Object> items = this.dao.find(this.criteria, startIndex, numberOfIds, this.orderByColumns);
     return items;
   }
