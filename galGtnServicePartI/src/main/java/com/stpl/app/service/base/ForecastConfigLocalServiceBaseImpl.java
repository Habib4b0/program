...
import com.stpl.app.service.ForecastConfigLocalService;
...
/**
 * Provides the base implementation for the forecast config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ForecastConfigLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ForecastConfigLocalServiceImpl
 * @see com.stpl.app.service.ForecastConfigLocalServiceUtil
 * @generated
 */
public abstract class ForecastConfigLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ForecastConfigLocalService,
        IdentifiableBean {
    ...
    private ForecastConfigLocalServiceClpInvoker _clpInvoker = new ForecastConfigLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ForecastConfigLocalServiceUtil} to access the forecast config local service.
     */
    ...
    @Override
    public ForecastConfig addForecastConfig(ForecastConfig forecastConfig)
        throws SystemException {
        forecastConfig.setNew(true);

        return forecastConfigPersistence.update(forecastConfig);
    }
     ...
     */
    @Override
    public ForecastConfig createForecastConfig(int forecastConfigSid) {
        return forecastConfigPersistence.create(forecastConfigSid);
    }
    ...
    @Override
    public ForecastConfig deleteForecastConfig(int forecastConfigSid)
        throws PortalException, SystemException {
        return forecastConfigPersistence.remove(forecastConfigSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ForecastConfig deleteForecastConfig(ForecastConfig forecastConfig)
        throws SystemException {
        return forecastConfigPersistence.remove(forecastConfig);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ForecastConfig.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return forecastConfigPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return forecastConfigPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ForecastConfig fetchForecastConfig(int forecastConfigSid)
        throws SystemException {
        return forecastConfigPersistence.fetchByPrimaryKey(forecastConfigSid);
    }
     ...
     */
    @Override
    public ForecastConfig getForecastConfig(int forecastConfigSid)
        throws PortalException, SystemException {
        return forecastConfigPersistence.findByPrimaryKey(forecastConfigSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return forecastConfigPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ForecastConfig> getForecastConfigs(int start, int end)
        throws SystemException {
        return forecastConfigPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getForecastConfigsCount() throws SystemException {
        return forecastConfigPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ForecastConfig updateForecastConfig(ForecastConfig forecastConfig)
        throws SystemException {
        return forecastConfigPersistence.update(forecastConfig);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ForecastConfig",
            forecastConfigLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.ForecastConfig");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = forecastConfigPersistence.getDataSource();
