...
AS (
	SELECT SUM(IIF(( SALES_INCLUSION = CONVERT(CHAR(1), @SALES_INCLUSION) OR @SALES_INCLUSION IS NULL ), ISNULL(ACTUAL_SALES,0), NULL)) PROJECTION_SALES
		,SUM(IIF(( SALES_INCLUSION = CONVERT(CHAR(1), @SALES_INCLUSION) OR @SALES_INCLUSION IS NULL ), ISNULL(ACTUAL_UNITS,0), NULL) * Isnull(UOM_VALUE, 0)) PROJECTION_UNITS
		,P.PERIOD
		,P.YEAR
		,CD.PPA_DISCOUNT
...
AS (
	SELECT SUM(IIF(( SALES_INCLUSION = CONVERT(CHAR(1), @SALES_INCLUSION) OR @SALES_INCLUSION IS NULL ), ISNULL(PROJECTION_SALES,0), NULL)) PROJECTION_SALES
		,SUM(IIF(( SALES_INCLUSION = CONVERT(CHAR(1), @SALES_INCLUSION) OR @SALES_INCLUSION IS NULL ), ISNULL(PROJECTION_UNITS,0), NULL) * Isnull(UOM_VALUE, 0)) PROJECTION_UNITS
		,P.PERIOD
		,P.YEAR
		,CD.PPA_DISCOUNT
...
SELECT SUM(IIF(( SALES_INCLUSION = CONVERT(CHAR(1), @SALES_INCLUSION) OR @SALES_INCLUSION IS NULL ), ISNULL(ACTUAL_SALES,0), NULL)) ACTUAL_SALES
	,SUM(IIF(( SALES_INCLUSION = CONVERT(CHAR(1), @SALES_INCLUSION) OR @SALES_INCLUSION IS NULL ), ISNULL(ACTUAL_UNITS,0), NULL) * Isnull(UOM_VALUE, 0)) ACTUAL_UNITS
	,P.PERIOD
	,P.YEAR
	,SELECTED_LEVEL
FROM ' + @SALES_ACTUAL_TABLE + ' NSP
...
AS (
	SELECT SUM(IIF(( SALES_INCLUSION = @SALES_INCLUSION OR @SALES_INCLUSION IS NULL ), ISNULL(ACTUAL_SALES,0), NULL)) PROJECTION_SALES
		,SUM(IIF(( SALES_INCLUSION = @SALES_INCLUSION OR @SALES_INCLUSION IS NULL ), ISNULL(ACTUAL_UNITS,0), NULL) * ISNULL(UOM_VALUE, 0)) PROJECTION_UNITS
		,P.PERIOD
		,P.YEAR
		,PPA_DISCOUNT
		,PD.PROJECTION_MASTER_SID
...
AS (
	SELECT pd.PROJECTION_MASTER_SID
		...
		,SUM(IIF(( SALES_INCLUSION = @SALES_INCLUSION OR @SALES_INCLUSION IS NULL ), ISNULL(PROJECTION_UNITS,0), NULL) * ISNULL(UOM_VALUE, 0)) PROJECTION_UNITS
		,P.PERIOD
		,P.YEAR
		,PPA_DISCOUNT
...
SELECT SUM(IIF(( SALES_INCLUSION = @SALES_INCLUSION OR @SALES_INCLUSION IS NULL ), ISNULL(ACTUAL_SALES,0), NULL)) ACTUAL_SALES
	,SUM(IIF(( SALES_INCLUSION = @SALES_INCLUSION OR @SALES_INCLUSION IS NULL ), ISNULL(ACTUAL_UNITS,0), NULL) * ISNULL(UOM_VALUE, 0)) ACTUAL_UNITS
	,P.PERIOD
	,P.YEAR
	,b.SELECTED_LEVEL
	,pd.PROJECTION_MASTER_SID
