...
public interface DataSelectionDAO {
     ...
     * @throws Exception the exception
     */
    ForecastingViewMaster deleteForecastingViewMaster(int systemId) throws SystemException, PortalException, Exception;
     ...
     * @throws Exception the exception
     */
    ForecastingViewMaster getForecastingViewMaster(int systemId) throws SystemException, PortalException, Exception;
     ...
     * @throws Exception the exception
     */
    ForecastingViewMaster addForecastingViewMaster(ForecastingViewMaster forecastViewMaster) throws SystemException, Exception;
     ...
     * @throws Exception the exception
     */
    ForecastingViewMaster updateForecastingViewMaster(ForecastingViewMaster forecastViewMaster) throws SystemException, Exception;
    ...
    public List<ProjectionCustHierarchy> findCustHierarchyByProjectionId(final DynamicQuery query) throws SystemException, Exception;

    public List<ProjectionProdHierarchy> findProdHierarchyByProjectionId(final DynamicQuery query) throws SystemException, Exception;

    public List<ProjectionDetails> findProjDetailsByProjectionId(final DynamicQuery query) throws SystemException, Exception;
    ...
    ProjectionDetails addProjectionDetails(ProjectionDetails projectionDetails) throws PortalException, SystemException, Exception;
