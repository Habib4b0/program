 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link CfpDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CfpDetailsImpl}.
 * </p>
 *
 * @author
 * @see CfpDetailsImpl
...
public class CfpDetailsModelImpl extends BaseModelImpl<CfpDetails>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("COMPANY_CFP_ATTACHED_STATUS", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("TRADE_CLASS", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("COMPANY_CFP_ATTACHED_DATE", Types.TIMESTAMP);
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.stpl.app.service.util.PropsUtil.get(
			...
			true);
	public static final long CFPMODELSID_COLUMN_BITMASK = 1L;
	public static final long CFPDETAILSSID_COLUMN_BITMASK = 2L;
	...
	private static final ClassLoader _classLoader = CfpDetails.class.getClassLoader();
