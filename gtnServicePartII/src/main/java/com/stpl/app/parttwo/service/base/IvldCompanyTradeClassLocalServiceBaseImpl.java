...
public abstract class IvldCompanyTradeClassLocalServiceBaseImpl
    ...
    private IvldCompanyTradeClassLocalServiceClpInvoker _clpInvoker = new IvldCompanyTradeClassLocalServiceClpInvoker();
    ...
    public IvldCompanyTradeClass deleteIvldCompanyTradeClass(
        int ivldCompanyTradeClassSid) throws PortalException, SystemException {
    ...
    public IvldCompanyTradeClass fetchIvldCompanyTradeClass(
        int ivldCompanyTradeClassSid) throws SystemException {
     ...
     */
    @Override
    public int getIvldCompanyTradeClassesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.IvldCompanyTradeClass",
