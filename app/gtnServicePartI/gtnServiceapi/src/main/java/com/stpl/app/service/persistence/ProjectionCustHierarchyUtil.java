...
/**
 * The persistence utility for the projection cust hierarchy service. This utility wraps {@link com.stpl.app.service.persistence.impl.ProjectionCustHierarchyPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class ProjectionCustHierarchyUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(projectionCustHierarchy);
	}
	 ...
	 */
	public static List<ProjectionCustHierarchy> findWithDynamicQuery(
	 ...
	 */
	public static ProjectionCustHierarchy update(
		ProjectionCustHierarchy projectionCustHierarchy) {
		return getPersistence().update(projectionCustHierarchy);
	}
	...
	public static ProjectionCustHierarchy update(
		...
		return getPersistence().update(projectionCustHierarchy, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		ProjectionCustHierarchy projectionCustHierarchy) {
		getPersistence().cacheResult(projectionCustHierarchy);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(projectionCustHierarchies);
	}
	...
	*/
	public static ProjectionCustHierarchy create(int projectionCustHierarchySid) {
		return getPersistence().create(projectionCustHierarchySid);
	}
	...
	*/
	public static ProjectionCustHierarchy remove(int projectionCustHierarchySid)
		throws com.stpl.app.exception.NoSuchProjectionCustHierarchyException {
		return getPersistence().remove(projectionCustHierarchySid);
	}

	public static ProjectionCustHierarchy updateImpl(
		ProjectionCustHierarchy projectionCustHierarchy) {
		return getPersistence().updateImpl(projectionCustHierarchy);
	}
	...
	* @throws NoSuchProjectionCustHierarchyException if a projection cust hierarchy with the primary key could not be found
	*/
	public static ProjectionCustHierarchy findByPrimaryKey(
		int projectionCustHierarchySid)
		throws com.stpl.app.exception.NoSuchProjectionCustHierarchyException {
		return getPersistence().findByPrimaryKey(projectionCustHierarchySid);
	}
	...
	*/
	public static ProjectionCustHierarchy fetchByPrimaryKey(
		int projectionCustHierarchySid) {
		return getPersistence().fetchByPrimaryKey(projectionCustHierarchySid);
	}

	public static java.util.Map<java.io.Serializable, ProjectionCustHierarchy> fetchByPrimaryKeys(
	...
	*/
	public static List<ProjectionCustHierarchy> findAll() {
	...
	*/
	public static List<ProjectionCustHierarchy> findAll(int start, int end) {
	...
	*/
	...
	public static ProjectionCustHierarchyPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<ProjectionCustHierarchyPersistence, ProjectionCustHierarchyPersistence> _serviceTracker =
		ServiceTrackerFactory.open(ProjectionCustHierarchyPersistence.class);
}