        ...
        saveBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                ...
                try {
                    ...
                    if ("0".equals(binder.getField("organizationKey").getValue().toString()) || ConstantsUtils.SELECT_ONE.equals(binder.getField("organizationKey").getValue().toString())) {
                        if (flag) {
                            errorMessage.append(ConstantsUtils.COMMA);
                        }
                        errorMessage.append("Organization Key");
                        flag = true;
                    }
                    if (flag) {
    ...
    public void resetlogicforedit(){
                       ...
                       final int systemId = sessionDTO.getSystemId();
                        ...
                        if (selectedTabIndex == 0) {         
                           ...
                           ComboBox orgKey=(ComboBox)binder.getField("organizationKey");
    ...
    public void resetlogicforadd(){
        ...
        try {
                                ...
                                if (selectedTabIndex == 0) {
                                    ...
                                    ComboBox organizationKey = (ComboBox) binder.getField("organizationKey");
