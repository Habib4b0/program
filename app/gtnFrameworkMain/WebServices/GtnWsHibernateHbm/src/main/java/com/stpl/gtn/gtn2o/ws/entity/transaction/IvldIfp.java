...
/**
 * IvldIfp generated by hbm2java
 */
@SuppressWarnings("serial")
public class IvldIfp  implements java.io.Serializable {


     private int ivldIfpSid;
	...
	public IvldIfp(int ivldIfpSid, String ifpIntfid) {
        this.ivldIfpSid = ivldIfpSid;
        this.ifpIntfid = ifpIntfid;
    }

	public IvldIfp(int ivldIfpSid, String ifpIntfid, String ifpId, String ifpNo, String ifpName, String ifpType,
			...
			String reasonForFailure, Date intfInsertedDate, String errorCode, String errorField, Boolean checkRecord,
    ...
    public int getIvldIfpSid() {
        return this.ivldIfpSid;
    }
    
    public void setIvldIfpSid(int ivldIfpSid) {
        this.ivldIfpSid = ivldIfpSid;
    }
