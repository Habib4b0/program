...
public class ItemIdentifierLocalServiceUtil {
    private static ItemIdentifierLocalService _service;
    ...
    */
    ...
    public static java.util.List<com.stpl.app.model.ItemIdentifier> findByItemIrtIdentifierDetails(
        int itemMasterSid)
        throws com.stpl.portal.kernel.exception.SystemException {
        return getService().findByItemIrtIdentifierDetails(itemMasterSid);
    }
    ...
    public static ItemIdentifierLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ItemIdentifierLocalService.class.getName());

            if (invokableLocalService instanceof ItemIdentifierLocalService) {
                _service = (ItemIdentifierLocalService) invokableLocalService;
            } else {
                _service = new ItemIdentifierLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ItemIdentifierLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ItemIdentifierLocalService service) {
    }
}
