 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.stpl.app.parttwo.model.CustomerGtsActualModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CustomerGtsActualImpl}.
 * </p>
 *
 * @author
 * @see CustomerGtsActualImpl
 * @see com.stpl.app.parttwo.model.CustomerGtsActual
 * @see com.stpl.app.parttwo.model.CustomerGtsActualModel
 * @generated
 */
public class CustomerGtsActualModelImpl extends BaseModelImpl<CustomerGtsActual>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a customer gts actual model instance should use the {@link com.stpl.app.parttwo.model.CustomerGtsActual} interface instead.
     */
    ...
    private static ClassLoader _classLoader = CustomerGtsActual.class.getClassLoader();
