...
import com.stpl.app.service.CcpMapLocalService;
...
/**
 * Provides the base implementation for the ccp map local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CcpMapLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.CcpMapLocalServiceImpl
 * @see com.stpl.app.service.CcpMapLocalServiceUtil
 * @generated
 */
public abstract class CcpMapLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements CcpMapLocalService, IdentifiableBean {
    ...
    private CcpMapLocalServiceClpInvoker _clpInvoker = new CcpMapLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CcpMapLocalServiceUtil} to access the ccp map local service.
     */
    ...
    @Override
    public CcpMap addCcpMap(CcpMap ccpMap) throws SystemException {
        ccpMap.setNew(true);

        return ccpMapPersistence.update(ccpMap);
    }
     ...
     */
    @Override
    public CcpMap createCcpMap(int ccpMapSid) {
        return ccpMapPersistence.create(ccpMapSid);
    }
    ...
    @Override
    public CcpMap deleteCcpMap(int ccpMapSid)
        throws PortalException, SystemException {
        return ccpMapPersistence.remove(ccpMapSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public CcpMap deleteCcpMap(CcpMap ccpMap) throws SystemException {
        return ccpMapPersistence.remove(ccpMap);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CcpMap.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return ccpMapPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return ccpMapPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ccpMapPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return ccpMapPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public CcpMap fetchCcpMap(int ccpMapSid) throws SystemException {
        return ccpMapPersistence.fetchByPrimaryKey(ccpMapSid);
    }
     ...
     */
    @Override
    public CcpMap getCcpMap(int ccpMapSid)
        throws PortalException, SystemException {
        return ccpMapPersistence.findByPrimaryKey(ccpMapSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ccpMapPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<CcpMap> getCcpMaps(int start, int end)
        throws SystemException {
        return ccpMapPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCcpMapsCount() throws SystemException {
        return ccpMapPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public CcpMap updateCcpMap(CcpMap ccpMap) throws SystemException {
        return ccpMapPersistence.update(ccpMap);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.CcpMap",
            ccpMapLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.CcpMap");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ccpMapPersistence.getDataSource();
