...
public class PublicPrivateLookupTableLogic extends PageTableLogic {
    ...
    private ExclusionDetailsLogic logic = new ExclusionDetailsLogic();
    private boolean isGenerate = false;
    public static final Logger LOGGER = LoggerFactory.getLogger(PublicPrivateLookupTableLogic.class);
