...
IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_CFP' AND COLUMN_NAME  = 'CFP_ELIGIBILITY_DATE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_CONTRACT_HEADER' AND COLUMN_NAME  = 'CONTRACT_ELIGIBLE_DATE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
-------------------------------AGN-429----------------------------
 ...
 IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'INTERNAL_NOTES' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'PRICE_PROTECTION_STATUS' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'PRICE_PROTECTION_PRICE_TYPE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  ...
  IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NEP' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
    IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NEP_FORMULA' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
      ...
      IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'BASE_PRICE_TYPE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
      IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NET_BASE_PRICE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
    IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NET_BASE_PRICE_FORMULA' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
   ...
   IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'SUBSEQUENT_PERIOD_PRICE_TYPE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
   IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NET_SUBSEQUENT_PERIOD_PRICE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
     ...
     IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NET_SUBSEQUENT_PERIOD_PRICE_FORMULA' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
       ...
       IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'MAX_INCREMENTAL_CHANGE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
         ...
         IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'RESET_ELIGIBLE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
      IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'RESET_TYPE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  ...
  IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'RESET_DATE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
        ...
        IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'RESET_INTERVAL' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
        ...
        IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'RESET_FREQUENCY' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
         ...
         IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'RESET_PRICE_TYPE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
         IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NET_RESET_PRICE_TYPE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
         IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NET_RESET_PRICE_FORMULA' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
         IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NET_PRICE_TYPE' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
END
  GO
         IF NOT EXISTS(
    SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS
      WHERE TABLE_NAME = 'IVLD_PRICE_SCHEDULE' AND COLUMN_NAME  = 'NET_PRICE_TYPE_FORMULA' AND TABLE_SCHEMA = 'DBO')
    BEGIN
...
-------------------------- COLUMN ADDITION IN IVLD_REBATE_SCHEDULE --------------------------
 IF NOT EXISTS (
		SELECT 1
		FROM INFORMATION_SCHEMA.COLUMNS
		WHERE TABLE_NAME = 'IVLD_REBATE_SCHEDULE'
...
------------ADDITIONAL COLUMN----ACCRUAL_INBOUND_INTERFACE_ID--------
...
BEGIN 
 ALTER TABLE IVLD_ACCRUAL_INBOUND 
		ADD   ACCRUAL_INBOUND_INTERFACE_ID VARCHAR(200)
END
GO
...
IF NOT EXISTS (SELECT 1
               FROM   SYS.DEFAULT_CONSTRAINTS
               WHERE  PARENT_OBJECT_ID = Object_id('IVLD_ITEM_UOM')
                      AND NAME = 'DF_IVLD_ITEM_UOM_REPROCESSED_FLAG')
  BEGIN
      ALTER TABLE IVLD_ITEM_UOM
        ADD CONSTRAINT DF_IVLD_ITEM_UOM_REPROCESSED_FLAG DEFAULT ('N') FOR REPROCESSED_FLAG
  END
...
IF NOT EXISTS (SELECT 1
               FROM   SYS.DEFAULT_CONSTRAINTS
               WHERE  PARENT_OBJECT_ID = OBJECT_ID('IVLD_RETURN_RATE_FORECAST')
                      AND NAME = 'DF_IVLD_RETURN_RATE_FORECAST_REPROCESSED_FLAG')
  BEGIN
      ALTER TABLE IVLD_RETURN_RATE_FORECAST
        ADD CONSTRAINT DF_IVLD_RETURN_RATE_FORECAST_REPROCESSED_FLAG DEFAULT 'N' FOR REPROCESSED_FLAG
  END
