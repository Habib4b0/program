...
/**
 * The persistence utility for the st adjustment reserve detail service. This utility wraps {@link com.stpl.app.parttwo.service.persistence.impl.StAdjustmentReserveDetailPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StAdjustmentReserveDetailUtil {
	...
	*/
	public static StAdjustmentReserveDetail create(java.lang.String workflowId) {
	...
	*/
	public static StAdjustmentReserveDetail remove(java.lang.String workflowId)
		throws com.stpl.app.parttwo.exception.NoSuchStAdjustmentReserveDetailException {
		return getPersistence().remove(workflowId);
	}

	public static StAdjustmentReserveDetail updateImpl(
		StAdjustmentReserveDetail stAdjustmentReserveDetail) {
	...
	* @throws NoSuchStAdjustmentReserveDetailException if a st adjustment reserve detail with the primary key could not be found
	*/
	public static StAdjustmentReserveDetail findByPrimaryKey(
	...
	*/
	public static StAdjustmentReserveDetail fetchByPrimaryKey(
		java.lang.String workflowId) {
		return getPersistence().fetchByPrimaryKey(workflowId);
	}

	public static java.util.Map<java.io.Serializable, StAdjustmentReserveDetail> fetchByPrimaryKeys(
	...
	*/
	public static List<StAdjustmentReserveDetail> findAll() {
	...
	*/
	public static List<StAdjustmentReserveDetail> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<StAdjustmentReserveDetailPersistence, StAdjustmentReserveDetailPersistence> _serviceTracker =
		ServiceTrackerFactory.open(StAdjustmentReserveDetailPersistence.class);
}