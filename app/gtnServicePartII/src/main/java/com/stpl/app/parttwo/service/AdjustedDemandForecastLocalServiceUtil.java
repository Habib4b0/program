...
public class AdjustedDemandForecastLocalServiceUtil {
    private static AdjustedDemandForecastLocalService _service;
    ...
    */
    ...
    public static AdjustedDemandForecastLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    AdjustedDemandForecastLocalService.class.getName());

            if (invokableLocalService instanceof AdjustedDemandForecastLocalService) {
                _service = (AdjustedDemandForecastLocalService) invokableLocalService;
            } else {
                _service = new AdjustedDemandForecastLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(AdjustedDemandForecastLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(AdjustedDemandForecastLocalService service) {
    }
}
