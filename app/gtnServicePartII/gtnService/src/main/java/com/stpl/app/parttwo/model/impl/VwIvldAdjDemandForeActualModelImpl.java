 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link VwIvldAdjDemandForeActualModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link VwIvldAdjDemandForeActualImpl}.
 * </p>
 *
 * @author
...
public class VwIvldAdjDemandForeActualModelImpl extends BaseModelImpl<VwIvldAdjDemandForeActual>
	...
	static {
		TABLE_COLUMNS_MAP.put("FORECAST_VERSION", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ADJUSTED_DEMAND_FORECAST_INTF_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("COUNTRY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("FORECAST_TYPE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("TOTAL_ADJUSTED_DEMAND_UNITS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("BRAND_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("IS_FORECAST", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("TOTAL_ADJUSTED_DEMAND_AMOUNT", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("IVLD_ADJUSTED_DEMAND_FORECAST_SID", Types.INTEGER);
	...
	private static final ClassLoader _classLoader = VwIvldAdjDemandForeActual.class.getClassLoader();
