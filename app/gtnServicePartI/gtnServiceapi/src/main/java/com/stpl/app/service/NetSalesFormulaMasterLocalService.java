...
/**
 * Provides the local service interface for NetSalesFormulaMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see NetSalesFormulaMasterLocalServiceUtil
...
public interface NetSalesFormulaMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NetSalesFormulaMasterLocalServiceUtil} to access the net sales formula master local service. Add custom service methods to {@link com.stpl.app.service.impl.NetSalesFormulaMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
