...
/**
 * The persistence utility for the m supplemental disc proj service. This utility wraps {@link com.stpl.app.service.persistence.impl.MSupplementalDiscProjPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class MSupplementalDiscProjUtil {
	...
	*/
	public static void cacheResult(MSupplementalDiscProj mSupplementalDiscProj) {
	...
	*/
	public static void cacheResult(
		List<MSupplementalDiscProj> mSupplementalDiscProjs) {
	...
	*/
	public static MSupplementalDiscProj create(int projectionDetailsSid) {
	...
	*/
	public static MSupplementalDiscProj remove(int projectionDetailsSid)
		throws com.stpl.app.exception.NoSuchMSupplementalDiscProjException {
		return getPersistence().remove(projectionDetailsSid);
	}

	public static MSupplementalDiscProj updateImpl(
		MSupplementalDiscProj mSupplementalDiscProj) {
	...
	* @throws NoSuchMSupplementalDiscProjException if a m supplemental disc proj with the primary key could not be found
	*/
	public static MSupplementalDiscProj findByPrimaryKey(
	...
	*/
	public static MSupplementalDiscProj fetchByPrimaryKey(
		int projectionDetailsSid) {
		return getPersistence().fetchByPrimaryKey(projectionDetailsSid);
	}

	public static java.util.Map<java.io.Serializable, MSupplementalDiscProj> fetchByPrimaryKeys(
	...
	*/
	public static List<MSupplementalDiscProj> findAll() {
	...
	*/
	public static List<MSupplementalDiscProj> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<MSupplementalDiscProjPersistence, MSupplementalDiscProjPersistence> _serviceTracker =
		ServiceTrackerFactory.open(MSupplementalDiscProjPersistence.class);
}