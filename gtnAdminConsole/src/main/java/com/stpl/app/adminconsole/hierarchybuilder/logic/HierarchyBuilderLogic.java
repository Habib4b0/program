...
public class HierarchyBuilderLogic {
     ...
     */
    public List<HelperDTO> getHierachyCategory(final String listName) throws SystemException {
        ...
        LOGGER.debug("getHierachyCategory return List<HelperDTO> results=" + results.size());
        return results;
    }
     ...
     * @throws Exception the exception
     */
    public List<SearchResultsDTO> getSearchResults(final ErrorfulFieldGroup hierarchyBuilderForm, final List<SortByColumn> sortByColumns, final Set<Container.Filter> filterSet) throws SystemException, ParseException, PortalException {
        LOGGER.debug("getSearchResults started with P1:CustomFieldGroup hierarchyBuilderForm");
        ...
        LOGGER.debug("getSearchResults return List<HierarchyBuilderDTO> hierarchyBuilderDTO");
     ...
     * @throws Exception the exception
     */
    public List<SearchResultsDTO> getHistorySearchResults(final ErrorfulFieldGroup hierarchyBuilderForm) throws SystemException, PortalException {
        LOGGER.debug("getSearchResults started with P1:CustomFieldGroup hierarchyBuilderForm");
    ...
    private String[] getdefSysList(final List levelDefenitionList) {
        LOGGER.debug("getdefSysList started with P1:List levelDefenitionList");
        ...
        LOGGER.debug("getdefSysList return String[] obj");
        return obj;
    }
     ...
     * @throws Exception the exception
     */
    public int levelCheckCount(final int levelNo) throws SystemException {

        LOGGER.debug("levelCheckCount started with P1:int levelNo=" + levelNo);
        ...
        LOGGER.debug("levelCheckCount return int count=" + count);
        return count;
    }
     ...
     * @throws Exception the exception
     */
    public int updateLevelCheckCount(final int levelSystemId, final int levelNo) throws SystemException {
        LOGGER.debug("updateLevelCheckCount started with P1:int levelSystemId=" + levelSystemId + " and int levelNo" + levelNo);
        int updateCount;
        final DynamicQuery countQuery = DynamicQueryFactoryUtil.forClass(ImtdLevelValues.class);
        ...
        LOGGER.debug("updateLevelCheckCount return int finalCount=" + finalCount);
        return finalCount;
    }
    ...
    public String saveHierarchy(final CustomFieldGroup hierarchyBuilderBinder, final BeanItemContainer<HierarchyBuilderLevelDTO> hierarchyBuilderLevelDTOBean, final SessionDTO sessionDTO) throws SystemException, PortalException
        ...
        LOGGER.debug("systemId 1-====" + systemId);
        if (systemId == 0) {
            ...
            LOGGER.debug("item======================id=================" + item.getHierarchyDefinitionSid());
        ...
        LOGGER.debug("saveHierarchy return msg=Success");
     ...
     * @throws Exception the exception
     */
    public void saveLevelList(final HierarchyDefinition dto, final List<HierarchyBuilderLevelDTO> levelList, final SessionDTO sessionDTO) throws SystemException {
        LOGGER.debug("saveLevelList started with P1:HierarchyDefinition dto and List<HierarchyBuilderLevelDTO> levelList size:" + levelList.size());
        int user = Integer.valueOf(sessionDTO.getUserId());
        ...
        try {
            ...
            LOGGER.debug("saveLevelList Ended");
        } catch (Exception e) {
            LOGGER.error(e);
        }
    }
     ...
     * @throws Exception the exception
     */
    public void saveLevelValues(final List<LevelDTO> levelValuesList, final HierarchyLevelDefinition result, final SessionDTO sessionDTO) throws SystemException {
        final Date date = new Date();
        LOGGER.debug("saveLevelValues started with P1:List<LevelDTO> levelValuesList size:" + levelValuesList.size() + "and HierarchyLevelDefinition result");
        ...
        LOGGER.debug("saveLevelValues Ended");
    }
    ...
    private List<HierarchyBuilderLevelDTO> getCustomizedLevelDefenition(final List<HierarchyLevelDefinition> resultList) throws SystemException {
        ...
        LOGGER.debug("getCustomizedLevelDefenition return List<HierarchyBuilderLevelDTO> hierarchyLevelDefinitionList size:" + hierarchyLevelDefinitionList.size());
     ...
     * @throws Exception the exception
     */
    public HierarchyBuilderDTO gethierarchyBuilderDTO(final int systemId) throws SystemException, PortalException {
        final HierarchyBuilderDTO objDTO = new HierarchyBuilderDTO();
        LOGGER.debug("gethierarchyBuilderDTO started with P1:int systemId=" + systemId);
        final HashMap<String, String> userInfoMap = (HashMap<String, String>) CommonUtil.getCreatedByUser();
     ...
     * @throws Exception the exception
     */
    public HierarchyBuilderDTO getHistHierarchyBuilderDTO(final int systemId, final int version) throws SystemException, PortalException {
        final HierarchyBuilderDTO objDTO = new HierarchyBuilderDTO();
        LOGGER.debug("gethierarchyBuilderDTO started with P1:int systemId=" + systemId);
        final HashMap<String, String> userInfoMap = (HashMap<String, String>) CommonUtil.getCreatedByUser();
    ...
    public HierarchyBuilderLevelDTO getHierarchyBuilderLevelDTO(final int systemId) throws SystemException, PortalException {
        ...
        LOGGER.debug("getHierarchyBuilderLevelDTO started with P1:int systemId=" + systemId);
        ...
        LOGGER.debug("getHierarchyBuilderLevelDTO return HierarchyBuilderLevelDTO objDTO");
        return objDTO;
    }
    ...
    public List<HierarchyBuilderLevelDTO> getHierarchyLevelDTOByDefinitionSystemId(final int systemId) throws SystemException {
        ...
        LOGGER.debug("getHierarchyLevelDTOByDefinitionSystemId return List<HierarchyBuilderLevelDTO> size:" + finalList.size());
        return finalList;
    }
    ...
    public List<LevelDTO> getLevels(final int systemId) throws SystemException {
        ...
        LOGGER.debug("getLevels return List<LevelDTO> size:" + list.size());
        return list;
    }
    ...
    public String deleteHierarchy(final int systemId) throws SystemException, PortalException {
        ...
        if (rblist.isEmpty()) {
            ...
            LOGGER.debug("deleteHierarchy return String deletedHrName=");
            return ConstantsUtils.SUCCESS;
     ...
     * @throws Exception the exception
     */
    public void deleteHierarchyLevelValues(final int levelSystemId) throws SystemException, PortalException {
        LOGGER.debug("deleteHierarchyLevelValues started with P1:int levelSystemId=" + levelSystemId);
        ...
        LOGGER.debug("deleteHierarchyLevelValues ended");
    ...
    public List<TableFieldLookUpDTO> getTableAndField(final TextField tableName, final TextField fieldName) throws SystemException {
        ...
        LOGGER.debug("getTableAndField return List<TableFieldLookUpDTO> size:" + lookUpList.size());
        return lookUpList;
    }
    ...
    public List<TableFieldLookUpDTO> getUniqueTable(final TableFieldLookUpDTO tableFieldLookUpDTO, int startIndex, int offset, Set<Container.Filter> filters, List<SortByColumn> sortByColumns) throws PortalException, SystemException {
        ...
        LOGGER.debug("getUniqueTable return List<TableFieldLookUpDTO> lookUpList=" + lookUpList.size());
        return lookUpList;
    }

    public int getTableCount(final TableFieldLookUpDTO tableFieldLookUpDTO, Set<Container.Filter> filters) throws SystemException {
        final DynamicQuery vwUserTablesDynamicQuery = configureDynamicQuery(tableFieldLookUpDTO, filters);
        final List<String> list = dao.getLookUpData(vwUserTablesDynamicQuery);
        return list == null ? 0 : list.size();
    }
    ...
    public List<LevelDTO> getLevelList(final int levelNo) throws SystemException, PortalException {
        ...
        LOGGER.debug("getLevelList return List<LevelDTO> list=" + list.size());
        return list;
    }
     ...
     * @throws Exception the exception
     */
    public void saveTempData(final int levelNo, final String levelName, final BeanItemContainer<LevelDTO> levelDTOBean) throws SystemException {
        LOGGER.debug("saveTempData started with P1:int levelNo=" + levelNo + " P2:String levelName=" + levelName + " P3:BeanItemContainer<LevelDTO> levelDTOBean");
        ...
        LOGGER.debug("saveTempData Ended");
    }
    ...
    public List<TableFieldLookUpDTO> getLevelValues(String tableName, String fieldName, int startIndex, int offset, Set<Container.Filter> filters, List<SortByColumn> sortByColumns) throws SystemException {
        ...
        if (resultList != null && resultList.size() > 0) {
            for (final Iterator<SortByColumn> iterator = sortByColumns.iterator(); iterator.hasNext();) {
                final SortByColumn orderByColumn = (SortByColumn) iterator.next();
                LOGGER.debug("orderByColumn.getType()  " + orderByColumn.getType());
...
//            filters
            ...
            String listName = String.valueOf(obj[NumericConstants.TWO]);
    ...
    public int getLevelValuesCount(String tableName, String fieldName, Set<Container.Filter> filters) throws SystemException {
        ...
        if (resultList != null && resultList.size() > 0) {
            ...
            if (table.equals("HELPER_TABLE")) {
                ...
                LOGGER.debug("HelperQuery  " + helperQuery);
                ...
                LOGGER.debug("valueQuery  " + valueQuery);
     ...
     * @throws Exception the exception
     */
    public void deleteTempLevelValues() throws SystemException {
        LOGGER.debug("deleteTempLevelValues started");
        final List<ImtdLevelValues> tempList = dao.deleteMultipleLevels();
        dao.deleteTempLevelValues(tempList);
        LOGGER.debug("deleteTempLevelValues Ended");
    }
     ...
     * @throws Exception the exception
     */
    public List<HierarchyBuilderDTO> getHierachyDefinitionList() throws SystemException, PortalException {
        LOGGER.debug("getHierachyDefinitionList started");
        final DynamicQuery hierarchyBuilderDynamicQuery = DynamicQueryFactoryUtil.forClass(HierarchyDefinition.class);
        List<HierarchyDefinition> resultList;
        resultList = dao.getHierachyDefinitionList(hierarchyBuilderDynamicQuery);
        final List<HierarchyBuilderDTO> list = getCustomizedResults1(resultList);
        LOGGER.debug("getHierachyDefinitionList return List<HierarchyBuilderDTO> list");
        return list;
    }
    ...
    public int getExistingVersion(final int systemId) throws SystemException, PortalException {
        ...
        LOGGER.debug("getExistingItemgroupNames return results");
        return version;
    }
