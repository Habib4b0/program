...
public class GtnUIFrameWorkLoadDualListBoxAction implements GtnUIFrameWorkAction, GtnUIFrameworkActionShareable ,GtnUIFrameworkDynamicClass{
	...
	public GtnUIFrameWorkAction createInstance() {
		return new GtnUIFrameWorkLoadDualListBoxAction();
	}
