...
/**
 * Provides the local service interface for IvldGlBalance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldGlBalanceLocalServiceUtil
...
public interface IvldGlBalanceLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IvldGlBalanceLocalServiceUtil} to access the ivld gl balance local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldGlBalanceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
