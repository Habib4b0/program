...
import com.stpl.app.parttwo.service.IvldItemIdentifierLocalService;
...
/**
 * Provides the base implementation for the ivld item identifier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.IvldItemIdentifierLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class IvldItemIdentifierLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldItemIdentifierLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldItemIdentifierLocalServiceUtil} to access the ivld item identifier local service.
	 */
	...
	@Override
	public IvldItemIdentifier addIvldItemIdentifier(
		IvldItemIdentifier ivldItemIdentifier) {
		ivldItemIdentifier.setNew(true);

		return ivldItemIdentifierPersistence.update(ivldItemIdentifier);
	}
	 ...
	 */
	@Override
	public IvldItemIdentifier createIvldItemIdentifier(
		int ivldItemIdentifierSid) {
		return ivldItemIdentifierPersistence.create(ivldItemIdentifierSid);
	}
	...
	@Override
	public IvldItemIdentifier deleteIvldItemIdentifier(
		int ivldItemIdentifierSid) throws PortalException {
		return ivldItemIdentifierPersistence.remove(ivldItemIdentifierSid);
	}
	...
	public IvldItemIdentifier deleteIvldItemIdentifier(
		IvldItemIdentifier ivldItemIdentifier) {
		return ivldItemIdentifierPersistence.remove(ivldItemIdentifier);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldItemIdentifier.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldItemIdentifierPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldItemIdentifierPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldItemIdentifier fetchIvldItemIdentifier(int ivldItemIdentifierSid) {
		return ivldItemIdentifierPersistence.fetchByPrimaryKey(ivldItemIdentifierSid);
	}
	 ...
	 */
	@Override
	public IvldItemIdentifier getIvldItemIdentifier(int ivldItemIdentifierSid)
		throws PortalException {
		return ivldItemIdentifierPersistence.findByPrimaryKey(ivldItemIdentifierSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldItemIdentifierLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldItemIdentifier.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldItemIdentifierLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldItemIdentifier.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldItemIdentifierLocalService.deleteIvldItemIdentifier((IvldItemIdentifier)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldItemIdentifierPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldItemIdentifier> getIvldItemIdentifiers(int start, int end) {
		return ivldItemIdentifierPersistence.findAll(start, end);
	}
	...
	public int getIvldItemIdentifiersCount() {
		return ivldItemIdentifierPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldItemIdentifier updateIvldItemIdentifier(
		IvldItemIdentifier ivldItemIdentifier) {
		return ivldItemIdentifierPersistence.update(ivldItemIdentifier);
	}
	 ...
	 */
	public IvldItemIdentifierLocalService getIvldItemIdentifierLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.IvldItemIdentifier",
			ivldItemIdentifierLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.IvldItemIdentifier");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldItemIdentifierLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldItemIdentifierPersistence.getDataSource();
	...
	@BeanReference(type = IvldItemIdentifierLocalService.class)
	protected IvldItemIdentifierLocalService ivldItemIdentifierLocalService;
