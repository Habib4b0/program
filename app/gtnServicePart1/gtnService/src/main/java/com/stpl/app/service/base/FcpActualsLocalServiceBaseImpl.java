...
import com.stpl.app.service.FcpActualsLocalService;
...
/**
 * Provides the base implementation for the fcp actuals local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.FcpActualsLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class FcpActualsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FcpActualsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.FcpActualsLocalServiceUtil} to access the fcp actuals local service.
	 */
	...
	@Override
	public FcpActuals addFcpActuals(FcpActuals fcpActuals) {
		fcpActuals.setNew(true);

		return fcpActualsPersistence.update(fcpActuals);
	}
	 ...
	 */
	@Override
	public FcpActuals createFcpActuals(FcpActualsPK fcpActualsPK) {
		return fcpActualsPersistence.create(fcpActualsPK);
	}
	...
	@Override
	public FcpActuals deleteFcpActuals(FcpActualsPK fcpActualsPK)
		throws PortalException {
		return fcpActualsPersistence.remove(fcpActualsPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FcpActuals deleteFcpActuals(FcpActuals fcpActuals) {
		return fcpActualsPersistence.remove(fcpActuals);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FcpActuals.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fcpActualsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return fcpActualsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fcpActualsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FcpActuals fetchFcpActuals(FcpActualsPK fcpActualsPK) {
		return fcpActualsPersistence.fetchByPrimaryKey(fcpActualsPK);
	}
	 ...
	 */
	@Override
	public FcpActuals getFcpActuals(FcpActualsPK fcpActualsPK)
		throws PortalException {
		return fcpActualsPersistence.findByPrimaryKey(fcpActualsPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(fcpActualsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FcpActuals.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(fcpActualsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FcpActuals.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return fcpActualsLocalService.deleteFcpActuals((FcpActuals)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return fcpActualsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FcpActuals> getFcpActualses(int start, int end) {
		return fcpActualsPersistence.findAll(start, end);
	}
	...
	public int getFcpActualsesCount() {
		return fcpActualsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FcpActuals updateFcpActuals(FcpActuals fcpActuals) {
		return fcpActualsPersistence.update(fcpActuals);
	}
	 ...
	 */
	public FcpActualsLocalService getFcpActualsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.FcpActuals",
			fcpActualsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.FcpActuals");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FcpActualsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fcpActualsPersistence.getDataSource();
	...
	@BeanReference(type = FcpActualsLocalService.class)
	protected FcpActualsLocalService fcpActualsLocalService;
