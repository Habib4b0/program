 ...
 * @generated
 */
public class DocDetailsLocalServiceClp implements DocDetailsLocalService {
    ...
    public DocDetailsLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addDocDetails";

        _methodParameterTypes0 = new String[] { "com.stpl.app.model.DocDetails" };

        _methodName1 = "createDocDetails";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteDocDetails";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteDocDetails";

        _methodParameterTypes3 = new String[] { "com.stpl.app.model.DocDetails" };
        ...
        _methodName10 = "fetchDocDetails";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getDocDetails";
        ...
        _methodName13 = "getDocDetailses";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getDocDetailsesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateDocDetails";

        _methodParameterTypes15 = new String[] { "com.stpl.app.model.DocDetails" };
    ...
    public com.stpl.app.model.DocDetails addDocDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(docDetails) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.DocDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.DocDetails createDocDetails(int docDetailsId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { docDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.DocDetails deleteDocDetails(int docDetailsId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { docDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.DocDetails fetchDocDetails(int docDetailsId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { docDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.DocDetails getDocDetails(int docDetailsId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { docDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.DocDetails> getDocDetailses(
        ...
        return (java.util.List<com.stpl.app.model.DocDetails>) ClpSerializer.translateOutput(returnObj);
    }
