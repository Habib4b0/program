...
public class WorkflowMasterCacheModel implements CacheModel<WorkflowMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof WorkflowMasterCacheModel)) {
			return false;
		}

		WorkflowMasterCacheModel workflowMasterCacheModel = (WorkflowMasterCacheModel)obj;

		if (workflowMasterSid == workflowMasterCacheModel.workflowMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, workflowMasterSid);
	}
