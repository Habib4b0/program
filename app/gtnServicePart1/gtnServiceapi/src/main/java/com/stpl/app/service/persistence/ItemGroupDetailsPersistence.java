...
public interface ItemGroupDetailsPersistence extends BasePersistence<ItemGroupDetails> {
	...
	*/
	public void cacheResult(java.util.List<ItemGroupDetails> itemGroupDetailses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ItemGroupDetails> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ItemGroupDetails> findAll();
	...
	*/
	public java.util.List<ItemGroupDetails> findAll(int start, int end);
	...
	*/
	public java.util.List<ItemGroupDetails> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ItemGroupDetails> orderByComparator);
