...
public abstract class IvldCpiLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements IvldCpiLocalService, IdentifiableBean {
    ...
    private IvldCpiLocalServiceClpInvoker _clpInvoker = new IvldCpiLocalServiceClpInvoker();
    ...
    @Override
    public IvldCpi addIvldCpi(IvldCpi ivldCpi) throws SystemException {
        ivldCpi.setNew(true);
    ...
    @Override
    public IvldCpi deleteIvldCpi(int ivldCpiSid)
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public IvldCpi deleteIvldCpi(IvldCpi ivldCpi) throws SystemException {
    ...
    @Override
    public IvldCpi fetchIvldCpi(int ivldCpiSid) throws SystemException {
     ...
     */
    @Override
    public IvldCpi getIvldCpi(int ivldCpiSid)
        throws PortalException, SystemException {
     ...
     */
    @Override
    public int getIvldCpisCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IvldCpi updateIvldCpi(IvldCpi ivldCpi) throws SystemException {
        return ivldCpiPersistence.update(ivldCpi);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.IvldCpi",
            ivldCpiLocalService);
    }
