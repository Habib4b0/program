...
import com.stpl.app.parttwo.service.ArpOutboundLocalService;
...
/**
 * Provides the base implementation for the arp outbound local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.ArpOutboundLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.ArpOutboundLocalServiceImpl
 * @see com.stpl.app.parttwo.service.ArpOutboundLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ArpOutboundLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ArpOutboundLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.ArpOutboundLocalServiceUtil} to access the arp outbound local service.
	 */
	...
	public ArpOutbound addArpOutbound(ArpOutbound arpOutbound) {
		...
		return arpOutboundPersistence.update(arpOutbound);
	}
	...
	public ArpOutbound createArpOutbound(ArpOutboundPK arpOutboundPK) {
		return arpOutboundPersistence.create(arpOutboundPK);
	}
	...
	public ArpOutbound deleteArpOutbound(ArpOutboundPK arpOutboundPK)
		...
		return arpOutboundPersistence.remove(arpOutboundPK);
	}
	...
	public ArpOutbound deleteArpOutbound(ArpOutbound arpOutbound) {
		return arpOutboundPersistence.remove(arpOutbound);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ArpOutbound.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return arpOutboundPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return arpOutboundPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return arpOutboundPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ArpOutbound fetchArpOutbound(ArpOutboundPK arpOutboundPK) {
		return arpOutboundPersistence.fetchByPrimaryKey(arpOutboundPK);
	}
	...
	public ArpOutbound getArpOutbound(ArpOutboundPK arpOutboundPK)
		throws PortalException {
		return arpOutboundPersistence.findByPrimaryKey(arpOutboundPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(arpOutboundLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ArpOutbound.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(arpOutboundLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ArpOutbound.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return arpOutboundLocalService.deleteArpOutbound((ArpOutbound)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return arpOutboundPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ArpOutbound> getArpOutbounds(int start, int end) {
		return arpOutboundPersistence.findAll(start, end);
	}
	...
	public int getArpOutboundsCount() {
		return arpOutboundPersistence.countAll();
	}
	 ...
	 */
	public ArpOutboundLocalService getArpOutboundLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.ArpOutbound",
			arpOutboundLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.ArpOutbound");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ArpOutboundLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = arpOutboundPersistence.getDataSource();
	...
	@BeanReference(type = ArpOutboundLocalService.class)
	protected ArpOutboundLocalService arpOutboundLocalService;
