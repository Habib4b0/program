...
import com.stpl.app.parttwo.service.IvldItemMasterLocalService;
...
/**
 * Provides the base implementation for the ivld item master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.IvldItemMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.IvldItemMasterLocalServiceImpl
 * @see com.stpl.app.parttwo.service.IvldItemMasterLocalServiceUtil
 * @generated
 */
public abstract class IvldItemMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements IvldItemMasterLocalService,
        IdentifiableBean {
    ...
    private IvldItemMasterLocalServiceClpInvoker _clpInvoker = new IvldItemMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldItemMasterLocalServiceUtil} to access the ivld item master local service.
     */
    ...
    @Override
    public IvldItemMaster addIvldItemMaster(IvldItemMaster ivldItemMaster)
        throws SystemException {
        ivldItemMaster.setNew(true);

        return ivldItemMasterPersistence.update(ivldItemMaster);
    }
     ...
     */
    @Override
    public IvldItemMaster createIvldItemMaster(int ivldItemMasterSid) {
        return ivldItemMasterPersistence.create(ivldItemMasterSid);
    }
    ...
    @Override
    public IvldItemMaster deleteIvldItemMaster(int ivldItemMasterSid)
        throws PortalException, SystemException {
        return ivldItemMasterPersistence.remove(ivldItemMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public IvldItemMaster deleteIvldItemMaster(IvldItemMaster ivldItemMaster)
        throws SystemException {
        return ivldItemMasterPersistence.remove(ivldItemMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IvldItemMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldItemMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldItemMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public IvldItemMaster fetchIvldItemMaster(int ivldItemMasterSid)
        throws SystemException {
        return ivldItemMasterPersistence.fetchByPrimaryKey(ivldItemMasterSid);
    }
     ...
     */
    @Override
    public IvldItemMaster getIvldItemMaster(int ivldItemMasterSid)
        throws PortalException, SystemException {
        return ivldItemMasterPersistence.findByPrimaryKey(ivldItemMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ivldItemMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IvldItemMaster> getIvldItemMasters(int start, int end)
        throws SystemException {
        return ivldItemMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIvldItemMastersCount() throws SystemException {
        return ivldItemMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IvldItemMaster updateIvldItemMaster(IvldItemMaster ivldItemMaster)
        throws SystemException {
        return ivldItemMasterPersistence.update(ivldItemMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.IvldItemMaster",
            ivldItemMasterLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.IvldItemMaster");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ivldItemMasterPersistence.getDataSource();
