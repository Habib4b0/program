...
import com.stpl.app.service.GcmContractDetailsLocalService;
...
/**
 * Provides the base implementation for the gcm contract details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.GcmContractDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.GcmContractDetailsLocalServiceImpl
 * @see com.stpl.app.service.GcmContractDetailsLocalServiceUtil
 * @generated
 */
public abstract class GcmContractDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements GcmContractDetailsLocalService,
        IdentifiableBean {
    ...
    private GcmContractDetailsLocalServiceClpInvoker _clpInvoker = new GcmContractDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.GcmContractDetailsLocalServiceUtil} to access the gcm contract details local service.
     */
    ...
    @Override
    public GcmContractDetails addGcmContractDetails(
        GcmContractDetails gcmContractDetails) throws SystemException {
        gcmContractDetails.setNew(true);

        return gcmContractDetailsPersistence.update(gcmContractDetails);
    }
     ...
     */
    @Override
    public GcmContractDetails createGcmContractDetails(
        int gcmContractDetailsSid) {
        return gcmContractDetailsPersistence.create(gcmContractDetailsSid);
    }
    ...
    @Override
    public GcmContractDetails deleteGcmContractDetails(
        int gcmContractDetailsSid) throws PortalException, SystemException {
        return gcmContractDetailsPersistence.remove(gcmContractDetailsSid);
    }
    ...
    public GcmContractDetails deleteGcmContractDetails(
        GcmContractDetails gcmContractDetails) throws SystemException {
        return gcmContractDetailsPersistence.remove(gcmContractDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(GcmContractDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return gcmContractDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return gcmContractDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public GcmContractDetails fetchGcmContractDetails(int gcmContractDetailsSid)
        throws SystemException {
        return gcmContractDetailsPersistence.fetchByPrimaryKey(gcmContractDetailsSid);
    }
     ...
     */
    @Override
    public GcmContractDetails getGcmContractDetails(int gcmContractDetailsSid)
        throws PortalException, SystemException {
        return gcmContractDetailsPersistence.findByPrimaryKey(gcmContractDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return gcmContractDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<GcmContractDetails> getGcmContractDetailses(int start, int end)
        throws SystemException {
        return gcmContractDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getGcmContractDetailsesCount() throws SystemException {
        return gcmContractDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public GcmContractDetails updateGcmContractDetails(
        GcmContractDetails gcmContractDetails) throws SystemException {
        return gcmContractDetailsPersistence.update(gcmContractDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.GcmContractDetails",
            gcmContractDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.GcmContractDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = gcmContractDetailsPersistence.getDataSource();
