...
public class RSItemAdditionTabForm extends CustomComponent implements View {
    ...
    public RSItemAdditionTabForm(ErrorfulFieldGroup binder, final RebateScheduleMasterDTO rebateScheduleMaster, BeanItemContainer<IfpModel> itemFamilyplanResultsBean, final BeanItemContainer<IFPDetailsDTO> selectedItemResultBean,final BeanItemContainer<ItemDetailsDTO> itemResultsBean,final ExtPagedTable itemDetailsTable,
            final RebateScheduleLogic rebateLogic, final Label selectedIfp, String mode,RSRebateSetupTabForm rsRebateSetupTabForm, final SessionDTO sessionDTO) throws Exception {
    ...
    private void getIfpTable() throws Exception {
        LOGGER.info("Entering getTables");
        if (isViewMode) {
 ...
 if (tableResultCustom.getObjResult().length == 0) {
     ...
     * @return the button
     */
    public Button configureSearchButton() throws Exception {
        ...
        searchBtn.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                try {
                    LOGGER.info("Entering Rebate Schedule Search operation in Add");
                    LOGGER.info("addFindBtn ifpNumber=" + ifpNo.getValue() + " ifpName=" + ifpName.getValue() + " ifpType=" + ifpType.getValue());
                    ...
                    LOGGER.info("Ending Rebate Schedule Search operation in Add");
    ...
    public void configureAddRemoveButons() throws Exception {
        addBtn.setCaption(">");
        ...
        addBtn.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                LOGGER.info("Entering AddFormForPS Move Right operation");
                ...
                LOGGER.info("Ending AddFormForPS Move Right operation");
            }
    ...
    private void configureFields() throws Exception {
        ...
        if (isViewMode) {
            ...
            LOGGER.info("In configureFields lodding-ifpType Dblb List Type addNaviButtonForLandingSearchWithDeclarativeUI");
        }
        ...
        ifpNo.addValidator(new RegexpValidator(ValidationUtils.SEARCH_SP_CHAR, ValidationUtils.SEARCH_SPCHAR_MSG));
        ...
        ifpName.addValidator(new RegexpValidator(ValidationUtils.SEARCH_SP_CHAR, ValidationUtils.SEARCH_SPCHAR_MSG));
        ...
        itemID.addValidator(new RegexpValidator(ValidationUtils.SEARCH_SP_CHAR, ValidationUtils.SEARCH_SPCHAR_MSG));
        ...
        itemName.addValidator(new RegexpValidator(ValidationUtils.SEARCH_SP_CHAR, ValidationUtils.SEARCH_SPCHAR_MSG));
        ...
        LOGGER.info("In configureFields lodding-ifpType Dblb ListType=" + GeneralCommonUtils.IFP_TYPE);
