...
----------------------------------------------------PSTG_ITM_MST_INTERFACE------------------------------------------------
IF NOT EXISTS (SELECT 'X'
               FROM   INFORMATION_SCHEMA.TABLES
               WHERE  TABLE_NAME = 'PSTG_ITM_MST_INTERFACE'
                      AND TABLE_SCHEMA = 'DBO'
					  AND TABLE_TYPE='BASE TABLE')
BEGIN
CREATE TABLE [dbo].[PSTG_ITM_MST_INTERFACE](
	[PSTG_ITM_MST_INTERFACE_SID] [bigint] IDENTITY(1,1) NOT NULL,
...
IF NOT EXISTS (SELECT 1
               FROM   SYS.DEFAULT_CONSTRAINTS
               WHERE  OBJECT_NAME(PARENT_OBJECT_ID) = 'PSTG_ITM_MST_INTERFACE'
                      AND SCHEMA_NAME(SCHEMA_ID) = 'DBO'
                      AND NAME = 'DF_PSTG_ITM_MST_INTERFACE_CREATED_DATE')
	BEGIN
		ALTER TABLE [DBO].[PSTG_ITM_MST_INTERFACE] ADD  CONSTRAINT [DF_PSTG_ITM_MST_INTERFACE_CREATED_DATE]  DEFAULT (GETDATE()) FOR [CREATED_DATE]
	END	
GO
IF NOT EXISTS (SELECT 1
               FROM   SYS.DEFAULT_CONSTRAINTS
               WHERE  OBJECT_NAME(PARENT_OBJECT_ID) = 'PSTG_ITM_MST_INTERFACE'
                      AND SCHEMA_NAME(SCHEMA_ID) = 'DBO'
                      AND NAME = 'DF_PSTG_ITM_MST_INTERFACE_CREATED_BY')
	BEGIN
		ALTER TABLE [DBO].[PSTG_ITM_MST_INTERFACE] ADD  CONSTRAINT [DF_PSTG_ITM_MST_INTERFACE_CREATED_BY]  DEFAULT ('AGN') FOR [CREATED_BY]
	END
GO
---------------------------------------------------------IVLD_PSTG_ITM_MST_INTERFACE--------------------------------------------------
IF NOT EXISTS (SELECT 'X'
               FROM   INFORMATION_SCHEMA.TABLES
               WHERE  TABLE_NAME = 'IVLD_PSTG_ITM_MST_INTERFACE'
                      AND TABLE_SCHEMA = 'DBO'
					  AND TABLE_TYPE='BASE TABLE')
BEGIN
CREATE TABLE [dbo].[IVLD_PSTG_ITM_MST_INTERFACE](
	[IVLD_PSTG_ITM_MST_INTERFACE_SID] [bigint] IDENTITY(1,1) NOT NULL,
	[PROD_NUM] [nvarchar](1000) NULL,
	[USERID] [nvarchar](1000) NULL,
	[LASTMOD] [nvarchar](1000) NULL,
	[FLG_NOTE] [nvarchar](1000) NULL,
	...
	[UOM_CBK] [nvarchar](1000) NULL,
	[UOM_CMS] [nvarchar](1000) NULL,
	[PSTG_ITM_MST_INTERFACE_SID] [bigint] NULL,
	[CREATED_DATE] [datetime] NULL,
	[CREATED_BY] [nvarchar](100) NULL,
	[REASON_FOR_FAILURE] [nvarchar](1000) NULL,
...
IF NOT EXISTS (SELECT 1
               FROM   SYS.DEFAULT_CONSTRAINTS
               WHERE  OBJECT_NAME(PARENT_OBJECT_ID) = 'IVLD_PSTG_ITM_MST_INTERFACE'
                      AND SCHEMA_NAME(SCHEMA_ID) = 'DBO'
                      AND NAME = 'DF_IVLD_PSTG_ITM_MST_INTERFACE_IVLD_INTERFACE_DATE')
	BEGIN
		ALTER TABLE [DBO].[IVLD_PSTG_ITM_MST_INTERFACE] ADD  CONSTRAINT [DF_IVLD_PSTG_ITM_MST_INTERFACE_IVLD_INTERFACE_DATE] DEFAULT (GETDATE()) FOR [IVLD_INTERFACE_DATE]
	END
	
GO
-------------------------------------------------------------------VLD_PSTG_ITM_MST_INTERFACE---------------------------------------------
IF NOT EXISTS (SELECT 'X'
               FROM   INFORMATION_SCHEMA.TABLES
               WHERE  TABLE_NAME = 'VLD_PSTG_ITM_MST_INTERFACE'
                      AND TABLE_SCHEMA = 'DBO'
					  AND TABLE_TYPE='BASE TABLE')
BEGIN
    CREATE TABLE [dbo].[VLD_PSTG_ITM_MST_INTERFACE](
...
GO
	...
	BASE_CPI_PERIOD,                
	BASE_CPI                      
		FROM VLD_PSTG_ITM_MST_INTERFACE WHERE IS_COMPLETE='Y'
