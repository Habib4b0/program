...
/**
 * Provides the local service interface for StMAssumptions. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see StMAssumptionsLocalServiceUtil
...
public interface StMAssumptionsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link StMAssumptionsLocalServiceUtil} to access the st m assumptions local service. Add custom service methods to {@link com.stpl.app.service.impl.StMAssumptionsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
