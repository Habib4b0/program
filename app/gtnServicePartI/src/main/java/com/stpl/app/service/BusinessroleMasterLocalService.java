...
/**
 * Provides the local service interface for BusinessroleMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see BusinessroleMasterLocalServiceUtil
...
public interface BusinessroleMasterLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link BusinessroleMasterLocalServiceUtil} to access the businessrole master local service. Add custom service methods to {@link com.stpl.app.service.impl.BusinessroleMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
