...
public abstract class StAdjustmentReserveDetailLocalServiceBaseImpl
    ...
    implements StAdjustmentReserveDetailLocalService, IdentifiableBean {
    ...
    private StAdjustmentReserveDetailLocalServiceClpInvoker _clpInvoker = new StAdjustmentReserveDetailLocalServiceClpInvoker();
    ...
    public StAdjustmentReserveDetail createStAdjustmentReserveDetail(
        ...
        return stAdjustmentReserveDetailPersistence.create(stAdjustmentReserveDetailPK);
    }
    ...
    public StAdjustmentReserveDetail deleteStAdjustmentReserveDetail(
        ...
        return stAdjustmentReserveDetailPersistence.remove(stAdjustmentReserveDetailPK);
    }
    ...
    public StAdjustmentReserveDetail fetchStAdjustmentReserveDetail(
        StAdjustmentReserveDetailPK stAdjustmentReserveDetailPK)
        throws SystemException {
        return stAdjustmentReserveDetailPersistence.fetchByPrimaryKey(stAdjustmentReserveDetailPK);
    }
    ...
    public StAdjustmentReserveDetail getStAdjustmentReserveDetail(
        StAdjustmentReserveDetailPK stAdjustmentReserveDetailPK)
        throws PortalException, SystemException {
        return stAdjustmentReserveDetailPersistence.findByPrimaryKey(stAdjustmentReserveDetailPK);
    }
     ...
     */
    @Override
    public int getStAdjustmentReserveDetailsCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.StAdjustmentReserveDetail",
