...
//            String query = CommonUtil.workFlowQuery(start, offset, count, scheduler,null,false);
    ...
    private List getCustomizedSchedulerProcessing(List list)  throws SystemException{
        ...
        if (list != null && list.size() != 0) {
            for (int i = 0; i < list.size(); i++) {
                ...
                if (obj[NumericConstants.FOUR] != null && !ConstantsUtils.EMPTY.equals(String.valueOf(obj[NumericConstants.FOUR])) && !"null".equals(String.valueOf(obj[NumericConstants.FOUR]))) {
        ...
        try {
            ...
            if (ProcessDTO.getProcessSid() != 0) {
                ...
                if ("Interval".equals(ProcessDTO.getFrequencyRadio())) {
                    profile.setStartHour(ProcessDTO.getRunHours() == null || "null".equals(ProcessDTO.getRunHours()) ? NumericConstants.TWENTY_FOUR : Integer.valueOf(ProcessDTO.getRunHours()));
                    profile.setStartMinutes(ProcessDTO.getRunMinutes() == null || "null".equals(ProcessDTO.getRunMinutes()) ? NumericConstants.SIXTY : Integer.valueOf(ProcessDTO.getRunMinutes()));
                    ...
                    profile.setStartHour1(ProcessDTO.getHoursOne() == null || "null".equals(ProcessDTO.getHoursOne()) ? NumericConstants.TWENTY_FOUR : Integer.valueOf(ProcessDTO.getHoursOne()));
                    profile.setStartHour2(ProcessDTO.getHoursTwo() == null || "null".equals(ProcessDTO.getHoursTwo()) ? NumericConstants.TWENTY_FOUR : Integer.valueOf(ProcessDTO.getHoursTwo()));
                    profile.setStartHour3(ProcessDTO.getHoursThree() == null || "null".equals(ProcessDTO.getHoursThree()) ? NumericConstants.TWENTY_FOUR : Integer.valueOf(ProcessDTO.getHoursThree()));
                    profile.setStartMinutes1(ProcessDTO.getMinutesOne() == null || "null".equals(ProcessDTO.getMinutesOne()) ? NumericConstants.SIXTY : Integer.valueOf(ProcessDTO.getMinutesOne()));
                    profile.setStartMinutes2(ProcessDTO.getMinutesTwo() == null || "null".equals(ProcessDTO.getMinutesTwo()) ? NumericConstants.SIXTY : Integer.valueOf(ProcessDTO.getMinutesTwo()));
                    profile.setStartMinutes3(ProcessDTO.getMinutesThree() == null || "null".equals(ProcessDTO.getMinutesThree()) ? NumericConstants.SIXTY : Integer.valueOf(ProcessDTO.getMinutesThree()));
    ...
    * @throws Exception 
    */
    public List<ProcessSchedulerDTO> getSearchResults(final ProcessSchedulerDTO binderDto, final SessionDTO sessionDTO) {
    ...
    public List<ProcessSchedulerDTO> getCustomizedSearchResults(List<Object[]> resultList)  {
        ...
        for (Object[] obj : resultList) {
            ...
            cffSearchDTOLoop.setTypeDesc(isValid(obj[NumericConstants.TWO]) ? obj[NumericConstants.TWO].toString() : StringUtils.EMPTY);
            cffSearchDTOLoop.setProjectionId(isValid(obj[NumericConstants.THREE]) ? String.valueOf(obj[NumericConstants.THREE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setProjectionName(isValid(obj[NumericConstants.FOUR]) ? String.valueOf(obj[NumericConstants.FOUR]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setYear(isValid(obj[NumericConstants.FIVE]) ? String.valueOf(obj[NumericConstants.FIVE]) : "0");
            cffSearchDTOLoop.setMonth(isValid(obj[NumericConstants.SIX]) ? Integer.valueOf(String.valueOf(obj[NumericConstants.SIX])) : 0);
            cffSearchDTOLoop.setContractId(isValid(obj[NumericConstants.SEVEN]) ? String.valueOf(obj[NumericConstants.SEVEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setContractNo(isValid(obj[NumericConstants.EIGHT]) ? String.valueOf(obj[NumericConstants.EIGHT]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setContractName(isValid(obj[NumericConstants.NINE]) ? String.valueOf(obj[NumericConstants.NINE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setContractType(isValid(obj[NumericConstants.TEN]) ? String.valueOf(obj[NumericConstants.TEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setContractHolderId(isValid(obj[NumericConstants.ELEVEN]) ? String.valueOf(obj[NumericConstants.ELEVEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setContractHolderNo(isValid(obj[NumericConstants.TWELVE]) ? String.valueOf(obj[NumericConstants.TWELVE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setContractHolderName(isValid(obj[NumericConstants.THIRTEEN]) ? String.valueOf(obj[NumericConstants.THIRTEEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setCustomerId(isValid(obj[NumericConstants.FOURTEEN]) ? String.valueOf(obj[NumericConstants.FOURTEEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setCustomerNo(isValid(obj[NumericConstants.FIFTEEN]) ? String.valueOf(obj[NumericConstants.FIFTEEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setCustomerName(isValid(obj[NumericConstants.SIXTEEN]) ? String.valueOf(obj[NumericConstants.SIXTEEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setItemId(isValid(obj[NumericConstants.SEVENTEEN]) ? String.valueOf(obj[NumericConstants.SEVENTEEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setItemNo(isValid(obj[NumericConstants.EIGHTEEN]) ? String.valueOf(obj[NumericConstants.EIGHTEEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setItemName(isValid(obj[NumericConstants.NINETEEN]) ? String.valueOf(obj[NumericConstants.NINETEEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setSalesDollars(isValid(obj[NumericConstants.TWENTY]) ? String.valueOf(obj[NumericConstants.TWENTY]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setSalesUnits(isValid(obj[NumericConstants.TWENTY_ONE]) ? String.valueOf(obj[NumericConstants.TWENTY_ONE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setSalesInclusion(isValid(obj[NumericConstants.TWENTY_TWO]) ? String.valueOf(obj[NumericConstants.TWENTY_TWO]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionId(isValid(obj[NumericConstants.TWENTY_THREE]) ? String.valueOf(obj[NumericConstants.TWENTY_THREE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionNo(isValid(obj[NumericConstants.TWENTY_FOUR]) ? String.valueOf(obj[NumericConstants.TWENTY_FOUR]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionName(isValid(obj[NumericConstants.TWENTY_FIVE]) ? String.valueOf(obj[NumericConstants.TWENTY_FIVE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionCategory(isValid(obj[NumericConstants.TWENTY_SIX]) ? String.valueOf(obj[NumericConstants.TWENTY_SIX]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionType(isValid(obj[NumericConstants.TWENTY_SEVEN]) ? String.valueOf(obj[NumericConstants.TWENTY_SEVEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionProgram(isValid(obj[NumericConstants.TWENTY_EIGHT]) ? String.valueOf(obj[NumericConstants.TWENTY_EIGHT]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionInclusion(isValid(obj[NumericConstants.TWENTY_NINE]) ? String.valueOf(obj[NumericConstants.TWENTY_NINE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionCategoryOne(isValid(obj[NumericConstants.THIRTY]) ? String.valueOf(obj[NumericConstants.THIRTY]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionCategoryTwo(isValid(obj[NumericConstants.THIRTY_ONE]) ? String.valueOf(obj[NumericConstants.THIRTY_ONE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionCategoryThree(isValid(obj[NumericConstants.THIRTY_TWO]) ? String.valueOf(obj[NumericConstants.THIRTY_TWO]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionCategoryFour(isValid(obj[NumericConstants.THIRTY_THREE]) ? String.valueOf(obj[NumericConstants.THIRTY_THREE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionCategoryFive(isValid(obj[NumericConstants.THIRTY_FOUR]) ? String.valueOf(obj[NumericConstants.THIRTY_FOUR]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionCategorySix(isValid(obj[NumericConstants.THIRTY_FIVE]) ? String.valueOf(obj[NumericConstants.THIRTY_FIVE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionDollars(isValid(obj[NumericConstants.THIRTY_SIX]) ? String.valueOf(obj[NumericConstants.THIRTY_SIX]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionRate(isValid(obj[NumericConstants.THIRTY_SEVEN]) ? String.valueOf(obj[NumericConstants.THIRTY_SEVEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setDeductionPerUnit(isValid(obj[NumericConstants.THIRTY_EIGHT]) ? String.valueOf(obj[NumericConstants.THIRTY_EIGHT]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setNetSalesDollar(isValid(obj[NumericConstants.THIRTY_NINE]) ? String.valueOf(obj[NumericConstants.THIRTY_NINE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setCogsAmount(isValid(obj[NumericConstants.FORTY]) ? String.valueOf(obj[NumericConstants.FORTY]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setCogsPerUnit(isValid(obj[NumericConstants.FORTY_ONE]) ? String.valueOf(obj[NumericConstants.FORTY_ONE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setNetProfitDollars(isValid(obj[NumericConstants.FORTY_TWO]) ? String.valueOf(obj[NumericConstants.FORTY_TWO]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setNetProfitPerUnit(isValid(obj[NumericConstants.FORTY_THREE]) ? String.valueOf(obj[NumericConstants.FORTY_THREE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setCompanyId(isValid(obj[NumericConstants.FORTY_FOUR]) ? String.valueOf(obj[NumericConstants.FORTY_FOUR]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setCompanyNo(isValid(obj[NumericConstants.FORTY_FIVE]) ? String.valueOf(obj[NumericConstants.FORTY_FIVE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setCompanyName(isValid(obj[NumericConstants.FORTY_SIX]) ? String.valueOf(obj[NumericConstants.FORTY_SIX]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setBusinessUnitId(isValid(obj[NumericConstants.FORTY_SEVEN]) ? String.valueOf(obj[NumericConstants.FORTY_SEVEN]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setBusinessUnitNo(isValid(obj[NumericConstants.FORTY_EIGHT]) ? String.valueOf(obj[NumericConstants.FORTY_EIGHT]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setBusinessUnitName(isValid(obj[NumericConstants.FORTY_NINE]) ? String.valueOf(obj[NumericConstants.FORTY_NINE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setFinancialForecastCreationDate(isValid(obj[NumericConstants.FIFTY]) ? format.format(obj[NumericConstants.FIFTY]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setFinancialForecastApprovalDate(isValid(obj[NumericConstants.FIFTY_ONE]) ? format.format(obj[NumericConstants.FIFTY_ONE]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setOutboundStatus(isValid(obj[NumericConstants.FIFTY_TWO]) ? String.valueOf(obj[NumericConstants.FIFTY_TWO]) : StringUtils.EMPTY);
            cffSearchDTOLoop.setOriginalBatchId(isValid(obj[NumericConstants.FIFTY_THREE]) ? String.valueOf(obj[NumericConstants.FIFTY_THREE]) : StringUtils.EMPTY);

            cffSearchDTOLoop.setPeriodSid(isValid(obj[NumericConstants.FIFTY_FOUR]) ? Integer.valueOf(String.valueOf(obj[NumericConstants.FIFTY_FOUR])) : 0);
            cffSearchDTOLoop.setCffDetailSid(isValid(obj[NumericConstants.FIFTY_FIVE]) ? Integer.valueOf(String.valueOf(obj[NumericConstants.FIFTY_FIVE])) : 0);
            cffSearchDTOLoop.setRsModelSid(isValid(obj[NumericConstants.FIFTY_SIX]) ? Integer.valueOf(String.valueOf(obj[NumericConstants.FIFTY_SIX])) : 0);
    ...
    private Boolean isValid(Object obj){
        if (obj ==null || "null".equals(String.valueOf(obj)) || "-Select One".equals(String.valueOf(obj)) || StringUtils.isBlank(String.valueOf(obj)) || "0".equals(String.valueOf(obj))) {
    ...
    /**
     * To delete all the records from temp table before searching based on user id and session id
     * @param sessionDTO 
     */
    ...
    public void cffOutboundInsertProc(final String userId, final String sessionId, final List cffIds) {
        ...
        if (cffIds != null && cffIds.size() != 0) {
            try {
                ...
                sb.append(" \n EXEC PRC_CFF_OUTBOUND @CFF_DETAILS_SID,").append(userId).append(",").append(sessionId).append(" , 'SCHEDULER' ").append(";");
...
public void callSriptForArp(String userId, String sessionId){
     ...
     public void deleteTempArpOutbound(String sessionId,String userId, Boolean isScheduler) {
      ...
      public void deleteTempTable(SessionDTO sessionDTO) {
        String query = "DELETE FROM ST_ARP_OUTBOUND WHERE USER_ID='" + sessionDTO.getUserId() + "' AND SESSION_ID=" + sessionDTO.getArpSessionId();          
        HelperTableLocalServiceUtil.executeUpdateQuery(query);
      }
