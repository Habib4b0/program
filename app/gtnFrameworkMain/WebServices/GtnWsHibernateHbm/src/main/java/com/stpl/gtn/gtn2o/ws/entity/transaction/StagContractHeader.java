...
public class StagContractHeader  implements java.io.Serializable {


     private int stagContractHeaderSid;
    ...
    public StagContractHeader() {
    }

	
    public StagContractHeader(int stagContractHeaderSid, String  contractHeaderIntfid, String contractId, String contractStatus, String companyNo, String startDate, String batchId, String addChgDelIndicator) {
        this.stagContractHeaderSid = stagContractHeaderSid;
    ...
    public int getStagContractHeaderSid() {
        return this.stagContractHeaderSid;
    }
    
    public void setStagContractHeaderSid(int stagContractHeaderSid) {
        this.stagContractHeaderSid = stagContractHeaderSid;
    }
