...
public class DataSelectionDTO implements Serializable {
    ...
    private String customerHierarchyVer = StringUtils.EMPTY;
    private String productHierarchyVer = StringUtils.EMPTY;
     ...
     *
     * @param privateView the private view
     */
     ...
     *
     * @param publicView the public view
     */
     ...
     *
     * @param contractHolder the contract holder
     */
     ...
     *
     * @param projectionId the new version number
     */
     ...
     *
     * @param customerHierarchyLevel the customer hierarchy level number
     */
     ...
     *
     * @param productHierarchyLevel the product hierarchy level number
     */
     ...
     *
     * @param customerHierVersionNo Customer hierarchy version number
     */
    ...
    public String getCustomerHierarchyVer() {
        return customerHierarchyVer;
    }

    public void setCustomerHierarchyVer(String customerHierarchyVer) {
        this.customerHierarchyVer = customerHierarchyVer;
    }

    public String getProductHierarchyVer() {
        return productHierarchyVer;
    }

    public void setProductHierarchyVer(String productHierarchyVer) {
        this.productHierarchyVer = productHierarchyVer;
    }
    ...
    public void clear() {
        ...
        customerHierarchyVer = StringUtils.EMPTY;
        productHierarchyVer = StringUtils.EMPTY;
