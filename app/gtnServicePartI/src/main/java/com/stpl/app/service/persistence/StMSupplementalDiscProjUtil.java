...
/**
 * The persistence utility for the st m supplemental disc proj service. This utility wraps {@link StMSupplementalDiscProjPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StMSupplementalDiscProjUtil {
    private static StMSupplementalDiscProjPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.StMSupplementalDiscProj create(
    ...
    */
    public static com.stpl.app.model.StMSupplementalDiscProj remove(
        StMSupplementalDiscProjPK stMSupplementalDiscProjPK)
    ...
    public static com.stpl.app.model.StMSupplementalDiscProj updateImpl(
        com.stpl.app.model.StMSupplementalDiscProj stMSupplementalDiscProj)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.StMSupplementalDiscProj findByPrimaryKey(
        StMSupplementalDiscProjPK stMSupplementalDiscProjPK)
        throws com.stpl.app.NoSuchStMSupplementalDiscProjException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.StMSupplementalDiscProj fetchByPrimaryKey(
        StMSupplementalDiscProjPK stMSupplementalDiscProjPK)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.StMSupplementalDiscProj> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static StMSupplementalDiscProjPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (StMSupplementalDiscProjPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    StMSupplementalDiscProjPersistence.class.getName());

            ReferenceRegistry.registerReference(StMSupplementalDiscProjUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(StMSupplementalDiscProjPersistence persistence) {
    }
}
