...
/**
 * Provides the local service interface for IvldInventoryWdProjMas. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldInventoryWdProjMasLocalServiceUtil
 * @see com.stpl.app.service.base.IvldInventoryWdProjMasLocalServiceBaseImpl
...
public interface IvldInventoryWdProjMasLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldInventoryWdProjMasLocalServiceUtil} to access the ivld inventory wd proj mas local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldInventoryWdProjMasLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
