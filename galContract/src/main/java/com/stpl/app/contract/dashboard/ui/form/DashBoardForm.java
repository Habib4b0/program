...
public final class DashBoardForm extends CustomComponent implements SearchBaseForm {
     ...
     */
    public DashBoardForm(final SessionDTO sessionDTO) throws SystemException, PortalException, Exception {
        super();
        LOGGER.info("Entering DashBoardForm");
        this.sessionDTO = sessionDTO;
        dashBoardLogic = new DashBoardLogic(this.sessionDTO);
        init();
        LOGGER.info("End of DashBoardForm");
    }
    ...
    private CustomFieldGroup getLeftBinder() {
        LOGGER.info("Entering getLeftBinder method ");
        ...
        LOGGER.info(" getLeftBinder method ends");
    ...
    private CustomFieldGroup getRightBinder() {
        LOGGER.info("Entering getRightBinder method ");
        ...
        LOGGER.info(" getRightBinder method ends");
    ...
    private void basic() throws SystemException, PortalException, Exception {
        LOGGER.info("Entering basic method");
        ...
        addToTreeBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                try {
                    ...
                    LOGGER.error("Error While Adding to right side tree node :"+ex.getMessage());
                }
            }
        });
        ...
        excelExport.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                try {
                    ...
                    ExcelExport exp = new ExcelExport(new ExtCustomTableHolder(exceltable), "Contract Dashboard" , "Contract Dashboard", "Contract Dashboard.xls", false);
                    exp.export();
        ...
        LOGGER.info("End of basic method");
    }

    public void excelExportLogic() throws SystemException, PortalException, Exception {
        LOGGER.info("Entering excelExportLogic operation");

        createWorkSheet();

        LOGGER.info("Ending excelExportLogic operation");
    }

    private void createWorkSheet() throws SystemException, PortalException, Exception {
        LOGGER.info("Entering createWorkSheet operation");
        ...
        LOGGER.info("Ending createWorkSheet operation");
    }
    ...
    public void createWorkSheetContent(final Integer start, final Integer end, final PrintWriter printWriter) throws SystemException, PortalException, Exception {
        ...
        ContractMember searchItemForm;
        final List<OrderByColumn> columns = new ArrayList<OrderByColumn>();
        DashboardCriteria criteria = new DashboardCriteria();
        final List<ContractMember> reultList = dashboardSearchLogic.getComponentSearch(leftSearchBinder, String.valueOf(leftComponent.getValue()), columns, criteria, start, end, true);

        if (ContractUtils.CONTRACT_DETAILS_COMPONENT.equals(String.valueOf(leftComponent.getValue()))) {
            for (int rowCount = 0; rowCount < reultList.size(); rowCount++) {

                searchItemForm = (ContractMember) reultList.get(rowCount);

                printWriter.print(UIUtils.QUOTE + searchItemForm.getMemberId() + UIUtils.QUOTE + UIUtils.COMMA);

                printWriter.print(UIUtils.QUOTE + searchItemForm.getMemberNo() + UIUtils.QUOTE + UIUtils.COMMA);

                printWriter.print(UIUtils.QUOTE + searchItemForm.getName() + UIUtils.QUOTE + UIUtils.COMMA);

                printWriter.println(UIUtils.QUOTE + searchItemForm.getMemberType() + UIUtils.QUOTE + UIUtils.COMMA);
            }
        } else if (ContractUtils.CFP_COMPONENT.equals(String.valueOf(leftComponent.getValue()))) {
            for (int rowCount = 0; rowCount < reultList.size(); rowCount++) {
    ...
    public void loadDataToContainer(List<ContractMember> resultList, Object parentId) throws SystemException, PortalException {
        for (ContractMember dto : resultList) {
            ...
            if (!Constants.RS_VALUE.equals(dto.getCategory()) && ((levelNo == 1 && cdbLogic.isLevel2ListAvlbl(dto.getSystemId(), dto.getCategory()))
                    || (levelNo == 2 && cdbLogic.isLevel3ListAvlbl(dto.getSystemId(), dto.getCategory()))
                    || (levelNo == 3 && cdbLogic.isLevel4ListAvlbl(dto.getSystemId(), dto.getCategory()))
                    || (levelNo == 4 && cdbLogic.isLevel5ListAvlbl(dto.getSystemId())))) {
    ...
    protected void loadTableValues(CustomFieldGroup leftSearchBinder) {
        LOGGER.info("inside DashBoardForm loadTableValues");
    ...
    public void getDroppableTree() {
        LOGGER.info("Entering getDroppableTree");
        tree.markAsDirty();
        ...
        tree.addItemClickListener(new ItemClickEvent.ItemClickListener() {
            ...
            public void itemClick(final ItemClickEvent event) {
                ...
                LOGGER.info("Start date = = =  =>" + treeBean.getStartDate());
                LOGGER.info("Start date = = =  =>" + treeBean.getEndDate());
                LOGGER.info("category date = = =  =>" + treeBean.getCategory());
                LOGGER.info("Name date = = =  =>" + treeBean.getName());
            }
        });
                ...
                if (targetItem == null) {
                    ...
                    if (bean.getCategory().equals(Constants.CONTRACT)) {
                        ...
                        if (bean.getCategory().equals(targetBean.getCategory())) {
                            ...
                            if (Constants.CONTRACT.equals(targetBean.getCategory())) {
                                getBeanFromID(targetItem).setContractId(targetBean.getInternalId());
                                getBeanFromID(beanItem).setContractChild(true);
                            } else {
                                getBeanFromID(beanItem).setContractId(targetBean.getContractId());
                            }
        ...
        LOGGER.info("End of getDropableTable method");
    }
    ...
    public HierarchicalContainer createTreeContent() {
        ...
        LOGGER.info("Entering createTreeContent method");
        ...
        LOGGER.info("End of createTreeContent method");
        return container;
    }
            ...
            try {
                ...
                switch (contractMember.getLevel()) {
                    case ContractMember.LEVEL1:
                        ...
                        hierarchicalContainer = contractDashboardLogic.getLevel1Hierarchy(rightSearchBinder, hierarchicalContainer, 0, 15);
                    ...
                    case ContractMember.LEVEL3:
                        ...
                        processTreeTable.setContainerDataSource(contractDashboardLogic.getLevel3Hierarchy(contractMember.getParent2(), hierarchicalContainer, 0, tempPageLength - 2));
                        processTreeTable.removeExpandListener(expandListener);
                        setProcessedTableHeader();
                        processTreeTable.setCollapsed(contractMember.getParent1(), false);
                    ...
                    case ContractMember.LEVEL4:
                        ...
                        processTreeTable.setContainerDataSource(contractDashboardLogic.getLevel4Hierarchy(contractMember.getParent3(), hierarchicalContainer, 0, tempPageLength - 3));
                        processTreeTable.removeExpandListener(expandListener);
                        setProcessedTableHeader();
                        processTreeTable.setCollapsed(contractMember.getParent1(), false);
                        processTreeTable.setCollapsed(contractMember.getParent2(), false);
            ...
            try {
                ...
                switch (contractMember.getLevel()) {
                    ...
                    case ContractMember.LEVEL2:
                        ...
                        processTreeTable.setContainerDataSource(contractDashboardLogic.getLevel3Hierarchy(contractMember, hierarchicalContainer, 0, tempPageLength - 2));
                        processTreeTable.removeExpandListener(expandListener);
                        processTreeTable.setCollapsed(contractMember.getParent1(), false);
                    ...
                    case ContractMember.LEVEL3:
                        ...
                        processTreeTable.setContainerDataSource(contractDashboardLogic.getLevel4Hierarchy(contractMember, hierarchicalContainer, 0, tempPageLength - 3));
                        processTreeTable.removeExpandListener(expandListener);
                        processTreeTable.setCollapsed(contractMember.getParent1(), false);
                        processTreeTable.setCollapsed(contractMember.getParent2(), false);
                        processTreeTable.setCollapsed(contractMember, false);
                    ...
                    case ContractMember.LEVEL4:
                        ...
                        processTreeTable.setContainerDataSource(contractDashboardLogic.getLevel5Hierarchy(contractMember, hierarchicalContainer, 0, tempPageLength - 4));
                        processTreeTable.removeExpandListener(expandListener);
                        processTreeTable.setCollapsed(contractMember.getParent1(), false);
                        processTreeTable.setCollapsed(contractMember.getParent2(), false);
                        processTreeTable.setCollapsed(contractMember.getParent3(), false);
    ...
    private void getProcessedTree(CustomFieldGroup rightSearchBinder) throws SystemException {
        ...
        processTreeTable.setSizeFull();
        processTreeTable.setPageLength(10);
        processTreeTable.removeAllItems();
    ...
    public void navigateToNextView() throws SystemException, PortalException {
        LOGGER.info("Entering navigateToNextView method");
        try {
            ...
            if (tableBean.getCategory().equals(Constants.REBATE_SCHEDULE)) {
                ...
                LOGGER.info(" rsSystemId=" + tableBean.getInternalId());
                ...
                if (rsparent.getCategory().equals(Constants.PRICE_SCHEDULE)) {
                    ...
                    LOGGER.info(" psSystemId=" + rsparent.getInternalId());
                    final Object psParentId = processTreeTable.getParent(systemId);
                    LOGGER.info(" psParentId=" + psParentId);
                    ...
                    if (psParent.getCategory().equals(Constants.IFP)) {
                        ...
                        LOGGER.info(" ifpSystemId=" + psParent.getInternalId());
                        ...
                        if (ifpParent.getCategory().equals(Constants.CFP)) {
                            ...
                            if (cfpParent.getCategory().equals(Constants.CONTRACT)) {
                                ...
                                LOGGER.info(" contractSystemId=" + cfpParent.getInternalId());
        ...
        LOGGER.info("End of navigateToNextView method");
    }
    ...
    public void enter(final ViewChangeEvent event) {
        LOGGER.info("Entering enter method in DashboardForm");
    }
    ...
    private void addFrmTableToTree() {
        try {
            LOGGER.info("Entering addFrmTableToTree method");
            ...
            LOGGER.info("End of addFrmTableToTree method");
        } catch (SystemException ex) {
            LOGGER.error(ex.getMessage());
        } catch (PortalException ex) {
            LOGGER.error(ex.getMessage());
    ...
    public void configure() {
        ...
        try {
            ...
            leftContractId.addValidator(new StringLengthValidator("Contract ID length should be less than 38 characters", 0, 38, true));
            leftContractId.addValidator(new RegexpValidator(Constants.ALPHA_NUM_VALIDATION, "Contract ID  can contain only digits,alphabets"));
            ...
            leftContractNo.addValidator(new StringLengthValidator("Contract No should be less than 38 characters", 0, 38, true));
            leftContractNo.addValidator(new RegexpValidator("([0-9|a-z|A-Z|\\_|\\*|\\:|\\.|\\,|\\'|\\;|\\-|\\ |\\/])*", "Contract No allows Special Characters like *,:,.,(,),',;,-,/,_"));
            ...
            leftContractName.addValidator(new StringLengthValidator("Contract Name should be less than 38 characters", 0, 38, true));
            leftContractName.addValidator(new RegexpValidator("([0-9|a-z|A-Z|\\_|\\*|\\:|\\.|\\,|\\'|\\;|\\-|\\ |\\/])*", "Contract Name allows Special Characters like *,:,.,(,),',;,-,/,_"));
            ...
            leftContractType.setPageLength(7);
            ...
            leftCfpId.addValidator(new StringLengthValidator(" CFP ID Should be less than 38 characters", 0, 38, true));
            ...
            leftCfpNo.addValidator(new StringLengthValidator(" CFP No Should be less than 50 characters", 0, 50, true));
            ...
            leftCfpName.addValidator(new StringLengthValidator(" CFP Name Should be less than 100 characters", 0, 100, true));
            ...
            leftCompanyNo.addValidator(new StringLengthValidator(" Company No Should be less than 50 characters", 0, 50, true));
            ...
            leftCompanyName.addValidator(new StringLengthValidator(" Company Name Should be less than 100 characters", 0, 100, true));
            ...
            leftCompanyType.setPageLength(7);
            ...
            leftCompanyCategory.addValidator(new StringLengthValidator(" Company Category Should be less than 100 characters", 0, 100, true));
            ...
            leftIfpId.addValidator(new StringLengthValidator("IFP ID length should be less than 50 characters", 0, 50, true));
            ...
            leftIfpNo.addValidator(new StringLengthValidator("IFP No length should be less than 50 characters", 0, 50, true));
            ...
            leftIfpName.addValidator(new StringLengthValidator("IFP Name length should be less than 100 characters", 0, 100, true));
            ...
            leftIfpItemNo.addValidator(new StringLengthValidator(" Item No should be less than 50 characters", 0, 50, true));
            ...
            leftIfpItemName.addValidator(new StringLengthValidator(" Item Name Should be less than 100 characters", 0, 100, true));
            ...
            leftIfpTherapeuticClass.setPageLength(7);
            ...
            leftPsId.addValidator(new StringLengthValidator("Price Schedule Id should be less than 38 characters", 0, 38, true));
            ...
            leftPsNo.addValidator(new StringLengthValidator(" Price Schedule No should be less than 50 characters", 0, 50, true));
            ...
            leftPsName.addValidator(new StringLengthValidator(" Price Schedule Name Should be less than 100 characters", 0, 100, true));
            ...
            leftPsItemNo.addValidator(new StringLengthValidator(" Item No should be less than 50 characters", 0, 50, true));
            ...
            leftPsItemName.addValidator(new StringLengthValidator(" Item Name Should be less than 100 characters", 0, 100, true));
            ...
            leftPsTherapeuticClass.setPageLength(7);
            ...
            leftRsId.addValidator(new StringLengthValidator(" Rebate Schedule ID should be less than 38 Characters", 0, 38, true));
            ...
            leftRsNo.addValidator(new StringLengthValidator(" Rebate Schedule No should be less than or equal to 50 Characters", 0, 50, true));
            ...
            leftRsName.addValidator(new StringLengthValidator("Rebate Schedule Name should be less than 100 Characters", 0, 100, true));
            ...
            leftRsItemNo.addValidator(new StringLengthValidator(" Item No should be less than 50 characters", 0, 50, true));
            ...
            leftRsItemName.addValidator(new StringLengthValidator(" Item Name Should be less than 100 characters", 0, 100, true));
            ...
            leftRsProgramCategory.setPageLength(7);
            ...
            rightContractId.addValidator(new StringLengthValidator("Contract ID length should be less than 38 characters", 0, 38, true));
            rightContractId.addValidator(new RegexpValidator(Constants.ALPHA_NUM_VALIDATION, "Contract ID  can contain only digits,alphabets"));
            ...
            rightContractNo.addValidator(new StringLengthValidator("Contract No should be less than 38 characters", 0, 38, true));
            rightContractNo.addValidator(new RegexpValidator("([0-9|a-z|A-Z|\\_|\\*|\\:|\\.|\\,|\\'|\\;|\\-|\\ |\\/])*", "Contract No allows Special Characters like *,:,.,(,),',;,-,/,_"));
            ...
            rightContractName.addValidator(new StringLengthValidator("Contract Name should be less than 38 characters", 0, 38, true));
            rightContractName.addValidator(new RegexpValidator("([0-9|a-z|A-Z|\\_|\\*|\\:|\\.|\\,|\\'|\\;|\\-|\\ |\\/])*", "Contract Name allows Special Characters like *,:,.,(,),',;,-,/,_"));
            ...
            rightContractType.setPageLength(7);
            ...
            rightCfpId.addValidator(new StringLengthValidator(" CFP ID Should be less than 38 characters", 0, 38, true));
            ...
            rightCfpNo.addValidator(new StringLengthValidator(" CFP No Should be less than 50 characters", 0, 50, true));
            ...
            rightCfpName.addValidator(new StringLengthValidator(" CFP Name Should be less than 100 characters", 0, 100, true));
            ...
            rightCompanyNo.addValidator(new StringLengthValidator(" Company No Should be less than 50 characters", 0, 50, true));
            ...
            rightCompanyName.addValidator(new StringLengthValidator(" Company Name Should be less than 100 characters", 0, 100, true));
            ...
            rightCompanyType.setPageLength(7);
            ...
            rightCompanyCategory.addValidator(new StringLengthValidator(" Company Category Should be less than 100 characters", 0, 100, true));
            ...
            rightIfpId.addValidator(new StringLengthValidator("IFP ID length should be less than 50 characters", 0, 50, true));
            ...
            rightIfpNo.addValidator(new StringLengthValidator("IFP No length should be less than 50 characters", 0, 50, true));
            ...
            rightIfpName.addValidator(new StringLengthValidator("IFP Name length should be less than 100 characters", 0, 100, true));
            ...
            rightIfpItemNo.addValidator(new StringLengthValidator(" Item No should be less than 50 characters", 0, 50, true));
            ...
            rightIfpItemName.addValidator(new StringLengthValidator(" Item Name Should be less than 100 characters", 0, 100, true));
            ...
            rightIfpTherapeuticClass.setPageLength(7);
            ...
            rightPsId.addValidator(new StringLengthValidator("Price Schedule Id should be less than 38 characters", 0, 38, true));
            ...
            rightPsNo.addValidator(new StringLengthValidator(" Price Schedule No should be less than 50 characters", 0, 50, true));
            ...
            rightPsName.addValidator(new StringLengthValidator(" Price Schedule Name Should be less than 100 characters", 0, 100, true));
            ...
            rightPsItemNo.addValidator(new StringLengthValidator(" Item No should be less than 50 characters", 0, 50, true));
            ...
            rightPsItemName.addValidator(new StringLengthValidator(" Item Name Should be less than 100 characters", 0, 100, true));
            ...
            rightPsTherapeuticClass.setPageLength(7);
            ...
            rightRsId.addValidator(new StringLengthValidator(" Rebate Schedule ID should be less than 38 Characters", 0, 38, true));
            ...
            rightRsNo.addValidator(new StringLengthValidator(" Rebate Schedule No should be less than or equal to 50 Characters", 0, 50, true));
            ...
            rightRsName.addValidator(new StringLengthValidator("Rebate Schedule Name should be less than 100 Characters", 0, 100, true));
            ...
            rightRsItemNo.addValidator(new StringLengthValidator(" Item No should be less than 50 characters", 0, 50, true));
            ...
            rightRsItemName.addValidator(new StringLengthValidator(" Item Name Should be less than 100 characters", 0, 100, true));
            ...
            rightRsProgramCategory.setPageLength(7);
        ...
        LOGGER.info("End of configure method");
    }
    ...
    private void changeTableHeader(String componentValue) {
        LOGGER.info("Entering changeTableHeader method");
        if (ContractUtils.CONTRACT_DETAILS_COMPONENT.equals(String.valueOf(leftComponent.getValue()))) {
            table.setVisibleColumns(new Object[]{Constants.MEMBER_ID, Constants.MEMBER_NO, Constants.NAME, Constants.MEMBER_TYPE});
            table.setColumnHeaders(Constants.CONTRACT_ID1, Constants.CONTRACT_NO_SP, Constants.CONTRACT_NAME1, Constants.CONTRACT_TYPE_HEADER);
        } else if (ContractUtils.CFP_COMPONENT.equals(String.valueOf(leftComponent.getValue()))) {
        ...
        LOGGER.info("End of changeTableHeader method");
    }

    private Boolean addToTreeMethod() throws SystemException, Exception {
     ...
     * @throws Exception
     */
    private void validation(List<Object> values, final BeanItem<?> targetItem, String category) throws Exception {
            ...
            public void valueChange(
                ...
                try {
                    ...
                    if (currentPageNo <= Integer.valueOf(totalPagesLabel.getValue()) && currentPageNo > 0) {
                        ...
                        AbstractNotificationUtils.getErrorNotification(Constants.ERROR, "Page does not exist");
    ...
    public class DateValidatorContract extends AbstractValidator {
        ...
        public void validate(final Object value) throws Validator.InvalidValueException {
            LOGGER.info("Entering validate method for start date and end date");
        ...
        protected boolean isValidValue(final Object value) {
            LOGGER.info("Entering validValue method ");
            if (leftContractStartDate.getValue() != null && leftContractEndDate.getValue() != null) {
                final boolean isValid = leftContractStartDate.getValue().compareTo(leftContractEndDate.getValue()) <= 0;
                LOGGER.info("isValidValue method ends after returning isValid= " + isValid);
                return isValid;
            }
            LOGGER.info("isValidValue method ends after returning isValid = true");
            return true;
        }
