...
import com.stpl.app.service.ImtdItemPriceRebateDetailsLocalService;
...
/**
 * Provides the base implementation for the imtd item price rebate details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ImtdItemPriceRebateDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class ImtdItemPriceRebateDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ImtdItemPriceRebateDetailsLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ImtdItemPriceRebateDetailsLocalServiceUtil} to access the imtd item price rebate details local service.
	 */
	...
	@Override
	public ImtdItemPriceRebateDetails addImtdItemPriceRebateDetails(
		ImtdItemPriceRebateDetails imtdItemPriceRebateDetails) {
		imtdItemPriceRebateDetails.setNew(true);

		return imtdItemPriceRebateDetailsPersistence.update(imtdItemPriceRebateDetails);
	}
	 ...
	 */
	@Override
	public ImtdItemPriceRebateDetails createImtdItemPriceRebateDetails(
		int imtdItemPriceRebateSid) {
		return imtdItemPriceRebateDetailsPersistence.create(imtdItemPriceRebateSid);
	}
	...
	@Override
	public ImtdItemPriceRebateDetails deleteImtdItemPriceRebateDetails(
		int imtdItemPriceRebateSid) throws PortalException {
		return imtdItemPriceRebateDetailsPersistence.remove(imtdItemPriceRebateSid);
	}
	...
	public ImtdItemPriceRebateDetails deleteImtdItemPriceRebateDetails(
		ImtdItemPriceRebateDetails imtdItemPriceRebateDetails) {
		return imtdItemPriceRebateDetailsPersistence.remove(imtdItemPriceRebateDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ImtdItemPriceRebateDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return imtdItemPriceRebateDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return imtdItemPriceRebateDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ImtdItemPriceRebateDetails fetchImtdItemPriceRebateDetails(
		int imtdItemPriceRebateSid) {
		return imtdItemPriceRebateDetailsPersistence.fetchByPrimaryKey(imtdItemPriceRebateSid);
	}
	 ...
	 */
	@Override
	public ImtdItemPriceRebateDetails getImtdItemPriceRebateDetails(
		int imtdItemPriceRebateSid) throws PortalException {
		return imtdItemPriceRebateDetailsPersistence.findByPrimaryKey(imtdItemPriceRebateSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(imtdItemPriceRebateDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ImtdItemPriceRebateDetails.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(imtdItemPriceRebateDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ImtdItemPriceRebateDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return imtdItemPriceRebateDetailsLocalService.deleteImtdItemPriceRebateDetails((ImtdItemPriceRebateDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return imtdItemPriceRebateDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ImtdItemPriceRebateDetails> getImtdItemPriceRebateDetailses(
		int start, int end) {
		return imtdItemPriceRebateDetailsPersistence.findAll(start, end);
	}
	...
	public int getImtdItemPriceRebateDetailsesCount() {
		return imtdItemPriceRebateDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ImtdItemPriceRebateDetails updateImtdItemPriceRebateDetails(
		ImtdItemPriceRebateDetails imtdItemPriceRebateDetails) {
		return imtdItemPriceRebateDetailsPersistence.update(imtdItemPriceRebateDetails);
	}
	 ...
	 */
	public ImtdItemPriceRebateDetailsLocalService getImtdItemPriceRebateDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ImtdItemPriceRebateDetails",
			imtdItemPriceRebateDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ImtdItemPriceRebateDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ImtdItemPriceRebateDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = imtdItemPriceRebateDetailsPersistence.getDataSource();
	...
	@BeanReference(type = ImtdItemPriceRebateDetailsLocalService.class)
	protected ImtdItemPriceRebateDetailsLocalService imtdItemPriceRebateDetailsLocalService;
