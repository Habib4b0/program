...
public class RebateSummary extends Summary {
 public static final Logger LOGGER = Logger.getLogger(RebateSummary.class);
    ...
    public void excelButtonLogic(Button.ClickEvent event) {
        ...
        CustomExcelExport exp = new CustomExcelExport(new ExtCustomTableHolder(exportPeriodViewTable), "Rebate Projection", "Rebate Projection", "Rebate Projection.xls", false, formatter);
        exp.export();
    ...
    public void loadExcelResultTable() {
        ...
        List<AbstractSummaryDTO> resultList = logic.getConfiguredRebateTabResults(new Object(), 0, 100000000, selectionDTO, true);
    ...
    public void addLowerLevelsForExport(Object id) {
        List<AbstractSummaryDTO> resultList = logic.getConfiguredRebateTabResults(id, 0, 10000000, selectionDTO, true);
