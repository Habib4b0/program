 ...
 */
package com.stpl.app.gtnutilities.etlupload;


import com.stpl.app.gtnutilities.etlupload.form.ETLView;
 ...
 * and open the template in the editor.
 */
public class ETLUI extends UI implements VaadinPortletSession.PortletListener{
     ...
     * The Constant LOGGER.
     */
    private static final Logger LOGGER = Logger.getLogger(ETLUI.class);
    ...
    protected void init(final VaadinRequest request) {
        try {
            ...
            navigator.addView(ETLView.NAME, new ETLView());
         ...
         UI.getCurrent().setErrorHandler(new DefaultErrorHandler() {
            ...
            public void error(com.vaadin.server.ErrorEvent event) {
                ...
                for (Throwable t = event.getThrowable(); t != null; t = t.getCause()) {
                 ...
                 if(event.getThrowable().getClass().getName().equalsIgnoreCase("com.vaadin.server.NoOutputStreamException")){
                     CommonMethods.getErrorNotification("Halt", "Please Select any File to Upload");
                 }
