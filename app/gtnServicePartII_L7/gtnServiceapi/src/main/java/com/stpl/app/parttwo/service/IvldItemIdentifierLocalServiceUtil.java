...
public class IvldItemIdentifierLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<IvldItemIdentifierLocalService, IvldItemIdentifierLocalService> _serviceTracker =
		ServiceTrackerFactory.open(IvldItemIdentifierLocalService.class);
}