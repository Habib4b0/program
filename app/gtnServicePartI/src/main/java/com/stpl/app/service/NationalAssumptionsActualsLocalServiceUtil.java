...
public class NationalAssumptionsActualsLocalServiceUtil {
    private static NationalAssumptionsActualsLocalService _service;
    ...
    */
    ...
    public static NationalAssumptionsActualsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    NationalAssumptionsActualsLocalService.class.getName());

            if (invokableLocalService instanceof NationalAssumptionsActualsLocalService) {
                _service = (NationalAssumptionsActualsLocalService) invokableLocalService;
            } else {
                _service = new NationalAssumptionsActualsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(NationalAssumptionsActualsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(NationalAssumptionsActualsLocalService service) {
    }
}
