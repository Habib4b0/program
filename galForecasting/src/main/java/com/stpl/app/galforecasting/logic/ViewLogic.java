...
public class ViewLogic {
     ...
     */
    public boolean isDuplicateView(final String viewName) throws SystemException, Exception {
     ...
     * @throws Exception the exception
     */
    public static User getUserById(final String userId) throws SystemException, PortalException, Exception {
     ...
     * @throws Exception the exception
     */
    public int saveForecastViewMaster(final SaveViewDTO saveViewDTO, final int projectionId) throws SystemException, PortalException, Exception {
        LOGGER.info("Entering saveForecastViewMaster method viewBinder and projectionId='" + projectionId + "' and view id: " + String.valueOf(saveViewDTO.getViewId()));
        ...
        LOGGER.info("End of saveForecastViewMaster method with view id: " + viewMaster.getViewId());
