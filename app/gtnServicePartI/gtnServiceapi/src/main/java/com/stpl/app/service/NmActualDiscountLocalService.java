...
/**
 * Provides the local service interface for NmActualDiscount. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see NmActualDiscountLocalServiceUtil
...
public interface NmActualDiscountLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NmActualDiscountLocalServiceUtil} to access the nm actual discount local service. Add custom service methods to {@link com.stpl.app.service.impl.NmActualDiscountLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
