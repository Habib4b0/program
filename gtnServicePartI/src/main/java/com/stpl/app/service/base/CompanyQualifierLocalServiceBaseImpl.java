...
import com.stpl.app.service.CompanyQualifierLocalService;
...
/**
 * Provides the base implementation for the company qualifier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CompanyQualifierLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class CompanyQualifierLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements CompanyQualifierLocalService,
        IdentifiableBean {
    ...
    private CompanyQualifierLocalServiceClpInvoker _clpInvoker = new CompanyQualifierLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CompanyQualifierLocalServiceUtil} to access the company qualifier local service.
     */
    ...
    @Override
    public CompanyQualifier addCompanyQualifier(
        CompanyQualifier companyQualifier) throws SystemException {
        companyQualifier.setNew(true);

        return companyQualifierPersistence.update(companyQualifier);
    }
     ...
     */
    @Override
    public CompanyQualifier createCompanyQualifier(int companyQualifierSid) {
        return companyQualifierPersistence.create(companyQualifierSid);
    }
    ...
    @Override
    public CompanyQualifier deleteCompanyQualifier(int companyQualifierSid)
        throws PortalException, SystemException {
        return companyQualifierPersistence.remove(companyQualifierSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public CompanyQualifier deleteCompanyQualifier(
        CompanyQualifier companyQualifier) throws SystemException {
        return companyQualifierPersistence.remove(companyQualifier);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CompanyQualifier.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return companyQualifierPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return companyQualifierPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public CompanyQualifier fetchCompanyQualifier(int companyQualifierSid)
        throws SystemException {
        return companyQualifierPersistence.fetchByPrimaryKey(companyQualifierSid);
    }
     ...
     */
    @Override
    public CompanyQualifier getCompanyQualifier(int companyQualifierSid)
        throws PortalException, SystemException {
        return companyQualifierPersistence.findByPrimaryKey(companyQualifierSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return companyQualifierPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<CompanyQualifier> getCompanyQualifiers(int start, int end)
        throws SystemException {
        return companyQualifierPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCompanyQualifiersCount() throws SystemException {
        return companyQualifierPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public CompanyQualifier updateCompanyQualifier(
        CompanyQualifier companyQualifier) throws SystemException {
        return companyQualifierPersistence.update(companyQualifier);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.CompanyQualifier",
            companyQualifierLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.CompanyQualifier");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = companyQualifierPersistence.getDataSource();
