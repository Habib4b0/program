...
import com.stpl.app.contract.dashboard.dto.IFPCriteria;
import com.stpl.app.contract.dashboard.dto.IfpFilterGenerator;
import com.stpl.app.contract.dashboard.dto.TempPricingDTO;
import com.stpl.app.contract.dashboard.logic.IFPParentLookupContainer;
...
public final class ParentIFPIdLookup extends Window {
     ...
     * The logger.
     */
    private static final Logger LOGGER = Logger.getLogger(ParentIFPIdLookup.class);
    ...
    public IFPCriteria ifpCriteria = new IFPCriteria();
    /**
     * The binder.
     */
	...
	public void setBinder(final ErrorfulFieldGroup binder) {
         ...
         */
        public BeanItemContainer<TempPricingDTO> getDummySearchResulbeans() {
         ...
         */
        public void setDummySearchResulbeans(final BeanItemContainer<TempPricingDTO> dummySearchResulbeans) {
        ...
        search.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                ...
                try {
                    ...
                    searchResults = new LazyBeanItemContainer(TempPricingDTO.class, new IFPParentLookupContainer(binder), ifpCriteria);
    ...
    public void selectBtn(Button.ClickEvent event) {
        if(itemClicked){
        final TempPricingDTO ifpSearchDto = (TempPricingDTO) resultTable.getValue();
        parentItemFamilyplanId.setValue(ifpSearchDto.getItemFamilyplanId());
        parentItemFamilyplanName.setValue(ifpSearchDto.getItemFamilyplanName());
        close();
        }else{
