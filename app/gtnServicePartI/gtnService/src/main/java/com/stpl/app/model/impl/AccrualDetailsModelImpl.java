 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link AccrualDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AccrualDetailsImpl}.
 * </p>
 *
 * @author
...
public class AccrualDetailsModelImpl extends BaseModelImpl<AccrualDetails>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a accrual details model instance should use the {@link AccrualDetails} interface instead.
	 */
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("RECORD_CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("POSTING_INDICATOR", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("BRAND_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ACCRUAL_PERIOD_END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("SALES_MASTER_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("SOURCE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CONTRACT_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("ACCRUAL_DETAILS_SID", Types.INTEGER);
		...
		TABLE_COLUMNS_MAP.put("COMPANY_IDENTIFIER_CODE_QUALIFIER", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("POSTING_STATUS", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("GL_COMPANY_MASTER_SID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CREATED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("ACCRUAL_PERIOD_START_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("SUB_LEDGER_TYPE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PROGRAM_NO", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CATEGORY_ID", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ACCRUAL_TYPE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("PROGRAM_TYPE", Types.INTEGER);
	...
	public String getCompanyStringIdentifierCodeQualifier() {
		if (_companyStringIdentifierCodeQualifier == null) {
			return StringPool.BLANK;
		}
		else {
	...
	public Object clone() {
		...
		accrualDetailsImpl.setCompanyStringIdentifierCodeQualifier(getCompanyStringIdentifierCodeQualifier());
		...
		accrualDetailsImpl.setCompanyStringId(getCompanyStringId());
	...
	public CacheModel<AccrualDetails> toCacheModel() {
		...
		accrualDetailsCacheModel.companyStringIdentifierCodeQualifier = getCompanyStringIdentifierCodeQualifier();

		String companyStringIdentifierCodeQualifier = accrualDetailsCacheModel.companyStringIdentifierCodeQualifier;

		if ((companyStringIdentifierCodeQualifier != null) &&
				(companyStringIdentifierCodeQualifier.length() == 0)) {
			accrualDetailsCacheModel.companyStringIdentifierCodeQualifier = null;
		}
		...
		accrualDetailsCacheModel.companyStringId = getCompanyStringId();

		String companyStringId = accrualDetailsCacheModel.companyStringId;

		if ((companyStringId != null) && (companyStringId.length() == 0)) {
			accrualDetailsCacheModel.companyStringId = null;
		}
	...
	public String toString() {
		...
		sb.append(getCompanyStringIdentifierCodeQualifier());
		sb.append(", amount=");
		sb.append(getAmount());
		sb.append(", subLedger=");
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>companyStringIdentifierCodeQualifier</column-name><column-value><![CDATA[");
		sb.append(getCompanyStringIdentifierCodeQualifier());
		sb.append("]]></column-value></column>");
		sb.append(
	...
	private static final ClassLoader _classLoader = AccrualDetails.class.getClassLoader();
