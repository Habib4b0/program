...
/**
 * The persistence utility for the phs actuals service. This utility wraps {@link PhsActualsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PhsActualsUtil {
    private static PhsActualsPersistence _persistence;
    ...
    */
    public static void cacheResult(com.stpl.app.model.PhsActuals phsActuals) {
    ...
    */
    public static com.stpl.app.model.PhsActuals create(
    ...
    */
    public static com.stpl.app.model.PhsActuals remove(
        PhsActualsPK phsActualsPK)
    ...
    public static com.stpl.app.model.PhsActuals updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PhsActuals findByPrimaryKey(
        PhsActualsPK phsActualsPK)
        throws com.stpl.app.NoSuchPhsActualsException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.PhsActuals fetchByPrimaryKey(
        PhsActualsPK phsActualsPK)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.PhsActuals> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static PhsActualsPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (PhsActualsPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    PhsActualsPersistence.class.getName());

            ReferenceRegistry.registerReference(PhsActualsUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(PhsActualsPersistence persistence) {
    }
}
