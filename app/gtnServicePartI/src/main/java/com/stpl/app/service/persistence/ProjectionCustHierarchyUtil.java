...
/**
 * The persistence utility for the projection cust hierarchy service. This utility wraps {@link ProjectionCustHierarchyPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ProjectionCustHierarchyUtil {
    private static ProjectionCustHierarchyPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.ProjectionCustHierarchy create(
    ...
    */
    public static com.stpl.app.model.ProjectionCustHierarchy remove(
        int projectionCustHierarchySid)
    ...
    public static com.stpl.app.model.ProjectionCustHierarchy updateImpl(
        com.stpl.app.model.ProjectionCustHierarchy projectionCustHierarchy)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.ProjectionCustHierarchy findByPrimaryKey(
        int projectionCustHierarchySid)
        throws com.stpl.app.NoSuchProjectionCustHierarchyException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.ProjectionCustHierarchy fetchByPrimaryKey(
        int projectionCustHierarchySid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.ProjectionCustHierarchy> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static ProjectionCustHierarchyPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (ProjectionCustHierarchyPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    ProjectionCustHierarchyPersistence.class.getName());

            ReferenceRegistry.registerReference(ProjectionCustHierarchyUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(ProjectionCustHierarchyPersistence persistence) {
    }
}
