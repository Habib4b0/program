...
//    private ComboBox exemptFromLowPrice;
     ...
     */
    public ContractInfoTab(final ContractMasterDTO contractMaster, final CustomFieldGroup contractBinder, final boolean isEditable) throws PortalException, SystemException, Exception {
        super();
    ...
    private void addResponsivenessToFields() throws PortalException, SystemException, Exception {
...
//        exemptFromLowPrice.select(Constants.SELECT_ONE);
        ...
        companySystemId.setPageLength(7);
        ...
        companySystemId.addValueChangeListener(new Property.ValueChangeListener() {
            ...
            public void valueChange(final ValueChangeEvent event) {
                LOGGER.info("valueChange(ValueChangeEvent event) contractId=" + companySystemId.getValue());
        ...
        contractId.addValidator(new StringLengthValidator("Contract ID length should be less than 38 characters", 0, 38, true));
        ...
        contractId.addValueChangeListener(new Property.ValueChangeListener() {
            ...
            @SuppressWarnings("PMD")
            public void valueChange(final ValueChangeEvent event) {
                LOGGER.info("valueChange(ValueChangeEvent event) contractId=" + contractId.getValue());

                contractId.setDescription(contractId.getValue());
            }
        });

        contractName.addValidator(new StringLengthValidator("Contract Name should be less than 100 characters", 0, 100, true));
        ...
        contractName.addValueChangeListener(new Property.ValueChangeListener() {
             ...
             */
            public void valueChange(final ValueChangeEvent event) {
                LOGGER.info("valueChange(ValueChangeEvent event) contractName=" + contractName.getValue());
                contractName.setDescription(contractName.getValue());
            }
        });

        contractNo.addValidator(new StringLengthValidator("Contract No should be less than 50 characters", 0, 50, true));
        ...
        contractNo.addValueChangeListener(new Property.ValueChangeListener() {
             ...
             */
            public void valueChange(final ValueChangeEvent event) {
                LOGGER.info("valueChange(ValueChangeEvent event) contractNo=" + contractNo.getValue());
                contractNo.setDescription(contractNo.getValue());
            }
        });
        ...
        endDate.addListener(new Property.ValueChangeListener() {
            ...
            public void valueChange(final ValueChangeEvent event) {
                ...
                LOGGER.info("valueChange(ValueChangeEvent event) endDate=" + endDate.getValue());
                termSetValue();

            }
        });

//        tradingPartnerName.addValidator(new StringLengthValidator("Trading Partner Name should be less than 100 characters", 0, 100, true));
//        tradingPartnerName.addValidator(new RegexpValidator("([0-9|a-z|A-Z|\\ |\\_|\\*|\\:|\\.|\\,|\\'|\\;|\\-|\\\"])*", "Trading Partner Name  can contain only digits,alphabets"));
        ...
        term.addValidator(new StringLengthValidator("Term length should be less than 50 characters", 0, 50, true));
        ...
        LOGGER.info("End of getFirstTab method");
     ...
     */
    public void setFocusOnContractId(final boolean value) {
        LOGGER.info("Entering setFocusOnContractId method");
        contractId.focus();
        LOGGER.info("End of setFocusOnContractId method");
    }
    ...
    public void termSetValue() {
        LOGGER.info("Entering termSetValue method ");
        if (startDate.getValue() == null || endDate.getValue() == null) {
        ...
        LOGGER.info("termSetValue method ends ");
    }
      ...
      public void validateFields() {
        ...
        for (Field field : collection) {
            if (field instanceof TextField) {
                ...
                LOGGER.info("key ---->" + String.valueOf(textField.getData()));
            }
        }
    }
}
