...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD DEDUCTION_INCLUSION VARCHAR(10) NOT NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD REBATE_SCHEDULE_ALIAS_ID VARCHAR(38) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD PAYMENT_LEVEL VARCHAR(38) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD EVALUATION_RULE_LEVEL VARCHAR(38) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD EVALUATION_RULE VARCHAR(100) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD EVALUATION_RULE_BUNDLE VARCHAR(38) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD CALCULATION_TYPE VARCHAR(38) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD CALCULATION_RULE VARCHAR(100) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD CALCULATION_RULE_LEVEL VARCHAR(38) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD CALCULATION_RULE_BUNDLE VARCHAR(38) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD NET_SALES_FORMULA VARCHAR(100) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD NET_SALES_RULE VARCHAR(100) NULL
END
GO 
...
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD DEDUCTION_CALENDAR_NO VARCHAR(38) NULL
END
GO 
 ...
 IF NOT EXISTS (
		...
		WHERE TABLE_NAME = 'REBATE_SCHEDULE_INTERFACE'
			...
			AND TABLE_SCHEMA = 'DBO')
BEGIN
	ALTER TABLE REBATE_SCHEDULE_INTERFACE ADD DEDUCTION_CALENDAR_NAME VARCHAR(100) NULL
END
GO  
