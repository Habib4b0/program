...
public class DeductionDetailsLocalServiceUtil {
    private static DeductionDetailsLocalService _service;
    ...
    */
    ...
    public static DeductionDetailsLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    DeductionDetailsLocalService.class.getName());

            if (invokableLocalService instanceof DeductionDetailsLocalService) {
                _service = (DeductionDetailsLocalService) invokableLocalService;
            } else {
                _service = new DeductionDetailsLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(DeductionDetailsLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(DeductionDetailsLocalService service) {
    }
}
