...
public class PPAHelperDTO implements Serializable, Comparable<PPAHelperDTO> {
    ...
    public int hashCode() {
        ...
        hash = NumericConstants.SEVENTY_NINE * hash + Objects.hashCode(this.itemName);
        hash = NumericConstants.SEVENTY_NINE * hash + Objects.hashCode(this.itemNo);
        hash = NumericConstants.SEVENTY_NINE * hash + this.itemMasterSysId;
        return hash;
    }
