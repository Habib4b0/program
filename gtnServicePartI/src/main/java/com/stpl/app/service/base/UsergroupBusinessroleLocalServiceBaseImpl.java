...
public abstract class UsergroupBusinessroleLocalServiceBaseImpl
    ...
    private UsergroupBusinessroleLocalServiceClpInvoker _clpInvoker = new UsergroupBusinessroleLocalServiceClpInvoker();
    ...
    public UsergroupBusinessrole deleteUsergroupBusinessrole(
        int usergroupBusinessroleSid) throws PortalException, SystemException {
    ...
    public UsergroupBusinessrole fetchUsergroupBusinessrole(
        int usergroupBusinessroleSid) throws SystemException {
     ...
     */
    @Override
    public int getUsergroupBusinessrolesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.UsergroupBusinessrole",
