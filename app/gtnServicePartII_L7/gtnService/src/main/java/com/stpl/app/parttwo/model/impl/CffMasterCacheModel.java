...
public class CffMasterCacheModel implements CacheModel<CffMaster>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CffMasterCacheModel)) {
			return false;
		}

		CffMasterCacheModel cffMasterCacheModel = (CffMasterCacheModel)obj;

		if (cffMasterSid == cffMasterCacheModel.cffMasterSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, cffMasterSid);
	}
