...
import com.stpl.app.service.NaProjDetailsLocalService;
...
/**
 * Provides the base implementation for the na proj details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.NaProjDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class NaProjDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NaProjDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.NaProjDetailsLocalServiceUtil} to access the na proj details local service.
	 */
	...
	@Override
	public NaProjDetails addNaProjDetails(NaProjDetails naProjDetails) {
		naProjDetails.setNew(true);

		return naProjDetailsPersistence.update(naProjDetails);
	}
	 ...
	 */
	@Override
	public NaProjDetails createNaProjDetails(int naProjDetailsSid) {
		return naProjDetailsPersistence.create(naProjDetailsSid);
	}
	...
	@Override
	public NaProjDetails deleteNaProjDetails(int naProjDetailsSid)
		throws PortalException {
		return naProjDetailsPersistence.remove(naProjDetailsSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public NaProjDetails deleteNaProjDetails(NaProjDetails naProjDetails) {
		return naProjDetailsPersistence.remove(naProjDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NaProjDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return naProjDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return naProjDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NaProjDetails fetchNaProjDetails(int naProjDetailsSid) {
		return naProjDetailsPersistence.fetchByPrimaryKey(naProjDetailsSid);
	}
	 ...
	 */
	@Override
	public NaProjDetails getNaProjDetails(int naProjDetailsSid)
		throws PortalException {
		return naProjDetailsPersistence.findByPrimaryKey(naProjDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(naProjDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NaProjDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("naProjDetailsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(naProjDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NaProjDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return naProjDetailsLocalService.deleteNaProjDetails((NaProjDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return naProjDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NaProjDetails> getNaProjDetailses(int start, int end) {
		return naProjDetailsPersistence.findAll(start, end);
	}
	...
	public int getNaProjDetailsesCount() {
		return naProjDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NaProjDetails updateNaProjDetails(NaProjDetails naProjDetails) {
		return naProjDetailsPersistence.update(naProjDetails);
	}
	 ...
	 */
	public NaProjDetailsLocalService getNaProjDetailsLocalService() {
	...
	public void setNaProjDetailsLocalService(
		NaProjDetailsLocalService naProjDetailsLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.NaProjDetails",
			naProjDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.NaProjDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return NaProjDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = naProjDetailsPersistence.getDataSource();
	...
	@BeanReference(type = NaProjDetailsLocalService.class)
	protected NaProjDetailsLocalService naProjDetailsLocalService;
