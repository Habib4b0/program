...
public abstract class UsergroupDomainMasterLocalServiceBaseImpl
    ...
    private UsergroupDomainMasterLocalServiceClpInvoker _clpInvoker = new UsergroupDomainMasterLocalServiceClpInvoker();
    ...
    public UsergroupDomainMaster deleteUsergroupDomainMaster(
        int usergroupDomainSid) throws PortalException, SystemException {
    ...
    public UsergroupDomainMaster fetchUsergroupDomainMaster(
        int usergroupDomainSid) throws SystemException {
     ...
     */
    @Override
    public int getUsergroupDomainMastersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.UsergroupDomainMaster",
