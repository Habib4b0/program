...
//    private Map<String, AlternateHistoryDTO> selectedCustomersMap = new HashMap();
    ...
    public void removeBtnClick(Button.ClickEvent event) {
        LOGGER.info("Entered inside remove btn method");
...
//            }
        ...
        LOGGER.info("Ending remove btn method");
    }
    ...
    public void removeAllBtnBtnClick(Button.ClickEvent event) {
        ...
        /* Below line is used to delete all the record from the temp table */
//        altHistoryDTO.getSelectedCustomerSet().clear();
//        logic.remove_All_customerSelection(session);
    ...
    public void configureTable() {
        ...
        availableCustomerTable.setWidth(100, Unit.PERCENTAGE);
        availableCustomerTable.setHeight(400, Unit.PIXELS);
        availableCustomerTable.setPageLength(5);
        ...
        availableCustomerTable.setColumnWidth(Constant.CHECK, 50);
...
//                        companyType.addItem(Constants.SELECT_ONE);
//                        companyType.setNullSelectionAllowed(true);
//                        companyType.setNullSelectionItemId(Constants.SELECT_ONE);
//                        companyType.addItems(commonLogic.getDropDownList("CONTRACT_TYPE"));
//                        return companyType;
//                    } catch (Exception ex) {
//                        java.util.logging.Logger.getLogger(CustomerSelection.class.getName()).log(Level.SEVERE, null, ex);
//                    }
//                }
        ...
        selectedCustomerTable.setWidth(100, Unit.PERCENTAGE);
        selectedCustomerTable.setHeight(400, Unit.PIXELS);
        selectedCustomerTable.setPageLength(5);
        ...
        selectedCustomerTable.setColumnWidth(Constant.CHECK, 50);
