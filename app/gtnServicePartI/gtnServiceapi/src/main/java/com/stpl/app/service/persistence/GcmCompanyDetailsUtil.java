...
/**
 * The persistence utility for the gcm company details service. This utility wraps {@link com.stpl.app.service.persistence.impl.GcmCompanyDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class GcmCompanyDetailsUtil {
	...
	*/
	public static void cacheResult(GcmCompanyDetails gcmCompanyDetails) {
	...
	*/
	public static void cacheResult(List<GcmCompanyDetails> gcmCompanyDetailses) {
	...
	*/
	public static GcmCompanyDetails create(int gcmCompanyDetailsSid) {
	...
	*/
	public static GcmCompanyDetails remove(int gcmCompanyDetailsSid)
		throws com.stpl.app.exception.NoSuchGcmCompanyDetailsException {
		return getPersistence().remove(gcmCompanyDetailsSid);
	}

	public static GcmCompanyDetails updateImpl(
	...
	* @throws NoSuchGcmCompanyDetailsException if a gcm company details with the primary key could not be found
	*/
	public static GcmCompanyDetails findByPrimaryKey(int gcmCompanyDetailsSid)
		throws com.stpl.app.exception.NoSuchGcmCompanyDetailsException {
	...
	*/
	public static GcmCompanyDetails fetchByPrimaryKey(int gcmCompanyDetailsSid) {
		return getPersistence().fetchByPrimaryKey(gcmCompanyDetailsSid);
	}

	public static java.util.Map<java.io.Serializable, GcmCompanyDetails> fetchByPrimaryKeys(
	...
	*/
	public static List<GcmCompanyDetails> findAll() {
	...
	*/
	public static List<GcmCompanyDetails> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<GcmCompanyDetailsPersistence, GcmCompanyDetailsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(GcmCompanyDetailsPersistence.class);
}