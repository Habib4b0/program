...
/**
 * Provides the local service interface for VwCustomerGtsForecast. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see VwCustomerGtsForecastLocalServiceUtil
...
public interface VwCustomerGtsForecastLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VwCustomerGtsForecastLocalServiceUtil} to access the vw customer gts forecast local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.VwCustomerGtsForecastLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
