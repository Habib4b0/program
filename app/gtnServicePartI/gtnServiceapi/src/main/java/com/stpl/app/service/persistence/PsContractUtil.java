...
/**
 * The persistence utility for the ps contract service. This utility wraps {@link com.stpl.app.service.persistence.impl.PsContractPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PsContractUtil {
	...
	*/
	public static void cacheResult(PsContract psContract) {
	...
	*/
	public static void cacheResult(List<PsContract> psContracts) {
	...
	*/
	public static PsContract create(int psContractSid) {
	...
	*/
	public static PsContract remove(int psContractSid)
		throws com.stpl.app.exception.NoSuchPsContractException {
		return getPersistence().remove(psContractSid);
	}

	public static PsContract updateImpl(PsContract psContract) {
	...
	* @throws NoSuchPsContractException if a ps contract with the primary key could not be found
	*/
	public static PsContract findByPrimaryKey(int psContractSid)
		throws com.stpl.app.exception.NoSuchPsContractException {
	...
	*/
	public static PsContract fetchByPrimaryKey(int psContractSid) {
		return getPersistence().fetchByPrimaryKey(psContractSid);
	}

	public static java.util.Map<java.io.Serializable, PsContract> fetchByPrimaryKeys(
	...
	*/
	public static List<PsContract> findAll() {
	...
	*/
	public static List<PsContract> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<PsContractPersistence, PsContractPersistence> _serviceTracker =
		ServiceTrackerFactory.open(PsContractPersistence.class);
}