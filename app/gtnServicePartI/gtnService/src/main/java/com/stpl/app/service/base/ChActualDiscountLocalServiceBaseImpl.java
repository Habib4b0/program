...
import com.stpl.app.service.ChActualDiscountLocalService;
...
/**
 * Provides the base implementation for the ch actual discount local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ChActualDiscountLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ChActualDiscountLocalServiceImpl
 * @see com.stpl.app.service.ChActualDiscountLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ChActualDiscountLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ChActualDiscountLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ChActualDiscountLocalServiceUtil} to access the ch actual discount local service.
	 */
	...
	@Override
	public ChActualDiscount addChActualDiscount(
		ChActualDiscount chActualDiscount) {
		chActualDiscount.setNew(true);

		return chActualDiscountPersistence.update(chActualDiscount);
	}
	 ...
	 */
	@Override
	public ChActualDiscount createChActualDiscount(
		ChActualDiscountPK chActualDiscountPK) {
		return chActualDiscountPersistence.create(chActualDiscountPK);
	}
	...
	@Override
	public ChActualDiscount deleteChActualDiscount(
		ChActualDiscountPK chActualDiscountPK) throws PortalException {
		return chActualDiscountPersistence.remove(chActualDiscountPK);
	}
	...
	public ChActualDiscount deleteChActualDiscount(
		ChActualDiscount chActualDiscount) {
		return chActualDiscountPersistence.remove(chActualDiscount);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ChActualDiscount.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return chActualDiscountPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return chActualDiscountPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ChActualDiscount fetchChActualDiscount(
		ChActualDiscountPK chActualDiscountPK) {
		return chActualDiscountPersistence.fetchByPrimaryKey(chActualDiscountPK);
	}
	 ...
	 */
	@Override
	public ChActualDiscount getChActualDiscount(
		ChActualDiscountPK chActualDiscountPK) throws PortalException {
		return chActualDiscountPersistence.findByPrimaryKey(chActualDiscountPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(chActualDiscountLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ChActualDiscount.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(chActualDiscountLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ChActualDiscount.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return chActualDiscountLocalService.deleteChActualDiscount((ChActualDiscount)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return chActualDiscountPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ChActualDiscount> getChActualDiscounts(int start, int end) {
		return chActualDiscountPersistence.findAll(start, end);
	}
	...
	public int getChActualDiscountsCount() {
		return chActualDiscountPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ChActualDiscount updateChActualDiscount(
		ChActualDiscount chActualDiscount) {
		return chActualDiscountPersistence.update(chActualDiscount);
	}
	 ...
	 */
	public ChActualDiscountLocalService getChActualDiscountLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ChActualDiscount",
			chActualDiscountLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ChActualDiscountLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = chActualDiscountPersistence.getDataSource();
	...
	@BeanReference(type = ChActualDiscountLocalService.class)
	protected ChActualDiscountLocalService chActualDiscountLocalService;
