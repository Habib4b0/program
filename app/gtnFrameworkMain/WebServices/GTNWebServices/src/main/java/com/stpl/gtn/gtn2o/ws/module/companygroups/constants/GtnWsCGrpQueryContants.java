...
public class GtnWsCGrpQueryContants {
	...
	public static final String GTN_CGRP_AUDIT_SEARCH_QUERY = " FROM DBO.HIST_COMPANY_GROUP CG " +  " JOIN @SYS.dbo.User_ cgCreatedBy on cgCreatedBy.userId = CG.CREATED_BY ";
