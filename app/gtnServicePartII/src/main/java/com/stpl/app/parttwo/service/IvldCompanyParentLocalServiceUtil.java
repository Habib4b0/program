...
public class IvldCompanyParentLocalServiceUtil {
    private static IvldCompanyParentLocalService _service;
    ...
    */
    ...
    public static IvldCompanyParentLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    IvldCompanyParentLocalService.class.getName());

            if (invokableLocalService instanceof IvldCompanyParentLocalService) {
                _service = (IvldCompanyParentLocalService) invokableLocalService;
            } else {
                _service = new IvldCompanyParentLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(IvldCompanyParentLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(IvldCompanyParentLocalService service) {
    }
}
