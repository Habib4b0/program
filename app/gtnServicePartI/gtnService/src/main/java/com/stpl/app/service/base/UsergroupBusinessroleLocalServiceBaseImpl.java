...
/**
 * Provides the base implementation for the usergroup businessrole local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.UsergroupBusinessroleLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.UsergroupBusinessroleLocalServiceImpl
 * @see com.stpl.app.service.UsergroupBusinessroleLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class UsergroupBusinessroleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UsergroupBusinessroleLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.UsergroupBusinessroleLocalServiceUtil} to access the usergroup businessrole local service.
	 */
	...
	@Override
	public UsergroupBusinessrole addUsergroupBusinessrole(
		UsergroupBusinessrole usergroupBusinessrole) {
		usergroupBusinessrole.setNew(true);

		return usergroupBusinessrolePersistence.update(usergroupBusinessrole);
	}
	 ...
	 */
	@Override
	public UsergroupBusinessrole createUsergroupBusinessrole(
		int usergroupBusinessroleSid) {
		return usergroupBusinessrolePersistence.create(usergroupBusinessroleSid);
	}
	...
	@Override
	public UsergroupBusinessrole deleteUsergroupBusinessrole(
		int usergroupBusinessroleSid) throws PortalException {
		return usergroupBusinessrolePersistence.remove(usergroupBusinessroleSid);
	}
	...
	public UsergroupBusinessrole deleteUsergroupBusinessrole(
		UsergroupBusinessrole usergroupBusinessrole) {
		return usergroupBusinessrolePersistence.remove(usergroupBusinessrole);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UsergroupBusinessrole.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return usergroupBusinessrolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return usergroupBusinessrolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UsergroupBusinessrole fetchUsergroupBusinessrole(
		int usergroupBusinessroleSid) {
		return usergroupBusinessrolePersistence.fetchByPrimaryKey(usergroupBusinessroleSid);
	}
	 ...
	 */
	@Override
	public UsergroupBusinessrole getUsergroupBusinessrole(
		int usergroupBusinessroleSid) throws PortalException {
		return usergroupBusinessrolePersistence.findByPrimaryKey(usergroupBusinessroleSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(usergroupBusinessroleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UsergroupBusinessrole.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(usergroupBusinessroleLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(UsergroupBusinessrole.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return usergroupBusinessroleLocalService.deleteUsergroupBusinessrole((UsergroupBusinessrole)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return usergroupBusinessrolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UsergroupBusinessrole> getUsergroupBusinessroles(int start,
		int end) {
		return usergroupBusinessrolePersistence.findAll(start, end);
	}
	...
	public int getUsergroupBusinessrolesCount() {
		return usergroupBusinessrolePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UsergroupBusinessrole updateUsergroupBusinessrole(
		UsergroupBusinessrole usergroupBusinessrole) {
		return usergroupBusinessrolePersistence.update(usergroupBusinessrole);
	}
	 ...
	 */
	public UsergroupBusinessroleLocalService getUsergroupBusinessroleLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.UsergroupBusinessrole",
			usergroupBusinessroleLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.UsergroupBusinessrole");
	}
	...
	public String getOSGiServiceIdentifier() {
		return UsergroupBusinessroleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = usergroupBusinessrolePersistence.getDataSource();
	...
	@BeanReference(type = UsergroupBusinessroleLocalService.class)
	protected UsergroupBusinessroleLocalService usergroupBusinessroleLocalService;
