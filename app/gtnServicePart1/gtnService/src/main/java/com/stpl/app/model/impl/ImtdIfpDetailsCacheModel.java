...
public class ImtdIfpDetailsCacheModel implements CacheModel<ImtdIfpDetails>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ImtdIfpDetailsCacheModel)) {
			return false;
		}

		ImtdIfpDetailsCacheModel imtdIfpDetailsCacheModel = (ImtdIfpDetailsCacheModel)obj;

		if (imtdIfpDetailsSid == imtdIfpDetailsCacheModel.imtdIfpDetailsSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, imtdIfpDetailsSid);
	}
