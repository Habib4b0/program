...
import com.stpl.app.service.ImtdIfpDetailsLocalService;
...
/**
 * Provides the base implementation for the imtd ifp details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ImtdIfpDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class ImtdIfpDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ImtdIfpDetailsLocalService,
        IdentifiableBean {
    ...
    private ImtdIfpDetailsLocalServiceClpInvoker _clpInvoker = new ImtdIfpDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ImtdIfpDetailsLocalServiceUtil} to access the imtd ifp details local service.
     */
    ...
    @Override
    public ImtdIfpDetails addImtdIfpDetails(ImtdIfpDetails imtdIfpDetails)
        throws SystemException {
        imtdIfpDetails.setNew(true);

        return imtdIfpDetailsPersistence.update(imtdIfpDetails);
    }
     ...
     */
    @Override
    public ImtdIfpDetails createImtdIfpDetails(int imtdIfpDetailsSid) {
        return imtdIfpDetailsPersistence.create(imtdIfpDetailsSid);
    }
    ...
    @Override
    public ImtdIfpDetails deleteImtdIfpDetails(int imtdIfpDetailsSid)
        throws PortalException, SystemException {
        return imtdIfpDetailsPersistence.remove(imtdIfpDetailsSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ImtdIfpDetails deleteImtdIfpDetails(ImtdIfpDetails imtdIfpDetails)
        throws SystemException {
        return imtdIfpDetailsPersistence.remove(imtdIfpDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ImtdIfpDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return imtdIfpDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return imtdIfpDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ImtdIfpDetails fetchImtdIfpDetails(int imtdIfpDetailsSid)
        throws SystemException {
        return imtdIfpDetailsPersistence.fetchByPrimaryKey(imtdIfpDetailsSid);
    }
     ...
     */
    @Override
    public ImtdIfpDetails getImtdIfpDetails(int imtdIfpDetailsSid)
        throws PortalException, SystemException {
        return imtdIfpDetailsPersistence.findByPrimaryKey(imtdIfpDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return imtdIfpDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ImtdIfpDetails> getImtdIfpDetailses(int start, int end)
        throws SystemException {
        return imtdIfpDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getImtdIfpDetailsesCount() throws SystemException {
        return imtdIfpDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ImtdIfpDetails updateImtdIfpDetails(ImtdIfpDetails imtdIfpDetails)
        throws SystemException {
        return imtdIfpDetailsPersistence.update(imtdIfpDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ImtdIfpDetails",
            imtdIfpDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.ImtdIfpDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = imtdIfpDetailsPersistence.getDataSource();
