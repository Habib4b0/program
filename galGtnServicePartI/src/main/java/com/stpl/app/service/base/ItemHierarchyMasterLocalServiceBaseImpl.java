...
public abstract class ItemHierarchyMasterLocalServiceBaseImpl
    ...
    private ItemHierarchyMasterLocalServiceClpInvoker _clpInvoker = new ItemHierarchyMasterLocalServiceClpInvoker();
    ...
    public ItemHierarchyMaster deleteItemHierarchyMaster(
        int itemHierarchyMasterSid) throws PortalException, SystemException {
    ...
    public ItemHierarchyMaster fetchItemHierarchyMaster(
        int itemHierarchyMasterSid) throws SystemException {
     ...
     */
    @Override
    public int getItemHierarchyMastersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ItemHierarchyMaster",
