...
public class StNmPpaProjectionMasterPK implements Comparable<StNmPpaProjectionMasterPK>,
    Serializable {
    public int projectionDetailsSid;
    public int userId;
    public int sessionId;

    public StNmPpaProjectionMasterPK() {
    }

    public StNmPpaProjectionMasterPK(int projectionDetailsSid, int userId,
        int sessionId) {
    ...
    @Override
    public int compareTo(StNmPpaProjectionMasterPK pk) {
        if (pk == null) {
            return -1;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof StNmPpaProjectionMasterPK)) {
            return false;
        }

        StNmPpaProjectionMasterPK pk = (StNmPpaProjectionMasterPK) obj;
