...
public class IvldItemHierarchyDefinitionLocalServiceUtil {
    private static IvldItemHierarchyDefinitionLocalService _service;
    ...
    */
    ...
    public static IvldItemHierarchyDefinitionLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    IvldItemHierarchyDefinitionLocalService.class.getName());

            if (invokableLocalService instanceof IvldItemHierarchyDefinitionLocalService) {
                _service = (IvldItemHierarchyDefinitionLocalService) invokableLocalService;
            } else {
                _service = new IvldItemHierarchyDefinitionLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(IvldItemHierarchyDefinitionLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(IvldItemHierarchyDefinitionLocalService service) {
    }
}
