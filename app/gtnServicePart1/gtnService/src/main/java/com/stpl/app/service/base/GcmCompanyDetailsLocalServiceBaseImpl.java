...
import com.stpl.app.service.GcmCompanyDetailsLocalService;
...
/**
 * Provides the base implementation for the gcm company details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.GcmCompanyDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.GcmCompanyDetailsLocalServiceImpl
 * @see com.stpl.app.service.GcmCompanyDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class GcmCompanyDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GcmCompanyDetailsLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.GcmCompanyDetailsLocalServiceUtil} to access the gcm company details local service.
	 */
	...
	@Override
	public GcmCompanyDetails addGcmCompanyDetails(
		GcmCompanyDetails gcmCompanyDetails) {
		gcmCompanyDetails.setNew(true);

		return gcmCompanyDetailsPersistence.update(gcmCompanyDetails);
	}
	 ...
	 */
	@Override
	public GcmCompanyDetails createGcmCompanyDetails(int gcmCompanyDetailsSid) {
		return gcmCompanyDetailsPersistence.create(gcmCompanyDetailsSid);
	}
	...
	@Override
	public GcmCompanyDetails deleteGcmCompanyDetails(int gcmCompanyDetailsSid)
		throws PortalException {
		return gcmCompanyDetailsPersistence.remove(gcmCompanyDetailsSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GcmCompanyDetails deleteGcmCompanyDetails(
		GcmCompanyDetails gcmCompanyDetails) {
		return gcmCompanyDetailsPersistence.remove(gcmCompanyDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GcmCompanyDetails.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return gcmCompanyDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return gcmCompanyDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GcmCompanyDetails fetchGcmCompanyDetails(int gcmCompanyDetailsSid) {
		return gcmCompanyDetailsPersistence.fetchByPrimaryKey(gcmCompanyDetailsSid);
	}
	 ...
	 */
	@Override
	public GcmCompanyDetails getGcmCompanyDetails(int gcmCompanyDetailsSid)
		throws PortalException {
		return gcmCompanyDetailsPersistence.findByPrimaryKey(gcmCompanyDetailsSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(gcmCompanyDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(GcmCompanyDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("gcmCompanyDetailsSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(gcmCompanyDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(GcmCompanyDetails.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return gcmCompanyDetailsLocalService.deleteGcmCompanyDetails((GcmCompanyDetails)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return gcmCompanyDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GcmCompanyDetails> getGcmCompanyDetailses(int start, int end) {
		return gcmCompanyDetailsPersistence.findAll(start, end);
	}
	...
	public int getGcmCompanyDetailsesCount() {
		return gcmCompanyDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GcmCompanyDetails updateGcmCompanyDetails(
		GcmCompanyDetails gcmCompanyDetails) {
		return gcmCompanyDetailsPersistence.update(gcmCompanyDetails);
	}
	 ...
	 */
	public GcmCompanyDetailsLocalService getGcmCompanyDetailsLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.GcmCompanyDetails",
			gcmCompanyDetailsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.GcmCompanyDetails");
	}
	...
	public String getOSGiServiceIdentifier() {
		return GcmCompanyDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = gcmCompanyDetailsPersistence.getDataSource();
	...
	@BeanReference(type = GcmCompanyDetailsLocalService.class)
	protected GcmCompanyDetailsLocalService gcmCompanyDetailsLocalService;
