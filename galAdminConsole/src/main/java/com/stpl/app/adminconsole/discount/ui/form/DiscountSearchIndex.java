...
public class DiscountSearchIndex extends CustomComponent implements View {
    ...
    /**
     * Adds the results tables.
     *
     * @return the panel
     */
    private Panel addResultsTables() {
        final Panel panel = new Panel();
        final GridLayout tableLayout = new GridLayout(1, 1);
    ...
    private ExtFilterTable addResultsTable() {
        ...
        results.addValueChangeListener(new Property.ValueChangeListener() {
            ...
            public void valueChange(final Property.ValueChangeEvent event) {
                LOGGER.info("In results results.addValueChangeListener started");
                resultsItemClick(event.getProperty().getValue());
                LOGGER.info("In results results.addValueChangeListener Ended");
            }
        });
    ...
    private Component addNavigationButtons() {
        LOGGER.info("addNavigationButtons method Started ");
        final HorizontalLayout layout = new HorizontalLayout();
        ...
        LOGGER.info("addNavigationButtons method RETURNS layout ");
    ...
    public void configureFields() {
        ...
        searchBtn.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                LOGGER.info("In configureFields searchBtn listener started");
                try {
        ...
        addBtn.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                ...
                VaadinSession.getCurrent().setAttribute("logic", "add");
     ...
     */
    protected void searchButtonClickLogic() throws SystemException, PortalException, Exception {
    ...
    protected void resultsItemClick(final Object obj) {
        ...
        if (obj == null) {
            ...
            version = ((DiscountSearchDTO) targetItem.getBean()).getVersion();
        }
