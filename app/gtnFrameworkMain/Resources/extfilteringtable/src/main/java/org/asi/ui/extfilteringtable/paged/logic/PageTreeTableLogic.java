...
public abstract class PageTreeTableLogic extends PageTreeLogicBase {
    ...
    public int getDepth(Object itemId, int depth) {
        ...
        if (treeLevel != null) {
            depth = treeDepthMapList.get(treeLevel);
        }
        return depth;
    }
    ...
    public String getParentHierarchyNo(String hierarchyNos) {
        ...
        int lin = hierarchyNos.lastIndexOf(".", len - 2);
        if (lin > 0) {
    ...
    public List<String> getAllLevels() {
        ...
        treelevels.addAll(getExpandedTreeList().keySet());
    ...
    protected int getTotalCount(int totalCount, String treeLevel, String nextTreeLevel, int currentPageStartIndex) {
        List<String> list = new ArrayList<String>(treeIndexMapList.keySet());
        ...
        for (int i = hierarchyList.size() - 1; i >= 0; i--) {
            ...
            int treeIndex = treeIndexMapList.get(s);
            int cond = 0;
            if (len >= (len1)) {
    ...
    private Object getItemId(String treeLevels) {
        ...
        if (isBulkDataLoadAllowed()) {
            ...
            Map<String, Object> bulkDataMap = new HashMap<String, Object>();
            for (String key : list) {
     ...
     */
    private void loadBulkDataContainer(Map<String, Object> bulkDataMap) {
        try {
    ...
    public void removeLevelRecursively(String treeLevel, int count) {
        ...
        List<String> list = new ArrayList<String>(expandedTreeList.keySet());
     ...
     */
    public Map<String, Object> getCurrentPageData() {
     ...
     */
    public void setCurrentPageData(Map<String, Object> currentPageData) {
    ...
    public String getCurrentPageDataLevelTree(Object itemId) {
        ...
        for (String lvl : currentPageData.keySet()) {
            if (itemId.equals(getCurrentPageData(lvl))) {
                levelTree = lvl;
            }
        }
        return levelTree;
     ...
     */
    protected Map<String, Object> getExpandedTreeList() {
    ...
    /**
     * Removes the expanded tree list.
     *
     * @param treeLevel the tree level
     * @return the object
     */
    protected Object removeExpandedTreeList(String treeLevel) {
        return expandedTreeList.remove(treeLevel);
    }
     ...
     */
    protected Map<String, Object> getNonFetchableData() {
     ...
     */
    protected void setNonFetchableData(Map<String, Object> nonFetchableData) {
    ...
    /**
     * Removes the non fetchable data.
     *
     * @param index the index
     * @return the object
     */
    protected Object removeNonFetchableData(String index) {
        return nonFetchableData.remove(index);
    }
