...
public class IvldItemHierarchyWrapper implements IvldItemHierarchy,
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<IvldItemHierarchy> toCacheModel() {
	...
	public boolean equals(Object obj) {
		...
		if (Objects.equals(_ivldItemHierarchy,
	...
	public boolean isEntityCacheEnabled() {
		return _ivldItemHierarchy.isEntityCacheEnabled();
	}

	@Override
	public boolean isFinderCacheEnabled() {
		return _ivldItemHierarchy.isFinderCacheEnabled();
	}
	...
	private final IvldItemHierarchy _ivldItemHierarchy;
}