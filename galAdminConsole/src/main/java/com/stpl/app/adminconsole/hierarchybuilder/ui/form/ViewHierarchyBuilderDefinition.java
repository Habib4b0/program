...
public final class ViewHierarchyBuilderDefinition extends CustomComponent implements View {
    ...
    private void configureFields() {
        ...
        tableName.addFocusListener(new FocusListener() {
            ...
            public void focus(final FocusEvent event) {
                LOGGER.info("In configureFields tableName.addFocusListener Started");
                ...
                LOGGER.info("In configureFields tableName.addFocusListener Ended");
            }
        });
        fieldName.setEnabled(false);
        ...
        fieldName.addFocusListener(new FocusListener() {
             ...
             */
            public void focus(final FocusEvent event) {
                LOGGER.info("In configureFields fieldName.addFocusListener Started");
                final TableFieldNameLookUp lookUp = new TableFieldNameLookUp(tableName, fieldName);
                UI.getCurrent().addWindow(lookUp);
                lookUp.addCloseListener(new Window.CloseListener() {
                    @SuppressWarnings("PMD")
                ...
                LOGGER.info("In configureFields fieldName.addFocusListener Ended");
            }
        });
    }
    ...
    public Button getBackButton() {
        ...
        backButton.addClickListener(new ClickListener() {
            ...
            @SuppressWarnings("PMD")
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("In getBackButton backButton.addClickListener navigateTo HierarchyBuilderIndex");
    ...
    public Table levelDefinitionListTable() {
        ...
        levelDefinitionTable.addValueChangeListener(new Property.ValueChangeListener() {
            ...
            public void valueChange(final ValueChangeEvent event) {
                LOGGER.info("In levelDefinitionListTable levelDefinitionTable.addValueChangeListener Started");
                ...
                LOGGER.info("In levelDefinitionListTable levelDefinitionTable.addValueChangeListener Ended");
            }
        });
        return levelDefinitionTable;
    }
