...
/**
 * The persistence utility for the deduction details service. This utility wraps {@link com.stpl.app.service.persistence.impl.DeductionDetailsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class DeductionDetailsUtil {
	...
	*/
	public static void cacheResult(DeductionDetails deductionDetails) {
	...
	*/
	public static void cacheResult(List<DeductionDetails> deductionDetailses) {
	...
	*/
	public static DeductionDetails create(int deductionDetailsSid) {
	...
	*/
	public static DeductionDetails remove(int deductionDetailsSid)
		throws com.stpl.app.exception.NoSuchDeductionDetailsException {
		return getPersistence().remove(deductionDetailsSid);
	}

	public static DeductionDetails updateImpl(DeductionDetails deductionDetails) {
	...
	* @throws NoSuchDeductionDetailsException if a deduction details with the primary key could not be found
	*/
	public static DeductionDetails findByPrimaryKey(int deductionDetailsSid)
		throws com.stpl.app.exception.NoSuchDeductionDetailsException {
	...
	*/
	public static DeductionDetails fetchByPrimaryKey(int deductionDetailsSid) {
		return getPersistence().fetchByPrimaryKey(deductionDetailsSid);
	}

	public static java.util.Map<java.io.Serializable, DeductionDetails> fetchByPrimaryKeys(
	...
	*/
	public static List<DeductionDetails> findAll() {
	...
	*/
	public static List<DeductionDetails> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<DeductionDetailsPersistence, DeductionDetailsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(DeductionDetailsPersistence.class);
}