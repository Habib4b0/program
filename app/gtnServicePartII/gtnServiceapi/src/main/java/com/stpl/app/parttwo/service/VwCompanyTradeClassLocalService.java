...
/**
 * Provides the local service interface for VwCompanyTradeClass. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see VwCompanyTradeClassLocalServiceUtil
...
public interface VwCompanyTradeClassLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VwCompanyTradeClassLocalServiceUtil} to access the vw company trade class local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.VwCompanyTradeClassLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
