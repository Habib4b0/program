...
public interface CdrModelPersistence extends BasePersistence<CdrModel> {
	...
	*/
	public void cacheResult(java.util.List<CdrModel> cdrModels);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CdrModel> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<CdrModel> findAll();
	...
	*/
	public java.util.List<CdrModel> findAll(int start, int end);
	...
	*/
	public java.util.List<CdrModel> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CdrModel> orderByComparator);
