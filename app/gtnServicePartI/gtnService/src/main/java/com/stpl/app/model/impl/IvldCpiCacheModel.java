...
public class IvldCpiCacheModel implements CacheModel<IvldCpi>, Externalizable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldCpiCacheModel)) {
			return false;
		}

		IvldCpiCacheModel ivldCpiCacheModel = (IvldCpiCacheModel)obj;

		if (ivldCpiSid == ivldCpiCacheModel.ivldCpiSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldCpiSid);
	}
