...
/**
 * Provides the local service interface for AdjustedDemandForecast. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see AdjustedDemandForecastLocalServiceUtil
...
public interface AdjustedDemandForecastLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AdjustedDemandForecastLocalServiceUtil} to access the adjusted demand forecast local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.AdjustedDemandForecastLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AdjustedDemandForecast deleteAdjustedDemandForecast(
		int adjustedDemandForecastSid) throws PortalException;
