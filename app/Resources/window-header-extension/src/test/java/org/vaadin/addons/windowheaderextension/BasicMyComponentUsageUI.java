...
import com.stpl.addons.windowheaderextension.WindowButtonClickListener;
    ...
    public Component getTestComponent() {
        ...
        b.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                WindowHeaderExtension.extend(w, VaadinIcons.AMBULANCE,
                ...
                WindowHeaderExtension.extend(w, VaadinIcons.CASH,
