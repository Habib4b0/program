...
import com.stpl.app.service.IfpModelLocalService;
...
/**
 * Provides the base implementation for the ifp model local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.IfpModelLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class IfpModelLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements IfpModelLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.IfpModelLocalServiceUtil} to access the ifp model local service.
	 */
	...
	@Override
	public IfpModel addIfpModel(IfpModel ifpModel) {
		ifpModel.setNew(true);

		return ifpModelPersistence.update(ifpModel);
	}
	 ...
	 */
	@Override
	public IfpModel createIfpModel(int ifpModelSid) {
		return ifpModelPersistence.create(ifpModelSid);
	}
	...
	@Override
	public IfpModel deleteIfpModel(int ifpModelSid) throws PortalException {
		return ifpModelPersistence.remove(ifpModelSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IfpModel deleteIfpModel(IfpModel ifpModel) {
		return ifpModelPersistence.remove(ifpModel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IfpModel.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ifpModelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ifpModelPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return ifpModelPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ifpModelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IfpModel fetchIfpModel(int ifpModelSid) {
		return ifpModelPersistence.fetchByPrimaryKey(ifpModelSid);
	}
	 ...
	 */
	@Override
	public IfpModel getIfpModel(int ifpModelSid) throws PortalException {
		return ifpModelPersistence.findByPrimaryKey(ifpModelSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ifpModelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IfpModel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ifpModelSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ifpModelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IfpModel.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("ifpModelSid");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ifpModelLocalService.deleteIfpModel((IfpModel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ifpModelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IfpModel> getIfpModels(int start, int end) {
		return ifpModelPersistence.findAll(start, end);
	}
	...
	public int getIfpModelsCount() {
		return ifpModelPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IfpModel updateIfpModel(IfpModel ifpModel) {
		return ifpModelPersistence.update(ifpModel);
	}
	 ...
	 */
	public IfpModelLocalService getIfpModelLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.IfpModel",
			ifpModelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.IfpModel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IfpModelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ifpModelPersistence.getDataSource();
	...
	@BeanReference(type = IfpModelLocalService.class)
	protected IfpModelLocalService ifpModelLocalService;
