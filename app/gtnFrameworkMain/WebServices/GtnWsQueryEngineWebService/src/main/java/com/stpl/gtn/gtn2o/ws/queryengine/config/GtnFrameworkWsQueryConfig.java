...
public class GtnFrameworkWsQueryConfig {
	
	private GtnFrameworkDependencyLogger gtnLogger = GtnFrameworkDependencyLogger.getGTNLogger(GtnFrameworkWsQueryConfig.class);
	...
	public GtnFrameworkWsQueryConfig() {
		super();
	}

	public GtnFrameworkWsQueryConfig(String query, boolean insertOrSelectQuery, boolean updateOrDeleteQuery) {
		super();
		this.query = query;
