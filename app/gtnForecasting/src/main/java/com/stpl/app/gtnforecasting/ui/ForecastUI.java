                ...
                sessionDto.setApprovalLevel(Integer.parseInt(approvalLevels));
                    ...
                    if (!CommonUtils.BUSINESS_PROCESS_TYPE_ACCRUAL_RATE_PROJECTION.equalsIgnoreCase(screenName)) {
                        if (screenName.equals(CommonUtils.BUSINESS_PROCESS_TYPE_NONMANDATED)) {
                            ...
                            sessionDto.setCustomRelationShipSid(dataList!=null &&  dataList.get(0)[0]!=null? Integer.parseInt(String.valueOf(dataList.get(0)[0])) : 0);
                            sessionDto.setCustomDeductionRelationShipSid(dataList!=null && dataList.get(0)[1]!=null ? Integer.parseInt(String.valueOf(dataList.get(0)[1])) : 0);
                        }
