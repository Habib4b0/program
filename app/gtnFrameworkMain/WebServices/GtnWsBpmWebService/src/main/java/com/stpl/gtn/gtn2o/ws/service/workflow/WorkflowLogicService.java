...
public class WorkflowLogicService {
	...
	public List<ForecastingRulesDTO> getProjectionValues(int projectionId, String screenName) {
		List<ForecastingRulesDTO> list = new ArrayList<>();
		try {

			List<Object[]> returnList = getProjectionRecords(projectionId, screenName);// ,
	...
	@SuppressWarnings("unchecked")
	public List<Object[]> getProjectionRecords(int projectionId, String screenName) {
