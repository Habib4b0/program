...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD DEDUCTION_INCLUSION VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD REBATE_SCHEDULE_ALIAS_ID VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD PAYMENT_LEVEL VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD EVALUATION_RULE_LEVEL VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD EVALUATION_RULE VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD EVALUATION_RULE_BUNDLE VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD CALCULATION_TYPE VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD CALCULATION_RULE VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD CALCULATION_RULE_LEVEL VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD CALCULATION_RULE_BUNDLE VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD NET_SALES_FORMULA VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD NET_SALES_RULE VARCHAR(200) NULL
END
GO
...
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD DEDUCTION_CALENDAR_NO VARCHAR(200) NULL
END
GO
 ...
 IF NOT EXISTS (
		...
		WHERE TABLE_NAME = 'IVLD_REBATE_SCHEDULE'
			...
			AND TABLE_SCHEMA = 'DBO')
BEGIN
	ALTER TABLE IVLD_REBATE_SCHEDULE ADD DEDUCTION_CALENDAR_NAME VARCHAR(200) NULL
END
GO
--------------------------------STATISTICS-------------------------
DECLARE @SQL NVARCHAR(MAX)
