...
public class NmActualDiscountPK implements Comparable<NmActualDiscountPK>,
    Serializable {
    public int periodSid;
    public int projectionDetailsSid;

    public NmActualDiscountPK() {
    }

    public NmActualDiscountPK(int periodSid, int projectionDetailsSid) {
    ...
    @Override
    public int compareTo(NmActualDiscountPK pk) {
        if (pk == null) {
            return -1;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof NmActualDiscountPK)) {
            return false;
        }

        NmActualDiscountPK pk = (NmActualDiscountPK) obj;
