...
public class RebatePlanTierCacheModel implements CacheModel<RebatePlanTier>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RebatePlanTierCacheModel)) {
			return false;
		}

		RebatePlanTierCacheModel rebatePlanTierCacheModel = (RebatePlanTierCacheModel)obj;

		if (rebatePlanTierSid == rebatePlanTierCacheModel.rebatePlanTierSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, rebatePlanTierSid);
	}
