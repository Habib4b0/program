...
import com.stpl.app.service.ForecastingViewMasterLocalService;
...
/**
 * Provides the base implementation for the forecasting view master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ForecastingViewMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class ForecastingViewMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ForecastingViewMasterLocalService,
        IdentifiableBean {
    ...
    private ForecastingViewMasterLocalServiceClpInvoker _clpInvoker = new ForecastingViewMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ForecastingViewMasterLocalServiceUtil} to access the forecasting view master local service.
     */
    ...
    @Override
    public ForecastingViewMaster addForecastingViewMaster(
        ForecastingViewMaster forecastingViewMaster) throws SystemException {
        forecastingViewMaster.setNew(true);

        return forecastingViewMasterPersistence.update(forecastingViewMaster);
    }
     ...
     */
    @Override
    public ForecastingViewMaster createForecastingViewMaster(int viewId) {
        return forecastingViewMasterPersistence.create(viewId);
    }
    ...
    @Override
    public ForecastingViewMaster deleteForecastingViewMaster(int viewId)
        throws PortalException, SystemException {
        return forecastingViewMasterPersistence.remove(viewId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ForecastingViewMaster deleteForecastingViewMaster(
        ForecastingViewMaster forecastingViewMaster) throws SystemException {
        return forecastingViewMasterPersistence.remove(forecastingViewMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ForecastingViewMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return forecastingViewMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return forecastingViewMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public ForecastingViewMaster fetchForecastingViewMaster(int viewId)
        throws SystemException {
        return forecastingViewMasterPersistence.fetchByPrimaryKey(viewId);
    }
     ...
     */
    @Override
    public ForecastingViewMaster getForecastingViewMaster(int viewId)
        throws PortalException, SystemException {
        return forecastingViewMasterPersistence.findByPrimaryKey(viewId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return forecastingViewMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ForecastingViewMaster> getForecastingViewMasters(int start,
        int end) throws SystemException {
        return forecastingViewMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getForecastingViewMastersCount() throws SystemException {
        return forecastingViewMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ForecastingViewMaster updateForecastingViewMaster(
        ForecastingViewMaster forecastingViewMaster) throws SystemException {
        return forecastingViewMasterPersistence.update(forecastingViewMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ForecastingViewMaster",
            forecastingViewMasterLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.ForecastingViewMaster");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = forecastingViewMasterPersistence.getDataSource();
