...
/**
 * Provides the local service interface for GlCostCenterMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see GlCostCenterMasterLocalServiceUtil
...
public interface GlCostCenterMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GlCostCenterMasterLocalServiceUtil} to access the gl cost center master local service. Add custom service methods to {@link com.stpl.app.service.impl.GlCostCenterMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public GlCostCenterMaster addGlCostCenterMaster(
	...
	*/
	public GlCostCenterMaster createGlCostCenterMaster(
	...
	*/
	...
	public GlCostCenterMaster deleteGlCostCenterMaster(
		GlCostCenterMaster glCostCenterMaster);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public GlCostCenterMaster deleteGlCostCenterMaster(
		int glCostCenterMasterSid) throws PortalException;
	...
	*/
	...
	public GlCostCenterMaster fetchGlCostCenterMaster(int glCostCenterMasterSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GlCostCenterMaster getGlCostCenterMaster(int glCostCenterMasterSid)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GlCostCenterMaster> getGlCostCenterMasters(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public GlCostCenterMaster updateGlCostCenterMaster(
		GlCostCenterMaster glCostCenterMaster);
}