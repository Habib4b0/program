...
public class DemandForecastCacheModel implements CacheModel<DemandForecast>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DemandForecastCacheModel)) {
			return false;
		}

		DemandForecastCacheModel demandForecastCacheModel = (DemandForecastCacheModel)obj;

		if (demandForecastSid == demandForecastCacheModel.demandForecastSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, demandForecastSid);
	}
