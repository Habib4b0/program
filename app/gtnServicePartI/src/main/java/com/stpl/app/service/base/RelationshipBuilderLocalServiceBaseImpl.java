...
public abstract class RelationshipBuilderLocalServiceBaseImpl
    ...
    private RelationshipBuilderLocalServiceClpInvoker _clpInvoker = new RelationshipBuilderLocalServiceClpInvoker();
    ...
    public RelationshipBuilder deleteRelationshipBuilder(
        int relationshipBuilderSid) throws PortalException, SystemException {
    ...
    public RelationshipBuilder fetchRelationshipBuilder(
        int relationshipBuilderSid) throws SystemException {
     ...
     */
    @Override
    public int getRelationshipBuildersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.RelationshipBuilder",
