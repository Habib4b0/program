...
import com.stpl.app.service.AdditionalNotesLocalService;
...
/**
 * Provides the base implementation for the additional notes local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.AdditionalNotesLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.AdditionalNotesLocalServiceImpl
 * @see com.stpl.app.service.AdditionalNotesLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class AdditionalNotesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AdditionalNotesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.AdditionalNotesLocalServiceUtil} to access the additional notes local service.
	 */
	...
	public AdditionalNotes addAdditionalNotes(AdditionalNotes additionalNotes) {
		...
		return additionalNotesPersistence.update(additionalNotes);
	}
	...
	public AdditionalNotes createAdditionalNotes(int additionalNotesId) {
		return additionalNotesPersistence.create(additionalNotesId);
	}
	...
	public AdditionalNotes deleteAdditionalNotes(int additionalNotesId)
		...
		return additionalNotesPersistence.remove(additionalNotesId);
	}
	...
	public AdditionalNotes deleteAdditionalNotes(
		...
		return additionalNotesPersistence.remove(additionalNotes);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AdditionalNotes.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return additionalNotesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return additionalNotesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AdditionalNotes fetchAdditionalNotes(int additionalNotesId) {
		return additionalNotesPersistence.fetchByPrimaryKey(additionalNotesId);
	}
	...
	public AdditionalNotes getAdditionalNotes(int additionalNotesId)
		throws PortalException {
		return additionalNotesPersistence.findByPrimaryKey(additionalNotesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(additionalNotesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AdditionalNotes.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("additionalNotesId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(additionalNotesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AdditionalNotes.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return additionalNotesLocalService.deleteAdditionalNotes((AdditionalNotes)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return additionalNotesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AdditionalNotes> getAdditionalNoteses(int start, int end) {
		return additionalNotesPersistence.findAll(start, end);
	}
	...
	public int getAdditionalNotesesCount() {
		return additionalNotesPersistence.countAll();
	}
	 ...
	 */
	public AdditionalNotesLocalService getAdditionalNotesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.AdditionalNotes",
			additionalNotesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.AdditionalNotes");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AdditionalNotesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = additionalNotesPersistence.getDataSource();
	...
	@BeanReference(type = AdditionalNotesLocalService.class)
	protected AdditionalNotesLocalService additionalNotesLocalService;
