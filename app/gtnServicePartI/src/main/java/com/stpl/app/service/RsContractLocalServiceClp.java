 ...
 * @generated
 */
public class RsContractLocalServiceClp implements RsContractLocalService {
    ...
    public RsContractLocalServiceClp(
    ...
    public com.stpl.app.model.RsContract addRsContract(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(rsContract) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.RsContract) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.RsContract createRsContract(int rsContractSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { rsContractSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.RsContract deleteRsContract(int rsContractSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { rsContractSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.RsContract fetchRsContract(int rsContractSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { rsContractSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.RsContract getRsContract(int rsContractSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { rsContractSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.RsContract> getRsContracts(
        ...
        return (java.util.List<com.stpl.app.model.RsContract>) ClpSerializer.translateOutput(returnObj);
    }
