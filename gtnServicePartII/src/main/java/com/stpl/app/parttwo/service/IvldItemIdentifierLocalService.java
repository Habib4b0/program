...
/**
 * Provides the local service interface for IvldItemIdentifier. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldItemIdentifierLocalServiceUtil
...
public interface IvldItemIdentifierLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IvldItemIdentifierLocalServiceUtil} to access the ivld item identifier local service. Add custom service methods to {@link com.stpl.app.parttwo.service.impl.IvldItemIdentifierLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
