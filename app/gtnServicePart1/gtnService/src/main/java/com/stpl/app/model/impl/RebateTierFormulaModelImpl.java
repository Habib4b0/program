 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link RebateTierFormulaModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link RebateTierFormulaImpl}.
 * </p>
 *
 * @author
...
public class RebateTierFormulaModelImpl extends BaseModelImpl<RebateTierFormula>
	...
	static {
		TABLE_COLUMNS_MAP.put("REBATE_TIER_FORMULA_NO", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("REBATE_TIER_FORMULA_NAME", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("REBATE_TIER_FORMULA_ID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("INBOUND_STATUS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("REBATE_TIER_FORMULA_SID", Types.INTEGER);
	}
	...
	private static final ClassLoader _classLoader = RebateTierFormula.class.getClassLoader();
