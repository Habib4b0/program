...
//                }
            ...
            LOGGER.info("insertQuery populate ...>>>>" + insertQuery.toString());
    ...
    public Object validateTempPSDeatils(String userId, String sessionId, String createdDate, String process, Object future1, Object future2, Object future3, Object future4) {
        ...
        try {
            ...
            if (process.equalsIgnoreCase("Price")) {
                sql.append("select item_No from dbo.Imtd_Ps_Details where (ps_Details_Price is null OR ps_Details_Price = '0') and ");
            }
    ...
    public Object getTempPSLazyList(String psId, String sessionId, String createdDate, String operation, Object future1, Object future2, Object future3, Object future4) {
     ...
     StringBuilder sql = new StringBuilder();
          try {
              ...
              sql.append( "PS_DETAILS_PRICE,PS_DETAILS_PRIC_PRTCN_EDDATE,PS_DETAILS_PRIC_PRTCN_STDATE,PS_MODEL_SID,");
              ...
              sql.append( "PS_MODEL_SID,OPERATION,PS_DETAILS_PRICETYPE, ipq.ITEM_PRICING_QUALIFIER_NAME as qualifiername,htolInt.DESCRIPTION as ");
              sql.append("tolinterval,htoltyp.DESCRIPTION as toltype,htolfrq.DESCRIPTION as tolfrequency, ITEM_ID, BRAND_MASTER_SID, PRICE_PROTECTION_STATUS, NEP, Status, MAX_INCREMENTAL_CHANGE, RESET_ELIGIBLE");
              ...
              sql.append(" FROM IMTD_PS_DETAILS ");
