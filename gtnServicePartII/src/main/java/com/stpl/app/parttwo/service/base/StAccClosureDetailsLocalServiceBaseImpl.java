...
import com.stpl.app.parttwo.service.StAccClosureDetailsLocalService;
...
/**
 * Provides the base implementation for the st acc closure details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.StAccClosureDetailsLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.StAccClosureDetailsLocalServiceImpl
 * @see com.stpl.app.parttwo.service.StAccClosureDetailsLocalServiceUtil
 * @generated
 */
public abstract class StAccClosureDetailsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements StAccClosureDetailsLocalService,
        IdentifiableBean {
    ...
    private StAccClosureDetailsLocalServiceClpInvoker _clpInvoker = new StAccClosureDetailsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.StAccClosureDetailsLocalServiceUtil} to access the st acc closure details local service.
     */
    ...
    @Override
    public StAccClosureDetails addStAccClosureDetails(
        StAccClosureDetails stAccClosureDetails) throws SystemException {
        stAccClosureDetails.setNew(true);

        return stAccClosureDetailsPersistence.update(stAccClosureDetails);
    }
     ...
     */
    @Override
    public StAccClosureDetails createStAccClosureDetails(
        int accClosureMasterSid) {
        return stAccClosureDetailsPersistence.create(accClosureMasterSid);
    }
    ...
    @Override
    public StAccClosureDetails deleteStAccClosureDetails(
        int accClosureMasterSid) throws PortalException, SystemException {
        return stAccClosureDetailsPersistence.remove(accClosureMasterSid);
    }
    ...
    public StAccClosureDetails deleteStAccClosureDetails(
        StAccClosureDetails stAccClosureDetails) throws SystemException {
        return stAccClosureDetailsPersistence.remove(stAccClosureDetails);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(StAccClosureDetails.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return stAccClosureDetailsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return stAccClosureDetailsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public StAccClosureDetails fetchStAccClosureDetails(int accClosureMasterSid)
        throws SystemException {
        return stAccClosureDetailsPersistence.fetchByPrimaryKey(accClosureMasterSid);
    }
     ...
     */
    @Override
    public StAccClosureDetails getStAccClosureDetails(int accClosureMasterSid)
        throws PortalException, SystemException {
        return stAccClosureDetailsPersistence.findByPrimaryKey(accClosureMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return stAccClosureDetailsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<StAccClosureDetails> getStAccClosureDetailses(int start, int end)
        throws SystemException {
        return stAccClosureDetailsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getStAccClosureDetailsesCount() throws SystemException {
        return stAccClosureDetailsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public StAccClosureDetails updateStAccClosureDetails(
        StAccClosureDetails stAccClosureDetails) throws SystemException {
        return stAccClosureDetailsPersistence.update(stAccClosureDetails);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.StAccClosureDetails",
            stAccClosureDetailsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.StAccClosureDetails");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = stAccClosureDetailsPersistence.getDataSource();
