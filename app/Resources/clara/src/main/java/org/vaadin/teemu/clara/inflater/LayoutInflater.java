...
public class LayoutInflater {
     ...
     * @throws LayoutInflaterException in case of an error in the inflation
     * process.
     */
     ...
     *
     * @param xml {@link InputStream} for the XML.
     * @param componentOverrideMap {@link Map} of already existing
     * {@link Component} instances from their {@code id} properties.
     * @return the inflated {@link Component} (hierarchy).
     * @throws LayoutInflaterException in case of an error in the inflation
     * process.
     */
     ...
     * @param componentProviders the {@link ComponentProvider}s to apply in
     * given order to inflate xml to components.
     * @return the inflated {@link Component} (hierarchy).
     * @throws LayoutInflaterException in case of an error in the inflation
     * process.
     */
    ...
    private class LayoutInflaterContentHandler extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName,
            ...
            if (uri.length() == 0 && v7Components.contains(localName)) {
                uri = DEFAULT_V7_NAMESPACE;
