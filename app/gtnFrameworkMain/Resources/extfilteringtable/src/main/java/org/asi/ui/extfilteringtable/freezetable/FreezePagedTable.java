...
/**
 * The Class FreezePagedTable.
 *
 * @author Abhiram
 */
public class FreezePagedTable extends HorizontalSplitPanel {
    ...
    /**
     * Instantiates a new freeze paged table.
     *
     * @param logic the logic
     */
    public FreezePagedTable(PageTableLogic logic) {
        this(null, logic);
    }
     ...
     * @param logic the logic
     */
    public FreezePagedTable(String caption, PageTableLogic logic) {
        super();
        setCaption(caption);
        this.logic = logic;
    ...
    public void constructLeftFreeze(boolean reConstruct){
        ...
        leftTable = new ExtPagedTable(this.logic);
    ...
    public void constructRightFreeze(boolean reConstruct){
        ...
        int pageLen = logic.getPageLength();
        int itemPerPage = logic.getItemsPerPage();
        rightTable = new ExtPagedTable(this.logic);
     ...
     */
    public ExtPagedTable getLeftFreezeAsTable(){
        return leftTable;
    }
     ...
     */
    public ExtPagedTable getRightFreezeAsTable(){
        return rightTable;
    }
