 ...
 * @generated
 */
public class VwAccrualMasterLocalServiceClp
    ...
    public VwAccrualMasterLocalServiceClp(
    ...
    public com.stpl.app.model.VwAccrualMaster addVwAccrualMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(vwAccrualMaster) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.VwAccrualMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.VwAccrualMaster createVwAccrualMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { accrualMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.VwAccrualMaster deleteVwAccrualMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { accrualMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.VwAccrualMaster fetchVwAccrualMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { accrualMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.VwAccrualMaster getVwAccrualMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { accrualMasterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.VwAccrualMaster> getVwAccrualMasters(
        ...
        return (java.util.List<com.stpl.app.model.VwAccrualMaster>) ClpSerializer.translateOutput(returnObj);
    }
