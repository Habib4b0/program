...
import com.stpl.app.parttwo.service.IvldCustomerGtsActualLocalService;
...
/**
 * Provides the base implementation for the ivld customer gts actual local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.IvldCustomerGtsActualLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.IvldCustomerGtsActualLocalServiceImpl
 * @see com.stpl.app.parttwo.service.IvldCustomerGtsActualLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldCustomerGtsActualLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldCustomerGtsActualLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldCustomerGtsActualLocalServiceUtil} to access the ivld customer gts actual local service.
	 */
	...
	@Override
	public IvldCustomerGtsActual addIvldCustomerGtsActual(
		IvldCustomerGtsActual ivldCustomerGtsActual) {
		ivldCustomerGtsActual.setNew(true);

		return ivldCustomerGtsActualPersistence.update(ivldCustomerGtsActual);
	}
	 ...
	 */
	@Override
	public IvldCustomerGtsActual createIvldCustomerGtsActual(
		int ivldCustomerGtsActualSid) {
		return ivldCustomerGtsActualPersistence.create(ivldCustomerGtsActualSid);
	}
	...
	@Override
	public IvldCustomerGtsActual deleteIvldCustomerGtsActual(
		int ivldCustomerGtsActualSid) throws PortalException {
		return ivldCustomerGtsActualPersistence.remove(ivldCustomerGtsActualSid);
	}
	...
	public IvldCustomerGtsActual deleteIvldCustomerGtsActual(
		IvldCustomerGtsActual ivldCustomerGtsActual) {
		return ivldCustomerGtsActualPersistence.remove(ivldCustomerGtsActual);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldCustomerGtsActual.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldCustomerGtsActualPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldCustomerGtsActualPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldCustomerGtsActual fetchIvldCustomerGtsActual(
		int ivldCustomerGtsActualSid) {
		return ivldCustomerGtsActualPersistence.fetchByPrimaryKey(ivldCustomerGtsActualSid);
	}
	 ...
	 */
	@Override
	public IvldCustomerGtsActual getIvldCustomerGtsActual(
		int ivldCustomerGtsActualSid) throws PortalException {
		return ivldCustomerGtsActualPersistence.findByPrimaryKey(ivldCustomerGtsActualSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldCustomerGtsActualLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldCustomerGtsActual.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldCustomerGtsActualLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldCustomerGtsActual.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldCustomerGtsActualLocalService.deleteIvldCustomerGtsActual((IvldCustomerGtsActual)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldCustomerGtsActualPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldCustomerGtsActual> getIvldCustomerGtsActuals(int start,
		int end) {
		return ivldCustomerGtsActualPersistence.findAll(start, end);
	}
	...
	public int getIvldCustomerGtsActualsCount() {
		return ivldCustomerGtsActualPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldCustomerGtsActual updateIvldCustomerGtsActual(
		IvldCustomerGtsActual ivldCustomerGtsActual) {
		return ivldCustomerGtsActualPersistence.update(ivldCustomerGtsActual);
	}
	 ...
	 */
	public IvldCustomerGtsActualLocalService getIvldCustomerGtsActualLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.IvldCustomerGtsActual",
			ivldCustomerGtsActualLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.parttwo.model.IvldCustomerGtsActual");
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldCustomerGtsActualLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldCustomerGtsActualPersistence.getDataSource();
	...
	@BeanReference(type = IvldCustomerGtsActualLocalService.class)
	protected IvldCustomerGtsActualLocalService ivldCustomerGtsActualLocalService;
