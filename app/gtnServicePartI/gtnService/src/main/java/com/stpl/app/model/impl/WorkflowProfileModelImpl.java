 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link WorkflowProfileModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link WorkflowProfileImpl}.
 * </p>
 *
 * @author
 * @see WorkflowProfileImpl
 * @see WorkflowProfile
 * @see WorkflowProfileModel
 * @generated
 */
@ProviderType
public class WorkflowProfileModelImpl extends BaseModelImpl<WorkflowProfile>
	...
	static {
		TABLE_COLUMNS_MAP.put("START_HOUR", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("FREQUENCY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PROCESS_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("START_MINUTES1", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("END_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("EMAIL_NOTIFICATION_FAILURE_CC", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("FAILURE_MAIL_SUBJECT", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("SCHEMA_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CREATED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CREATED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("SCHEDULE_LAST_RUN", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("EMAIL_NOTIFICATION_SUCCESS_TO", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("START_MINUTES3", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("START_MINUTES2", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("PROCESS_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("SUCCESS_MAIL_BODY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("INBOUND_STATUS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("EMAIL_NOTIFICATION_SUCCESS_CC", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("EMAIL_NOTIFICATION_FAILURE_TO", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("FAILURE_MAIL_BODY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ACTIVE_FLAG", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PROCESS_DISPLAY_NAME", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("START_MINUTES", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("MANUAL_LAST_RUN", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("START_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("SLA_CALENDAR_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("SUCCESS_MAIL_SUBJECT", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("START_HOUR3", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("START_HOUR2", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("USER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("START_HOUR1", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("PROCESS_TYPE", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("SCRIPT_NAME", Types.VARCHAR);
	}
	...
	private static final ClassLoader _classLoader = WorkflowProfile.class.getClassLoader();
