...
AS
  ...
  FROM  (SELECT DF.DEMAND_FORECAST_SID AS DEMAND_FORECAST_ACTUAL_SID,
                ...
                NULL                   AS IS_ACTIVE,
                1                      AS IS_FORECAST,
				 (select HELPER_TABLE_SID from HELPER_TABLE where list_name ='FORECAST_TYPE' and description='projections') as DEMAND_FORECAST_TYPE_SID
         ...
         SELECT DA.DEMAND_ACTUAL_SID,
                ...
                END             IS_ACTIVE,
                0               AS IS_FORECAST
				,(select HELPER_TABLE_SID from HELPER_TABLE where list_name ='FORECAST_TYPE' and description='Actuals') as DEMAND_FORECAST_TYPE_SID
