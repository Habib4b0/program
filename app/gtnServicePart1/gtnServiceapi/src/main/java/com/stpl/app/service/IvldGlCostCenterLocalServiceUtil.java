...
public class IvldGlCostCenterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<IvldGlCostCenterLocalService, IvldGlCostCenterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(IvldGlCostCenterLocalService.class);
}