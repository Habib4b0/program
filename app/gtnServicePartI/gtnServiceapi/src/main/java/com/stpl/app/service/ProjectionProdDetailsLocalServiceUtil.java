...
public class ProjectionProdDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<ProjectionProdDetailsLocalService, ProjectionProdDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ProjectionProdDetailsLocalService.class);
}