...
public class AdjustmentTab {
	...
	public void addAdjustmentTabLayout(List<GtnUIFrameworkComponentConfig> componentList, String nameSpace) {
		...
		GtnUIFrameworkComponentConfig adjustmentPanel = configProvider.getPanelConfig(nameSpace+"_" +"adjustmentPanel", false, null);
	...
	public void addTypeOptionGroup(List<GtnUIFrameworkComponentConfig> componentList, 
			String nameSpace) {
		GtnUIFrameworkComponentConfig typeOptionLayout = configProvider
				.getHorizontalLayoutConfig(nameSpace + "_" + "typeOptionLayout", true, nameSpace + GtnFrameworkScreenRegisteryConstants.ADJUSTMENT_TAB_PARENT_ID);
		...
		GtnUIFrameworkComponentConfig adjustmentTypeRadioGroup = configProvider.getUIFrameworkComponentConfig(
				nameSpace + "_" + "adjustmentType", true, typeOptionLayout.getComponentId(), GtnUIFrameworkComponentType.OPTIONGROUP);
		...
		adjustmentTypeRadioGroupConfig.setValuesFromService(Boolean.FALSE);
		adjustmentTypeRadioGroupConfig.setEnable(Boolean.TRUE);
		adjustmentTypeRadioGroup
	...
	public void addBasisOptionGroup(List<GtnUIFrameworkComponentConfig> componentList, 
			String nameSpace) {
		GtnUIFrameworkComponentConfig basisOptionLayout = configProvider
				.getHorizontalLayoutConfig(nameSpace + "_" + "basisOptionLayout", true,  nameSpace +GtnFrameworkScreenRegisteryConstants.ADJUSTMENT_TAB_PARENT_ID);
		...
		GtnUIFrameworkComponentConfig adjustmentBasisRadioGroup = configProvider.getUIFrameworkComponentConfig(
				nameSpace + "_" + "adjustmentBasis", true, basisOptionLayout.getComponentId(), GtnUIFrameworkComponentType.OPTIONGROUP);
		...
		adjustmentBasisRadioGroupConfig.setValuesFromService(Boolean.FALSE);
		adjustmentBasisRadioGroupConfig.setEnable(Boolean.TRUE);
		adjustmentBasisRadioGroup
				.setComponentStyle(Arrays.asList( GtnFrameworkCssConstants.HORIZONTAL_LOWER_CASE ));
	...
	public void addVariableOptionGroup(List<GtnUIFrameworkComponentConfig> componentList, 
			String nameSpace) {
		GtnUIFrameworkComponentConfig variableOptionLayout = configProvider
				.getHorizontalLayoutConfig(nameSpace + "_" + "variableOptionLayout", true,  nameSpace + GtnFrameworkScreenRegisteryConstants.ADJUSTMENT_TAB_PARENT_ID);
	...
	public void addAdjustmentTextBox(List<GtnUIFrameworkComponentConfig> componentList, 
			String nameSpace) {
		GtnUIFrameworkComponentConfig adjustmentLayout = configProvider
				.getHorizontalLayoutConfig(nameSpace + "_" + "adjustmentTextBox", true,  nameSpace + GtnFrameworkScreenRegisteryConstants.ADJUSTMENT_TAB_PARENT_ID);
		...
		GtnUIFrameworkComponentConfig adjustmentComboBox = configProvider.getUIFrameworkComponentConfig(
				nameSpace + "_" + "adjustment", true, adjustmentLayout.getComponentId(), GtnUIFrameworkComponentType.COMBOBOX_VAADIN8);
	...
	public void addAllocationMehodologyComboBox(List<GtnUIFrameworkComponentConfig> componentList,
			 String nameSpace) {
		GtnUIFrameworkComponentConfig allocationMehodologyLayout = configProvider
				.getHorizontalLayoutConfig(nameSpace + "_" + "allocationMehodologyLayout", true,  nameSpace + GtnFrameworkScreenRegisteryConstants.ADJUSTMENT_TAB_PARENT_ID);
	...
	public void addAdjustmentPeriodComboBox(List<GtnUIFrameworkComponentConfig> componentList,
			 String nameSpace) {
		GtnUIFrameworkComponentConfig adjustmentPeriodLayout = configProvider
				.getHorizontalLayoutConfig(nameSpace + "_" + "adjustmentPeriodLayout", true,  nameSpace + GtnFrameworkScreenRegisteryConstants.ADJUSTMENT_TAB_PARENT_ID);
	...
	public void addAdjustButton(List<GtnUIFrameworkComponentConfig> componentList, 
			String nameSpace) {
		GtnUIFrameworkComponentConfig adjustLayout = configProvider
				.getHorizontalLayoutConfig(nameSpace + "_" + "adjustLayout", true,  nameSpace + GtnFrameworkScreenRegisteryConstants.ADJUSTMENT_TAB_PARENT_ID);
		...
		GtnUIFrameworkComponentConfig adjustButton = configProvider.getUIFrameworkComponentConfig(
				nameSpace + "_" + "adjustButton", true, adjustLayout.getComponentId(), GtnUIFrameworkComponentType.BUTTON);
