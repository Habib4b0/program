...
import com.stpl.app.parttwo.service.VwItemPricingLocalService;
...
/**
 * Provides the base implementation for the vw item pricing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwItemPricingLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwItemPricingLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwItemPricingLocalServiceUtil
 * @generated
 */
public abstract class VwItemPricingLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements VwItemPricingLocalService,
        IdentifiableBean {
    ...
    private VwItemPricingLocalServiceClpInvoker _clpInvoker = new VwItemPricingLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwItemPricingLocalServiceUtil} to access the vw item pricing local service.
     */
    ...
    @Override
    public VwItemPricing addVwItemPricing(VwItemPricing vwItemPricing)
        throws SystemException {
        vwItemPricing.setNew(true);

        return vwItemPricingPersistence.update(vwItemPricing);
    }
     ...
     */
    @Override
    public VwItemPricing createVwItemPricing(int itemPricingSid) {
        return vwItemPricingPersistence.create(itemPricingSid);
    }
    ...
    @Override
    public VwItemPricing deleteVwItemPricing(int itemPricingSid)
        throws PortalException, SystemException {
        return vwItemPricingPersistence.remove(itemPricingSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public VwItemPricing deleteVwItemPricing(VwItemPricing vwItemPricing)
        throws SystemException {
        return vwItemPricingPersistence.remove(vwItemPricing);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(VwItemPricing.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwItemPricingPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwItemPricingPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public VwItemPricing fetchVwItemPricing(int itemPricingSid)
        throws SystemException {
        return vwItemPricingPersistence.fetchByPrimaryKey(itemPricingSid);
    }
     ...
     */
    @Override
    public VwItemPricing getVwItemPricing(int itemPricingSid)
        throws PortalException, SystemException {
        return vwItemPricingPersistence.findByPrimaryKey(itemPricingSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return vwItemPricingPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<VwItemPricing> getVwItemPricings(int start, int end)
        throws SystemException {
        return vwItemPricingPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getVwItemPricingsCount() throws SystemException {
        return vwItemPricingPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public VwItemPricing updateVwItemPricing(VwItemPricing vwItemPricing)
        throws SystemException {
        return vwItemPricingPersistence.update(vwItemPricing);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.VwItemPricing",
            vwItemPricingLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.VwItemPricing");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = vwItemPricingPersistence.getDataSource();
