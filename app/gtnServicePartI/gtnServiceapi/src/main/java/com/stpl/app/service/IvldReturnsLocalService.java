...
/**
 * Provides the local service interface for IvldReturns. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see IvldReturnsLocalServiceUtil
...
public interface IvldReturnsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IvldReturnsLocalServiceUtil} to access the ivld returns local service. Add custom service methods to {@link com.stpl.app.service.impl.IvldReturnsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public IvldReturns addIvldReturns(IvldReturns ivldReturns);
	...
	*/
	public IvldReturns createIvldReturns(int ivldReturnsSid);
	...
	*/
	...
	public IvldReturns deleteIvldReturns(int ivldReturnsSid)
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public IvldReturns deleteIvldReturns(IvldReturns ivldReturns);
	...
	*/
	...
	public IvldReturns fetchIvldReturns(int ivldReturnsSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public IvldReturns getIvldReturns(int ivldReturnsSid)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<IvldReturns> getIvldReturnses(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public IvldReturns updateIvldReturns(IvldReturns ivldReturns);
}