...
public class CustomerGtsForecastCacheModel implements CacheModel<CustomerGtsForecast>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CustomerGtsForecastCacheModel)) {
			return false;
		}

		CustomerGtsForecastCacheModel customerGtsForecastCacheModel = (CustomerGtsForecastCacheModel)obj;

		if (customerGtsForecastSid == customerGtsForecastCacheModel.customerGtsForecastSid) {
			return true;
		}
