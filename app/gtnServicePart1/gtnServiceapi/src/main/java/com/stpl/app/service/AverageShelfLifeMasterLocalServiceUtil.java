...
public class AverageShelfLifeMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<AverageShelfLifeMasterLocalService, AverageShelfLifeMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(AverageShelfLifeMasterLocalService.class);
}