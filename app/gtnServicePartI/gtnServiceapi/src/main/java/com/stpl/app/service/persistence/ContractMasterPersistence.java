...
/**
 * The persistence interface for the contract master service.
 *
 * <p>
 ...
 */
@ProviderType
public interface ContractMasterPersistence extends BasePersistence<ContractMaster> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContractMasterUtil} to access the contract master persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<ContractMaster> contractMasters);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ContractMaster> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ContractMaster> findAll();
	...
	*/
	public java.util.List<ContractMaster> findAll(int start, int end);
	...
	*/
	public java.util.List<ContractMaster> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ContractMaster> orderByComparator);
