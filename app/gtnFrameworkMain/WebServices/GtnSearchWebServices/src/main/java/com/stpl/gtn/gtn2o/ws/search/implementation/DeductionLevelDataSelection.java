 ...
 */
public class DeductionLevelDataSelection extends GtnCommonWebServiceImplClass implements SearchInterface {
    
    public DeductionLevelDataSelection()
    {
        super();
        initializeLogger();
    }
    ...
    public void initializeLogger() {
        super.logInformation(DeductionLevelDataSelection.class);
    }
    ...
    public GtnUIFrameworkWebserviceResponse getSearch(GtnGeneralSearchBean gtnGeneralSearchBean) {
        ...
        try {
            ...
            logger.debug("deduction level query:" + query);
            ...
            logger.error("Exception in deductionlevel" + e);
        }
        return response;
    }
