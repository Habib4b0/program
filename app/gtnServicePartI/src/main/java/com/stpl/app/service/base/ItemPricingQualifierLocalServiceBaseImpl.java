...
public abstract class ItemPricingQualifierLocalServiceBaseImpl
    ...
    private ItemPricingQualifierLocalServiceClpInvoker _clpInvoker = new ItemPricingQualifierLocalServiceClpInvoker();
    ...
    public ItemPricingQualifier deleteItemPricingQualifier(
        int itemPricingQualifierSid) throws PortalException, SystemException {
    ...
    public ItemPricingQualifier fetchItemPricingQualifier(
        int itemPricingQualifierSid) throws SystemException {
     ...
     */
    @Override
    public int getItemPricingQualifiersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.ItemPricingQualifier",
