...
public static final Logger LOGGER = Logger.getLogger(PromoteTpDAOImpl.class);
    ...
    public List getItems(String query) throws SystemException, Exception {
    ...
    public List getComponentInformation(String componentSelectionValue, String[] id) {
        ...
        if (REBATE_SCHEDULE.getConstant().equals(componentSelectionValue)) {
            ...
            query1 = " select RS.RS_ID, RS.RS_NO, RS.RS_NAME,HT.DESCRIPTION as RS_STATUS,RS.RS_START_DATE, RS.RS_END_DATE,  '' AS RAR_TYPE,RS.REBATE_FREQUENCY, RS.INTEREST_BEARING_BASIS "
                    ...
                    + " WHERE RS.CFP_CONTRACT_SID = " + id[0] + " and RS.IFP_CONTRACT_SID = " + id[1] + " and RS.PS_CONTRACT_SID = " + id[2] + " and RS.RS_CONTRACT_SID = " + id[3];
            ...
            query1 = "  select CFPM.CFP_ID,CFPM.CFP_NO,CFPM.CFP_NAME,HT.DESCRIPTION as CFP_STATUS,CPFC.CFP_START_DATE,CPFC.CFP_END_DATE,' ' as col1,' ' as col2, ' ' as col3   "
            ...
            query1 = "  select IFPM.IFP_ID,IFPM.IFP_NO,IFPM.IFP_NAME,(case when  HT.HELPER_TABLE_SID=0 then ' ' else HT.DESCRIPTION end) as IFP_STATUS,IFPC.IFP_START_DATE,IFPC.IFP_END_DATE ,' ' as col1,' ' as col2, ' ' as col3 "
            ...
            query1 = "    select PSM.PS_ID,PSM.PS_NO,PSM.PS_NAME,(case when  HT.HELPER_TABLE_SID=0 then ' ' else HT.DESCRIPTION end) as PS_STATUS,PSC.PS_START_DATE,PSC.PS_START_DATE,' ' as col1,' ' as col2, ' ' as col3  from PS_CONTRACT PSC "
                    + " join PS_MODEL PSM ON PSM.PS_MODEL_SID=PSC.PS_MODEL_SID "
                    + " JOIN HELPER_TABLE HT ON HT.HELPER_TABLE_SID=PSC.PS_STATUS WHERE "
                    + " PSC.CFP_CONTRACT_SID = " + id[0] + " and PSC.IFP_CONTRACT_SID = " + id[1] + " and PSC.PS_CONTRACT_SID = " + id[2];
            query2 = "Select IM.ITEM_NO, IM.ITEM_NAME, B.BRAND_NAME, HT.DESCRIPTION, \n"
                    ...
                    + " WHERE PS.CFP_CONTRACT_SID = " + id[0] + " and PS.IFP_CONTRACT_SID = " + id[1] + " and PS.PS_CONTRACT_SID = " + id[2];
        }
        String[] queries = new String[2];
        queries[0] = query1;
        queries[1] = query2;
