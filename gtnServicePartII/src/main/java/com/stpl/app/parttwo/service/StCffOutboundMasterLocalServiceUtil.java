...
public class StCffOutboundMasterLocalServiceUtil {
    private static StCffOutboundMasterLocalService _service;
    ...
    */
    ...
    public static StCffOutboundMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StCffOutboundMasterLocalService.class.getName());

            if (invokableLocalService instanceof StCffOutboundMasterLocalService) {
                _service = (StCffOutboundMasterLocalService) invokableLocalService;
            } else {
                _service = new StCffOutboundMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StCffOutboundMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StCffOutboundMasterLocalService service) {
    }
}
