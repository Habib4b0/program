 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldCpiModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldCpiImpl}.
 * </p>
 *
 * @author
 * @see IvldCpiImpl
...
public class IvldCpiModelImpl extends BaseModelImpl<IvldCpi>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("IVLD_CPI_SID", Types.INTEGER);
	...
	public Object clone() {
		...
		ivldCpiImpl.setCheckRecord(getCheckRecord());
	...
	public CacheModel<IvldCpi> toCacheModel() {
		...
		ivldCpiCacheModel.checkRecord = getCheckRecord();
	...
	private static final ClassLoader _classLoader = IvldCpi.class.getClassLoader();
