...
public class PSInfoTabForm extends CustomComponent implements View {
    ...
    /**
     * The price schedule status value.
     */
    final private TextField priceScheduleStatusValue = new TextField();

    /**
     * The price schedule type value.
     */
    final private TextField priceScheduleTypeValue = new TextField();

    /**
     * The price schedule designation value.
     */
    final private TextField priceScheduleDesignationValue = new TextField();

    /**
     * The price schedule category value.
     */
    final private TextField priceScheduleCategoryValue = new TextField();

    /**
     * The price schedule trade value.
     */
    final private TextField priceScheduleTradeValue = new TextField();

    /**
     * The parent flag sid.
     */
    final private TextField parentFlagSID = new TextField();
     ...
     */
    public PSInfoTabForm(final ErrorfulFieldGroup binder, final PSLogic psLogic, final ErrorLabel errorMsg, final PSDTO psMaster, Map<String, AppPermission> fieldPsHM
    , final String mode) throws SystemException,
            Exception {
    ...
    private void configureFields() throws SystemException, Exception {
        ...
        priceScheduleName.addValidator(new RegexpValidator(ValidationUtils.SPECIAL_CHAR, ValidationUtils.SPECIAL_CHAR_MSG));
        ...
        priceScheduleNo.addValidator(new RegexpValidator(ValidationUtils.SPECIAL_CHAR, ValidationUtils.SPECIAL_CHAR_MSG));
        ...
        priceScheduleId.addValidator(new RegexpValidator(ValidationUtils.SPECIAL_CHAR, ValidationUtils.SPECIAL_CHAR_MSG));
        ...
        parentPriceScheduleId.addClickListener(new CustomTextField.ClickListener() {
            ...
            public void click(CustomTextField.ClickEvent event) {
                try {
                    ...
                    int psSystemId = (priceScheduleSystemId.getValue() != null) ? Integer.parseInt(priceScheduleSystemId.getValue()) : 0;
                    if (lookUp == null) {
