 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldGlBalanceModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldGlBalanceImpl}.
 * </p>
 *
 * @author
...
public class IvldGlBalanceModelImpl extends BaseModelImpl<IvldGlBalance>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("INSERTED_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ERROR_FIELD", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("IVLD_GL_BALANCE_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("ERROR_CODE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("GL_BALANCE_INTFID", Types.VARCHAR);
	...
	private static final ClassLoader _classLoader = IvldGlBalance.class.getClassLoader();
