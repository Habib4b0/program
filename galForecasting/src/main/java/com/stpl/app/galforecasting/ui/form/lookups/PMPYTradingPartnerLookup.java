...
public class PMPYTradingPartnerLookup extends Window {
    ...
    private Panel addContract() {
        LOGGER.info("Entering addContract method");
        final Panel panel = new Panel();
        ...
        final GridLayout content = new GridLayout(2, 2);
        ...
        LOGGER.info("End of addContract method");
    ...
    public HorizontalLayout addFooterButton() {
        ...
        LOGGER.info("Entering addFooterButton method");
        ...
        LOGGER.info("End of addFooterButton method");
    ...
    private Button getSelectButton() {
        ...
        LOGGER.info("Entering getSelectButton method");
        ...
        LOGGER.info("End of getSelectButton method");
    ...
    private Button getResetButton() {
        ...
        LOGGER.info("Entering getResetButton method");
        ...
        LOGGER.info("End of getResetButton method");
    ...
    private static GridLayout addSpace() {
        ...
        gridLayout.addComponent(new Label(StringUtils.EMPTY));
    ...
    private HorizontalLayout addHeaderButton() {
        ...
        LOGGER.info("Entering addHeaderButton method");
        layout3.setSpacing(true);
        layout3.addComponent(searchTP);
        layout3.addComponent(resetTP);
        LOGGER.info("End of addHeaderButton method");
    ...
    private Panel addResultsTable() {
        ...
        LOGGER.info("Entering addResultsTable method");
        Panel panel = new Panel(Constant.RESULTS);

        resultsTableTP.setWidth(100, Sizeable.Unit.PERCENTAGE);
        ...
        resultsTableTP.setPageLength(6);
        panel.setContent(resultsTableTP);
        LOGGER.info("End of addResultsTable method");
