...
public class ItemGroupSearchMain extends VerticalLayout implements View {
     ...
     */
    public ItemGroupSearchMain(final SessionDTO sessionDTO) throws SystemException, PortalException {

        super();
        LOGGER.debug("ItemGroupSearchMain Constructor started ");
        setSpacing(true);
        ...
        LOGGER.debug("ItemGroupSearchMain Constructor Ended ");
    }
