 ...
 * @generated
 */
public class IvldGlCostCenterLocalServiceClp
    ...
    public IvldGlCostCenterLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addIvldGlCostCenter";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.IvldGlCostCenter"
            };

        _methodName1 = "createIvldGlCostCenter";

        _methodParameterTypes1 = new String[] { "int" };

        _methodName2 = "deleteIvldGlCostCenter";

        _methodParameterTypes2 = new String[] { "int" };

        _methodName3 = "deleteIvldGlCostCenter";
        ...
        _methodName10 = "fetchIvldGlCostCenter";

        _methodParameterTypes10 = new String[] { "int" };

        _methodName11 = "getIvldGlCostCenter";
        ...
        _methodName13 = "getIvldGlCostCenters";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getIvldGlCostCentersCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateIvldGlCostCenter";
    ...
    public com.stpl.app.model.IvldGlCostCenter addIvldGlCostCenter(
        ...
        return (com.stpl.app.model.IvldGlCostCenter) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.IvldGlCostCenter createIvldGlCostCenter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { ivldGlCostCenterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IvldGlCostCenter deleteIvldGlCostCenter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { ivldGlCostCenterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.IvldGlCostCenter fetchIvldGlCostCenter(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    ...
                    new Object[] { ivldGlCostCenterSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.IvldGlCostCenter> getIvldGlCostCenters(
        ...
        return (java.util.List<com.stpl.app.model.IvldGlCostCenter>) ClpSerializer.translateOutput(returnObj);
    }
