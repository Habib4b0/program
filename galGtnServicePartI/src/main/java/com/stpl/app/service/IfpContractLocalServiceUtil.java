...
public class IfpContractLocalServiceUtil {
    private static IfpContractLocalService _service;
    ...
    */
    ...
    public static IfpContractLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    IfpContractLocalService.class.getName());

            if (invokableLocalService instanceof IfpContractLocalService) {
                _service = (IfpContractLocalService) invokableLocalService;
            } else {
                _service = new IfpContractLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(IfpContractLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(IfpContractLocalService service) {
    }
}
