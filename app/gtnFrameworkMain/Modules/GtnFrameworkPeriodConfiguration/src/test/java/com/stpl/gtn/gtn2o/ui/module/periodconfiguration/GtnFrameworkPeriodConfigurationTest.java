...
import com.stpl.gtn.gtn2o.ui.module.periodconfiguration.dynamicclasses.GtnUIFrameworkPeriodConfigDynamicClassFillerTest;
...
public class GtnFrameworkPeriodConfigurationTest {


private transient GtnWSLogger gtnLogger = GtnWSLogger.getGTNLogger(GtnFrameworkPeriodConfigurationTest.class); 
	
	@Mock
	GtnUIFrameworkEngine gtnUIFrameworkEngine;
	@InjectMocks
	GtnFrameworkPeriodConfiguration instance;
    ...
    public void testInit() {
        ...
        GtnUIFrameworkPeriodConfigDynamicClassFiller fil = Mockito.mock(GtnUIFrameworkPeriodConfigDynamicClassFiller.class);
        ...
        PowerMockito.whenNew(GtnUIFrameworkPeriodConfigDynamicClassFiller.class).withNoArguments().thenReturn(fil);

        doNothing().when(engine).buildVaadinScreen(root, nav, request, ui, "Period Configuration", fil);
