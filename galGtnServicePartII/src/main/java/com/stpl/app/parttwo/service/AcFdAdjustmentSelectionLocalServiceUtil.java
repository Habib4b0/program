...
public class AcFdAdjustmentSelectionLocalServiceUtil {
    private static AcFdAdjustmentSelectionLocalService _service;
    ...
    */
    ...
    public static AcFdAdjustmentSelectionLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    AcFdAdjustmentSelectionLocalService.class.getName());

            if (invokableLocalService instanceof AcFdAdjustmentSelectionLocalService) {
                _service = (AcFdAdjustmentSelectionLocalService) invokableLocalService;
            } else {
                _service = new AcFdAdjustmentSelectionLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(AcFdAdjustmentSelectionLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(AcFdAdjustmentSelectionLocalService service) {
    }
}
