...
import com.stpl.app.parttwo.service.IvldCompanyTradeClassLocalService;
...
/**
 * Provides the base implementation for the ivld company trade class local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.IvldCompanyTradeClassLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.IvldCompanyTradeClassLocalServiceImpl
 * @see com.stpl.app.parttwo.service.IvldCompanyTradeClassLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class IvldCompanyTradeClassLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements IvldCompanyTradeClassLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldCompanyTradeClassLocalServiceUtil} to access the ivld company trade class local service.
	 */
	...
	@Override
	public IvldCompanyTradeClass addIvldCompanyTradeClass(
		IvldCompanyTradeClass ivldCompanyTradeClass) {
		ivldCompanyTradeClass.setNew(true);

		return ivldCompanyTradeClassPersistence.update(ivldCompanyTradeClass);
	}
	 ...
	 */
	@Override
	public IvldCompanyTradeClass createIvldCompanyTradeClass(
		int ivldCompanyTradeClassSid) {
		return ivldCompanyTradeClassPersistence.create(ivldCompanyTradeClassSid);
	}
	...
	@Override
	public IvldCompanyTradeClass deleteIvldCompanyTradeClass(
		int ivldCompanyTradeClassSid) throws PortalException {
		return ivldCompanyTradeClassPersistence.remove(ivldCompanyTradeClassSid);
	}
	...
	public IvldCompanyTradeClass deleteIvldCompanyTradeClass(
		IvldCompanyTradeClass ivldCompanyTradeClass) {
		return ivldCompanyTradeClassPersistence.remove(ivldCompanyTradeClass);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(IvldCompanyTradeClass.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ivldCompanyTradeClassPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ivldCompanyTradeClassPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public IvldCompanyTradeClass fetchIvldCompanyTradeClass(
		int ivldCompanyTradeClassSid) {
		return ivldCompanyTradeClassPersistence.fetchByPrimaryKey(ivldCompanyTradeClassSid);
	}
	 ...
	 */
	@Override
	public IvldCompanyTradeClass getIvldCompanyTradeClass(
		int ivldCompanyTradeClassSid) throws PortalException {
		return ivldCompanyTradeClassPersistence.findByPrimaryKey(ivldCompanyTradeClassSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ivldCompanyTradeClassLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(IvldCompanyTradeClass.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ivldCompanyTradeClassLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(IvldCompanyTradeClass.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ivldCompanyTradeClassLocalService.deleteIvldCompanyTradeClass((IvldCompanyTradeClass)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ivldCompanyTradeClassPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<IvldCompanyTradeClass> getIvldCompanyTradeClasses(int start,
		int end) {
		return ivldCompanyTradeClassPersistence.findAll(start, end);
	}
	...
	public int getIvldCompanyTradeClassesCount() {
		return ivldCompanyTradeClassPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IvldCompanyTradeClass updateIvldCompanyTradeClass(
		IvldCompanyTradeClass ivldCompanyTradeClass) {
		return ivldCompanyTradeClassPersistence.update(ivldCompanyTradeClass);
	}
	 ...
	 */
	public IvldCompanyTradeClassLocalService getIvldCompanyTradeClassLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.IvldCompanyTradeClass",
			ivldCompanyTradeClassLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return IvldCompanyTradeClassLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ivldCompanyTradeClassPersistence.getDataSource();
	...
	@BeanReference(type = IvldCompanyTradeClassLocalService.class)
	protected IvldCompanyTradeClassLocalService ivldCompanyTradeClassLocalService;
