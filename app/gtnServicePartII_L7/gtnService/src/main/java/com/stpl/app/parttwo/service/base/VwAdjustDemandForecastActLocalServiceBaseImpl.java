...
import com.stpl.app.parttwo.service.VwAdjustDemandForecastActLocalService;
...
/**
 * Provides the base implementation for the vw adjust demand forecast act local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwAdjustDemandForecastActLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwAdjustDemandForecastActLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwAdjustDemandForecastActLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VwAdjustDemandForecastActLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements VwAdjustDemandForecastActLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwAdjustDemandForecastActLocalServiceUtil} to access the vw adjust demand forecast act local service.
	 */
	...
	@Override
	public VwAdjustDemandForecastAct addVwAdjustDemandForecastAct(
		VwAdjustDemandForecastAct vwAdjustDemandForecastAct) {
		vwAdjustDemandForecastAct.setNew(true);

		return vwAdjustDemandForecastActPersistence.update(vwAdjustDemandForecastAct);
	}
	 ...
	 */
	@Override
	public VwAdjustDemandForecastAct createVwAdjustDemandForecastAct(
		int adjustedDemandForecastId) {
		return vwAdjustDemandForecastActPersistence.create(adjustedDemandForecastId);
	}
	...
	@Override
	public VwAdjustDemandForecastAct deleteVwAdjustDemandForecastAct(
		int adjustedDemandForecastId) throws PortalException {
		return vwAdjustDemandForecastActPersistence.remove(adjustedDemandForecastId);
	}
	...
	public VwAdjustDemandForecastAct deleteVwAdjustDemandForecastAct(
		VwAdjustDemandForecastAct vwAdjustDemandForecastAct) {
		return vwAdjustDemandForecastActPersistence.remove(vwAdjustDemandForecastAct);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VwAdjustDemandForecastAct.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vwAdjustDemandForecastActPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vwAdjustDemandForecastActPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VwAdjustDemandForecastAct fetchVwAdjustDemandForecastAct(
		int adjustedDemandForecastId) {
		return vwAdjustDemandForecastActPersistence.fetchByPrimaryKey(adjustedDemandForecastId);
	}
	 ...
	 */
	@Override
	public VwAdjustDemandForecastAct getVwAdjustDemandForecastAct(
		int adjustedDemandForecastId) throws PortalException {
		return vwAdjustDemandForecastActPersistence.findByPrimaryKey(adjustedDemandForecastId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vwAdjustDemandForecastActLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VwAdjustDemandForecastAct.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vwAdjustDemandForecastActLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VwAdjustDemandForecastAct.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vwAdjustDemandForecastActLocalService.deleteVwAdjustDemandForecastAct((VwAdjustDemandForecastAct)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vwAdjustDemandForecastActPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VwAdjustDemandForecastAct> getVwAdjustDemandForecastActs(
		int start, int end) {
		return vwAdjustDemandForecastActPersistence.findAll(start, end);
	}
	...
	public int getVwAdjustDemandForecastActsCount() {
		return vwAdjustDemandForecastActPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VwAdjustDemandForecastAct updateVwAdjustDemandForecastAct(
		VwAdjustDemandForecastAct vwAdjustDemandForecastAct) {
		return vwAdjustDemandForecastActPersistence.update(vwAdjustDemandForecastAct);
	}
	 ...
	 */
	public VwAdjustDemandForecastActLocalService getVwAdjustDemandForecastActLocalService() {
	...
	/**
	 * Returns the vwcompany identifier local service.
	 *
	 * @return the vwcompany identifier local service
	 */
	...
	/**
	 * Sets the vwcompany identifier local service.
	 *
	 * @param vwcompanyIdentifierLocalService the vwcompany identifier local service
	 */
	...
	/**
	 * Returns the vwcompany identifier persistence.
	 *
	 * @return the vwcompany identifier persistence
	 */
	...
	/**
	 * Sets the vwcompany identifier persistence.
	 *
	 * @param vwcompanyIdentifierPersistence the vwcompany identifier persistence
	 */
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.VwAdjustDemandForecastAct",
			vwAdjustDemandForecastActLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VwAdjustDemandForecastActLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vwAdjustDemandForecastActPersistence.getDataSource();
	...
	@BeanReference(type = VwAdjustDemandForecastActLocalService.class)
	protected VwAdjustDemandForecastActLocalService vwAdjustDemandForecastActLocalService;
