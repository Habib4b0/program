 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.stpl.app.model.ProjectionNameConfigModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ProjectionNameConfigImpl}.
 * </p>
 *
 * @author
 * @see ProjectionNameConfigImpl
 * @see com.stpl.app.model.ProjectionNameConfig
 * @see com.stpl.app.model.ProjectionNameConfigModel
 * @generated
 */
public class ProjectionNameConfigModelImpl extends BaseModelImpl<ProjectionNameConfig>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a projection name config model instance should use the {@link com.stpl.app.model.ProjectionNameConfig} interface instead.
     */
    ...
    private static ClassLoader _classLoader = ProjectionNameConfig.class.getClassLoader();
