...
import com.stpl.app.parttwo.service.CffAdditionalInfoLocalService;
...
/**
 * Provides the base implementation for the cff additional info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.CffAdditionalInfoLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.CffAdditionalInfoLocalServiceImpl
 * @see com.stpl.app.parttwo.service.CffAdditionalInfoLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class CffAdditionalInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CffAdditionalInfoLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.CffAdditionalInfoLocalServiceUtil} to access the cff additional info local service.
	 */
	...
	public CffAdditionalInfo addCffAdditionalInfo(
		...
		return cffAdditionalInfoPersistence.update(cffAdditionalInfo);
	}
	...
	public CffAdditionalInfo createCffAdditionalInfo(int cffAdditionalInfoSid) {
		return cffAdditionalInfoPersistence.create(cffAdditionalInfoSid);
	}
	...
	public CffAdditionalInfo deleteCffAdditionalInfo(int cffAdditionalInfoSid)
		...
		return cffAdditionalInfoPersistence.remove(cffAdditionalInfoSid);
	}
	...
	public CffAdditionalInfo deleteCffAdditionalInfo(
		CffAdditionalInfo cffAdditionalInfo) {
		return cffAdditionalInfoPersistence.remove(cffAdditionalInfo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CffAdditionalInfo.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cffAdditionalInfoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cffAdditionalInfoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CffAdditionalInfo fetchCffAdditionalInfo(int cffAdditionalInfoSid) {
		return cffAdditionalInfoPersistence.fetchByPrimaryKey(cffAdditionalInfoSid);
	}
	...
	public CffAdditionalInfo getCffAdditionalInfo(int cffAdditionalInfoSid)
		throws PortalException {
		return cffAdditionalInfoPersistence.findByPrimaryKey(cffAdditionalInfoSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cffAdditionalInfoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CffAdditionalInfo.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("cffAdditionalInfoSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(cffAdditionalInfoLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CffAdditionalInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return cffAdditionalInfoLocalService.deleteCffAdditionalInfo((CffAdditionalInfo)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return cffAdditionalInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CffAdditionalInfo> getCffAdditionalInfos(int start, int end) {
		return cffAdditionalInfoPersistence.findAll(start, end);
	}
	...
	public int getCffAdditionalInfosCount() {
		return cffAdditionalInfoPersistence.countAll();
	}
	 ...
	 */
	public CffAdditionalInfoLocalService getCffAdditionalInfoLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.parttwo.model.CffAdditionalInfo",
			cffAdditionalInfoLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CffAdditionalInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cffAdditionalInfoPersistence.getDataSource();
	...
	@BeanReference(type = CffAdditionalInfoLocalService.class)
	protected CffAdditionalInfoLocalService cffAdditionalInfoLocalService;
