...
import com.stpl.app.parttwo.service.IvldItemPricingLocalService;
...
/**
 * Provides the base implementation for the ivld item pricing local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.IvldItemPricingLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.IvldItemPricingLocalServiceImpl
 * @see com.stpl.app.parttwo.service.IvldItemPricingLocalServiceUtil
 * @generated
 */
public abstract class IvldItemPricingLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements IvldItemPricingLocalService,
        IdentifiableBean {
    ...
    private IvldItemPricingLocalServiceClpInvoker _clpInvoker = new IvldItemPricingLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.IvldItemPricingLocalServiceUtil} to access the ivld item pricing local service.
     */
    ...
    public IvldItemPricing addIvldItemPricing(IvldItemPricing ivldItemPricing)
        ...
        return ivldItemPricingPersistence.update(ivldItemPricing);
    }
    ...
    public IvldItemPricing createIvldItemPricing(int ivldItemPricingSid) {
        return ivldItemPricingPersistence.create(ivldItemPricingSid);
    }
    ...
    public IvldItemPricing deleteIvldItemPricing(int ivldItemPricingSid)
        ...
        return ivldItemPricingPersistence.remove(ivldItemPricingSid);
    }
    ...
    public IvldItemPricing deleteIvldItemPricing(
        IvldItemPricing ivldItemPricing) throws SystemException {
        return ivldItemPricingPersistence.remove(ivldItemPricing);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IvldItemPricing.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldItemPricingPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return ivldItemPricingPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public IvldItemPricing fetchIvldItemPricing(int ivldItemPricingSid)
        throws SystemException {
        return ivldItemPricingPersistence.fetchByPrimaryKey(ivldItemPricingSid);
    }
    ...
    public IvldItemPricing getIvldItemPricing(int ivldItemPricingSid)
        throws PortalException, SystemException {
        return ivldItemPricingPersistence.findByPrimaryKey(ivldItemPricingSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return ivldItemPricingPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public List<IvldItemPricing> getIvldItemPricings(int start, int end)
        throws SystemException {
        return ivldItemPricingPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIvldItemPricingsCount() throws SystemException {
        return ivldItemPricingPersistence.countAll();
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.IvldItemPricing",
            ivldItemPricingLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.IvldItemPricing");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = ivldItemPricingPersistence.getDataSource();
