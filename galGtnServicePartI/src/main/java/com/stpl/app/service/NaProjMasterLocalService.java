...
/**
 * Provides the local service interface for NaProjMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see NaProjMasterLocalServiceUtil
...
public interface NaProjMasterLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link NaProjMasterLocalServiceUtil} to access the na proj master local service. Add custom service methods to {@link com.stpl.app.service.impl.NaProjMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
