...
public class CdrModelLocalServiceUtil {
    private static CdrModelLocalService _service;
    ...
    */
    ...
    public static CdrModelLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    CdrModelLocalService.class.getName());

            if (invokableLocalService instanceof CdrModelLocalService) {
                _service = (CdrModelLocalService) invokableLocalService;
            } else {
                _service = new CdrModelLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(CdrModelLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(CdrModelLocalService service) {
    }
}
