...
import com.stpl.app.service.ChActualSalesLocalService;
...
/**
 * Provides the base implementation for the ch actual sales local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ChActualSalesLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ChActualSalesLocalServiceImpl
 * @see com.stpl.app.service.ChActualSalesLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ChActualSalesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ChActualSalesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ChActualSalesLocalServiceUtil} to access the ch actual sales local service.
	 */
	...
	@Override
	public ChActualSales addChActualSales(ChActualSales chActualSales) {
		chActualSales.setNew(true);

		return chActualSalesPersistence.update(chActualSales);
	}
	 ...
	 */
	@Override
	public ChActualSales createChActualSales(ChActualSalesPK chActualSalesPK) {
		return chActualSalesPersistence.create(chActualSalesPK);
	}
	...
	@Override
	public ChActualSales deleteChActualSales(ChActualSalesPK chActualSalesPK)
		throws PortalException {
		return chActualSalesPersistence.remove(chActualSalesPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ChActualSales deleteChActualSales(ChActualSales chActualSales) {
		return chActualSalesPersistence.remove(chActualSales);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ChActualSales.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return chActualSalesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return chActualSalesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ChActualSales fetchChActualSales(ChActualSalesPK chActualSalesPK) {
		return chActualSalesPersistence.fetchByPrimaryKey(chActualSalesPK);
	}
	 ...
	 */
	@Override
	public ChActualSales getChActualSales(ChActualSalesPK chActualSalesPK)
		throws PortalException {
		return chActualSalesPersistence.findByPrimaryKey(chActualSalesPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(chActualSalesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ChActualSales.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(chActualSalesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ChActualSales.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return chActualSalesLocalService.deleteChActualSales((ChActualSales)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return chActualSalesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ChActualSales> getChActualSaleses(int start, int end) {
		return chActualSalesPersistence.findAll(start, end);
	}
	...
	public int getChActualSalesesCount() {
		return chActualSalesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ChActualSales updateChActualSales(ChActualSales chActualSales) {
		return chActualSalesPersistence.update(chActualSales);
	}
	 ...
	 */
	public ChActualSalesLocalService getChActualSalesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ChActualSales",
			chActualSalesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ChActualSales");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ChActualSalesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = chActualSalesPersistence.getDataSource();
	...
	@BeanReference(type = ChActualSalesLocalService.class)
	protected ChActualSalesLocalService chActualSalesLocalService;
