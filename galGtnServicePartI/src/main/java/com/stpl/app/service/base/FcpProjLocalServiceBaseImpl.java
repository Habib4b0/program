...
public abstract class FcpProjLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements FcpProjLocalService, IdentifiableBean {
    ...
    private FcpProjLocalServiceClpInvoker _clpInvoker = new FcpProjLocalServiceClpInvoker();
    ...
    @Override
    public FcpProj addFcpProj(FcpProj fcpProj) throws SystemException {
        fcpProj.setNew(true);
    ...
    @Override
    public FcpProj deleteFcpProj(FcpProjPK fcpProjPK)
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public FcpProj deleteFcpProj(FcpProj fcpProj) throws SystemException {
    ...
    @Override
    public FcpProj fetchFcpProj(FcpProjPK fcpProjPK) throws SystemException {
     ...
     */
    @Override
    public FcpProj getFcpProj(FcpProjPK fcpProjPK)
        throws PortalException, SystemException {
     ...
     */
    @Override
    public int getFcpProjsCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public FcpProj updateFcpProj(FcpProj fcpProj) throws SystemException {
        return fcpProjPersistence.update(fcpProj);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.FcpProj",
            fcpProjLocalService);
    }
