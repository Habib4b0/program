...
public class ModuleSubmoduleMasterLocalServiceUtil {
    private static ModuleSubmoduleMasterLocalService _service;
    ...
    */
    ...
    public static ModuleSubmoduleMasterLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ModuleSubmoduleMasterLocalService.class.getName());

            if (invokableLocalService instanceof ModuleSubmoduleMasterLocalService) {
                _service = (ModuleSubmoduleMasterLocalService) invokableLocalService;
            } else {
                _service = new ModuleSubmoduleMasterLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ModuleSubmoduleMasterLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ModuleSubmoduleMasterLocalService service) {
    }
}
