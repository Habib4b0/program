...
import com.stpl.app.service.WfMailConfigLocalService;
...
/**
 * Provides the base implementation for the wf mail config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.WfMailConfigLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.WfMailConfigLocalServiceImpl
 * @see com.stpl.app.service.WfMailConfigLocalServiceUtil
 * @generated
 */
public abstract class WfMailConfigLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements WfMailConfigLocalService,
        IdentifiableBean {
    ...
    private WfMailConfigLocalServiceClpInvoker _clpInvoker = new WfMailConfigLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.WfMailConfigLocalServiceUtil} to access the wf mail config local service.
     */
    ...
    @Override
    public WfMailConfig addWfMailConfig(WfMailConfig wfMailConfig)
        throws SystemException {
        wfMailConfig.setNew(true);

        return wfMailConfigPersistence.update(wfMailConfig);
    }
     ...
     */
    @Override
    public WfMailConfig createWfMailConfig(int wfMailConfigSid) {
        return wfMailConfigPersistence.create(wfMailConfigSid);
    }
    ...
    @Override
    public WfMailConfig deleteWfMailConfig(int wfMailConfigSid)
        throws PortalException, SystemException {
        return wfMailConfigPersistence.remove(wfMailConfigSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public WfMailConfig deleteWfMailConfig(WfMailConfig wfMailConfig)
        throws SystemException {
        return wfMailConfigPersistence.remove(wfMailConfig);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(WfMailConfig.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return wfMailConfigPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return wfMailConfigPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public WfMailConfig fetchWfMailConfig(int wfMailConfigSid)
        throws SystemException {
        return wfMailConfigPersistence.fetchByPrimaryKey(wfMailConfigSid);
    }
     ...
     */
    @Override
    public WfMailConfig getWfMailConfig(int wfMailConfigSid)
        throws PortalException, SystemException {
        return wfMailConfigPersistence.findByPrimaryKey(wfMailConfigSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return wfMailConfigPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<WfMailConfig> getWfMailConfigs(int start, int end)
        throws SystemException {
        return wfMailConfigPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getWfMailConfigsCount() throws SystemException {
        return wfMailConfigPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public WfMailConfig updateWfMailConfig(WfMailConfig wfMailConfig)
        throws SystemException {
        return wfMailConfigPersistence.update(wfMailConfig);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.WfMailConfig",
            wfMailConfigLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.WfMailConfig");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = wfMailConfigPersistence.getDataSource();
