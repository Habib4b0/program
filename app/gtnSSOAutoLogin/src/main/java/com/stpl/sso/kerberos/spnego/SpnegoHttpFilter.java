 ...
 *
 * <p>
 * < pre> &lt;html&gt; &lt;head&gt; &lt;title&gt;Hello SPNEGO
 * Example&lt;/title&gt; &lt;/head&gt; &lt;body&gt; Hello &lt;%=
 * request.getRemoteUser() %&gt; ! &lt;/body&gt; &lt;/html&gt;
 * </pre>
 * </p>
 *
 * <p>
...
public final class SpnegoHttpFilter implements Filter {
	...
	public void init(final FilterConfig filterConfig) throws ServletException {
		// initiateSystemPropertiesManually();
		StplConfigReader reader = StplConfigReader.getInstance();
		try {
	...
	public SpnegoPrincipal getPrincipal(final ServletRequest request, final ServletResponse response)
	...
	/**
	 * Defines constants and parameter names that are used in the web.xml file,
	 * and HTTP request headers, etc.
	 *
	 * <p>
	...
	public static final class Constants {
		 ...
		 *
		 * <p>
		 * Set this value to <code>true</code> in web.xml if the filter should
		 * allow Basic Authentication.
		 * </p>
		 *
		 * <p>
		 * It is recommended that you only allow Basic Authentication if you
		 * have clients that cannot perform Kerberos authentication. Also, you
		 * should consider requiring SSL/TLS by setting
		 ...
		 *
		 * <p>
		 * Set this value to <code>true</code> if server should support
		 * credential delegation requests.
		 * </p>
		 *
		 * <p>
		 * Take a look at the {@link DelegateServletRequest} for more
		 ...
		 *
		 * <p>
		 * Flag to indicate if requests coming from http://localhost or
		 * http://127.0.0.1 should not be authenticated using Kerberos.
		 * </p>
		 *
		 * <p>
		...
		/**
		 * Servlet init param name in web.xml
		 * <b>spnego.allow.unsecure.basic</b>.
		 *
		 * <p>
		 * Set this value to <code>false</code> in web.xml if the filter should
		 * reject connections that do not use SSL/TLS.
		 * </p>
		 */
		 ...
		 *
		 * <p>
		 * The filter will respond with this header with a value of "Basic"
		 ...
		 *
		 * <p>
		 * The filter will set this as the value for the "WWW-Authenticate"
		 ...
		 * sometimes be named krb5.ini and reside
		 * <code>%WINDOWS_ROOT%/krb5.ini</code> here.
		 * </p>
		 *
		 * <p>
		 ...
		 * <p>
		 * The filter will set this as the value for the "WWW-Authenticate"
		 * header. Note that the filter may also add another header with a value
		 * of "Basic" (if allowed by the web.xml file).
		 * </p>
		 */
		 ...
		 *
		 * <p>
		 * Network Domain username. For Windows, this is sometimes known as the
		 * Windows NT username.
		 * </p>
		 */
		 ...
		 * and with Basic as the only option (no Negotiate)
		 * <b>spnego.prompt.ntlm</b>.
		 */
