...
import com.stpl.app.service.RsModelLocalService;
...
/**
 * Provides the base implementation for the rs model local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.RsModelLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 */
@ProviderType
public abstract class RsModelLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements RsModelLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.RsModelLocalServiceUtil} to access the rs model local service.
	 */
	...
	public RsModel addRsModel(RsModel rsModel) {
		...
		return rsModelPersistence.update(rsModel);
	}
	...
	public RsModel createRsModel(int rsModelSid) {
		return rsModelPersistence.create(rsModelSid);
	}
	...
	public RsModel deleteRsModel(int rsModelSid) throws PortalException {
		return rsModelPersistence.remove(rsModelSid);
	}
	...
	public RsModel deleteRsModel(RsModel rsModel) {
		return rsModelPersistence.remove(rsModel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RsModel.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return rsModelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return rsModelPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return rsModelPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return rsModelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return rsModelPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public RsModel fetchRsModel(int rsModelSid) {
		return rsModelPersistence.fetchByPrimaryKey(rsModelSid);
	}
	...
	public RsModel getRsModel(int rsModelSid) throws PortalException {
		return rsModelPersistence.findByPrimaryKey(rsModelSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(rsModelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RsModel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("rsModelSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(rsModelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RsModel.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("rsModelSid");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return rsModelLocalService.deleteRsModel((RsModel)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return rsModelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<RsModel> getRsModels(int start, int end) {
		return rsModelPersistence.findAll(start, end);
	}
	...
	public int getRsModelsCount() {
		return rsModelPersistence.countAll();
	}
	 ...
	 */
	public RsModelLocalService getRsModelLocalService() {
	 ...
	 */
	public void setRsModelLocalService(RsModelLocalService rsModelLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.RsModel",
			rsModelLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.RsModel");
	}
	...
	public String getOSGiServiceIdentifier() {
		return RsModelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rsModelPersistence.getDataSource();
	...
	@BeanReference(type = RsModelLocalService.class)
	protected RsModelLocalService rsModelLocalService;
