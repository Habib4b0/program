...
public class GtnUIFrameworkConfirmedCopyAction implements GtnUIFrameWorkAction,GtnUIFrameworkDynamicClass{
    ...
    public void doAction(String componentId, GtnUIFrameWorkActionConfig gtnUIFrameWorkActionConfig) throws GtnFrameworkGeneralException {
        ...
        Object value = GtnUIFrameworkGlobalUI.getVaadinBaseComponent(gtnUIFrameWorkActionConfig.getActionParameterList().get(1).toString()).getValueFromComponent();
        if(value == null){
            GtnUIFrameWorkActionConfig alertActionConfig = new GtnUIFrameWorkActionConfig(GtnUIFrameworkActionType.INFO_ACTION);
        ...
        GtnUIFrameWorkActionConfig confirmationActionConfig = new GtnUIFrameWorkActionConfig(GtnUIFrameworkActionType.CONFIRMATION_ACTION);
        confirmationActionConfig.addActionParameter(parameters.get(18));
        confirmationActionConfig.addActionParameter(parameters.get(19)+" "+gtnWsRecordBean.getStringPropertyByIndex(0)+ "?");
