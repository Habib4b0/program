...
public class AccrualRateChart {
     ...
     * The Constant LOGGER.
     */
    private static final Logger LOGGER = Logger.getLogger(AccrualRateChart.class);
     ...
     */
    public AccrualRateChart(int proId) {
        LOGGER.info("Entering AccrualRateChart method ");
        this.proId=proId;
        this.projType=projType;
//        this.dto = dto;
//        this.rightDto = rightDto;
        LOGGER.info("End of AccrualRateChart method ");
    }
...
//        tooltip.setPointFormat("$ {point.y:%.2f}");
    ...
    public Component configureFields() {
        ...
        List finalList = logic.getAccrualRateData(proId);
