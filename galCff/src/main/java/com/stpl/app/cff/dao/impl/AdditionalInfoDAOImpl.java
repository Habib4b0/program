...
public class AdditionalInfoDAOImpl implements AdditionalInfoDAO{
     ...
     */
    @Override
    public void saveNotes(final CffAdditionalInfo additionalNotesList) throws SystemException, Exception {
     ...
     */
    @Override
    public void addCffDocDetails(final CffDocDetails docDetails) throws SystemException, Exception {
     ...
     */
    @Override
    public void updateCffDocDetails(final CffDocDetails docDetails) throws SystemException, Exception {
     ...
     */
    @Override
    public void deleteCffDocDetails(final int docDetailsId) throws SystemException, PortalException, Exception {
