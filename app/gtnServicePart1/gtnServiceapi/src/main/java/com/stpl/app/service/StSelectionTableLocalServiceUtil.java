...
public class StSelectionTableLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<StSelectionTableLocalService, StSelectionTableLocalService> _serviceTracker =
		ServiceTrackerFactory.open(StSelectionTableLocalService.class);
}