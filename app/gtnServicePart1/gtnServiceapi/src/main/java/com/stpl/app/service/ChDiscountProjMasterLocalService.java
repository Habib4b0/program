...
/**
 * Provides the local service interface for ChDiscountProjMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see ChDiscountProjMasterLocalServiceUtil
...
public interface ChDiscountProjMasterLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChDiscountProjMasterLocalServiceUtil} to access the ch discount proj master local service. Add custom service methods to {@link com.stpl.app.service.impl.ChDiscountProjMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
