...
public final class ParentLookUp extends Window {
    ...
    public ParentLookUp() {
        ...
        try {
            ...
            LOGGER.error(e);
            LOGGER.info("Unable to load the parent lookup :");
        }
    ...
    private void addTable() {
        ...
        parentLookUpTableLogic.setPageLength(10);
    ...
    protected void configureFields() throws SystemException, Exception {
        ...
        LOGGER.info("In configureFields lodding-RebateScheduleType Dblb ListType=" + GeneralCommonUtils.REBATE_SCHEDULE_TYPE);
        ...
        searchBtn.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                try {
                    LOGGER.info("Entering ParetnLookUp Search operation");
                    try {
                        binder.commit();
                    ...
                    LOGGER.info("Ending ParetnLookUp Search operation");
                } catch (Exception e) {
                    LOGGER.error(e);
                }
            }
        ...
        resetBtn.addClickListener(new ClickListener() {
             ...
             */
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("Entering ParetnLookUp Reset operation");
                ...
                LOGGER.info("Ending ParetnLookUp Reset operation");
            }
        });
        selectBtn.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                ...
                LOGGER.info("Ending Payment RS ID SELECT  method ");
            }
        });
    }
