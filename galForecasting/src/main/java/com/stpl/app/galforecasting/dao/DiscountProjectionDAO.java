...
public interface DiscountProjectionDAO {
     ...
     * @return
     */
//    List loadLevels(int projectionId, String hierarchyIndicator, int startLevelNo, int endLevelNo, int customId, String relationshipBuilderSid, boolean isCustomHierarchy, boolean isLevelFilter);
