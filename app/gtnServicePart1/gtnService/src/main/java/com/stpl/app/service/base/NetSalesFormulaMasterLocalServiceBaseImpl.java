...
import com.stpl.app.service.NetSalesFormulaMasterLocalService;
...
/**
 * Provides the base implementation for the net sales formula master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.NetSalesFormulaMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.NetSalesFormulaMasterLocalServiceImpl
 * @see com.stpl.app.service.NetSalesFormulaMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class NetSalesFormulaMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NetSalesFormulaMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.NetSalesFormulaMasterLocalServiceUtil} to access the net sales formula master local service.
	 */
	...
	@Override
	public NetSalesFormulaMaster addNetSalesFormulaMaster(
		NetSalesFormulaMaster netSalesFormulaMaster) {
		netSalesFormulaMaster.setNew(true);

		return netSalesFormulaMasterPersistence.update(netSalesFormulaMaster);
	}
	 ...
	 */
	@Override
	public NetSalesFormulaMaster createNetSalesFormulaMaster(
		int netSalesFormulaMasterSid) {
		return netSalesFormulaMasterPersistence.create(netSalesFormulaMasterSid);
	}
	...
	@Override
	public NetSalesFormulaMaster deleteNetSalesFormulaMaster(
		int netSalesFormulaMasterSid) throws PortalException {
		return netSalesFormulaMasterPersistence.remove(netSalesFormulaMasterSid);
	}
	...
	public NetSalesFormulaMaster deleteNetSalesFormulaMaster(
		NetSalesFormulaMaster netSalesFormulaMaster) {
		return netSalesFormulaMasterPersistence.remove(netSalesFormulaMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NetSalesFormulaMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return netSalesFormulaMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return netSalesFormulaMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public NetSalesFormulaMaster fetchNetSalesFormulaMaster(
		int netSalesFormulaMasterSid) {
		return netSalesFormulaMasterPersistence.fetchByPrimaryKey(netSalesFormulaMasterSid);
	}
	...
	public NetSalesFormulaMaster getNetSalesFormulaMaster(
		int netSalesFormulaMasterSid) throws PortalException {
		return netSalesFormulaMasterPersistence.findByPrimaryKey(netSalesFormulaMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(netSalesFormulaMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NetSalesFormulaMaster.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(netSalesFormulaMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NetSalesFormulaMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return netSalesFormulaMasterLocalService.deleteNetSalesFormulaMaster((NetSalesFormulaMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return netSalesFormulaMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<NetSalesFormulaMaster> getNetSalesFormulaMasters(int start,
		int end) {
		return netSalesFormulaMasterPersistence.findAll(start, end);
	}
	...
	public int getNetSalesFormulaMastersCount() {
		return netSalesFormulaMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public NetSalesFormulaMaster updateNetSalesFormulaMaster(
		NetSalesFormulaMaster netSalesFormulaMaster) {
		return netSalesFormulaMasterPersistence.update(netSalesFormulaMaster);
	}
	 ...
	 */
	public NetSalesFormulaMasterLocalService getNetSalesFormulaMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.NetSalesFormulaMaster",
			netSalesFormulaMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.NetSalesFormulaMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return NetSalesFormulaMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = netSalesFormulaMasterPersistence.getDataSource();
	...
	@BeanReference(type = NetSalesFormulaMasterLocalService.class)
	protected NetSalesFormulaMasterLocalService netSalesFormulaMasterLocalService;
