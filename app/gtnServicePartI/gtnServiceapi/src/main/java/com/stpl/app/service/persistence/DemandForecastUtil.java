...
/**
 * The persistence utility for the demand forecast service. This utility wraps {@link com.stpl.app.service.persistence.impl.DemandForecastPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.stpl.app.service.persistence.impl.DemandForecastPersistenceImpl
 * @generated
 */
@ProviderType
public class DemandForecastUtil {
	...
	*/
	public static void cacheResult(DemandForecast demandForecast) {
	...
	*/
	public static void cacheResult(List<DemandForecast> demandForecasts) {
	...
	*/
	public static DemandForecast create(int demandForecastSid) {
	...
	*/
	public static DemandForecast remove(int demandForecastSid)
		throws com.stpl.app.exception.NoSuchDemandForecastException {
		return getPersistence().remove(demandForecastSid);
	}

	public static DemandForecast updateImpl(DemandForecast demandForecast) {
	...
	* @throws NoSuchDemandForecastException if a demand forecast with the primary key could not be found
	*/
	public static DemandForecast findByPrimaryKey(int demandForecastSid)
		throws com.stpl.app.exception.NoSuchDemandForecastException {
	...
	*/
	public static DemandForecast fetchByPrimaryKey(int demandForecastSid) {
		return getPersistence().fetchByPrimaryKey(demandForecastSid);
	}

	public static java.util.Map<java.io.Serializable, DemandForecast> fetchByPrimaryKeys(
	...
	*/
	public static List<DemandForecast> findAll() {
	...
	*/
	public static List<DemandForecast> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<DemandForecastPersistence, DemandForecastPersistence> _serviceTracker =
		ServiceTrackerFactory.open(DemandForecastPersistence.class);
}