...
import com.stpl.app.service.ChProjectionDiscountLocalService;
...
/**
 * Provides the base implementation for the ch projection discount local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.ChProjectionDiscountLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.ChProjectionDiscountLocalServiceImpl
 * @see com.stpl.app.service.ChProjectionDiscountLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class ChProjectionDiscountLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ChProjectionDiscountLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.ChProjectionDiscountLocalServiceUtil} to access the ch projection discount local service.
	 */
	...
	@Override
	public ChProjectionDiscount addChProjectionDiscount(
		ChProjectionDiscount chProjectionDiscount) {
		chProjectionDiscount.setNew(true);

		return chProjectionDiscountPersistence.update(chProjectionDiscount);
	}
	 ...
	 */
	@Override
	public ChProjectionDiscount createChProjectionDiscount(
		ChProjectionDiscountPK chProjectionDiscountPK) {
		return chProjectionDiscountPersistence.create(chProjectionDiscountPK);
	}
	...
	@Override
	public ChProjectionDiscount deleteChProjectionDiscount(
		ChProjectionDiscountPK chProjectionDiscountPK)
		throws PortalException {
		return chProjectionDiscountPersistence.remove(chProjectionDiscountPK);
	}
	...
	public ChProjectionDiscount deleteChProjectionDiscount(
		ChProjectionDiscount chProjectionDiscount) {
		return chProjectionDiscountPersistence.remove(chProjectionDiscount);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ChProjectionDiscount.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return chProjectionDiscountPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return chProjectionDiscountPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ChProjectionDiscount fetchChProjectionDiscount(
		ChProjectionDiscountPK chProjectionDiscountPK) {
		return chProjectionDiscountPersistence.fetchByPrimaryKey(chProjectionDiscountPK);
	}
	 ...
	 */
	@Override
	public ChProjectionDiscount getChProjectionDiscount(
		ChProjectionDiscountPK chProjectionDiscountPK)
		throws PortalException {
		return chProjectionDiscountPersistence.findByPrimaryKey(chProjectionDiscountPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(chProjectionDiscountLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ChProjectionDiscount.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(chProjectionDiscountLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ChProjectionDiscount.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return chProjectionDiscountLocalService.deleteChProjectionDiscount((ChProjectionDiscount)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return chProjectionDiscountPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ChProjectionDiscount> getChProjectionDiscounts(int start,
		int end) {
		return chProjectionDiscountPersistence.findAll(start, end);
	}
	...
	public int getChProjectionDiscountsCount() {
		return chProjectionDiscountPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ChProjectionDiscount updateChProjectionDiscount(
		ChProjectionDiscount chProjectionDiscount) {
		return chProjectionDiscountPersistence.update(chProjectionDiscount);
	}
	 ...
	 */
	public ChProjectionDiscountLocalService getChProjectionDiscountLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.ChProjectionDiscount",
			chProjectionDiscountLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.ChProjectionDiscount");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ChProjectionDiscountLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = chProjectionDiscountPersistence.getDataSource();
	...
	@BeanReference(type = ChProjectionDiscountLocalService.class)
	protected ChProjectionDiscountLocalService chProjectionDiscountLocalService;
