...
import com.stpl.app.service.CompanyMasterLocalService;
...
/**
 * Provides the base implementation for the company master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.CompanyMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class CompanyMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements CompanyMasterLocalService,
        IdentifiableBean {
    ...
    private CompanyMasterLocalServiceClpInvoker _clpInvoker = new CompanyMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.CompanyMasterLocalServiceUtil} to access the company master local service.
     */
    ...
    @Override
    public CompanyMaster addCompanyMaster(CompanyMaster companyMaster)
        throws SystemException {
        companyMaster.setNew(true);

        return companyMasterPersistence.update(companyMaster);
    }
     ...
     */
    @Override
    public CompanyMaster createCompanyMaster(int companyMasterSid) {
        return companyMasterPersistence.create(companyMasterSid);
    }
    ...
    @Override
    public CompanyMaster deleteCompanyMaster(int companyMasterSid)
        throws PortalException, SystemException {
        return companyMasterPersistence.remove(companyMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public CompanyMaster deleteCompanyMaster(CompanyMaster companyMaster)
        throws SystemException {
        return companyMasterPersistence.remove(companyMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CompanyMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return companyMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return companyMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public CompanyMaster fetchCompanyMaster(int companyMasterSid)
        throws SystemException {
        return companyMasterPersistence.fetchByPrimaryKey(companyMasterSid);
    }
     ...
     */
    @Override
    public CompanyMaster getCompanyMaster(int companyMasterSid)
        throws PortalException, SystemException {
        return companyMasterPersistence.findByPrimaryKey(companyMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return companyMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<CompanyMaster> getCompanyMasters(int start, int end)
        throws SystemException {
        return companyMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCompanyMastersCount() throws SystemException {
        return companyMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public CompanyMaster updateCompanyMaster(CompanyMaster companyMaster)
        throws SystemException {
        return companyMasterPersistence.update(companyMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.CompanyMaster",
            companyMasterLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.CompanyMaster");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = companyMasterPersistence.getDataSource();
