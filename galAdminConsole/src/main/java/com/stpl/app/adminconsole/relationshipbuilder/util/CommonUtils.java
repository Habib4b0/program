...
public final class CommonUtils {
    ...
    public static ComboBox getHierarchy(final ComboBox select) throws SystemException, Exception {
        LOGGER.info("Entering getHierarchy method");
        ...
        LOGGER.info("getHierarchy return List<HelperDTO> results size " + results.size());
        return select;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static ComboBox getHistHierarchy(final ComboBox select, SessionDTO sessionDTO) throws SystemException, Exception {
        LOGGER.info("Entering getHierarchy method");
    ...
    public static Map getHierarchyInfo() throws SystemException {
        LOGGER.info("Entering getHierarchyInfo ");
        List<Object[]> resultList;
        ...
        LOGGER.info("getHierarchyInfo return HashMap results size:" + results.size());
        return results;
    }
     ...
     * @throws java.lang.Exception
     */
    public static String convertDateToString(final Date aDate) throws Exception {
     ...
     * @throws java.lang.Exception
     */
    public static String getDateTime(final String aMask, final Date aDate) throws Exception {
        SimpleDateFormat dateFormat;
        String returnValue;
        LOGGER.info("Entering getDateTime  with P1:String aMask=" + aMask + " and P2:Date aDate=" + aDate);
        if (aDate == null) {
            returnValue = EMPTY;
        } else {
            dateFormat = new SimpleDateFormat(aMask);
            returnValue = dateFormat.format(aDate);
            LOGGER.info("getDateTime return String returnValue=" + returnValue);
        }
        return returnValue;
    }
    ...
    public static Date convert2DigitTo4DigitYearFormat(final Date enteredDate) throws SystemException {
        Date returnDate;
        LOGGER.info("convert2DigitTo4DigitYearFormat started with P1:Date enteredDate=" + enteredDate);
        if (enteredDate == null || enteredDate.equals(ConstantsUtils.EMPTY)) {
            returnDate = enteredDate;
        } else {
            try {
                if (enteredDate.toString().length() == 28) {
                    returnDate = enteredDate;
                } else {
        ...
        LOGGER.info("convert2DigitTo4DigitYearFormat return Date enteredDate=" + enteredDate);
        return returnDate;
    }

    public static void main(String[] args) {
        LOGGER.info("Thu Nov 11 00:00:00 GMT 93".length());
    }
     ...
     * @throws java.lang.Exception
     */
    public static Date convertStringToDate(final String strDate) throws Exception {
        Date aDate;
        LOGGER.info("Entering convertStringToDate started with P1:String strDate=" + strDate);
        if (strDate == null || strDate.equals(EMPTY) || strDate.equals(STRING_NULL)) {
            aDate = NULL_VALUE;
        } else {
            aDate = convertStringToDate(MMDDYYYY, strDate);
        }
        LOGGER.info("convertStringToDate return Date aDate" + aDate);
        return aDate;
    }
     ...
     * @throws java.lang.Exception
     */
    public static Date convertStringToDate(final String aMask, final String strDate) throws Exception {
        Date date;
        LOGGER.info("convertStringToDate started with P1:String aMask=" + aMask + " and P2:String strDate" + strDate);
        SimpleDateFormat dateFormat;
        dateFormat = new SimpleDateFormat(aMask);
        date = dateFormat.parse(strDate);
        LOGGER.info("convertStringToDate return Date date" + date);
        return date;
    }
