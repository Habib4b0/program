...
/**
 * Provides the local service interface for WorkflowProfile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see WorkflowProfileLocalServiceUtil
...
public interface WorkflowProfileLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkflowProfileLocalServiceUtil} to access the workflow profile local service. Add custom service methods to {@link com.stpl.app.service.impl.WorkflowProfileLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
