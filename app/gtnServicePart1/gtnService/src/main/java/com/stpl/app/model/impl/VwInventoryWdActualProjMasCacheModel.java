...
public class VwInventoryWdActualProjMasCacheModel implements CacheModel<VwInventoryWdActualProjMas>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof VwInventoryWdActualProjMasCacheModel)) {
			return false;
		}

		VwInventoryWdActualProjMasCacheModel vwInventoryWdActualProjMasCacheModel =
			(VwInventoryWdActualProjMasCacheModel)obj;

		if (inventoryWdActualProjMasSid == vwInventoryWdActualProjMasCacheModel.inventoryWdActualProjMasSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, inventoryWdActualProjMasSid);
	}
	...
	public VwInventoryWdActualProjMas toEntityModel() {
		...
		if (companyStringId == null) {
			vwInventoryWdActualProjMasImpl.setCompanyStringId(StringPool.BLANK);
		}
		else {
			vwInventoryWdActualProjMasImpl.setCompanyStringId(companyStringId);
		}
