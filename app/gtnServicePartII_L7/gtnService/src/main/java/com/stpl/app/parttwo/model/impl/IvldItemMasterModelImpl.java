 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link IvldItemMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link IvldItemMasterImpl}.
 * </p>
 *
 * @author
...
public class IvldItemMasterModelImpl extends BaseModelImpl<IvldItemMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("NEW_FORMULATION_END_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("UDC4", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CLOTTING_FACTOR_START_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("SECONDARY_UOM", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_DESC", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("AUTHORIZED_GENERIC_END_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("PEDIATRIC_EXCLUSIVE_START_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("LAST_LOT_EXPIRATION_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("DISCONTINUATION_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_MASTER_INTFID", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("INTF_INSERTED_DATE", Types.TIMESTAMP);
		TABLE_COLUMNS_MAP.put("DIVESTITURE_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MODIFIED_BY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("BASE_CPI_PERIOD", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("CLOTTING_FACTOR_END_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("ACQUISITION_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("DUAL_PRICING_INDICATOR", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("NON_FEDERAL_EXPIRATION_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("AUTHORIZED_GENERIC_START_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("NEW_FORMULATION_START_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_CATEGORY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_END_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_TYPE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("PEDIATRIC_EXCLUSIVE_END_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ORGANIZATION_KEY", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("FIRST_SALE_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("SHELF_LIFE_TYPE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("ITEM_START_DATE", Types.VARCHAR);
		...
		TABLE_COLUMNS_MAP.put("PACKAGE_SIZE_INTRO_DATE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("UPPS", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("IVLD_ITEM_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("PACKAGE_SIZE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("SHELF_LIFE", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("MARKET_TERMINATION_DATE", Types.VARCHAR);
	...
	private static final ClassLoader _classLoader = IvldItemMaster.class.getClassLoader();
