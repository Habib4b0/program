...
/**
 * Provides the local service interface for GcmContractDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see GcmContractDetailsLocalServiceUtil
...
public interface GcmContractDetailsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link GcmContractDetailsLocalServiceUtil} to access the gcm contract details local service. Add custom service methods to {@link com.stpl.app.service.impl.GcmContractDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
