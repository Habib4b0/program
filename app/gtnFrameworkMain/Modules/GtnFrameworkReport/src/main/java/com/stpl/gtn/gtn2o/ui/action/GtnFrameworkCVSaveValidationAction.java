...
//                .getStringFromField();
        ...
        if (String.valueOf(GtnUIFrameworkGlobalUI.getSessionProperty("mode")).equalsIgnoreCase("Edit")) {
            reportCustomViewRequest.setCvSysId(Integer.parseInt(String.valueOf(GtnUIFrameworkGlobalUI.getSessionProperty("customSid"))));
        }
...
//        reportCustomViewRequest.setGtnWsCustomTreeData(customTreeData);
    ...
    public List<GtnWsRecordBean> getAllTreeNodes(TreeData<GtnWsRecordBean> treeData, List<GtnWsRecordBean> treeNodeList, List<GtnWsRecordBean> parentItems) throws GtnFrameworkValidationFailedException {
    ...
    private void saveCustomView(String componentId, String customViewName,
