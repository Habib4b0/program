...
public class ProjectionOptionsPrivateViewLookupTest {

	
	
	@Test
    public void testMainScreenConfigPrivateMethod1() {
        String methodName = "addPrivatePublicViewSearchLookupRootLayout";
        ProjectionOptionsPrivateViewLookup instance = new ProjectionOptionsPrivateViewLookup();
        testComponentConfig(methodName, instance);
       instance.getPrivateViewLookUpView("test");
    }

	
	public void testComponentConfig(String gtnFrameworkContractMainConfigMethodName, ProjectionOptionsPrivateViewLookup gtnFrameworkContractMainConfig) {
    ...
    private List<GtnUIFrameworkComponentConfig> getComponentList(Method method, ProjectionOptionsPrivateViewLookup gtnFrameworkContractMainConfig) throws SecurityException {
        ...
        try {
            ...
            Logger.getLogger(ProjectionOptionsPrivateViewLookup.class.getName()).log(Level.SEVERE, null, ex);
        }
