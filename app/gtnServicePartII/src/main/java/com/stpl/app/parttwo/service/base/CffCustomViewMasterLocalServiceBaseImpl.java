...
import com.stpl.app.parttwo.service.CffCustomViewMasterLocalService;
...
/**
 * Provides the base implementation for the cff custom view master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.CffCustomViewMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.CffCustomViewMasterLocalServiceImpl
 * @see com.stpl.app.parttwo.service.CffCustomViewMasterLocalServiceUtil
 * @generated
 */
public abstract class CffCustomViewMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements CffCustomViewMasterLocalService,
        IdentifiableBean {
    ...
    private CffCustomViewMasterLocalServiceClpInvoker _clpInvoker = new CffCustomViewMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.CffCustomViewMasterLocalServiceUtil} to access the cff custom view master local service.
     */
    ...
    public CffCustomViewMaster addCffCustomViewMaster(
        ...
        return cffCustomViewMasterPersistence.update(cffCustomViewMaster);
    }
    ...
    public CffCustomViewMaster createCffCustomViewMaster(
        ...
        return cffCustomViewMasterPersistence.create(cffCustomViewMasterSid);
    }
    ...
    public CffCustomViewMaster deleteCffCustomViewMaster(
        int cffCustomViewMasterSid) throws PortalException, SystemException {
        return cffCustomViewMasterPersistence.remove(cffCustomViewMasterSid);
    }
    ...
    public CffCustomViewMaster deleteCffCustomViewMaster(
        CffCustomViewMaster cffCustomViewMaster) throws SystemException {
        return cffCustomViewMasterPersistence.remove(cffCustomViewMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(CffCustomViewMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return cffCustomViewMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return cffCustomViewMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public CffCustomViewMaster fetchCffCustomViewMaster(
        int cffCustomViewMasterSid) throws SystemException {
        return cffCustomViewMasterPersistence.fetchByPrimaryKey(cffCustomViewMasterSid);
    }
    ...
    public CffCustomViewMaster getCffCustomViewMaster(
        int cffCustomViewMasterSid) throws PortalException, SystemException {
        return cffCustomViewMasterPersistence.findByPrimaryKey(cffCustomViewMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return cffCustomViewMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
    ...
    public List<CffCustomViewMaster> getCffCustomViewMasters(int start, int end)
        throws SystemException {
        return cffCustomViewMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCffCustomViewMastersCount() throws SystemException {
        return cffCustomViewMasterPersistence.countAll();
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.CffCustomViewMaster",
            cffCustomViewMasterLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.parttwo.model.CffCustomViewMaster");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = cffCustomViewMasterPersistence.getDataSource();
