...
public class ItemPricingGenerator extends DefaultFieldFactory {
    ...
    public ItemPricingGenerator(BeanItemContainer<TempPricingDTO> saveContainer, final Object[] dates, final Object[] psDates, final Map<String, List> tempDate, Map<Integer, String> priceType, SessionDTO sessionDTO) {
        ...
        try {
            ...
            statusList = new ItemSearchLogic().getItemType("Status");
            ...
            attachedStatusList = new ItemSearchLogic().getItemType("Status");
    ...
    public Field<?> createField(final Container container, final Object itemId, final Object propertyId, final Component uiContext) {
        try {
            ...
            if (Constants.CHECK_BOX.equals(propertyId)) {
                ...
                checkbox.addValueChangeListener(new Property.ValueChangeListener() {
                    ...
                    public void valueChange(ValueChangeEvent event) {
                        ...
                        IfpLogic.updateTempCheck(sessionDTO, false, temp.getTempItemPriceRebateSystemId(), checkbox.getValue());
            ...
            if (Constants.PRICE_TYPE.equals(propertyId)) {
                ...
                if (temp.getPriceType()
                        != null && !"".equals(temp.getPriceType())) {
                    comboBox.setReadOnly(false);
                } else if (temp.getPrice()
                        != null && !Double.isNaN(Double.valueOf(temp.getPrice()))) {
            ...
            if (Constants.PRICE.equals(propertyId)) {
                ...
                price.setRequiredError("Price should be present");
    ...
    public void attachListeners(final AbstractField field, final String component, final Object itemId, final TempPricingDTO temp) throws Exception {
                ...
                try {
                    if (Constants.START_DATE.equals(component)) {
                        ...
                        if (((PopupDateField) field).getValue()!=null && (((PopupDateField) field).getValue().before((Date) psDates[0]))) {
                            ...
                            detachListeners(field);
                            ((PopupDateField) field).setValue(tempDateList.get(2));
                            attachListeners(field, component, itemId, temp);
                            return;
                        ...
                        if ((Date) psDates[1] != null && ((PopupDateField) field).getValue().after((Date) psDates[1])) {
                            detachListeners(field);
                            ((PopupDateField) field).setValue(tempDateList.get(3) != null ? tempDateList.get(3) : null);
