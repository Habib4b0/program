...
/**
 * Provides the local service interface for MSupplementalDiscMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see MSupplementalDiscMasterLocalServiceUtil
...
public interface MSupplementalDiscMasterLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link MSupplementalDiscMasterLocalServiceUtil} to access the m supplemental disc master local service. Add custom service methods to {@link com.stpl.app.service.impl.MSupplementalDiscMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
