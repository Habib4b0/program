		...
		btnSearch.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				try {
					...
					if(binder.getField("businessroleMasterSid").getValue()!=null && !"".equals(binder.getField("businessroleMasterSid").getValue().toString())){
						int id = Integer.parseInt(binder.getField("businessroleMasterSid").getValue().toString());
				...
				LOGGER.error(e);
					...
					/*Notification notif = new Notification(e.getCause()
