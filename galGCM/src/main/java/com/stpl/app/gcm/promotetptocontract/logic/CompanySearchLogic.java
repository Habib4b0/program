...
public class CompanySearchLogic {
     ...
     * @throws Exception
     */
    public List<PromoteTpToChDto> searchCompaniesLazy(final PromoteTpToChDto tpDTO, int startIndex, int offset, List<OrderByColumn> orderByColumns, Set<Container.Filter> filters, String searchSessionId) throws PortalException, Exception {
        Map<String, Object> parameters = new HashMap<String, Object>();
        List resultList;
