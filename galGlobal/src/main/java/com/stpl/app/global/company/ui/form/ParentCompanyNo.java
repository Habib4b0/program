...
public final class ParentCompanyNo extends Window {
    ...
    public ParentCompanyNo(final TextField parentCompanyNo) throws SystemException, PortalException, Exception {
    ...
    public void addResponsiveTableCollapse(final ExtFilterTable table) {
        reloadMap.put(850, true);
        reloadMap.put(450, true);
        ...
        Page.getCurrent().addBrowserWindowResizeListener(new Page.BrowserWindowResizeListener() {
            ...
            public void browserWindowResized(final Page.BrowserWindowResizeEvent event) {
                ...
                try {
                    ...
                    if (browserWidth > 850 && reloadMap.get(850)) {
                        searchCriteria.setCustomDirty(false);
                        for (Object propertyId : table.getVisibleColumns()) {
                            table.setColumnCollapsed(propertyId, false);
                        }
                        reloadMap.put(850, false);
                        reloadMap.put(450, true);
                        reloadMap.put(0, true);
                        searchCriteria.setCustomDirty(true);
                    } else if (browserWidth < 850 && browserWidth > 450 && reloadMap.get(450)) {
                        searchCriteria.setCustomDirty(false);
                        for (Object propertyId : table.getVisibleColumns()) {
                            table.setColumnCollapsed(propertyId, false);
                        }
                        ...
                        reloadMap.put(850, true);
                        reloadMap.put(450, false);
                        reloadMap.put(0, true);
                        searchCriteria.setCustomDirty(true);
                    } else if (browserWidth < 450 && reloadMap.get(0)) {
                        searchCriteria.setCustomDirty(false);
                        for (Object propertyId : table.getVisibleColumns()) {
                            table.setColumnCollapsed(propertyId, false);
                        }
     ...
     * @throws SystemException the system exception
     */
    protected GridLayout addToGrid() throws PortalException, SystemException, Exception {
        final CustomGridLayout grid = new CustomGridLayout(6, 4);
    ...
    protected void addToGrid2() throws SystemException, PortalException, Exception {
        final StplSecurity stplSecurity = new StplSecurity();
        final String userId = String.valueOf(VaadinSession.getCurrent().getAttribute(ConstantsUtils.USER_ID));
        final Map<String, AppPermission> fieldCompanyHM = stplSecurity.getFieldOrColumnPermission(userId, UISecurityUtil.COMPANY_MASTER,false);
    ...
    protected void configureFields() throws PortalException, SystemException, Exception {
        ...
        companyNo.setData("maxlengthvalidationfifty,maxlengthvalidationcompanyno,alphaNumericChars,alphaNumericCharsMessage");
        companyNo.setImmediate(true);
        companyNo.setValidationVisible(true);

        companyId.setData("maxlengthvalidation,maxlengthvalidationcompanyid,alphaNumericChars,alphaNumericCharsMessage");
       ...
       closeBtn.addClickListener(new ClickListener() {
            ...
            @SuppressWarnings("PMD")
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("Entering inside  Close  method ");
                parentCompanyId.setReadOnly(false);
                parentCompanyNo.setReadOnly(false);
                parentCompanyName.setReadOnly(false);
                ...
                sessionDTO.setParentLookUpId("0001");
                close();
                LOGGER.info("Ending Close  method ");
            }            
        });
    }
