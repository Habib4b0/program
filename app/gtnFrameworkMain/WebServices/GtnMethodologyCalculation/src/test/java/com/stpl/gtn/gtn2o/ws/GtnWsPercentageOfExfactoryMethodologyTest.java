...
public class GtnWsPercentageOfExfactoryMethodologyTest {

	@Test
	public void testExfactoryMethodology() {
	...
	private GtnWsMethodologyBean createMethodologyBean() {
		...
		methodologyBean.setBaselineFormula("ACTUAL_RETURN_AMOUNT/ORIG_SALE_DOLLARS");
		methodologyBean.setBaselinePeriodList(getBaselinePeriodList());

		methodologyBean.setProjectionFormula("BASELINE * ACTIVE_EXFACTORY_SALES_AMOUNT");
	...
	/*
	 * EXFACTORY will be appended before PROJECTED_RETURN_AMOUNT and
	 * PROJECTED_RPU in the formula properties file.
	 * 
	 * Will be like EXFACTORY_PROJECTED_RETURN_AMOUNT and
	 * EXFACTORY_PROJECTED_RPU.
	 */
	private Map<String, String> getFormulaMap() {
		Map<String, String> map = new HashMap<>();
		map.put("PROJECTED_RETURN_PERCENT",
				"(PROJECTED_RETURN_AMOUNT/(ACTIVE_EXFACTORY_SALES_AMOUNT/ACTIVE_EXFACTORY_SALES_UNITS))/ACTIVE_EXFACTORY_SALES_UNITS");
		map.put("PROJECTED_RPU",
				"(PROJECTED_RETURN_PERCENT/ACTIVE_EXFACTORY_SALES_AMOUNT)/ACTIVE_EXFACTORY_SALES_UNITS");
