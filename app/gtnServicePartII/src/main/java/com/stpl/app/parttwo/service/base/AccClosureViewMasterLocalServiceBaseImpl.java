...
public abstract class AccClosureViewMasterLocalServiceBaseImpl
    ...
    private AccClosureViewMasterLocalServiceClpInvoker _clpInvoker = new AccClosureViewMasterLocalServiceClpInvoker();
    ...
    public AccClosureViewMaster deleteAccClosureViewMaster(
        int accClosureViewMasterSid) throws PortalException, SystemException {
    ...
    public AccClosureViewMaster fetchAccClosureViewMaster(
        int accClosureViewMasterSid) throws SystemException {
     ...
     */
    @Override
    public int getAccClosureViewMastersCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.AccClosureViewMaster",
