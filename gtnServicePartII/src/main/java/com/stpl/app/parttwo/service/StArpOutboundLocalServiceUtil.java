...
public class StArpOutboundLocalServiceUtil {
    private static StArpOutboundLocalService _service;
    ...
    */
    ...
    public static StArpOutboundLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StArpOutboundLocalService.class.getName());

            if (invokableLocalService instanceof StArpOutboundLocalService) {
                _service = (StArpOutboundLocalService) invokableLocalService;
            } else {
                _service = new StArpOutboundLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StArpOutboundLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StArpOutboundLocalService service) {
    }
}
