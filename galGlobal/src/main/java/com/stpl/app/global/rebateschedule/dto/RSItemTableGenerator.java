...
import com.stpl.app.global.rebateschedule.ui.lookup.ComplianceDeductionLookUP;
...
public class RSItemTableGenerator extends DefaultFieldFactory {
     ...
     */
    public RSItemTableGenerator(ExtPagedTable table,BeanItemContainer itemResultBean, String rebatePlanLevel, RebateSetupTableLogic rebateSetupTableLogic) {
    ...
    public Field<?> createField(final Container container, final Object itemId, final Object propertyId, final Component uiContext) {
        ...
        try {
            ...
            if (propertyId.equals(ConstantsUtils.REBATE_AMOUNT)) {
                ...
                rebateAmount.addValidator(new StringLengthValidator(" Rebate Amount should be less than 38 Characters", 0, 38, true));
            ...
            public void click(CustomTextField.ClickEvent event) {
                try {
                    ...
                    final NetSalesRuleLookUp netSalesLookup = new NetSalesRuleLookUp(netSalesRule, tempDto,"Net Sales Rule Lookup","Rebate Schedule");
                    UI.getCurrent().addWindow(netSalesLookup);
                    netSalesLookup.addCloseListener(new Window.CloseListener() {
                        @Override
                        public void windowClose(Window.CloseEvent e) {
            ...
            public void click(CustomTextField.ClickEvent event) {
                try {
                    ...
                    final NetSalesRuleLookUp netSalesLookup = new NetSalesRuleLookUp(evaluationRule, tempDto,"Evaluation Rule Lookup","Rebate Schedule");
                    UI.getCurrent().addWindow(netSalesLookup);
                    netSalesLookup.addCloseListener(new Window.CloseListener() {
                        @Override
                        public void windowClose(Window.CloseEvent e) {
