...
public class PeriodLocalServiceUtil {
    private static PeriodLocalService _service;
    ...
    */
    ...
    public static PeriodLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    PeriodLocalService.class.getName());

            if (invokableLocalService instanceof PeriodLocalService) {
                _service = (PeriodLocalService) invokableLocalService;
            } else {
                _service = new PeriodLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(PeriodLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(PeriodLocalService service) {
    }
}
