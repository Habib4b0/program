...
import com.stpl.app.galforecasting.nationalassumptions.logic.tablelogic.MedicaidURAResultsTableLogic;
...
import static com.stpl.app.galforecasting.nationalassumptions.util.Constants.IndicatorConstants.URA_RESULTS_SCREEN;
...
public class MedicaidURA extends CustomComponent implements View {
     ...
     */
    public MedicaidURA(NationalAssumptionsForm form) {

        LOGGER.info("MedicaidURA Constructor initiated ");
        this.form = form;
        setCompositionRoot(Clara.create(getClass().getResourceAsStream("/nationalassumption/MedicaidURA.xml"), this));
        gridLayout.addComponent(priceType, 1, 2, 4, 2);
        ...
        configureFields();
        LOGGER.info("MedicaidURA Constructor Ended ");
    }
    ...
    public String getCaption() {
        LOGGER.info("Inside MedicaidURA getCaption");
                ...
                if (tableDto.getParent() == 1) {
                    ...
                    ndcLink.addClickListener(new Button.ClickListener() {
                        ...
                        public void buttonClick(final Button.ClickEvent event) {
                            ...
                            final MedicaidUraWorkSheet lookUp = new MedicaidUraWorkSheet(worksheetProjDto);
    ...
    public void callProcedure() {
        try {
            ...
            medResLogic.medicaidProcSetupDataCook(projectionId, userId.intValue(), sessionId, priceBasis);
        } catch (Exception ex) {
    ...
    public void excelBtn(final Button.ClickEvent event) {
        ...
        try {
            ...
            ExcelExport exp = new ExcelExport(new ExtCustomTableHolder(exceltable), "Medicaid URA Results", "Medicaid URA Results", "Medicaid URA Results.xls", false);
            exp.export();
    ...
    private void loadExcelResultTable(int parentLevelId) throws Exception {
    ...
    public void addLowerLevelsForExport(TableDTO id) {
        List<TableDTO> resultList = medResLogic.getMedicaidChild(projectionDTO, id.getNdc9());
