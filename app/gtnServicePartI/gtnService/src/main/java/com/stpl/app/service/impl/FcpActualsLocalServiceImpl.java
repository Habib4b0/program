 ...
 *
 * @author
 * @see FcpActualsLocalServiceBaseImpl
...
public class FcpActualsLocalServiceImpl extends FcpActualsLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link com.stpl.app.service.FcpActualsLocalServiceUtil} to access the fcp actuals local service.
	 */
}