 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link ProjectionCustHierarchyModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ProjectionCustHierarchyImpl}.
 * </p>
 *
 * @author
...
public class ProjectionCustHierarchyModelImpl extends BaseModelImpl<ProjectionCustHierarchy>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("PROJECTION_CUST_HIERARCHY_SID", Types.INTEGER);
	...
	private static final ClassLoader _classLoader = ProjectionCustHierarchy.class.getClassLoader();
