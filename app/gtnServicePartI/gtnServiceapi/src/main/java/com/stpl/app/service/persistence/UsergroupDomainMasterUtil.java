...
/**
 * The persistence utility for the usergroup domain master service. This utility wraps {@link com.stpl.app.service.persistence.impl.UsergroupDomainMasterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class UsergroupDomainMasterUtil {
	...
	*/
	public static void cacheResult(UsergroupDomainMaster usergroupDomainMaster) {
	...
	*/
	public static void cacheResult(
		List<UsergroupDomainMaster> usergroupDomainMasters) {
	...
	*/
	public static UsergroupDomainMaster create(int usergroupDomainSid) {
	...
	*/
	public static UsergroupDomainMaster remove(int usergroupDomainSid)
		throws com.stpl.app.exception.NoSuchUsergroupDomainMasterException {
		return getPersistence().remove(usergroupDomainSid);
	}

	public static UsergroupDomainMaster updateImpl(
		UsergroupDomainMaster usergroupDomainMaster) {
	...
	* @throws NoSuchUsergroupDomainMasterException if a usergroup domain master with the primary key could not be found
	*/
	public static UsergroupDomainMaster findByPrimaryKey(int usergroupDomainSid)
		throws com.stpl.app.exception.NoSuchUsergroupDomainMasterException {
	...
	*/
	public static UsergroupDomainMaster fetchByPrimaryKey(
		int usergroupDomainSid) {
		return getPersistence().fetchByPrimaryKey(usergroupDomainSid);
	}

	public static java.util.Map<java.io.Serializable, UsergroupDomainMaster> fetchByPrimaryKeys(
	...
	*/
	public static List<UsergroupDomainMaster> findAll() {
	...
	*/
	public static List<UsergroupDomainMaster> findAll(int start, int end) {
	...
	*/
	...
	private static ServiceTracker<UsergroupDomainMasterPersistence, UsergroupDomainMasterPersistence> _serviceTracker =
		ServiceTrackerFactory.open(UsergroupDomainMasterPersistence.class);
}