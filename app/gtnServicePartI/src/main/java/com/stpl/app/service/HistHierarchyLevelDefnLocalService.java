...
/**
 * Provides the local service interface for HistHierarchyLevelDefn. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see HistHierarchyLevelDefnLocalServiceUtil
...
public interface HistHierarchyLevelDefnLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link HistHierarchyLevelDefnLocalServiceUtil} to access the hist hierarchy level defn local service. Add custom service methods to {@link com.stpl.app.service.impl.HistHierarchyLevelDefnLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
