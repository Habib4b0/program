...
/**
 * Provides the local service interface for VwIvldDemandForecastActual. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see VwIvldDemandForecastActualLocalServiceUtil
...
public interface VwIvldDemandForecastActualLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VwIvldDemandForecastActualLocalServiceUtil} to access the vw ivld demand forecast actual local service. Add custom service methods to {@link com.stpl.app.service.impl.VwIvldDemandForecastActualLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
