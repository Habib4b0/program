 ...
 * @generated
 */
public class ProjectionProdDetailsLocalServiceClp
    ...
    public ProjectionProdDetailsLocalServiceClp(
    ...
    public com.stpl.app.model.ProjectionProdDetails addProjectionProdDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(projectionProdDetails)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ProjectionProdDetails) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ProjectionProdDetails createProjectionProdDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { productDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ProjectionProdDetails deleteProjectionProdDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { productDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ProjectionProdDetails fetchProjectionProdDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { productDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ProjectionProdDetails getProjectionProdDetails(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { productDetailsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ProjectionProdDetails> getProjectionProdDetailses(
        ...
        return (java.util.List<com.stpl.app.model.ProjectionProdDetails>) ClpSerializer.translateOutput(returnObj);
    }
