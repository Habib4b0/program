...
public class Summary extends VerticalLayout implements View {
    ...
    protected void initializeTabs() {
        ...
        try {
            tabSheet.addTab(summaryTPDetails, Constants.IndicatorConstants.TAB_SUMMARY_TP_DETAILS.getConstant(), null, 0);
            tabSheet.addTab(summarySalesProjectionTransfer, Constants.IndicatorConstants.TAB_SALES_PROJECTION_TRANSFER.getConstant(), null, 1);
