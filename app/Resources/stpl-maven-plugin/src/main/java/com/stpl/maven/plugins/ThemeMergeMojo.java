...
package com.stpl.maven.plugins;
...
import com.stpl.maven.plugins.theme.Theme;
import com.stpl.maven.plugins.util.ContextReplace;
import com.stpl.maven.plugins.util.GetterUtil;
import com.stpl.maven.plugins.util.PortalUtil;
import com.stpl.maven.plugins.util.SAXReaderUtil;
import com.stpl.maven.plugins.util.StringUtil;
import com.stpl.maven.plugins.util.Validator;
...
public class ThemeMergeMojo extends AbstractLiferayMojo {
	...
	protected void doExecute() throws Exception {
		...
		if (parentThemeArtifactGroupId.equals("com.stpl.portal") &&
	...
	/**
	 * @parameter default-value="com.stpl.portal"
	 */
