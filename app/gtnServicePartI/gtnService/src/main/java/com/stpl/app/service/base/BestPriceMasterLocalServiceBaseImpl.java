...
import com.stpl.app.service.BestPriceMasterLocalService;
...
/**
 * Provides the base implementation for the best price master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.BestPriceMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.BestPriceMasterLocalServiceImpl
 * @see com.stpl.app.service.BestPriceMasterLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class BestPriceMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements BestPriceMasterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.BestPriceMasterLocalServiceUtil} to access the best price master local service.
	 */
	...
	@Override
	public BestPriceMaster addBestPriceMaster(BestPriceMaster bestPriceMaster) {
		bestPriceMaster.setNew(true);

		return bestPriceMasterPersistence.update(bestPriceMaster);
	}
	 ...
	 */
	@Override
	public BestPriceMaster createBestPriceMaster(int bestPriceMasterSid) {
		return bestPriceMasterPersistence.create(bestPriceMasterSid);
	}
	...
	@Override
	public BestPriceMaster deleteBestPriceMaster(int bestPriceMasterSid)
		throws PortalException {
		return bestPriceMasterPersistence.remove(bestPriceMasterSid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public BestPriceMaster deleteBestPriceMaster(
		BestPriceMaster bestPriceMaster) {
		return bestPriceMasterPersistence.remove(bestPriceMaster);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(BestPriceMaster.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return bestPriceMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return bestPriceMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public BestPriceMaster fetchBestPriceMaster(int bestPriceMasterSid) {
		return bestPriceMasterPersistence.fetchByPrimaryKey(bestPriceMasterSid);
	}
	 ...
	 */
	@Override
	public BestPriceMaster getBestPriceMaster(int bestPriceMasterSid)
		throws PortalException {
		return bestPriceMasterPersistence.findByPrimaryKey(bestPriceMasterSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(bestPriceMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BestPriceMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("bestPriceMasterSid");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(bestPriceMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BestPriceMaster.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return bestPriceMasterLocalService.deleteBestPriceMaster((BestPriceMaster)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return bestPriceMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BestPriceMaster> getBestPriceMasters(int start, int end) {
		return bestPriceMasterPersistence.findAll(start, end);
	}
	...
	public int getBestPriceMastersCount() {
		return bestPriceMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BestPriceMaster updateBestPriceMaster(
		BestPriceMaster bestPriceMaster) {
		return bestPriceMasterPersistence.update(bestPriceMaster);
	}
	 ...
	 */
	public BestPriceMasterLocalService getBestPriceMasterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.BestPriceMaster",
			bestPriceMasterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.BestPriceMaster");
	}
	...
	public String getOSGiServiceIdentifier() {
		return BestPriceMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = bestPriceMasterPersistence.getDataSource();
	...
	@BeanReference(type = BestPriceMasterLocalService.class)
	protected BestPriceMasterLocalService bestPriceMasterLocalService;
