...
public interface PhsProjPersistence extends BasePersistence<PhsProj> {
	...
	*/
	public void cacheResult(java.util.List<PhsProj> phsProjs);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, PhsProj> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<PhsProj> findAll();
	...
	*/
	public java.util.List<PhsProj> findAll(int start, int end);
	...
	*/
	public java.util.List<PhsProj> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<PhsProj> orderByComparator);
