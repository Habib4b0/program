...
import com.stpl.app.service.NmDiscountProjMasterLocalService;
...
/**
 * Provides the base implementation for the nm discount proj master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.NmDiscountProjMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 ...
 * @generated
 */
public abstract class NmDiscountProjMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements NmDiscountProjMasterLocalService,
        IdentifiableBean {
    ...
    private NmDiscountProjMasterLocalServiceClpInvoker _clpInvoker = new NmDiscountProjMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.NmDiscountProjMasterLocalServiceUtil} to access the nm discount proj master local service.
     */
    ...
    @Override
    public NmDiscountProjMaster addNmDiscountProjMaster(
        NmDiscountProjMaster nmDiscountProjMaster) throws SystemException {
        nmDiscountProjMaster.setNew(true);

        return nmDiscountProjMasterPersistence.update(nmDiscountProjMaster);
    }
     ...
     */
    @Override
    public NmDiscountProjMaster createNmDiscountProjMaster(
        int projectionDetailsSid) {
        return nmDiscountProjMasterPersistence.create(projectionDetailsSid);
    }
    ...
    @Override
    public NmDiscountProjMaster deleteNmDiscountProjMaster(
        int projectionDetailsSid) throws PortalException, SystemException {
        return nmDiscountProjMasterPersistence.remove(projectionDetailsSid);
    }
    ...
    public NmDiscountProjMaster deleteNmDiscountProjMaster(
        NmDiscountProjMaster nmDiscountProjMaster) throws SystemException {
        return nmDiscountProjMasterPersistence.remove(nmDiscountProjMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(NmDiscountProjMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return nmDiscountProjMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return nmDiscountProjMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public NmDiscountProjMaster fetchNmDiscountProjMaster(
        int projectionDetailsSid) throws SystemException {
        return nmDiscountProjMasterPersistence.fetchByPrimaryKey(projectionDetailsSid);
    }
     ...
     */
    @Override
    public NmDiscountProjMaster getNmDiscountProjMaster(
        int projectionDetailsSid) throws PortalException, SystemException {
        return nmDiscountProjMasterPersistence.findByPrimaryKey(projectionDetailsSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return nmDiscountProjMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<NmDiscountProjMaster> getNmDiscountProjMasters(int start,
        int end) throws SystemException {
        return nmDiscountProjMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getNmDiscountProjMastersCount() throws SystemException {
        return nmDiscountProjMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public NmDiscountProjMaster updateNmDiscountProjMaster(
        NmDiscountProjMaster nmDiscountProjMaster) throws SystemException {
        return nmDiscountProjMasterPersistence.update(nmDiscountProjMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.NmDiscountProjMaster",
            nmDiscountProjMasterLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.NmDiscountProjMaster");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = nmDiscountProjMasterPersistence.getDataSource();
