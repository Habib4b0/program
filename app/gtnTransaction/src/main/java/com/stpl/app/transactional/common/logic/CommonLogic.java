...
public class CommonLogic {
    ...
    public Object[] getValuesById(final int sysID, final Object[] ob) throws SystemException {
        ...
        if (adjustDemand == true) {
            hm = new HashMap();
            hm.put(ConstantUtil.FORECASTVER, ConstantUtil.FORECASTVER);
            hm.put("FORECAST_MONTH", "FORECAST_MONTH");
            hm.put("FORECAST_YEAR", "FORECAST_YEAR");
            hm.put("TOTAL_DEMAND_AMOUNT", "TOTAL_DEMAND_AMOUNT");
            hm.put("TOTAL_DEMAND_UNITS", "TOTAL_DEMAND_UNITS");
        ...
        if (tableName.contains("VW_INVENTORY_WD_ACTUAL_PROJ_MAS")) {
            ...
            if (objList != null && !objList.isEmpty()) {
                ...
                if (invalidtableName.equals("IVLD_ITEM_MASTER")) {
                    ...
                    VaadinSession.getCurrent().setAttribute(ConstantUtil.BASE_CPI_PRECISION, result[NumericConstants.FIFTY_NINE] == null ? 0 : result[NumericConstants.FIFTY_NINE]);
                    VaadinSession.getCurrent().setAttribute(ConstantUtil.BASELINE_AMP_PRECISION, result[NumericConstants.SIXTY_ONE] == null ? 0 : result[NumericConstants.SIXTY_ONE]);
                }
            }
            ...
            if (objList != null && !objList.isEmpty()) {
                Object[] result = (Object[]) objList.get(0);
                VaadinSession.getCurrent().setAttribute(ConstantUtil.ITEM_PRICE_PRECISION, result[NumericConstants.SEVEN] == null ? 0 : result[NumericConstants.SEVEN]);
