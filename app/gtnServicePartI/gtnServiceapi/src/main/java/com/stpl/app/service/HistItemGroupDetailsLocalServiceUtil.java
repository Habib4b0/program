...
public class HistItemGroupDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<HistItemGroupDetailsLocalService, HistItemGroupDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(HistItemGroupDetailsLocalService.class);
}