...
/**
 * Provides the local service interface for InventoryWdActualMas. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see InventoryWdActualMasLocalServiceUtil
...
public interface InventoryWdActualMasLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InventoryWdActualMasLocalServiceUtil} to access the inventory wd actual mas local service. Add custom service methods to {@link com.stpl.app.service.impl.InventoryWdActualMasLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public InventoryWdActualMas deleteInventoryWdActualMas(
		int inventoryWdActualMasSid) throws PortalException;
