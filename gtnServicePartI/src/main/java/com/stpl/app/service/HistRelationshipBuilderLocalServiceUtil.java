...
public class HistRelationshipBuilderLocalServiceUtil {
    private static HistRelationshipBuilderLocalService _service;
    ...
    */
    ...
    public static java.util.List findByTableName(java.lang.String tableName,
        ...
        return getService()
                   .findByTableName(tableName, columnName, hierListValues);
    }

    public static java.util.List findFilteredLevelValues(java.lang.String query) {
        return getService().findFilteredLevelValues(query);
    }
    ...
    public static HistRelationshipBuilderLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    HistRelationshipBuilderLocalService.class.getName());

            if (invokableLocalService instanceof HistRelationshipBuilderLocalService) {
                _service = (HistRelationshipBuilderLocalService) invokableLocalService;
            } else {
                _service = new HistRelationshipBuilderLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(HistRelationshipBuilderLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(HistRelationshipBuilderLocalService service) {
    }
}
