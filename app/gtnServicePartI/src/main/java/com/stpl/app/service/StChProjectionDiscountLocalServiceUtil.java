...
public class StChProjectionDiscountLocalServiceUtil {
    private static StChProjectionDiscountLocalService _service;
    ...
    */
    ...
    public static StChProjectionDiscountLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    StChProjectionDiscountLocalService.class.getName());

            if (invokableLocalService instanceof StChProjectionDiscountLocalService) {
                _service = (StChProjectionDiscountLocalService) invokableLocalService;
            } else {
                _service = new StChProjectionDiscountLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(StChProjectionDiscountLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(StChProjectionDiscountLocalService service) {
    }
}
