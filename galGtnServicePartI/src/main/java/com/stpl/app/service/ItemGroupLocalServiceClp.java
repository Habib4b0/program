 ...
 * @generated
 */
public class ItemGroupLocalServiceClp implements ItemGroupLocalService {
    ...
    public ItemGroupLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "getItemGroupMaster";

        _methodParameterTypes19 = new String[] { "java.lang.String" };

        _methodName20 = "getItemGroupDetails";
        ...
        _methodName21 = "getAvailableSearchResults";
    ...
    public com.stpl.app.model.ItemGroup addItemGroup(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(itemGroup) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ItemGroup) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ItemGroup createItemGroup(int itemGroupSid) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { itemGroupSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ItemGroup deleteItemGroup(int itemGroupSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { itemGroupSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ItemGroup fetchItemGroup(int itemGroupSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { itemGroupSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ItemGroup getItemGroup(int itemGroupSid)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { itemGroupSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ItemGroup> getItemGroups(
        ...
        return (java.util.List<com.stpl.app.model.ItemGroup>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List getItemGroupMaster(java.lang.String itemGroupName) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] { ClpSerializer.translateInput(itemGroupName) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List getItemGroupDetails(java.lang.String itemType,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    ...
                    ClpSerializer.translateInput(strength),
                        
                    ClpSerializer.translateInput(itemNoCriteria),
                        
                    ClpSerializer.translateInput(therapeuticCriteria),
                        
                    ClpSerializer.translateInput(formCriteria)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List getAvailableSearchResults(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName21,
                    ...
                    new Object[] { ClpSerializer.translateInput(finalCriteria) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
