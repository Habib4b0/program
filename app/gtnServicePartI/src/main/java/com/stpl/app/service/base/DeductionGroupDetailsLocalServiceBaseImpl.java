...
public abstract class DeductionGroupDetailsLocalServiceBaseImpl
    ...
    private DeductionGroupDetailsLocalServiceClpInvoker _clpInvoker = new DeductionGroupDetailsLocalServiceClpInvoker();
    ...
    public DeductionGroupDetails deleteDeductionGroupDetails(
        int deductionGroupDetailsSid) throws PortalException, SystemException {
    ...
    public DeductionGroupDetails fetchDeductionGroupDetails(
        int deductionGroupDetailsSid) throws SystemException {
     ...
     */
    @Override
    public int getDeductionGroupDetailsesCount() throws SystemException {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.DeductionGroupDetails",
