 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link AdditionalNotesModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AdditionalNotesImpl}.
 * </p>
 *
 * @author
...
public class AdditionalNotesModelImpl extends BaseModelImpl<AdditionalNotes>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("ADDITIONAL_NOTES_ID", Types.INTEGER);
	...
	private static final ClassLoader _classLoader = AdditionalNotes.class.getClassLoader();
