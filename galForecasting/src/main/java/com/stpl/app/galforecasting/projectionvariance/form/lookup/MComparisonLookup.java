...
import com.stpl.app.galforecasting.projectionvariance.dto.LookUpDTO;
import com.stpl.app.galforecasting.sessionutils.SessionDTO;
import com.stpl.app.galforecasting.utils.AbstractNotificationUtils;
import com.stpl.app.galforecasting.utils.Constant;
import static com.stpl.app.galforecasting.utils.Constant.NUM_VALIDATION;
...
public class MComparisonLookup extends ForecastPVComparisonLookup {
     ...
     */
    private LazyBeanItemContainer<LookUpDTO> searchResultbeans;
     ...
     */
    public MComparisonLookup(CustomTextField comparison, SessionDTO sessionDTO, final String screenName) {
        super(screenName, comparison);
        LOGGER.info("ComparisonLookUp constructor started");
        ...
        setModal(true);
        setClosable(true);
        setWidth(90f, Sizeable.Unit.PERCENTAGE);
        setWidth(70f, Sizeable.Unit.PERCENTAGE);
        init();
        LOGGER.info("ComparisonLookUp constructor ends");
    }
     ...
     */
    public void init() {
        LOGGER.info("ComparisonLookUp init method started");
        configureFields();
        resultsTable.setFilterBarVisible(true);
        resultsTable.setFilterGenerator(new ComparisonFilterGenerator(null, null, false));
        resultsTable.setFilterDecorator(new ExtDemoFilterDecorator());
        LOGGER.info("ComparisonLookUp init method ends");
    }
    ...
    public void searchButtonLogic() {
        try {
            ...
            if (flag) {
                if (!tableLogic.fireSetData(lookUpDTO, sessionDTO, notNeededProjectionIds, false, screenName)) {
        ...
        LOGGER.info("Ending searchButtonLogic");
    }
