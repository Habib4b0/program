...
public abstract class PeriodLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements PeriodLocalService, IdentifiableBean {
    ...
    private PeriodLocalServiceClpInvoker _clpInvoker = new PeriodLocalServiceClpInvoker();
    ...
    @Override
    public Period addPeriod(Period period) throws SystemException {
        period.setNew(true);
    ...
    @Override
    public Period deletePeriod(int periodSid)
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Period deletePeriod(Period period) throws SystemException {
    ...
    @Override
    public Period fetchPeriod(int periodSid) throws SystemException {
     ...
     */
    @Override
    public Period getPeriod(int periodSid)
        throws PortalException, SystemException {
     ...
     */
    @Override
    public int getPeriodsCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Period updatePeriod(Period period) throws SystemException {
        return periodPersistence.update(period);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.Period",
            periodLocalService);
    }
