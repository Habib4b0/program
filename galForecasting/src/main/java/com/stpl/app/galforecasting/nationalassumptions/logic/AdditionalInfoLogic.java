...
import com.stpl.app.galforecasting.dao.impl.AdditionalInfoDAOImpl;
...
public class AdditionalInfoLogic {
     ...
     * @throws Exception the exception
     */
    public List<AttachmentDTO> getAttachmentDTOList(final int projectionId, final String moduleName,final File filePath) throws SystemException, Exception {
     ...
     * @throws Exception the exception
     */
    public Boolean deleteUploadedFile(final int docDetailsId) throws SystemException, PortalException, Exception { 
     ...
     * @throws Exception the exception
     */
    public String getNotes(final int projectionId, final String moduleName,List<String> notesListTemp) throws SystemException, Exception {
