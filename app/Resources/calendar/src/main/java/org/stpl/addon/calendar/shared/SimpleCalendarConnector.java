...
import org.stpl.addon.calendar.SimpleCalendar;

import org.stpl.addon.calendar.client.DateValueChangeListener;
import org.stpl.addon.calendar.client.SimpleCalendarWidget;
...
public class SimpleCalendarConnector extends AbstractComponentConnector {
	...
	public void onStateChanged(StateChangeEvent stateChangeEvent) {		
		...
		if(stateChangeEvent.hasPropertyChanged("setDate")){
               List<Date> setDays=getState().setDate;
               if(!setDays.isEmpty()){
               for(Date day:setDays){
               getWidget().select(day);
