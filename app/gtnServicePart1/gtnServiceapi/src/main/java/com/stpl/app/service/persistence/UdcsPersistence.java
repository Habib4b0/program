...
public interface UdcsPersistence extends BasePersistence<Udcs> {
	...
	*/
	public void cacheResult(java.util.List<Udcs> udcses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Udcs> fetchByPrimaryKeys(
	...
	* @return the udcses
	*/
	public java.util.List<Udcs> findAll();
	...
	*/
	public java.util.List<Udcs> findAll(int start, int end);
	...
	*/
	public java.util.List<Udcs> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Udcs> orderByComparator);
