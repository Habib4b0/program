...
public class ImtdPsDetailsLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<ImtdPsDetailsLocalService, ImtdPsDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ImtdPsDetailsLocalService.class);
}