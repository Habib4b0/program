...
public class IvldCompanyMasterLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<IvldCompanyMasterLocalService, IvldCompanyMasterLocalService> _serviceTracker =
		ServiceTrackerFactory.open(IvldCompanyMasterLocalService.class);
}