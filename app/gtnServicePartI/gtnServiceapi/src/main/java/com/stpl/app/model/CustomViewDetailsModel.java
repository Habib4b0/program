...
/**
 * The base model interface for the CustomViewDetails service. Represents a row in the &quot;CUSTOM_VIEW_DETAILS&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.stpl.app.model.impl.CustomViewDetailsModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.stpl.app.model.impl.CustomViewDetailsImpl}.
 * </p>
 *
 * @author
 * @see CustomViewDetails
 * @see com.stpl.app.model.impl.CustomViewDetailsImpl
 * @see com.stpl.app.model.impl.CustomViewDetailsModelImpl
 * @generated
 */
@ProviderType
public interface CustomViewDetailsModel extends BaseModel<CustomViewDetails> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a custom view details model instance should use the {@link CustomViewDetails} interface instead.
	 */
