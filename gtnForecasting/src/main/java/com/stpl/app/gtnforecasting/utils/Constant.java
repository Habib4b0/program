...
//    public  static  final String PRC_PPA_DATA_SELECTION_CALL="PRC_PPA_DATA_SELECTION_CALL";
    ...
    public enum DPRVariables {
        ...
        public static String[] names() {
            return Arrays.toString(DPRVariables.values()).replaceAll("^.|.$", StringUtils.EMPTY).split(",");
        }

        public static String[] getCheckAllVariables() {
            return Arrays.toString(ArrayUtils.removeElement(DPRVariables.values(), CHECK_ALL)).replaceAll("^.|.$", StringUtils.EMPTY).split(",");
        }
    }
