...
/**
 * Provides the local service interface for WorkflowProcessInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author
 * @see WorkflowProcessInfoLocalServiceUtil
...
public interface WorkflowProcessInfoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkflowProcessInfoLocalServiceUtil} to access the workflow process info local service. Add custom service methods to {@link com.stpl.app.service.impl.WorkflowProcessInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
