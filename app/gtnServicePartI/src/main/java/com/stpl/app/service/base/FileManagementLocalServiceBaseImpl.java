...
import com.stpl.app.service.FileManagementLocalService;
...
/**
 * Provides the base implementation for the file management local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.FileManagementLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.FileManagementLocalServiceImpl
 * @see com.stpl.app.service.FileManagementLocalServiceUtil
 * @generated
 */
public abstract class FileManagementLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements FileManagementLocalService,
        IdentifiableBean {
    ...
    private FileManagementLocalServiceClpInvoker _clpInvoker = new FileManagementLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.service.FileManagementLocalServiceUtil} to access the file management local service.
     */
    ...
    @Override
    public FileManagement addFileManagement(FileManagement fileManagement)
        throws SystemException {
        fileManagement.setNew(true);

        return fileManagementPersistence.update(fileManagement);
    }
     ...
     */
    @Override
    public FileManagement createFileManagement(int fileManagementSid) {
        return fileManagementPersistence.create(fileManagementSid);
    }
    ...
    @Override
    public FileManagement deleteFileManagement(int fileManagementSid)
        throws PortalException, SystemException {
        return fileManagementPersistence.remove(fileManagementSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public FileManagement deleteFileManagement(FileManagement fileManagement)
        throws SystemException {
        return fileManagementPersistence.remove(fileManagement);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(FileManagement.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return fileManagementPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return fileManagementPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public FileManagement fetchFileManagement(int fileManagementSid)
        throws SystemException {
        return fileManagementPersistence.fetchByPrimaryKey(fileManagementSid);
    }
     ...
     */
    @Override
    public FileManagement getFileManagement(int fileManagementSid)
        throws PortalException, SystemException {
        return fileManagementPersistence.findByPrimaryKey(fileManagementSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return fileManagementPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<FileManagement> getFileManagements(int start, int end)
        throws SystemException {
        return fileManagementPersistence.findAll(start, end);
    }
    ...
    public int getFileManagementsCount() throws SystemException {
        return fileManagementPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public FileManagement updateFileManagement(FileManagement fileManagement)
        throws SystemException {
        return fileManagementPersistence.update(fileManagement);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.model.FileManagement",
            fileManagementLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.stpl.app.model.FileManagement");
    }
