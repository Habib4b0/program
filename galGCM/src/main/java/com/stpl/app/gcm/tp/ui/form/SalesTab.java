...
public class SalesTab extends VerticalLayout {
    ...
    public CustomTreeContainer<SalesTabDTO> resultBean = new CustomTreeContainer<SalesTabDTO>(SalesTabDTO.class);
    /**
    ...
    public void configureTable() {
        ...
        rightDTO = HeaderUtils.getSalesAndRebateColumns(tableHeader, fullHeader, 4, "Quarterly", true);
    ...
    private void configureExcelResultTable() {
        excelResultBean = new CustomTreeContainer<>(SalesTabDTO.class);
    ...
    public CustomTreeContainer<SalesTabDTO> getResultBean() {
        return resultBean;
    }

    public void setResultBean(CustomTreeContainer<SalesTabDTO> resultBean) {
