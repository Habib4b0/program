...
import com.stpl.app.service.MProjectionSelectionLocalService;
...
/**
 * Provides the base implementation for the m projection selection local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.service.impl.MProjectionSelectionLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.service.impl.MProjectionSelectionLocalServiceImpl
 * @see com.stpl.app.service.MProjectionSelectionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class MProjectionSelectionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MProjectionSelectionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.stpl.app.service.MProjectionSelectionLocalServiceUtil} to access the m projection selection local service.
	 */
	...
	@Override
	public MProjectionSelection addMProjectionSelection(
		MProjectionSelection mProjectionSelection) {
		mProjectionSelection.setNew(true);

		return mProjectionSelectionPersistence.update(mProjectionSelection);
	}
	 ...
	 */
	@Override
	public MProjectionSelection createMProjectionSelection(
		int mProjectionSelectionSid) {
		return mProjectionSelectionPersistence.create(mProjectionSelectionSid);
	}
	...
	@Override
	public MProjectionSelection deleteMProjectionSelection(
		int mProjectionSelectionSid) throws PortalException {
		return mProjectionSelectionPersistence.remove(mProjectionSelectionSid);
	}
	...
	public MProjectionSelection deleteMProjectionSelection(
		MProjectionSelection mProjectionSelection) {
		return mProjectionSelectionPersistence.remove(mProjectionSelection);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MProjectionSelection.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return mProjectionSelectionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return mProjectionSelectionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MProjectionSelection fetchMProjectionSelection(
		int mProjectionSelectionSid) {
		return mProjectionSelectionPersistence.fetchByPrimaryKey(mProjectionSelectionSid);
	}
	 ...
	 */
	@Override
	public MProjectionSelection getMProjectionSelection(
		int mProjectionSelectionSid) throws PortalException {
		return mProjectionSelectionPersistence.findByPrimaryKey(mProjectionSelectionSid);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(mProjectionSelectionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MProjectionSelection.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(mProjectionSelectionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MProjectionSelection.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return mProjectionSelectionLocalService.deleteMProjectionSelection((MProjectionSelection)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return mProjectionSelectionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MProjectionSelection> getMProjectionSelections(int start,
		int end) {
		return mProjectionSelectionPersistence.findAll(start, end);
	}
	...
	public int getMProjectionSelectionsCount() {
		return mProjectionSelectionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MProjectionSelection updateMProjectionSelection(
		MProjectionSelection mProjectionSelection) {
		return mProjectionSelectionPersistence.update(mProjectionSelection);
	}
	 ...
	 */
	public MProjectionSelectionLocalService getMProjectionSelectionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.stpl.app.model.MProjectionSelection",
			mProjectionSelectionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.stpl.app.model.MProjectionSelection");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MProjectionSelectionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = mProjectionSelectionPersistence.getDataSource();
	...
	@BeanReference(type = MProjectionSelectionLocalService.class)
	protected MProjectionSelectionLocalService mProjectionSelectionLocalService;
