 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link CffDocDetailsModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CffDocDetailsImpl}.
 * </p>
 *
 * @author
...
public class CffDocDetailsModelImpl extends BaseModelImpl<CffDocDetails>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("UPLOAD_BY", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CFF_MASTER_SID", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("CFF_DOC_DETAILS_SID", Types.INTEGER);
	...
	private static final ClassLoader _classLoader = CffDocDetails.class.getClassLoader();
