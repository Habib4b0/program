...
import com.stpl.app.parttwo.service.VwItemMasterLocalService;
...
/**
 * Provides the base implementation for the vw item master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.stpl.app.parttwo.service.impl.VwItemMasterLocalServiceImpl}.
 * </p>
 *
 * @author
 * @see com.stpl.app.parttwo.service.impl.VwItemMasterLocalServiceImpl
 * @see com.stpl.app.parttwo.service.VwItemMasterLocalServiceUtil
 * @generated
 */
public abstract class VwItemMasterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements VwItemMasterLocalService,
        IdentifiableBean {
    ...
    private VwItemMasterLocalServiceClpInvoker _clpInvoker = new VwItemMasterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.stpl.app.parttwo.service.VwItemMasterLocalServiceUtil} to access the vw item master local service.
     */
    ...
    @Override
    public VwItemMaster addVwItemMaster(VwItemMaster vwItemMaster)
        throws SystemException {
        vwItemMaster.setNew(true);

        return vwItemMasterPersistence.update(vwItemMaster);
    }
     ...
     */
    @Override
    public VwItemMaster createVwItemMaster(int itemMasterSid) {
        return vwItemMasterPersistence.create(itemMasterSid);
    }
    ...
    @Override
    public VwItemMaster deleteVwItemMaster(int itemMasterSid)
        throws PortalException, SystemException {
        return vwItemMasterPersistence.remove(itemMasterSid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public VwItemMaster deleteVwItemMaster(VwItemMaster vwItemMaster)
        throws SystemException {
        return vwItemMasterPersistence.remove(vwItemMaster);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(VwItemMaster.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwItemMasterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return vwItemMasterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public VwItemMaster fetchVwItemMaster(int itemMasterSid)
        throws SystemException {
        return vwItemMasterPersistence.fetchByPrimaryKey(itemMasterSid);
    }
     ...
     */
    @Override
    public VwItemMaster getVwItemMaster(int itemMasterSid)
        throws PortalException, SystemException {
        return vwItemMasterPersistence.findByPrimaryKey(itemMasterSid);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return vwItemMasterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<VwItemMaster> getVwItemMasters(int start, int end)
        throws SystemException {
        return vwItemMasterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getVwItemMastersCount() throws SystemException {
        return vwItemMasterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public VwItemMaster updateVwItemMaster(VwItemMaster vwItemMaster)
        throws SystemException {
        return vwItemMasterPersistence.update(vwItemMaster);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.stpl.app.parttwo.model.VwItemMaster",
            vwItemMasterLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = vwItemMasterPersistence.getDataSource();
