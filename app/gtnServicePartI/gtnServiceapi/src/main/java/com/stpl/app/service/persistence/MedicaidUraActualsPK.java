 ...
 */
@ProviderType
public class MedicaidUraActualsPK implements Comparable<MedicaidUraActualsPK>,
	Serializable {
	public int periodSid;
	public String priceType;
	public int naProjDetailsSid;

	public MedicaidUraActualsPK() {
	}

	public MedicaidUraActualsPK(int periodSid, String priceType,
	...
	@Override
	public int compareTo(MedicaidUraActualsPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MedicaidUraActualsPK)) {
			return false;
		}

		MedicaidUraActualsPK pk = (MedicaidUraActualsPK)obj;
