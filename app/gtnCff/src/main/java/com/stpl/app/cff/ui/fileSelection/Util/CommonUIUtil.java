...
public final class CommonUIUtil {
     ...
     */
    public final Object[] fileMgtHistoryResultColumns  = new Object[]{"file", "effectiveDate", "type", "version", "fromPeriod", "toPeriod"};

    /**
     * The Constant FILE_MGT_HISTORY_RESULT_HEADER.
     */
    public final String[] fileMgtHistoryResultHeader  = new String[]{"File", "Effective Date", "Type", StringConstantsUtil.VERSION_LABEL, "From Period", "To Period"};

    /**
     * The Constant FILE_MGT_LOOKUP_RESULT_COLUMNS.
     */
    public final Object[] fileMgtLookupResultColumns = new Object[]{"fileType", "country", "fileName", "type", "version", "fromDate", "toDate"};

    /**
     * The Constant FILE_MGT_LOOKUP_RESULT_HEADER.
     */
    public final String[] fileMgtLookupResultHeader = new String[]{"File Type", COUNTRY, "File Name", "Type", StringConstantsUtil.VERSION_LABEL, "From Date", "To Date"};
     ...
     */
    public final Object[] fileMgtLookupDetailsColumns = new Object[]{"year", MONTH_PROPERTY, ITEM_NO, ITEM_NAME_PROPERTY, START_DATE, PRICE_PROPERTY, UNITS_PROPERTY, "dollars"};
    /**
     * The Constant FILE_MGT_LOOKUP_DETAILS_COLUMNS.
     */
    public final Object[] fileMgtLookupDetailsColumnsExcel = new Object[]{"year", MONTH_PROPERTY, ITEM_NO, ITEM_NAME_PROPERTY, START_DATE, PRICE_PROPERTY, UNITS_PROPERTY, "dollars"};
     ...
     */
    public final String[] fileMgtLookupDemandDetailsHeader = new String[]{FORECAST_TYPE, FORECAST_YEAR, FORECAST_MONTH_LABEL, ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL,
    ...
    public final Object[] fileMgtLookupDemandDetailsColumns = new Object[]{"forecastType", FORCAST_YEAR, StringConstantsUtil.FORECAST_MONTH, StringConstantsUtil.ITEM_ID,
    ...
    public final String[] fileMgtLookupDemandDetailsHeaderExcel = new String[]{FORECAST_TYPE, FORECAST_YEAR, FORECAST_MONTH_LABEL,
    ...
    public final Object[] fileMgtLookupDemandDetailsColumnsExcel = new Object[]{"forecastType", FORCAST_YEAR, StringConstantsUtil.FORECAST_MONTH, StringConstantsUtil.ITEM_ID,
        StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER, StringConstantsUtil.ITEM_IDENTIFIER, BRAND_ID, SEGMENT_PROPERTY, StringConstantsUtil.MARKET_SIZE_UNITS, MARKET_SHARE_RATIO_PROPERTY, MARKET_SHARE_UNITS, UNCAPTURED_UNITS1, UNCAPTURED_UNITS_RATIO1,
         TOTAL_DEMAND_UNITS1, TOTAL_DEMAND_AMOUNT1, StringConstantsUtil.INVENTORY_UNIT_CHANGE, GROSS_UNITS, GROSS_PRICE1, GROSS_AMOUNT1, StringConstantsUtil.NET_SALES_PRICE, NET_SALES_AMOUNT, BATCH_ID_PROPERTY, ORGANIZATION_KEY1};
     ...
     */
    public final String[] fileMgtLookupInventoryDetailsSummaryHeader = new String[]{"Year", MONTH_LABEL, "Day", "Week", ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER, UNITS_WITHDRAWN, AMOUNT_WITHDRAWN1, PRICE_LABEL, StringConstantsUtil.BATCH_ID_LABEL, ORGANIZATION_KEY};
    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_COLUMNS
     */
    public final Object[] fileMgtInventoryDetailsSummaryColumnsExcel = new Object[]{"year", MONTH_PROPERTY, "day", "week", StringConstantsUtil.ITEM_ID, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER, StringConstantsUtil.ITEM_IDENTIFIER, UNITS_WITHDRAWN1, AMOUNT_WITHDRAWN, PRICE_PROPERTY, BATCH_ID_PROPERTY, ORGANIZATION_KEY1};
    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_HEADER
     */
    public final String[] fileMgtLookupInventoryDetailsSummaryHeaderExcel = new String[]{"Year", MONTH_LABEL, "Day", "Week", ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER, UNITS_WITHDRAWN, AMOUNT_WITHDRAWN1, PRICE_LABEL, StringConstantsUtil.BATCH_ID_LABEL, ORGANIZATION_KEY};
    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_COLUMNS
     */
    public final Object[] fileMgtLookupInventoryDetailsDetailsColumns = new Object[]{"year", MONTH_PROPERTY, "day", "week", StringConstantsUtil.COMPANY_ID_PROPERTY, "identifierCodeQualifier", "companyIdentifier", StringConstantsUtil.ITEM_ID, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER, StringConstantsUtil.ITEM_IDENTIFIER, UNITS_WITHDRAWN1, AMOUNT_WITHDRAWN, PRICE_PROPERTY, BATCH_ID_PROPERTY, ORGANIZATION_KEY1};
    public final String COMPANY_ID_LABEL = "Company ID";
    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_HEADER
     */
    public final String[] fileMgtLookupInventoryDetailsDetailsHeader = new String[]{"Year", MONTH_LABEL, "Day", "Week", COMPANY_ID_LABEL, "Identifier Code Qualifier", "Company Identifier", ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER, UNITS_WITHDRAWN, AMOUNT_WITHDRAWN1, PRICE_LABEL, StringConstantsUtil.BATCH_ID_LABEL, ORGANIZATION_KEY};

    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_COLUMNS
     */
    public final Object[] fileMgtLookupInventoryDetailsDetailsColumnsExcel = new Object[]{"year", MONTH_PROPERTY, "day", "week", StringConstantsUtil.COMPANY_ID_PROPERTY, "identifierCodeQualifier", "companyIdentifier", StringConstantsUtil.ITEM_ID, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER, StringConstantsUtil.ITEM_IDENTIFIER, UNITS_WITHDRAWN1, AMOUNT_WITHDRAWN, PRICE_PROPERTY, BATCH_ID_PROPERTY, ORGANIZATION_KEY1};
    /**
     * The Constant FILE_MGT_LOOKUP_INVENTORY_DETAILS_HEADER
     */
    public final String[] fileMgtLookupInventoryDetailsDetailsHeaderExcel = new String[]{"Year", MONTH_LABEL, "Day", "Week", "Company Id", "Identifier Code Qualifier", "Company Identifier", ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER, UNITS_WITHDRAWN, AMOUNT_WITHDRAWN1, PRICE_LABEL, StringConstantsUtil.BATCH_ID_LABEL, ORGANIZATION_KEY};
     ...
     */
    public final String[] fileMgtLookupDetailsHeader = new String[]{"Year", MONTH_LABEL, ITEM_HASH, ITEM_NAME_LABEL, FORECAST_DATE_LABEL, PRICE_LABEL, UNITS_LABEL, DOLLARS};
    public final String[] fileMgtLookupDetailsHeaderExcel = new String[]{"Year", MONTH_LABEL, ITEM_HASH, ITEM_NAME_LABEL, FORECAST_DATE_LABEL, PRICE_LABEL, UNITS_LABEL, DOLLARS};

    /**
     * The Constant AC_SEARCH_RESULT_COLUMNS.
     */
    public final Object[] acSearchResultColumns = new Object[]{"resultRSName", "resultRSDesc", "resultRSType", "resultRSHierarchyName", "versionNo", START_DATE, "createdDate", "modifiedDate",
        "resultCreatedBy"};
     ...
     */
    public final String[] acSearchResultHeader = new String[]{"Relationship Name", "Relationship Description", "Relationship Type", "Hierarchy Name", "version No", "Start Date", "Creation Date", MODIFIED_DATE_LABEL, CREATED_BY_LABEL};

    /**
     * The Constant AC_HB_SEARCH_RESULT_COLUMNS.
     */
    public final Object[] acHbSearchResultColumns = new Object[]{"hierarchyName", "hierarchyType", "hierarchyCategoryInString", "noOfLevels", "versionNo", "createdDate", "modifiedDate", "createdBy"};

    /**
     * The Constant AC_HB_SEARCH_RESULT_HEADER.
     */
    public final String[] acHbSearchResultHeader = new String[]{"Hierarchy Name", "Hierarchy Type", "Hierarchy Category", "# of Levels", StringConstantsUtil.VERSION_LABEL, "Creation Date", MODIFIED_DATE_LABEL, CREATED_BY_LABEL};

    /**
     * The Constant AC_HB_LEVEL_DEFINITION_COLUMNS.
     */
    public final Object[] acHbLevelDefinitionColumns = new Object[]{"levelNo", "levelName", "tableName", "fieldName", "userDefinedOrLinked"};

    /**
     * The Constant AC_HB_LEVEL_DEFINITION_HEADER.
     */
    public final String[] acHbLevelDefinitionHeader = new String[]{"Level #", "Level Name", "Table Name", "Field Name", "User Defined/ Linked"};
     ...
     */
    public final Object[] tableLookupColumn = new Object[]{"tableName"};
     ...
     */
    public final Object[] rbSelectedLevelColumn = new Object[]{"levelValue"};
    ...
    public final String[] fileMgtLookupCustomerHeader = new String[]{FORECAST_YEAR, FORECAST_MONTH_LABEL, ITEM_ID_LABEL, COMPANY_ID_LABEL, UNITS_LABEL, "Price Type", PRICE_LABEL, "Sales Amount", "Sales Inclusion", "Deduction ID",
    ...
    public final Object[] fileMgtLookupCustomerColumns = new Object[]{FORCAST_YEAR, StringConstantsUtil.FORECAST_MONTH, StringConstantsUtil.ITEM_ID,
    ...
    public final String[] excelFileMgtLookupDemandDetailsHeader = new String[]{FORECAST_TYPE, FORECAST_YEAR, FORECAST_MONTH_LABEL,
        "Item Id", StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER,
        "Brand Id", StringConstantsUtil.SEGMENT_LABEL, MARKET_SIZE_UNITS, MARKET_SHARE_RATIO_LABEL, StringConstantsUtil.MARKET_SHARE_UNITS_LABEL, UNCAPTURED_UNITS, UNCAPTURED_UNITS_RATIO, TOTAL_DEMAND_UNITS, TOTAL_DEMAND_AMOUNT, INVENTORY_UNIT_CHANGE, GROSS_UNITS_LABEL, GROSS_PRICE, GROSS_AMOUNT, NET_SALES_PRICE, NET_SALE_AMOUNT, "Batch Id", ORGANIZATION_KEY};

    public final String[] excelFileMgtLookupDetailsHeader = new String[]{"Year", MONTH_LABEL, ITEM_HASH, ITEM_NAME_LABEL, FORECAST_DATE_LABEL, PRICE_LABEL, UNITS_LABEL, DOLLARS};

    public final String[] excelFileMgtLookupInventoryDetailsDetailsHeader = new String[]{"Year", MONTH_LABEL, "Day", "Week", COMPANY_ID_LABEL, "Company Name", ITEM_ID_LABEL, ITEM_NAME_LABEL, UNITS_WITHDRAWN, AMOUNT_WITHDRAWN1, PRICE_LABEL, CREATED_BY_LABEL, "Created Date", "Modified By", MODIFIED_DATE_LABEL, "Add Chg Del Indicator", StringConstantsUtil.BATCH_ID_LABEL, "Source ID", "Forecast Name", "Forecast Ver", "Country", ORGANIZATION_KEY};

    public final String[] excelFileMgtLookupInventoryDetailsSummaryHeader = new String[]{"Year", MONTH_LABEL, "Day", "Week", ITEM_ID_LABEL, StringConstantsUtil.ITEM_IDENTIFIER_CODE_QUALIFIER_LABEL, ITEM_IDENTIFIER, UNITS_WITHDRAWN, AMOUNT_WITHDRAWN1, PRICE_LABEL, StringConstantsUtil.BATCH_ID_LABEL, ORGANIZATION_KEY};
