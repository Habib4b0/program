 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link MSalesProjectionMasterModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link MSalesProjectionMasterImpl}.
 * </p>
 *
 * @author
...
public class MSalesProjectionMasterModelImpl extends BaseModelImpl<MSalesProjectionMaster>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("CALCULATION_BASED", Types.VARCHAR);
	...
	private static final ClassLoader _classLoader = MSalesProjectionMaster.class.getClassLoader();
