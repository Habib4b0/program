    ...
    public AbstractField<?> getCustomFilterComponent(Object propertyId) {
        ...
        try {
            ...
            if ("companyFamilyPlanStatus".equals(propertyId)) {
                ...
                comboBox = new ComboBox();
                comboBox.setImmediate(true);
                new CommonUtils().getNativeSelectForFilter(comboBox, cfpLogic.getDropDownList(UIUtils.CFP_TYPE));
                comboBox.select(0);
                comboBox.setNullSelectionAllowed(true);
                comboBox.setNullSelectionItemId(ConstantsUtils.Show_All);
                comboBox.select(ConstantsUtils.ZERO_INT);
            ...
            group.setNullSelectionItemId("Show all");
            group.select("Show all");
            return group;
