...
public class ServiceBuilderMojo extends AbstractLiferayMojo {
	...
	protected void doExecute() throws Exception {
		...
		executeTool(
			"com.stpl.portal.tools.servicebuilder.ServiceBuilder",
	...
	protected void initProperties() throws Exception {
		...
		if (pluginType.equals("ext")) {
			if (Validator.isNull(beanLocatorUtil)) {
				beanLocatorUtil =
					"com.stpl.portal.kernel.bean.PortalBeanLocatorUtil";
			}

			if (Validator.isNull(propsUtil)) {
				propsUtil = "com.stpl.portal.util.PropsUtil";
			}
			...
			if (Validator.isNull(beanLocatorUtil)) {
				beanLocatorUtil =
					"com.stpl.util.bean.PortletBeanLocatorUtil";
			}
			...
			if (Validator.isNull(propsUtil)) {
				propsUtil = "com.stpl.util.service.ServiceProps";
			}
