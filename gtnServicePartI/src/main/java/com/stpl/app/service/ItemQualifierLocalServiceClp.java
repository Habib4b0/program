 ...
 * @generated
 */
public class ItemQualifierLocalServiceClp implements ItemQualifierLocalService {
    ...
    public ItemQualifierLocalServiceClp(
        ...
        _methodName19 = "findByItemIrtQualifierByName";
    ...
    public com.stpl.app.model.ItemQualifier addItemQualifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(itemQualifier) });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ItemQualifier) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ItemQualifier createItemQualifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { itemQualifierSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ItemQualifier deleteItemQualifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { itemQualifierSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ItemQualifier fetchItemQualifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { itemQualifierSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stpl.app.model.ItemQualifier getItemQualifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { itemQualifierSid });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ItemQualifier> getItemQualifiers(
        ...
        return (java.util.List<com.stpl.app.model.ItemQualifier>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ItemQualifier findByItemIrtQualifierByName(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(itemQualifierValue)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

            if (t instanceof com.stpl.app.NoSuchItemQualifierException) {
                throw (com.stpl.app.NoSuchItemQualifierException) t;
            }
