...
public class GtnFrameworkForecastConfigurationContantsTest {
	...
	public void testGetForecastConfigurationTableColumnType_1()
		...
		assertEquals("class java.util.Date", result[3].toString());
		assertEquals(1, result[3].getModifiers());
		...
		assertEquals("java.util.Date", result[3].getName());
		assertEquals(false, result[3].desiredAssertionStatus());
		assertEquals("java.util.Date", result[3].getCanonicalName());
		...
		assertEquals("Date", result[3].getSimpleName());
		assertEquals("java.util.Date", result[3].getTypeName());
		...
		assertEquals("public class java.util.Date", result[3].toGenericString());
		assertNotNull(result[4]);
		assertEquals("class java.util.Date", result[4].toString());
		assertEquals(1, result[4].getModifiers());
		...
		assertEquals("java.util.Date", result[4].getName());
		assertEquals(false, result[4].desiredAssertionStatus());
		assertEquals("java.util.Date", result[4].getCanonicalName());
		...
		assertEquals("Date", result[4].getSimpleName());
		assertEquals("java.util.Date", result[4].getTypeName());
		...
		assertEquals("public class java.util.Date", result[4].toGenericString());
		...
		assertEquals("class java.lang.Integer", result[6].toString());
		...
		assertEquals("java.lang.Integer", result[6].getName());
		assertEquals(false, result[6].desiredAssertionStatus());
		assertEquals("java.lang.Integer", result[6].getCanonicalName());
		...
		assertEquals("Integer", result[6].getSimpleName());
		assertEquals("java.lang.Integer", result[6].getTypeName());
		...
		assertEquals("public final class java.lang.Integer", result[6].toGenericString());
		...
		assertEquals("class java.lang.Integer", result[8].toString());
		...
		assertEquals("java.lang.Integer", result[8].getName());
		assertEquals(false, result[8].desiredAssertionStatus());
		assertEquals("java.lang.Integer", result[8].getCanonicalName());
		...
		assertEquals("Integer", result[8].getSimpleName());
		assertEquals("java.lang.Integer", result[8].getTypeName());
		...
		assertEquals("public final class java.lang.Integer", result[8].toGenericString());
		assertNotNull(result[9]);
		assertEquals("class java.lang.Integer", result[9].toString());
		...
		assertEquals("java.lang.Integer", result[9].getName());
		assertEquals(false, result[9].desiredAssertionStatus());
		assertEquals("java.lang.Integer", result[9].getCanonicalName());
		...
		assertEquals("Integer", result[9].getSimpleName());
		assertEquals("java.lang.Integer", result[9].getTypeName());
		...
		assertEquals("public final class java.lang.Integer", result[9].toGenericString());
		assertNotNull(result[10]);
		assertEquals("class java.util.Date", result[10].toString());
		assertEquals(1, result[10].getModifiers());
		...
		assertEquals("java.util.Date", result[10].getName());
		assertEquals(false, result[10].desiredAssertionStatus());
		assertEquals("java.util.Date", result[10].getCanonicalName());
		...
		assertEquals("Date", result[10].getSimpleName());
		assertEquals("java.util.Date", result[10].getTypeName());
		...
		assertEquals("public class java.util.Date", result[10].toGenericString());
	...
	@Test
	public void testGetForecastConfigurationTableColumns_1()
		throws Exception {
	...
	@Test
	public void testGetForecastConfigurationTableHeader_1()
		throws Exception {

		String[] result = GtnFrameworkForecastConfigurationContants.getForecastConfigurationTableHeader();

		// add additional test code here
		assertNotNull(result);
		assertEquals(14, result.length);
		assertEquals("Business Process", result[0]);
		assertEquals("Process Type", result[1]);
		assertEquals("Process Mode", result[2]);
		assertEquals("From Date", result[3]);
		assertEquals("To Date", result[4]);
		assertEquals("Historic Interval", result[5]);
		assertEquals("Historic Period", result[6]);
		assertEquals("Future Interval", result[7]);
		assertEquals("Future Period", result[8]);
		assertEquals("Version", result[9]);
		assertEquals("From Period", result[10]);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(GtnFrameworkForecastConfigurationContantsTest.class);
	}
}