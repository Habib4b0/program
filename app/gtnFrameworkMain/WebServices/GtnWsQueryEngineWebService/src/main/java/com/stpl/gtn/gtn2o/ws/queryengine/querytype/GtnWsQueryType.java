...
import com.stpl.gtn.gtn2o.ws.queryengine.querytypeimpl.GtnWsExecuteProcedureImpl;
...
public enum GtnWsQueryType {
	...
	SELECT(new GtnExecuteSelectQueryImpl()), COUNT(new GtnWsExecuteCountQueryImpl()), SELECTWITHPARAMS(
			new GtnWsExecuteSelectParamsQueryImpl()), INSERTORUPDATE(
					new GtnWsExecuteInsertUpdateQueryImpl()), PROCEDURE(
							new GtnWsExecuteProcedureImpl()), INSERTORUPDATEWITHPARAMS(
