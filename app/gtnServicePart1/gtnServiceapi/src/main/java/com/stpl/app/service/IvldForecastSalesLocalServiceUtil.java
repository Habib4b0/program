...
public class IvldForecastSalesLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<IvldForecastSalesLocalService, IvldForecastSalesLocalService> _serviceTracker =
		ServiceTrackerFactory.open(IvldForecastSalesLocalService.class);
}