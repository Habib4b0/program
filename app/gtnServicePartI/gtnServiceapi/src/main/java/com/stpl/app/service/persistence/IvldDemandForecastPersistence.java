...
public interface IvldDemandForecastPersistence extends BasePersistence<IvldDemandForecast> {
	...
	*/
	public void cacheResult(
		java.util.List<IvldDemandForecast> ivldDemandForecasts);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, IvldDemandForecast> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<IvldDemandForecast> findAll();
	...
	*/
	public java.util.List<IvldDemandForecast> findAll(int start, int end);
	...
	*/
	public java.util.List<IvldDemandForecast> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<IvldDemandForecast> orderByComparator);
