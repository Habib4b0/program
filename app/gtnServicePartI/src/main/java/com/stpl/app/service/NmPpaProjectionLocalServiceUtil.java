...
public class NmPpaProjectionLocalServiceUtil {
    private static NmPpaProjectionLocalService _service;
    ...
    */
    ...
    public static NmPpaProjectionLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    NmPpaProjectionLocalService.class.getName());

            if (invokableLocalService instanceof NmPpaProjectionLocalService) {
                _service = (NmPpaProjectionLocalService) invokableLocalService;
            } else {
                _service = new NmPpaProjectionLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(NmPpaProjectionLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(NmPpaProjectionLocalService service) {
    }
}
