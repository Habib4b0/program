...
public class DeductionCalendarForm extends StplCustomComponent implements AddBaseForm {
    ...
    public DeductionCalendarForm(final SessionDTO sessionDTO) throws SystemException, PortalException, Exception {
        super();
    ...
    public DeductionCalendarForm(final SessionDTO sessionDTO, final ErrorfulFieldGroup binder) throws SystemException, PortalException, Exception {
        super();
        this.sessionDTO = sessionDTO;
        this.binder = binder;
        init();
    ...
    private void backButton() throws Exception {
        ...
        backBtn.addClickListener(new ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("Entering Deduction Calendar back button operation from Add");
                try {
                    MessageBox.showPlain(Icon.QUESTION, "Confirmation", commonMsg.getBackMessage(), new MessageBoxListener() {
                        ...
                        public void buttonClicked(final ButtonId buttonId) {
                            if (buttonId.name().equals(ConstantsUtils.YES)) {
                                LOGGER.info("NavigateTo AbstractSearchView page");
                ...
                LOGGER.info("Ending Deduction Calendar back button operation from Add");
            }
        });
    }
    ...
    private void saveButton() {
        ...
        saveBtn.addClickListener(new ClickListener() {
            ...
            @Override
            public void buttonClick(final ClickEvent event) {
                LOGGER.info("Entering Deduction Calendar Save button operation from Add");
                try {
                    binder.commit();
                    detailsDto = logic.getForecastConfig(detailsDto);
                ...
                LOGGER.info("Ending Deduction Calendar Save button operation from Add");
