...
public class GtnWsTierTwoMethodologyTest {

	@Test
	public void testTierTwoMethodology() {
	...
	/*
	 * TIER_TWO_ will be appended before PROJECTED_RETURN_AMOUNT and
	 * PROJECTED_RPU in the formula properties file.
	 * 
	 * Will be like TIER_TWO_PROJECTED_RETURN_AMOUNT and TIER_TWO_PROJECTED_RPU.
	 */
