...
public class ItemPricingQualifierLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<ItemPricingQualifierLocalService, ItemPricingQualifierLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ItemPricingQualifierLocalService.class);
}