...
public class CustomerGtsActualCacheModel implements CacheModel<CustomerGtsActual>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CustomerGtsActualCacheModel)) {
			return false;
		}

		CustomerGtsActualCacheModel customerGtsActualCacheModel = (CustomerGtsActualCacheModel)obj;

		if (customerGtsActualSid == customerGtsActualCacheModel.customerGtsActualSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, customerGtsActualSid);
	}
