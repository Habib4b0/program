...
/**
 * The persistence utility for the ivld demand actual service. This utility wraps {@link IvldDemandActualPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class IvldDemandActualUtil {
    private static IvldDemandActualPersistence _persistence;
    ...
    */
    public static com.stpl.app.model.IvldDemandActual create(
    ...
    */
    public static com.stpl.app.model.IvldDemandActual remove(
        int ivldDemandActualSid)
    ...
    public static com.stpl.app.model.IvldDemandActual updateImpl(
        com.stpl.app.model.IvldDemandActual ivldDemandActual)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.IvldDemandActual findByPrimaryKey(
        int ivldDemandActualSid)
        throws com.stpl.app.NoSuchIvldDemandActualException,
            com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stpl.app.model.IvldDemandActual fetchByPrimaryKey(
        int ivldDemandActualSid)
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stpl.app.model.IvldDemandActual> findAll()
        throws com.stpl.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static IvldDemandActualPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (IvldDemandActualPersistence) PortletBeanLocatorUtil.locate(com.stpl.app.service.ClpSerializer.getServletContextName(),
                    IvldDemandActualPersistence.class.getName());

            ReferenceRegistry.registerReference(IvldDemandActualUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(IvldDemandActualPersistence persistence) {
    }
}
