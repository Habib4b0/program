...
public class IvldAverageShelfLifeCacheModel implements CacheModel<IvldAverageShelfLife>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof IvldAverageShelfLifeCacheModel)) {
			return false;
		}

		IvldAverageShelfLifeCacheModel ivldAverageShelfLifeCacheModel = (IvldAverageShelfLifeCacheModel)obj;

		if (ivldAverageShelfLifeSid == ivldAverageShelfLifeCacheModel.ivldAverageShelfLifeSid) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, ivldAverageShelfLifeSid);
	}
