...
import static com.stpl.app.galforecasting.logic.CommonLogic.isValidViewName;
import com.stpl.app.galforecasting.logic.CustomViewLogic;
...
public class CustomTreeBuild extends AbstractCustomTreeView {
    ...
    protected int customTreeSaveLogic(String viewName) {
        LOGGER.info("SustomTreeSaveLogic started :");
        int returnBack = 0;
