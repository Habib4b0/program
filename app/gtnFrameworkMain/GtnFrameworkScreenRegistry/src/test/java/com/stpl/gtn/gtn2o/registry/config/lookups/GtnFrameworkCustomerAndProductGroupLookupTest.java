...
public class GtnFrameworkCustomerAndProductGroupLookupTest {

	
	@Test
    public void testMainScreenConfigPrivateMethod1() {
        String methodName = "addForecastCustomerProductGroupRootLayout";
        GtnFrameworkCustomerAndProductGroupLookup instance = new GtnFrameworkCustomerAndProductGroupLookup();
        testComponentConfig(methodName, instance);
        instance.getCustProdGroupLookUpView("test");
       
    }

	
	public void testComponentConfig(String gtnFrameworkContractMainConfigMethodName, GtnFrameworkCustomerAndProductGroupLookup gtnFrameworkContractMainConfig) {
    ...
    private List<GtnUIFrameworkComponentConfig> getComponentList(Method method, GtnFrameworkCustomerAndProductGroupLookup gtnFrameworkContractMainConfig) throws SecurityException {
        ...
        try {
            ...
            Logger.getLogger(GtnFrameworkCustomerAndProductGroupLookup.class.getName()).log(Level.SEVERE, null, ex);
        }
