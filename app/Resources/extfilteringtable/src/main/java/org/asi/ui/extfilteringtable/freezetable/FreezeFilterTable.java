...
/**
 * The Class FreezeFilterTable.
 *
 * @author Abhiram
 */
public class FreezeFilterTable extends HorizontalSplitPanel {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 1L;
    
    /** The left table. */
    private ExtFilterTable leftTable = new ExtFilterTable();
    
    /** The right table. */
    private ExtFilterTable rightTable = new ExtFilterTable();
    ...
    /**
     * Instantiates a new freeze filter table.
     */
    public FreezeFilterTable() {
        super();
        init();
    }
     ...
     */
    public FreezeFilterTable(String caption) {
        super();
        setCaption(caption);
        init();
    }
     ...
     */
    public FreezeFilterTable(String caption, Container newDataSource) {
        super();
        setCaption(caption);
    ...
    private void init(){
        ...
        addStyleName("freeze-filter-table");
     ...
     */
    public ExtFilterTable getLeftFreezeAsTable(){
        return leftTable;
    }
     ...
     */
    public ExtFilterTable getRightFreezeAsTable(){
        return rightTable;
    }
