 ...
 * @generated
 */
public class ChDiscountProjMasterLocalServiceClp
    ...
    public ChDiscountProjMasterLocalServiceClp(
        InvokableLocalService invokableLocalService) {
        _invokableLocalService = invokableLocalService;

        _methodName0 = "addChDiscountProjMaster";

        _methodParameterTypes0 = new String[] {
                "com.stpl.app.model.ChDiscountProjMaster"
            };

        _methodName1 = "createChDiscountProjMaster";

        _methodParameterTypes1 = new String[] {
                "com.stpl.app.service.persistence.ChDiscountProjMasterPK"
            };

        _methodName2 = "deleteChDiscountProjMaster";

        _methodParameterTypes2 = new String[] {
                "com.stpl.app.service.persistence.ChDiscountProjMasterPK"
            };

        _methodName3 = "deleteChDiscountProjMaster";
        ...
        _methodName10 = "fetchChDiscountProjMaster";

        _methodParameterTypes10 = new String[] {
                "com.stpl.app.service.persistence.ChDiscountProjMasterPK"
            };

        _methodName11 = "getChDiscountProjMaster";
        ...
        _methodName13 = "getChDiscountProjMasters";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getChDiscountProjMastersCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateChDiscountProjMaster";
    ...
    public com.stpl.app.model.ChDiscountProjMaster addChDiscountProjMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(chDiscountProjMaster)
                    });
        } catch (Throwable t) {
        ...
        return (com.stpl.app.model.ChDiscountProjMaster) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stpl.app.model.ChDiscountProjMaster createChDiscountProjMaster(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(chDiscountProjMasterPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stpl.app.model.ChDiscountProjMaster> getChDiscountProjMasters(
        ...
        return (java.util.List<com.stpl.app.model.ChDiscountProjMaster>) ClpSerializer.translateOutput(returnObj);
    }
