...
public class FormulaDetails extends TestBenchTestCase{
	...
	public void setUp() throws Exception {		
		...
		findElement(By.xpath(".//span[contains(text(),' Formula Details')]")).click();
		
	}
	@Test
	public void formulaDetails1() {
	...
	@Test
	public void formulaDetails4() throws Exception {
		$(ButtonElement.class).caption("Search").first().click();
		Assert.assertEquals("Search operation failed", "Search Completed",$(NotificationElement.class).first().getText());
