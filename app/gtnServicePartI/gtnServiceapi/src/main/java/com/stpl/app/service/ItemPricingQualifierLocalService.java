...
public interface ItemPricingQualifierLocalService extends BaseLocalService,
	...
	*/
	...
	public ItemPricingQualifier addItemPricingQualifier(
	...
	*/
	public ItemPricingQualifier createItemPricingQualifier(
	...
	*/
	...
	public ItemPricingQualifier deleteItemPricingQualifier(
		int itemPricingQualifierSid) throws PortalException;
	...
	*/
	...
	public ItemPricingQualifier fetchItemPricingQualifier(
		int itemPricingQualifierSid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ItemPricingQualifier> getItemPricingQualifiers(int start,
		int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ItemPricingQualifier updateItemPricingQualifier(
		ItemPricingQualifier itemPricingQualifier);
}